...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// Instabank Callback
    /// </summary>
    [DataContract(Name = "InstabankConnectionCallback")]
    public partial class InstabankConnectionCallback : IEquatable<InstabankConnectionCallback>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankConnectionCallback" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstabankConnectionCallback() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankConnectionCallback" /> class.
        /// </summary>
        /// <param name="organizationNumber">organizationNumber (required).</param>
        public InstabankConnectionCallback(string organizationNumber = default(string))
        {
            // to ensure "organizationNumber" is required (not null)
            this.OrganizationNumber = organizationNumber ?? throw new ArgumentNullException("organizationNumber is a required property for InstabankConnectionCallback and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstabankConnectionCallback {\n");
        ...
        {
            return this.Equals(input as InstabankConnectionCallback);
        }

        /// <summary>
        /// Returns true if InstabankConnectionCallback instances are equal
        /// </summary>
        /// <param name="input">Instance of InstabankConnectionCallback to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstabankConnectionCallback input)
        {
            if (input == null)
                return false;
