...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InstabankConnectionConfiguration_payment_product_codes")]
    public partial class InstabankConnectionConfigurationPaymentProductCodes : IEquatable<InstabankConnectionConfigurationPaymentProductCodes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankConnectionConfigurationPaymentProductCodes" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstabankConnectionConfigurationPaymentProductCodes() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankConnectionConfigurationPaymentProductCodes" /> class.
        /// </summary>
        /// <param name="instabankFinance">instabankFinance (required).</param>
        /// <param name="instabankInvoice">instabankInvoice (required).</param>
        public InstabankConnectionConfigurationPaymentProductCodes(string instabankFinance = default(string), string instabankInvoice = default(string))
        {
            // to ensure "instabankFinance" is required (not null)
            this.InstabankFinance = instabankFinance ?? throw new ArgumentNullException("instabankFinance is a required property for InstabankConnectionConfigurationPaymentProductCodes and cannot be null");
            // to ensure "instabankInvoice" is required (not null)
            this.InstabankInvoice = instabankInvoice ?? throw new ArgumentNullException("instabankInvoice is a required property for InstabankConnectionConfigurationPaymentProductCodes and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstabankConnectionConfigurationPaymentProductCodes {\n");
        ...
        {
            return this.Equals(input as InstabankConnectionConfigurationPaymentProductCodes);
        }

        /// <summary>
        /// Returns true if InstabankConnectionConfigurationPaymentProductCodes instances are equal
        /// </summary>
        /// <param name="input">Instance of InstabankConnectionConfigurationPaymentProductCodes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstabankConnectionConfigurationPaymentProductCodes input)
        {
            if (input == null)
                return false;
