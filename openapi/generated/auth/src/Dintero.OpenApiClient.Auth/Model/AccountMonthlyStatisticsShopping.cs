...
{
    /// <summary>
    /// AccountMonthlyStatisticsShopping
    /// </summary>
    [DataContract(Name = "AccountMonthlyStatistics_shopping")]
    public partial class AccountMonthlyStatisticsShopping : IEquatable<AccountMonthlyStatisticsShopping>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountMonthlyStatisticsShopping" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountMonthlyStatisticsShopping() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountMonthlyStatisticsShopping" /> class.
        /// </summary>
        /// <param name="orders">orders (required).</param>
        public AccountMonthlyStatisticsShopping(List<Object> orders = default(List<Object>))
        {
            // to ensure "orders" is required (not null)
            this.Orders = orders ?? throw new ArgumentNullException("orders is a required property for AccountMonthlyStatisticsShopping and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountMonthlyStatisticsShopping {\n");
        ...
        {
            return this.Equals(input as AccountMonthlyStatisticsShopping);
        }

        /// <summary>
        /// Returns true if AccountMonthlyStatisticsShopping instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountMonthlyStatisticsShopping to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountMonthlyStatisticsShopping input)
        {
            if (input == null)
                return false;
