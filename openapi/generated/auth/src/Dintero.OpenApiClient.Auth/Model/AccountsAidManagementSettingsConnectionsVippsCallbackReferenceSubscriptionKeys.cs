...
{
    /// <summary>
    /// AccountsAidManagementSettingsConnectionsVippsCallbackReferenceSubscriptionKeys
    /// </summary>
    [DataContract(Name = "_accounts__aid__management_settings_connections_vipps__callback_reference__subscriptionKeys")]
    public partial class AccountsAidManagementSettingsConnectionsVippsCallbackReferenceSubscriptionKeys : IEquatable<AccountsAidManagementSettingsConnectionsVippsCallbackReferenceSubscriptionKeys>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountsAidManagementSettingsConnectionsVippsCallbackReferenceSubscriptionKeys" /> class.
        /// </summary>
        /// <param name="product">product.</param>
        /// <param name="ocpApimSubscriptionKey">ocpApimSubscriptionKey.</param>
        public AccountsAidManagementSettingsConnectionsVippsCallbackReferenceSubscriptionKeys(string product = default(string), string ocpApimSubscriptionKey = default(string))
        {
        ...
        /// </summary>
        [DataMember(Name = "ocp-apim-subscription-key", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountsAidManagementSettingsConnectionsVippsCallbackReferenceSubscriptionKeys {\n");
        ...
        {
            return this.Equals(input as AccountsAidManagementSettingsConnectionsVippsCallbackReferenceSubscriptionKeys);
        }

        /// <summary>
        /// Returns true if AccountsAidManagementSettingsConnectionsVippsCallbackReferenceSubscriptionKeys instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountsAidManagementSettingsConnectionsVippsCallbackReferenceSubscriptionKeys to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountsAidManagementSettingsConnectionsVippsCallbackReferenceSubscriptionKeys input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.OcpApimSubscriptionKey == input.OcpApimSubscriptionKey ||
                    (this.OcpApimSubscriptionKey != null &&
                    this.OcpApimSubscriptionKey.Equals(input.OcpApimSubscriptionKey))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OcpApimSubscriptionKey != null)
                    hashCode = hashCode * 59 + this.OcpApimSubscriptionKey.GetHashCode();
                return hashCode;
            }
        }
