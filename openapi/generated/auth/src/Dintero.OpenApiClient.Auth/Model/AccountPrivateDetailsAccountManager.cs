...
{
    /// <summary>
    /// Account manager responsible for the account. &gt; value is not visible for the merchant 
    /// </summary>
    [DataContract(Name = "AccountPrivateDetails_account_manager")]
    public partial class AccountPrivateDetailsAccountManager : IEquatable<AccountPrivateDetailsAccountManager>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountPrivateDetailsAccountManager" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountPrivateDetailsAccountManager() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountPrivateDetailsAccountManager" /> class.
        /// </summary>
        /// <param name="email">email (required).</param>
        public AccountPrivateDetailsAccountManager(string email = default(string))
        {
            // to ensure "email" is required (not null)
            this.Email = email ?? throw new ArgumentNullException("email is a required property for AccountPrivateDetailsAccountManager and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountPrivateDetailsAccountManager {\n");
        ...
        {
            return this.Equals(input as AccountPrivateDetailsAccountManager);
        }

        /// <summary>
        /// Returns true if AccountPrivateDetailsAccountManager instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountPrivateDetailsAccountManager to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountPrivateDetailsAccountManager input)
        {
            if (input == null)
                return false;
