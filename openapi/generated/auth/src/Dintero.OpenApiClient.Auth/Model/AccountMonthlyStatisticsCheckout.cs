...
{
    /// <summary>
    /// AccountMonthlyStatisticsCheckout
    /// </summary>
    [DataContract(Name = "AccountMonthlyStatistics_checkout")]
    public partial class AccountMonthlyStatisticsCheckout : IEquatable<AccountMonthlyStatisticsCheckout>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountMonthlyStatisticsCheckout" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountMonthlyStatisticsCheckout() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountMonthlyStatisticsCheckout" /> class.
        /// </summary>
        /// <param name="paymentProductTypes">paymentProductTypes (required).</param>
        public AccountMonthlyStatisticsCheckout(List<Object> paymentProductTypes = default(List<Object>))
        {
            // to ensure "paymentProductTypes" is required (not null)
            this.PaymentProductTypes = paymentProductTypes ?? throw new ArgumentNullException("paymentProductTypes is a required property for AccountMonthlyStatisticsCheckout and cannot be null");
        }

        /// <summary>
        /// Gets or Sets PaymentProductTypes
        /// </summary>
        [DataMember(Name = "payment_product_types", IsRequired = true, EmitDefaultValue = false)]
        public List<Object> PaymentProductTypes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountMonthlyStatisticsCheckout {\n");
            sb.Append("  PaymentProductTypes: ").Append(PaymentProductTypes).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AccountMonthlyStatisticsCheckout);
        }

        /// <summary>
        /// Returns true if AccountMonthlyStatisticsCheckout instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountMonthlyStatisticsCheckout to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountMonthlyStatisticsCheckout input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.PaymentProductTypes == input.PaymentProductTypes ||
                    this.PaymentProductTypes != null &&
                    input.PaymentProductTypes != null &&
                    this.PaymentProductTypes.SequenceEqual(input.PaymentProductTypes)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.PaymentProductTypes != null)
                    hashCode = hashCode * 59 + this.PaymentProductTypes.GetHashCode();
                return hashCode;
            }
        }
