...
{
    /// <summary>
    /// BamboraConnectionAllOf
    /// </summary>
    [DataContract(Name = "BamboraConnection_allOf")]
    public partial class BamboraConnectionAllOf : IEquatable<BamboraConnectionAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraConnectionAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BamboraConnectionAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraConnectionAllOf" /> class.
        /// </summary>
        /// <param name="configuration">configuration.</param>
        /// <param name="signup">signup (required).</param>
        public BamboraConnectionAllOf(BamboraConnectionConfiguration configuration = default(BamboraConnectionConfiguration), BamboraConnectionSignup signup = default(BamboraConnectionSignup))
        {
            // to ensure "signup" is required (not null)
            this.Signup = signup ?? throw new ArgumentNullException("signup is a required property for BamboraConnectionAllOf and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BamboraConnectionAllOf {\n");
        ...
        {
            return this.Equals(input as BamboraConnectionAllOf);
        }

        /// <summary>
        /// Returns true if BamboraConnectionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of BamboraConnectionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BamboraConnectionAllOf input)
        {
            if (input == null)
                return false;
