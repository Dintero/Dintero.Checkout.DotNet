...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    public partial class InlineObject8 : IEquatable<InlineObject8>, IValidatableObject
    {
        ...
        public InlineObject8(PayExConnectionSignup signup = default(PayExConnectionSignup))
        {
            // to ensure "signup" is required (not null)
            this.Signup = signup ?? throw new ArgumentNullException("signup is a required property for InlineObject8 and cannot be null");
        }
