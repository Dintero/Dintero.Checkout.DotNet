...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    public partial class InlineResponse2001 : IEquatable<InlineResponse2001>, IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name = "binding_method", EmitDefaultValue = false)]
        ...
        /// <param name="mfaToken">mfaToken.</param>
        public InlineResponse2001(ChallengeTypeEnum? challengeType = default(ChallengeTypeEnum?), BindingMethodEnum? bindingMethod = default(BindingMethodEnum?), string oobCode = default(string), string mfaToken = default(string))
        {
        ...
        /// </summary>
        [DataMember(Name = "oob_code", EmitDefaultValue = false)]
