...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    public partial class ErrorError : IEquatable<ErrorError>, IValidatableObject
    {
        ...
        public ErrorError(string code = default(string), List<Object> errors = default(List<Object>), string message = default(string))
        {
            // to ensure "message" is required (not null)
            this.Message = message ?? throw new ArgumentNullException("message is a required property for ErrorError and cannot be null");
            this.Code = code;
            this.Errors = errors;
        }
