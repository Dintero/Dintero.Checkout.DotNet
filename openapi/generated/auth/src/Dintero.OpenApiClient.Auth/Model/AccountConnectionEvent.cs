...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccountConnectionEvent")]
    public partial class AccountConnectionEvent : IEquatable<AccountConnectionEvent>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountConnectionEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountConnectionEvent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountConnectionEvent" /> class.
        /// </summary>
        /// <param name="status">status (required).</param>
        /// <param name="_event">_event (required).</param>
        /// <param name="description">short description about the event.</param>
        /// <param name="metadata">A set of key/values that you can attach to a connection event. .</param>
        public AccountConnectionEvent(StatusEnum status = default(StatusEnum), string _event = default(string), string description = default(string), Object metadata = default(Object))
        {
            this.Status = status;
            // to ensure "_event" is required (not null)
            this.Event = _event ?? throw new ArgumentNullException("_event is a required property for AccountConnectionEvent and cannot be null");
        ...
        /// </summary>
        /// <value>short description about the event</value>
        ...
        /// </summary>
        /// <value>A set of key/values that you can attach to a connection event. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountConnectionEvent {\n");
        ...
        {
            return this.Equals(input as AccountConnectionEvent);
        }

        /// <summary>
        /// Returns true if AccountConnectionEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountConnectionEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountConnectionEvent input)
        {
            if (input == null)
                return false;
