...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// GrantAllOf
    /// </summary>
    [DataContract(Name = "Grant_allOf")]
    public partial class GrantAllOf : IEquatable<GrantAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GrantAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GrantAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GrantAllOf" /> class.
        /// </summary>
        ...
        public GrantAllOf(string clientId = default(string), string audience = default(string), List<string> scope = default(List<string>), TypeEnum? type = TypeEnum.Any)
        {
            // to ensure "clientId" is required (not null)
            this.ClientId = clientId ?? throw new ArgumentNullException("clientId is a required property for GrantAllOf and cannot be null");
            // to ensure "audience" is required (not null)
            this.Audience = audience ?? throw new ArgumentNullException("audience is a required property for GrantAllOf and cannot be null");
            // to ensure "scope" is required (not null)
            this.Scope = scope ?? throw new ArgumentNullException("scope is a required property for GrantAllOf and cannot be null");
            this.Type = type;
        }
        ...
        {
            return this.Equals(input as GrantAllOf);
        }

        /// <summary>
        /// Returns true if GrantAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GrantAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GrantAllOf input)
        {
            if (input == null)
                return false;
