...
{
    /// <summary>
    /// AccountConnectionAllOfConfiguration
    /// </summary>
    [DataContract(Name = "AccountConnection_allOf_configuration")]
    public partial class AccountConnectionAllOfConfiguration : IEquatable<AccountConnectionAllOfConfiguration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountConnectionAllOfConfiguration" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountConnectionAllOfConfiguration() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountConnectionAllOfConfiguration" /> class.
        /// </summary>
        /// <param name="paymentOptions">Payment options supported by this connection  (required).</param>
        public AccountConnectionAllOfConfiguration(List<AccountConnectionAllOfConfigurationPaymentOptions> paymentOptions = default(List<AccountConnectionAllOfConfigurationPaymentOptions>))
        {
            // to ensure "paymentOptions" is required (not null)
            this.PaymentOptions = paymentOptions ?? throw new ArgumentNullException("paymentOptions is a required property for AccountConnectionAllOfConfiguration and cannot be null");
        }

        /// <summary>
        /// Payment options supported by this connection 
        /// </summary>
        /// <value>Payment options supported by this connection </value>
        [DataMember(Name = "payment_options", IsRequired = true, EmitDefaultValue = false)]
        public List<AccountConnectionAllOfConfigurationPaymentOptions> PaymentOptions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountConnectionAllOfConfiguration {\n");
        ...
        {
            return this.Equals(input as AccountConnectionAllOfConfiguration);
        }

        /// <summary>
        /// Returns true if AccountConnectionAllOfConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountConnectionAllOfConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountConnectionAllOfConfiguration input)
        {
            if (input == null)
                return false;
