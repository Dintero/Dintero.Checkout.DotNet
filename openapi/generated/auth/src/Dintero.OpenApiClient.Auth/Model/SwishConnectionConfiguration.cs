...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SwishConnectionConfiguration")]
    public partial class SwishConnectionConfiguration : IEquatable<SwishConnectionConfiguration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SwishConnectionConfiguration" /> class.
        /// </summary>
        /// <param name="swishNumber">The merchant&#39;s Swish number.</param>
        /// <param name="paymentOptions">Payment options to enable for this connection .</param>
        public SwishConnectionConfiguration(string swishNumber = default(string), List<SwishConnectionCallbackPaymentOptions> paymentOptions = default(List<SwishConnectionCallbackPaymentOptions>))
        {
        ...
        [DataMember(Name = "swish_number", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SwishConnectionConfiguration {\n");
        ...
        {
            return this.Equals(input as SwishConnectionConfiguration);
        }

        /// <summary>
        /// Returns true if SwishConnectionConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of SwishConnectionConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SwishConnectionConfiguration input)
        {
            if (input == null)
                return false;
