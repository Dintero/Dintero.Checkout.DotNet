...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// ClientAllOf
    /// </summary>
    [DataContract(Name = "Client_allOf")]
    public partial class ClientAllOf : IEquatable<ClientAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientAllOf" /> class.
        /// </summary>
        /// <param name="name">name.</param>
        /// <param name="description">description.</param>
        /// <param name="clientId">Your client ID..</param>
        /// <param name="callbacks">callbacks.</param>
        public ClientAllOf(string name = default(string), string description = default(string), string clientId = default(string), List<string> callbacks = default(List<string>))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as ClientAllOf);
        }

        /// <summary>
        /// Returns true if ClientAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientAllOf input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.Callbacks != null &&
                    input.Callbacks != null &&
                    this.Callbacks.SequenceEqual(input.Callbacks)
                );
        }
