...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CheckoutAccountService_allOf_gateways")]
    public partial class CheckoutAccountServiceAllOfGateways : IEquatable<CheckoutAccountServiceAllOfGateways>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckoutAccountServiceAllOfGateways" /> class.
        /// </summary>
        ...
        public CheckoutAccountServiceAllOfGateways(AccountCheckoutGateway santander = default(AccountCheckoutGateway), AccountCheckoutGateway collector = default(AccountCheckoutGateway), AccountCheckoutGateway instabank = default(AccountCheckoutGateway), AccountCheckoutGateway vipps = default(AccountCheckoutGateway), AccountCheckoutGateway swish = default(AccountCheckoutGateway), AccountCheckoutGateway bambora = default(AccountCheckoutGateway), CheckoutAccountServiceAllOfGatewaysPayex payex = default(CheckoutAccountServiceAllOfGatewaysPayex))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CheckoutAccountServiceAllOfGateways {\n");
        ...
        {
            return this.Equals(input as CheckoutAccountServiceAllOfGateways);
        }

        /// <summary>
        /// Returns true if CheckoutAccountServiceAllOfGateways instances are equal
        /// </summary>
        /// <param name="input">Instance of CheckoutAccountServiceAllOfGateways to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CheckoutAccountServiceAllOfGateways input)
        {
            if (input == null)
                return false;
