...
{
    /// <summary>
    /// CollectorConnectionConfigurationPaymentOptions
    /// </summary>
    [DataContract(Name = "CollectorConnectionConfiguration_payment_options")]
    public partial class CollectorConnectionConfigurationPaymentOptions : IEquatable<CollectorConnectionConfigurationPaymentOptions>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorConnectionConfigurationPaymentOptions" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorConnectionConfigurationPaymentOptions() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorConnectionConfigurationPaymentOptions" /> class.
        /// </summary>
        /// <param name="currencies">currencies (required).</param>
        /// <param name="type">type (required).</param>
        public CollectorConnectionConfigurationPaymentOptions(List<string> currencies = default(List<string>), TypeEnum type = default(TypeEnum))
        {
            // to ensure "currencies" is required (not null)
            this.Currencies = currencies ?? throw new ArgumentNullException("currencies is a required property for CollectorConnectionConfigurationPaymentOptions and cannot be null");
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorConnectionConfigurationPaymentOptions {\n");
        ...
        {
            return this.Equals(input as CollectorConnectionConfigurationPaymentOptions);
        }

        /// <summary>
        /// Returns true if CollectorConnectionConfigurationPaymentOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorConnectionConfigurationPaymentOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorConnectionConfigurationPaymentOptions input)
        {
            if (input == null)
                return false;
