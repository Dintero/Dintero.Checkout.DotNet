...
{
    /// <summary>
    /// SwishConnectionAllOf
    /// </summary>
    [DataContract(Name = "SwishConnection_allOf")]
    public partial class SwishConnectionAllOf : IEquatable<SwishConnectionAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SwishConnectionAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SwishConnectionAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SwishConnectionAllOf" /> class.
        /// </summary>
        /// <param name="configuration">configuration.</param>
        /// <param name="signup">signup (required).</param>
        public SwishConnectionAllOf(SwishConnectionConfiguration configuration = default(SwishConnectionConfiguration), SwishConnectionSignup signup = default(SwishConnectionSignup))
        {
            // to ensure "signup" is required (not null)
            this.Signup = signup ?? throw new ArgumentNullException("signup is a required property for SwishConnectionAllOf and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SwishConnectionAllOf {\n");
        ...
        {
            return this.Equals(input as SwishConnectionAllOf);
        }

        /// <summary>
        /// Returns true if SwishConnectionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SwishConnectionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SwishConnectionAllOf input)
        {
            if (input == null)
                return false;
