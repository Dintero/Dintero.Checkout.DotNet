...
{
    /// <summary>
    /// AccountCompanyBranding
    /// </summary>
    [DataContract(Name = "AccountCompany_branding")]
    public partial class AccountCompanyBranding : IEquatable<AccountCompanyBranding>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountCompanyBranding" /> class.
        /// </summary>
        ...
        /// <param name="logoUrl">Url to logo. Will be used in receipts, emails, etc. .</param>
        public AccountCompanyBranding(string iconUrl = default(string), string logoUrl = default(string))
        {
        ...
        /// </summary>
        /// <value>Url to logo. Will be used in receipts, emails, etc. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountCompanyBranding {\n");
        ...
        {
            return this.Equals(input as AccountCompanyBranding);
        }

        /// <summary>
        /// Returns true if AccountCompanyBranding instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountCompanyBranding to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountCompanyBranding input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if(this.LogoUrl != null && this.LogoUrl.Length > 240)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for LogoUrl, length must be less than 240.", new [] { "LogoUrl" });
            }
