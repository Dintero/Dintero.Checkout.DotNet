...
{
    /// <summary>
    /// AccountConnectionAllOf
    /// </summary>
    [DataContract(Name = "AccountConnection_allOf")]
    public partial class AccountConnectionAllOf : IEquatable<AccountConnectionAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountConnectionAllOf" /> class.
        /// </summary>
        /// <param name="configuration">configuration.</param>
        public AccountConnectionAllOf(AccountConnectionAllOfConfiguration configuration = default(AccountConnectionAllOfConfiguration))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountConnectionAllOf {\n");
        ...
        {
            return this.Equals(input as AccountConnectionAllOf);
        }

        /// <summary>
        /// Returns true if AccountConnectionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountConnectionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountConnectionAllOf input)
        {
            if (input == null)
                return false;
