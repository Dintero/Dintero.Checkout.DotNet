...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccountCheckoutGateway")]
    public partial class AccountCheckoutGateway : IEquatable<AccountCheckoutGateway>, IValidatableObject
    {
        /// <summary>
        /// Defines Progression
        /// </summary>
        ...
        public enum ProgressionEnum
        {
            ...
            /// <summary>
            /// Enum WaitingForDintero for value: waiting_for_dintero
            /// </summary>
            [EnumMember(Value = "waiting_for_dintero")]
            WaitingForDintero = 2,

            /// <summary>
            /// Enum WaitingForGateway for value: waiting_for_gateway
            /// </summary>
            [EnumMember(Value = "waiting_for_gateway")]
            WaitingForGateway = 3,

            /// <summary>
            /// Enum WaitingForMerchant for value: waiting_for_merchant
            /// </summary>
            [EnumMember(Value = "waiting_for_merchant")]
            WaitingForMerchant = 4,
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountCheckoutGateway" /> class.
        /// </summary>
        /// <param name="progression">progression.</param>
        public AccountCheckoutGateway(ProgressionEnum? progression = default(ProgressionEnum?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountCheckoutGateway {\n");
        ...
        {
            return this.Equals(input as AccountCheckoutGateway);
        }

        /// <summary>
        /// Returns true if AccountCheckoutGateway instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountCheckoutGateway to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountCheckoutGateway input)
        {
            if (input == null)
                return false;
