...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// AccountService
    /// </summary>
    [DataContract(Name = "AccountService")]
    public partial class AccountService : IEquatable<AccountService>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        public AccountService(StatusEnum? status = default(StatusEnum?), ProgressionEnum? progression = default(ProgressionEnum?), Object metadata = default(Object))
        {
            this.Status = status;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountService {\n");
        ...
        {
            return this.Equals(input as AccountService);
        }

        /// <summary>
        /// Returns true if AccountService instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountService to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountService input)
        {
            if (input == null)
                return false;
