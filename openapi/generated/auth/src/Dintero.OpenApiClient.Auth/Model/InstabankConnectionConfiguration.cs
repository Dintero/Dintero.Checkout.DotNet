...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InstabankConnectionConfiguration")]
    public partial class InstabankConnectionConfiguration : IEquatable<InstabankConnectionConfiguration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankConnectionConfiguration" /> class.
        /// </summary>
        /// <param name="paymentProductCodes">paymentProductCodes.</param>
        /// <param name="organizationNumber">organizationNumber.</param>
        /// <param name="paymentOptions">paymentOptions.</param>
        public InstabankConnectionConfiguration(InstabankConnectionConfigurationPaymentProductCodes paymentProductCodes = default(InstabankConnectionConfigurationPaymentProductCodes), string organizationNumber = default(string), List<InstabankConnectionConfigurationPaymentOptions> paymentOptions = default(List<InstabankConnectionConfigurationPaymentOptions>))
        {
            this.PaymentProductCodes = paymentProductCodes;
        ...
        /// </summary>
        [DataMember(Name = "payment_product_codes", EmitDefaultValue = false)]
        public InstabankConnectionConfigurationPaymentProductCodes PaymentProductCodes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstabankConnectionConfiguration {\n");
        ...
        {
            return this.Equals(input as InstabankConnectionConfiguration);
        }

        /// <summary>
        /// Returns true if InstabankConnectionConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of InstabankConnectionConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstabankConnectionConfiguration input)
        {
            if (input == null)
                return false;
