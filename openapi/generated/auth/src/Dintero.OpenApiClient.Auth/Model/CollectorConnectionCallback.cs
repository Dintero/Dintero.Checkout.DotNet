...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CollectorConnectionCallback")]
    public partial class CollectorConnectionCallback : IEquatable<CollectorConnectionCallback>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorConnectionCallback" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorConnectionCallback() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorConnectionCallback" /> class.
        /// </summary>
        ...
        public CollectorConnectionCallback(string username = default(string), string password = default(string), decimal storeId = default(decimal), string country = default(string), List<CollectorConnectionCallbackPaymentOptions> paymentOptions = default(List<CollectorConnectionCallbackPaymentOptions>))
        {
            // to ensure "username" is required (not null)
            this.Username = username ?? throw new ArgumentNullException("username is a required property for CollectorConnectionCallback and cannot be null");
            // to ensure "password" is required (not null)
            this.Password = password ?? throw new ArgumentNullException("password is a required property for CollectorConnectionCallback and cannot be null");
            this.StoreId = storeId;
            // to ensure "country" is required (not null)
            this.Country = country ?? throw new ArgumentNullException("country is a required property for CollectorConnectionCallback and cannot be null");
            // to ensure "paymentOptions" is required (not null)
            this.PaymentOptions = paymentOptions ?? throw new ArgumentNullException("paymentOptions is a required property for CollectorConnectionCallback and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorConnectionCallback {\n");
        ...
        {
            return this.Equals(input as CollectorConnectionCallback);
        }

        /// <summary>
        /// Returns true if CollectorConnectionCallback instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorConnectionCallback to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorConnectionCallback input)
        {
            if (input == null)
                return false;
