...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    public partial class InlineResponse2007 : IEquatable<InlineResponse2007>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="accountSignupPreFillRequest">accountSignupPreFillRequest.</param>
        /// <param name="emailAuthorizedUser">emailAuthorizedUser.</param>
        public InlineResponse2007(AccountSignupPreFillRequest accountSignupPreFillRequest = default(AccountSignupPreFillRequest), EmailAuthorizedUser emailAuthorizedUser = default(EmailAuthorizedUser))
        {
            this.AccountSignupPreFillRequest = accountSignupPreFillRequest;
            this.EmailAuthorizedUser = emailAuthorizedUser;
        }

        /// <summary>
        /// Gets or Sets AccountSignupPreFillRequest
        /// </summary>
        [DataMember(Name = "AccountSignupPreFillRequest", EmitDefaultValue = false)]
        public AccountSignupPreFillRequest AccountSignupPreFillRequest { get; set; }

        /// <summary>
        /// Gets or Sets EmailAuthorizedUser
        /// </summary>
        [DataMember(Name = "EmailAuthorizedUser", EmitDefaultValue = false)]
        public EmailAuthorizedUser EmailAuthorizedUser { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AccountSignupPreFillRequest: ").Append(AccountSignupPreFillRequest).Append("\n");
            sb.Append("  EmailAuthorizedUser: ").Append(EmailAuthorizedUser).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(InlineResponse2007 input)
        {
            ...
            return 
                (
                    this.AccountSignupPreFillRequest == input.AccountSignupPreFillRequest ||
                    (this.AccountSignupPreFillRequest != null &&
                    this.AccountSignupPreFillRequest.Equals(input.AccountSignupPreFillRequest))
                ) && 
                (
                    this.EmailAuthorizedUser == input.EmailAuthorizedUser ||
                    (this.EmailAuthorizedUser != null &&
                    this.EmailAuthorizedUser.Equals(input.EmailAuthorizedUser))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.AccountSignupPreFillRequest != null)
                    hashCode = hashCode * 59 + this.AccountSignupPreFillRequest.GetHashCode();
                if (this.EmailAuthorizedUser != null)
                    hashCode = hashCode * 59 + this.EmailAuthorizedUser.GetHashCode();
                return hashCode;
            }
        }
