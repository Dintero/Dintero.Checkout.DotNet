...
{
    /// <summary>
    /// CollectorConnectionCallbackPaymentOptions
    /// </summary>
    [DataContract(Name = "CollectorConnectionCallback_payment_options")]
    public partial class CollectorConnectionCallbackPaymentOptions : IEquatable<CollectorConnectionCallbackPaymentOptions>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorConnectionCallbackPaymentOptions" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorConnectionCallbackPaymentOptions() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorConnectionCallbackPaymentOptions" /> class.
        /// </summary>
        /// <param name="currencies">currencies (required).</param>
        /// <param name="type">type (required).</param>
        public CollectorConnectionCallbackPaymentOptions(List<string> currencies = default(List<string>), TypeEnum type = default(TypeEnum))
        {
            // to ensure "currencies" is required (not null)
            this.Currencies = currencies ?? throw new ArgumentNullException("currencies is a required property for CollectorConnectionCallbackPaymentOptions and cannot be null");
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorConnectionCallbackPaymentOptions {\n");
        ...
        {
            return this.Equals(input as CollectorConnectionCallbackPaymentOptions);
        }

        /// <summary>
        /// Returns true if CollectorConnectionCallbackPaymentOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorConnectionCallbackPaymentOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorConnectionCallbackPaymentOptions input)
        {
            if (input == null)
                return false;
