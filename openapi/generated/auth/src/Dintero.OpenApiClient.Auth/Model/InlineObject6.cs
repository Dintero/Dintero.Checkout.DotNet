...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    public partial class InlineObject6 : IEquatable<InlineObject6>, IValidatableObject
    {
        ...
        public InlineObject6(CommonConnectionSignup signup = default(CommonConnectionSignup))
        {
            // to ensure "signup" is required (not null)
            this.Signup = signup ?? throw new ArgumentNullException("signup is a required property for InlineObject6 and cannot be null");
        }
