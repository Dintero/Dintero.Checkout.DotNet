...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BamboraConnectionSignup_applicant")]
    public partial class BamboraConnectionSignupApplicant : IEquatable<BamboraConnectionSignupApplicant>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraConnectionSignupApplicant" /> class.
        /// </summary>
        /// <param name="phoneNumber">A phone number in E.164 number formatting. .</param>
        public BamboraConnectionSignupApplicant(string phoneNumber = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BamboraConnectionSignupApplicant {\n");
        ...
        {
            return this.Equals(input as BamboraConnectionSignupApplicant);
        }

        /// <summary>
        /// Returns true if BamboraConnectionSignupApplicant instances are equal
        /// </summary>
        /// <param name="input">Instance of BamboraConnectionSignupApplicant to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BamboraConnectionSignupApplicant input)
        {
            if (input == null)
                return false;
