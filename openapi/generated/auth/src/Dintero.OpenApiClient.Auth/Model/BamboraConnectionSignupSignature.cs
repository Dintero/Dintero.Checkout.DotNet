...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BamboraConnectionSignup_signature")]
    public partial class BamboraConnectionSignupSignature : IEquatable<BamboraConnectionSignupSignature>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraConnectionSignupSignature" /> class.
        /// </summary>
        /// <param name="signatures">signatures.</param>
        /// <param name="politicallyExposedPerson">If you or owner is a politically exposed person according to the money laundering act .</param>
        /// <param name="politicallyExposedAssociated">If you or owner is closesely associated with an politically exposed person according to the money laundering act .</param>
        public BamboraConnectionSignupSignature(List<BamboraConnectionSignupSignatureSignatures> signatures = default(List<BamboraConnectionSignupSignatureSignatures>), bool politicallyExposedPerson = default(bool), bool politicallyExposedAssociated = default(bool))
        {
            this.Signatures = signatures;
            this.PoliticallyExposedPerson = politicallyExposedPerson;
            this.PoliticallyExposedAssociated = politicallyExposedAssociated;
        }
        ...
        public List<BamboraConnectionSignupSignatureSignatures> Signatures { get; set; }

        /// <summary>
        /// If you or owner is a politically exposed person according to the money laundering act 
        /// </summary>
        /// <value>If you or owner is a politically exposed person according to the money laundering act </value>
        [DataMember(Name = "politically_exposed_person", EmitDefaultValue = true)]
        public bool PoliticallyExposedPerson { get; set; }

        /// <summary>
        /// If you or owner is closesely associated with an politically exposed person according to the money laundering act 
        /// </summary>
        /// <value>If you or owner is closesely associated with an politically exposed person according to the money laundering act </value>
        [DataMember(Name = "politically_exposed_associated", EmitDefaultValue = true)]
        public bool PoliticallyExposedAssociated { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BamboraConnectionSignupSignature {\n");
            sb.Append("  Signatures: ").Append(Signatures).Append("\n");
            sb.Append("  PoliticallyExposedPerson: ").Append(PoliticallyExposedPerson).Append("\n");
            sb.Append("  PoliticallyExposedAssociated: ").Append(PoliticallyExposedAssociated).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as BamboraConnectionSignupSignature);
        }

        /// <summary>
        /// Returns true if BamboraConnectionSignupSignature instances are equal
        /// </summary>
        /// <param name="input">Instance of BamboraConnectionSignupSignature to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BamboraConnectionSignupSignature input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PoliticallyExposedAssociated == input.PoliticallyExposedAssociated ||
                    this.PoliticallyExposedAssociated.Equals(input.PoliticallyExposedAssociated)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.PoliticallyExposedAssociated.GetHashCode();
                return hashCode;
            }
        }
