...
{
    /// <summary>
    /// VippsConnectionAllOf
    /// </summary>
    [DataContract(Name = "VippsConnection_allOf")]
    public partial class VippsConnectionAllOf : IEquatable<VippsConnectionAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VippsConnectionAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VippsConnectionAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VippsConnectionAllOf" /> class.
        /// </summary>
        /// <param name="signup">signup (required).</param>
        /// <param name="configuration">configuration.</param>
        public VippsConnectionAllOf(VippsConnectionAllOfSignup signup = default(VippsConnectionAllOfSignup), VippsConnectionAllOfConfiguration configuration = default(VippsConnectionAllOfConfiguration))
        {
            // to ensure "signup" is required (not null)
            this.Signup = signup ?? throw new ArgumentNullException("signup is a required property for VippsConnectionAllOf and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VippsConnectionAllOf {\n");
        ...
        {
            return this.Equals(input as VippsConnectionAllOf);
        }

        /// <summary>
        /// Returns true if VippsConnectionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of VippsConnectionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VippsConnectionAllOf input)
        {
            if (input == null)
                return false;
