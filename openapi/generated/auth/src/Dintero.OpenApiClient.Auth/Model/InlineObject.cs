...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    public partial class InlineObject : IEquatable<InlineObject>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="InlineObject" /> class.
        /// </summary>
        /// <param name="phoneNumber">mobile number of a person / company, ITU/E.123 format with international prefix (+PPNNNNNNNNN...)  **required** when enabling SMS MFA .</param>
        /// <param name="enabled">enabled (required).</param>
        public InlineObject(string phoneNumber = default(string), bool enabled = default(bool))
        {
        ...
        /// <summary>
        /// mobile number of a person / company, ITU/E.123 format with international prefix (+PPNNNNNNNNN...)  **required** when enabling SMS MFA 
        /// </summary>
        /// <value>mobile number of a person / company, ITU/E.123 format with international prefix (+PPNNNNNNNNN...)  **required** when enabling SMS MFA </value>
