...
{
    /// <summary>
    /// ClientCredentialsAllOf
    /// </summary>
    [DataContract(Name = "client_credentials_allOf")]
    public partial class ClientCredentialsAllOf : IEquatable<ClientCredentialsAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientCredentialsAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ClientCredentialsAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientCredentialsAllOf" /> class.
        /// </summary>
        ...
        public ClientCredentialsAllOf(string audience = default(string))
        {
            // to ensure "audience" is required (not null)
            this.Audience = audience ?? throw new ArgumentNullException("audience is a required property for ClientCredentialsAllOf and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClientCredentialsAllOf {\n");
        ...
        {
            return this.Equals(input as ClientCredentialsAllOf);
        }

        /// <summary>
        /// Returns true if ClientCredentialsAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientCredentialsAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientCredentialsAllOf input)
        {
            if (input == null)
                return false;
