...
{
    /// <summary>
    /// CommonConnectionSignupOwnership
    /// </summary>
    [DataContract(Name = "CommonConnectionSignup_ownership")]
    public partial class CommonConnectionSignupOwnership : IEquatable<CommonConnectionSignupOwnership>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonConnectionSignupOwnership" /> class.
        /// </summary>
        /// <param name="ownershipStructure">ownershipStructure.</param>
        /// <param name="owners">owners.</param>
        public CommonConnectionSignupOwnership(OwnershipStructureEnum? ownershipStructure = default(OwnershipStructureEnum?), List<CommonConnectionSignupOwnershipOwners> owners = default(List<CommonConnectionSignupOwnershipOwners>))
        {
        ...
        public List<CommonConnectionSignupOwnershipOwners> Owners { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CommonConnectionSignupOwnership {\n");
        ...
        {
            return this.Equals(input as CommonConnectionSignupOwnership);
        }

        /// <summary>
        /// Returns true if CommonConnectionSignupOwnership instances are equal
        /// </summary>
        /// <param name="input">Instance of CommonConnectionSignupOwnership to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommonConnectionSignupOwnership input)
        {
            if (input == null)
                return false;
