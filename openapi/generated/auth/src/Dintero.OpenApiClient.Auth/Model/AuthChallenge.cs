...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AuthChallenge")]
    public partial class AuthChallenge : IEquatable<AuthChallenge>, IValidatableObject
    {
        /// <summary>
        /// The challenge type accepted by your application 
        /// </summary>
        /// <value>The challenge type accepted by your application </value>
        ...
        /// </summary>
        /// <value>The channel to use for OOB. Can only be provided when &#x60;challenge_type&#x60; is oob. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum OobChannelEnum
        {
            /// <summary>
        ...
        /// </summary>
        /// <value>The channel to use for OOB. Can only be provided when &#x60;challenge_type&#x60; is oob. </value>
        [DataMember(Name = "oob_channel", EmitDefaultValue = false)]
        public OobChannelEnum? OobChannel { get; set; }
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="AuthChallenge" /> class.
        /// </summary>
        /// <param name="challengeType">The challenge type accepted by your application  (required).</param>
        /// <param name="oobChannel">The channel to use for OOB. Can only be provided when &#x60;challenge_type&#x60; is oob.  (default to OobChannelEnum.Sms).</param>
        /// <param name="mfaToken">The token received from &#x60;mfa_required&#x60; error.  (required).</param>
        public AuthChallenge(ChallengeTypeEnum challengeType = default(ChallengeTypeEnum), OobChannelEnum? oobChannel = OobChannelEnum.Sms, string mfaToken = default(string))
        {
            this.ChallengeType = challengeType;
            // to ensure "mfaToken" is required (not null)
            this.MfaToken = mfaToken ?? throw new ArgumentNullException("mfaToken is a required property for AuthChallenge and cannot be null");
        ...
        /// </summary>
        /// <value>The token received from &#x60;mfa_required&#x60; error. </value>
        ...
        {
            return this.Equals(input as AuthChallenge);
        }

        /// <summary>
        /// Returns true if AuthChallenge instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthChallenge to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthChallenge input)
        {
            if (input == null)
                return false;
