...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PayExConnectionConfiguration")]
    public partial class PayExConnectionConfiguration : IEquatable<PayExConnectionConfiguration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExConnectionConfiguration" /> class.
        /// </summary>
        /// <param name="payeeId">payeeId.</param>
        /// <param name="subsite">subsite.</param>
        /// <param name="paymentOptions">Payment options to enable for this connection .</param>
        public PayExConnectionConfiguration(string payeeId = default(string), string subsite = default(string), List<PayExConnectionCallbackPaymentOptions> paymentOptions = default(List<PayExConnectionCallbackPaymentOptions>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PayExConnectionConfiguration {\n");
        ...
        {
            return this.Equals(input as PayExConnectionConfiguration);
        }

        /// <summary>
        /// Returns true if PayExConnectionConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of PayExConnectionConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayExConnectionConfiguration input)
        {
            if (input == null)
                return false;
