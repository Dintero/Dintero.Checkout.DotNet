...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// AuthorizationCode
    /// </summary>
    [DataContract(Name = "authorization_code")]
    [JsonConverter(typeof(JsonSubtypes), "GrantType")]
    public partial class AuthorizationCode : AuthToken, IEquatable<AuthorizationCode>, IValidatableObject
    {
        /// <summary>
        /// Defines IdentType
        /// </summary>
        ...
        /// <param name="grantType">grantType (required) (default to &quot;authorization_code&quot;).</param>
        public AuthorizationCode(IdentTypeEnum identType = default(IdentTypeEnum), string ident = default(string), string verificationCode = default(string), string audience = default(string), string grantType = "authorization_code") : base(grantType)
        {
            this.IdentType = identType;
            // to ensure "ident" is required (not null)
            this.Ident = ident ?? throw new ArgumentNullException("ident is a required property for AuthorizationCode and cannot be null");
            // to ensure "verificationCode" is required (not null)
            this.VerificationCode = verificationCode ?? throw new ArgumentNullException("verificationCode is a required property for AuthorizationCode and cannot be null");
            // to ensure "audience" is required (not null)
            this.Audience = audience ?? throw new ArgumentNullException("audience is a required property for AuthorizationCode and cannot be null");
        }
