...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PayExConnectionSignup")]
    public partial class PayExConnectionSignup : IEquatable<PayExConnectionSignup>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExConnectionSignup" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayExConnectionSignup() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExConnectionSignup" /> class.
        /// </summary>
        /// <param name="businessName">Name of the merchant, if it differs from legal_name.</param>
        /// <param name="legalName">legalName.</param>
        /// <param name="organizationNumber">organizationNumber.</param>
        /// <param name="applicantContact">applicantContact.</param>
        /// <param name="accountingContact">accountingContact.</param>
        ...
        /// <param name="website">Company&#39;s website url.</param>
        /// <param name="paymentOptions">Payment options to enable for this connection  (required).</param>
        public PayExConnectionSignup(string businessName = default(string), string legalName = default(string), string organizationNumber = default(string), PayExConnectionSignupContact applicantContact = default(PayExConnectionSignupContact), PayExConnectionSignupContact accountingContact = default(PayExConnectionSignupContact), string bankName = default(string), string accountNumber = default(string), string website = default(string), List<PayExConnectionCallbackPaymentOptions> paymentOptions = default(List<PayExConnectionCallbackPaymentOptions>))
        {
            // to ensure "paymentOptions" is required (not null)
            this.PaymentOptions = paymentOptions ?? throw new ArgumentNullException("paymentOptions is a required property for PayExConnectionSignup and cannot be null");
        ...
        /// <summary>
        /// Name of the merchant, if it differs from legal_name
        /// </summary>
        /// <value>Name of the merchant, if it differs from legal_name</value>
        ...
        /// <summary>
        /// Gets or Sets ApplicantContact
        /// </summary>
        [DataMember(Name = "applicant_contact", EmitDefaultValue = false)]
        public PayExConnectionSignupContact ApplicantContact { get; set; }

        /// <summary>
        /// Gets or Sets AccountingContact
        /// </summary>
        [DataMember(Name = "accounting_contact", EmitDefaultValue = false)]
        public PayExConnectionSignupContact AccountingContact { get; set; }
        ...
        /// </summary>
        /// <value>Company&#39;s website url</value>
        ...
        public List<PayExConnectionCallbackPaymentOptions> PaymentOptions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PayExConnectionSignup {\n");
            sb.Append("  BusinessName: ").Append(BusinessName).Append("\n");
            sb.Append("  LegalName: ").Append(LegalName).Append("\n");
            sb.Append("  OrganizationNumber: ").Append(OrganizationNumber).Append("\n");
            sb.Append("  ApplicantContact: ").Append(ApplicantContact).Append("\n");
            sb.Append("  AccountingContact: ").Append(AccountingContact).Append("\n");
        ...
        {
            return this.Equals(input as PayExConnectionSignup);
        }

        /// <summary>
        /// Returns true if PayExConnectionSignup instances are equal
        /// </summary>
        /// <param name="input">Instance of PayExConnectionSignup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayExConnectionSignup input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ApplicantContact == input.ApplicantContact ||
                    (this.ApplicantContact != null &&
                    this.ApplicantContact.Equals(input.ApplicantContact))
                ) && 
                (
                    this.AccountingContact == input.AccountingContact ||
                    (this.AccountingContact != null &&
                    this.AccountingContact.Equals(input.AccountingContact))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ApplicantContact != null)
                    hashCode = hashCode * 59 + this.ApplicantContact.GetHashCode();
                if (this.AccountingContact != null)
                    hashCode = hashCode * 59 + this.AccountingContact.GetHashCode();
