...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BamboraConnectionConfiguration")]
    public partial class BamboraConnectionConfiguration : IEquatable<BamboraConnectionConfiguration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraConnectionConfiguration" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BamboraConnectionConfiguration() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraConnectionConfiguration" /> class.
        /// </summary>
        ...
        public BamboraConnectionConfiguration(string merchantNumber = default(string), string md5Key = default(string), decimal accessToken = default(decimal), string secretToken = default(string))
        {
            // to ensure "merchantNumber" is required (not null)
            this.MerchantNumber = merchantNumber ?? throw new ArgumentNullException("merchantNumber is a required property for BamboraConnectionConfiguration and cannot be null");
            // to ensure "md5Key" is required (not null)
            this.Md5Key = md5Key ?? throw new ArgumentNullException("md5Key is a required property for BamboraConnectionConfiguration and cannot be null");
        ...
        public decimal AccessToken { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BamboraConnectionConfiguration {\n");
        ...
        {
            return this.Equals(input as BamboraConnectionConfiguration);
        }

        /// <summary>
        /// Returns true if BamboraConnectionConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of BamboraConnectionConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BamboraConnectionConfiguration input)
        {
            if (input == null)
                return false;
