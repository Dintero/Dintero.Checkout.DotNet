...
{
    /// <summary>
    /// CommonConnectionSignupOwnershipOwners
    /// </summary>
    [DataContract(Name = "CommonConnectionSignup_ownership_owners")]
    public partial class CommonConnectionSignupOwnershipOwners : IEquatable<CommonConnectionSignupOwnershipOwners>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonConnectionSignupOwnershipOwners" /> class.
        /// </summary>
        /// <param name="name">Name of owner, or representative of the company owning shares..</param>
        /// <param name="legalName">Name of company. Required if the owner is a company..</param>
        /// <param name="dateOfBirth">Date of birth of the signee..</param>
        /// <param name="percentage">Ownership percentage.</param>
        /// <param name="address">address.</param>
        public CommonConnectionSignupOwnershipOwners(string name = default(string), string legalName = default(string), string dateOfBirth = default(string), decimal percentage = default(decimal), Address address = default(Address))
        {
            this.Name = name;
        ...
        /// <summary>
        /// Name of owner, or representative of the company owning shares.
        /// </summary>
        /// <value>Name of owner, or representative of the company owning shares.</value>
        [DataMember(Name = "name", EmitDefaultValue = false)]
        public string Name { get; set; }

        /// <summary>
        /// Name of company. Required if the owner is a company.
        /// </summary>
        /// <value>Name of company. Required if the owner is a company.</value>
        [DataMember(Name = "legal_name", EmitDefaultValue = false)]
        public string LegalName { get; set; }

        /// <summary>
        /// Date of birth of the signee.
        /// </summary>
        /// <value>Date of birth of the signee.</value>
        ...
        /// </summary>
        /// <value>Ownership percentage</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CommonConnectionSignupOwnershipOwners {\n");
        ...
        {
            return this.Equals(input as CommonConnectionSignupOwnershipOwners);
        }

        /// <summary>
        /// Returns true if CommonConnectionSignupOwnershipOwners instances are equal
        /// </summary>
        /// <param name="input">Instance of CommonConnectionSignupOwnershipOwners to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommonConnectionSignupOwnershipOwners input)
        {
            if (input == null)
                return false;
