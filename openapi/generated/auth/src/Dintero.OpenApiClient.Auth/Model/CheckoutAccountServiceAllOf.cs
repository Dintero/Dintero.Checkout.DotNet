...
{
    /// <summary>
    /// CheckoutAccountServiceAllOf
    /// </summary>
    [DataContract(Name = "CheckoutAccountService_allOf")]
    public partial class CheckoutAccountServiceAllOf : IEquatable<CheckoutAccountServiceAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckoutAccountServiceAllOf" /> class.
        /// </summary>
        /// <param name="gateways">gateways.</param>
        public CheckoutAccountServiceAllOf(CheckoutAccountServiceAllOfGateways gateways = default(CheckoutAccountServiceAllOfGateways))
        {
        ...
        public CheckoutAccountServiceAllOfGateways Gateways { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CheckoutAccountServiceAllOf {\n");
        ...
        {
            return this.Equals(input as CheckoutAccountServiceAllOf);
        }

        /// <summary>
        /// Returns true if CheckoutAccountServiceAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CheckoutAccountServiceAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CheckoutAccountServiceAllOf input)
        {
            if (input == null)
                return false;
