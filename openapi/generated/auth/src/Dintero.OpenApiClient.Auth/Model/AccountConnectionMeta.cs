...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccountConnectionMeta")]
    public partial class AccountConnectionMeta : IEquatable<AccountConnectionMeta>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountConnectionMeta" /> class.
        /// </summary>
        ...
        public AccountConnectionMeta(Object metadata = default(Object), StatusEnum? status = default(StatusEnum?), List<AccountConnectionEvent> events = default(List<AccountConnectionEvent>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountConnectionMeta {\n");
        ...
        {
            return this.Equals(input as AccountConnectionMeta);
        }

        /// <summary>
        /// Returns true if AccountConnectionMeta instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountConnectionMeta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountConnectionMeta input)
        {
            if (input == null)
                return false;
