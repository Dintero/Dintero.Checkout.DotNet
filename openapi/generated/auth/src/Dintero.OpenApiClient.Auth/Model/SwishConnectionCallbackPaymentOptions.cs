...
{
    /// <summary>
    /// SwishConnectionCallbackPaymentOptions
    /// </summary>
    [DataContract(Name = "SwishConnectionCallback_payment_options")]
    public partial class SwishConnectionCallbackPaymentOptions : IEquatable<SwishConnectionCallbackPaymentOptions>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SwishConnectionCallbackPaymentOptions" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SwishConnectionCallbackPaymentOptions() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SwishConnectionCallbackPaymentOptions" /> class.
        /// </summary>
        /// <param name="currencies">currencies (required).</param>
        /// <param name="type">type (required).</param>
        public SwishConnectionCallbackPaymentOptions(List<string> currencies = default(List<string>), TypeEnum type = default(TypeEnum))
        {
            // to ensure "currencies" is required (not null)
            this.Currencies = currencies ?? throw new ArgumentNullException("currencies is a required property for SwishConnectionCallbackPaymentOptions and cannot be null");
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SwishConnectionCallbackPaymentOptions {\n");
        ...
        {
            return this.Equals(input as SwishConnectionCallbackPaymentOptions);
        }

        /// <summary>
        /// Returns true if SwishConnectionCallbackPaymentOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of SwishConnectionCallbackPaymentOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SwishConnectionCallbackPaymentOptions input)
        {
            if (input == null)
                return false;
