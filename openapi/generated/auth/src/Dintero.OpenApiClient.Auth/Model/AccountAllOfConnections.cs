...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Account_allOf_connections")]
    public partial class AccountAllOfConnections : IEquatable<AccountAllOfConnections>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountAllOfConnections" /> class.
        /// </summary>
        ...
        public AccountAllOfConnections(InstabankConnection instabank = default(InstabankConnection), VippsConnection vipps = default(VippsConnection), AccountAllOfConnectionsPayex payex = default(AccountAllOfConnectionsPayex), CollectorConnection collector = default(CollectorConnection), SwishConnection swish = default(SwishConnection), BamboraConnection bambora = default(BamboraConnection), CommonConnection common = default(CommonConnection))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountAllOfConnections {\n");
        ...
        {
            return this.Equals(input as AccountAllOfConnections);
        }

        /// <summary>
        /// Returns true if AccountAllOfConnections instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountAllOfConnections to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountAllOfConnections input)
        {
            if (input == null)
                return false;
