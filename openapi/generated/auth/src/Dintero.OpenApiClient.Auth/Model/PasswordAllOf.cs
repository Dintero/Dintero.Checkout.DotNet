...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// PasswordAllOf
    /// </summary>
    [DataContract(Name = "password_allOf")]
    public partial class PasswordAllOf : IEquatable<PasswordAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PasswordAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PasswordAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PasswordAllOf" /> class.
        /// </summary>
        /// <param name="username">The end user&#39;s identifier.  (required).</param>
        /// <param name="password">The end user&#39;s password.  (required).</param>
        ...
        public PasswordAllOf(string username = default(string), string password = default(string), string audience = default(string))
        {
            // to ensure "username" is required (not null)
            this.Username = username ?? throw new ArgumentNullException("username is a required property for PasswordAllOf and cannot be null");
            // to ensure "password" is required (not null)
            this.Password = password ?? throw new ArgumentNullException("password is a required property for PasswordAllOf and cannot be null");
            // to ensure "audience" is required (not null)
            this.Audience = audience ?? throw new ArgumentNullException("audience is a required property for PasswordAllOf and cannot be null");
        }

        /// <summary>
        /// The end user&#39;s identifier. 
        /// </summary>
        /// <value>The end user&#39;s identifier. </value>
        ...
        /// </summary>
        /// <value>The end user&#39;s password. </value>
        ...
        {
            return this.Equals(input as PasswordAllOf);
        }

        /// <summary>
        /// Returns true if PasswordAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PasswordAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PasswordAllOf input)
        {
            if (input == null)
                return false;
