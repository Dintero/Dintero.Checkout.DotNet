...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// RefreshTokenAllOf
    /// </summary>
    [DataContract(Name = "refresh_token_allOf")]
    public partial class RefreshTokenAllOf : IEquatable<RefreshTokenAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RefreshTokenAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RefreshTokenAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RefreshTokenAllOf" /> class.
        /// </summary>
        /// <param name="refreshToken">The Refresh Token to use.  (required).</param>
        public RefreshTokenAllOf(string refreshToken = default(string))
        {
            // to ensure "refreshToken" is required (not null)
            this.RefreshToken = refreshToken ?? throw new ArgumentNullException("refreshToken is a required property for RefreshTokenAllOf and cannot be null");
        }

        /// <summary>
        /// The Refresh Token to use. 
        /// </summary>
        /// <value>The Refresh Token to use. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RefreshTokenAllOf {\n");
        ...
        {
            return this.Equals(input as RefreshTokenAllOf);
        }

        /// <summary>
        /// Returns true if RefreshTokenAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of RefreshTokenAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RefreshTokenAllOf input)
        {
            if (input == null)
                return false;
