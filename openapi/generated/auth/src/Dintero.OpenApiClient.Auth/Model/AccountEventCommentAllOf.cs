...
{
    /// <summary>
    /// AccountEventCommentAllOf
    /// </summary>
    [DataContract(Name = "AccountEventComment_allOf")]
    public partial class AccountEventCommentAllOf : IEquatable<AccountEventCommentAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountEventCommentAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountEventCommentAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountEventCommentAllOf" /> class.
        /// </summary>
        ...
        public AccountEventCommentAllOf(EventTypeEnum eventType = default(EventTypeEnum), string body = default(string), VisibilityEnum visibility = default(VisibilityEnum))
        {
            this.EventType = eventType;
            // to ensure "body" is required (not null)
            this.Body = body ?? throw new ArgumentNullException("body is a required property for AccountEventCommentAllOf and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountEventCommentAllOf {\n");
        ...
        {
            return this.Equals(input as AccountEventCommentAllOf);
        }

        /// <summary>
        /// Returns true if AccountEventCommentAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountEventCommentAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountEventCommentAllOf input)
        {
            if (input == null)
                return false;
