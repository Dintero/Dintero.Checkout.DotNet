...
{
    /// <summary>
    /// PayExConnectionAllOf
    /// </summary>
    [DataContract(Name = "PayExConnection_allOf")]
    public partial class PayExConnectionAllOf : IEquatable<PayExConnectionAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExConnectionAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayExConnectionAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExConnectionAllOf" /> class.
        /// </summary>
        /// <param name="configuration">configuration.</param>
        /// <param name="signup">signup (required).</param>
        public PayExConnectionAllOf(PayExConnectionConfiguration configuration = default(PayExConnectionConfiguration), PayExConnectionSignup signup = default(PayExConnectionSignup))
        {
            // to ensure "signup" is required (not null)
            this.Signup = signup ?? throw new ArgumentNullException("signup is a required property for PayExConnectionAllOf and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PayExConnectionAllOf {\n");
        ...
        {
            return this.Equals(input as PayExConnectionAllOf);
        }

        /// <summary>
        /// Returns true if PayExConnectionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PayExConnectionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayExConnectionAllOf input)
        {
            if (input == null)
                return false;
