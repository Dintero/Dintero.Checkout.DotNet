...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// AccountApplicant
    /// </summary>
    [DataContract(Name = "AccountApplicant")]
    public partial class AccountApplicant : IEquatable<AccountApplicant>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountApplicant" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountApplicant() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountApplicant" /> class.
        /// </summary>
        ...
        /// <param name="phoneNumber">A phone number in E.164 number formatting. .</param>
        /// <param name="agreement">agreement (required).</param>
        /// <param name="recaptchaSitekey">The public site key used for reCAPTCHA .</param>
        /// <param name="recaptchaResponse">A response from a reCAPTCHA check .</param>
        /// <param name="promoCode">Promotion code.</param>
        /// <param name="utm">utm.</param>
        public AccountApplicant(string firstName = default(string), string lastName = default(string), string email = default(string), string phoneNumber = default(string), AccountApplicantAgreement agreement = default(AccountApplicantAgreement), string recaptchaSitekey = default(string), string recaptchaResponse = default(string), string promoCode = default(string), UtmCampaign utm = default(UtmCampaign))
        {
            // to ensure "email" is required (not null)
            this.Email = email ?? throw new ArgumentNullException("email is a required property for AccountApplicant and cannot be null");
            // to ensure "agreement" is required (not null)
            this.Agreement = agreement ?? throw new ArgumentNullException("agreement is a required property for AccountApplicant and cannot be null");
        ...
        /// </summary>
        [DataMember(Name = "agreement", IsRequired = true, EmitDefaultValue = false)]
        public AccountApplicantAgreement Agreement { get; set; }

        /// <summary>
        /// The public site key used for reCAPTCHA 
        /// </summary>
        /// <value>The public site key used for reCAPTCHA </value>
        [DataMember(Name = "recaptcha_sitekey", EmitDefaultValue = false)]
        public string RecaptchaSitekey { get; set; }

        /// <summary>
        /// A response from a reCAPTCHA check 
        /// </summary>
        /// <value>A response from a reCAPTCHA check </value>
        [DataMember(Name = "recaptcha_response", EmitDefaultValue = false)]
        ...
        public UtmCampaign Utm { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountApplicant {\n");
            sb.Append("  FirstName: ").Append(FirstName).Append("\n");
            sb.Append("  LastName: ").Append(LastName).Append("\n");
            sb.Append("  Email: ").Append(Email).Append("\n");
            sb.Append("  PhoneNumber: ").Append(PhoneNumber).Append("\n");
            sb.Append("  Agreement: ").Append(Agreement).Append("\n");
            sb.Append("  RecaptchaSitekey: ").Append(RecaptchaSitekey).Append("\n");
        ...
        {
            return this.Equals(input as AccountApplicant);
        }

        /// <summary>
        /// Returns true if AccountApplicant instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountApplicant to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountApplicant input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.RecaptchaSitekey == input.RecaptchaSitekey ||
                    (this.RecaptchaSitekey != null &&
                    this.RecaptchaSitekey.Equals(input.RecaptchaSitekey))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RecaptchaSitekey != null)
                    hashCode = hashCode * 59 + this.RecaptchaSitekey.GetHashCode();
