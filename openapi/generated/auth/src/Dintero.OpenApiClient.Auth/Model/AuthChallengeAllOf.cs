...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// AuthChallengeAllOf
    /// </summary>
    [DataContract(Name = "AuthChallenge_allOf")]
    public partial class AuthChallengeAllOf : IEquatable<AuthChallengeAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthChallengeAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuthChallengeAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthChallengeAllOf" /> class.
        /// </summary>
        /// <param name="mfaToken">The token received from &#x60;mfa_required&#x60; error.  (required).</param>
        public AuthChallengeAllOf(string mfaToken = default(string))
        {
            // to ensure "mfaToken" is required (not null)
            this.MfaToken = mfaToken ?? throw new ArgumentNullException("mfaToken is a required property for AuthChallengeAllOf and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthChallengeAllOf {\n");
        ...
        {
            return this.Equals(input as AuthChallengeAllOf);
        }

        /// <summary>
        /// Returns true if AuthChallengeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthChallengeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthChallengeAllOf input)
        {
            if (input == null)
                return false;
