...
{
    /// <summary>
    /// AccountPrivateDetailsStatistics
    /// </summary>
    [DataContract(Name = "AccountPrivateDetails_statistics")]
    public partial class AccountPrivateDetailsStatistics : IEquatable<AccountPrivateDetailsStatistics>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountPrivateDetailsStatistics" /> class.
        /// </summary>
        /// <param name="latest">latest.</param>
        public AccountPrivateDetailsStatistics(AccountMonthlyStatistics latest = default(AccountMonthlyStatistics))
        {
            this.Latest = latest;
        }
        ...
        public AccountMonthlyStatistics Latest { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountPrivateDetailsStatistics {\n");
        ...
        {
            return this.Equals(input as AccountPrivateDetailsStatistics);
        }

        /// <summary>
        /// Returns true if AccountPrivateDetailsStatistics instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountPrivateDetailsStatistics to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountPrivateDetailsStatistics input)
        {
            if (input == null)
                return false;
