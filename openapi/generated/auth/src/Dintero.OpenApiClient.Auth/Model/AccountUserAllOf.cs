...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// AccountUserAllOf
    /// </summary>
    [DataContract(Name = "AccountUser_allOf")]
    public partial class AccountUserAllOf : IEquatable<AccountUserAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountUserAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountUserAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountUserAllOf" /> class.
        /// </summary>
        ...
        public AccountUserAllOf(string email = default(string), string name = default(string), List<string> scope = default(List<string>))
        {
            // to ensure "email" is required (not null)
            this.Email = email ?? throw new ArgumentNullException("email is a required property for AccountUserAllOf and cannot be null");
            this.Name = name;
            this.Scope = scope;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountUserAllOf {\n");
        ...
        {
            return this.Equals(input as AccountUserAllOf);
        }

        /// <summary>
        /// Returns true if AccountUserAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountUserAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountUserAllOf input)
        {
            if (input == null)
                return false;
