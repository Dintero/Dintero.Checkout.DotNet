...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccountSignupPreFillRequest")]
    public partial class AccountSignupPreFillRequest : IEquatable<AccountSignupPreFillRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountSignupPreFillRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountSignupPreFillRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountSignupPreFillRequest" /> class.
        /// </summary>
        /// <param name="prefillId">Auto-generated id.</param>
        ...
        public AccountSignupPreFillRequest(string prefillId = default(string), AccountApplicant applicant = default(AccountApplicant), AccountCompany company = default(AccountCompany), AccountBilling billing = default(AccountBilling), AccountPrivateDetailsAccountManager accountManager = default(AccountPrivateDetailsAccountManager))
        {
            // to ensure "applicant" is required (not null)
            this.Applicant = applicant ?? throw new ArgumentNullException("applicant is a required property for AccountSignupPreFillRequest and cannot be null");
            // to ensure "company" is required (not null)
            this.Company = company ?? throw new ArgumentNullException("company is a required property for AccountSignupPreFillRequest and cannot be null");
            // to ensure "billing" is required (not null)
            this.Billing = billing ?? throw new ArgumentNullException("billing is a required property for AccountSignupPreFillRequest and cannot be null");
        ...
        [DataMember(Name = "prefill_id", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountSignupPreFillRequest {\n");
            sb.Append("  PrefillId: ").Append(PrefillId).Append("\n");
        ...
        {
            return this.Equals(input as AccountSignupPreFillRequest);
        }

        /// <summary>
        /// Returns true if AccountSignupPreFillRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountSignupPreFillRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountSignupPreFillRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.PrefillId == input.PrefillId ||
                    (this.PrefillId != null &&
                    this.PrefillId.Equals(input.PrefillId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PrefillId != null)
                    hashCode = hashCode * 59 + this.PrefillId.GetHashCode();
