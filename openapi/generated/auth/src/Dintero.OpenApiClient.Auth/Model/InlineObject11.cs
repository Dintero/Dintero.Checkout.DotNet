...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    public partial class InlineObject11 : IEquatable<InlineObject11>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Specify optional claims to include in the ID token </value>
        [DataMember(Name = "claims", EmitDefaultValue = false)]
        public List<ClaimsEnum> Claims { get; set; }
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="InlineObject11" /> class.
        /// </summary>
        /// <param name="redirectUri">The HTTP URL to redirect to  (required).</param>
        /// <param name="customClaims">Include custom claims to the ID token. Custom claims will be prefixed by &#x60;ext_&#x60;. .</param>
        /// <param name="claims">Specify optional claims to include in the ID token .</param>
        public InlineObject11(Object redirectUri = default(Object), Dictionary<string, string> customClaims = default(Dictionary<string, string>), List<ClaimsEnum> claims = default(List<ClaimsEnum>))
        {
            // to ensure "redirectUri" is required (not null)
            this.RedirectUri = redirectUri ?? throw new ArgumentNullException("redirectUri is a required property for InlineObject11 and cannot be null");
        ...
        /// </summary>
        /// <value>The HTTP URL to redirect to </value>
        ...
        /// </summary>
        /// <value>Include custom claims to the ID token. Custom claims will be prefixed by &#x60;ext_&#x60;. </value>
        [DataMember(Name = "custom_claims", EmitDefaultValue = false)]
