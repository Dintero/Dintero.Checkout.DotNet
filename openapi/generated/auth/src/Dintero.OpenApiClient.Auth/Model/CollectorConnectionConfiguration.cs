...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CollectorConnectionConfiguration")]
    public partial class CollectorConnectionConfiguration : IEquatable<CollectorConnectionConfiguration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorConnectionConfiguration" /> class.
        /// </summary>
        /// <param name="username">username.</param>
        /// <param name="storeId">storeId.</param>
        /// <param name="country">country.</param>
        /// <param name="paymentOptions">Payment options to enable for this connection .</param>
        public CollectorConnectionConfiguration(string username = default(string), decimal storeId = default(decimal), string country = default(string), List<CollectorConnectionConfigurationPaymentOptions> paymentOptions = default(List<CollectorConnectionConfigurationPaymentOptions>))
        {
        ...
        public List<CollectorConnectionConfigurationPaymentOptions> PaymentOptions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorConnectionConfiguration {\n");
        ...
        {
            return this.Equals(input as CollectorConnectionConfiguration);
        }

        /// <summary>
        /// Returns true if CollectorConnectionConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorConnectionConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorConnectionConfiguration input)
        {
            if (input == null)
                return false;
