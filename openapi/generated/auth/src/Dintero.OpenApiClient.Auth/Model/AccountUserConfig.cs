...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccountUserConfig")]
    public partial class AccountUserConfig : IEquatable<AccountUserConfig>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountUserConfig" /> class.
        /// </summary>
        /// <param name="mfa">mfa.</param>
        public AccountUserConfig(AccountUserConfigMfa mfa = default(AccountUserConfigMfa))
        {
            this.Mfa = mfa;
        }
        ...
        public AccountUserConfigMfa Mfa { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountUserConfig {\n");
        ...
        {
            return this.Equals(input as AccountUserConfig);
        }

        /// <summary>
        /// Returns true if AccountUserConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountUserConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountUserConfig input)
        {
            if (input == null)
                return false;
