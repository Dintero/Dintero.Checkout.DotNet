...
{
    /// <summary>
    /// AccountSignupRequestExternalIntegrationsWallmobSignup
    /// </summary>
    [DataContract(Name = "AccountSignupRequest_external_integrations_wallmob_signup")]
    public partial class AccountSignupRequestExternalIntegrationsWallmobSignup : IEquatable<AccountSignupRequestExternalIntegrationsWallmobSignup>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember(Name = "merchant_type", IsRequired = true, EmitDefaultValue = false)]
        public MerchantTypeEnum MerchantType { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountSignupRequestExternalIntegrationsWallmobSignup" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountSignupRequestExternalIntegrationsWallmobSignup() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountSignupRequestExternalIntegrationsWallmobSignup" /> class.
        /// </summary>
        /// <param name="merchantType">merchantType (required).</param>
        /// <param name="password">password (required).</param>
        public AccountSignupRequestExternalIntegrationsWallmobSignup(MerchantTypeEnum merchantType = default(MerchantTypeEnum), string password = default(string))
        {
            this.MerchantType = merchantType;
            // to ensure "password" is required (not null)
            this.Password = password ?? throw new ArgumentNullException("password is a required property for AccountSignupRequestExternalIntegrationsWallmobSignup and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountSignupRequestExternalIntegrationsWallmobSignup {\n");
        ...
        {
            return this.Equals(input as AccountSignupRequestExternalIntegrationsWallmobSignup);
        }

        /// <summary>
        /// Returns true if AccountSignupRequestExternalIntegrationsWallmobSignup instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountSignupRequestExternalIntegrationsWallmobSignup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountSignupRequestExternalIntegrationsWallmobSignup input)
        {
            if (input == null)
                return false;
