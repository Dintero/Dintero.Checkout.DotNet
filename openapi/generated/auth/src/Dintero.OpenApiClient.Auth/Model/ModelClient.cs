...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    public partial class ModelClient : IEquatable<ModelClient>, IValidatableObject
    {
        ...
        public ModelClient(string name = default(string), string description = default(string), string clientId = default(string), List<string> callbacks = default(List<string>))
        {
            this.Name = name;
