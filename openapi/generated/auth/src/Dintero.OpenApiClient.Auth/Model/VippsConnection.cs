...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// VippsConnection
    /// </summary>
    [DataContract(Name = "VippsConnection")]
    public partial class VippsConnection : IEquatable<VippsConnection>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VippsConnection" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VippsConnection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VippsConnection" /> class.
        /// </summary>
        ...
        public VippsConnection(Object metadata = default(Object), StatusEnum? status = default(StatusEnum?), List<AccountConnectionEvent> events = default(List<AccountConnectionEvent>), VippsConnectionAllOfConfiguration configuration = default(VippsConnectionAllOfConfiguration), VippsConnectionAllOfSignup signup = default(VippsConnectionAllOfSignup))
        {
            // to ensure "signup" is required (not null)
            this.Signup = signup ?? throw new ArgumentNullException("signup is a required property for VippsConnection and cannot be null");
        ...
        public VippsConnectionAllOfConfiguration Configuration { get; set; }

        /// <summary>
        /// Gets or Sets Signup
        /// </summary>
        [DataMember(Name = "signup", IsRequired = true, EmitDefaultValue = false)]
        public VippsConnectionAllOfSignup Signup { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VippsConnection {\n");
        ...
        {
            return this.Equals(input as VippsConnection);
        }

        /// <summary>
        /// Returns true if VippsConnection instances are equal
        /// </summary>
        /// <param name="input">Instance of VippsConnection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VippsConnection input)
        {
            if (input == null)
                return false;
