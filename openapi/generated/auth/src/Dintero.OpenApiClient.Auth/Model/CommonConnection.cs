...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// CommonConnection
    /// </summary>
    [DataContract(Name = "CommonConnection")]
    public partial class CommonConnection : IEquatable<CommonConnection>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonConnection" /> class.
        /// </summary>
        ...
        public CommonConnection(Object metadata = default(Object), StatusEnum? status = default(StatusEnum?), List<AccountConnectionEvent> events = default(List<AccountConnectionEvent>), CommonConnectionSignup signup = default(CommonConnectionSignup))
        {
            // to ensure "signup" is required (not null)
            this.Signup = signup ?? throw new ArgumentNullException("signup is a required property for CommonConnection and cannot be null");
        ...
        public CommonConnectionSignup Signup { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CommonConnection {\n");
        ...
        {
            return this.Equals(input as CommonConnection);
        }

        /// <summary>
        /// Returns true if CommonConnection instances are equal
        /// </summary>
        /// <param name="input">Instance of CommonConnection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommonConnection input)
        {
            if (input == null)
                return false;
