...
{
    /// <summary>
    /// BamboraConnectionSignupOwnership
    /// </summary>
    [DataContract(Name = "BamboraConnectionSignup_ownership")]
    public partial class BamboraConnectionSignupOwnership : IEquatable<BamboraConnectionSignupOwnership>, IValidatableObject
    {
        /// <summary>
        /// Defines OwnershipStructure
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum OwnershipStructureEnum
        {
            /// <summary>
            /// Enum OwnersWithMoreThan25 for value: owners_with_more_than_25
            /// </summary>
            [EnumMember(Value = "owners_with_more_than_25")]
            OwnersWithMoreThan25 = 1,

            /// <summary>
            /// Enum NoOwnersWithMoreThan25 for value: no_owners_with_more_than_25
            /// </summary>
            [EnumMember(Value = "no_owners_with_more_than_25")]
            NoOwnersWithMoreThan25 = 2,
        ...
        /// <summary>
        /// Gets or Sets OwnershipStructure
        /// </summary>
        [DataMember(Name = "ownership_structure", EmitDefaultValue = false)]
        public OwnershipStructureEnum? OwnershipStructure { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraConnectionSignupOwnership" /> class.
        /// </summary>
        /// <param name="ownershipStructure">ownershipStructure.</param>
        /// <param name="owners">owners.</param>
        public BamboraConnectionSignupOwnership(OwnershipStructureEnum? ownershipStructure = default(OwnershipStructureEnum?), List<BamboraConnectionSignupOwnershipOwners> owners = default(List<BamboraConnectionSignupOwnershipOwners>))
        {
        ...
        public List<BamboraConnectionSignupOwnershipOwners> Owners { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BamboraConnectionSignupOwnership {\n");
            sb.Append("  OwnershipStructure: ").Append(OwnershipStructure).Append("\n");
        ...
        {
            return this.Equals(input as BamboraConnectionSignupOwnership);
        }

        /// <summary>
        /// Returns true if BamboraConnectionSignupOwnership instances are equal
        /// </summary>
        /// <param name="input">Instance of BamboraConnectionSignupOwnership to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BamboraConnectionSignupOwnership input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.OwnershipStructure == input.OwnershipStructure ||
                    this.OwnershipStructure.Equals(input.OwnershipStructure)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = hashCode * 59 + this.OwnershipStructure.GetHashCode();
                if (this.Owners != null)
