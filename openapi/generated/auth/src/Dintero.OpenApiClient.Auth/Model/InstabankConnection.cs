...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// InstabankConnection
    /// </summary>
    [DataContract(Name = "InstabankConnection")]
    public partial class InstabankConnection : IEquatable<InstabankConnection>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankConnection" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstabankConnection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankConnection" /> class.
        /// </summary>
        ...
        public InstabankConnection(Object metadata = default(Object), StatusEnum? status = default(StatusEnum?), List<AccountConnectionEvent> events = default(List<AccountConnectionEvent>), InstabankConnectionConfiguration configuration = default(InstabankConnectionConfiguration), InstabankConnectionSignup signup = default(InstabankConnectionSignup))
        {
            // to ensure "signup" is required (not null)
            this.Signup = signup ?? throw new ArgumentNullException("signup is a required property for InstabankConnection and cannot be null");
        ...
        public InstabankConnectionConfiguration Configuration { get; set; }

        /// <summary>
        /// Gets or Sets Signup
        /// </summary>
        [DataMember(Name = "signup", IsRequired = true, EmitDefaultValue = false)]
        public InstabankConnectionSignup Signup { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstabankConnection {\n");
        ...
        {
            return this.Equals(input as InstabankConnection);
        }

        /// <summary>
        /// Returns true if InstabankConnection instances are equal
        /// </summary>
        /// <param name="input">Instance of InstabankConnection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstabankConnection input)
        {
            if (input == null)
                return false;
