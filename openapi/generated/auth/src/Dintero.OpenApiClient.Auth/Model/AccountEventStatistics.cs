...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccountEventStatistics")]
    [JsonConverter(typeof(JsonSubtypes), "EventType")]
    public partial class AccountEventStatistics : AccountEvent, IEquatable<AccountEventStatistics>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountEventStatistics" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountEventStatistics() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountEventStatistics" /> class.
        /// </summary>
        /// <param name="eventType">The event_type corresponding to comment event  (required) (default to &quot;AccountEventStatistics&quot;).</param>
        /// <param name="statistics">statistics (required).</param>
        public AccountEventStatistics(EventTypeEnum eventType = "AccountEventStatistics", AccountMonthlyStatistics statistics = default(AccountMonthlyStatistics)) : base(id, createdAt, createdBy)
        {
            this.EventType = eventType;
            // to ensure "statistics" is required (not null)
            this.Statistics = statistics ?? throw new ArgumentNullException("statistics is a required property for AccountEventStatistics and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountEventStatistics {\n");
        ...
        {
            return this.Equals(input as AccountEventStatistics);
        }

        /// <summary>
        /// Returns true if AccountEventStatistics instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountEventStatistics to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountEventStatistics input)
        {
            if (input == null)
                return false;
