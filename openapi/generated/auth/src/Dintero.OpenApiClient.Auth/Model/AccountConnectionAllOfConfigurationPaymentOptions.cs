...
{
    /// <summary>
    /// AccountConnectionAllOfConfigurationPaymentOptions
    /// </summary>
    [DataContract(Name = "AccountConnection_allOf_configuration_payment_options")]
    public partial class AccountConnectionAllOfConfigurationPaymentOptions : IEquatable<AccountConnectionAllOfConfigurationPaymentOptions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountConnectionAllOfConfigurationPaymentOptions" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountConnectionAllOfConfigurationPaymentOptions() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountConnectionAllOfConfigurationPaymentOptions" /> class.
        /// </summary>
        /// <param name="currencies">currencies (required).</param>
        /// <param name="type">type (required).</param>
        public AccountConnectionAllOfConfigurationPaymentOptions(List<string> currencies = default(List<string>), string type = default(string))
        {
            // to ensure "currencies" is required (not null)
            this.Currencies = currencies ?? throw new ArgumentNullException("currencies is a required property for AccountConnectionAllOfConfigurationPaymentOptions and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for AccountConnectionAllOfConfigurationPaymentOptions and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountConnectionAllOfConfigurationPaymentOptions {\n");
        ...
        {
            return this.Equals(input as AccountConnectionAllOfConfigurationPaymentOptions);
        }

        /// <summary>
        /// Returns true if AccountConnectionAllOfConfigurationPaymentOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountConnectionAllOfConfigurationPaymentOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountConnectionAllOfConfigurationPaymentOptions input)
        {
            if (input == null)
                return false;
