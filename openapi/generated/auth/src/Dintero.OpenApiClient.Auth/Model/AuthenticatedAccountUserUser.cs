...
{
    /// <summary>
    /// AuthenticatedAccountUserUser
    /// </summary>
    [DataContract(Name = "AuthenticatedAccountUser_user")]
    public partial class AuthenticatedAccountUserUser : IEquatable<AuthenticatedAccountUserUser>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthenticatedAccountUserUser" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuthenticatedAccountUserUser() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthenticatedAccountUserUser" /> class.
        /// </summary>
        /// <param name="id">An UUID that uniquely identifies the account user (required).</param>
        /// <param name="lastSeenAt">lastSeenAt.</param>
        /// <param name="scope">scope.</param>
        /// <param name="name">The name of the user in the account.</param>
        /// <param name="email">email (required).</param>
        public AuthenticatedAccountUserUser(string id = default(string), DateTime lastSeenAt = default(DateTime), List<string> scope = default(List<string>), string name = default(string), string email = default(string))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for AuthenticatedAccountUserUser and cannot be null");
            // to ensure "email" is required (not null)
            this.Email = email ?? throw new ArgumentNullException("email is a required property for AuthenticatedAccountUserUser and cannot be null");
        ...
        /// <summary>
        /// An UUID that uniquely identifies the account user
        /// </summary>
        /// <value>An UUID that uniquely identifies the account user</value>
        ...
        /// <summary>
        /// The name of the user in the account
        /// </summary>
        /// <value>The name of the user in the account</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthenticatedAccountUserUser {\n");
        ...
        {
            return this.Equals(input as AuthenticatedAccountUserUser);
        }

        /// <summary>
        /// Returns true if AuthenticatedAccountUserUser instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthenticatedAccountUserUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthenticatedAccountUserUser input)
        {
            if (input == null)
                return false;
