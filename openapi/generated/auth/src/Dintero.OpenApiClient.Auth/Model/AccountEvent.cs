...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(AccountEventComment), "AccountEventComment")]
    [JsonSubtypes.KnownSubType(typeof(AccountEventStatistics), "AccountEventStatistics")]
    [JsonSubtypes.KnownSubType(typeof(AccountEventComment), "comment")]
    [JsonSubtypes.KnownSubType(typeof(AccountEventStatistics), "statistics")]
    public partial class AccountEvent : IEquatable<AccountEvent>, IValidatableObject
    {
        ...
        public AccountEvent(string eventType = default(string))
        {
            // to ensure "eventType" is required (not null)
            this.EventType = eventType ?? throw new ArgumentNullException("eventType is a required property for AccountEvent and cannot be null");
        }
