...
{
    /// <summary>
    /// CommonConnectionSignupBankAccounts
    /// </summary>
    [DataContract(Name = "CommonConnectionSignup_bank_accounts")]
    public partial class CommonConnectionSignupBankAccounts : IEquatable<CommonConnectionSignupBankAccounts>, IValidatableObject
    {
        /// <summary>
        /// What format the account number is. 
        /// </summary>
        /// <value>What format the account number is. </value>
        ...
        public enum AccountNumberTypeEnum
        {
            ...
            /// <summary>
            /// Enum Mod11 for value: mod11
            /// </summary>
            [EnumMember(Value = "mod11")]
            Mod11 = 2
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonConnectionSignupBankAccounts" /> class.
        /// </summary>
        /// <param name="accountNumber">The bank account number.</param>
        /// <param name="accountNumberType">What format the account number is. .</param>
        /// <param name="bankName">The name of the bank.</param>
        /// <param name="accountStatementUrl">Document or image to prove that the account number belongs to the company. .</param>
        public CommonConnectionSignupBankAccounts(string accountNumber = default(string), AccountNumberTypeEnum? accountNumberType = default(AccountNumberTypeEnum?), string bankName = default(string), string accountStatementUrl = default(string))
        {
            this.AccountNumber = accountNumber;
            this.AccountNumberType = accountNumberType;
            this.BankName = bankName;
            this.AccountStatementUrl = accountStatementUrl;
        }
        ...
        /// </summary>
        /// <value>Document or image to prove that the account number belongs to the company. </value>
        [DataMember(Name = "account_statement_url", EmitDefaultValue = false)]
        public string AccountStatementUrl { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CommonConnectionSignupBankAccounts {\n");
            sb.Append("  AccountNumber: ").Append(AccountNumber).Append("\n");
            sb.Append("  AccountNumberType: ").Append(AccountNumberType).Append("\n");
            sb.Append("  BankName: ").Append(BankName).Append("\n");
            sb.Append("  AccountStatementUrl: ").Append(AccountStatementUrl).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as CommonConnectionSignupBankAccounts);
        }

        /// <summary>
        /// Returns true if CommonConnectionSignupBankAccounts instances are equal
        /// </summary>
        /// <param name="input">Instance of CommonConnectionSignupBankAccounts to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommonConnectionSignupBankAccounts input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.AccountNumberType == input.AccountNumberType ||
                    this.AccountNumberType.Equals(input.AccountNumberType)
                ) && 
                (
                ...
                (
                    this.AccountStatementUrl == input.AccountStatementUrl ||
                    (this.AccountStatementUrl != null &&
                    this.AccountStatementUrl.Equals(input.AccountStatementUrl))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.AccountNumberType.GetHashCode();
                if (this.BankName != null)
                    hashCode = hashCode * 59 + this.BankName.GetHashCode();
                if (this.AccountStatementUrl != null)
                    hashCode = hashCode * 59 + this.AccountStatementUrl.GetHashCode();
                return hashCode;
            }
        }
        ...
        {
            // AccountStatementUrl (string) pattern
            Regex regexAccountStatementUrl = new Regex(@"https?:\/\/_*", RegexOptions.CultureInvariant);
            if (false == regexAccountStatementUrl.Match(this.AccountStatementUrl).Success)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AccountStatementUrl, must match a pattern of " + regexAccountStatementUrl, new [] { "AccountStatementUrl" });
            }
