...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    public partial class InlineObject4 : IEquatable<InlineObject4>, IValidatableObject
    {
        ...
        public InlineObject4(BamboraConnectionSignup signup = default(BamboraConnectionSignup))
        {
            // to ensure "signup" is required (not null)
            this.Signup = signup ?? throw new ArgumentNullException("signup is a required property for InlineObject4 and cannot be null");
        }
