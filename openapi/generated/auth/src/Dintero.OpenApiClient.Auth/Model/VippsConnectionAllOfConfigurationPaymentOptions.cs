...
{
    /// <summary>
    /// VippsConnectionAllOfConfigurationPaymentOptions
    /// </summary>
    [DataContract(Name = "VippsConnection_allOf_configuration_payment_options")]
    public partial class VippsConnectionAllOfConfigurationPaymentOptions : IEquatable<VippsConnectionAllOfConfigurationPaymentOptions>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VippsConnectionAllOfConfigurationPaymentOptions" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VippsConnectionAllOfConfigurationPaymentOptions() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VippsConnectionAllOfConfigurationPaymentOptions" /> class.
        /// </summary>
        /// <param name="type">type (required).</param>
        public VippsConnectionAllOfConfigurationPaymentOptions(TypeEnum type = default(TypeEnum))
        {
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VippsConnectionAllOfConfigurationPaymentOptions {\n");
        ...
        {
            return this.Equals(input as VippsConnectionAllOfConfigurationPaymentOptions);
        }

        /// <summary>
        /// Returns true if VippsConnectionAllOfConfigurationPaymentOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of VippsConnectionAllOfConfigurationPaymentOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VippsConnectionAllOfConfigurationPaymentOptions input)
        {
            if (input == null)
                return false;
