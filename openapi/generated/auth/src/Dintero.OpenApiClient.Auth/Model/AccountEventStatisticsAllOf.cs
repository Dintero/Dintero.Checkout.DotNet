...
{
    /// <summary>
    /// AccountEventStatisticsAllOf
    /// </summary>
    [DataContract(Name = "AccountEventStatistics_allOf")]
    public partial class AccountEventStatisticsAllOf : IEquatable<AccountEventStatisticsAllOf>, IValidatableObject
    {
        /// <summary>
        /// The event_type corresponding to comment event 
        /// </summary>
        /// <value>The event_type corresponding to comment event </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountEventStatisticsAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountEventStatisticsAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountEventStatisticsAllOf" /> class.
        /// </summary>
        /// <param name="eventType">The event_type corresponding to comment event  (required).</param>
        /// <param name="statistics">statistics (required).</param>
        public AccountEventStatisticsAllOf(EventTypeEnum eventType = default(EventTypeEnum), AccountMonthlyStatistics statistics = default(AccountMonthlyStatistics))
        {
            this.EventType = eventType;
            // to ensure "statistics" is required (not null)
            this.Statistics = statistics ?? throw new ArgumentNullException("statistics is a required property for AccountEventStatisticsAllOf and cannot be null");
        }

        /// <summary>
        /// Gets or Sets Statistics
        /// </summary>
        [DataMember(Name = "statistics", IsRequired = true, EmitDefaultValue = false)]
        public AccountMonthlyStatistics Statistics { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountEventStatisticsAllOf {\n");
        ...
        {
            return this.Equals(input as AccountEventStatisticsAllOf);
        }

        /// <summary>
        /// Returns true if AccountEventStatisticsAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountEventStatisticsAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountEventStatisticsAllOf input)
        {
            if (input == null)
                return false;
