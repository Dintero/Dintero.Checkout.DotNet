...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccountUserResponse")]
    public partial class AccountUserResponse : IEquatable<AccountUserResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountUserResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountUserResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountUserResponse" /> class.
        /// </summary>
        ...
        public AccountUserResponse(string email = default(string), string name = default(string), List<string> scope = default(List<string>), List<AuthRole> roles = default(List<AuthRole>), DateTime lastSeenAt = default(DateTime), AccountUserConfig configuration = default(AccountUserConfig))
        {
            // to ensure "email" is required (not null)
            this.Email = email ?? throw new ArgumentNullException("email is a required property for AccountUserResponse and cannot be null");
            this.Name = name;
            this.Scope = scope;
            this.Roles = roles;
        ...
        /// <summary>
        /// Returns false as AuthenticationType should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountUserResponse {\n");
        ...
        {
            return this.Equals(input as AccountUserResponse);
        }

        /// <summary>
        /// Returns true if AccountUserResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountUserResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountUserResponse input)
        {
            if (input == null)
                return false;
