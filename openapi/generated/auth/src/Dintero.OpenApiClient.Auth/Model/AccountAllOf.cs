...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// AccountAllOf
    /// </summary>
    [DataContract(Name = "Account_allOf")]
    public partial class AccountAllOf : IEquatable<AccountAllOf>, IValidatableObject
    {
        ...
        public AccountAllOf(AccountApplicant applicant = default(AccountApplicant), AccountCompany company = default(AccountCompany), AccountBilling billing = default(AccountBilling), Subscription subscription = default(Subscription), bool livemode = false, string languageCode = default(string), AccountAllOfConnections connections = default(AccountAllOfConnections), AccountAllOfServices services = default(AccountAllOfServices))
        {
            ...
            this.Applicant = applicant ?? throw new ArgumentNullException("applicant is a required property for AccountAllOf and cannot be null");
            // to ensure "company" is required (not null)
            this.Company = company ?? throw new ArgumentNullException("company is a required property for AccountAllOf and cannot be null");
            // to ensure "billing" is required (not null)
            this.Billing = billing ?? throw new ArgumentNullException("billing is a required property for AccountAllOf and cannot be null");
