...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// AccountConnection
    /// </summary>
    [DataContract(Name = "AccountConnection")]
    public partial class AccountConnection : IEquatable<AccountConnection>, IValidatableObject
    {
        /// <summary>
        ...
        public AccountConnection(Object metadata = default(Object), StatusEnum? status = default(StatusEnum?), List<AccountConnectionEvent> events = default(List<AccountConnectionEvent>), AccountConnectionAllOfConfiguration configuration = default(AccountConnectionAllOfConfiguration))
        {
        ...
        public AccountConnectionAllOfConfiguration Configuration { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountConnection {\n");
        ...
        {
            return this.Equals(input as AccountConnection);
        }

        /// <summary>
        /// Returns true if AccountConnection instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountConnection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountConnection input)
        {
            if (input == null)
                return false;
