...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CommonConnectionSignup")]
    public partial class CommonConnectionSignup : IEquatable<CommonConnectionSignup>, IValidatableObject
    {
        /// <summary>
        /// Defines StoreType
        /// </summary>
        ...
        /// </summary>
        [DataMember(Name = "store_type", IsRequired = true, EmitDefaultValue = false)]
        public List<StoreTypeEnum> StoreType { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonConnectionSignup" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CommonConnectionSignup() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonConnectionSignup" /> class.
        /// </summary>
        /// <param name="paymentOptions">paymentOptions (required).</param>
        /// <param name="storeType">storeType (required).</param>
        /// <param name="package">What pricing strategy to use for this company. .</param>
        /// <param name="revenue">revenue.</param>
        /// <param name="bankAccounts">Will only support one bank account for the time being .</param>
        ...
        /// <param name="paymentMethodSpecific">paymentMethodSpecific.</param>
        public CommonConnectionSignup(List<CommonConnectionSignupPaymentOptions> paymentOptions = default(List<CommonConnectionSignupPaymentOptions>), List<StoreTypeEnum> storeType = default(List<StoreTypeEnum>), string package = default(string), BamboraConnectionSignupRevenue revenue = default(BamboraConnectionSignupRevenue), List<CommonConnectionSignupBankAccounts> bankAccounts = default(List<CommonConnectionSignupBankAccounts>), CommonConnectionSignupOwnership ownership = default(CommonConnectionSignupOwnership), CommonConnectionSignupVerifications verifications = default(CommonConnectionSignupVerifications), BamboraConnectionSignupSignature signature = default(BamboraConnectionSignupSignature), CommonConnectionSignupApplicant applicant = default(CommonConnectionSignupApplicant), CommonConnectionSignupCompanyInformation companyInformation = default(CommonConnectionSignupCompanyInformation), CommonConnectionSignupPaymentMethodSpecific paymentMethodSpecific = default(CommonConnectionSignupPaymentMethodSpecific))
        {
            // to ensure "paymentOptions" is required (not null)
            this.PaymentOptions = paymentOptions ?? throw new ArgumentNullException("paymentOptions is a required property for CommonConnectionSignup and cannot be null");
            // to ensure "storeType" is required (not null)
            this.StoreType = storeType ?? throw new ArgumentNullException("storeType is a required property for CommonConnectionSignup and cannot be null");
            ...
            this.PaymentMethodSpecific = paymentMethodSpecific;
        }
        ...
        public List<CommonConnectionSignupPaymentOptions> PaymentOptions { get; set; }

        /// <summary>
        /// What pricing strategy to use for this company. 
        /// </summary>
        /// <value>What pricing strategy to use for this company. </value>
        ...
        /// </summary>
        /// <value>Will only support one bank account for the time being </value>
        [DataMember(Name = "bank_accounts", EmitDefaultValue = false)]
        public List<CommonConnectionSignupBankAccounts> BankAccounts { get; set; }

        /// <summary>
        /// Gets or Sets Ownership
        /// </summary>
        [DataMember(Name = "ownership", EmitDefaultValue = false)]
        public CommonConnectionSignupOwnership Ownership { get; set; }

        /// <summary>
        /// Gets or Sets Verifications
        /// </summary>
        [DataMember(Name = "verifications", EmitDefaultValue = false)]
        public CommonConnectionSignupVerifications Verifications { get; set; }
        ...
        public CommonConnectionSignupApplicant Applicant { get; set; }

        /// <summary>
        /// Gets or Sets CompanyInformation
        /// </summary>
        [DataMember(Name = "company_information", EmitDefaultValue = false)]
        public CommonConnectionSignupCompanyInformation CompanyInformation { get; set; }

        /// <summary>
        /// Gets or Sets PaymentMethodSpecific
        /// </summary>
        [DataMember(Name = "payment_method_specific", EmitDefaultValue = false)]
        public CommonConnectionSignupPaymentMethodSpecific PaymentMethodSpecific { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CommonConnectionSignup {\n");
            ...
            sb.Append("  PaymentMethodSpecific: ").Append(PaymentMethodSpecific).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as CommonConnectionSignup);
        }

        /// <summary>
        /// Returns true if CommonConnectionSignup instances are equal
        /// </summary>
        /// <param name="input">Instance of CommonConnectionSignup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommonConnectionSignup input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PaymentMethodSpecific == input.PaymentMethodSpecific ||
                    (this.PaymentMethodSpecific != null &&
                    this.PaymentMethodSpecific.Equals(input.PaymentMethodSpecific))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PaymentMethodSpecific != null)
                    hashCode = hashCode * 59 + this.PaymentMethodSpecific.GetHashCode();
                return hashCode;
            }
        }
