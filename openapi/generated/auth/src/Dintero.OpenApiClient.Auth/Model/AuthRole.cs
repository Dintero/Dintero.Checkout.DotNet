...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AuthRole")]
    public partial class AuthRole : IEquatable<AuthRole>, IValidatableObject
    {
        /// <summary>
        ...
        public AuthRole(string name = default(string), string description = default(string), List<string> scope = default(List<string>))
        {
            // to ensure "scope" is required (not null)
            this.Scope = scope ?? throw new ArgumentNullException("scope is a required property for AuthRole and cannot be null");
            this.Name = name;
        ...
        {
            return this.Equals(input as AuthRole);
        }

        /// <summary>
        /// Returns true if AuthRole instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthRole to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthRole input)
        {
            if (input == null)
                return false;
