...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SwishConnectionSignup")]
    public partial class SwishConnectionSignup : IEquatable<SwishConnectionSignup>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SwishConnectionSignup" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SwishConnectionSignup() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SwishConnectionSignup" /> class.
        /// </summary>
        ...
        public SwishConnectionSignup(string businessName = default(string), string legalName = default(string), string organizationNumber = default(string), string bankName = default(string), string accountNumber = default(string), string website = default(string), List<SwishConnectionSignupPaymentOptions> paymentOptions = default(List<SwishConnectionSignupPaymentOptions>))
        {
            // to ensure "legalName" is required (not null)
            this.LegalName = legalName ?? throw new ArgumentNullException("legalName is a required property for SwishConnectionSignup and cannot be null");
            // to ensure "organizationNumber" is required (not null)
            this.OrganizationNumber = organizationNumber ?? throw new ArgumentNullException("organizationNumber is a required property for SwishConnectionSignup and cannot be null");
            // to ensure "website" is required (not null)
            this.Website = website ?? throw new ArgumentNullException("website is a required property for SwishConnectionSignup and cannot be null");
            // to ensure "paymentOptions" is required (not null)
            this.PaymentOptions = paymentOptions ?? throw new ArgumentNullException("paymentOptions is a required property for SwishConnectionSignup and cannot be null");
        ...
        public List<SwishConnectionSignupPaymentOptions> PaymentOptions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SwishConnectionSignup {\n");
        ...
        {
            return this.Equals(input as SwishConnectionSignup);
        }

        /// <summary>
        /// Returns true if SwishConnectionSignup instances are equal
        /// </summary>
        /// <param name="input">Instance of SwishConnectionSignup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SwishConnectionSignup input)
        {
            if (input == null)
                return false;
