...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    public partial class InlineObject1 : IEquatable<InlineObject1>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="InlineObject1" /> class.
        /// </summary>
        /// <param name="previousPassword">previousPassword (required).</param>
        /// <param name="proposedPassword">proposedPassword (required).</param>
        public InlineObject1(string previousPassword = default(string), string proposedPassword = default(string))
        {
            // to ensure "previousPassword" is required (not null)
            this.PreviousPassword = previousPassword ?? throw new ArgumentNullException("previousPassword is a required property for InlineObject1 and cannot be null");
            // to ensure "proposedPassword" is required (not null)
            this.ProposedPassword = proposedPassword ?? throw new ArgumentNullException("proposedPassword is a required property for InlineObject1 and cannot be null");
        }

        /// <summary>
        /// Gets or Sets PreviousPassword
        /// </summary>
        [DataMember(Name = "previous_password", IsRequired = true, EmitDefaultValue = false)]
        public string PreviousPassword { get; set; }

        /// <summary>
        /// Gets or Sets ProposedPassword
        /// </summary>
        [DataMember(Name = "proposed_password", IsRequired = true, EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ProposedPassword: ").Append(ProposedPassword).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(InlineObject1 input)
        {
            ...
            return 
                (
                    this.PreviousPassword == input.PreviousPassword ||
                    (this.PreviousPassword != null &&
                    this.PreviousPassword.Equals(input.PreviousPassword))
                ) && 
                (
                    this.ProposedPassword == input.ProposedPassword ||
                    (this.ProposedPassword != null &&
                    this.ProposedPassword.Equals(input.ProposedPassword))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PreviousPassword != null)
                    hashCode = hashCode * 59 + this.PreviousPassword.GetHashCode();
                if (this.ProposedPassword != null)
                    hashCode = hashCode * 59 + this.ProposedPassword.GetHashCode();
                return hashCode;
            }
        }
