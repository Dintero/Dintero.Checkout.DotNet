...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CheckoutAccountService")]
    public partial class CheckoutAccountService : IEquatable<CheckoutAccountService>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckoutAccountService" /> class.
        /// </summary>
        ...
        public CheckoutAccountService(StatusEnum? status = default(StatusEnum?), ProgressionEnum? progression = default(ProgressionEnum?), Object metadata = default(Object), CheckoutAccountServiceAllOfGateways gateways = default(CheckoutAccountServiceAllOfGateways))
        {
            this.Status = status;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CheckoutAccountService {\n");
        ...
        {
            return this.Equals(input as CheckoutAccountService);
        }

        /// <summary>
        /// Returns true if CheckoutAccountService instances are equal
        /// </summary>
        /// <param name="input">Instance of CheckoutAccountService to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CheckoutAccountService input)
        {
            if (input == null)
                return false;
