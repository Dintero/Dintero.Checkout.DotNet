...
{
    /// <summary>
    /// AccountUserConfigMfaSms
    /// </summary>
    [DataContract(Name = "AccountUserConfig_mfa_sms")]
    public partial class AccountUserConfigMfaSms : IEquatable<AccountUserConfigMfaSms>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountUserConfigMfaSms" /> class.
        /// </summary>
        /// <param name="updatedAt">updatedAt.</param>
        /// <param name="enabled">enabled.</param>
        public AccountUserConfigMfaSms(DateTime updatedAt = default(DateTime), bool enabled = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountUserConfigMfaSms {\n");
        ...
        {
            return this.Equals(input as AccountUserConfigMfaSms);
        }

        /// <summary>
        /// Returns true if AccountUserConfigMfaSms instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountUserConfigMfaSms to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountUserConfigMfaSms input)
        {
            if (input == null)
                return false;
