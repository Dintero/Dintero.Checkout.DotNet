...
{
    /// <summary>
    /// SwishConnectionSignupPaymentOptions
    /// </summary>
    [DataContract(Name = "SwishConnectionSignup_payment_options")]
    public partial class SwishConnectionSignupPaymentOptions : IEquatable<SwishConnectionSignupPaymentOptions>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SwishConnectionSignupPaymentOptions" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SwishConnectionSignupPaymentOptions() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SwishConnectionSignupPaymentOptions" /> class.
        /// </summary>
        /// <param name="currencies">currencies (required).</param>
        /// <param name="type">type (required).</param>
        public SwishConnectionSignupPaymentOptions(List<string> currencies = default(List<string>), TypeEnum type = default(TypeEnum))
        {
            // to ensure "currencies" is required (not null)
            this.Currencies = currencies ?? throw new ArgumentNullException("currencies is a required property for SwishConnectionSignupPaymentOptions and cannot be null");
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SwishConnectionSignupPaymentOptions {\n");
        ...
        {
            return this.Equals(input as SwishConnectionSignupPaymentOptions);
        }

        /// <summary>
        /// Returns true if SwishConnectionSignupPaymentOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of SwishConnectionSignupPaymentOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SwishConnectionSignupPaymentOptions input)
        {
            if (input == null)
                return false;
