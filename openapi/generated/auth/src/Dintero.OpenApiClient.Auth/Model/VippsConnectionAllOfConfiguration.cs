...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VippsConnection_allOf_configuration")]
    public partial class VippsConnectionAllOfConfiguration : IEquatable<VippsConnectionAllOfConfiguration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VippsConnectionAllOfConfiguration" /> class.
        /// </summary>
        ...
        public VippsConnectionAllOfConfiguration(List<VippsConnectionAllOfConfigurationPaymentOptions> paymentOptions = default(List<VippsConnectionAllOfConfigurationPaymentOptions>), string merchantName = default(string), string createdTime = default(string), string merchantSerialNumber = default(string), Guid clientId = default(Guid), List<VippsConnectionAllOfConfigurationSubscriptionKeys> subscriptionKeys = default(List<VippsConnectionAllOfConfigurationSubscriptionKeys>))
        {
        ...
        public List<VippsConnectionAllOfConfigurationPaymentOptions> PaymentOptions { get; set; }
        ...
        /// </summary>
        [DataMember(Name = "merchant_serial_number", EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "subscription_keys", EmitDefaultValue = false)]
        public List<VippsConnectionAllOfConfigurationSubscriptionKeys> SubscriptionKeys { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VippsConnectionAllOfConfiguration {\n");
        ...
        {
            return this.Equals(input as VippsConnectionAllOfConfiguration);
        }

        /// <summary>
        /// Returns true if VippsConnectionAllOfConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of VippsConnectionAllOfConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VippsConnectionAllOfConfiguration input)
        {
            if (input == null)
                return false;
