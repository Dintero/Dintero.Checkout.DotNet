...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AuthenticatedAccountUser")]
    public partial class AuthenticatedAccountUser : IEquatable<AuthenticatedAccountUser>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthenticatedAccountUser" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuthenticatedAccountUser() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthenticatedAccountUser" /> class.
        /// </summary>
        ...
        public AuthenticatedAccountUser(string id = default(string), AccountUserConfig configuration = default(AccountUserConfig), List<AuthenticatedAccountUserAccounts> accounts = default(List<AuthenticatedAccountUserAccounts>))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for AuthenticatedAccountUser and cannot be null");
            // to ensure "accounts" is required (not null)
            this.Accounts = accounts ?? throw new ArgumentNullException("accounts is a required property for AuthenticatedAccountUser and cannot be null");
        ...
        public AccountUserConfig Configuration { get; set; }

        /// <summary>
        /// Gets or Sets Accounts
        /// </summary>
        [DataMember(Name = "accounts", IsRequired = true, EmitDefaultValue = false)]
        public List<AuthenticatedAccountUserAccounts> Accounts { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthenticatedAccountUser {\n");
        ...
        {
            return this.Equals(input as AuthenticatedAccountUser);
        }

        /// <summary>
        /// Returns true if AuthenticatedAccountUser instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthenticatedAccountUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthenticatedAccountUser input)
        {
            if (input == null)
                return false;
