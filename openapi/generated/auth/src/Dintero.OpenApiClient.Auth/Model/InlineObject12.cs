...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    public partial class InlineObject12 : IEquatable<InlineObject12>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>- &#x60;external&#x60;: authentication of the user will be done   externally, Dintero will not manage user password. Requires   the account to be configured with &#x60;jwks.uri&#x60;. </value>
        ...
        /// <param name="authenticationType">- &#x60;external&#x60;: authentication of the user will be done   externally, Dintero will not manage user password. Requires   the account to be configured with &#x60;jwks.uri&#x60;. .</param>
        /// <param name="roles">Create user with one or more roles. The authorization used to create the user must have access to use the role, i.e. have the same scopes as granted by the role. .</param>
        public InlineObject12(string email = default(string), string name = default(string), List<string> scope = default(List<string>), AuthenticationTypeEnum? authenticationType = default(AuthenticationTypeEnum?), List<AccountsOidManagementUsersRoles> roles = default(List<AccountsOidManagementUsersRoles>))
        {
            // to ensure "email" is required (not null)
            this.Email = email ?? throw new ArgumentNullException("email is a required property for InlineObject12 and cannot be null");
            this.Name = name;
            this.Scope = scope;
        ...
        /// </summary>
        /// <value>Create user with one or more roles. The authorization used to create the user must have access to use the role, i.e. have the same scopes as granted by the role. </value>
        [DataMember(Name = "roles", EmitDefaultValue = false)]
        public List<AccountsOidManagementUsersRoles> Roles { get; set; }
