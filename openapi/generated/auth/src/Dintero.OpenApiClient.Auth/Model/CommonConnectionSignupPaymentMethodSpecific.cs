...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CommonConnectionSignup_payment_method_specific")]
    public partial class CommonConnectionSignupPaymentMethodSpecific : IEquatable<CommonConnectionSignupPaymentMethodSpecific>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonConnectionSignupPaymentMethodSpecific" /> class.
        /// </summary>
        /// <param name="instabank">instabank.</param>
        public CommonConnectionSignupPaymentMethodSpecific(CommonConnectionSignupPaymentMethodSpecificInstabank instabank = default(CommonConnectionSignupPaymentMethodSpecificInstabank))
        {
        ...
        public CommonConnectionSignupPaymentMethodSpecificInstabank Instabank { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CommonConnectionSignupPaymentMethodSpecific {\n");
        ...
        {
            return this.Equals(input as CommonConnectionSignupPaymentMethodSpecific);
        }

        /// <summary>
        /// Returns true if CommonConnectionSignupPaymentMethodSpecific instances are equal
        /// </summary>
        /// <param name="input">Instance of CommonConnectionSignupPaymentMethodSpecific to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommonConnectionSignupPaymentMethodSpecific input)
        {
            if (input == null)
                return false;
