...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// AuthUserAllOf
    /// </summary>
    [DataContract(Name = "AuthUser_allOf")]
    public partial class AuthUserAllOf : IEquatable<AuthUserAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthUserAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuthUserAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthUserAllOf" /> class.
        /// </summary>
        ...
        public AuthUserAllOf(string username = default(string), List<Object> links = default(List<Object>), AuthUserMfa mfa = default(AuthUserMfa))
        {
            // to ensure "username" is required (not null)
            this.Username = username ?? throw new ArgumentNullException("username is a required property for AuthUserAllOf and cannot be null");
            this.Links = links;
            this.Mfa = mfa;
        }
        ...
        {
            return this.Equals(input as AuthUserAllOf);
        }

        /// <summary>
        /// Returns true if AuthUserAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthUserAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthUserAllOf input)
        {
            if (input == null)
                return false;
