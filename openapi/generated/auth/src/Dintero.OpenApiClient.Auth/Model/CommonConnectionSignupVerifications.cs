...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CommonConnectionSignup_verifications")]
    public partial class CommonConnectionSignupVerifications : IEquatable<CommonConnectionSignupVerifications>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonConnectionSignupVerifications" /> class.
        /// </summary>
        ...
        /// <param name="paymentSiteUrl">Url to payment site. .</param>
        /// <param name="demoSiteUrl">Url to demo site. .</param>
        ...
        public CommonConnectionSignupVerifications(bool termsAndConditions = default(bool), string termsAndConditionsUrl = default(string), bool contactInformation = default(bool), bool paymentSite = default(bool), string paymentSiteUrl = default(string), string demoSiteUrl = default(string), bool clearPricing = default(bool), bool paymentProductLogos = default(bool))
        {
            this.TermsAndConditions = termsAndConditions;
            this.TermsAndConditionsUrl = termsAndConditionsUrl;
            this.ContactInformation = contactInformation;
            this.PaymentSite = paymentSite;
            this.PaymentSiteUrl = paymentSiteUrl;
        ...
        /// Url to payment site. 
        /// </summary>
        /// <value>Url to payment site. </value>
        [DataMember(Name = "payment_site_url", EmitDefaultValue = false)]
        public string PaymentSiteUrl { get; set; }

        /// <summary>
        /// Url to demo site. 
        /// </summary>
        /// <value>Url to demo site. </value>
        [DataMember(Name = "demo_site_url", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CommonConnectionSignupVerifications {\n");
            ...
            sb.Append("  PaymentSiteUrl: ").Append(PaymentSiteUrl).Append("\n");
            sb.Append("  DemoSiteUrl: ").Append(DemoSiteUrl).Append("\n");
        ...
        {
            return this.Equals(input as CommonConnectionSignupVerifications);
        }

        /// <summary>
        /// Returns true if CommonConnectionSignupVerifications instances are equal
        /// </summary>
        /// <param name="input">Instance of CommonConnectionSignupVerifications to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommonConnectionSignupVerifications input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PaymentSiteUrl == input.PaymentSiteUrl ||
                    (this.PaymentSiteUrl != null &&
                    this.PaymentSiteUrl.Equals(input.PaymentSiteUrl))
                ) && 
                (
                    this.DemoSiteUrl == input.DemoSiteUrl ||
                    (this.DemoSiteUrl != null &&
                    this.DemoSiteUrl.Equals(input.DemoSiteUrl))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PaymentSiteUrl != null)
                    hashCode = hashCode * 59 + this.PaymentSiteUrl.GetHashCode();
                if (this.DemoSiteUrl != null)
                    hashCode = hashCode * 59 + this.DemoSiteUrl.GetHashCode();
