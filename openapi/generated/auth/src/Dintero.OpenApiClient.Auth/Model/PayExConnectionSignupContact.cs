...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PayExConnectionSignupContact")]
    public partial class PayExConnectionSignupContact : IEquatable<PayExConnectionSignupContact>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExConnectionSignupContact" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayExConnectionSignupContact() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExConnectionSignupContact" /> class.
        /// </summary>
        /// <param name="name">Name of the contact person (required).</param>
        /// <param name="phoneNumber">Phone number for the contact person. A phone number in E.164 number formatting.  (required).</param>
        /// <param name="email">Contact person&#39;s e-mail (required).</param>
        public PayExConnectionSignupContact(string name = default(string), string phoneNumber = default(string), string email = default(string))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for PayExConnectionSignupContact and cannot be null");
            // to ensure "phoneNumber" is required (not null)
            this.PhoneNumber = phoneNumber ?? throw new ArgumentNullException("phoneNumber is a required property for PayExConnectionSignupContact and cannot be null");
            // to ensure "email" is required (not null)
            this.Email = email ?? throw new ArgumentNullException("email is a required property for PayExConnectionSignupContact and cannot be null");
        }
        ...
        /// </summary>
        /// <value>Phone number for the contact person. A phone number in E.164 number formatting. </value>
        ...
        /// </summary>
        /// <value>Contact person&#39;s e-mail</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PayExConnectionSignupContact {\n");
        ...
        {
            return this.Equals(input as PayExConnectionSignupContact);
        }

        /// <summary>
        /// Returns true if PayExConnectionSignupContact instances are equal
        /// </summary>
        /// <param name="input">Instance of PayExConnectionSignupContact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayExConnectionSignupContact input)
        {
            if (input == null)
                return false;
