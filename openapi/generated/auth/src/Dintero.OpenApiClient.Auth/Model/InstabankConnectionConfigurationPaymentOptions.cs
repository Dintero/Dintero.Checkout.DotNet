...
{
    /// <summary>
    /// InstabankConnectionConfigurationPaymentOptions
    /// </summary>
    [DataContract(Name = "InstabankConnectionConfiguration_payment_options")]
    public partial class InstabankConnectionConfigurationPaymentOptions : IEquatable<InstabankConnectionConfigurationPaymentOptions>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankConnectionConfigurationPaymentOptions" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstabankConnectionConfigurationPaymentOptions() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankConnectionConfigurationPaymentOptions" /> class.
        /// </summary>
        /// <param name="type">type (required).</param>
        public InstabankConnectionConfigurationPaymentOptions(TypeEnum type = default(TypeEnum))
        {
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstabankConnectionConfigurationPaymentOptions {\n");
        ...
        {
            return this.Equals(input as InstabankConnectionConfigurationPaymentOptions);
        }

        /// <summary>
        /// Returns true if InstabankConnectionConfigurationPaymentOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of InstabankConnectionConfigurationPaymentOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstabankConnectionConfigurationPaymentOptions input)
        {
            if (input == null)
                return false;
