...
{
    /// <summary>
    /// VippsConnectionAllOfConfigurationSubscriptionKeys
    /// </summary>
    [DataContract(Name = "VippsConnection_allOf_configuration_subscription_keys")]
    public partial class VippsConnectionAllOfConfigurationSubscriptionKeys : IEquatable<VippsConnectionAllOfConfigurationSubscriptionKeys>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VippsConnectionAllOfConfigurationSubscriptionKeys" /> class.
        /// </summary>
        /// <param name="product">product.</param>
        /// <param name="ocpApimSubscriptionKey">ocpApimSubscriptionKey.</param>
        public VippsConnectionAllOfConfigurationSubscriptionKeys(string product = default(string), string ocpApimSubscriptionKey = default(string))
        {
        ...
        /// </summary>
        [DataMember(Name = "ocp_apim_subscription_key", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VippsConnectionAllOfConfigurationSubscriptionKeys {\n");
        ...
        {
            return this.Equals(input as VippsConnectionAllOfConfigurationSubscriptionKeys);
        }

        /// <summary>
        /// Returns true if VippsConnectionAllOfConfigurationSubscriptionKeys instances are equal
        /// </summary>
        /// <param name="input">Instance of VippsConnectionAllOfConfigurationSubscriptionKeys to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VippsConnectionAllOfConfigurationSubscriptionKeys input)
        {
            if (input == null)
                return false;
