...
{
    /// <summary>
    /// BamboraConnectionSignupSignatureSignatures
    /// </summary>
    [DataContract(Name = "BamboraConnectionSignup_signature_signatures")]
    public partial class BamboraConnectionSignupSignatureSignatures : IEquatable<BamboraConnectionSignupSignatureSignatures>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraConnectionSignupSignatureSignatures" /> class.
        /// </summary>
        /// <param name="name">name.</param>
        /// <param name="email">email.</param>
        public BamboraConnectionSignupSignatureSignatures(string name = default(string), string email = default(string))
        {
            this.Name = name;
            this.Email = email;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BamboraConnectionSignupSignatureSignatures {\n");
        ...
        {
            return this.Equals(input as BamboraConnectionSignupSignatureSignatures);
        }

        /// <summary>
        /// Returns true if BamboraConnectionSignupSignatureSignatures instances are equal
        /// </summary>
        /// <param name="input">Instance of BamboraConnectionSignupSignatureSignatures to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BamboraConnectionSignupSignatureSignatures input)
        {
            if (input == null)
                return false;
