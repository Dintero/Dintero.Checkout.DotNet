...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccountPrivateDetails")]
    public partial class AccountPrivateDetails : IEquatable<AccountPrivateDetails>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountPrivateDetails" /> class.
        /// </summary>
        ...
        public AccountPrivateDetails(ProgressionEnum? progression = default(ProgressionEnum?), string resellerId = default(string), AccountPrivateDetailsAccountManager accountManager = default(AccountPrivateDetailsAccountManager), AccountPrivateDetailsStatistics statistics = default(AccountPrivateDetailsStatistics))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountPrivateDetails {\n");
        ...
        {
            return this.Equals(input as AccountPrivateDetails);
        }

        /// <summary>
        /// Returns true if AccountPrivateDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountPrivateDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountPrivateDetails input)
        {
            if (input == null)
                return false;
