...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccountApplicant_agreement")]
    public partial class AccountApplicantAgreement : IEquatable<AccountApplicantAgreement>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountApplicantAgreement" /> class.
        /// </summary>
        /// <param name="name">Defines the name of the agreement.</param>
        /// <param name="version">Defines the version of the agreement.</param>
        /// <param name="personalGuaranteeAccepted">The applicant has read and accepted the terms of a personal guarantee. .</param>
        /// <param name="attachments">attachment policies.</param>
        public AccountApplicantAgreement(string name = default(string), string version = default(string), bool personalGuaranteeAccepted = default(bool), List<AccountApplicantAgreementAttachments> attachments = default(List<AccountApplicantAgreementAttachments>))
        {
            this.Name = name;
            this.Version = version;
            this.PersonalGuaranteeAccepted = personalGuaranteeAccepted;
            this.Attachments = attachments;
        }

        /// <summary>
        /// Defines the name of the agreement
        /// </summary>
        /// <value>Defines the name of the agreement</value>
        [DataMember(Name = "name", EmitDefaultValue = false)]
        public string Name { get; set; }

        /// <summary>
        /// Defines the version of the agreement
        /// </summary>
        /// <value>Defines the version of the agreement</value>
        [DataMember(Name = "version", EmitDefaultValue = false)]
        public string Version { get; set; }

        /// <summary>
        /// The applicant has read and accepted the terms of a personal guarantee. 
        /// </summary>
        /// <value>The applicant has read and accepted the terms of a personal guarantee. </value>
        [DataMember(Name = "personal_guarantee_accepted", EmitDefaultValue = true)]
        public bool PersonalGuaranteeAccepted { get; set; }

        /// <summary>
        /// attachment policies
        /// </summary>
        /// <value>attachment policies</value>
        [DataMember(Name = "attachments", EmitDefaultValue = false)]
        public List<AccountApplicantAgreementAttachments> Attachments { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountApplicantAgreement {\n");
            sb.Append("  Name: ").Append(Name).Append("\n");
            sb.Append("  Version: ").Append(Version).Append("\n");
            sb.Append("  PersonalGuaranteeAccepted: ").Append(PersonalGuaranteeAccepted).Append("\n");
        ...
        {
            return this.Equals(input as AccountApplicantAgreement);
        }

        /// <summary>
        /// Returns true if AccountApplicantAgreement instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountApplicantAgreement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountApplicantAgreement input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PersonalGuaranteeAccepted == input.PersonalGuaranteeAccepted ||
                    this.PersonalGuaranteeAccepted.Equals(input.PersonalGuaranteeAccepted)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.PersonalGuaranteeAccepted.GetHashCode();
