...
{
    /// <summary>
    /// AccountAllOfConnectionsPayex
    /// </summary>
    [DataContract(Name = "Account_allOf_connections_payex")]
    public partial class AccountAllOfConnectionsPayex : IEquatable<AccountAllOfConnectionsPayex>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountAllOfConnectionsPayex" /> class.
        /// </summary>
        /// <param name="creditcard">creditcard.</param>
        public AccountAllOfConnectionsPayex(PayExConnection creditcard = default(PayExConnection))
        {
        ...
        public PayExConnection Creditcard { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountAllOfConnectionsPayex {\n");
        ...
        {
            return this.Equals(input as AccountAllOfConnectionsPayex);
        }

        /// <summary>
        /// Returns true if AccountAllOfConnectionsPayex instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountAllOfConnectionsPayex to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountAllOfConnectionsPayex input)
        {
            if (input == null)
                return false;
