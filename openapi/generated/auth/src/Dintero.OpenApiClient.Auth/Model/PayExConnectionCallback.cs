...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PayExConnectionCallback")]
    public partial class PayExConnectionCallback : IEquatable<PayExConnectionCallback>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExConnectionCallback" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayExConnectionCallback() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExConnectionCallback" /> class.
        /// </summary>
        /// <param name="token">token (required).</param>
        /// <param name="payeeId">payeeId (required).</param>
        /// <param name="subsite">Perform split settlements on payments. The subsite must be resolved with PayEx reconciliation before being used. .</param>
        /// <param name="paymentOptions">Payment options to enable for this connection  (required).</param>
        public PayExConnectionCallback(string token = default(string), string payeeId = default(string), string subsite = default(string), List<PayExConnectionCallbackPaymentOptions> paymentOptions = default(List<PayExConnectionCallbackPaymentOptions>))
        {
            // to ensure "token" is required (not null)
            this.Token = token ?? throw new ArgumentNullException("token is a required property for PayExConnectionCallback and cannot be null");
            // to ensure "payeeId" is required (not null)
            this.PayeeId = payeeId ?? throw new ArgumentNullException("payeeId is a required property for PayExConnectionCallback and cannot be null");
            // to ensure "paymentOptions" is required (not null)
            this.PaymentOptions = paymentOptions ?? throw new ArgumentNullException("paymentOptions is a required property for PayExConnectionCallback and cannot be null");
        ...
        /// </summary>
        /// <value>Perform split settlements on payments. The subsite must be resolved with PayEx reconciliation before being used. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PayExConnectionCallback {\n");
        ...
        {
            return this.Equals(input as PayExConnectionCallback);
        }

        /// <summary>
        /// Returns true if PayExConnectionCallback instances are equal
        /// </summary>
        /// <param name="input">Instance of PayExConnectionCallback to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayExConnectionCallback input)
        {
            if (input == null)
                return false;
