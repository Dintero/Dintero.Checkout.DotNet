...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    public partial class InlineObject5 : IEquatable<InlineObject5>, IValidatableObject
    {
        ...
        public InlineObject5(CollectorConnectionSignup signup = default(CollectorConnectionSignup))
        {
            // to ensure "signup" is required (not null)
            this.Signup = signup ?? throw new ArgumentNullException("signup is a required property for InlineObject5 and cannot be null");
        }
