...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    public partial class Exchange : IEquatable<Exchange>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Exchange" /> class.
        /// </summary>
        /// <param name="accountId">The account_id to create exchange access_token for  (required).</param>
        public Exchange(string accountId = default(string))
        {
            // to ensure "accountId" is required (not null)
            this.AccountId = accountId ?? throw new ArgumentNullException("accountId is a required property for Exchange and cannot be null");
        }

        /// <summary>
        /// The account_id to create exchange access_token for 
        /// </summary>
        /// <value>The account_id to create exchange access_token for </value>
