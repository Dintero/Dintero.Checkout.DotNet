...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// MfaOobAllOf
    /// </summary>
    [DataContract(Name = "mfa_oob_allOf")]
    public partial class MfaOobAllOf : IEquatable<MfaOobAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MfaOobAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MfaOobAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MfaOobAllOf" /> class.
        /// </summary>
        ...
        public MfaOobAllOf(string oobCode = default(string), string bindingCode = default(string), string mfaToken = default(string))
        {
            // to ensure "oobCode" is required (not null)
            this.OobCode = oobCode ?? throw new ArgumentNullException("oobCode is a required property for MfaOobAllOf and cannot be null");
            // to ensure "bindingCode" is required (not null)
            this.BindingCode = bindingCode ?? throw new ArgumentNullException("bindingCode is a required property for MfaOobAllOf and cannot be null");
            // to ensure "mfaToken" is required (not null)
            this.MfaToken = mfaToken ?? throw new ArgumentNullException("mfaToken is a required property for MfaOobAllOf and cannot be null");
        }
        ...
        {
            return this.Equals(input as MfaOobAllOf);
        }

        /// <summary>
        /// Returns true if MfaOobAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of MfaOobAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MfaOobAllOf input)
        {
            if (input == null)
                return false;
