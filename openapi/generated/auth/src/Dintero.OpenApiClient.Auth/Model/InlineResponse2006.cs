...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    public partial class InlineResponse2006 : IEquatable<InlineResponse2006>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="redirectUri">The HTTP URL to redirect to with ID token .</param>
        public InlineResponse2006(Object redirectUri = default(Object))
        {
        ...
        /// </summary>
        /// <value>The HTTP URL to redirect to with ID token </value>
