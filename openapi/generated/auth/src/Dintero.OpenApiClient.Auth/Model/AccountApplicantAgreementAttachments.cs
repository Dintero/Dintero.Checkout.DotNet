...
{
    /// <summary>
    /// AccountApplicantAgreementAttachments
    /// </summary>
    [DataContract(Name = "AccountApplicant_agreement_attachments")]
    public partial class AccountApplicantAgreementAttachments : IEquatable<AccountApplicantAgreementAttachments>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountApplicantAgreementAttachments" /> class.
        /// </summary>
        /// <param name="name">Defines the name of the attachment.</param>
        /// <param name="version">Defines the version of the attachment.</param>
        public AccountApplicantAgreementAttachments(string name = default(string), string version = default(string))
        {
            this.Name = name;
        ...
        /// <summary>
        /// Defines the name of the attachment
        /// </summary>
        /// <value>Defines the name of the attachment</value>
        [DataMember(Name = "name", EmitDefaultValue = false)]
        public string Name { get; set; }

        /// <summary>
        /// Defines the version of the attachment
        /// </summary>
        /// <value>Defines the version of the attachment</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountApplicantAgreementAttachments {\n");
        ...
        {
            return this.Equals(input as AccountApplicantAgreementAttachments);
        }

        /// <summary>
        /// Returns true if AccountApplicantAgreementAttachments instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountApplicantAgreementAttachments to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountApplicantAgreementAttachments input)
        {
            if (input == null)
                return false;
