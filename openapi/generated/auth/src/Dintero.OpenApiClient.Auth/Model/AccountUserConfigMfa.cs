...
{
    /// <summary>
    /// AccountUserConfigMfa
    /// </summary>
    [DataContract(Name = "AccountUserConfig_mfa")]
    public partial class AccountUserConfigMfa : IEquatable<AccountUserConfigMfa>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountUserConfigMfa" /> class.
        /// </summary>
        /// <param name="sms">sms.</param>
        public AccountUserConfigMfa(AccountUserConfigMfaSms sms = default(AccountUserConfigMfaSms))
        {
            this.Sms = sms;
        }
        ...
        public AccountUserConfigMfaSms Sms { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountUserConfigMfa {\n");
        ...
        {
            return this.Equals(input as AccountUserConfigMfa);
        }

        /// <summary>
        /// Returns true if AccountUserConfigMfa instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountUserConfigMfa to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountUserConfigMfa input)
        {
            if (input == null)
                return false;
