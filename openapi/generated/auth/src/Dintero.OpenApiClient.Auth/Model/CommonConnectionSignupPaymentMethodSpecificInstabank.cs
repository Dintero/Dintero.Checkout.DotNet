...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CommonConnectionSignup_payment_method_specific_instabank")]
    public partial class CommonConnectionSignupPaymentMethodSpecificInstabank : IEquatable<CommonConnectionSignupPaymentMethodSpecificInstabank>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonConnectionSignupPaymentMethodSpecificInstabank" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CommonConnectionSignupPaymentMethodSpecificInstabank() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonConnectionSignupPaymentMethodSpecificInstabank" /> class.
        /// </summary>
        ...
        public CommonConnectionSignupPaymentMethodSpecificInstabank(string totalNumberOfTransactions = default(string), string totalVolumeOfTransactions = default(string), string financeNumberOfTransactions = default(string), string financeVolumeOfTransactions = default(string))
        {
            // to ensure "totalNumberOfTransactions" is required (not null)
            this.TotalNumberOfTransactions = totalNumberOfTransactions ?? throw new ArgumentNullException("totalNumberOfTransactions is a required property for CommonConnectionSignupPaymentMethodSpecificInstabank and cannot be null");
            // to ensure "totalVolumeOfTransactions" is required (not null)
            this.TotalVolumeOfTransactions = totalVolumeOfTransactions ?? throw new ArgumentNullException("totalVolumeOfTransactions is a required property for CommonConnectionSignupPaymentMethodSpecificInstabank and cannot be null");
            // to ensure "financeNumberOfTransactions" is required (not null)
            this.FinanceNumberOfTransactions = financeNumberOfTransactions ?? throw new ArgumentNullException("financeNumberOfTransactions is a required property for CommonConnectionSignupPaymentMethodSpecificInstabank and cannot be null");
            // to ensure "financeVolumeOfTransactions" is required (not null)
            this.FinanceVolumeOfTransactions = financeVolumeOfTransactions ?? throw new ArgumentNullException("financeVolumeOfTransactions is a required property for CommonConnectionSignupPaymentMethodSpecificInstabank and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CommonConnectionSignupPaymentMethodSpecificInstabank {\n");
        ...
        {
            return this.Equals(input as CommonConnectionSignupPaymentMethodSpecificInstabank);
        }

        /// <summary>
        /// Returns true if CommonConnectionSignupPaymentMethodSpecificInstabank instances are equal
        /// </summary>
        /// <param name="input">Instance of CommonConnectionSignupPaymentMethodSpecificInstabank to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommonConnectionSignupPaymentMethodSpecificInstabank input)
        {
            if (input == null)
                return false;
