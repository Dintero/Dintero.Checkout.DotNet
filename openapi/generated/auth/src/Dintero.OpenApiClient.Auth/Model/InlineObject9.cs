...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    public partial class InlineObject9 : IEquatable<InlineObject9>, IValidatableObject
    {
        ...
        public InlineObject9(SwishConnectionSignup signup = default(SwishConnectionSignup))
        {
            // to ensure "signup" is required (not null)
            this.Signup = signup ?? throw new ArgumentNullException("signup is a required property for InlineObject9 and cannot be null");
        }
