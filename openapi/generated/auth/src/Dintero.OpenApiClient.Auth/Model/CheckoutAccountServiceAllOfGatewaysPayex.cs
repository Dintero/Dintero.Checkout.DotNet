...
{
    /// <summary>
    /// CheckoutAccountServiceAllOfGatewaysPayex
    /// </summary>
    [DataContract(Name = "CheckoutAccountService_allOf_gateways_payex")]
    public partial class CheckoutAccountServiceAllOfGatewaysPayex : IEquatable<CheckoutAccountServiceAllOfGatewaysPayex>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckoutAccountServiceAllOfGatewaysPayex" /> class.
        /// </summary>
        /// <param name="creditcard">creditcard.</param>
        /// <param name="swish">swish.</param>
        public CheckoutAccountServiceAllOfGatewaysPayex(AccountCheckoutGateway creditcard = default(AccountCheckoutGateway), AccountCheckoutGateway swish = default(AccountCheckoutGateway))
        {
        ...
        public AccountCheckoutGateway Creditcard { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CheckoutAccountServiceAllOfGatewaysPayex {\n");
        ...
        {
            return this.Equals(input as CheckoutAccountServiceAllOfGatewaysPayex);
        }

        /// <summary>
        /// Returns true if CheckoutAccountServiceAllOfGatewaysPayex instances are equal
        /// </summary>
        /// <param name="input">Instance of CheckoutAccountServiceAllOfGatewaysPayex to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CheckoutAccountServiceAllOfGatewaysPayex input)
        {
            if (input == null)
                return false;
