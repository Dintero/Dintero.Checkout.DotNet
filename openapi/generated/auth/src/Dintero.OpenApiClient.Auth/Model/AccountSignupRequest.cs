...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccountSignupRequest")]
    public partial class AccountSignupRequest : IEquatable<AccountSignupRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountSignupRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountSignupRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountSignupRequest" /> class.
        /// </summary>
        ...
        /// <param name="externalIntegrations">externalIntegrations.</param>
        public AccountSignupRequest(AccountApplicant applicant = default(AccountApplicant), AccountCompany company = default(AccountCompany), AccountBilling billing = default(AccountBilling), AccountPrivateDetailsAccountManager accountManager = default(AccountPrivateDetailsAccountManager), AccountSignupRequestExternalIntegrations externalIntegrations = default(AccountSignupRequestExternalIntegrations))
        {
            // to ensure "applicant" is required (not null)
            this.Applicant = applicant ?? throw new ArgumentNullException("applicant is a required property for AccountSignupRequest and cannot be null");
        ...
        /// <summary>
        /// Gets or Sets ExternalIntegrations
        /// </summary>
        [DataMember(Name = "external_integrations", EmitDefaultValue = false)]
        public AccountSignupRequestExternalIntegrations ExternalIntegrations { get; set; }
        ...
        {
            return this.Equals(input as AccountSignupRequest);
        }

        /// <summary>
        /// Returns true if AccountSignupRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountSignupRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountSignupRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ExternalIntegrations == input.ExternalIntegrations ||
                    (this.ExternalIntegrations != null &&
                    this.ExternalIntegrations.Equals(input.ExternalIntegrations))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ExternalIntegrations != null)
                    hashCode = hashCode * 59 + this.ExternalIntegrations.GetHashCode();
                return hashCode;
            }
        }
