...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// ExtendedAccount
    /// </summary>
    [DataContract(Name = "ExtendedAccount")]
    public partial class ExtendedAccount : IEquatable<ExtendedAccount>, IValidatableObject
    {
        /// <summary>
        /// Status assigned to the account by the account partner &gt; value is not visible for the merchant. 
        /// </summary>
        /// <value>Status assigned to the account by the account partner &gt; value is not visible for the merchant. </value>
        ...
        public ProgressionEnum? Progression { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExtendedAccount" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExtendedAccount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExtendedAccount" /> class.
        /// </summary>
        ...
        /// <param name="progression">Status assigned to the account by the account partner &gt; value is not visible for the merchant. .</param>
        /// <param name="resellerId">Reseller id assigned by the account partner &gt; value is not visible for the merchant .</param>
        /// <param name="accountManager">accountManager.</param>
        /// <param name="statistics">statistics.</param>
        public ExtendedAccount(AccountJwksJwks jwks = default(AccountJwksJwks), AccountApplicant applicant = default(AccountApplicant), AccountCompany company = default(AccountCompany), AccountBilling billing = default(AccountBilling), Subscription subscription = default(Subscription), bool livemode = false, string languageCode = default(string), AccountAllOfConnections connections = default(AccountAllOfConnections), AccountAllOfServices services = default(AccountAllOfServices), ProgressionEnum? progression = default(ProgressionEnum?), string resellerId = default(string), AccountPrivateDetailsAccountManager accountManager = default(AccountPrivateDetailsAccountManager), AccountPrivateDetailsStatistics statistics = default(AccountPrivateDetailsStatistics))
        {
            // to ensure "applicant" is required (not null)
            this.Applicant = applicant ?? throw new ArgumentNullException("applicant is a required property for ExtendedAccount and cannot be null");
            // to ensure "company" is required (not null)
            this.Company = company ?? throw new ArgumentNullException("company is a required property for ExtendedAccount and cannot be null");
            // to ensure "billing" is required (not null)
            this.Billing = billing ?? throw new ArgumentNullException("billing is a required property for ExtendedAccount and cannot be null");
            this.Jwks = jwks;
        ...
        /// <summary>
        /// Reseller id assigned by the account partner &gt; value is not visible for the merchant 
        /// </summary>
        /// <value>Reseller id assigned by the account partner &gt; value is not visible for the merchant </value>
        ...
        public AccountPrivateDetailsAccountManager AccountManager { get; set; }

        /// <summary>
        /// Gets or Sets Statistics
        /// </summary>
        [DataMember(Name = "statistics", EmitDefaultValue = false)]
        public AccountPrivateDetailsStatistics Statistics { get; set; }
        ...
        {
            return this.Equals(input as ExtendedAccount);
        }

        /// <summary>
        /// Returns true if ExtendedAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of ExtendedAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExtendedAccount input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.AccountManager == input.AccountManager ||
                    (this.AccountManager != null &&
                    this.AccountManager.Equals(input.AccountManager))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AccountManager != null)
                    hashCode = hashCode * 59 + this.AccountManager.GetHashCode();
