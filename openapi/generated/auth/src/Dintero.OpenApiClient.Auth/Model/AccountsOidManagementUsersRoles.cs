...
{
    /// <summary>
    /// AccountsOidManagementUsersRoles
    /// </summary>
    [DataContract(Name = "_accounts__oid__management_users_roles")]
    public partial class AccountsOidManagementUsersRoles : IEquatable<AccountsOidManagementUsersRoles>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountsOidManagementUsersRoles" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountsOidManagementUsersRoles() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountsOidManagementUsersRoles" /> class.
        /// </summary>
        /// <param name="id">Role ID (required).</param>
        public AccountsOidManagementUsersRoles(string id = default(string))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for AccountsOidManagementUsersRoles and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountsOidManagementUsersRoles {\n");
        ...
        {
            return this.Equals(input as AccountsOidManagementUsersRoles);
        }

        /// <summary>
        /// Returns true if AccountsOidManagementUsersRoles instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountsOidManagementUsersRoles to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountsOidManagementUsersRoles input)
        {
            if (input == null)
                return false;
