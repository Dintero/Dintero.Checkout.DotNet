...
{
    /// <summary>
    /// InstabankConnectionAllOf
    /// </summary>
    [DataContract(Name = "InstabankConnection_allOf")]
    public partial class InstabankConnectionAllOf : IEquatable<InstabankConnectionAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankConnectionAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstabankConnectionAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankConnectionAllOf" /> class.
        /// </summary>
        /// <param name="configuration">configuration.</param>
        /// <param name="signup">signup (required).</param>
        public InstabankConnectionAllOf(InstabankConnectionConfiguration configuration = default(InstabankConnectionConfiguration), InstabankConnectionSignup signup = default(InstabankConnectionSignup))
        {
            // to ensure "signup" is required (not null)
            this.Signup = signup ?? throw new ArgumentNullException("signup is a required property for InstabankConnectionAllOf and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstabankConnectionAllOf {\n");
        ...
        {
            return this.Equals(input as InstabankConnectionAllOf);
        }

        /// <summary>
        /// Returns true if InstabankConnectionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of InstabankConnectionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstabankConnectionAllOf input)
        {
            if (input == null)
                return false;
