...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    public partial class InlineResponse200 : IEquatable<InlineResponse200>, IValidatableObject
    {
        ...
        public InlineResponse200(ChallengeTypeEnum? challengeType = default(ChallengeTypeEnum?), BindingMethodEnum? bindingMethod = default(BindingMethodEnum?), string oobCode = default(string))
        {
