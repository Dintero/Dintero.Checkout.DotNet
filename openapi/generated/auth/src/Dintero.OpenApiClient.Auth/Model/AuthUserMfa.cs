...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AuthUserMfa")]
    public partial class AuthUserMfa : IEquatable<AuthUserMfa>, IValidatableObject
    {
        /// <summary>
        /// Defines OobChannels
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum OobChannelsEnum
        {
            /// <summary>
        ...
        /// <summary>
        /// The supported channels to use for OOB. Can only be used if &#x60;channel_type&#x60; is &#x60;oob&#x60;. 
        /// </summary>
        /// <value>The supported channels to use for OOB. Can only be used if &#x60;channel_type&#x60; is &#x60;oob&#x60;. </value>
        [DataMember(Name = "oob_channels", EmitDefaultValue = false)]
        public List<OobChannelsEnum> OobChannels { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthUserMfa" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuthUserMfa() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthUserMfa" /> class.
        /// </summary>
        /// <param name="challengeType">The challenges types enabled (required) by the user.    enum: - oob  (required).</param>
        /// <param name="oobChannels">The supported channels to use for OOB. Can only be used if &#x60;channel_type&#x60; is &#x60;oob&#x60;. .</param>
        public AuthUserMfa(string challengeType = default(string), List<OobChannelsEnum> oobChannels = default(List<OobChannelsEnum>))
        {
            // to ensure "challengeType" is required (not null)
            this.ChallengeType = challengeType ?? throw new ArgumentNullException("challengeType is a required property for AuthUserMfa and cannot be null");
            this.OobChannels = oobChannels;
        }

        /// <summary>
        /// The challenges types enabled (required) by the user.    enum: - oob 
        /// </summary>
        /// <value>The challenges types enabled (required) by the user.    enum: - oob </value>
        [DataMember(Name = "challenge_type", IsRequired = true, EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthUserMfa {\n");
            sb.Append("  ChallengeType: ").Append(ChallengeType).Append("\n");
            sb.Append("  OobChannels: ").Append(OobChannels).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AuthUserMfa);
        }

        /// <summary>
        /// Returns true if AuthUserMfa instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthUserMfa to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthUserMfa input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.ChallengeType == input.ChallengeType ||
                    (this.ChallengeType != null &&
                    this.ChallengeType.Equals(input.ChallengeType))
                ) && 
                (
                    this.OobChannels == input.OobChannels ||
                    this.OobChannels.SequenceEqual(input.OobChannels)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ChallengeType != null)
                    hashCode = hashCode * 59 + this.ChallengeType.GetHashCode();
                hashCode = hashCode * 59 + this.OobChannels.GetHashCode();
                return hashCode;
            }
        }
