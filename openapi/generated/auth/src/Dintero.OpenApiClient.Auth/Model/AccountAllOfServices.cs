...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Account_allOf_services")]
    public partial class AccountAllOfServices : IEquatable<AccountAllOfServices>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountAllOfServices" /> class.
        /// </summary>
        ...
        public AccountAllOfServices(CheckoutAccountService checkout = default(CheckoutAccountService), AccountService customers = default(AccountService), AccountService discounts = default(AccountService), AccountService shopping = default(AccountService), AccountService receipts = default(AccountService), AccountService wallets = default(AccountService))
        {
        ...
        public CheckoutAccountService Checkout { get; set; }

        /// <summary>
        /// Gets or Sets Customers
        /// </summary>
        [DataMember(Name = "customers", EmitDefaultValue = false)]
        public AccountService Customers { get; set; }

        /// <summary>
        /// Gets or Sets Discounts
        /// </summary>
        [DataMember(Name = "discounts", EmitDefaultValue = false)]
        public AccountService Discounts { get; set; }

        /// <summary>
        /// Gets or Sets Shopping
        /// </summary>
        [DataMember(Name = "shopping", EmitDefaultValue = false)]
        public AccountService Shopping { get; set; }

        /// <summary>
        /// Gets or Sets Receipts
        /// </summary>
        [DataMember(Name = "receipts", EmitDefaultValue = false)]
        public AccountService Receipts { get; set; }

        /// <summary>
        /// Gets or Sets Wallets
        /// </summary>
        [DataMember(Name = "wallets", EmitDefaultValue = false)]
        public AccountService Wallets { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountAllOfServices {\n");
        ...
        {
            return this.Equals(input as AccountAllOfServices);
        }

        /// <summary>
        /// Returns true if AccountAllOfServices instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountAllOfServices to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountAllOfServices input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    (this.Wallets != null &&
                    this.Wallets.Equals(input.Wallets))
                );
        }
