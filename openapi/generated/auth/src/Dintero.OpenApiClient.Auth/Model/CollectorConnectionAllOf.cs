...
{
    /// <summary>
    /// CollectorConnectionAllOf
    /// </summary>
    [DataContract(Name = "CollectorConnection_allOf")]
    public partial class CollectorConnectionAllOf : IEquatable<CollectorConnectionAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorConnectionAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorConnectionAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorConnectionAllOf" /> class.
        /// </summary>
        /// <param name="configuration">configuration.</param>
        /// <param name="signup">signup (required).</param>
        public CollectorConnectionAllOf(CollectorConnectionConfiguration configuration = default(CollectorConnectionConfiguration), CollectorConnectionSignup signup = default(CollectorConnectionSignup))
        {
            // to ensure "signup" is required (not null)
            this.Signup = signup ?? throw new ArgumentNullException("signup is a required property for CollectorConnectionAllOf and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorConnectionAllOf {\n");
        ...
        {
            return this.Equals(input as CollectorConnectionAllOf);
        }

        /// <summary>
        /// Returns true if CollectorConnectionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorConnectionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorConnectionAllOf input)
        {
            if (input == null)
                return false;
