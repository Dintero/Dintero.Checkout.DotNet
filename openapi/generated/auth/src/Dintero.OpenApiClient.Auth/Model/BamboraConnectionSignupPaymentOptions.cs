...
{
    /// <summary>
    /// BamboraConnectionSignupPaymentOptions
    /// </summary>
    [DataContract(Name = "BamboraConnectionSignup_payment_options")]
    public partial class BamboraConnectionSignupPaymentOptions : IEquatable<BamboraConnectionSignupPaymentOptions>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        public enum TypeEnum
        {
            ...
            /// <summary>
            /// Enum Mobilepay for value: bambora.mobilepay
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraConnectionSignupPaymentOptions" /> class.
        /// </summary>
        /// <param name="currencies">currencies.</param>
        /// <param name="type">type.</param>
        public BamboraConnectionSignupPaymentOptions(List<string> currencies = default(List<string>), TypeEnum? type = default(TypeEnum?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BamboraConnectionSignupPaymentOptions {\n");
        ...
        {
            return this.Equals(input as BamboraConnectionSignupPaymentOptions);
        }

        /// <summary>
        /// Returns true if BamboraConnectionSignupPaymentOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of BamboraConnectionSignupPaymentOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BamboraConnectionSignupPaymentOptions input)
        {
            if (input == null)
                return false;
