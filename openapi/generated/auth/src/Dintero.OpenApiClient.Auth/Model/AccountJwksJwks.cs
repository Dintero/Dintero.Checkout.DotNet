...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccountJwks_jwks")]
    public partial class AccountJwksJwks : IEquatable<AccountJwksJwks>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountJwksJwks" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountJwksJwks() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountJwksJwks" /> class.
        /// </summary>
        /// <param name="name">Short name identifying the issuer.  (required).</param>
        /// <param name="uri">uri (required).</param>
        public AccountJwksJwks(string name = default(string), string uri = default(string))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for AccountJwksJwks and cannot be null");
            // to ensure "uri" is required (not null)
            this.Uri = uri ?? throw new ArgumentNullException("uri is a required property for AccountJwksJwks and cannot be null");
        }

        /// <summary>
        /// Short name identifying the issuer. 
        /// </summary>
        /// <value>Short name identifying the issuer. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountJwksJwks {\n");
        ...
        {
            return this.Equals(input as AccountJwksJwks);
        }

        /// <summary>
        /// Returns true if AccountJwksJwks instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountJwksJwks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountJwksJwks input)
        {
            if (input == null)
                return false;
