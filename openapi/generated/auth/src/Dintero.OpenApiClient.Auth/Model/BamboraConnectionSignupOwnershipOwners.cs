...
{
    /// <summary>
    /// BamboraConnectionSignupOwnershipOwners
    /// </summary>
    [DataContract(Name = "BamboraConnectionSignup_ownership_owners")]
    public partial class BamboraConnectionSignupOwnershipOwners : IEquatable<BamboraConnectionSignupOwnershipOwners>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraConnectionSignupOwnershipOwners" /> class.
        /// </summary>
        ...
        public BamboraConnectionSignupOwnershipOwners(string name = default(string), string legalName = default(string), string dateOfBirth = default(string), decimal percentage = default(decimal))
        {
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BamboraConnectionSignupOwnershipOwners {\n");
        ...
        {
            return this.Equals(input as BamboraConnectionSignupOwnershipOwners);
        }

        /// <summary>
        /// Returns true if BamboraConnectionSignupOwnershipOwners instances are equal
        /// </summary>
        /// <param name="input">Instance of BamboraConnectionSignupOwnershipOwners to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BamboraConnectionSignupOwnershipOwners input)
        {
            if (input == null)
                return false;
