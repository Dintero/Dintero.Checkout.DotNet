...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CollectorConnectionSignup")]
    public partial class CollectorConnectionSignup : IEquatable<CollectorConnectionSignup>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorConnectionSignup" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorConnectionSignup() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorConnectionSignup" /> class.
        /// </summary>
        ...
        /// <param name="organizationNumber">organizationNumber (required).</param>
        ...
        /// <param name="website">Company&#39;s website url (required).</param>
        /// <param name="paymentOptions">Payment options to enable for this connection  (required).</param>
        public CollectorConnectionSignup(string businessName = default(string), string legalName = default(string), string organizationNumber = default(string), string bankName = default(string), string accountNumber = default(string), string website = default(string), List<CollectorConnectionCallbackPaymentOptions> paymentOptions = default(List<CollectorConnectionCallbackPaymentOptions>))
        {
            // to ensure "legalName" is required (not null)
            this.LegalName = legalName ?? throw new ArgumentNullException("legalName is a required property for CollectorConnectionSignup and cannot be null");
            // to ensure "organizationNumber" is required (not null)
            this.OrganizationNumber = organizationNumber ?? throw new ArgumentNullException("organizationNumber is a required property for CollectorConnectionSignup and cannot be null");
            // to ensure "bankName" is required (not null)
            this.BankName = bankName ?? throw new ArgumentNullException("bankName is a required property for CollectorConnectionSignup and cannot be null");
            // to ensure "accountNumber" is required (not null)
            this.AccountNumber = accountNumber ?? throw new ArgumentNullException("accountNumber is a required property for CollectorConnectionSignup and cannot be null");
            // to ensure "website" is required (not null)
            this.Website = website ?? throw new ArgumentNullException("website is a required property for CollectorConnectionSignup and cannot be null");
            // to ensure "paymentOptions" is required (not null)
            this.PaymentOptions = paymentOptions ?? throw new ArgumentNullException("paymentOptions is a required property for CollectorConnectionSignup and cannot be null");
        ...
        public List<CollectorConnectionCallbackPaymentOptions> PaymentOptions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorConnectionSignup {\n");
        ...
        {
            return this.Equals(input as CollectorConnectionSignup);
        }

        /// <summary>
        /// Returns true if CollectorConnectionSignup instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorConnectionSignup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorConnectionSignup input)
        {
            if (input == null)
                return false;
