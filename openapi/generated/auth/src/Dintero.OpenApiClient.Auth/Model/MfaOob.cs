...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// MfaOob
    /// </summary>
    [DataContract(Name = "mfa_oob")]
    [JsonConverter(typeof(JsonSubtypes), "GrantType")]
    public partial class MfaOob : AuthToken, IEquatable<MfaOob>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MfaOob" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="MfaOob" /> class.
        /// </summary>
        /// <param name="oobCode">The &#x60;oob_code&#x60; received from the challenge response (required).</param>
        /// <param name="bindingCode">The binding code sent _out of band_. (required).</param>
        /// <param name="mfaToken">The &#x60;mfa_token&#x60; received as part of mfa_required error. (required).</param>
        /// <param name="grantType">grantType (required) (default to &quot;mfa_oob&quot;).</param>
        public MfaOob(string oobCode = default(string), string bindingCode = default(string), string mfaToken = default(string), string grantType = "mfa_oob") : base(grantType)
        {
            // to ensure "oobCode" is required (not null)
            this.OobCode = oobCode ?? throw new ArgumentNullException("oobCode is a required property for MfaOob and cannot be null");
            // to ensure "bindingCode" is required (not null)
            this.BindingCode = bindingCode ?? throw new ArgumentNullException("bindingCode is a required property for MfaOob and cannot be null");
            // to ensure "mfaToken" is required (not null)
            this.MfaToken = mfaToken ?? throw new ArgumentNullException("mfaToken is a required property for MfaOob and cannot be null");
        }

        /// <summary>
        /// The &#x60;oob_code&#x60; received from the challenge response
        /// </summary>
        /// <value>The &#x60;oob_code&#x60; received from the challenge response</value>
        [DataMember(Name = "oob_code", IsRequired = true, EmitDefaultValue = false)]
        public string OobCode { get; set; }

        /// <summary>
        /// The binding code sent _out of band_.
        /// </summary>
        /// <value>The binding code sent _out of band_.</value>
        [DataMember(Name = "binding_code", IsRequired = true, EmitDefaultValue = false)]
        public string BindingCode { get; set; }

        /// <summary>
        /// The &#x60;mfa_token&#x60; received as part of mfa_required error.
        /// </summary>
        /// <value>The &#x60;mfa_token&#x60; received as part of mfa_required error.</value>
        [DataMember(Name = "mfa_token", IsRequired = true, EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MfaOob {\n");
            sb.Append("  ").Append(base.ToString().Replace("\n", "\n  ")).Append("\n");
            sb.Append("  OobCode: ").Append(OobCode).Append("\n");
            sb.Append("  BindingCode: ").Append(BindingCode).Append("\n");
        ...
        {
            return this.Equals(input as MfaOob);
        }

        /// <summary>
        /// Returns true if MfaOob instances are equal
        /// </summary>
        /// <param name="input">Instance of MfaOob to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MfaOob input)
        {
            if (input == null)
                return false;
            ...
            return base.Equals(input) && 
                ...
                (
                    this.BindingCode == input.BindingCode ||
                    (this.BindingCode != null &&
                    this.BindingCode.Equals(input.BindingCode))
                ) && base.Equals(input) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BindingCode != null)
                    hashCode = hashCode * 59 + this.BindingCode.GetHashCode();
