...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// ServiceStatistic
    /// </summary>
    [DataContract(Name = "ServiceStatistic")]
    public partial class ServiceStatistic : IEquatable<ServiceStatistic>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceStatistic" /> class.
        /// </summary>
        /// <param name="startAt">startAt.</param>
        /// <param name="endAt">endAt.</param>
        /// <param name="type">type.</param>
        /// <param name="totalCount">totalCount.</param>
        /// <param name="totalMetricValue">totalMetricValue.</param>
        public ServiceStatistic(string startAt = default(string), string endAt = default(string), string type = default(string), decimal totalCount = default(decimal), decimal totalMetricValue = default(decimal))
        {
        ...
        /// <summary>
        /// Gets or Sets TotalMetricValue
        /// </summary>
        [DataMember(Name = "total_metric_value", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceStatistic {\n");
            sb.Append("  StartAt: ").Append(StartAt).Append("\n");
            sb.Append("  EndAt: ").Append(EndAt).Append("\n");
            sb.Append("  Type: ").Append(Type).Append("\n");
            sb.Append("  TotalCount: ").Append(TotalCount).Append("\n");
            sb.Append("  TotalMetricValue: ").Append(TotalMetricValue).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ServiceStatistic);
        }

        /// <summary>
        /// Returns true if ServiceStatistic instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceStatistic to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceStatistic input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.TotalMetricValue == input.TotalMetricValue ||
                    this.TotalMetricValue.Equals(input.TotalMetricValue)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.TotalMetricValue.GetHashCode();
                return hashCode;
            }
        }
