...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VippsConnectionCallback")]
    public partial class VippsConnectionCallback : IEquatable<VippsConnectionCallback>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VippsConnectionCallback" /> class.
        /// </summary>
        /// <param name="signupId">signupId.</param>
        /// <param name="orgnumber">orgnumber.</param>
        /// <param name="merchantName">merchantName.</param>
        /// <param name="createdTime">createdTime.</param>
        /// <param name="merchantSerialNumber">merchantSerialNumber.</param>
        /// <param name="clientId">clientId.</param>
        /// <param name="clientSecret">clientSecret.</param>
        /// <param name="subscriptionKeys">subscriptionKeys.</param>
        public VippsConnectionCallback(string signupId = default(string), string orgnumber = default(string), string merchantName = default(string), string createdTime = default(string), string merchantSerialNumber = default(string), string clientId = default(string), string clientSecret = default(string), List<AccountsAidManagementSettingsConnectionsVippsCallbackReferenceSubscriptionKeys> subscriptionKeys = default(List<AccountsAidManagementSettingsConnectionsVippsCallbackReferenceSubscriptionKeys>))
        {
        ...
        /// <summary>
        /// Gets or Sets SignupId
        /// </summary>
        [DataMember(Name = "signup-id", EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "merchant-name", EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "merchantSerialNumber", EmitDefaultValue = false)]
        ...
        /// <summary>
        /// Gets or Sets SubscriptionKeys
        /// </summary>
        [DataMember(Name = "subscriptionKeys", EmitDefaultValue = false)]
        public List<AccountsAidManagementSettingsConnectionsVippsCallbackReferenceSubscriptionKeys> SubscriptionKeys { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VippsConnectionCallback {\n");
            sb.Append("  SignupId: ").Append(SignupId).Append("\n");
        ...
        {
            return this.Equals(input as VippsConnectionCallback);
        }

        /// <summary>
        /// Returns true if VippsConnectionCallback instances are equal
        /// </summary>
        /// <param name="input">Instance of VippsConnectionCallback to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VippsConnectionCallback input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    ...
                    (this.SignupId != null &&
                    this.SignupId.Equals(input.SignupId))
                ) && 
                (
                ...
                (
                    this.SubscriptionKeys == input.SubscriptionKeys ||
                    this.SubscriptionKeys != null &&
                    input.SubscriptionKeys != null &&
                    this.SubscriptionKeys.SequenceEqual(input.SubscriptionKeys)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SignupId != null)
                    hashCode = hashCode * 59 + this.SignupId.GetHashCode();
                ...
                if (this.SubscriptionKeys != null)
                    hashCode = hashCode * 59 + this.SubscriptionKeys.GetHashCode();
                return hashCode;
            }
        }
