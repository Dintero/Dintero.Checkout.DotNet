...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// AccountEventComment
    /// </summary>
    [DataContract(Name = "AccountEventComment")]
    [JsonConverter(typeof(JsonSubtypes), "EventType")]
    public partial class AccountEventComment : AccountEvent, IEquatable<AccountEventComment>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountEventComment" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountEventComment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountEventComment" /> class.
        /// </summary>
        /// <param name="eventType">The event_type corresponding to comment event  (required) (default to &quot;AccountEventComment&quot;).</param>
        /// <param name="body">body (required).</param>
        /// <param name="visibility">visibility (required).</param>
        public AccountEventComment(EventTypeEnum eventType = "AccountEventComment", string body = default(string), VisibilityEnum visibility = default(VisibilityEnum)) : base(id, createdAt, createdBy)
        {
            this.EventType = eventType;
            // to ensure "body" is required (not null)
            this.Body = body ?? throw new ArgumentNullException("body is a required property for AccountEventComment and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountEventComment {\n");
        ...
        {
            return this.Equals(input as AccountEventComment);
        }

        /// <summary>
        /// Returns true if AccountEventComment instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountEventComment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountEventComment input)
        {
            if (input == null)
                return false;
