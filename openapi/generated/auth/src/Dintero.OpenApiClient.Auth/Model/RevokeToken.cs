...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// RevokeToken
    /// </summary>
    [DataContract(Name = "RevokeToken")]
    public partial class RevokeToken : IEquatable<RevokeToken>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RevokeToken" /> class.
        /// </summary>
        ...
        public RevokeToken(string token = default(string))
        {
            // to ensure "token" is required (not null)
            this.Token = token ?? throw new ArgumentNullException("token is a required property for RevokeToken and cannot be null");
        }
        ...
        {
            return this.Equals(input as RevokeToken);
        }

        /// <summary>
        /// Returns true if RevokeToken instances are equal
        /// </summary>
        /// <param name="input">Instance of RevokeToken to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RevokeToken input)
        {
            if (input == null)
                return false;
