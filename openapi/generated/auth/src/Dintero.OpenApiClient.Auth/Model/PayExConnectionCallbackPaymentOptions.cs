...
{
    /// <summary>
    /// PayExConnectionCallbackPaymentOptions
    /// </summary>
    [DataContract(Name = "PayExConnectionCallback_payment_options")]
    public partial class PayExConnectionCallbackPaymentOptions : IEquatable<PayExConnectionCallbackPaymentOptions>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExConnectionCallbackPaymentOptions" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayExConnectionCallbackPaymentOptions() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExConnectionCallbackPaymentOptions" /> class.
        /// </summary>
        /// <param name="currencies">currencies (required).</param>
        /// <param name="type">type (required).</param>
        public PayExConnectionCallbackPaymentOptions(List<string> currencies = default(List<string>), TypeEnum type = default(TypeEnum))
        {
            // to ensure "currencies" is required (not null)
            this.Currencies = currencies ?? throw new ArgumentNullException("currencies is a required property for PayExConnectionCallbackPaymentOptions and cannot be null");
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PayExConnectionCallbackPaymentOptions {\n");
        ...
        {
            return this.Equals(input as PayExConnectionCallbackPaymentOptions);
        }

        /// <summary>
        /// Returns true if PayExConnectionCallbackPaymentOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of PayExConnectionCallbackPaymentOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayExConnectionCallbackPaymentOptions input)
        {
            if (input == null)
                return false;
