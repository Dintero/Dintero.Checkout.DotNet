...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    public partial class AuditEvent : IEquatable<AuditEvent>, IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="AuditEvent" /> class.
        /// </summary>
        /// <param name="id">An UUID that uniquely identifies the resource  (required).</param>
        /// <param name="createdAt">The date-time when the resource was created  (required).</param>
        /// <param name="action">Name of the action (required).</param>
        /// <param name="actor">User ID who initiated the action..</param>
        /// <param name="entity">ID of the target entity of the action (required).</param>
        /// <param name="context">Context for the event (required).</param>
        public AuditEvent(Guid id = default(Guid), DateTime createdAt = default(DateTime), string action = default(string), string actor = default(string), string entity = default(string), Object context = default(Object))
        {
            this.Id = id;
            this.CreatedAt = createdAt;
            // to ensure "action" is required (not null)
            this.Action = action ?? throw new ArgumentNullException("action is a required property for AuditEvent and cannot be null");
            // to ensure "entity" is required (not null)
            this.Entity = entity ?? throw new ArgumentNullException("entity is a required property for AuditEvent and cannot be null");
            // to ensure "context" is required (not null)
            this.Context = context ?? throw new ArgumentNullException("context is a required property for AuditEvent and cannot be null");
            this.Actor = actor;
        }
        ...
        /// </summary>
        /// <value>User ID who initiated the action.</value>
        ...
        /// </summary>
        /// <value>ID of the target entity of the action</value>
        ...
        /// </summary>
        /// <value>Context for the event</value>
        ...
        {
            return this.Equals(input as AuditEvent);
        }

        /// <summary>
        /// Returns true if AuditEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditEvent input)
        {
            if (input == null)
                return false;
