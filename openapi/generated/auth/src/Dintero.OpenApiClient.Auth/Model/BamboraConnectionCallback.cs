...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BamboraConnectionCallback")]
    public partial class BamboraConnectionCallback : IEquatable<BamboraConnectionCallback>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraConnectionCallback" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BamboraConnectionCallback() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraConnectionCallback" /> class.
        /// </summary>
        ...
        public BamboraConnectionCallback(string merchantNumber = default(string), string md5Key = default(string), string accessToken = default(string), string secretToken = default(string), List<BamboraConnectionCallbackPaymentOptions> paymentOptions = default(List<BamboraConnectionCallbackPaymentOptions>))
        {
            // to ensure "merchantNumber" is required (not null)
            this.MerchantNumber = merchantNumber ?? throw new ArgumentNullException("merchantNumber is a required property for BamboraConnectionCallback and cannot be null");
            // to ensure "md5Key" is required (not null)
            this.Md5Key = md5Key ?? throw new ArgumentNullException("md5Key is a required property for BamboraConnectionCallback and cannot be null");
            // to ensure "paymentOptions" is required (not null)
            this.PaymentOptions = paymentOptions ?? throw new ArgumentNullException("paymentOptions is a required property for BamboraConnectionCallback and cannot be null");
        ...
        public List<BamboraConnectionCallbackPaymentOptions> PaymentOptions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BamboraConnectionCallback {\n");
        ...
        {
            return this.Equals(input as BamboraConnectionCallback);
        }

        /// <summary>
        /// Returns true if BamboraConnectionCallback instances are equal
        /// </summary>
        /// <param name="input">Instance of BamboraConnectionCallback to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BamboraConnectionCallback input)
        {
            if (input == null)
                return false;
