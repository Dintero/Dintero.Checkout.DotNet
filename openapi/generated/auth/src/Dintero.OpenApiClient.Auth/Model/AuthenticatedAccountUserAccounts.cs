...
{
    /// <summary>
    /// AuthenticatedAccountUserAccounts
    /// </summary>
    [DataContract(Name = "AuthenticatedAccountUser_accounts")]
    public partial class AuthenticatedAccountUserAccounts : IEquatable<AuthenticatedAccountUserAccounts>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthenticatedAccountUserAccounts" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuthenticatedAccountUserAccounts() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthenticatedAccountUserAccounts" /> class.
        /// </summary>
        /// <param name="accountId">The id that uniquely identifies the account (required).</param>
        /// <param name="businessName">businessName.</param>
        /// <param name="organizationNumber">organizationNumber.</param>
        /// <param name="displayName">displayName.</param>
        /// <param name="iconUrl">Url to icon. The image should have equal height and width, around 50px. Will be used to personalize the backoffice and checkout. .</param>
        /// <param name="user">user (required).</param>
        public AuthenticatedAccountUserAccounts(string accountId = default(string), string businessName = default(string), string organizationNumber = default(string), string displayName = default(string), string iconUrl = default(string), AuthenticatedAccountUserUser user = default(AuthenticatedAccountUserUser))
        {
            // to ensure "accountId" is required (not null)
            this.AccountId = accountId ?? throw new ArgumentNullException("accountId is a required property for AuthenticatedAccountUserAccounts and cannot be null");
            // to ensure "user" is required (not null)
            this.User = user ?? throw new ArgumentNullException("user is a required property for AuthenticatedAccountUserAccounts and cannot be null");
        ...
        /// <summary>
        /// Url to icon. The image should have equal height and width, around 50px. Will be used to personalize the backoffice and checkout. 
        /// </summary>
        /// <value>Url to icon. The image should have equal height and width, around 50px. Will be used to personalize the backoffice and checkout. </value>
        ...
        public AuthenticatedAccountUserUser User { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthenticatedAccountUserAccounts {\n");
        ...
        {
            return this.Equals(input as AuthenticatedAccountUserAccounts);
        }

        /// <summary>
        /// Returns true if AuthenticatedAccountUserAccounts instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthenticatedAccountUserAccounts to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthenticatedAccountUserAccounts input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if(this.IconUrl != null && this.IconUrl.Length > 240)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for IconUrl, length must be less than 240.", new [] { "IconUrl" });
            }
