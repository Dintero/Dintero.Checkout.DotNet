...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// CollectorConnection
    /// </summary>
    [DataContract(Name = "CollectorConnection")]
    public partial class CollectorConnection : IEquatable<CollectorConnection>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorConnection" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorConnection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorConnection" /> class.
        /// </summary>
        ...
        public CollectorConnection(Object metadata = default(Object), StatusEnum? status = default(StatusEnum?), List<AccountConnectionEvent> events = default(List<AccountConnectionEvent>), CollectorConnectionConfiguration configuration = default(CollectorConnectionConfiguration), CollectorConnectionSignup signup = default(CollectorConnectionSignup))
        {
            // to ensure "signup" is required (not null)
            this.Signup = signup ?? throw new ArgumentNullException("signup is a required property for CollectorConnection and cannot be null");
        ...
        public CollectorConnectionConfiguration Configuration { get; set; }

        /// <summary>
        /// Gets or Sets Signup
        /// </summary>
        [DataMember(Name = "signup", IsRequired = true, EmitDefaultValue = false)]
        public CollectorConnectionSignup Signup { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorConnection {\n");
        ...
        {
            return this.Equals(input as CollectorConnection);
        }

        /// <summary>
        /// Returns true if CollectorConnection instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorConnection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorConnection input)
        {
            if (input == null)
                return false;
