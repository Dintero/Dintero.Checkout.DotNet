...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// Password
    /// </summary>
    [DataContract(Name = "password")]
    [JsonConverter(typeof(JsonSubtypes), "GrantType")]
    public partial class Password : AuthToken, IEquatable<Password>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="grantType">grantType (required) (default to &quot;password&quot;).</param>
        public Password(string username = default(string), string password = default(string), string audience = default(string), string grantType = "password") : base(grantType)
        {
            // to ensure "username" is required (not null)
            this.Username = username ?? throw new ArgumentNullException("username is a required property for Password and cannot be null");
            // to ensure "password" is required (not null)
            this._Password = password ?? throw new ArgumentNullException("password is a required property for Password and cannot be null");
            // to ensure "audience" is required (not null)
            this.Audience = audience ?? throw new ArgumentNullException("audience is a required property for Password and cannot be null");
        }
        ...
        public bool Equals(Password input)
        {
            ...
            return base.Equals(input) && 
                ...
                (
                    ...
                    (this._Password != null &&
                    this._Password.Equals(input._Password))
                ) && base.Equals(input) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this._Password != null)
                    hashCode = hashCode * 59 + this._Password.GetHashCode();
