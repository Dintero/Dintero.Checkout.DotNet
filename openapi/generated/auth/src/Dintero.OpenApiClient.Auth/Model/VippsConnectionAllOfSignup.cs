...
{
    /// <summary>
    /// VippsConnectionAllOfSignup
    /// </summary>
    [DataContract(Name = "VippsConnection_allOf_signup")]
    public partial class VippsConnectionAllOfSignup : IEquatable<VippsConnectionAllOfSignup>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VippsConnectionAllOfSignup" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VippsConnectionAllOfSignup() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VippsConnectionAllOfSignup" /> class.
        /// </summary>
        /// <param name="createdAt">The time when signup was initiated  (required).</param>
        /// <param name="id">Signup ID from Vipps  (required).</param>
        /// <param name="url">Signup URL from Vipps, where merchant can complete the signup  (required).</param>
        /// <param name="callbackAt">Result from callback received from Vipps after merchant completed the signup, and Vipps approved it. .</param>
        /// <param name="expiresAt">The Vipps signup URL expires after 30 days. .</param>
        public VippsConnectionAllOfSignup(DateTime createdAt = default(DateTime), string id = default(string), string url = default(string), DateTime callbackAt = default(DateTime), DateTime expiresAt = default(DateTime))
        {
            this.CreatedAt = createdAt;
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for VippsConnectionAllOfSignup and cannot be null");
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url is a required property for VippsConnectionAllOfSignup and cannot be null");
        ...
        /// </summary>
        /// <value>The time when signup was initiated </value>
        ...
        /// </summary>
        /// <value>Signup ID from Vipps </value>
        ...
        /// </summary>
        /// <value>Signup URL from Vipps, where merchant can complete the signup </value>
        [DataMember(Name = "url", IsRequired = true, EmitDefaultValue = false)]
        public string Url { get; set; }

        /// <summary>
        /// Result from callback received from Vipps after merchant completed the signup, and Vipps approved it. 
        /// </summary>
        /// <value>Result from callback received from Vipps after merchant completed the signup, and Vipps approved it. </value>
        ...
        /// </summary>
        /// <value>The Vipps signup URL expires after 30 days. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VippsConnectionAllOfSignup {\n");
        ...
        {
            return this.Equals(input as VippsConnectionAllOfSignup);
        }

        /// <summary>
        /// Returns true if VippsConnectionAllOfSignup instances are equal
        /// </summary>
        /// <param name="input">Instance of VippsConnectionAllOfSignup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VippsConnectionAllOfSignup input)
        {
            if (input == null)
                return false;
