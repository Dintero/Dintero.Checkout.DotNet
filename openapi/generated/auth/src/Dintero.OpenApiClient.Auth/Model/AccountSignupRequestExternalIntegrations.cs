...
{
    /// <summary>
    /// AccountSignupRequestExternalIntegrations
    /// </summary>
    [DataContract(Name = "AccountSignupRequest_external_integrations")]
    public partial class AccountSignupRequestExternalIntegrations : IEquatable<AccountSignupRequestExternalIntegrations>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountSignupRequestExternalIntegrations" /> class.
        /// </summary>
        /// <param name="wallmobSignup">wallmobSignup.</param>
        public AccountSignupRequestExternalIntegrations(AccountSignupRequestExternalIntegrationsWallmobSignup wallmobSignup = default(AccountSignupRequestExternalIntegrationsWallmobSignup))
        {
            this.WallmobSignup = wallmobSignup;
        }

        /// <summary>
        /// Gets or Sets WallmobSignup
        /// </summary>
        [DataMember(Name = "wallmob_signup", EmitDefaultValue = false)]
        public AccountSignupRequestExternalIntegrationsWallmobSignup WallmobSignup { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountSignupRequestExternalIntegrations {\n");
            sb.Append("  WallmobSignup: ").Append(WallmobSignup).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AccountSignupRequestExternalIntegrations);
        }

        /// <summary>
        /// Returns true if AccountSignupRequestExternalIntegrations instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountSignupRequestExternalIntegrations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountSignupRequestExternalIntegrations input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.WallmobSignup == input.WallmobSignup ||
                    (this.WallmobSignup != null &&
                    this.WallmobSignup.Equals(input.WallmobSignup))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.WallmobSignup != null)
                    hashCode = hashCode * 59 + this.WallmobSignup.GetHashCode();
                return hashCode;
            }
        }
