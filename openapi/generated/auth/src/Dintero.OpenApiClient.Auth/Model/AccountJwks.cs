...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// AccountJwks
    /// </summary>
    [DataContract(Name = "AccountJwks")]
    public partial class AccountJwks : IEquatable<AccountJwks>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountJwks" /> class.
        /// </summary>
        /// <param name="jwks">jwks.</param>
        public AccountJwks(AccountJwksJwks jwks = default(AccountJwksJwks))
        {
            this.Jwks = jwks;
        }
        ...
        {
            return this.Equals(input as AccountJwks);
        }

        /// <summary>
        /// Returns true if AccountJwks instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountJwks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountJwks input)
        {
            if (input == null)
                return false;
