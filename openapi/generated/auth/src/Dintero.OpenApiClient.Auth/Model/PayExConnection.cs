...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// PayExConnection
    /// </summary>
    [DataContract(Name = "PayExConnection")]
    public partial class PayExConnection : IEquatable<PayExConnection>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExConnection" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayExConnection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExConnection" /> class.
        /// </summary>
        ...
        public PayExConnection(Object metadata = default(Object), StatusEnum? status = default(StatusEnum?), List<AccountConnectionEvent> events = default(List<AccountConnectionEvent>), PayExConnectionConfiguration configuration = default(PayExConnectionConfiguration), PayExConnectionSignup signup = default(PayExConnectionSignup))
        {
            // to ensure "signup" is required (not null)
            this.Signup = signup ?? throw new ArgumentNullException("signup is a required property for PayExConnection and cannot be null");
        ...
        public PayExConnectionConfiguration Configuration { get; set; }

        /// <summary>
        /// Gets or Sets Signup
        /// </summary>
        [DataMember(Name = "signup", IsRequired = true, EmitDefaultValue = false)]
        public PayExConnectionSignup Signup { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PayExConnection {\n");
        ...
        {
            return this.Equals(input as PayExConnection);
        }

        /// <summary>
        /// Returns true if PayExConnection instances are equal
        /// </summary>
        /// <param name="input">Instance of PayExConnection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayExConnection input)
        {
            if (input == null)
                return false;
