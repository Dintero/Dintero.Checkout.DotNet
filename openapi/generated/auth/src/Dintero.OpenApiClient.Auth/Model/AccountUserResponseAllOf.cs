...
{
    /// <summary>
    /// AccountUserResponseAllOf
    /// </summary>
    [DataContract(Name = "AccountUserResponse_allOf")]
    public partial class AccountUserResponseAllOf : IEquatable<AccountUserResponseAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountUserResponseAllOf" /> class.
        /// </summary>
        /// <param name="roles">roles.</param>
        /// <param name="lastSeenAt">lastSeenAt.</param>
        /// <param name="configuration">configuration.</param>
        public AccountUserResponseAllOf(List<AuthRole> roles = default(List<AuthRole>), DateTime lastSeenAt = default(DateTime), AccountUserConfig configuration = default(AccountUserConfig))
        {
            this.Roles = roles;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountUserResponseAllOf {\n");
        ...
        {
            return this.Equals(input as AccountUserResponseAllOf);
        }

        /// <summary>
        /// Returns true if AccountUserResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountUserResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountUserResponseAllOf input)
        {
            if (input == null)
                return false;
