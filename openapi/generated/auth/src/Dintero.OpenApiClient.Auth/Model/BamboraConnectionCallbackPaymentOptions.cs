...
{
    /// <summary>
    /// BamboraConnectionCallbackPaymentOptions
    /// </summary>
    [DataContract(Name = "BamboraConnectionCallback_payment_options")]
    public partial class BamboraConnectionCallbackPaymentOptions : IEquatable<BamboraConnectionCallbackPaymentOptions>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraConnectionCallbackPaymentOptions" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BamboraConnectionCallbackPaymentOptions() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraConnectionCallbackPaymentOptions" /> class.
        /// </summary>
        /// <param name="currencies">currencies (required).</param>
        /// <param name="type">type (required).</param>
        public BamboraConnectionCallbackPaymentOptions(List<string> currencies = default(List<string>), TypeEnum type = default(TypeEnum))
        {
            // to ensure "currencies" is required (not null)
            this.Currencies = currencies ?? throw new ArgumentNullException("currencies is a required property for BamboraConnectionCallbackPaymentOptions and cannot be null");
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BamboraConnectionCallbackPaymentOptions {\n");
        ...
        {
            return this.Equals(input as BamboraConnectionCallbackPaymentOptions);
        }

        /// <summary>
        /// Returns true if BamboraConnectionCallbackPaymentOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of BamboraConnectionCallbackPaymentOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BamboraConnectionCallbackPaymentOptions input)
        {
            if (input == null)
                return false;
