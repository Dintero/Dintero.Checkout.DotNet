...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    public partial class InlineObject7 : IEquatable<InlineObject7>, IValidatableObject
    {
        ...
        public InlineObject7(InstabankConnectionSignup signup = default(InstabankConnectionSignup))
        {
            // to ensure "signup" is required (not null)
            this.Signup = signup ?? throw new ArgumentNullException("signup is a required property for InlineObject7 and cannot be null");
        }
