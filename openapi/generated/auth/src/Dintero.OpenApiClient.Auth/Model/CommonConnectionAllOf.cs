...
{
    /// <summary>
    /// CommonConnectionAllOf
    /// </summary>
    [DataContract(Name = "CommonConnection_allOf")]
    public partial class CommonConnectionAllOf : IEquatable<CommonConnectionAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonConnectionAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CommonConnectionAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonConnectionAllOf" /> class.
        /// </summary>
        /// <param name="signup">signup (required).</param>
        public CommonConnectionAllOf(CommonConnectionSignup signup = default(CommonConnectionSignup))
        {
            // to ensure "signup" is required (not null)
            this.Signup = signup ?? throw new ArgumentNullException("signup is a required property for CommonConnectionAllOf and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CommonConnectionAllOf {\n");
        ...
        {
            return this.Equals(input as CommonConnectionAllOf);
        }

        /// <summary>
        /// Returns true if CommonConnectionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CommonConnectionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommonConnectionAllOf input)
        {
            if (input == null)
                return false;
