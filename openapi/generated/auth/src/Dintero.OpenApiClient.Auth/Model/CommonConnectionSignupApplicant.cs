...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CommonConnectionSignup_applicant")]
    public partial class CommonConnectionSignupApplicant : IEquatable<CommonConnectionSignupApplicant>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonConnectionSignupApplicant" /> class.
        /// </summary>
        /// <param name="firstName">firstName.</param>
        /// <param name="lastName">lastName.</param>
        /// <param name="email">email.</param>
        /// <param name="phoneNumber">A phone number in E.164 number formatting. .</param>
        public CommonConnectionSignupApplicant(string firstName = default(string), string lastName = default(string), string email = default(string), string phoneNumber = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CommonConnectionSignupApplicant {\n");
        ...
        {
            return this.Equals(input as CommonConnectionSignupApplicant);
        }

        /// <summary>
        /// Returns true if CommonConnectionSignupApplicant instances are equal
        /// </summary>
        /// <param name="input">Instance of CommonConnectionSignupApplicant to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommonConnectionSignupApplicant input)
        {
            if (input == null)
                return false;
