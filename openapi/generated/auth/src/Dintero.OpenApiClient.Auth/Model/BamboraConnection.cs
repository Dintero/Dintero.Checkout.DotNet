...
namespace Dintero.OpenApiClient.Auth.Model
{
    ...
    /// BamboraConnection
    /// </summary>
    [DataContract(Name = "BamboraConnection")]
    public partial class BamboraConnection : IEquatable<BamboraConnection>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraConnection" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BamboraConnection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraConnection" /> class.
        /// </summary>
        ...
        public BamboraConnection(Object metadata = default(Object), StatusEnum? status = default(StatusEnum?), List<AccountConnectionEvent> events = default(List<AccountConnectionEvent>), BamboraConnectionConfiguration configuration = default(BamboraConnectionConfiguration), BamboraConnectionSignup signup = default(BamboraConnectionSignup))
        {
            // to ensure "signup" is required (not null)
            this.Signup = signup ?? throw new ArgumentNullException("signup is a required property for BamboraConnection and cannot be null");
        ...
        public BamboraConnectionConfiguration Configuration { get; set; }

        /// <summary>
        /// Gets or Sets Signup
        /// </summary>
        [DataMember(Name = "signup", IsRequired = true, EmitDefaultValue = false)]
        public BamboraConnectionSignup Signup { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BamboraConnection {\n");
        ...
        {
            return this.Equals(input as BamboraConnection);
        }

        /// <summary>
        /// Returns true if BamboraConnection instances are equal
        /// </summary>
        /// <param name="input">Instance of BamboraConnection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BamboraConnection input)
        {
            if (input == null)
                return false;
