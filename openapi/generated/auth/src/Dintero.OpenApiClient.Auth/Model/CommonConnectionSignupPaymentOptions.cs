...
{
    /// <summary>
    /// CommonConnectionSignupPaymentOptions
    /// </summary>
    [DataContract(Name = "CommonConnectionSignup_payment_options")]
    public partial class CommonConnectionSignupPaymentOptions : IEquatable<CommonConnectionSignupPaymentOptions>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonConnectionSignupPaymentOptions" /> class.
        /// </summary>
        /// <param name="currencies">currencies.</param>
        /// <param name="type">type.</param>
        public CommonConnectionSignupPaymentOptions(List<string> currencies = default(List<string>), TypeEnum? type = default(TypeEnum?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CommonConnectionSignupPaymentOptions {\n");
        ...
        {
            return this.Equals(input as CommonConnectionSignupPaymentOptions);
        }

        /// <summary>
        /// Returns true if CommonConnectionSignupPaymentOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of CommonConnectionSignupPaymentOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommonConnectionSignupPaymentOptions input)
        {
            if (input == null)
                return false;
