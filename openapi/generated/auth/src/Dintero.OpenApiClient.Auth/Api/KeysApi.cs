...
namespace Dintero.OpenApiClient.Auth.Api
{
    ...
    public interface IKeysApiSync : IApiAccessor
    {
        ...
        ApiResponse<List<InlineResponse2004>> AidAuthsKeysGetWithHttpInfo(string oid);
    ...
    public interface IKeysApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<InlineResponse2004>> AidAuthsKeysGetAsync(string oid, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<InlineResponse2004>>> AidAuthsKeysGetWithHttpInfoAsync(string oid, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class KeysApi : IKeysApi
    {
        ...
        /// <returns></returns>
        public KeysApi(Dintero.OpenApiClient.Auth.Client.Configuration configuration)
        {
        ...
        public KeysApi(Dintero.OpenApiClient.Auth.Client.ISynchronousClient client, Dintero.OpenApiClient.Auth.Client.IAsynchronousClient asyncClient, Dintero.OpenApiClient.Auth.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Get public keys Retrieve the JSON Web Key Set (JWKS) that can be used to validate &#x60;access_token&#x60;  scopes: - admin:accounts - read:accounts 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Auth.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="oid">An id that uniquely identifies the account or owner (partner) </param>
        /// <returns>List&lt;InlineResponse2004&gt;</returns>
        public List<InlineResponse2004> AidAuthsKeysGet(string oid)
        {
            Dintero.OpenApiClient.Auth.Client.ApiResponse<List<InlineResponse2004>> localVarResponse = AidAuthsKeysGetWithHttpInfo(oid);
        ...
        /// <param name="oid">An id that uniquely identifies the account or owner (partner) </param>
        /// <returns>ApiResponse of List&lt;InlineResponse2004&gt;</returns>
        public Dintero.OpenApiClient.Auth.Client.ApiResponse<List<InlineResponse2004>> AidAuthsKeysGetWithHttpInfo(string oid)
        {
            // verify the required parameter 'oid' is set
            if (oid == null)
                throw new Dintero.OpenApiClient.Auth.Client.ApiException(400, "Missing required parameter 'oid' when calling KeysApi->AidAuthsKeysGet");
            ...
            var localVarResponse = this.Client.Get<List<InlineResponse2004>>("/accounts/{oid}/auth/keys", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("AidAuthsKeysGet", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;InlineResponse2004&gt;</returns>
        public async System.Threading.Tasks.Task<List<InlineResponse2004>> AidAuthsKeysGetAsync(string oid, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Auth.Client.ApiResponse<List<InlineResponse2004>> localVarResponse = await AidAuthsKeysGetWithHttpInfoAsync(oid, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;InlineResponse2004&gt;)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Auth.Client.ApiResponse<List<InlineResponse2004>>> AidAuthsKeysGetWithHttpInfoAsync(string oid, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'oid' is set
            if (oid == null)
                throw new Dintero.OpenApiClient.Auth.Client.ApiException(400, "Missing required parameter 'oid' when calling KeysApi->AidAuthsKeysGet");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<InlineResponse2004>>("/accounts/{oid}/auth/keys", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
