...
namespace Dintero.OpenApiClient.Auth.Api
{
    ...
    public interface IAccountSettingsApiSync : IApiAccessor
    {
        ...
        ApiResponse<Account> AidAccountAidGetWithHttpInfo(string aid);
        /// <summary>
        ...
        /// <param name="data"></param>
        /// <returns>ApiResponse of Account</returns>
        ApiResponse<Account> AidAccountSettingsPutWithHttpInfo(string aid, InlineObject3 data);
    ...
    public interface IAccountSettingsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Account> AidAccountAidGetAsync(string aid, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Account>> AidAccountAidGetWithHttpInfoAsync(string aid, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Update Account Settings
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Account</returns>
        System.Threading.Tasks.Task<Account> AidAccountSettingsPutAsync(string aid, InlineObject3 data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Account)</returns>
        System.Threading.Tasks.Task<ApiResponse<Account>> AidAccountSettingsPutWithHttpInfoAsync(string aid, InlineObject3 data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class AccountSettingsApi : IAccountSettingsApi
    {
        ...
        /// <returns></returns>
        public AccountSettingsApi(Dintero.OpenApiClient.Auth.Client.Configuration configuration)
        {
        ...
        public AccountSettingsApi(Dintero.OpenApiClient.Auth.Client.ISynchronousClient client, Dintero.OpenApiClient.Auth.Client.IAsynchronousClient asyncClient, Dintero.OpenApiClient.Auth.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Get Account settings Get details about the account  scopes: - admin:accounts - read:accounts 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Auth.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="aid">An id that uniquely identifies the account. </param>
        /// <returns>Account</returns>
        public Account AidAccountAidGet(string aid)
        {
            Dintero.OpenApiClient.Auth.Client.ApiResponse<Account> localVarResponse = AidAccountAidGetWithHttpInfo(aid);
        ...
        /// <param name="aid">An id that uniquely identifies the account. </param>
        /// <returns>ApiResponse of Account</returns>
        public Dintero.OpenApiClient.Auth.Client.ApiResponse<Account> AidAccountAidGetWithHttpInfo(string aid)
        {
            // verify the required parameter 'aid' is set
            if (aid == null)
                throw new Dintero.OpenApiClient.Auth.Client.ApiException(400, "Missing required parameter 'aid' when calling AccountSettingsApi->AidAccountAidGet");
            ...
            var localVarResponse = this.Client.Get<Account>("/accounts/{aid}/management/settings", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("AidAccountAidGet", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Account</returns>
        public async System.Threading.Tasks.Task<Account> AidAccountAidGetAsync(string aid, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Auth.Client.ApiResponse<Account> localVarResponse = await AidAccountAidGetWithHttpInfoAsync(aid, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Account)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Auth.Client.ApiResponse<Account>> AidAccountAidGetWithHttpInfoAsync(string aid, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'aid' is set
            if (aid == null)
                throw new Dintero.OpenApiClient.Auth.Client.ApiException(400, "Missing required parameter 'aid' when calling AccountSettingsApi->AidAccountAidGet");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<Account>("/accounts/{aid}/management/settings", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Update Account Settings Update account settings  scopes: - admin:accounts - write:accounts 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Auth.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="aid">An id that uniquely identifies the account. </param>
        /// <param name="data"></param>
        /// <returns>Account</returns>
        public Account AidAccountSettingsPut(string aid, InlineObject3 data)
        {
            Dintero.OpenApiClient.Auth.Client.ApiResponse<Account> localVarResponse = AidAccountSettingsPutWithHttpInfo(aid, data);
            return localVarResponse.Data;
        }
        ...
        /// <param name="data"></param>
        /// <returns>ApiResponse of Account</returns>
        public Dintero.OpenApiClient.Auth.Client.ApiResponse<Account> AidAccountSettingsPutWithHttpInfo(string aid, InlineObject3 data)
        {
            // verify the required parameter 'aid' is set
            if (aid == null)
                throw new Dintero.OpenApiClient.Auth.Client.ApiException(400, "Missing required parameter 'aid' when calling AccountSettingsApi->AidAccountSettingsPut");

            // verify the required parameter 'data' is set
            if (data == null)
                throw new Dintero.OpenApiClient.Auth.Client.ApiException(400, "Missing required parameter 'data' when calling AccountSettingsApi->AidAccountSettingsPut");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Put<Account>("/accounts/{aid}/management/settings", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("AidAccountSettingsPut", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Account</returns>
        public async System.Threading.Tasks.Task<Account> AidAccountSettingsPutAsync(string aid, InlineObject3 data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Auth.Client.ApiResponse<Account> localVarResponse = await AidAccountSettingsPutWithHttpInfoAsync(aid, data, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Account)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Auth.Client.ApiResponse<Account>> AidAccountSettingsPutWithHttpInfoAsync(string aid, InlineObject3 data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'aid' is set
            if (aid == null)
                throw new Dintero.OpenApiClient.Auth.Client.ApiException(400, "Missing required parameter 'aid' when calling AccountSettingsApi->AidAccountSettingsPut");
            ...
            var localVarResponse = await this.AsynchronousClient.PutAsync<Account>("/accounts/{aid}/management/settings", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
