...
namespace Dintero.OpenApiClient.Auth.Api
{
    ...
    /// </summary>
    public interface IAccountAssetsApiSync : IApiAccessor
    {
        ...
        ApiResponse<InlineResponse2002> AidAccountAssetsPostWithHttpInfo(string aid, InlineObject2 data);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAccountAssetsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<InlineResponse2002> AidAccountAssetsPostAsync(string aid, InlineObject2 data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse2002>> AidAccountAssetsPostWithHttpInfoAsync(string aid, InlineObject2 data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAccountAssetsApi : IAccountAssetsApiSync, IAccountAssetsApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class AccountAssetsApi : IAccountAssetsApi
    {
        private Dintero.OpenApiClient.Auth.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="AccountAssetsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public AccountAssetsApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public AccountAssetsApi(String basePath)
        {
        ...
        /// <returns></returns>
        public AccountAssetsApi(Dintero.OpenApiClient.Auth.Client.Configuration configuration)
        {
        ...
        public AccountAssetsApi(Dintero.OpenApiClient.Auth.Client.ISynchronousClient client, Dintero.OpenApiClient.Auth.Client.IAsynchronousClient asyncClient, Dintero.OpenApiClient.Auth.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Create asset upload url Create an upload URL that can be used to transfere the asset  scopes: - admin:accounts - write:accounts 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Auth.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="aid">An id that uniquely identifies the account. </param>
        /// <param name="data"></param>
        /// <returns>InlineResponse2002</returns>
        public InlineResponse2002 AidAccountAssetsPost(string aid, InlineObject2 data)
        {
            Dintero.OpenApiClient.Auth.Client.ApiResponse<InlineResponse2002> localVarResponse = AidAccountAssetsPostWithHttpInfo(aid, data);
        ...
        /// <param name="data"></param>
        /// <returns>ApiResponse of InlineResponse2002</returns>
        public Dintero.OpenApiClient.Auth.Client.ApiResponse<InlineResponse2002> AidAccountAssetsPostWithHttpInfo(string aid, InlineObject2 data)
        {
            // verify the required parameter 'aid' is set
            if (aid == null)
                throw new Dintero.OpenApiClient.Auth.Client.ApiException(400, "Missing required parameter 'aid' when calling AccountAssetsApi->AidAccountAssetsPost");

            // verify the required parameter 'data' is set
            if (data == null)
                throw new Dintero.OpenApiClient.Auth.Client.ApiException(400, "Missing required parameter 'data' when calling AccountAssetsApi->AidAccountAssetsPost");
            ...
            var localVarResponse = this.Client.Post<InlineResponse2002>("/accounts/{aid}/management/assets", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("AidAccountAssetsPost", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse2002</returns>
        public async System.Threading.Tasks.Task<InlineResponse2002> AidAccountAssetsPostAsync(string aid, InlineObject2 data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Auth.Client.ApiResponse<InlineResponse2002> localVarResponse = await AidAccountAssetsPostWithHttpInfoAsync(aid, data, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse2002)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Auth.Client.ApiResponse<InlineResponse2002>> AidAccountAssetsPostWithHttpInfoAsync(string aid, InlineObject2 data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'aid' is set
            if (aid == null)
                throw new Dintero.OpenApiClient.Auth.Client.ApiException(400, "Missing required parameter 'aid' when calling AccountAssetsApi->AidAccountAssetsPost");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<InlineResponse2002>("/accounts/{aid}/management/assets", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
