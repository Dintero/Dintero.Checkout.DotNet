...
namespace Dintero.OpenApiClient.Auth.Api
{
    ...
    /// </summary>
    public interface IAccountOnboardingApiSync : IApiAccessor
    {
        ...
        ApiResponse<Object> AccountsOidSignupPostWithHttpInfo(string oid, AccountSignupRequest data);
        /// <summary>
        /// Verify signup
        /// </summary>
        /// <remarks>
        ...
        /// <exception cref="Dintero.OpenApiClient.Auth.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="oid">An id that uniquely identifies the account or owner (partner) </param>
        /// <param name="verificationCode">Verification code sent to the applicant email when requesting a signup [POST /accounts/{oid}/signup](#operation/accounts_oid_signup_post) </param>
        /// <param name="authorize">Request access tokens to be included in the response.  (optional)</param>
        /// <returns>EmailAuthorizedUser</returns>
        EmailAuthorizedUser AccountsOidSignupVerifyPost(string oid, string verificationCode, string authorize = default(string));
        ...
        /// <param name="verificationCode">Verification code sent to the applicant email when requesting a signup [POST /accounts/{oid}/signup](#operation/accounts_oid_signup_post) </param>
        /// <param name="authorize">Request access tokens to be included in the response.  (optional)</param>
        /// <returns>ApiResponse of EmailAuthorizedUser</returns>
        ApiResponse<EmailAuthorizedUser> AccountsOidSignupVerifyPostWithHttpInfo(string oid, string verificationCode, string authorize = default(string));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAccountOnboardingApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task AccountsOidSignupPostAsync(string oid, AccountSignupRequest data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> AccountsOidSignupPostWithHttpInfoAsync(string oid, AccountSignupRequest data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Verify signup
        /// </summary>
        /// <remarks>
        ...
        /// <param name="authorize">Request access tokens to be included in the response.  (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of EmailAuthorizedUser</returns>
        System.Threading.Tasks.Task<EmailAuthorizedUser> AccountsOidSignupVerifyPostAsync(string oid, string verificationCode, string authorize = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="authorize">Request access tokens to be included in the response.  (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (EmailAuthorizedUser)</returns>
        System.Threading.Tasks.Task<ApiResponse<EmailAuthorizedUser>> AccountsOidSignupVerifyPostWithHttpInfoAsync(string oid, string verificationCode, string authorize = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAccountOnboardingApi : IAccountOnboardingApiSync, IAccountOnboardingApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class AccountOnboardingApi : IAccountOnboardingApi
    {
        private Dintero.OpenApiClient.Auth.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="AccountOnboardingApi"/> class.
        /// </summary>
        /// <returns></returns>
        public AccountOnboardingApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public AccountOnboardingApi(String basePath)
        {
        ...
        /// <returns></returns>
        public AccountOnboardingApi(Dintero.OpenApiClient.Auth.Client.Configuration configuration)
        {
        ...
        public AccountOnboardingApi(Dintero.OpenApiClient.Auth.Client.ISynchronousClient client, Dintero.OpenApiClient.Auth.Client.IAsynchronousClient asyncClient, Dintero.OpenApiClient.Auth.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Signup to Dintero Account Initiate a signup for Dintero Account  - An email verification request will be sent to the applicant,   that contains a code that must be sent to   [POST /account/{oid}/signup/verify](#operation/accounts_oid_signup_verify_post)  - A welcome email will be sent after verification of the applicant email   is completed. The email contains links to Backoffice  scopes: - create:account 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Auth.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="oid">An id that uniquely identifies the account or owner (partner) </param>
        /// <param name="data"></param>
        /// <returns></returns>
        public void AccountsOidSignupPost(string oid, AccountSignupRequest data)
        {
            AccountsOidSignupPostWithHttpInfo(oid, data);
        }
        ...
        /// <param name="data"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Dintero.OpenApiClient.Auth.Client.ApiResponse<Object> AccountsOidSignupPostWithHttpInfo(string oid, AccountSignupRequest data)
        {
            // verify the required parameter 'oid' is set
            if (oid == null)
                throw new Dintero.OpenApiClient.Auth.Client.ApiException(400, "Missing required parameter 'oid' when calling AccountOnboardingApi->AccountsOidSignupPost");

            // verify the required parameter 'data' is set
            if (data == null)
                throw new Dintero.OpenApiClient.Auth.Client.ApiException(400, "Missing required parameter 'data' when calling AccountOnboardingApi->AccountsOidSignupPost");
            ...
            var localVarResponse = this.Client.Post<Object>("/accounts/{oid}/signup", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("AccountsOidSignupPost", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task AccountsOidSignupPostAsync(string oid, AccountSignupRequest data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await AccountsOidSignupPostWithHttpInfoAsync(oid, data, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Auth.Client.ApiResponse<Object>> AccountsOidSignupPostWithHttpInfoAsync(string oid, AccountSignupRequest data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'oid' is set
            if (oid == null)
                throw new Dintero.OpenApiClient.Auth.Client.ApiException(400, "Missing required parameter 'oid' when calling AccountOnboardingApi->AccountsOidSignupPost");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/accounts/{oid}/signup", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Verify signup Complete the signup for a Dintero Account by sending the verification code sent to the applicant  scopes: - create:account 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Auth.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="oid">An id that uniquely identifies the account or owner (partner) </param>
        /// <param name="verificationCode">Verification code sent to the applicant email when requesting a signup [POST /accounts/{oid}/signup](#operation/accounts_oid_signup_post) </param>
        /// <param name="authorize">Request access tokens to be included in the response.  (optional)</param>
        /// <returns>EmailAuthorizedUser</returns>
        public EmailAuthorizedUser AccountsOidSignupVerifyPost(string oid, string verificationCode, string authorize = default(string))
        {
            Dintero.OpenApiClient.Auth.Client.ApiResponse<EmailAuthorizedUser> localVarResponse = AccountsOidSignupVerifyPostWithHttpInfo(oid, verificationCode, authorize);
        ...
        /// <param name="authorize">Request access tokens to be included in the response.  (optional)</param>
        /// <returns>ApiResponse of EmailAuthorizedUser</returns>
        public Dintero.OpenApiClient.Auth.Client.ApiResponse<EmailAuthorizedUser> AccountsOidSignupVerifyPostWithHttpInfo(string oid, string verificationCode, string authorize = default(string))
        {
            // verify the required parameter 'oid' is set
            if (oid == null)
                throw new Dintero.OpenApiClient.Auth.Client.ApiException(400, "Missing required parameter 'oid' when calling AccountOnboardingApi->AccountsOidSignupVerifyPost");

            // verify the required parameter 'verificationCode' is set
            if (verificationCode == null)
                throw new Dintero.OpenApiClient.Auth.Client.ApiException(400, "Missing required parameter 'verificationCode' when calling AccountOnboardingApi->AccountsOidSignupVerifyPost");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<EmailAuthorizedUser>("/accounts/{oid}/signup/verify", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("AccountsOidSignupVerifyPost", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of EmailAuthorizedUser</returns>
        public async System.Threading.Tasks.Task<EmailAuthorizedUser> AccountsOidSignupVerifyPostAsync(string oid, string verificationCode, string authorize = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Auth.Client.ApiResponse<EmailAuthorizedUser> localVarResponse = await AccountsOidSignupVerifyPostWithHttpInfoAsync(oid, verificationCode, authorize, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (EmailAuthorizedUser)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Auth.Client.ApiResponse<EmailAuthorizedUser>> AccountsOidSignupVerifyPostWithHttpInfoAsync(string oid, string verificationCode, string authorize = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'oid' is set
            if (oid == null)
                throw new Dintero.OpenApiClient.Auth.Client.ApiException(400, "Missing required parameter 'oid' when calling AccountOnboardingApi->AccountsOidSignupVerifyPost");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<EmailAuthorizedUser>("/accounts/{oid}/signup/verify", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
