...
{
    /// <summary>
    ///  Class for testing AccountOnboardingApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class AccountOnboardingApiTests : IDisposable
    {
        private AccountOnboardingApi instance;

        public AccountOnboardingApiTests()
        {
            instance = new AccountOnboardingApi();
        }
        ...
        /// <summary>
        /// Test an instance of AccountOnboardingApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' AccountOnboardingApi
            //Assert.IsType<AccountOnboardingApi>(instance);
        }

        /// <summary>
        /// Test AccountsOidSignupPost
        /// </summary>
        [Fact]
        public void AccountsOidSignupPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //AccountSignupRequest data = null;
            //instance.AccountsOidSignupPost(oid, data);
        }

        /// <summary>
        /// Test AccountsOidSignupVerifyPost
        /// </summary>
        [Fact]
        public void AccountsOidSignupVerifyPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //string verificationCode = null;
            //string authorize = null;
            //var response = instance.AccountsOidSignupVerifyPost(oid, verificationCode, authorize);
            //Assert.IsType<EmailAuthorizedUser>(response);
        }
    }
}
