...
{
    /// <summary>
    ///  Class for testing ChallengeApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class ChallengeApiTests : IDisposable
    {
        private ChallengeApi instance;

        public ChallengeApiTests()
        {
        ...
        /// <summary>
        /// Test an instance of ChallengeApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' ChallengeApi
            //Assert.IsType<ChallengeApi>(instance);
        }

        /// <summary>
        /// Test AidAuthMfaChallengePost
        /// </summary>
        [Fact]
        public void AidAuthMfaChallengePostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string aid = null;
            //AuthChallenge data = null;
            //var response = instance.AidAuthMfaChallengePost(aid, data);
            //Assert.IsType<InlineResponse200>(response);
        }

        /// <summary>
        /// Test AidAuthMfaRecoveryPost
        /// </summary>
        [Fact]
        public void AidAuthMfaRecoveryPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string aid = null;
            //UNKNOWN_BASE_TYPE data = null;
            //var response = instance.AidAuthMfaRecoveryPost(aid, data);
