...
namespace Dintero.OpenApiClient.Auth.Test.Api
{
    ...
    public class ClientsApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test AidAuthClientsGet
        /// </summary>
        [Fact]
        public void AidAuthClientsGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //var response = instance.AidAuthClientsGet(oid);
            //Assert.IsType<List<ModelClient>>(response);
        }

        /// <summary>
        /// Test AidAuthClientsPost
        /// </summary>
        [Fact]
        public void AidAuthClientsPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //ModelClient data = null;
            //var response = instance.AidAuthClientsPost(oid, data);
            //Assert.IsType<InlineResponse2003>(response);
        }

        /// <summary>
        /// Test AidAuthsClientsIdDelete
        /// </summary>
        [Fact]
        public void AidAuthsClientsIdDeleteTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //string id = null;
            //var response = instance.AidAuthsClientsIdDelete(oid, id);
            //Assert.IsType<ModelClient>(response);
        }

        /// <summary>
        /// Test AidAuthsClientsIdGet
        /// </summary>
        [Fact]
        public void AidAuthsClientsIdGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //string id = null;
            //var response = instance.AidAuthsClientsIdGet(oid, id);
            //Assert.IsType<ModelClient>(response);
        }

        /// <summary>
        /// Test AidAuthsClientsIdRotatePost
        /// </summary>
        [Fact]
        public void AidAuthsClientsIdRotatePostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //string id = null;
            //var response = instance.AidAuthsClientsIdRotatePost(oid, id);
            //Assert.IsType<InlineResponse2003>(response);
        }
    }
}
