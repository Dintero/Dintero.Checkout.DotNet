...
namespace Dintero.OpenApiClient.Auth.Test.Api
{
    ...
    public class AuthenticateApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test AidAuthAccountPasswordlessPost
        /// </summary>
        [Fact]
        public void AidAuthAccountPasswordlessPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //PasswordLess data = null;
            //instance.AidAuthAccountPasswordlessPost(oid, data);
        }

        /// <summary>
        /// Test AidAuthPasswordlessPost
        /// </summary>
        [Fact]
        public void AidAuthPasswordlessPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //UNKNOWN_BASE_TYPE data = null;
            //var response = instance.AidAuthPasswordlessPost(oid, data);
            //Assert.IsType<InlineResponse2005>(response);
        }

        /// <summary>
        /// Test AidAuthsOauthAuthorizePost
        /// </summary>
        [Fact]
        public void AidAuthsOauthAuthorizePostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            ...
            //instance.AidAuthsOauthAuthorizePost(oid, audience, responseType, clientId, verificationCode, scope, state, redirectUri, connection);
        }

        /// <summary>
        /// Test AidAuthsOauthExchangeTokenPost
        /// </summary>
        [Fact]
        public void AidAuthsOauthExchangeTokenPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string partnerId = null;
            //Exchange data = null;
            //var response = instance.AidAuthsOauthExchangeTokenPost(partnerId, data);
            //Assert.IsType<AccessToken>(response);
        }

        /// <summary>
        /// Test AidAuthsOauthRedirectPost
        /// </summary>
        [Fact]
        public void AidAuthsOauthRedirectPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //InlineObject11 data = null;
            //var response = instance.AidAuthsOauthRedirectPost(oid, data);
            //Assert.IsType<InlineResponse2006>(response);
        }

        /// <summary>
        /// Test AidAuthsOauthRevokePost
        /// </summary>
        [Fact]
        public void AidAuthsOauthRevokePostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //RevokeToken data = null;
            //var response = instance.AidAuthsOauthRevokePost(oid, data);
            //Assert.IsType<Object>(response);
        }

        /// <summary>
        /// Test AidAuthsOauthTokenPost
        /// </summary>
        [Fact]
        public void AidAuthsOauthTokenPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //AuthToken data = null;
            //var response = instance.AidAuthsOauthTokenPost(oid, data);
            //Assert.IsType<AccessToken>(response);
        }
    }
}
