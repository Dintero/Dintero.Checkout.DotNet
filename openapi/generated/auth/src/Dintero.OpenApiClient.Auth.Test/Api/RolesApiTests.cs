...
namespace Dintero.OpenApiClient.Auth.Test.Api
{
    ...
    public class RolesApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test AidAuthsRolesGet
        /// </summary>
        [Fact]
        public void AidAuthsRolesGetTest()
        {
            ...
            //var response = instance.AidAuthsRolesGet(oid, search, name, includeDeleted, limit, startingAfter);
            //Assert.IsType<List<AuthRole>>(response);
        }

        /// <summary>
        /// Test AidAuthsRolesIdDelete
        /// </summary>
        [Fact]
        public void AidAuthsRolesIdDeleteTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //string roleId = null;
            //var response = instance.AidAuthsRolesIdDelete(oid, roleId);
            //Assert.IsType<AuthRole>(response);
        }

        /// <summary>
        /// Test AidAuthsRolesIdGet
        /// </summary>
        [Fact]
        public void AidAuthsRolesIdGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //string roleId = null;
            //var response = instance.AidAuthsRolesIdGet(oid, roleId);
            //Assert.IsType<AuthRole>(response);
        }

        /// <summary>
        /// Test AidAuthsRolesIdPut
        /// </summary>
        [Fact]
        public void AidAuthsRolesIdPutTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //string roleId = null;
            //AuthRole data = null;
            //var response = instance.AidAuthsRolesIdPut(oid, roleId, data);
            //Assert.IsType<AuthRole>(response);
        }

        /// <summary>
        /// Test AidAuthsRolesPost
        /// </summary>
        [Fact]
        public void AidAuthsRolesPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //AuthRole data = null;
            //var response = instance.AidAuthsRolesPost(oid, data);
            //Assert.IsType<AuthRole>(response);
        }
    }
}
