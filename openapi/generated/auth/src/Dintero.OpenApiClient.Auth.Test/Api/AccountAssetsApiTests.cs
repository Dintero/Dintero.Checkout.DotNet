...
{
    /// <summary>
    ///  Class for testing AccountAssetsApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class AccountAssetsApiTests : IDisposable
    {
        private AccountAssetsApi instance;

        public AccountAssetsApiTests()
        {
            instance = new AccountAssetsApi();
        }
        ...
        /// <summary>
        /// Test an instance of AccountAssetsApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' AccountAssetsApi
            //Assert.IsType<AccountAssetsApi>(instance);
        }

        /// <summary>
        /// Test AidAccountAssetsPost
        /// </summary>
        [Fact]
        public void AidAccountAssetsPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string aid = null;
            //InlineObject2 data = null;
            //var response = instance.AidAccountAssetsPost(aid, data);
