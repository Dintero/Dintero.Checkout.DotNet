...
{
    /// <summary>
    ///  Class for testing AccountUsersApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class AccountUsersApiTests : IDisposable
    {
        private AccountUsersApi instance;

        public AccountUsersApiTests()
        {
            instance = new AccountUsersApi();
        }
        ...
        /// <summary>
        /// Test an instance of AccountUsersApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' AccountUsersApi
            //Assert.IsType<AccountUsersApi>(instance);
        }
        ...
        public void AccountUserGetTest()
        {
            ...
            //var response = instance.AccountUserGet();
            //Assert.IsType<AuthenticatedAccountUser>(response);
        }

        /// <summary>
        /// Test AccountUserMfaSmsPut
        /// </summary>
        [Fact]
        public void AccountUserMfaSmsPutTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //InlineObject data = null;
            //instance.AccountUserMfaSmsPut(data);
        }

        /// <summary>
        /// Test AccountUserPasswordPut
        /// </summary>
        [Fact]
        public void AccountUserPasswordPutTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //InlineObject1 body = null;
            //instance.AccountUserPasswordPut(body);
        }

        /// <summary>
        /// Test AidAccountsAidMgmntUsersActivitiesGet
        /// </summary>
        [Fact]
        public void AidAccountsAidMgmntUsersActivitiesGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //string uid = null;
            //var response = instance.AidAccountsAidMgmntUsersActivitiesGet(oid, uid);
            //Assert.IsType<List<AuditEvent>>(response);
        }

        /// <summary>
        /// Test AidAccountsAidMgmntUsersDelete
        /// </summary>
        [Fact]
        public void AidAccountsAidMgmntUsersDeleteTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //string uid = null;
            //List<string> expand = null;
            //var response = instance.AidAccountsAidMgmntUsersDelete(oid, uid, expand);
            //Assert.IsType<AccountUserResponse>(response);
        }

        /// <summary>
        /// Test AidAccountsAidMgmntUsersGet
        /// </summary>
        [Fact]
        public void AidAccountsAidMgmntUsersGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //List<string> expand = null;
            //var response = instance.AidAccountsAidMgmntUsersGet(oid, expand);
            //Assert.IsType<List<AccountUserResponse>>(response);
        }

        /// <summary>
        /// Test AidAccountsAidMgmntUsersPost
        /// </summary>
        [Fact]
        public void AidAccountsAidMgmntUsersPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //InlineObject12 data = null;
            //List<string> expand = null;
            //var response = instance.AidAccountsAidMgmntUsersPost(oid, data, expand);
            //Assert.IsType<AccountUserResponse>(response);
        }

        /// <summary>
        /// Test AidAccountsAidMgmntUsersPut
        /// </summary>
        [Fact]
        public void AidAccountsAidMgmntUsersPutTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //string uid = null;
            ...
            //List<string> expand = null;
            //var response = instance.AidAccountsAidMgmntUsersPut(oid, uid, data, expand);
            //Assert.IsType<AccountUserResponse>(response);
        }
    }
}
