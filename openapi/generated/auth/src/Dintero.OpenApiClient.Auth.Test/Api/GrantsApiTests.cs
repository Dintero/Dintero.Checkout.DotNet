...
{
    /// <summary>
    ///  Class for testing GrantsApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class GrantsApiTests : IDisposable
    {
        private GrantsApi instance;

        public GrantsApiTests()
        {
            instance = new GrantsApi();
        }
        ...
        /// <summary>
        /// Test an instance of GrantsApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' GrantsApi
            //Assert.IsType<GrantsApi>(instance);
        }

        /// <summary>
        /// Test AidAuthsClientGrantsGet
        /// </summary>
        [Fact]
        public void AidAuthsClientGrantsGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //string audience = null;
            //string clientId = null;
            //var response = instance.AidAuthsClientGrantsGet(oid, audience, clientId);
            //Assert.IsType<List<Grant>>(response);
        }

        /// <summary>
        /// Test AidAuthsClientGrantsIdDelete
        /// </summary>
        [Fact]
        public void AidAuthsClientGrantsIdDeleteTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //string id = null;
            //var response = instance.AidAuthsClientGrantsIdDelete(oid, id);
            //Assert.IsType<Grant>(response);
        }

        /// <summary>
        /// Test AidAuthsClientGrantsPost
        /// </summary>
        [Fact]
        public void AidAuthsClientGrantsPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //Grant data = null;
            //var response = instance.AidAuthsClientGrantsPost(oid, data);
            //Assert.IsType<Grant>(response);
        }
    }
}
