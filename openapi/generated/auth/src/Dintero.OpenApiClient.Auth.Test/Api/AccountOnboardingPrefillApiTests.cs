...
{
    /// <summary>
    ///  Class for testing AccountOnboardingPrefillApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class AccountOnboardingPrefillApiTests : IDisposable
    {
        private AccountOnboardingPrefillApi instance;

        public AccountOnboardingPrefillApiTests()
        {
            instance = new AccountOnboardingPrefillApi();
        }
        ...
        /// <summary>
        /// Test an instance of AccountOnboardingPrefillApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' AccountOnboardingPrefillApi
            //Assert.IsType<AccountOnboardingPrefillApi>(instance);
        }

        /// <summary>
        /// Test AccountsOidSignupPrefillAcceptPost
        /// </summary>
        [Fact]
        public void AccountsOidSignupPrefillAcceptPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //string prefillId = null;
            //AccountSignupPreFillRequest data = null;
            //string authorize = null;
            //var response = instance.AccountsOidSignupPrefillAcceptPost(oid, prefillId, data, authorize);
            //Assert.IsType<InlineResponse2007>(response);
        }

        /// <summary>
        /// Test AccountsOidSignupPrefillGet
        /// </summary>
        [Fact]
        public void AccountsOidSignupPrefillGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //string prefillId = null;
            //var response = instance.AccountsOidSignupPrefillGet(oid, prefillId);
            //Assert.IsType<AccountSignupPreFillRequest>(response);
        }

        /// <summary>
        /// Test AccountsOidSignupPrefillPost
        /// </summary>
        [Fact]
        public void AccountsOidSignupPrefillPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //AccountSignupPreFillRequest data = null;
            //var response = instance.AccountsOidSignupPrefillPost(oid, data);
            //Assert.IsType<AccountSignupPreFillRequest>(response);
        }
    }
}
