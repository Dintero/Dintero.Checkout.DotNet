...
{
    /// <summary>
    ///  Class for testing AuthUsersApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class AuthUsersApiTests : IDisposable
    {
        private AuthUsersApi instance;

        public AuthUsersApiTests()
        {
            instance = new AuthUsersApi();
        }
        ...
        /// <summary>
        /// Test an instance of AuthUsersApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' AuthUsersApi
            //Assert.IsType<AuthUsersApi>(instance);
        }

        /// <summary>
        /// Test AidAuthUsersPost
        /// </summary>
        [Fact]
        public void AidAuthUsersPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string aid = null;
            //UNKNOWN_BASE_TYPE data = null;
            //var response = instance.AidAuthUsersPost(aid, data);
            //Assert.IsType<AuthUser>(response);
        }

        /// <summary>
        /// Test AidAuthUsersUsernameChangeUsernamePost
        /// </summary>
        [Fact]
        public void AidAuthUsersUsernameChangeUsernamePostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string aid = null;
            //string username = null;
            //UNKNOWN_BASE_TYPE data = null;
            //var response = instance.AidAuthUsersUsernameChangeUsernamePost(aid, username, data);
            //Assert.IsType<AuthUser>(response);
        }

        /// <summary>
        /// Test AidAuthUsersUsernameDelete
        /// </summary>
        [Fact]
        public void AidAuthUsersUsernameDeleteTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string aid = null;
            //string username = null;
            //var response = instance.AidAuthUsersUsernameDelete(aid, username);
            //Assert.IsType<AuthUser>(response);
        }

        /// <summary>
        /// Test AidAuthUsersUsernamePut
        /// </summary>
        [Fact]
        public void AidAuthUsersUsernamePutTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string aid = null;
            //string username = null;
            //UNKNOWN_BASE_TYPE data = null;
            //var response = instance.AidAuthUsersUsernamePut(aid, username, data);
            //Assert.IsType<AuthUser>(response);
        }
    }
}
