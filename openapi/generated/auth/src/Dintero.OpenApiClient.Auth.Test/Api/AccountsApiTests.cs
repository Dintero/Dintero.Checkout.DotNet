...
namespace Dintero.OpenApiClient.Auth.Test.Api
{
    ...
    public class AccountsApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test AidAccountsAidConnectionsEventsPost
        /// </summary>
        [Fact]
        public void AidAccountsAidConnectionsEventsPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //string aid = null;
            //string connection = null;
            //AccountConnectionEvent data = null;
            //var response = instance.AidAccountsAidConnectionsEventsPost(oid, aid, connection, data);
            //Assert.IsType<AccountConnectionEvent>(response);
        }

        /// <summary>
        /// Test AidAccountsAidGet
        /// </summary>
        [Fact]
        public void AidAccountsAidGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //string aid = null;
            //var response = instance.AidAccountsAidGet(oid, aid);
            //Assert.IsType<ExtendedAccount>(response);
        }

        /// <summary>
        /// Test AidAccountsAidPut
        /// </summary>
        [Fact]
        public void AidAccountsAidPutTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //string aid = null;
            //UNKNOWN_BASE_TYPE data = null;
            //var response = instance.AidAccountsAidPut(oid, aid, data);
            //Assert.IsType<ExtendedAccount>(response);
        }

        /// <summary>
        /// Test AidMgmntAccountsAidDelete
        /// </summary>
        [Fact]
        public void AidMgmntAccountsAidDeleteTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //string aid = null;
            //var response = instance.AidMgmntAccountsAidDelete(oid, aid);
            //Assert.IsType<ExtendedAccount>(response);
        }

        /// <summary>
        /// Test AidMgmntAccountsEventsGet
        /// </summary>
        [Fact]
        public void AidMgmntAccountsEventsGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //string aid = null;
            ...
            //var response = instance.AidMgmntAccountsEventsGet(oid, aid, type, limit, startingAfter);
            //Assert.IsType<List<AccountEvent>>(response);
        }

        /// <summary>
        /// Test AidMgmntAccountsEventsPost
        /// </summary>
        [Fact]
        public void AidMgmntAccountsEventsPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //string aid = null;
            //AccountEvent _event = null;
            //var response = instance.AidMgmntAccountsEventsPost(oid, aid, _event);
            //Assert.IsType<AccountEvent>(response);
        }

        /// <summary>
        /// Test AidMgmntAccountsGet
        /// </summary>
        [Fact]
        public void AidMgmntAccountsGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //string search = null;
            //List<string> progression = null;
            //List<string> connections = null;
            //List<string> connectionsProgression = null;
            //List<string> services = null;
            //List<string> servicesProgression = null;
            //List<string> accountManager = null;
            //int? limit = null;
            //string startingAfter = null;
            //var response = instance.AidMgmntAccountsGet(oid, search, progression, connections, connectionsProgression, services, servicesProgression, accountManager, limit, startingAfter);
            //Assert.IsType<List<ExtendedAccount>>(response);
        }

        /// <summary>
        /// Test AidMgmntAccountsPost
        /// </summary>
        [Fact]
        public void AidMgmntAccountsPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string oid = null;
            //UNKNOWN_BASE_TYPE data = null;
            //var response = instance.AidMgmntAccountsPost(oid, data);
            //Assert.IsType<ExtendedAccount>(response);
        }
    }
}
