...
namespace Dintero.OpenApiClient.Auth.Test.Api
{
    ...
    public class AccountSettingsApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test AidAccountAidGet
        /// </summary>
        [Fact]
        public void AidAccountAidGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string aid = null;
            //var response = instance.AidAccountAidGet(aid);
            //Assert.IsType<Account>(response);
        }

        /// <summary>
        /// Test AidAccountSettingsPut
        /// </summary>
        [Fact]
        public void AidAccountSettingsPutTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string aid = null;
            //InlineObject3 data = null;
            //var response = instance.AidAccountSettingsPut(aid, data);
            //Assert.IsType<Account>(response);
        }
    }
}
