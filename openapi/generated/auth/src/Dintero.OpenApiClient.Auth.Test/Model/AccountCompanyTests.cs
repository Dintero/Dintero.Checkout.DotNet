...
namespace Dintero.OpenApiClient.Auth.Test.Model
{
    ...
    public class AccountCompanyTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" AccountCompany
            //Assert.IsType<AccountCompany>(instance);
        }
        ...
        /// <summary>
        /// Test the property 'TechnicalEmail'
        /// </summary>
        [Fact]
        public void TechnicalEmailTest()
        {
            // TODO unit test for the property 'TechnicalEmail'
        }
        /// <summary>
