...
namespace Dintero.OpenApiClient.Auth.Test.Model
{
    ...
    public class PasswordTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" Password
            //Assert.IsType<Password>(instance);
        }
        ...
        /// <summary>
        /// Test the property '_Password'
        /// </summary>
        [Fact]
        public void _PasswordTest()
        {
            // TODO unit test for the property '_Password'
        }
        /// <summary>
