...
{
    /// <summary>
    ///  Class for testing AccountEvent
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the model.
    /// </remarks>
    public class AccountEventTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for AccountEvent
        //private AccountEvent instance;

        public AccountEventTests()
        {
            // TODO uncomment below to create an instance of AccountEvent
            //instance = new AccountEvent();
        }
        ...
        /// <summary>
        /// Test an instance of AccountEvent
        /// </summary>
        [Fact]
        public void AccountEventInstanceTest()
        {
            // TODO uncomment below to test "IsType" AccountEvent
            //Assert.IsType<AccountEvent>(instance);
        }

        /// <summary>
        /// Test deserialize a AccountEventStatistics from type AccountEvent
        /// </summary>
        [Fact]
        public void AccountEventStatisticsDeserializeFromAccountEventTest()
        {
            // TODO uncomment below to test deserialize a AccountEventStatistics from type AccountEvent
            //Assert.IsType<AccountEvent>(JsonConvert.DeserializeObject<AccountEvent>(new AccountEventStatistics().ToJson()));
        }
        /// <summary>
        /// Test deserialize a AccountEventComment from type AccountEvent
        /// </summary>
        [Fact]
        public void AccountEventCommentDeserializeFromAccountEventTest()
        {
            // TODO uncomment below to test deserialize a AccountEventComment from type AccountEvent
            //Assert.IsType<AccountEvent>(JsonConvert.DeserializeObject<AccountEvent>(new AccountEventComment().ToJson()));
        }
