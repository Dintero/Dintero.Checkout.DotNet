...
namespace Dintero.OpenApiClient.Auth.Test.Model
{
    ...
    public class AuthTokenTests : IDisposable
    {
        ...
        /// <summary>
        /// Test deserialize a RefreshToken from type AuthToken
        /// </summary>
        [Fact]
        public void RefreshTokenDeserializeFromAuthTokenTest()
        {
            // TODO uncomment below to test deserialize a RefreshToken from type AuthToken
            //Assert.IsType<AuthToken>(JsonConvert.DeserializeObject<AuthToken>(new RefreshToken().ToJson()));
        }
        /// <summary>
        /// Test deserialize a MfaOob from type AuthToken
        /// </summary>
        [Fact]
        public void MfaOobDeserializeFromAuthTokenTest()
        {
            // TODO uncomment below to test deserialize a MfaOob from type AuthToken
            //Assert.IsType<AuthToken>(JsonConvert.DeserializeObject<AuthToken>(new MfaOob().ToJson()));
        }
        /// <summary>
        /// Test deserialize a Password from type AuthToken
        /// </summary>
        [Fact]
        public void PasswordDeserializeFromAuthTokenTest()
        {
            // TODO uncomment below to test deserialize a Password from type AuthToken
            //Assert.IsType<AuthToken>(JsonConvert.DeserializeObject<AuthToken>(new Password().ToJson()));
        }
        /// <summary>
        /// Test deserialize a AuthorizationCode from type AuthToken
        /// </summary>
        [Fact]
        public void AuthorizationCodeDeserializeFromAuthTokenTest()
        {
            // TODO uncomment below to test deserialize a AuthorizationCode from type AuthToken
            //Assert.IsType<AuthToken>(JsonConvert.DeserializeObject<AuthToken>(new AuthorizationCode().ToJson()));
        }
        /// <summary>
        /// Test deserialize a ClientCredentials from type AuthToken
        /// </summary>
        [Fact]
        public void ClientCredentialsDeserializeFromAuthTokenTest()
        {
            // TODO uncomment below to test deserialize a ClientCredentials from type AuthToken
            //Assert.IsType<AuthToken>(JsonConvert.DeserializeObject<AuthToken>(new ClientCredentials().ToJson()));
        }
