...
namespace Dintero.OpenApiClient.Checkout.Test.Model
{
    ...
    public class StoreTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" Store
            //Assert.IsType<Store>(instance);
        }
        ...
        public void GlnTest()
        {
            // TODO unit test for the property 'Gln'
        }
        /// <summary>
        ...
        /// <summary>
        /// Test the property 'Bax'
        /// </summary>
        [Fact]
        public void BaxTest()
        {
            // TODO unit test for the property 'Bax'
        }
        /// <summary>
