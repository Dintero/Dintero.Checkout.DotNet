...
namespace Dintero.OpenApiClient.Checkout.Test.Api
{
    /// <summary>
    ...
    public class ViewApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test CheckoutSidHtmlGet
        /// </summary>
        [Fact]
        public void CheckoutSidHtmlGetTest()
        {
            ...
            //string ui = null;
            //string scc = null;
            //instance.CheckoutSidHtmlGet(sessionId, language, ui, scc);
        }

        /// <summary>
        /// Test CheckoutSidJsonGet
        /// </summary>
        [Fact]
        public void CheckoutSidJsonGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string sessionId = null;
            //var response = instance.CheckoutSidJsonGet(sessionId);
            //Assert.IsType<InlineResponse20012>(response);
        }

        /// <summary>
        /// Test CheckoutSidJsonOrderAddressesPut
        /// </summary>
        [Fact]
        public void CheckoutSidJsonOrderAddressesPutTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string sessionId = null;
            //ViewSessionUpdateAddress options = null;
            //string ifUnmodifiedSince = null;
            //var response = instance.CheckoutSidJsonOrderAddressesPut(sessionId, options, ifUnmodifiedSince);
            //Assert.IsType<InlineResponse20013>(response);
        }

        /// <summary>
        /// Test CheckoutSidJsonOrderDiscountCodesPut
        /// </summary>
        [Fact]
        public void CheckoutSidJsonOrderDiscountCodesPutTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string sessionId = null;
            //ViewSessionUpdateDiscountCodes options = null;
            //string ifUnmodifiedSince = null;
            //var response = instance.CheckoutSidJsonOrderDiscountCodesPut(sessionId, options, ifUnmodifiedSince);
            //Assert.IsType<InlineResponse20013>(response);
        }

        /// <summary>
        /// Test CheckoutSidJsonOrderItemsShippingOptionPut
        /// </summary>
        [Fact]
        public void CheckoutSidJsonOrderItemsShippingOptionPutTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string sessionId = null;
            //ShippingOption options = null;
            //string ifUnmodifiedSince = null;
            //var response = instance.CheckoutSidJsonOrderItemsShippingOptionPut(sessionId, options, ifUnmodifiedSince);
            //Assert.IsType<InlineResponse20013>(response);
        }

        /// <summary>
        /// Test CheckoutSidJsonOrderShippingAddressPut
        /// </summary>
        [Fact]
        public void CheckoutSidJsonOrderShippingAddressPutTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string sessionId = null;
            //OrderAddress options = null;
            //string ifUnmodifiedSince = null;
            //var response = instance.CheckoutSidJsonOrderShippingAddressPut(sessionId, options, ifUnmodifiedSince);
            //Assert.IsType<InlineResponse20013>(response);
        }

        /// <summary>
        /// Test CheckoutSidLock
        /// </summary>
        [Fact]
        public void CheckoutSidLockTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string sessionId = null;
            //var response = instance.CheckoutSidLock(sessionId);
            //Assert.IsType<SessionLock>(response);
        }

        /// <summary>
        /// Test CheckoutSidPaymentsProductTypePost
        /// </summary>
        [Fact]
        public void CheckoutSidPaymentsProductTypePostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string sessionId = null;
            //string paymentProductType = null;
            //string language = null;
            //var response = instance.CheckoutSidPaymentsProductTypePost(sessionId, paymentProductType, language);
            //Assert.IsType<PaymentOperations>(response);
        }

        /// <summary>
        /// Test CheckoutSidSendScc
        /// </summary>
        [Fact]
        public void CheckoutSidSendSccTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string sessionId = null;
            //instance.CheckoutSidSendScc(sessionId);
        }

        /// <summary>
        /// Test ViewSidSessionAbandonPost
        /// </summary>
        [Fact]
        public void ViewSidSessionAbandonPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string sessionId = null;
            //instance.ViewSidSessionAbandonPost(sessionId);
        }
    }
}
