...
namespace Dintero.OpenApiClient.Checkout.Test.Api
{
    ...
    public class TransactionsApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test TransactionsEventsSettlementsPost
        /// </summary>
        [Fact]
        public void TransactionsEventsSettlementsPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //UNKNOWN_BASE_TYPE data = null;
            //var response = instance.TransactionsEventsSettlementsPost(data);
            //Assert.IsType<List<Transaction>>(response);
        }
        ...
        public void TransactionsGetTest()
        {
            ...
            //List<string> paymentProduct = null;
            //List<string> paymentProductType = null;
            //List<string> cardBrand = null;
            //string merchantReference = null;
            //string merchantReference2 = null;
            //List<string> sessionId = null;
            //List<string> storeId = null;
            //List<string> payoutCorrelationId = null;
            ...
            //string capturedAtGte = null;
            //string capturedAtLte = null;
            //string refundedAtGte = null;
            //string refundedAtLte = null;
            //string search = null;
            //var response = instance.TransactionsGet(id, limit, startingAfter, status, paymentProduct, paymentProductType, cardBrand, merchantReference, merchantReference2, sessionId, storeId, payoutCorrelationId, currency, amount, amountGte, amountLte, createdAtGte, createdAtLte, capturedAtGte, capturedAtLte, refundedAtGte, refundedAtLte, search);
            //Assert.IsType<List<Transaction>>(response);
        }

        /// <summary>
        /// Test TransactionsIdCapturePost
        /// </summary>
        [Fact]
        public void TransactionsIdCapturePostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //InlineObject20 data = null;
            //var response = instance.TransactionsIdCapturePost(id, data);
            //Assert.IsType<InlineResponse20010>(response);
        }

        /// <summary>
        /// Test TransactionsIdGet
        /// </summary>
        [Fact]
        public void TransactionsIdGetTest()
        {
            ...
            //var response = instance.TransactionsIdGet(id, includes);
            //Assert.IsType<InlineResponse20010>(response);
        }

        /// <summary>
        /// Test TransactionsIdPut
        /// </summary>
        [Fact]
        public void TransactionsIdPutTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //InlineObject19 data = null;
            //var response = instance.TransactionsIdPut(id, data);
            //Assert.IsType<InlineResponse20010>(response);
        }

        /// <summary>
        /// Test TransactionsIdRefundPost
        /// </summary>
        [Fact]
        public void TransactionsIdRefundPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //InlineObject21 refunds = null;
            //var response = instance.TransactionsIdRefundPost(id, refunds);
            //Assert.IsType<InlineResponse20010>(response);
        }

        /// <summary>
        /// Test TransactionsIdVoidPost
        /// </summary>
        [Fact]
        public void TransactionsIdVoidPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //var response = instance.TransactionsIdVoidPost(id);
            //Assert.IsType<InlineResponse20010>(response);
        }
    }
}
