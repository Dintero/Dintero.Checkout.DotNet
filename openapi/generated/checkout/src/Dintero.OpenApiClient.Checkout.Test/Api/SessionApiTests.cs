...
namespace Dintero.OpenApiClient.Checkout.Test.Api
{
    ...
    public class SessionApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test CheckoutPaymentTokenSessionPost
        /// </summary>
        [Fact]
        public void CheckoutPaymentTokenSessionPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //InlineObject18 options = null;
            //bool? includeSession = null;
            //var response = instance.CheckoutPaymentTokenSessionPost(options, includeSession);
            //Assert.IsType<InlineResponse2008>(response);
        }

        /// <summary>
        /// Test CheckoutSessionCancelPost
        /// </summary>
        [Fact]
        public void CheckoutSessionCancelPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string sessionId = null;
            //var response = instance.CheckoutSessionCancelPost(sessionId);
        ...
        /// </summary>
        [Fact]
        public void CheckoutSessionGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string sessionId = null;
            //var response = instance.CheckoutSessionGet(sessionId);
            //Assert.IsType<InlineResponse2009>(response);
        }

        /// <summary>
        /// Test CheckoutSessionPost
        /// </summary>
        [Fact]
        public void CheckoutSessionPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //UNKNOWN_BASE_TYPE options = null;
            //bool? includeSession = null;
            //var response = instance.CheckoutSessionPost(options, includeSession);
            //Assert.IsType<InlineResponse2008>(response);
        }

        /// <summary>
        /// Test CheckoutSessionProfilePost
        /// </summary>
        [Fact]
        public void CheckoutSessionProfilePostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //UNKNOWN_BASE_TYPE options = null;
            //bool? includeSession = null;
            //var response = instance.CheckoutSessionProfilePost(options, includeSession);
            //Assert.IsType<InlineResponse2008>(response);
        }

        /// <summary>
        /// Test CheckoutSessionPut
        /// </summary>
        [Fact]
        public void CheckoutSessionPutTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string sessionId = null;
            //UNKNOWN_BASE_TYPE options = null;
            //var response = instance.CheckoutSessionPut(sessionId, options);
            //Assert.IsType<InlineResponse2009>(response);
        }

        /// <summary>
        /// Test CheckoutSessionsGet
        /// </summary>
        [Fact]
        public void CheckoutSessionsGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int? limit = null;
            ...
            //var response = instance.CheckoutSessionsGet(limit, startingAfter, id, search, transactionId, createdAtGte, createdAtLte, storeId);
            //Assert.IsType<List<Id>>(response);
        }
    }
}
