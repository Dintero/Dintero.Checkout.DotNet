...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// InstabankItem
    /// </summary>
    [DataContract(Name = "InstabankItem")]
    public partial class InstabankItem : IEquatable<InstabankItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankItem" /> class.
        /// </summary>
        /// <param name="externalReference">externalReference.</param>
        /// <param name="quantity">quantity.</param>
        /// <param name="amount">amount.</param>
        public InstabankItem(string externalReference = default(string), decimal quantity = default(decimal), decimal amount = default(decimal))
        {
        ...
        {
            return this.Equals(input as InstabankItem);
        }

        /// <summary>
        /// Returns true if InstabankItem instances are equal
        /// </summary>
        /// <param name="input">Instance of InstabankItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstabankItem input)
        {
            if (input == null)
                return false;
