...
{
    /// <summary>
    /// IngenicoWebhookEventPaymentPaymentOutput
    /// </summary>
    [DataContract(Name = "IngenicoWebhookEvent_payment_paymentOutput")]
    public partial class IngenicoWebhookEventPaymentPaymentOutput : IEquatable<IngenicoWebhookEventPaymentPaymentOutput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoWebhookEventPaymentPaymentOutput" /> class.
        /// </summary>
        /// <param name="amountOfMoney">amountOfMoney.</param>
        /// <param name="amountPaid">amountPaid.</param>
        /// <param name="amountReversed">amountReversed.</param>
        /// <param name="references">references.</param>
        /// <param name="paymentMethod">paymentMethod.</param>
        /// <param name="cardPaymentMethodSpecificOutput">cardPaymentMethodSpecificOutput.</param>
        public IngenicoWebhookEventPaymentPaymentOutput(IngenicoWebhookEventPaymentPaymentOutputAmountOfMoney amountOfMoney = default(IngenicoWebhookEventPaymentPaymentOutputAmountOfMoney), decimal amountPaid = default(decimal), decimal amountReversed = default(decimal), IngenicoWebhookEventPaymentPaymentOutputReferences references = default(IngenicoWebhookEventPaymentPaymentOutputReferences), string paymentMethod = default(string), IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutput cardPaymentMethodSpecificOutput = default(IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutput))
        {
        ...
        public IngenicoWebhookEventPaymentPaymentOutputAmountOfMoney AmountOfMoney { get; set; }
        ...
        /// <summary>
        /// Gets or Sets AmountReversed
        /// </summary>
        [DataMember(Name = "amountReversed", EmitDefaultValue = false)]
        ...
        public IngenicoWebhookEventPaymentPaymentOutputReferences References { get; set; }
        ...
        public IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutput CardPaymentMethodSpecificOutput { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IngenicoWebhookEventPaymentPaymentOutput {\n");
            sb.Append("  AmountOfMoney: ").Append(AmountOfMoney).Append("\n");
            sb.Append("  AmountPaid: ").Append(AmountPaid).Append("\n");
            sb.Append("  AmountReversed: ").Append(AmountReversed).Append("\n");
        ...
        {
            return this.Equals(input as IngenicoWebhookEventPaymentPaymentOutput);
        }

        /// <summary>
        /// Returns true if IngenicoWebhookEventPaymentPaymentOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of IngenicoWebhookEventPaymentPaymentOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IngenicoWebhookEventPaymentPaymentOutput input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.AmountOfMoney == input.AmountOfMoney ||
                    (this.AmountOfMoney != null &&
                    this.AmountOfMoney.Equals(input.AmountOfMoney))
                ) && 
                (
                ...
                (
                    this.AmountReversed == input.AmountReversed ||
                    this.AmountReversed.Equals(input.AmountReversed)
                ) && 
                (
                ...
                (
                    this.CardPaymentMethodSpecificOutput == input.CardPaymentMethodSpecificOutput ||
                    (this.CardPaymentMethodSpecificOutput != null &&
                    this.CardPaymentMethodSpecificOutput.Equals(input.CardPaymentMethodSpecificOutput))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AmountOfMoney != null)
                    hashCode = hashCode * 59 + this.AmountOfMoney.GetHashCode();
                hashCode = hashCode * 59 + this.AmountPaid.GetHashCode();
                hashCode = hashCode * 59 + this.AmountReversed.GetHashCode();
                if (this.References != null)
                    hashCode = hashCode * 59 + this.References.GetHashCode();
                if (this.PaymentMethod != null)
                    hashCode = hashCode * 59 + this.PaymentMethod.GetHashCode();
                if (this.CardPaymentMethodSpecificOutput != null)
                    hashCode = hashCode * 59 + this.CardPaymentMethodSpecificOutput.GetHashCode();
                return hashCode;
            }
        }
