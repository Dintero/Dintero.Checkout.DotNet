...
{
    /// <summary>
    /// IngenicoWebhookEventTokenCardCustomerDataCardWithoutCvv
    /// </summary>
    [DataContract(Name = "IngenicoWebhookEvent_token_card_customer_data_cardWithoutCvv")]
    public partial class IngenicoWebhookEventTokenCardCustomerDataCardWithoutCvv : IEquatable<IngenicoWebhookEventTokenCardCustomerDataCardWithoutCvv>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoWebhookEventTokenCardCustomerDataCardWithoutCvv" /> class.
        /// </summary>
        ...
        public IngenicoWebhookEventTokenCardCustomerDataCardWithoutCvv(string cardNumber = default(string), string cardholderName = default(string), string expiryDate = default(string), string issueNumber = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IngenicoWebhookEventTokenCardCustomerDataCardWithoutCvv {\n");
        ...
        {
            return this.Equals(input as IngenicoWebhookEventTokenCardCustomerDataCardWithoutCvv);
        }

        /// <summary>
        /// Returns true if IngenicoWebhookEventTokenCardCustomerDataCardWithoutCvv instances are equal
        /// </summary>
        /// <param name="input">Instance of IngenicoWebhookEventTokenCardCustomerDataCardWithoutCvv to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IngenicoWebhookEventTokenCardCustomerDataCardWithoutCvv input)
        {
            if (input == null)
                return false;
