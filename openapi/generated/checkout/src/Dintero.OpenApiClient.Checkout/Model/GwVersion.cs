...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// GwVersion
    /// </summary>
    [DataContract(Name = "GwVersion")]
    public partial class GwVersion : IEquatable<GwVersion>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GwVersion" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="GwVersion" /> class.
        /// </summary>
        /// <param name="validAfter">The version is valid given the transaction/session &#x60;created_at&#x60;  (required).</param>
        /// <param name="validBefore">The version is valid given the transaction/session &#x60;created_at&#x60;  (required).</param>
        public GwVersion(DateTime validAfter = default(DateTime), DateTime validBefore = default(DateTime))
        {
        ...
        /// </summary>
        /// <value>The version is valid given the transaction/session &#x60;created_at&#x60; </value>
        [DataMember(Name = "valid_after", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>The version is valid given the transaction/session &#x60;created_at&#x60; </value>
        [DataMember(Name = "valid_before", IsRequired = true, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as GwVersion);
        }

        /// <summary>
        /// Returns true if GwVersion instances are equal
        /// </summary>
        /// <param name="input">Instance of GwVersion to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GwVersion input)
        {
            if (input == null)
                return false;
