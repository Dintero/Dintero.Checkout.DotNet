...
{
    /// <summary>
    /// PayExCallbackTransaction
    /// </summary>
    [DataContract(Name = "PayExCallback_transaction")]
    public partial class PayExCallbackTransaction : IEquatable<PayExCallbackTransaction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExCallbackTransaction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayExCallbackTransaction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExCallbackTransaction" /> class.
        /// </summary>
        /// <param name="id">- Payment Instrument: CreditCard, Swish - Transaction Type: Authorizations, Captures, Cancellations, Reversals  (required).</param>
        /// <param name="number">number.</param>
        public PayExCallbackTransaction(string id = default(string), int number = default(int))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for PayExCallbackTransaction and cannot be null");
            this.Number = number;
        }

        /// <summary>
        /// - Payment Instrument: CreditCard, Swish - Transaction Type: Authorizations, Captures, Cancellations, Reversals 
        /// </summary>
        /// <value>- Payment Instrument: CreditCard, Swish - Transaction Type: Authorizations, Captures, Cancellations, Reversals </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PayExCallbackTransaction {\n");
        ...
        {
            return this.Equals(input as PayExCallbackTransaction);
        }

        /// <summary>
        /// Returns true if PayExCallbackTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of PayExCallbackTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayExCallbackTransaction input)
        {
            if (input == null)
                return false;
