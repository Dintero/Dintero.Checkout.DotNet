...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// VippsPayment
    /// </summary>
    [DataContract(Name = "VippsPayment")]
    [JsonConverter(typeof(JsonSubtypes), "PaymentProductType")]
    public partial class VippsPayment : Payment, IEquatable<VippsPayment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VippsPayment" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VippsPayment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VippsPayment" /> class.
        /// </summary>
        ...
        /// <param name="paymentProductType">The payment product type corresponding to this transaction  (required) (default to &quot;VippsPayment&quot;).</param>
        public VippsPayment(string phoneNumber = default(string), bool rememberMe = default(bool), string paymentProductType = "VippsPayment") : base(paymentProductType)
        {
            // to ensure "phoneNumber" is required (not null)
            this.PhoneNumber = phoneNumber ?? throw new ArgumentNullException("phoneNumber is a required property for VippsPayment and cannot be null");
        ...
        {
            return this.Equals(input as VippsPayment);
        }

        /// <summary>
        /// Returns true if VippsPayment instances are equal
        /// </summary>
        /// <param name="input">Instance of VippsPayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VippsPayment input)
        {
            if (input == null)
                return false;
