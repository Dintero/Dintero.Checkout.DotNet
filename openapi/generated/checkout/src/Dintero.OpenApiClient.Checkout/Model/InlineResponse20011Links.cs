...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_11_links")]
    public partial class InlineResponse20011Links : IEquatable<InlineResponse20011Links>, IValidatableObject
    {
        ...
        /// <param name="rel">The relationship between the location and the link - &#x60;checkout&#x60;: link to start checkout from the location .</param>
        public InlineResponse20011Links(string href = default(string), string rel = default(string))
        {
            this.Href = href;
            this.Rel = rel;
        }
        ...
        /// <summary>
        /// The relationship between the location and the link - &#x60;checkout&#x60;: link to start checkout from the location 
        /// </summary>
        /// <value>The relationship between the location and the link - &#x60;checkout&#x60;: link to start checkout from the location </value>
