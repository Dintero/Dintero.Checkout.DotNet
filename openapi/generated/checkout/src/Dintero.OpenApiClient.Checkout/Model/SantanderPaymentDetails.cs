...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SantanderPaymentDetails")]
    ...
    public partial class SantanderPaymentDetails : IEquatable<SantanderPaymentDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SantanderPaymentDetails" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SantanderPaymentDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SantanderPaymentDetails" /> class.
        /// </summary>
        /// <param name="paymentProductType">The payment product type corresponding to this transaction  (required).</param>
        public SantanderPaymentDetails(string paymentProductType = default(string))
        {
            // to ensure "paymentProductType" is required (not null)
            this.PaymentProductType = paymentProductType ?? throw new ArgumentNullException("paymentProductType is a required property for SantanderPaymentDetails and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SantanderPaymentDetails {\n");
        ...
        {
            return this.Equals(input as SantanderPaymentDetails);
        }

        /// <summary>
        /// Returns true if SantanderPaymentDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of SantanderPaymentDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SantanderPaymentDetails input)
        {
            if (input == null)
                return false;
