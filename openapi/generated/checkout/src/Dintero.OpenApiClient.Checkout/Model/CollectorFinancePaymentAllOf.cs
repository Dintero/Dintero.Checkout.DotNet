...
{
    /// <summary>
    /// CollectorFinancePaymentAllOf
    /// </summary>
    [DataContract(Name = "CollectorFinancePayment_allOf")]
    public partial class CollectorFinancePaymentAllOf : IEquatable<CollectorFinancePaymentAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorFinancePaymentAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorFinancePaymentAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorFinancePaymentAllOf" /> class.
        /// </summary>
        ...
        public CollectorFinancePaymentAllOf(CollectorAddress shippingAddress = default(CollectorAddress), CollectorAddress billingAddress = default(CollectorAddress), bool rememberMe = default(bool))
        {
            // to ensure "shippingAddress" is required (not null)
            this.ShippingAddress = shippingAddress ?? throw new ArgumentNullException("shippingAddress is a required property for CollectorFinancePaymentAllOf and cannot be null");
            // to ensure "billingAddress" is required (not null)
            this.BillingAddress = billingAddress ?? throw new ArgumentNullException("billingAddress is a required property for CollectorFinancePaymentAllOf and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorFinancePaymentAllOf {\n");
        ...
        {
            return this.Equals(input as CollectorFinancePaymentAllOf);
        }

        /// <summary>
        /// Returns true if CollectorFinancePaymentAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorFinancePaymentAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorFinancePaymentAllOf input)
        {
            if (input == null)
                return false;
