...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// TransactionIngenico
    /// </summary>
    [DataContract(Name = "TransactionIngenico")]
    [JsonConverter(typeof(JsonSubtypes), "PaymentProduct")]
    public partial class TransactionIngenico : Transaction, IEquatable<TransactionIngenico>, IValidatableObject
    {
        /// <summary>
        /// The payment type corresponding to this transaction 
        /// </summary>
        /// <value>The payment type corresponding to this transaction </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionIngenico" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionIngenico() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionIngenico" /> class.
        /// </summary>
        ...
        /// <param name="paymentProductType">The payment type corresponding to this transaction  (required).</param>
        /// <param name="card">card.</param>
        /// <param name="events">events.</param>
        /// <param name="metadata">metadata.</param>
        /// <param name="paymentProduct">The payment product corresponding to this transaction  (required) (default to &quot;TransactionIngenico&quot;).</param>
        ...
        public TransactionIngenico(string id = default(string), DateTime createdAt = default(DateTime), PaymentProductTypeEnum paymentProductType = default(PaymentProductTypeEnum), TransactionIngenicoAllOfCard card = default(TransactionIngenicoAllOfCard), List<TransactionIngenicoAllOfEvents> events = default(List<TransactionIngenicoAllOfEvents>), TransactionIngenicoAllOfMetadata1 metadata = default(TransactionIngenicoAllOfMetadata1), string paymentProduct = "TransactionIngenico", int amount = default(int), string currency = default(string), string merchantReference = default(string), string merchantReference2 = default(string), string dynamicDescriptor = default(string), SettlementStatus? settlementStatus = default(SettlementStatus?), TransactionCustomer customer = default(TransactionCustomer), string customerIp = default(string), string userAgent = default(string), OrderAddress shippingAddress = default(OrderAddress), ShippingOption shippingOption = default(ShippingOption), OrderAddress billingAddress = default(OrderAddress), Store store = default(Store), List<OrderItem> items = default(List<OrderItem>), TransactionUrl url = default(TransactionUrl), string sessionId = default(string), Session session = default(Session), DateTime updatedAt = default(DateTime)) : base(paymentProduct, amount, currency, merchantReference, merchantReference2, dynamicDescriptor, settlementStatus, customer, customerIp, userAgent, shippingAddress, shippingOption, billingAddress, store, status, items, url, sessionId, session, updatedAt)
        {
        ...
        public TransactionIngenicoAllOfCard Card { get; set; }

        /// <summary>
        /// Gets or Sets Events
        /// </summary>
        [DataMember(Name = "events", EmitDefaultValue = false)]
        public List<TransactionIngenicoAllOfEvents> Events { get; set; }

        /// <summary>
        /// Gets or Sets Metadata
        /// </summary>
        [DataMember(Name = "metadata", EmitDefaultValue = false)]
        public TransactionIngenicoAllOfMetadata1 Metadata { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionIngenico {\n");
        ...
        {
            return this.Equals(input as TransactionIngenico);
        }

        /// <summary>
        /// Returns true if TransactionIngenico instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionIngenico to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionIngenico input)
        {
            if (input == null)
                return false;
