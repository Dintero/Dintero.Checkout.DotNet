...
{
    /// <summary>
    /// TransactionNetaxeptAllOfEvents
    /// </summary>
    [DataContract(Name = "TransactionNetaxept_allOf_events")]
    public partial class TransactionNetaxeptAllOfEvents : IEquatable<TransactionNetaxeptAllOfEvents>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionNetaxeptAllOfEvents" /> class.
        /// </summary>
        /// <param name="metadata">metadata.</param>
        public TransactionNetaxeptAllOfEvents(TransactionNetaxeptAllOfMetadata metadata = default(TransactionNetaxeptAllOfMetadata))
        {
        ...
        public TransactionNetaxeptAllOfMetadata Metadata { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionNetaxeptAllOfEvents {\n");
        ...
        {
            return this.Equals(input as TransactionNetaxeptAllOfEvents);
        }

        /// <summary>
        /// Returns true if TransactionNetaxeptAllOfEvents instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionNetaxeptAllOfEvents to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionNetaxeptAllOfEvents input)
        {
            if (input == null)
                return false;
