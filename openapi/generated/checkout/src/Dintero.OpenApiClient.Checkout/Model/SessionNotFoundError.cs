...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SessionNotFound_error")]
    public partial class SessionNotFoundError : IEquatable<SessionNotFoundError>, IValidatableObject
    {
        /// <summary>
        /// Optional not found reason
        /// </summary>
        /// <value>Optional not found reason</value>
        ...
        public enum CauseEnum
        {
            ...
            /// <summary>
            /// Enum PAYMENTINITIATED for value: PAYMENT_INITIATED
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionNotFoundError" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SessionNotFoundError() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionNotFoundError" /> class.
        /// </summary>
        /// <param name="code">The code used to identify the error/warning.</param>
        /// <param name="errors">The nested error(s) encountered during validation.</param>
        /// <param name="message">The human readable description of the error/warning (required).</param>
        /// <param name="cause">Optional not found reason.</param>
        /// <param name="sessionDetails">sessionDetails.</param>
        public SessionNotFoundError(string code = default(string), List<Object> errors = default(List<Object>), string message = default(string), CauseEnum? cause = default(CauseEnum?), SessionNotFoundErrorSessionDetails sessionDetails = default(SessionNotFoundErrorSessionDetails))
        {
            // to ensure "message" is required (not null)
            this.Message = message ?? throw new ArgumentNullException("message is a required property for SessionNotFoundError and cannot be null");
            this.Code = code;
            this.Errors = errors;
            this.Cause = cause;
        ...
        /// </summary>
        /// <value>The code used to identify the error/warning</value>
        ...
        /// </summary>
        /// <value>The nested error(s) encountered during validation</value>
        ...
        /// </summary>
        /// <value>The human readable description of the error/warning</value>
        [DataMember(Name = "message", IsRequired = true, EmitDefaultValue = false)]
        public string Message { get; set; }

        /// <summary>
        /// Gets or Sets SessionDetails
        /// </summary>
        [DataMember(Name = "session_details", EmitDefaultValue = false)]
        public SessionNotFoundErrorSessionDetails SessionDetails { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SessionNotFoundError {\n");
        ...
        {
            return this.Equals(input as SessionNotFoundError);
        }

        /// <summary>
        /// Returns true if SessionNotFoundError instances are equal
        /// </summary>
        /// <param name="input">Instance of SessionNotFoundError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SessionNotFoundError input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SessionDetails == input.SessionDetails ||
                    (this.SessionDetails != null &&
                    this.SessionDetails.Equals(input.SessionDetails))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SessionDetails != null)
                    hashCode = hashCode * 59 + this.SessionDetails.GetHashCode();
                return hashCode;
            }
        }
