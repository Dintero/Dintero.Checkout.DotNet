...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// CollectorAddress
    /// </summary>
    [DataContract(Name = "CollectorAddress")]
    public partial class CollectorAddress : IEquatable<CollectorAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorAddress" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorAddress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorAddress" /> class.
        /// </summary>
        ...
        /// <param name="businessName">Name of the company.</param>
        ...
        public CollectorAddress(string firstName = default(string), string lastName = default(string), string addressLine = default(string), string addressLine2 = default(string), string businessName = default(string), string coAddress = default(string), string postalCode = default(string), string postalPlace = default(string), string country = default(string), string phoneNumber = default(string), string email = default(string))
        {
            // to ensure "firstName" is required (not null)
            this.FirstName = firstName ?? throw new ArgumentNullException("firstName is a required property for CollectorAddress and cannot be null");
            // to ensure "lastName" is required (not null)
            this.LastName = lastName ?? throw new ArgumentNullException("lastName is a required property for CollectorAddress and cannot be null");
            // to ensure "addressLine" is required (not null)
            this.AddressLine = addressLine ?? throw new ArgumentNullException("addressLine is a required property for CollectorAddress and cannot be null");
            // to ensure "postalCode" is required (not null)
            this.PostalCode = postalCode ?? throw new ArgumentNullException("postalCode is a required property for CollectorAddress and cannot be null");
            // to ensure "postalPlace" is required (not null)
            this.PostalPlace = postalPlace ?? throw new ArgumentNullException("postalPlace is a required property for CollectorAddress and cannot be null");
            // to ensure "country" is required (not null)
            this.Country = country ?? throw new ArgumentNullException("country is a required property for CollectorAddress and cannot be null");
            // to ensure "phoneNumber" is required (not null)
            this.PhoneNumber = phoneNumber ?? throw new ArgumentNullException("phoneNumber is a required property for CollectorAddress and cannot be null");
            // to ensure "email" is required (not null)
            this.Email = email ?? throw new ArgumentNullException("email is a required property for CollectorAddress and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorAddress {\n");
        ...
        {
            return this.Equals(input as CollectorAddress);
        }

        /// <summary>
        /// Returns true if CollectorAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorAddress input)
        {
            if (input == null)
                return false;
