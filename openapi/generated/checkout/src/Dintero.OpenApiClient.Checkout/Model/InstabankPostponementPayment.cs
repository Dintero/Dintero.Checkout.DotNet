...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InstabankPostponementPayment")]
    [JsonConverter(typeof(JsonSubtypes), "PaymentProductType")]
    public partial class InstabankPostponementPayment : Payment, IEquatable<InstabankPostponementPayment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankPostponementPayment" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstabankPostponementPayment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankPostponementPayment" /> class.
        /// </summary>
        ...
        /// <param name="totalIncome">income received by person from all source in smallest unit for the currency. e.g. $1.5 &#x3D; 150. **Required**.  (required).</param>
        /// <param name="paymentProductType">The payment product type corresponding to this transaction  (required) (default to &quot;InstabankPostponementPayment&quot;).</param>
        ...
        public InstabankPostponementPayment(string email = default(string), string socialSecurityNumber = default(string), string phoneNumber = default(string), int totalIncome = default(int), string paymentProductType = "InstabankPostponementPayment", string productCode = default(string), InstabankApplication applicant = default(InstabankApplication), bool rememberMe = default(bool)) : base()
        {
            // to ensure "email" is required (not null)
            this.Email = email ?? throw new ArgumentNullException("email is a required property for InstabankPostponementPayment and cannot be null");
            // to ensure "socialSecurityNumber" is required (not null)
            this.SocialSecurityNumber = socialSecurityNumber ?? throw new ArgumentNullException("socialSecurityNumber is a required property for InstabankPostponementPayment and cannot be null");
            // to ensure "phoneNumber" is required (not null)
            this.PhoneNumber = phoneNumber ?? throw new ArgumentNullException("phoneNumber is a required property for InstabankPostponementPayment and cannot be null");
            this.TotalIncome = totalIncome;
            // to ensure "paymentProductType" is required (not null)
            this.PaymentProductType = paymentProductType ?? throw new ArgumentNullException("paymentProductType is a required property for InstabankPostponementPayment and cannot be null");
            // to ensure "productCode" is required (not null)
            this.ProductCode = productCode ?? throw new ArgumentNullException("productCode is a required property for InstabankPostponementPayment and cannot be null");
        ...
        /// <summary>
        /// income received by person from all source in smallest unit for the currency. e.g. $1.5 &#x3D; 150. **Required**. 
        /// </summary>
        /// <value>income received by person from all source in smallest unit for the currency. e.g. $1.5 &#x3D; 150. **Required**. </value>
        ...
        public InstabankApplication Applicant { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstabankPostponementPayment {\n");
        ...
        {
            return this.Equals(input as InstabankPostponementPayment);
        }

        /// <summary>
        /// Returns true if InstabankPostponementPayment instances are equal
        /// </summary>
        /// <param name="input">Instance of InstabankPostponementPayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstabankPostponementPayment input)
        {
            if (input == null)
                return false;
