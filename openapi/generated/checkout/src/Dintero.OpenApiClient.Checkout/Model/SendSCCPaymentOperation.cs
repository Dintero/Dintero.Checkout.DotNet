...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SendSCCPaymentOperation")]
    [JsonConverter(typeof(JsonSubtypes), "Rel")]
    public partial class SendSCCPaymentOperation : PaymentOperation, IEquatable<SendSCCPaymentOperation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SendSCCPaymentOperation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SendSCCPaymentOperation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SendSCCPaymentOperation" /> class.
        /// </summary>
        /// <param name="href">Contains the URI to to send SCC code. .</param>
        /// <param name="contentType">contentType.</param>
        /// <param name="method">The HTTP method to use when performing the operation .</param>
        /// <param name="rel">rel (required) (default to &quot;SendSCCPaymentOperation&quot;).</param>
        public SendSCCPaymentOperation(string href = default(string), ContentTypeEnum? contentType = default(ContentTypeEnum?), MethodEnum? method = default(MethodEnum?), string rel = "SendSCCPaymentOperation") : base(contentType, method, rel)
        {
            this.Href = href;
        }
        ...
        /// </summary>
        /// <value>Contains the URI to to send SCC code. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SendSCCPaymentOperation {\n");
        ...
        {
            return this.Equals(input as SendSCCPaymentOperation);
        }

        /// <summary>
        /// Returns true if SendSCCPaymentOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of SendSCCPaymentOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SendSCCPaymentOperation input)
        {
            if (input == null)
                return false;
