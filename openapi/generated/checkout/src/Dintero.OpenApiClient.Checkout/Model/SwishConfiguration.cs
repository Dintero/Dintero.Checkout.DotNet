...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// Swish configuration
    /// </summary>
    [DataContract(Name = "SwishConfiguration")]
    public partial class SwishConfiguration : IEquatable<SwishConfiguration>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SwishConfiguration" /> class.
        /// </summary>
        /// <param name="type">Denotes what kind of config parameter this is.</param>
        /// <param name="swish">swish.</param>
        public SwishConfiguration(TypeEnum? type = default(TypeEnum?), SwishConfigurationSwish swish = default(SwishConfigurationSwish))
        {
            this.Type = type;
            this.Swish = swish;
        }
        ...
        public SwishConfigurationSwish Swish { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SwishConfiguration {\n");
        ...
        {
            return this.Equals(input as SwishConfiguration);
        }

        /// <summary>
        /// Returns true if SwishConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of SwishConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SwishConfiguration input)
        {
            if (input == null)
                return false;
