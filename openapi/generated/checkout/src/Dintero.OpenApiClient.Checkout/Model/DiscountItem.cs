...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// DiscountItem
    /// </summary>
    [DataContract(Name = "DiscountItem")]
    public partial class DiscountItem : IEquatable<DiscountItem>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DiscountItem" /> class.
        /// </summary>
        /// <param name="amount">Monetary amount in smallest unit for the currency .</param>
        /// <param name="percentage">Optional, set if the amount given was from a percentage discount .</param>
        /// <param name="discountType">discountType.</param>
        /// <param name="discountId">discountId.</param>
        /// <param name="description">description.</param>
        /// <param name="lineId">lineId.</param>
        public DiscountItem(int amount = default(int), decimal percentage = default(decimal), DiscountType? discountType = default(DiscountType?), string discountId = default(string), string description = default(string), int lineId = default(int))
        {
            this.Amount = amount;
        ...
        /// </summary>
        /// <value>Optional, set if the amount given was from a percentage discount </value>
        ...
        {
            return this.Equals(input as DiscountItem);
        }

        /// <summary>
        /// Returns true if DiscountItem instances are equal
        /// </summary>
        /// <param name="input">Instance of DiscountItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DiscountItem input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.DiscountId.Equals(input.DiscountId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DiscountId != null)
                    hashCode = hashCode * 59 + this.DiscountId.GetHashCode();
