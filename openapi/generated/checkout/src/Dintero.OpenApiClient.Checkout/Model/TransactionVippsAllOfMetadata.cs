...
{
    /// <summary>
    /// TransactionVippsAllOfMetadata
    /// </summary>
    [DataContract(Name = "TransactionVipps_allOf_metadata")]
    public partial class TransactionVippsAllOfMetadata : IEquatable<TransactionVippsAllOfMetadata>, IValidatableObject
    {
        /// <summary>
        /// Defines VippstransactionInfoStatus
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum VippstransactionInfoStatusEnum
        {
            /// <summary>
        ...
        /// <summary>
        /// Gets or Sets VippstransactionInfoStatus
        /// </summary>
        [DataMember(Name = "vipps:transactionInfo.status", EmitDefaultValue = false)]
        public VippstransactionInfoStatusEnum? VippstransactionInfoStatus { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionVippsAllOfMetadata" /> class.
        /// </summary>
        /// <param name="vippstransactionInfoTimeStamp">vippstransactionInfoTimeStamp.</param>
        /// <param name="vippstransactionInfoTransactionId">vippstransactionInfoTransactionId.</param>
        /// <param name="vippstransactionInfoStatus">vippstransactionInfoStatus.</param>
        /// <param name="vippstransactionTransactionText">vippstransactionTransactionText.</param>
        public TransactionVippsAllOfMetadata(DateTime vippstransactionInfoTimeStamp = default(DateTime), string vippstransactionInfoTransactionId = default(string), VippstransactionInfoStatusEnum? vippstransactionInfoStatus = default(VippstransactionInfoStatusEnum?), string vippstransactionTransactionText = default(string))
        {
            this.VippstransactionInfoTimeStamp = vippstransactionInfoTimeStamp;
            this.VippstransactionInfoTransactionId = vippstransactionInfoTransactionId;
            this.VippstransactionInfoStatus = vippstransactionInfoStatus;
            this.VippstransactionTransactionText = vippstransactionTransactionText;
        }

        /// <summary>
        /// Gets or Sets VippstransactionInfoTimeStamp
        /// </summary>
        [DataMember(Name = "vipps:transactionInfo.timeStamp", EmitDefaultValue = false)]
        public DateTime VippstransactionInfoTimeStamp { get; set; }

        /// <summary>
        /// Gets or Sets VippstransactionInfoTransactionId
        /// </summary>
        [DataMember(Name = "vipps:transactionInfo.transactionId", EmitDefaultValue = false)]
        public string VippstransactionInfoTransactionId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionVippsAllOfMetadata {\n");
            sb.Append("  VippstransactionInfoTimeStamp: ").Append(VippstransactionInfoTimeStamp).Append("\n");
            sb.Append("  VippstransactionInfoTransactionId: ").Append(VippstransactionInfoTransactionId).Append("\n");
            sb.Append("  VippstransactionInfoStatus: ").Append(VippstransactionInfoStatus).Append("\n");
        ...
        {
            return this.Equals(input as TransactionVippsAllOfMetadata);
        }

        /// <summary>
        /// Returns true if TransactionVippsAllOfMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionVippsAllOfMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionVippsAllOfMetadata input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.VippstransactionInfoTimeStamp == input.VippstransactionInfoTimeStamp ||
                    (this.VippstransactionInfoTimeStamp != null &&
                    this.VippstransactionInfoTimeStamp.Equals(input.VippstransactionInfoTimeStamp))
                ) && 
                (
                    this.VippstransactionInfoTransactionId == input.VippstransactionInfoTransactionId ||
                    (this.VippstransactionInfoTransactionId != null &&
                    this.VippstransactionInfoTransactionId.Equals(input.VippstransactionInfoTransactionId))
                ) && 
                (
                    this.VippstransactionInfoStatus == input.VippstransactionInfoStatus ||
                    this.VippstransactionInfoStatus.Equals(input.VippstransactionInfoStatus)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.VippstransactionInfoTimeStamp != null)
                    hashCode = hashCode * 59 + this.VippstransactionInfoTimeStamp.GetHashCode();
                if (this.VippstransactionInfoTransactionId != null)
                    hashCode = hashCode * 59 + this.VippstransactionInfoTransactionId.GetHashCode();
                hashCode = hashCode * 59 + this.VippstransactionInfoStatus.GetHashCode();
