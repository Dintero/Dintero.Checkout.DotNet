...
{
    /// <summary>
    /// CollectorInstallmentPaymentOperationAllOf
    /// </summary>
    [DataContract(Name = "CollectorInstallmentPaymentOperation_allOf")]
    public partial class CollectorInstallmentPaymentOperationAllOf : IEquatable<CollectorInstallmentPaymentOperationAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorInstallmentPaymentOperationAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorInstallmentPaymentOperationAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorInstallmentPaymentOperationAllOf" /> class.
        /// </summary>
        /// <param name="href">Contains the URI to initiate a payment. .</param>
        /// <param name="product">product (required).</param>
        public CollectorInstallmentPaymentOperationAllOf(string href = default(string), CollectorProduct product = default(CollectorProduct))
        {
            // to ensure "product" is required (not null)
            this.Product = product ?? throw new ArgumentNullException("product is a required property for CollectorInstallmentPaymentOperationAllOf and cannot be null");
            this.Href = href;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorInstallmentPaymentOperationAllOf {\n");
        ...
        {
            return this.Equals(input as CollectorInstallmentPaymentOperationAllOf);
        }

        /// <summary>
        /// Returns true if CollectorInstallmentPaymentOperationAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorInstallmentPaymentOperationAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorInstallmentPaymentOperationAllOf input)
        {
            if (input == null)
                return false;
