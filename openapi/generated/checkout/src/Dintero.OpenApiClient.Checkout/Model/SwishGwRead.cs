...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SwishGwRead")]
    public partial class SwishGwRead : IEquatable<SwishGwRead>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SwishGwRead" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SwishGwRead() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SwishGwRead" /> class.
        /// </summary>
        /// <param name="url">url (required).</param>
        /// <param name="swishNumber">The merchant&#39;s Swish number (required).</param>
        public SwishGwRead(string url = default(string), string swishNumber = default(string))
        {
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url is a required property for SwishGwRead and cannot be null");
            // to ensure "swishNumber" is required (not null)
            this.SwishNumber = swishNumber ?? throw new ArgumentNullException("swishNumber is a required property for SwishGwRead and cannot be null");
        }
        ...
        {
            return this.Equals(input as SwishGwRead);
        }

        /// <summary>
        /// Returns true if SwishGwRead instances are equal
        /// </summary>
        /// <param name="input">Instance of SwishGwRead to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SwishGwRead input)
        {
            if (input == null)
                return false;
