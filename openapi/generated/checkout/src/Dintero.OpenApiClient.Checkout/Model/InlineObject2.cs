...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class InlineObject2 : IEquatable<InlineObject2>, IValidatableObject
    {
        ...
        public InlineObject2(string storeId = default(string), CollectorGwStoreOverrideWrite _override = default(CollectorGwStoreOverrideWrite))
        {
            // to ensure "storeId" is required (not null)
            this.StoreId = storeId ?? throw new ArgumentNullException("storeId is a required property for InlineObject2 and cannot be null");
        ...
        public CollectorGwStoreOverrideWrite Override { get; set; }
