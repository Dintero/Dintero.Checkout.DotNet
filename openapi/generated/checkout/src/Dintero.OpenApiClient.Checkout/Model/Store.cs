...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class Store : IEquatable<Store>, IValidatableObject
    {
        ...
        /// <param name="name">name of the store, aka trade name of the store .</param>
        /// <param name="businessName">Official name of the person or entity that owns the store. .</param>
        ...
        /// <param name="mcc">A four-digit Merchant Category Code (MCC) for the store [ISO 18245:2003](https://www.iso.org/standard/33365.html) .</param>
        /// <param name="bax">Merchant number associated with the stores payment terminal .</param>
        /// <param name="terminalId">Id to a specific point-of-sale (POS) terminal or workstation .</param>
        public Store(string id = default(string), string name = default(string), string businessName = default(string), Address address = default(Address), string chain = default(string), string email = default(string), string gln = default(string), string organizationNumber = default(string), string phoneNumber = default(string), string mcc = default(string), string bax = default(string), string terminalId = default(string))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for Store and cannot be null");
            this.Name = name;
        ...
        /// </summary>
        /// <value>name of the store, aka trade name of the store </value>
        ...
        /// </summary>
        /// <value>Official name of the person or entity that owns the store. </value>
        ...
        /// <summary>
        /// A four-digit Merchant Category Code (MCC) for the store [ISO 18245:2003](https://www.iso.org/standard/33365.html) 
        /// </summary>
        /// <value>A four-digit Merchant Category Code (MCC) for the store [ISO 18245:2003](https://www.iso.org/standard/33365.html) </value>
        ...
        /// </summary>
        /// <value>Merchant number associated with the stores payment terminal </value>
        [DataMember(Name = "bax", EmitDefaultValue = false)]
        public string Bax { get; set; }

        /// <summary>
        /// Id to a specific point-of-sale (POS) terminal or workstation 
        /// </summary>
        /// <value>Id to a specific point-of-sale (POS) terminal or workstation </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Bax: ").Append(Bax).Append("\n");
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Gln != null)
                    hashCode = hashCode * 59 + this.Gln.GetHashCode();
                ...
                if (this.Bax != null)
                    hashCode = hashCode * 59 + this.Bax.GetHashCode();
