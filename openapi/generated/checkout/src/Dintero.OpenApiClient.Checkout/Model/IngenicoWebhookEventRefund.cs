...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IngenicoWebhookEvent_refund")]
    public partial class IngenicoWebhookEventRefund : IEquatable<IngenicoWebhookEventRefund>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        public enum StatusEnum
        {
            ...
            /// <summary>
            /// Enum REFUNDREQUESTED for value: REFUND_REQUESTED
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoWebhookEventRefund" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="status">status.</param>
        /// <param name="statusOutput">statusOutput.</param>
        /// <param name="refundOutput">refundOutput.</param>
        public IngenicoWebhookEventRefund(string id = default(string), StatusEnum? status = default(StatusEnum?), IngenicoWebhookEventRefundStatusOutput statusOutput = default(IngenicoWebhookEventRefundStatusOutput), IngenicoWebhookEventRefundRefundOutput refundOutput = default(IngenicoWebhookEventRefundRefundOutput))
        {
            this.Id = id;
            this.Status = status;
        ...
        public IngenicoWebhookEventRefundRefundOutput RefundOutput { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IngenicoWebhookEventRefund {\n");
        ...
        {
            return this.Equals(input as IngenicoWebhookEventRefund);
        }

        /// <summary>
        /// Returns true if IngenicoWebhookEventRefund instances are equal
        /// </summary>
        /// <param name="input">Instance of IngenicoWebhookEventRefund to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IngenicoWebhookEventRefund input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.RefundOutput == input.RefundOutput ||
                    (this.RefundOutput != null &&
                    this.RefundOutput.Equals(input.RefundOutput))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RefundOutput != null)
                    hashCode = hashCode * 59 + this.RefundOutput.GetHashCode();
                return hashCode;
            }
        }
