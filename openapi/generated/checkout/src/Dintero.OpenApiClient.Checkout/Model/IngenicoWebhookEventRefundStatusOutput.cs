...
{
    /// <summary>
    /// IngenicoWebhookEventRefundStatusOutput
    /// </summary>
    [DataContract(Name = "IngenicoWebhookEvent_refund_statusOutput")]
    public partial class IngenicoWebhookEventRefundStatusOutput : IEquatable<IngenicoWebhookEventRefundStatusOutput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoWebhookEventRefundStatusOutput" /> class.
        /// </summary>
        ...
        public IngenicoWebhookEventRefundStatusOutput(bool isCancellable = default(bool), bool isRefundable = default(bool), string statusCategory = default(string), int statusCode = default(int), string statusCodeChangeDateTime = default(string), List<IngenicoWebhookEventPaymentStatusOutputErrors> errors = default(List<IngenicoWebhookEventPaymentStatusOutputErrors>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IngenicoWebhookEventRefundStatusOutput {\n");
        ...
        {
            return this.Equals(input as IngenicoWebhookEventRefundStatusOutput);
        }

        /// <summary>
        /// Returns true if IngenicoWebhookEventRefundStatusOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of IngenicoWebhookEventRefundStatusOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IngenicoWebhookEventRefundStatusOutput input)
        {
            if (input == null)
                return false;
