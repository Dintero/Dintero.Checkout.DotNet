...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ViewSessionUpdateAddress")]
    public partial class ViewSessionUpdateAddress : IEquatable<ViewSessionUpdateAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewSessionUpdateAddress" /> class.
        /// </summary>
        /// <param name="shippingAddress">shippingAddress.</param>
        /// <param name="billingAddress">billingAddress.</param>
        /// <param name="myDintero">myDintero.</param>
        public ViewSessionUpdateAddress(OrderAddress shippingAddress = default(OrderAddress), OrderAddress billingAddress = default(OrderAddress), MyDinteroUserCreation myDintero = default(MyDinteroUserCreation))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ViewSessionUpdateAddress {\n");
        ...
        {
            return this.Equals(input as ViewSessionUpdateAddress);
        }

        /// <summary>
        /// Returns true if ViewSessionUpdateAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of ViewSessionUpdateAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ViewSessionUpdateAddress input)
        {
            if (input == null)
                return false;
