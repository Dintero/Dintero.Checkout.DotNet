...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// OrderItemGroups
    /// </summary>
    [DataContract(Name = "OrderItem_groups")]
    public partial class OrderItemGroups : IEquatable<OrderItemGroups>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderItemGroups" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OrderItemGroups() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderItemGroups" /> class.
        /// </summary>
        /// <param name="id">Group ID (required).</param>
        /// <param name="name">Group name.</param>
        public OrderItemGroups(string id = default(string), string name = default(string))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for OrderItemGroups and cannot be null");
            this.Name = name;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrderItemGroups {\n");
        ...
        {
            return this.Equals(input as OrderItemGroups);
        }

        /// <summary>
        /// Returns true if OrderItemGroups instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderItemGroups to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderItemGroups input)
        {
            if (input == null)
                return false;
