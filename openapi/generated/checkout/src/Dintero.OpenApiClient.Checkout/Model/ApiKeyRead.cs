...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// ApiKeyRead
    /// </summary>
    [DataContract(Name = "ApiKeyRead")]
    public partial class ApiKeyRead : IEquatable<ApiKeyRead>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiKeyRead" /> class.
        /// </summary>
        ...
        public ApiKeyRead(string id = default(string), DateTime createdAt = default(DateTime), string name = default(string), DateTime updatedAt = default(DateTime), DateTime expiresAt = default(DateTime), string deletedBy = default(string), DateTime deletedAt = default(DateTime))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for ApiKeyRead and cannot be null");
            this.Id = id;
        ...
        {
            return this.Equals(input as ApiKeyRead);
        }

        /// <summary>
        /// Returns true if ApiKeyRead instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiKeyRead to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiKeyRead input)
        {
            if (input == null)
                return false;
