...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class InlineResponse2007 : IEquatable<InlineResponse2007>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="InlineResponse2007" /> class.
        /// </summary>
        /// <param name="shippingOptions">Shipping options that will be presented to the end user after the callback  - If the merchant is not able to ship the order to the end users   shipping address, use an empty array. - If there is only one option, a free delivery, the order still   has to contain one option with a _&#x60;price.amount&#x60;_ of 0.  (required).</param>
        /// <param name="order">order.</param>
        public InlineResponse2007(List<ShippingOption> shippingOptions = default(List<ShippingOption>), ShippingAddressCallbackSessionOrderUpdate order = default(ShippingAddressCallbackSessionOrderUpdate))
        {
            // to ensure "shippingOptions" is required (not null)
            this.ShippingOptions = shippingOptions ?? throw new ArgumentNullException("shippingOptions is a required property for InlineResponse2007 and cannot be null");
            this.Order = order;
        }

        /// <summary>
        /// Shipping options that will be presented to the end user after the callback  - If the merchant is not able to ship the order to the end users   shipping address, use an empty array. - If there is only one option, a free delivery, the order still   has to contain one option with a _&#x60;price.amount&#x60;_ of 0. 
        /// </summary>
        /// <value>Shipping options that will be presented to the end user after the callback  - If the merchant is not able to ship the order to the end users   shipping address, use an empty array. - If there is only one option, a free delivery, the order still   has to contain one option with a _&#x60;price.amount&#x60;_ of 0. </value>
        ...
        public ShippingAddressCallbackSessionOrderUpdate Order { get; set; }
