...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// VippsConfiguration
    /// </summary>
    [DataContract(Name = "VippsConfiguration")]
    public partial class VippsConfiguration : IEquatable<VippsConfiguration>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VippsConfiguration" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VippsConfiguration() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VippsConfiguration" /> class.
        /// </summary>
        /// <param name="enabled">enable vipps payment (required).</param>
        /// <param name="payability">payability.</param>
        /// <param name="dynamicDescriptor">A short reference / descriptor that can be displayed to the end user .</param>
        public VippsConfiguration(bool enabled = default(bool), SessionPayability? payability = default(SessionPayability?), string dynamicDescriptor = default(string))
        {
        ...
        /// </summary>
        /// <value>enable vipps payment</value>
        ...
        /// </summary>
        /// <value>A short reference / descriptor that can be displayed to the end user </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VippsConfiguration {\n");
        ...
        {
            return this.Equals(input as VippsConfiguration);
        }

        /// <summary>
        /// Returns true if VippsConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of VippsConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VippsConfiguration input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if(this.DynamicDescriptor != null && this.DynamicDescriptor.Length > 100)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DynamicDescriptor, length must be less than 100.", new [] { "DynamicDescriptor" });
            }
