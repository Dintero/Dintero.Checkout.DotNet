...
{
    /// <summary>
    /// NetaxeptConfigurationCreditcard
    /// </summary>
    [DataContract(Name = "NetaxeptConfiguration_creditcard")]
    public partial class NetaxeptConfigurationCreditcard : IEquatable<NetaxeptConfigurationCreditcard>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NetaxeptConfigurationCreditcard" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NetaxeptConfigurationCreditcard() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NetaxeptConfigurationCreditcard" /> class.
        /// </summary>
        ...
        public NetaxeptConfigurationCreditcard(TypeEnum? type = default(TypeEnum?), bool enabled = default(bool), SessionPayability? payability = default(SessionPayability?), NetaxeptConfigurationCreditcardTerminal terminal = default(NetaxeptConfigurationCreditcardTerminal))
        {
        ...
        public NetaxeptConfigurationCreditcardTerminal Terminal { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NetaxeptConfigurationCreditcard {\n");
        ...
        {
            return this.Equals(input as NetaxeptConfigurationCreditcard);
        }

        /// <summary>
        /// Returns true if NetaxeptConfigurationCreditcard instances are equal
        /// </summary>
        /// <param name="input">Instance of NetaxeptConfigurationCreditcard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NetaxeptConfigurationCreditcard input)
        {
            if (input == null)
                return false;
