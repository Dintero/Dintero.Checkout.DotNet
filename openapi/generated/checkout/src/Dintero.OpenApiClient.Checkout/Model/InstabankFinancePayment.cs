...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InstabankFinancePayment")]
    [JsonConverter(typeof(JsonSubtypes), "PaymentProductType")]
    public partial class InstabankFinancePayment : Payment, IEquatable<InstabankFinancePayment>, IValidatableObject
    {
        /// <summary>
        ...
        public enum MaritalStatusEnum
        {
            ...
            /// <summary>
            /// Enum Cohabiting for value: cohabiting
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankFinancePayment" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstabankFinancePayment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankFinancePayment" /> class.
        /// </summary>
        /// <param name="email">The email address of a person or an organisation  (required).</param>
        /// <param name="socialSecurityNumber">The social security number of the customer. Only supported for NO. (required).</param>
        ...
        /// <param name="totalIncome">**Deprecated** in favour of the top-level &#x60;total_income&#x60;.  income received by person from all source in smallest unit for the currency. e.g. $1.5 &#x3D; 150.  (required).</param>
        /// <param name="ownsHouse">The consumer owns their house  (required).</param>
        /// <param name="monthlyHouseRental">Monthly housing cost in smallest unit for the currency. e.g. $1.5 &#x3D; 150 **Required** if &#x60;owns_house&#x60; is &#x60;false&#x60; .</param>
        /// <param name="maritalStatus">maritalStatus (required).</param>
        /// <param name="mortgageDebt">amount of money in smallest unit for the currency. .</param>
        /// <param name="consumerDebt">amount of money in smallest unit for the currency. (credit card, consumer finances) .</param>
        /// <param name="studentDebt">amount of money in smallest unit for the currency. .</param>
        /// <param name="otherSecuredDebt">amount of money in smallest unit for the currency. (car, boat, MC) .</param>
        /// <param name="numberOfChildren">number of children below the age of 18 in the household  (required).</param>
        /// <param name="debt">debt (required).</param>
        /// <param name="paymentProductType">The payment product type corresponding to this transaction  (required) (default to &quot;InstabankFinancePayment&quot;).</param>
        /// <param name="rememberMe">If true will either make the backend add or update a signed cookie with customer data. If false the cookie will be removed. If not set, any existing cookie will remain unchanged .</param>
        public InstabankFinancePayment(string email = default(string), string socialSecurityNumber = default(string), string phoneNumber = default(string), int totalIncome = default(int), bool ownsHouse = default(bool), int monthlyHouseRental = default(int), MaritalStatusEnum maritalStatus = default(MaritalStatusEnum), int mortgageDebt = default(int), int consumerDebt = default(int), int studentDebt = default(int), int otherSecuredDebt = default(int), int numberOfChildren = default(int), List<InstabankApplicationDebt> debt = default(List<InstabankApplicationDebt>), string paymentProductType = "InstabankFinancePayment", bool rememberMe = default(bool)) : base()
        {
            // to ensure "email" is required (not null)
            this.Email = email ?? throw new ArgumentNullException("email is a required property for InstabankFinancePayment and cannot be null");
            // to ensure "socialSecurityNumber" is required (not null)
            this.SocialSecurityNumber = socialSecurityNumber ?? throw new ArgumentNullException("socialSecurityNumber is a required property for InstabankFinancePayment and cannot be null");
            // to ensure "phoneNumber" is required (not null)
            this.PhoneNumber = phoneNumber ?? throw new ArgumentNullException("phoneNumber is a required property for InstabankFinancePayment and cannot be null");
            this.TotalIncome = totalIncome;
            this.OwnsHouse = ownsHouse;
            this.MaritalStatus = maritalStatus;
            this.NumberOfChildren = numberOfChildren;
            // to ensure "debt" is required (not null)
            this.Debt = debt ?? throw new ArgumentNullException("debt is a required property for InstabankFinancePayment and cannot be null");
            // to ensure "paymentProductType" is required (not null)
            this.PaymentProductType = paymentProductType ?? throw new ArgumentNullException("paymentProductType is a required property for InstabankFinancePayment and cannot be null");
            this.MonthlyHouseRental = monthlyHouseRental;
            this.MortgageDebt = mortgageDebt;
            this.ConsumerDebt = consumerDebt;
            this.StudentDebt = studentDebt;
            this.OtherSecuredDebt = otherSecuredDebt;
        ...
        /// <summary>
        /// The social security number of the customer. Only supported for NO.
        /// </summary>
        /// <value>The social security number of the customer. Only supported for NO.</value>
        [DataMember(Name = "social_security_number", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// <summary>
        /// **Deprecated** in favour of the top-level &#x60;total_income&#x60;.  income received by person from all source in smallest unit for the currency. e.g. $1.5 &#x3D; 150. 
        /// </summary>
        /// <value>**Deprecated** in favour of the top-level &#x60;total_income&#x60;.  income received by person from all source in smallest unit for the currency. e.g. $1.5 &#x3D; 150. </value>
        [DataMember(Name = "total_income", IsRequired = true, EmitDefaultValue = false)]
        public int TotalIncome { get; set; }

        /// <summary>
        /// The consumer owns their house 
        /// </summary>
        /// <value>The consumer owns their house </value>
        [DataMember(Name = "owns_house", IsRequired = true, EmitDefaultValue = true)]
        public bool OwnsHouse { get; set; }

        /// <summary>
        /// Monthly housing cost in smallest unit for the currency. e.g. $1.5 &#x3D; 150 **Required** if &#x60;owns_house&#x60; is &#x60;false&#x60; 
        /// </summary>
        /// <value>Monthly housing cost in smallest unit for the currency. e.g. $1.5 &#x3D; 150 **Required** if &#x60;owns_house&#x60; is &#x60;false&#x60; </value>
        [DataMember(Name = "monthly_house_rental", EmitDefaultValue = false)]
        public int MonthlyHouseRental { get; set; }

        /// <summary>
        /// amount of money in smallest unit for the currency. 
        /// </summary>
        /// <value>amount of money in smallest unit for the currency. </value>
        [DataMember(Name = "mortgage_debt", EmitDefaultValue = false)]
        public int MortgageDebt { get; set; }

        /// <summary>
        /// amount of money in smallest unit for the currency. (credit card, consumer finances) 
        /// </summary>
        /// <value>amount of money in smallest unit for the currency. (credit card, consumer finances) </value>
        [DataMember(Name = "consumer_debt", EmitDefaultValue = false)]
        public int ConsumerDebt { get; set; }

        /// <summary>
        /// amount of money in smallest unit for the currency. 
        /// </summary>
        /// <value>amount of money in smallest unit for the currency. </value>
        [DataMember(Name = "student_debt", EmitDefaultValue = false)]
        public int StudentDebt { get; set; }

        /// <summary>
        /// amount of money in smallest unit for the currency. (car, boat, MC) 
        /// </summary>
        /// <value>amount of money in smallest unit for the currency. (car, boat, MC) </value>
        [DataMember(Name = "other_secured_debt", EmitDefaultValue = false)]
        public int OtherSecuredDebt { get; set; }

        /// <summary>
        /// number of children below the age of 18 in the household 
        /// </summary>
        /// <value>number of children below the age of 18 in the household </value>
        [DataMember(Name = "number_of_children", IsRequired = true, EmitDefaultValue = false)]
        public int NumberOfChildren { get; set; }

        /// <summary>
        /// Gets or Sets Debt
        /// </summary>
        [DataMember(Name = "debt", IsRequired = true, EmitDefaultValue = false)]
        public List<InstabankApplicationDebt> Debt { get; set; }
        ...
        /// </summary>
        /// <value>If true will either make the backend add or update a signed cookie with customer data. If false the cookie will be removed. If not set, any existing cookie will remain unchanged </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstabankFinancePayment {\n");
            sb.Append("  ").Append(base.ToString().Replace("\n", "\n  ")).Append("\n");
            sb.Append("  Email: ").Append(Email).Append("\n");
            sb.Append("  SocialSecurityNumber: ").Append(SocialSecurityNumber).Append("\n");
            sb.Append("  PhoneNumber: ").Append(PhoneNumber).Append("\n");
            sb.Append("  TotalIncome: ").Append(TotalIncome).Append("\n");
            sb.Append("  OwnsHouse: ").Append(OwnsHouse).Append("\n");
            sb.Append("  MonthlyHouseRental: ").Append(MonthlyHouseRental).Append("\n");
            sb.Append("  MaritalStatus: ").Append(MaritalStatus).Append("\n");
            sb.Append("  MortgageDebt: ").Append(MortgageDebt).Append("\n");
            sb.Append("  ConsumerDebt: ").Append(ConsumerDebt).Append("\n");
            sb.Append("  StudentDebt: ").Append(StudentDebt).Append("\n");
            sb.Append("  OtherSecuredDebt: ").Append(OtherSecuredDebt).Append("\n");
        ...
        {
            return this.Equals(input as InstabankFinancePayment);
        }

        /// <summary>
        /// Returns true if InstabankFinancePayment instances are equal
        /// </summary>
        /// <param name="input">Instance of InstabankFinancePayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstabankFinancePayment input)
        {
            if (input == null)
                return false;
            ...
            return base.Equals(input) && 
                ...
                (
                    this.OwnsHouse == input.OwnsHouse ||
                    this.OwnsHouse.Equals(input.OwnsHouse)
                ) && base.Equals(input) && 
                (
                    this.MonthlyHouseRental == input.MonthlyHouseRental ||
                    this.MonthlyHouseRental.Equals(input.MonthlyHouseRental)
                ) && base.Equals(input) && 
                (
                ...
                (
                    this.MortgageDebt == input.MortgageDebt ||
                    this.MortgageDebt.Equals(input.MortgageDebt)
                ) && base.Equals(input) && 
                (
                    this.ConsumerDebt == input.ConsumerDebt ||
                    this.ConsumerDebt.Equals(input.ConsumerDebt)
                ) && base.Equals(input) && 
                (
                    this.StudentDebt == input.StudentDebt ||
                    this.StudentDebt.Equals(input.StudentDebt)
                ) && base.Equals(input) && 
                (
                    this.OtherSecuredDebt == input.OtherSecuredDebt ||
                    this.OtherSecuredDebt.Equals(input.OtherSecuredDebt)
                ) && base.Equals(input) && 
                (
                ...
                (
                    ...
                    this.Debt != null &&
                    input.Debt != null &&
                    this.Debt.SequenceEqual(input.Debt)
                ) && base.Equals(input) && 
                (
                    this.PaymentProductType == input.PaymentProductType ||
                    (this.PaymentProductType != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.OwnsHouse.GetHashCode();
                hashCode = hashCode * 59 + this.MonthlyHouseRental.GetHashCode();
                hashCode = hashCode * 59 + this.MaritalStatus.GetHashCode();
                hashCode = hashCode * 59 + this.MortgageDebt.GetHashCode();
                hashCode = hashCode * 59 + this.ConsumerDebt.GetHashCode();
                hashCode = hashCode * 59 + this.StudentDebt.GetHashCode();
                hashCode = hashCode * 59 + this.OtherSecuredDebt.GetHashCode();
        ...
        protected IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> BaseValidate(ValidationContext validationContext)
        {
            ...
            if(this.SocialSecurityNumber != null && this.SocialSecurityNumber.Length > 11)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SocialSecurityNumber, length must be less than 11.", new [] { "SocialSecurityNumber" });
            }

            // SocialSecurityNumber (string) minLength
            if(this.SocialSecurityNumber != null && this.SocialSecurityNumber.Length < 11)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SocialSecurityNumber, length must be greater than 11.", new [] { "SocialSecurityNumber" });
            }
            ...
            // NumberOfChildren (int) minimum
            if(this.NumberOfChildren < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NumberOfChildren, must be a value greater than or equal to 0.", new [] { "NumberOfChildren" });
            }
