...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class InlineObject8 : IEquatable<InlineObject8>, IValidatableObject
    {
        ...
        public InlineObject8(string storeId = default(string), PayExGwStoreOverride _override = default(PayExGwStoreOverride))
        {
            // to ensure "storeId" is required (not null)
            this.StoreId = storeId ?? throw new ArgumentNullException("storeId is a required property for InlineObject8 and cannot be null");
        ...
        public PayExGwStoreOverride Override { get; set; }
