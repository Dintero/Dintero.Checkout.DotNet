...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// TransactionVipps
    /// </summary>
    [DataContract(Name = "TransactionVipps")]
    [JsonConverter(typeof(JsonSubtypes), "PaymentProduct")]
    public partial class TransactionVipps : Transaction, IEquatable<TransactionVipps>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionVipps" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionVipps() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionVipps" /> class.
        /// </summary>
        ...
        /// <param name="paymentProduct">The payment product corresponding to this transaction  (required) (default to &quot;TransactionVipps&quot;).</param>
        ...
        public TransactionVipps(string id = default(string), DateTime createdAt = default(DateTime), PaymentProductTypeEnum paymentProductType = default(PaymentProductTypeEnum), List<TransactionVippsAllOfEvents> events = default(List<TransactionVippsAllOfEvents>), TransactionVippsAllOfMetadata1 metadata = default(TransactionVippsAllOfMetadata1), string paymentProduct = "TransactionVipps", int amount = default(int), string currency = default(string), string merchantReference = default(string), string merchantReference2 = default(string), string dynamicDescriptor = default(string), SettlementStatus? settlementStatus = default(SettlementStatus?), TransactionCustomer customer = default(TransactionCustomer), string customerIp = default(string), string userAgent = default(string), OrderAddress shippingAddress = default(OrderAddress), ShippingOption shippingOption = default(ShippingOption), OrderAddress billingAddress = default(OrderAddress), Store store = default(Store), List<OrderItem> items = default(List<OrderItem>), TransactionUrl url = default(TransactionUrl), string sessionId = default(string), Session session = default(Session), DateTime updatedAt = default(DateTime)) : base(paymentProduct, amount, currency, merchantReference, merchantReference2, dynamicDescriptor, settlementStatus, customer, customerIp, userAgent, shippingAddress, shippingOption, billingAddress, store, items, url, sessionId, session, updatedAt)
        {
        ...
        public List<TransactionVippsAllOfEvents> Events { get; set; }

        /// <summary>
        /// Gets or Sets Metadata
        /// </summary>
        [DataMember(Name = "metadata", EmitDefaultValue = false)]
        public TransactionVippsAllOfMetadata1 Metadata { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionVipps {\n");
        ...
        {
            return this.Equals(input as TransactionVipps);
        }

        /// <summary>
        /// Returns true if TransactionVipps instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionVipps to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionVipps input)
        {
            if (input == null)
                return false;
