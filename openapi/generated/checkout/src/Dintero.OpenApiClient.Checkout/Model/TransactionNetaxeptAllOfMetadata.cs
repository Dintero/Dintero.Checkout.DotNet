...
{
    /// <summary>
    /// TransactionNetaxeptAllOfMetadata
    /// </summary>
    [DataContract(Name = "TransactionNetaxept_allOf_metadata")]
    public partial class TransactionNetaxeptAllOfMetadata : IEquatable<TransactionNetaxeptAllOfMetadata>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionNetaxeptAllOfMetadata" /> class.
        /// </summary>
        /// <param name="netaxepttransactionId">netaxepttransactionId.</param>
        /// <param name="netaxeptoperation">netaxeptoperation.</param>
        /// <param name="netaxeptexecutionTime">netaxeptexecutionTime.</param>
        /// <param name="netaxeptbatNumber">netaxeptbatNumber.</param>
        /// <param name="netaxeptresponseCode">netaxeptresponseCode.</param>
        /// <param name="netaxeptterminalUrl">netaxeptterminalUrl.</param>
        public TransactionNetaxeptAllOfMetadata(string netaxepttransactionId = default(string), string netaxeptoperation = default(string), string netaxeptexecutionTime = default(string), string netaxeptbatNumber = default(string), string netaxeptresponseCode = default(string), string netaxeptterminalUrl = default(string))
        {
            this.NetaxepttransactionId = netaxepttransactionId;
            this.Netaxeptoperation = netaxeptoperation;
            this.NetaxeptexecutionTime = netaxeptexecutionTime;
            this.NetaxeptbatNumber = netaxeptbatNumber;
            this.NetaxeptresponseCode = netaxeptresponseCode;
            this.NetaxeptterminalUrl = netaxeptterminalUrl;
        }

        /// <summary>
        /// Gets or Sets NetaxepttransactionId
        /// </summary>
        [DataMember(Name = "netaxept:transaction_id", EmitDefaultValue = false)]
        public string NetaxepttransactionId { get; set; }

        /// <summary>
        /// Gets or Sets Netaxeptoperation
        /// </summary>
        [DataMember(Name = "netaxept:operation", EmitDefaultValue = false)]
        public string Netaxeptoperation { get; set; }

        /// <summary>
        /// Gets or Sets NetaxeptexecutionTime
        /// </summary>
        [DataMember(Name = "netaxept:execution_time", EmitDefaultValue = false)]
        public string NetaxeptexecutionTime { get; set; }

        /// <summary>
        /// Gets or Sets NetaxeptbatNumber
        /// </summary>
        [DataMember(Name = "netaxept:bat_number", EmitDefaultValue = false)]
        public string NetaxeptbatNumber { get; set; }

        /// <summary>
        /// Gets or Sets NetaxeptresponseCode
        /// </summary>
        [DataMember(Name = "netaxept:response_code", EmitDefaultValue = false)]
        public string NetaxeptresponseCode { get; set; }

        /// <summary>
        /// Gets or Sets NetaxeptterminalUrl
        /// </summary>
        [DataMember(Name = "netaxept:terminal_url", EmitDefaultValue = false)]
        public string NetaxeptterminalUrl { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionNetaxeptAllOfMetadata {\n");
            sb.Append("  NetaxepttransactionId: ").Append(NetaxepttransactionId).Append("\n");
            sb.Append("  Netaxeptoperation: ").Append(Netaxeptoperation).Append("\n");
            sb.Append("  NetaxeptexecutionTime: ").Append(NetaxeptexecutionTime).Append("\n");
            sb.Append("  NetaxeptbatNumber: ").Append(NetaxeptbatNumber).Append("\n");
            sb.Append("  NetaxeptresponseCode: ").Append(NetaxeptresponseCode).Append("\n");
            sb.Append("  NetaxeptterminalUrl: ").Append(NetaxeptterminalUrl).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TransactionNetaxeptAllOfMetadata);
        }

        /// <summary>
        /// Returns true if TransactionNetaxeptAllOfMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionNetaxeptAllOfMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionNetaxeptAllOfMetadata input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.NetaxepttransactionId == input.NetaxepttransactionId ||
                    (this.NetaxepttransactionId != null &&
                    this.NetaxepttransactionId.Equals(input.NetaxepttransactionId))
                ) && 
                (
                    this.Netaxeptoperation == input.Netaxeptoperation ||
                    (this.Netaxeptoperation != null &&
                    this.Netaxeptoperation.Equals(input.Netaxeptoperation))
                ) && 
                (
                    this.NetaxeptexecutionTime == input.NetaxeptexecutionTime ||
                    (this.NetaxeptexecutionTime != null &&
                    this.NetaxeptexecutionTime.Equals(input.NetaxeptexecutionTime))
                ) && 
                (
                    this.NetaxeptbatNumber == input.NetaxeptbatNumber ||
                    (this.NetaxeptbatNumber != null &&
                    this.NetaxeptbatNumber.Equals(input.NetaxeptbatNumber))
                ) && 
                (
                    this.NetaxeptresponseCode == input.NetaxeptresponseCode ||
                    (this.NetaxeptresponseCode != null &&
                    this.NetaxeptresponseCode.Equals(input.NetaxeptresponseCode))
                ) && 
                (
                    this.NetaxeptterminalUrl == input.NetaxeptterminalUrl ||
                    (this.NetaxeptterminalUrl != null &&
                    this.NetaxeptterminalUrl.Equals(input.NetaxeptterminalUrl))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.NetaxepttransactionId != null)
                    hashCode = hashCode * 59 + this.NetaxepttransactionId.GetHashCode();
                if (this.Netaxeptoperation != null)
                    hashCode = hashCode * 59 + this.Netaxeptoperation.GetHashCode();
                if (this.NetaxeptexecutionTime != null)
                    hashCode = hashCode * 59 + this.NetaxeptexecutionTime.GetHashCode();
                if (this.NetaxeptbatNumber != null)
                    hashCode = hashCode * 59 + this.NetaxeptbatNumber.GetHashCode();
                if (this.NetaxeptresponseCode != null)
                    hashCode = hashCode * 59 + this.NetaxeptresponseCode.GetHashCode();
                if (this.NetaxeptterminalUrl != null)
                    hashCode = hashCode * 59 + this.NetaxeptterminalUrl.GetHashCode();
                return hashCode;
            }
        }
