...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// SessionOptions
    /// </summary>
    [DataContract(Name = "SessionOptions")]
    public partial class SessionOptions : IEquatable<SessionOptions>, IValidatableObject
    {
        /// <summary>
        ...
        public SessionOptions(SessionUrls url = default(SessionUrls), SessionCustomer customer = default(SessionCustomer), SessionOrder order = default(SessionOrder), DateTime expiresAt = default(DateTime), SessionExpressExpress express = default(SessionExpressExpress), PaymentConfiguration configuration = default(PaymentConfiguration))
        {
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url is a required property for SessionOptions and cannot be null");
            // to ensure "order" is required (not null)
            this.Order = order ?? throw new ArgumentNullException("order is a required property for SessionOptions and cannot be null");
            // to ensure "configuration" is required (not null)
            this.Configuration = configuration ?? throw new ArgumentNullException("configuration is a required property for SessionOptions and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SessionOptions {\n");
        ...
        {
            return this.Equals(input as SessionOptions);
        }

        /// <summary>
        /// Returns true if SessionOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of SessionOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SessionOptions input)
        {
            if (input == null)
                return false;
