...
{
    /// <summary>
    /// SessionMetaDetailsBambora
    /// </summary>
    [DataContract(Name = "SessionMeta_details_bambora")]
    public partial class SessionMetaDetailsBambora : IEquatable<SessionMetaDetailsBambora>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionMetaDetailsBambora" /> class.
        /// </summary>
        /// <param name="sessionToken">sessionToken.</param>
        /// <param name="sessionUrl">sessionUrl.</param>
        /// <param name="walletSessionId">walletSessionId.</param>
        public SessionMetaDetailsBambora(string sessionToken = default(string), string sessionUrl = default(string), string walletSessionId = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets WalletSessionId
        /// </summary>
        [DataMember(Name = "wallet_session_id", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SessionMetaDetailsBambora {\n");
            sb.Append("  SessionToken: ").Append(SessionToken).Append("\n");
            sb.Append("  SessionUrl: ").Append(SessionUrl).Append("\n");
            sb.Append("  WalletSessionId: ").Append(WalletSessionId).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as SessionMetaDetailsBambora);
        }

        /// <summary>
        /// Returns true if SessionMetaDetailsBambora instances are equal
        /// </summary>
        /// <param name="input">Instance of SessionMetaDetailsBambora to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SessionMetaDetailsBambora input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.WalletSessionId == input.WalletSessionId ||
                    (this.WalletSessionId != null &&
                    this.WalletSessionId.Equals(input.WalletSessionId))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.WalletSessionId != null)
                    hashCode = hashCode * 59 + this.WalletSessionId.GetHashCode();
                return hashCode;
            }
        }
