...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MyDinteroUserCreation")]
    public partial class MyDinteroUserCreation : IEquatable<MyDinteroUserCreation>, IValidatableObject
    {
        /// <summary>
        /// Defines Actions
        /// </summary>
        ...
        {
            /// <summary>
            /// Enum CreateUser for value: create_user
            /// </summary>
            [EnumMember(Value = "create_user")]
            CreateUser = 1
        ...
        /// </summary>
        /// <value>Actions to perform on the customer </value>
        [DataMember(Name = "actions", IsRequired = true, EmitDefaultValue = false)]
        public List<ActionsEnum> Actions { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="MyDinteroUserCreation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MyDinteroUserCreation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MyDinteroUserCreation" /> class.
        /// </summary>
        /// <param name="actions">Actions to perform on the customer  (required).</param>
        /// <param name="terms">terms (required).</param>
        public MyDinteroUserCreation(List<ActionsEnum> actions = default(List<ActionsEnum>), MyDinteroUserCreationTerms terms = default(MyDinteroUserCreationTerms))
        {
            // to ensure "actions" is required (not null)
            this.Actions = actions ?? throw new ArgumentNullException("actions is a required property for MyDinteroUserCreation and cannot be null");
            // to ensure "terms" is required (not null)
            this.Terms = terms ?? throw new ArgumentNullException("terms is a required property for MyDinteroUserCreation and cannot be null");
        }
        ...
        public MyDinteroUserCreationTerms Terms { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MyDinteroUserCreation {\n");
        ...
        {
            return this.Equals(input as MyDinteroUserCreation);
        }

        /// <summary>
        /// Returns true if MyDinteroUserCreation instances are equal
        /// </summary>
        /// <param name="input">Instance of MyDinteroUserCreation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MyDinteroUserCreation input)
        {
            if (input == null)
                return false;
