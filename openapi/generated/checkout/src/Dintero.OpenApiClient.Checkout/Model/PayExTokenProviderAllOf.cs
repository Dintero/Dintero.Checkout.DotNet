...
{
    /// <summary>
    /// PayExTokenProviderAllOf
    /// </summary>
    [DataContract(Name = "PayExTokenProvider_allOf")]
    public partial class PayExTokenProviderAllOf : IEquatable<PayExTokenProviderAllOf>, IValidatableObject
    {
        /// <summary>
        /// Defines TokenTypes
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExTokenProviderAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayExTokenProviderAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExTokenProviderAllOf" /> class.
        /// </summary>
        /// <param name="tokenTypes">tokenTypes (required).</param>
        public PayExTokenProviderAllOf(List<TokenTypesEnum> tokenTypes = default(List<TokenTypesEnum>))
        {
            // to ensure "tokenTypes" is required (not null)
            this.TokenTypes = tokenTypes ?? throw new ArgumentNullException("tokenTypes is a required property for PayExTokenProviderAllOf and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PayExTokenProviderAllOf {\n");
        ...
        {
            return this.Equals(input as PayExTokenProviderAllOf);
        }

        /// <summary>
        /// Returns true if PayExTokenProviderAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PayExTokenProviderAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayExTokenProviderAllOf input)
        {
            if (input == null)
                return false;
