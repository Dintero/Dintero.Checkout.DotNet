...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class InlineResponse20013 : IEquatable<InlineResponse20013>, IValidatableObject
    {
        ...
        public InlineResponse20013(Id id = default(Id), SessionOperations sessionOperations = default(SessionOperations), SessionOptions sessionOptions = default(SessionOptions), SessionRead sessionRead = default(SessionRead))
        {
            this.Id = id;
