...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// invoice payment
    /// </summary>
    [DataContract(Name = "InstabankConfiguration_invoice")]
    public partial class InstabankConfigurationInvoice : IEquatable<InstabankConfigurationInvoice>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankConfigurationInvoice" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstabankConfigurationInvoice() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankConfigurationInvoice" /> class.
        /// </summary>
        /// <param name="enabled">enable invoice payment (only for amounts greater than 500 NOK) (required).</param>
        /// <param name="payability">payability.</param>
        /// <param name="product">product.</param>
        public InstabankConfigurationInvoice(bool enabled = default(bool), SessionPayability? payability = default(SessionPayability?), Object product = default(Object))
        {
        ...
        /// </summary>
        /// <value>enable invoice payment (only for amounts greater than 500 NOK)</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstabankConfigurationInvoice {\n");
        ...
        {
            return this.Equals(input as InstabankConfigurationInvoice);
        }

        /// <summary>
        /// Returns true if InstabankConfigurationInvoice instances are equal
        /// </summary>
        /// <param name="input">Instance of InstabankConfigurationInvoice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstabankConfigurationInvoice input)
        {
            if (input == null)
                return false;
