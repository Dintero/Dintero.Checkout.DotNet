...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// BamboraVippsPayment
    /// </summary>
    [DataContract(Name = "BamboraVippsPayment")]
    [JsonConverter(typeof(JsonSubtypes), "PaymentProductType")]
    public partial class BamboraVippsPayment : Payment, IEquatable<BamboraVippsPayment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraVippsPayment" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BamboraVippsPayment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraVippsPayment" /> class.
        /// </summary>
        ...
        /// <param name="paymentProductType">The payment product type corresponding to this transaction  (required) (default to &quot;BamboraVippsPayment&quot;).</param>
        public BamboraVippsPayment(string phoneNumber = default(string), bool rememberMe = default(bool), string paymentProductType = "BamboraVippsPayment") : base(paymentProductType)
        {
            // to ensure "phoneNumber" is required (not null)
            this.PhoneNumber = phoneNumber ?? throw new ArgumentNullException("phoneNumber is a required property for BamboraVippsPayment and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BamboraVippsPayment {\n");
        ...
        {
            return this.Equals(input as BamboraVippsPayment);
        }

        /// <summary>
        /// Returns true if BamboraVippsPayment instances are equal
        /// </summary>
        /// <param name="input">Instance of BamboraVippsPayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BamboraVippsPayment input)
        {
            if (input == null)
                return false;
