...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InstabankConfiguration")]
    public partial class InstabankConfiguration : IEquatable<InstabankConfiguration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankConfiguration" /> class.
        /// </summary>
        /// <param name="finance">finance.</param>
        /// <param name="invoice">invoice.</param>
        /// <param name="installment">installment.</param>
        /// <param name="postponement">postponement.</param>
        public InstabankConfiguration(InstabankConfigurationFinance finance = default(InstabankConfigurationFinance), InstabankConfigurationInvoice invoice = default(InstabankConfigurationInvoice), InstabankConfigurationInstallment installment = default(InstabankConfigurationInstallment), InstabankConfigurationPostponement postponement = default(InstabankConfigurationPostponement))
        {
        ...
        public InstabankConfigurationFinance Finance { get; set; }

        /// <summary>
        /// Gets or Sets Invoice
        /// </summary>
        [DataMember(Name = "invoice", EmitDefaultValue = false)]
        public InstabankConfigurationInvoice Invoice { get; set; }

        /// <summary>
        /// Gets or Sets Installment
        /// </summary>
        [DataMember(Name = "installment", EmitDefaultValue = false)]
        public InstabankConfigurationInstallment Installment { get; set; }

        /// <summary>
        /// Gets or Sets Postponement
        /// </summary>
        [DataMember(Name = "postponement", EmitDefaultValue = false)]
        public InstabankConfigurationPostponement Postponement { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstabankConfiguration {\n");
        ...
        {
            return this.Equals(input as InstabankConfiguration);
        }

        /// <summary>
        /// Returns true if InstabankConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of InstabankConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstabankConfiguration input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.Postponement == input.Postponement ||
                    (this.Postponement != null &&
                    this.Postponement.Equals(input.Postponement))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Postponement != null)
                    hashCode = hashCode * 59 + this.Postponement.GetHashCode();
                return hashCode;
            }
        }
