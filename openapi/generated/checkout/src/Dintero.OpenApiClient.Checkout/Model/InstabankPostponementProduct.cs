...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InstabankPostponementProduct")]
    public partial class InstabankPostponementProduct : IEquatable<InstabankPostponementProduct>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankPostponementProduct" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstabankPostponementProduct() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankPostponementProduct" /> class.
        /// </summary>
        ...
        /// <param name="postponementMonths">Number of months  (required).</param>
        /// <param name="originationFee">The startup fee for the payment product  (required).</param>
        /// <param name="notificationFee">The notification fee for the payment product .</param>
        ...
        public InstabankPostponementProduct(int minimumAmount = default(int), string productCode = default(string), int postponementMonths = default(int), int originationFee = default(int), int notificationFee = default(int), string annualInterestRate = default(string), int requireApplicantAmount = default(int), InstabankFinanceProductLoanExample loanExample = default(InstabankFinanceProductLoanExample), string brandingImageUrl = default(string))
        {
            // to ensure "productCode" is required (not null)
            this.ProductCode = productCode ?? throw new ArgumentNullException("productCode is a required property for InstabankPostponementProduct and cannot be null");
            this.PostponementMonths = postponementMonths;
            this.OriginationFee = originationFee;
            // to ensure "annualInterestRate" is required (not null)
            this.AnnualInterestRate = annualInterestRate ?? throw new ArgumentNullException("annualInterestRate is a required property for InstabankPostponementProduct and cannot be null");
        ...
        [DataMember(Name = "postponement_months", IsRequired = true, EmitDefaultValue = false)]
        public int PostponementMonths { get; set; }
        ...
        [DataMember(Name = "notification_fee", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstabankPostponementProduct {\n");
            sb.Append("  MinimumAmount: ").Append(MinimumAmount).Append("\n");
            sb.Append("  ProductCode: ").Append(ProductCode).Append("\n");
            sb.Append("  PostponementMonths: ").Append(PostponementMonths).Append("\n");
        ...
        {
            return this.Equals(input as InstabankPostponementProduct);
        }

        /// <summary>
        /// Returns true if InstabankPostponementProduct instances are equal
        /// </summary>
        /// <param name="input">Instance of InstabankPostponementProduct to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstabankPostponementProduct input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PostponementMonths == input.PostponementMonths ||
                    this.PostponementMonths.Equals(input.PostponementMonths)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.PostponementMonths.GetHashCode();
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // PostponementMonths (int) minimum
            if(this.PostponementMonths < (int)1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PostponementMonths, must be a value greater than or equal to 1.", new [] { "PostponementMonths" });
            }
