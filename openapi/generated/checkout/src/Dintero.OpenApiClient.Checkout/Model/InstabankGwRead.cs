...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InstabankGwRead")]
    public partial class InstabankGwRead : IEquatable<InstabankGwRead>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankGwRead" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstabankGwRead() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankGwRead" /> class.
        /// </summary>
        ...
        public InstabankGwRead(string organizationNumber = default(string), InstabankGwReadPaymentProductCodes paymentProductCodes = default(InstabankGwReadPaymentProductCodes))
        {
            // to ensure "organizationNumber" is required (not null)
            this.OrganizationNumber = organizationNumber ?? throw new ArgumentNullException("organizationNumber is a required property for InstabankGwRead and cannot be null");
            // to ensure "paymentProductCodes" is required (not null)
            this.PaymentProductCodes = paymentProductCodes ?? throw new ArgumentNullException("paymentProductCodes is a required property for InstabankGwRead and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstabankGwRead {\n");
        ...
        {
            return this.Equals(input as InstabankGwRead);
        }

        /// <summary>
        /// Returns true if InstabankGwRead instances are equal
        /// </summary>
        /// <param name="input">Instance of InstabankGwRead to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstabankGwRead input)
        {
            if (input == null)
                return false;
