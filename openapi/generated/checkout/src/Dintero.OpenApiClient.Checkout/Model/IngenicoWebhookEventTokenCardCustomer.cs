...
{
    /// <summary>
    /// IngenicoWebhookEventTokenCardCustomer
    /// </summary>
    [DataContract(Name = "IngenicoWebhookEvent_token_card_customer")]
    public partial class IngenicoWebhookEventTokenCardCustomer : IEquatable<IngenicoWebhookEventTokenCardCustomer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoWebhookEventTokenCardCustomer" /> class.
        /// </summary>
        ...
        public IngenicoWebhookEventTokenCardCustomer(IngenicoWebhookEventTokenCardCustomerBillingAddress billingAddress = default(IngenicoWebhookEventTokenCardCustomerBillingAddress), IngenicoWebhookEventTokenCardCustomerCompanyInformation companyInformation = default(IngenicoWebhookEventTokenCardCustomerCompanyInformation), string merchantCustomerId = default(string), IngenicoWebhookEventTokenCardCustomerData data = default(IngenicoWebhookEventTokenCardCustomerData))
        {
        ...
        public IngenicoWebhookEventTokenCardCustomerBillingAddress BillingAddress { get; set; }

        /// <summary>
        /// Gets or Sets CompanyInformation
        /// </summary>
        [DataMember(Name = "companyInformation", EmitDefaultValue = false)]
        public IngenicoWebhookEventTokenCardCustomerCompanyInformation CompanyInformation { get; set; }
        ...
        public IngenicoWebhookEventTokenCardCustomerData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IngenicoWebhookEventTokenCardCustomer {\n");
        ...
        {
            return this.Equals(input as IngenicoWebhookEventTokenCardCustomer);
        }

        /// <summary>
        /// Returns true if IngenicoWebhookEventTokenCardCustomer instances are equal
        /// </summary>
        /// <param name="input">Instance of IngenicoWebhookEventTokenCardCustomer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IngenicoWebhookEventTokenCardCustomer input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.MerchantCustomerId == input.MerchantCustomerId ||
                    (this.MerchantCustomerId != null &&
                    this.MerchantCustomerId.Equals(input.MerchantCustomerId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MerchantCustomerId != null)
                    hashCode = hashCode * 59 + this.MerchantCustomerId.GetHashCode();
                if (this.Data != null)
