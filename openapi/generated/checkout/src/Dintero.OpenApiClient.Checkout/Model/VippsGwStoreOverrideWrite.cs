...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VippsGwStoreOverrideWrite")]
    public partial class VippsGwStoreOverrideWrite : IEquatable<VippsGwStoreOverrideWrite>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VippsGwStoreOverrideWrite" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VippsGwStoreOverrideWrite() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VippsGwStoreOverrideWrite" /> class.
        /// </summary>
        /// <param name="clientId">clientId (required).</param>
        /// <param name="merchantSerialNumber">merchantSerialNumber (required).</param>
        /// <param name="ocpApimSubscriptionKeyAccessToken">ocpApimSubscriptionKeyAccessToken (required).</param>
        /// <param name="ocpApimSubscriptionKeyEcom">ocpApimSubscriptionKeyEcom (required).</param>
        /// <param name="clientSecret">clientSecret (required).</param>
        public VippsGwStoreOverrideWrite(string clientId = default(string), string merchantSerialNumber = default(string), string ocpApimSubscriptionKeyAccessToken = default(string), string ocpApimSubscriptionKeyEcom = default(string), string clientSecret = default(string))
        {
            // to ensure "clientId" is required (not null)
            this.ClientId = clientId ?? throw new ArgumentNullException("clientId is a required property for VippsGwStoreOverrideWrite and cannot be null");
            // to ensure "merchantSerialNumber" is required (not null)
            this.MerchantSerialNumber = merchantSerialNumber ?? throw new ArgumentNullException("merchantSerialNumber is a required property for VippsGwStoreOverrideWrite and cannot be null");
            // to ensure "ocpApimSubscriptionKeyAccessToken" is required (not null)
            this.OcpApimSubscriptionKeyAccessToken = ocpApimSubscriptionKeyAccessToken ?? throw new ArgumentNullException("ocpApimSubscriptionKeyAccessToken is a required property for VippsGwStoreOverrideWrite and cannot be null");
            // to ensure "ocpApimSubscriptionKeyEcom" is required (not null)
            this.OcpApimSubscriptionKeyEcom = ocpApimSubscriptionKeyEcom ?? throw new ArgumentNullException("ocpApimSubscriptionKeyEcom is a required property for VippsGwStoreOverrideWrite and cannot be null");
            // to ensure "clientSecret" is required (not null)
            this.ClientSecret = clientSecret ?? throw new ArgumentNullException("clientSecret is a required property for VippsGwStoreOverrideWrite and cannot be null");
        }
        ...
        /// <summary>
        /// Gets or Sets MerchantSerialNumber
        /// </summary>
        [DataMember(Name = "merchant_serial_number", IsRequired = true, EmitDefaultValue = false)]
        public string MerchantSerialNumber { get; set; }

        /// <summary>
        /// Gets or Sets OcpApimSubscriptionKeyAccessToken
        /// </summary>
        [DataMember(Name = "ocp_apim_subscription_key_access_token", IsRequired = true, EmitDefaultValue = false)]
        public string OcpApimSubscriptionKeyAccessToken { get; set; }

        /// <summary>
        /// Gets or Sets OcpApimSubscriptionKeyEcom
        /// </summary>
        [DataMember(Name = "ocp_apim_subscription_key_ecom", IsRequired = true, EmitDefaultValue = false)]
        public string OcpApimSubscriptionKeyEcom { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VippsGwStoreOverrideWrite {\n");
            sb.Append("  ClientId: ").Append(ClientId).Append("\n");
            sb.Append("  MerchantSerialNumber: ").Append(MerchantSerialNumber).Append("\n");
            sb.Append("  OcpApimSubscriptionKeyAccessToken: ").Append(OcpApimSubscriptionKeyAccessToken).Append("\n");
            sb.Append("  OcpApimSubscriptionKeyEcom: ").Append(OcpApimSubscriptionKeyEcom).Append("\n");
        ...
        {
            return this.Equals(input as VippsGwStoreOverrideWrite);
        }

        /// <summary>
        /// Returns true if VippsGwStoreOverrideWrite instances are equal
        /// </summary>
        /// <param name="input">Instance of VippsGwStoreOverrideWrite to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VippsGwStoreOverrideWrite input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.MerchantSerialNumber == input.MerchantSerialNumber ||
                    (this.MerchantSerialNumber != null &&
                    this.MerchantSerialNumber.Equals(input.MerchantSerialNumber))
                ) && 
                (
                    this.OcpApimSubscriptionKeyAccessToken == input.OcpApimSubscriptionKeyAccessToken ||
                    (this.OcpApimSubscriptionKeyAccessToken != null &&
                    this.OcpApimSubscriptionKeyAccessToken.Equals(input.OcpApimSubscriptionKeyAccessToken))
                ) && 
                (
                    this.OcpApimSubscriptionKeyEcom == input.OcpApimSubscriptionKeyEcom ||
                    (this.OcpApimSubscriptionKeyEcom != null &&
                    this.OcpApimSubscriptionKeyEcom.Equals(input.OcpApimSubscriptionKeyEcom))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MerchantSerialNumber != null)
                    hashCode = hashCode * 59 + this.MerchantSerialNumber.GetHashCode();
                if (this.OcpApimSubscriptionKeyAccessToken != null)
                    hashCode = hashCode * 59 + this.OcpApimSubscriptionKeyAccessToken.GetHashCode();
                if (this.OcpApimSubscriptionKeyEcom != null)
                    hashCode = hashCode * 59 + this.OcpApimSubscriptionKeyEcom.GetHashCode();
