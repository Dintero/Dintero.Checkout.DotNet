...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CollectorInstallmentPaymentOperation")]
    [JsonConverter(typeof(JsonSubtypes), "Rel")]
    public partial class CollectorInstallmentPaymentOperation : PaymentOperation, IEquatable<CollectorInstallmentPaymentOperation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorInstallmentPaymentOperation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorInstallmentPaymentOperation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorInstallmentPaymentOperation" /> class.
        /// </summary>
        ...
        /// <param name="rel">rel (required) (default to &quot;CollectorInstallmentPaymentOperation&quot;).</param>
        public CollectorInstallmentPaymentOperation(string href = default(string), CollectorProduct product = default(CollectorProduct), ContentTypeEnum? contentType = default(ContentTypeEnum?), MethodEnum? method = default(MethodEnum?), string rel = "CollectorInstallmentPaymentOperation") : base(contentType, method, rel)
        {
            // to ensure "product" is required (not null)
            this.Product = product ?? throw new ArgumentNullException("product is a required property for CollectorInstallmentPaymentOperation and cannot be null");
            this.Href = href;
        }
        ...
        public CollectorProduct Product { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorInstallmentPaymentOperation {\n");
        ...
        {
            return this.Equals(input as CollectorInstallmentPaymentOperation);
        }

        /// <summary>
        /// Returns true if CollectorInstallmentPaymentOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorInstallmentPaymentOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorInstallmentPaymentOperation input)
        {
            if (input == null)
                return false;
