...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class InlineObject17 : IEquatable<InlineObject17>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="session">The session to create the payment from .</param>
        /// <param name="payment">payment.</param>
        public InlineObject17(MitSessionOptions session = default(MitSessionOptions), MitPayment payment = default(MitPayment))
        {
        ...
        /// </summary>
        /// <value>The session to create the payment from </value>
        [DataMember(Name = "session", EmitDefaultValue = false)]
        public MitSessionOptions Session { get; set; }

        /// <summary>
        /// Gets or Sets Payment
        /// </summary>
        [DataMember(Name = "payment", EmitDefaultValue = false)]
        public MitPayment Payment { get; set; }
