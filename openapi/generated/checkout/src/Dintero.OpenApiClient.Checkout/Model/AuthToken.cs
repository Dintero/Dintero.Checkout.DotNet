...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(AccountUser), "account_user")]
    [JsonSubtypes.KnownSubType(typeof(AuthorizationCode), "authorization_code")]
    [JsonSubtypes.KnownSubType(typeof(ClientCredentials), "client_credentials")]
    [JsonSubtypes.KnownSubType(typeof(MfaOob), "mfa_oob")]
    [JsonSubtypes.KnownSubType(typeof(Password), "password")]
    [JsonSubtypes.KnownSubType(typeof(RefreshToken), "refresh_token")]
    public partial class AuthToken : IEquatable<AuthToken>, IValidatableObject
    {
        ...
        public AuthToken(string grantType = default(string))
        {
            // to ensure "grantType" is required (not null)
            this.GrantType = grantType ?? throw new ArgumentNullException("grantType is a required property for AuthToken and cannot be null");
        }
