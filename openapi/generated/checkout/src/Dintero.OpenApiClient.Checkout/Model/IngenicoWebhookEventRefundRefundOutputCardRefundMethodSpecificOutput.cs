...
{
    /// <summary>
    /// IngenicoWebhookEventRefundRefundOutputCardRefundMethodSpecificOutput
    /// </summary>
    [DataContract(Name = "IngenicoWebhookEvent_refund_refundOutput_cardRefundMethodSpecificOutput")]
    public partial class IngenicoWebhookEventRefundRefundOutputCardRefundMethodSpecificOutput : IEquatable<IngenicoWebhookEventRefundRefundOutputCardRefundMethodSpecificOutput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoWebhookEventRefundRefundOutputCardRefundMethodSpecificOutput" /> class.
        /// </summary>
        /// <param name="refundProductId">refundProductId.</param>
        /// <param name="totalAmountPaid">totalAmountPaid.</param>
        /// <param name="totalAmountRefunded">totalAmountRefunded.</param>
        public IngenicoWebhookEventRefundRefundOutputCardRefundMethodSpecificOutput(decimal refundProductId = default(decimal), decimal totalAmountPaid = default(decimal), decimal totalAmountRefunded = default(decimal))
        {
        ...
        /// <summary>
        /// Gets or Sets RefundProductId
        /// </summary>
        [DataMember(Name = "refundProductId", EmitDefaultValue = false)]
        public decimal RefundProductId { get; set; }

        /// <summary>
        /// Gets or Sets TotalAmountPaid
        /// </summary>
        [DataMember(Name = "totalAmountPaid", EmitDefaultValue = false)]
        public decimal TotalAmountPaid { get; set; }

        /// <summary>
        /// Gets or Sets TotalAmountRefunded
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IngenicoWebhookEventRefundRefundOutputCardRefundMethodSpecificOutput {\n");
            sb.Append("  RefundProductId: ").Append(RefundProductId).Append("\n");
        ...
        {
            return this.Equals(input as IngenicoWebhookEventRefundRefundOutputCardRefundMethodSpecificOutput);
        }

        /// <summary>
        /// Returns true if IngenicoWebhookEventRefundRefundOutputCardRefundMethodSpecificOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of IngenicoWebhookEventRefundRefundOutputCardRefundMethodSpecificOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IngenicoWebhookEventRefundRefundOutputCardRefundMethodSpecificOutput input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.RefundProductId == input.RefundProductId ||
                    this.RefundProductId.Equals(input.RefundProductId)
                ) && 
                (
                    this.TotalAmountPaid == input.TotalAmountPaid ||
                    this.TotalAmountPaid.Equals(input.TotalAmountPaid)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = hashCode * 59 + this.RefundProductId.GetHashCode();
                hashCode = hashCode * 59 + this.TotalAmountPaid.GetHashCode();
