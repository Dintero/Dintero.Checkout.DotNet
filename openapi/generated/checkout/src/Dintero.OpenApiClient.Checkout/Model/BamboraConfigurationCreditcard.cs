...
{
    /// <summary>
    /// BamboraConfigurationCreditcard
    /// </summary>
    [DataContract(Name = "BamboraConfiguration_creditcard")]
    public partial class BamboraConfigurationCreditcard : IEquatable<BamboraConfigurationCreditcard>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraConfigurationCreditcard" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BamboraConfigurationCreditcard() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraConfigurationCreditcard" /> class.
        /// </summary>
        ...
        public BamboraConfigurationCreditcard(TypeEnum? type = default(TypeEnum?), bool enabled = default(bool), SessionPayability? payability = default(SessionPayability?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BamboraConfigurationCreditcard {\n");
        ...
        {
            return this.Equals(input as BamboraConfigurationCreditcard);
        }

        /// <summary>
        /// Returns true if BamboraConfigurationCreditcard instances are equal
        /// </summary>
        /// <param name="input">Instance of BamboraConfigurationCreditcard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BamboraConfigurationCreditcard input)
        {
            if (input == null)
                return false;
