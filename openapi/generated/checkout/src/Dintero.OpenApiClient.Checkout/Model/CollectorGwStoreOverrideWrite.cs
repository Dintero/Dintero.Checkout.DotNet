...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CollectorGwStoreOverrideWrite")]
    public partial class CollectorGwStoreOverrideWrite : IEquatable<CollectorGwStoreOverrideWrite>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorGwStoreOverrideWrite" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorGwStoreOverrideWrite() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorGwStoreOverrideWrite" /> class.
        /// </summary>
        /// <param name="url">url (required).</param>
        /// <param name="username">Merchant&#39;s username at Collector Bank (required).</param>
        /// <param name="storeId">Default store_id for gateway (required).</param>
        /// <param name="country">Default country for gateway (required).</param>
        /// <param name="options">options.</param>
        /// <param name="stores">Configured stores in the Collector Partner Portal.</param>
        /// <param name="password">password (required).</param>
        public CollectorGwStoreOverrideWrite(string url = default(string), string username = default(string), decimal storeId = default(decimal), string country = default(string), CollectorGwStoreOverrideWriteAllOfOptions options = default(CollectorGwStoreOverrideWriteAllOfOptions), List<CollectorGwReadStores> stores = default(List<CollectorGwReadStores>), string password = default(string))
        {
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url is a required property for CollectorGwStoreOverrideWrite and cannot be null");
            // to ensure "username" is required (not null)
            this.Username = username ?? throw new ArgumentNullException("username is a required property for CollectorGwStoreOverrideWrite and cannot be null");
            this.StoreId = storeId;
            // to ensure "country" is required (not null)
            this.Country = country ?? throw new ArgumentNullException("country is a required property for CollectorGwStoreOverrideWrite and cannot be null");
            // to ensure "password" is required (not null)
            this.Password = password ?? throw new ArgumentNullException("password is a required property for CollectorGwStoreOverrideWrite and cannot be null");
        ...
        /// <summary>
        /// Merchant&#39;s username at Collector Bank
        /// </summary>
        /// <value>Merchant&#39;s username at Collector Bank</value>
        [DataMember(Name = "username", IsRequired = true, EmitDefaultValue = false)]
        public string Username { get; set; }

        /// <summary>
        /// Default store_id for gateway
        /// </summary>
        /// <value>Default store_id for gateway</value>
        [DataMember(Name = "store_id", IsRequired = true, EmitDefaultValue = false)]
        public decimal StoreId { get; set; }

        /// <summary>
        /// Default country for gateway
        /// </summary>
        /// <value>Default country for gateway</value>
        ...
        public CollectorGwStoreOverrideWriteAllOfOptions Options { get; set; }

        /// <summary>
        /// Configured stores in the Collector Partner Portal
        /// </summary>
        /// <value>Configured stores in the Collector Partner Portal</value>
        [DataMember(Name = "stores", EmitDefaultValue = false)]
        public List<CollectorGwReadStores> Stores { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorGwStoreOverrideWrite {\n");
        ...
        {
            return this.Equals(input as CollectorGwStoreOverrideWrite);
        }

        /// <summary>
        /// Returns true if CollectorGwStoreOverrideWrite instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorGwStoreOverrideWrite to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorGwStoreOverrideWrite input)
        {
            if (input == null)
                return false;
