...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class InlineResponse2008 : IEquatable<InlineResponse2008>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="id">The id of the checkout session.</param>
        /// <param name="url">URL for the Checkout session .</param>
        /// <param name="publish">Publish checkout message to the customer. .</param>
        /// <param name="session">session.</param>
        public InlineResponse2008(string id = default(string), string url = default(string), List<Object> publish = default(List<Object>), Id session = default(Id))
        {
            this.Id = id;
            this.Url = url;
        ...
        /// </summary>
        /// <value>The id of the checkout session</value>
        ...
        /// </summary>
        /// <value>URL for the Checkout session </value>
