...
{
    /// <summary>
    /// CollectorInstallmentB2BPreapprovedPaymentAllOf
    /// </summary>
    [DataContract(Name = "CollectorInstallmentB2BPreapprovedPayment_allOf")]
    public partial class CollectorInstallmentB2BPreapprovedPaymentAllOf : IEquatable<CollectorInstallmentB2BPreapprovedPaymentAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorInstallmentB2BPreapprovedPaymentAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorInstallmentB2BPreapprovedPaymentAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorInstallmentB2BPreapprovedPaymentAllOf" /> class.
        /// </summary>
        ...
        public CollectorInstallmentB2BPreapprovedPaymentAllOf(CollectorInstallmentB2BPreapprovedPaymentAllOfProduct product = default(CollectorInstallmentB2BPreapprovedPaymentAllOfProduct), CollectorB2BAddress shippingAddress = default(CollectorB2BAddress), string scc = default(string), string companyId = default(string), bool rememberMe = default(bool))
        {
            // to ensure "product" is required (not null)
            this.Product = product ?? throw new ArgumentNullException("product is a required property for CollectorInstallmentB2BPreapprovedPaymentAllOf and cannot be null");
            // to ensure "shippingAddress" is required (not null)
            this.ShippingAddress = shippingAddress ?? throw new ArgumentNullException("shippingAddress is a required property for CollectorInstallmentB2BPreapprovedPaymentAllOf and cannot be null");
            // to ensure "companyId" is required (not null)
            this.CompanyId = companyId ?? throw new ArgumentNullException("companyId is a required property for CollectorInstallmentB2BPreapprovedPaymentAllOf and cannot be null");
            this.Scc = scc;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorInstallmentB2BPreapprovedPaymentAllOf {\n");
        ...
        {
            return this.Equals(input as CollectorInstallmentB2BPreapprovedPaymentAllOf);
        }

        /// <summary>
        /// Returns true if CollectorInstallmentB2BPreapprovedPaymentAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorInstallmentB2BPreapprovedPaymentAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorInstallmentB2BPreapprovedPaymentAllOf input)
        {
            if (input == null)
                return false;
