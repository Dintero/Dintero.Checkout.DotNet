...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InstabankInvoiceProduct")]
    public partial class InstabankInvoiceProduct : IEquatable<InstabankInvoiceProduct>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankInvoiceProduct" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstabankInvoiceProduct() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankInvoiceProduct" /> class.
        /// </summary>
        /// <param name="productCode">productCode (required).</param>
        /// <param name="dueInDays">Number of days before the payment is due. (required).</param>
        ...
        /// <param name="invoiceFee">The fee for the payment product  (required).</param>
        /// <param name="requireApplicantAmount">The limit for when instabank will require a full applicant during payment.  (required).</param>
        /// <param name="brandingImageUrl">Url for a custom branding image.</param>
        public InstabankInvoiceProduct(string productCode = default(string), int dueInDays = default(int), int minimumAmount = default(int), int invoiceFee = default(int), int requireApplicantAmount = default(int), string brandingImageUrl = default(string))
        {
            // to ensure "productCode" is required (not null)
            this.ProductCode = productCode ?? throw new ArgumentNullException("productCode is a required property for InstabankInvoiceProduct and cannot be null");
        ...
        /// </summary>
        /// <value>Number of days before the payment is due.</value>
        [DataMember(Name = "due_in_days", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>The fee for the payment product </value>
        [DataMember(Name = "invoice_fee", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "require_applicant_amount", IsRequired = true, EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstabankInvoiceProduct {\n");
            sb.Append("  ProductCode: ").Append(ProductCode).Append("\n");
            sb.Append("  DueInDays: ").Append(DueInDays).Append("\n");
        ...
        {
            return this.Equals(input as InstabankInvoiceProduct);
        }

        /// <summary>
        /// Returns true if InstabankInvoiceProduct instances are equal
        /// </summary>
        /// <param name="input">Instance of InstabankInvoiceProduct to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstabankInvoiceProduct input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.DueInDays == input.DueInDays ||
                    this.DueInDays.Equals(input.DueInDays)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.DueInDays.GetHashCode();
        ...
        {
            // DueInDays (int) minimum
            if(this.DueInDays < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DueInDays, must be a value greater than or equal to 0.", new [] { "DueInDays" });
            }
            ...
            // InvoiceFee (int) minimum
            if(this.InvoiceFee < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for InvoiceFee, must be a value greater than or equal to 0.", new [] { "InvoiceFee" });
            }
