...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ShippingOption_time_slot")]
    public partial class ShippingOptionTimeSlot : IEquatable<ShippingOptionTimeSlot>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShippingOptionTimeSlot" /> class.
        /// </summary>
        /// <param name="startsAt">startsAt.</param>
        /// <param name="endsAt">endsAt.</param>
        public ShippingOptionTimeSlot(DateTime startsAt = default(DateTime), DateTime endsAt = default(DateTime))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShippingOptionTimeSlot {\n");
        ...
        {
            return this.Equals(input as ShippingOptionTimeSlot);
        }

        /// <summary>
        /// Returns true if ShippingOptionTimeSlot instances are equal
        /// </summary>
        /// <param name="input">Instance of ShippingOptionTimeSlot to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShippingOptionTimeSlot input)
        {
            if (input == null)
                return false;
