...
{
    /// <summary>
    /// TransactionPayExAllOfEvents
    /// </summary>
    [DataContract(Name = "TransactionPayEx_allOf_events")]
    public partial class TransactionPayExAllOfEvents : IEquatable<TransactionPayExAllOfEvents>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionPayExAllOfEvents" /> class.
        /// </summary>
        /// <param name="metadata">metadata.</param>
        public TransactionPayExAllOfEvents(TransactionPayExAllOfMetadata metadata = default(TransactionPayExAllOfMetadata))
        {
        ...
        public TransactionPayExAllOfMetadata Metadata { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionPayExAllOfEvents {\n");
        ...
        {
            return this.Equals(input as TransactionPayExAllOfEvents);
        }

        /// <summary>
        /// Returns true if TransactionPayExAllOfEvents instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionPayExAllOfEvents to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionPayExAllOfEvents input)
        {
            if (input == null)
                return false;
