...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PayExGwRead")]
    public partial class PayExGwRead : IEquatable<PayExGwRead>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExGwRead" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayExGwRead() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExGwRead" /> class.
        /// </summary>
        /// <param name="url">The base URIs of the eCommerce APIs:  - **test**: https://api.externalintegration.payex.com - **prod**: https://api.payex.com  (required).</param>
        /// <param name="payeeId">Unique id that identifies the payee for the account (like merchant) set by PayEx.  (required).</param>
        /// <param name="subsite">The subsite field can be used to perform split settlements on payments. The subsites must be resolved with PayEx reconciliation before being used. .</param>
        public PayExGwRead(string url = default(string), string payeeId = default(string), string subsite = default(string))
        {
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url is a required property for PayExGwRead and cannot be null");
            // to ensure "payeeId" is required (not null)
            this.PayeeId = payeeId ?? throw new ArgumentNullException("payeeId is a required property for PayExGwRead and cannot be null");
        ...
        /// <summary>
        /// The base URIs of the eCommerce APIs:  - **test**: https://api.externalintegration.payex.com - **prod**: https://api.payex.com 
        /// </summary>
        /// <value>The base URIs of the eCommerce APIs:  - **test**: https://api.externalintegration.payex.com - **prod**: https://api.payex.com </value>
        [DataMember(Name = "url", IsRequired = true, EmitDefaultValue = false)]
        public string Url { get; set; }

        /// <summary>
        /// Unique id that identifies the payee for the account (like merchant) set by PayEx. 
        /// </summary>
        /// <value>Unique id that identifies the payee for the account (like merchant) set by PayEx. </value>
        [DataMember(Name = "payee_id", IsRequired = true, EmitDefaultValue = false)]
        public string PayeeId { get; set; }

        /// <summary>
        /// The subsite field can be used to perform split settlements on payments. The subsites must be resolved with PayEx reconciliation before being used. 
        /// </summary>
        /// <value>The subsite field can be used to perform split settlements on payments. The subsites must be resolved with PayEx reconciliation before being used. </value>
        ...
        {
            return this.Equals(input as PayExGwRead);
        }

        /// <summary>
        /// Returns true if PayExGwRead instances are equal
        /// </summary>
        /// <param name="input">Instance of PayExGwRead to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayExGwRead input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.Subsite == input.Subsite ||
                    (this.Subsite != null &&
                    this.Subsite.Equals(input.Subsite))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Subsite != null)
                    hashCode = hashCode * 59 + this.Subsite.GetHashCode();
                return hashCode;
            }
        }
        ...
        {
            // Subsite (string) maxLength
            if(this.Subsite != null && this.Subsite.Length > 40)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Subsite, length must be less than 40.", new [] { "Subsite" });
            }
