...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransactionInstabank")]
    [JsonConverter(typeof(JsonSubtypes), "PaymentProduct")]
    public partial class TransactionInstabank : Transaction, IEquatable<TransactionInstabank>, IValidatableObject
    {
        /// <summary>
        ...
        {
            /// <summary>
            /// Enum Finance for value: instabank.finance
            /// </summary>
            [EnumMember(Value = "instabank.finance")]
            Finance = 1,

            /// <summary>
            /// Enum Invoice for value: instabank.invoice
            /// </summary>
            [EnumMember(Value = "instabank.invoice")]
            Invoice = 2,

            /// <summary>
            /// Enum Installment for value: instabank.installment
            /// </summary>
            [EnumMember(Value = "instabank.installment")]
            Installment = 3,

            /// <summary>
            /// Enum Postponement for value: instabank.postponement
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionInstabank" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionInstabank() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionInstabank" /> class.
        /// </summary>
        ...
        /// <param name="paymentProduct">The payment product corresponding to this transaction  (required) (default to &quot;TransactionInstabank&quot;).</param>
        ...
        public TransactionInstabank(string id = default(string), DateTime createdAt = default(DateTime), PaymentProductTypeEnum paymentProductType = default(PaymentProductTypeEnum), List<TransactionInstabankAllOfEvents> events = default(List<TransactionInstabankAllOfEvents>), TransactionInstabankAllOfMetadata1 metadata = default(TransactionInstabankAllOfMetadata1), string paymentProduct = "TransactionInstabank", int amount = default(int), string currency = default(string), string merchantReference = default(string), string merchantReference2 = default(string), string dynamicDescriptor = default(string), SettlementStatus? settlementStatus = default(SettlementStatus?), TransactionCustomer customer = default(TransactionCustomer), string customerIp = default(string), string userAgent = default(string), OrderAddress shippingAddress = default(OrderAddress), ShippingOption shippingOption = default(ShippingOption), OrderAddress billingAddress = default(OrderAddress), Store store = default(Store), List<OrderItem> items = default(List<OrderItem>), TransactionUrl url = default(TransactionUrl), string sessionId = default(string), Session session = default(Session), DateTime updatedAt = default(DateTime)) : base(paymentProduct, amount, currency, merchantReference, merchantReference2, dynamicDescriptor, settlementStatus, customer, customerIp, userAgent, shippingAddress, shippingOption, billingAddress, store, items, url, sessionId, session, updatedAt)
        {
        ...
        public List<TransactionInstabankAllOfEvents> Events { get; set; }

        /// <summary>
        /// Gets or Sets Metadata
        /// </summary>
        [DataMember(Name = "metadata", EmitDefaultValue = false)]
        public TransactionInstabankAllOfMetadata1 Metadata { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionInstabank {\n");
        ...
        {
            return this.Equals(input as TransactionInstabank);
        }

        /// <summary>
        /// Returns true if TransactionInstabank instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionInstabank to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionInstabank input)
        {
            if (input == null)
                return false;
