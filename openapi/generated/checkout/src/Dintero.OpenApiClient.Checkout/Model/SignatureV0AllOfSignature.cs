...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SignatureV0_allOf_signature")]
    public partial class SignatureV0AllOfSignature : IEquatable<SignatureV0AllOfSignature>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        {
            /// <summary>
            /// Enum V0HmacSha256 for value: v0-hmac-sha256
            /// </summary>
            [EnumMember(Value = "v0-hmac-sha256")]
            V0HmacSha256 = 1
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SignatureV0AllOfSignature" /> class.
        /// </summary>
        /// <param name="type">type.</param>
        /// <param name="secret">secret.</param>
        public SignatureV0AllOfSignature(TypeEnum? type = default(TypeEnum?), string secret = default(string))
        {
            this.Type = type;
            this.Secret = secret;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SignatureV0AllOfSignature {\n");
        ...
        {
            return this.Equals(input as SignatureV0AllOfSignature);
        }

        /// <summary>
        /// Returns true if SignatureV0AllOfSignature instances are equal
        /// </summary>
        /// <param name="input">Instance of SignatureV0AllOfSignature to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SignatureV0AllOfSignature input)
        {
            if (input == null)
                return false;
