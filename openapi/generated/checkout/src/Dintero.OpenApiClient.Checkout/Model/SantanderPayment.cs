...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// SantanderPayment
    /// </summary>
    [DataContract(Name = "SantanderPayment")]
    [JsonConverter(typeof(JsonSubtypes), "PaymentProductType")]
    public partial class SantanderPayment : Payment, IEquatable<SantanderPayment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SantanderPayment" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SantanderPayment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SantanderPayment" /> class.
        /// </summary>
        /// <param name="accountNumberToken">Token to represent the account number (required).</param>
        /// <param name="scc">Optional query parameter. SMS-confirm-code. To verify the identity of the payee..</param>
        /// <param name="paymentProductType">The payment product type corresponding to this transaction  (required) (default to &quot;SantanderPayment&quot;).</param>
        public SantanderPayment(decimal accountNumberToken = default(decimal), string scc = default(string), string paymentProductType = "SantanderPayment") : base()
        {
            this.AccountNumberToken = accountNumberToken;
            // to ensure "paymentProductType" is required (not null)
            this.PaymentProductType = paymentProductType ?? throw new ArgumentNullException("paymentProductType is a required property for SantanderPayment and cannot be null");
            this.Scc = scc;
        }
        ...
        /// </summary>
        /// <value>Token to represent the account number</value>
        [DataMember(Name = "account_number_token", IsRequired = true, EmitDefaultValue = false)]
        public decimal AccountNumberToken { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SantanderPayment {\n");
            sb.Append("  ").Append(base.ToString().Replace("\n", "\n  ")).Append("\n");
            sb.Append("  AccountNumberToken: ").Append(AccountNumberToken).Append("\n");
        ...
        {
            return this.Equals(input as SantanderPayment);
        }

        /// <summary>
        /// Returns true if SantanderPayment instances are equal
        /// </summary>
        /// <param name="input">Instance of SantanderPayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SantanderPayment input)
        {
            if (input == null)
                return false;
            ...
            return base.Equals(input) && 
                (
                    this.AccountNumberToken == input.AccountNumberToken ||
                    this.AccountNumberToken.Equals(input.AccountNumberToken)
                ) && base.Equals(input) && 
                (
                    this.Scc == input.Scc ||
                    (this.Scc != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.AccountNumberToken.GetHashCode();
                if (this.Scc != null)
