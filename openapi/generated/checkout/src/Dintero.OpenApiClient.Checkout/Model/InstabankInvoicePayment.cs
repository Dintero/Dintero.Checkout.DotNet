...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InstabankInvoicePayment")]
    [JsonConverter(typeof(JsonSubtypes), "PaymentProductType")]
    public partial class InstabankInvoicePayment : Payment, IEquatable<InstabankInvoicePayment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankInvoicePayment" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstabankInvoicePayment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankInvoicePayment" /> class.
        /// </summary>
        ...
        /// <param name="paymentProductType">The payment product type corresponding to this transaction  (required) (default to &quot;InstabankInvoicePayment&quot;).</param>
        ...
        public InstabankInvoicePayment(string email = default(string), string socialSecurityNumber = default(string), string phoneNumber = default(string), int totalIncome = default(int), string paymentProductType = "InstabankInvoicePayment", InstabankApplication applicant = default(InstabankApplication), bool rememberMe = default(bool)) : base()
        {
            // to ensure "email" is required (not null)
            this.Email = email ?? throw new ArgumentNullException("email is a required property for InstabankInvoicePayment and cannot be null");
            // to ensure "socialSecurityNumber" is required (not null)
            this.SocialSecurityNumber = socialSecurityNumber ?? throw new ArgumentNullException("socialSecurityNumber is a required property for InstabankInvoicePayment and cannot be null");
            // to ensure "phoneNumber" is required (not null)
            this.PhoneNumber = phoneNumber ?? throw new ArgumentNullException("phoneNumber is a required property for InstabankInvoicePayment and cannot be null");
            this.TotalIncome = totalIncome;
            // to ensure "paymentProductType" is required (not null)
            this.PaymentProductType = paymentProductType ?? throw new ArgumentNullException("paymentProductType is a required property for InstabankInvoicePayment and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstabankInvoicePayment {\n");
        ...
        {
            return this.Equals(input as InstabankInvoicePayment);
        }

        /// <summary>
        /// Returns true if InstabankInvoicePayment instances are equal
        /// </summary>
        /// <param name="input">Instance of InstabankInvoicePayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstabankInvoicePayment input)
        {
            if (input == null)
                return false;
