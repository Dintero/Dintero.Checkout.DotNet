...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// SessionMeta
    /// </summary>
    [DataContract(Name = "SessionMeta")]
    public partial class SessionMeta : IEquatable<SessionMeta>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionMeta" /> class.
        /// </summary>
        ...
        public SessionMeta(string id = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), DateTime expiresAt = default(DateTime), string customerIp = default(string), string userAgent = default(string), List<SessionMetaEvents> events = default(List<SessionMetaEvents>), string transactionId = default(string))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as SessionMeta);
        }

        /// <summary>
        /// Returns true if SessionMeta instances are equal
        /// </summary>
        /// <param name="input">Instance of SessionMeta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SessionMeta input)
        {
            if (input == null)
                return false;
