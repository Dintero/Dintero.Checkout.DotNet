...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// PaymentOperation
    /// </summary>
    [DataContract(Name = "PaymentOperation")]
    [JsonConverter(typeof(JsonSubtypes), "Rel")]
    [JsonSubtypes.KnownSubType(typeof(BamboraPaymentOperation), "BamboraPaymentOperation")]
    [JsonSubtypes.KnownSubType(typeof(CollectorInstallmentPaymentOperation), "CollectorInstallmentPaymentOperation")]
    [JsonSubtypes.KnownSubType(typeof(IngenicoCreditCardPaymentOperation), "IngenicoCreditCardPaymentOperation")]
    [JsonSubtypes.KnownSubType(typeof(SendSCCPaymentOperation), "SendSCCPaymentOperation")]
    [JsonSubtypes.KnownSubType(typeof(ViewPaymentOperation), "ViewPaymentOperation")]
    [JsonSubtypes.KnownSubType(typeof(BamboraPaymentOperation), "pay-bambora-creditcard")]
    [JsonSubtypes.KnownSubType(typeof(CollectorInstallmentPaymentOperation), "pay-collector-installment")]
    [JsonSubtypes.KnownSubType(typeof(IngenicoCreditCardPaymentOperation), "pay-ingenico-creditcard")]
    [JsonSubtypes.KnownSubType(typeof(SendSCCPaymentOperation), "publish-secret-confirmation-code")]
    [JsonSubtypes.KnownSubType(typeof(ViewPaymentOperation), "view-payment")]
    public partial class PaymentOperation : IEquatable<PaymentOperation>, IValidatableObject
    {
        /// <summary>
        /// Defines ContentType
        /// </summary>
        ...
        public enum ContentTypeEnum
        {
            ...
            /// <summary>
            /// Enum ApplicationJavascript for value: application/javascript
            /// </summary>
            [EnumMember(Value = "application/javascript")]
            ApplicationJavascript = 2,
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentOperation" /> class.
        /// </summary>
        ...
        public PaymentOperation(ContentTypeEnum? contentType = default(ContentTypeEnum?), MethodEnum? method = default(MethodEnum?), string rel = default(string))
        {
            // to ensure "rel" is required (not null)
            this.Rel = rel ?? throw new ArgumentNullException("rel is a required property for PaymentOperation and cannot be null");
        ...
        /// Gets or Sets Rel
        /// </summary>
        [DataMember(Name = "rel", IsRequired = true, EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentOperation {\n");
        ...
        {
            return this.Equals(input as PaymentOperation);
        }

        /// <summary>
        /// Returns true if PaymentOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentOperation input)
        {
            if (input == null)
                return false;
