...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PayExGwStoreOverride")]
    public partial class PayExGwStoreOverride : IEquatable<PayExGwStoreOverride>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExGwStoreOverride" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayExGwStoreOverride() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExGwStoreOverride" /> class.
        /// </summary>
        ...
        public PayExGwStoreOverride(string url = default(string), string payeeId = default(string), string subsite = default(string), string token = default(string))
        {
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url is a required property for PayExGwStoreOverride and cannot be null");
            // to ensure "payeeId" is required (not null)
            this.PayeeId = payeeId ?? throw new ArgumentNullException("payeeId is a required property for PayExGwStoreOverride and cannot be null");
            // to ensure "token" is required (not null)
            this.Token = token ?? throw new ArgumentNullException("token is a required property for PayExGwStoreOverride and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PayExGwStoreOverride {\n");
        ...
        {
            return this.Equals(input as PayExGwStoreOverride);
        }

        /// <summary>
        /// Returns true if PayExGwStoreOverride instances are equal
        /// </summary>
        /// <param name="input">Instance of PayExGwStoreOverride to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayExGwStoreOverride input)
        {
            if (input == null)
                return false;
