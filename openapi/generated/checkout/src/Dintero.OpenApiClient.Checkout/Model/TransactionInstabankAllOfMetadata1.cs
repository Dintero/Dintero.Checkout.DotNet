...
{
    /// <summary>
    /// TransactionInstabankAllOfMetadata1
    /// </summary>
    [DataContract(Name = "TransactionInstabank_allOf_metadata_1")]
    public partial class TransactionInstabankAllOfMetadata1 : IEquatable<TransactionInstabankAllOfMetadata1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionInstabankAllOfMetadata1" /> class.
        /// </summary>
        /// <param name="instabankSaleExternalReference">External reference for the transaction .</param>
        /// <param name="instabankSaleSequence">External case sequence (id) .</param>
        /// <param name="instabankSaleProductName">Payment product name.</param>
        public TransactionInstabankAllOfMetadata1(string instabankSaleExternalReference = default(string), decimal instabankSaleSequence = default(decimal), string instabankSaleProductName = default(string))
        {
            this.InstabankSaleExternalReference = instabankSaleExternalReference;
            this.InstabankSaleSequence = instabankSaleSequence;
            this.InstabankSaleProductName = instabankSaleProductName;
        }

        /// <summary>
        /// External reference for the transaction 
        /// </summary>
        /// <value>External reference for the transaction </value>
        [DataMember(Name = "instabank:Sale.ExternalReference", EmitDefaultValue = false)]
        public string InstabankSaleExternalReference { get; set; }

        /// <summary>
        /// External case sequence (id) 
        /// </summary>
        /// <value>External case sequence (id) </value>
        [DataMember(Name = "instabank:Sale.Sequence", EmitDefaultValue = false)]
        public decimal InstabankSaleSequence { get; set; }

        /// <summary>
        /// Payment product name
        /// </summary>
        /// <value>Payment product name</value>
        [DataMember(Name = "instabank:Sale.Product.Name", EmitDefaultValue = false)]
        public string InstabankSaleProductName { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionInstabankAllOfMetadata1 {\n");
            sb.Append("  InstabankSaleExternalReference: ").Append(InstabankSaleExternalReference).Append("\n");
            sb.Append("  InstabankSaleSequence: ").Append(InstabankSaleSequence).Append("\n");
            sb.Append("  InstabankSaleProductName: ").Append(InstabankSaleProductName).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TransactionInstabankAllOfMetadata1);
        }

        /// <summary>
        /// Returns true if TransactionInstabankAllOfMetadata1 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionInstabankAllOfMetadata1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionInstabankAllOfMetadata1 input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.InstabankSaleExternalReference == input.InstabankSaleExternalReference ||
                    (this.InstabankSaleExternalReference != null &&
                    this.InstabankSaleExternalReference.Equals(input.InstabankSaleExternalReference))
                ) && 
                (
                    this.InstabankSaleSequence == input.InstabankSaleSequence ||
                    this.InstabankSaleSequence.Equals(input.InstabankSaleSequence)
                ) && 
                (
                    this.InstabankSaleProductName == input.InstabankSaleProductName ||
                    (this.InstabankSaleProductName != null &&
                    this.InstabankSaleProductName.Equals(input.InstabankSaleProductName))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.InstabankSaleExternalReference != null)
                    hashCode = hashCode * 59 + this.InstabankSaleExternalReference.GetHashCode();
                hashCode = hashCode * 59 + this.InstabankSaleSequence.GetHashCode();
                if (this.InstabankSaleProductName != null)
                    hashCode = hashCode * 59 + this.InstabankSaleProductName.GetHashCode();
                return hashCode;
            }
        }
