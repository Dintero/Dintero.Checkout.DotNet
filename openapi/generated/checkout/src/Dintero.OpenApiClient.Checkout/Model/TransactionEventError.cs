...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransactionEvent_error")]
    public partial class TransactionEventError : IEquatable<TransactionEventError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionEventError" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionEventError() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionEventError" /> class.
        /// </summary>
        ...
        public TransactionEventError(string code = default(string), string message = default(string))
        {
            // to ensure "message" is required (not null)
            this.Message = message ?? throw new ArgumentNullException("message is a required property for TransactionEventError and cannot be null");
            this.Code = code;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionEventError {\n");
        ...
        {
            return this.Equals(input as TransactionEventError);
        }

        /// <summary>
        /// Returns true if TransactionEventError instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionEventError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionEventError input)
        {
            if (input == null)
                return false;
