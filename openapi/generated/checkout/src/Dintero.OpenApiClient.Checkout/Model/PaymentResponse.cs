...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class PaymentResponse : IEquatable<PaymentResponse>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="PaymentResponse" /> class.
        /// </summary>
        /// <param name="success">the payment was accepted (required).</param>
        ...
        public PaymentResponse(bool success = default(bool), List<PaymentResponseActions> actions = default(List<PaymentResponseActions>), string redirectUrl = default(string), Object pollUrl = default(Object), string error = default(string))
        {
            this.Success = success;
            // to ensure "actions" is required (not null)
            this.Actions = actions ?? throw new ArgumentNullException("actions is a required property for PaymentResponse and cannot be null");
        ...
        /// </summary>
        /// <value>the payment was accepted</value>
        ...
        public List<PaymentResponseActions> Actions { get; set; }
