...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DiscountsConfiguration_discounts")]
    public partial class DiscountsConfigurationDiscounts : IEquatable<DiscountsConfigurationDiscounts>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DiscountsConfigurationDiscounts" /> class.
        /// </summary>
        /// <param name="expressDiscountCodes">expressDiscountCodes.</param>
        /// <param name="order">order.</param>
        public DiscountsConfigurationDiscounts(DiscountsConfigurationDiscountsExpressDiscountCodes expressDiscountCodes = default(DiscountsConfigurationDiscountsExpressDiscountCodes), DiscountsConfigurationDiscountsOrder order = default(DiscountsConfigurationDiscountsOrder))
        {
            this.ExpressDiscountCodes = expressDiscountCodes;
            this.Order = order;
        }

        /// <summary>
        /// Gets or Sets ExpressDiscountCodes
        /// </summary>
        [DataMember(Name = "express_discount_codes", EmitDefaultValue = false)]
        public DiscountsConfigurationDiscountsExpressDiscountCodes ExpressDiscountCodes { get; set; }

        /// <summary>
        /// Gets or Sets Order
        /// </summary>
        [DataMember(Name = "order", EmitDefaultValue = false)]
        public DiscountsConfigurationDiscountsOrder Order { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DiscountsConfigurationDiscounts {\n");
            sb.Append("  Type: ").Append(Type).Append("\n");
            sb.Append("  ExpressDiscountCodes: ").Append(ExpressDiscountCodes).Append("\n");
        ...
        {
            return this.Equals(input as DiscountsConfigurationDiscounts);
        }

        /// <summary>
        /// Returns true if DiscountsConfigurationDiscounts instances are equal
        /// </summary>
        /// <param name="input">Instance of DiscountsConfigurationDiscounts to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DiscountsConfigurationDiscounts input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ExpressDiscountCodes == input.ExpressDiscountCodes ||
                    (this.ExpressDiscountCodes != null &&
                    this.ExpressDiscountCodes.Equals(input.ExpressDiscountCodes))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ExpressDiscountCodes != null)
                    hashCode = hashCode * 59 + this.ExpressDiscountCodes.GetHashCode();
                if (this.Order != null)
