...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class ShippingOption : IEquatable<ShippingOption>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="ShippingOption" /> class.
        /// </summary>
        /// <param name="id">Id of this shipping option product.  The express checkout will group all products with the same id. Used for grouping delivery to the same address at different time slots, or for grouping deliveries to different pick up points.  (required).</param>
        /// <param name="lineId">Unique id of the specific configuration of this shipping product  (required).</param>
        /// <param name="countries">Countries where this shipping option can be used.</param>
        /// <param name="amount">The monetary amount of the shipping option  (required).</param>
        /// <param name="vatAmount">The VAT of the &#x60;amount&#x60; parameter. Only used for display purposes. .</param>
        /// <param name="vat">The VAT percentage .</param>
        /// <param name="title">A shipping option title. Eg. \&quot;Standard\&quot;  (required).</param>
        /// <param name="description">A short description of the shipping option product .</param>
        /// <param name="deliveryMethod">deliveryMethod.</param>
        /// <param name="_operator">Name of company that provides shipping service  (required).</param>
        /// <param name="operatorProductId">The operators own id for this shipping product .</param>
        /// <param name="eta">eta.</param>
        /// <param name="timeSlot">timeSlot.</param>
        /// <param name="pickUpAddress">pickUpAddress.</param>
        public ShippingOption(string id = default(string), string lineId = default(string), List<string> countries = default(List<string>), int amount = default(int), int vatAmount = default(int), decimal vat = default(decimal), string title = default(string), string description = default(string), DeliveryMethodEnum? deliveryMethod = default(DeliveryMethodEnum?), string _operator = default(string), string operatorProductId = default(string), ShippingOptionEta eta = default(ShippingOptionEta), ShippingOptionTimeSlot timeSlot = default(ShippingOptionTimeSlot), OrderAddress pickUpAddress = default(OrderAddress))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for ShippingOption and cannot be null");
            // to ensure "lineId" is required (not null)
            this.LineId = lineId ?? throw new ArgumentNullException("lineId is a required property for ShippingOption and cannot be null");
            this.Amount = amount;
            // to ensure "title" is required (not null)
            this.Title = title ?? throw new ArgumentNullException("title is a required property for ShippingOption and cannot be null");
            // to ensure "_operator" is required (not null)
            this.Operator = _operator ?? throw new ArgumentNullException("_operator is a required property for ShippingOption and cannot be null");
        ...
        /// <summary>
        /// Id of this shipping option product.  The express checkout will group all products with the same id. Used for grouping delivery to the same address at different time slots, or for grouping deliveries to different pick up points. 
        /// </summary>
        /// <value>Id of this shipping option product.  The express checkout will group all products with the same id. Used for grouping delivery to the same address at different time slots, or for grouping deliveries to different pick up points. </value>
        ...
        /// </summary>
        /// <value>Unique id of the specific configuration of this shipping product </value>
        [DataMember(Name = "line_id", IsRequired = true, EmitDefaultValue = false)]
        public string LineId { get; set; }

        /// <summary>
        /// Countries where this shipping option can be used
        /// </summary>
        /// <value>Countries where this shipping option can be used</value>
        ...
        /// </summary>
        /// <value>The monetary amount of the shipping option </value>
        ...
        /// </summary>
        /// <value>The VAT of the &#x60;amount&#x60; parameter. Only used for display purposes. </value>
        ...
        /// </summary>
        /// <value>A shipping option title. Eg. \&quot;Standard\&quot; </value>
        ...
        /// </summary>
        /// <value>A short description of the shipping option product </value>
        ...
        /// </summary>
        /// <value>Name of company that provides shipping service </value>
        ...
        /// </summary>
        /// <value>The operators own id for this shipping product </value>
        [DataMember(Name = "operator_product_id", EmitDefaultValue = false)]
        public string OperatorProductId { get; set; }

        /// <summary>
        /// Gets or Sets Eta
        /// </summary>
        [DataMember(Name = "eta", EmitDefaultValue = false)]
        public ShippingOptionEta Eta { get; set; }

        /// <summary>
        /// Gets or Sets TimeSlot
        /// </summary>
        [DataMember(Name = "time_slot", EmitDefaultValue = false)]
        public ShippingOptionTimeSlot TimeSlot { get; set; }

        /// <summary>
        /// Gets or Sets PickUpAddress
        /// </summary>
        [DataMember(Name = "pick_up_address", EmitDefaultValue = false)]
        public OrderAddress PickUpAddress { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  OperatorProductId: ").Append(OperatorProductId).Append("\n");
        ...
        public bool Equals(ShippingOption input)
        {
            ...
            return 
                ...
                (
                    this.OperatorProductId == input.OperatorProductId ||
                    (this.OperatorProductId != null &&
                    this.OperatorProductId.Equals(input.OperatorProductId))
                ) && 
                (
                    this.Eta == input.Eta ||
                    (this.Eta != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OperatorProductId != null)
                    hashCode = hashCode * 59 + this.OperatorProductId.GetHashCode();
                if (this.Eta != null)
