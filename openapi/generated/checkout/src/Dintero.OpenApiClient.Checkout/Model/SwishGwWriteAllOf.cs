...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// SwishGwWriteAllOf
    /// </summary>
    [DataContract(Name = "SwishGwWrite_allOf")]
    public partial class SwishGwWriteAllOf : IEquatable<SwishGwWriteAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SwishGwWriteAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SwishGwWriteAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SwishGwWriteAllOf" /> class.
        /// </summary>
        ...
        public SwishGwWriteAllOf(string cert = default(string), string key = default(string), string passphrase = default(string), string ca = default(string))
        {
            // to ensure "cert" is required (not null)
            this.Cert = cert ?? throw new ArgumentNullException("cert is a required property for SwishGwWriteAllOf and cannot be null");
            // to ensure "passphrase" is required (not null)
            this.Passphrase = passphrase ?? throw new ArgumentNullException("passphrase is a required property for SwishGwWriteAllOf and cannot be null");
            this.Key = key;
            this.Ca = ca;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SwishGwWriteAllOf {\n");
        ...
        {
            return this.Equals(input as SwishGwWriteAllOf);
        }

        /// <summary>
        /// Returns true if SwishGwWriteAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SwishGwWriteAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SwishGwWriteAllOf input)
        {
            if (input == null)
                return false;
