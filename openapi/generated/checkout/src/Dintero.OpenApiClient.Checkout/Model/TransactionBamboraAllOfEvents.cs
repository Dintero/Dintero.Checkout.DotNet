...
{
    /// <summary>
    /// TransactionBamboraAllOfEvents
    /// </summary>
    [DataContract(Name = "TransactionBambora_allOf_events")]
    public partial class TransactionBamboraAllOfEvents : IEquatable<TransactionBamboraAllOfEvents>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionBamboraAllOfEvents" /> class.
        /// </summary>
        /// <param name="transactionStatus">transactionStatus.</param>
        /// <param name="metadata">metadata.</param>
        public TransactionBamboraAllOfEvents(TransactionStatusEnum? transactionStatus = default(TransactionStatusEnum?), TransactionBamboraAllOfMetadata metadata = default(TransactionBamboraAllOfMetadata))
        {
        ...
        public TransactionBamboraAllOfMetadata Metadata { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionBamboraAllOfEvents {\n");
        ...
        {
            return this.Equals(input as TransactionBamboraAllOfEvents);
        }

        /// <summary>
        /// Returns true if TransactionBamboraAllOfEvents instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionBamboraAllOfEvents to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionBamboraAllOfEvents input)
        {
            if (input == null)
                return false;
