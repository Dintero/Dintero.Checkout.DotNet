...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// BamboraGwWriteAllOf
    /// </summary>
    [DataContract(Name = "BamboraGwWrite_allOf")]
    public partial class BamboraGwWriteAllOf : IEquatable<BamboraGwWriteAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraGwWriteAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BamboraGwWriteAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraGwWriteAllOf" /> class.
        /// </summary>
        ...
        public BamboraGwWriteAllOf(string accessToken = default(string), string secretToken = default(string), string md5Key = default(string))
        {
            // to ensure "accessToken" is required (not null)
            this.AccessToken = accessToken ?? throw new ArgumentNullException("accessToken is a required property for BamboraGwWriteAllOf and cannot be null");
            // to ensure "secretToken" is required (not null)
            this.SecretToken = secretToken ?? throw new ArgumentNullException("secretToken is a required property for BamboraGwWriteAllOf and cannot be null");
            // to ensure "md5Key" is required (not null)
            this.Md5Key = md5Key ?? throw new ArgumentNullException("md5Key is a required property for BamboraGwWriteAllOf and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BamboraGwWriteAllOf {\n");
        ...
        {
            return this.Equals(input as BamboraGwWriteAllOf);
        }

        /// <summary>
        /// Returns true if BamboraGwWriteAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of BamboraGwWriteAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BamboraGwWriteAllOf input)
        {
            if (input == null)
                return false;
