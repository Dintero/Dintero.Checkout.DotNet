...
{
    /// <summary>
    /// SantanderConfigurationDebitAccount
    /// </summary>
    [DataContract(Name = "SantanderConfiguration_debit_account")]
    public partial class SantanderConfigurationDebitAccount : IEquatable<SantanderConfigurationDebitAccount>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SantanderConfigurationDebitAccount" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SantanderConfigurationDebitAccount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SantanderConfigurationDebitAccount" /> class.
        /// </summary>
        /// <param name="type">Denotes what kind of config parameter this is.</param>
        /// <param name="enabled">enable Santander Finance Debit Account (required).</param>
        /// <param name="payability">payability.</param>
        /// <param name="brandingName">The name of the chain.</param>
        /// <param name="accounts">Debit accounts belonging to the customer&#39;s phone number.</param>
        public SantanderConfigurationDebitAccount(Object type = default(Object), bool enabled = default(bool), SessionPayability? payability = default(SessionPayability?), string brandingName = default(string), List<SantanderConfigurationDebitAccountAccounts> accounts = default(List<SantanderConfigurationDebitAccountAccounts>))
        {
        ...
        /// </summary>
        /// <value>enable Santander Finance Debit Account</value>
        ...
        /// </summary>
        /// <value>Debit accounts belonging to the customer&#39;s phone number</value>
        [DataMember(Name = "accounts", EmitDefaultValue = false)]
        public List<SantanderConfigurationDebitAccountAccounts> Accounts { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SantanderConfigurationDebitAccount {\n");
        ...
        {
            return this.Equals(input as SantanderConfigurationDebitAccount);
        }

        /// <summary>
        /// Returns true if SantanderConfigurationDebitAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of SantanderConfigurationDebitAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SantanderConfigurationDebitAccount input)
        {
            if (input == null)
                return false;
