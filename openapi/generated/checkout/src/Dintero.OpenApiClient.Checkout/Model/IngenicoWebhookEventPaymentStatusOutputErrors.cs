...
{
    /// <summary>
    /// IngenicoWebhookEventPaymentStatusOutputErrors
    /// </summary>
    [DataContract(Name = "IngenicoWebhookEvent_payment_statusOutput_errors")]
    public partial class IngenicoWebhookEventPaymentStatusOutputErrors : IEquatable<IngenicoWebhookEventPaymentStatusOutputErrors>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoWebhookEventPaymentStatusOutputErrors" /> class.
        /// </summary>
        ...
        public IngenicoWebhookEventPaymentStatusOutputErrors(string category = default(string), string code = default(string), int httpStatusCode = default(int), string id = default(string), string message = default(string), string propertyName = default(string), string requestId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IngenicoWebhookEventPaymentStatusOutputErrors {\n");
        ...
        {
            return this.Equals(input as IngenicoWebhookEventPaymentStatusOutputErrors);
        }

        /// <summary>
        /// Returns true if IngenicoWebhookEventPaymentStatusOutputErrors instances are equal
        /// </summary>
        /// <param name="input">Instance of IngenicoWebhookEventPaymentStatusOutputErrors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IngenicoWebhookEventPaymentStatusOutputErrors input)
        {
            if (input == null)
                return false;
