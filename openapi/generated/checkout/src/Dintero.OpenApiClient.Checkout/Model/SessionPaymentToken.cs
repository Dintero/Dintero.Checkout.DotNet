...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// SessionPaymentToken
    /// </summary>
    [DataContract(Name = "SessionPaymentToken")]
    public partial class SessionPaymentToken : IEquatable<SessionPaymentToken>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionPaymentToken" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SessionPaymentToken() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionPaymentToken" /> class.
        /// </summary>
        /// <param name="order">order (required).</param>
        /// <param name="url">url (required).</param>
        /// <param name="profileId">configuration profile to use for branding .</param>
        /// <param name="customer">customer.</param>
        /// <param name="expiresAt">expiresAt.</param>
        /// <param name="configuration">configuration.</param>
        public SessionPaymentToken(SessionPaymentTokenOrder order = default(SessionPaymentTokenOrder), SessionUrls url = default(SessionUrls), string profileId = default(string), SessionCustomer customer = default(SessionCustomer), DateTime expiresAt = default(DateTime), SessionThemeConfiguration configuration = default(SessionThemeConfiguration))
        {
            // to ensure "order" is required (not null)
            this.Order = order ?? throw new ArgumentNullException("order is a required property for SessionPaymentToken and cannot be null");
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url is a required property for SessionPaymentToken and cannot be null");
        ...
        public SessionPaymentTokenOrder Order { get; set; }
        ...
        /// </summary>
        /// <value>configuration profile to use for branding </value>
        ...
        public SessionThemeConfiguration Configuration { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SessionPaymentToken {\n");
        ...
        {
            return this.Equals(input as SessionPaymentToken);
        }

        /// <summary>
        /// Returns true if SessionPaymentToken instances are equal
        /// </summary>
        /// <param name="input">Instance of SessionPaymentToken to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SessionPaymentToken input)
        {
            if (input == null)
                return false;
