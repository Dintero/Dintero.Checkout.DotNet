...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// PayExTokenProvider
    /// </summary>
    [DataContract(Name = "PayExTokenProvider")]
    [JsonConverter(typeof(JsonSubtypes), "PaymentProductType")]
    public partial class PayExTokenProvider : TokenProvider, IEquatable<PayExTokenProvider>, IValidatableObject
    {
        /// <summary>
        /// Defines TokenTypes
        /// </summary>
        ...
        public enum TokenTypesEnum
        {
            ...
            /// <summary>
            /// Enum RecurrenceToken for value: recurrence_token
            /// </summary>
            [EnumMember(Value = "recurrence_token")]
            RecurrenceToken = 2
        ...
        /// <summary>
        /// Gets or Sets TokenTypes
        /// </summary>
        [DataMember(Name = "token_types", IsRequired = true, EmitDefaultValue = false)]
        public List<TokenTypesEnum> TokenTypes { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExTokenProvider" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayExTokenProvider() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExTokenProvider" /> class.
        /// </summary>
        /// <param name="tokenTypes">tokenTypes (required).</param>
        /// <param name="paymentProductType">The payment product type corresponding to create token for  (required) (default to &quot;PayExTokenProvider&quot;).</param>
        public PayExTokenProvider(List<TokenTypesEnum> tokenTypes = default(List<TokenTypesEnum>), string paymentProductType = "PayExTokenProvider") : base(paymentProductType)
        {
            // to ensure "tokenTypes" is required (not null)
            this.TokenTypes = tokenTypes ?? throw new ArgumentNullException("tokenTypes is a required property for PayExTokenProvider and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PayExTokenProvider {\n");
            sb.Append("  ").Append(base.ToString().Replace("\n", "\n  ")).Append("\n");
            sb.Append("  TokenTypes: ").Append(TokenTypes).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as PayExTokenProvider);
        }

        /// <summary>
        /// Returns true if PayExTokenProvider instances are equal
        /// </summary>
        /// <param name="input">Instance of PayExTokenProvider to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayExTokenProvider input)
        {
            if (input == null)
                return false;
            ...
            return base.Equals(input) && 
                (
                    this.TokenTypes == input.TokenTypes ||
                    this.TokenTypes.SequenceEqual(input.TokenTypes)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.TokenTypes.GetHashCode();
                return hashCode;
            }
        }
