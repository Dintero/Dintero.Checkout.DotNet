...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SessionExpress_express")]
    public partial class SessionExpressExpress : IEquatable<SessionExpressExpress>, IValidatableObject
    {
        /// <summary>
        /// Defines CustomerTypes
        /// </summary>
        ...
        /// </summary>
        /// <value>Limit the lind of customers that can be submitted via the address form in the express checkout. </value>
        [DataMember(Name = "customer_types", EmitDefaultValue = false)]
        public List<CustomerTypesEnum> CustomerTypes { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionExpressExpress" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SessionExpressExpress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionExpressExpress" /> class.
        /// </summary>
        /// <param name="discountCodes">discountCodes.</param>
        /// <param name="shippingAddressCallbackUrl">URL that Checkout will POST to when the end user has submitted/changed a shipping address for an express-session.  Dintero will not attempt a retry after a failed delivery attempt. Following situations is considered as failed delivery  - HTTP status codes that are not 200. - A request timeout (60 seconds) - Any connection error such as connection timeout, bad certificate, etc  The response from the callback will be used to update the shipping options.  See [POST example/shipping_address_callback_url](#operation/example_shipping_address_callback_url) for details about the request and response. .</param>
        /// <param name="shippingOptions">Shipping options that will be presented to the end user after the end user has submitted a shipping address.  To dynamically update the shipping_options when the _&#x60;order.shipping_address&#x60;_ is changed by the end user in the checkout, use the _&#x60;url.shipping_address_callback_url&#x60;_.   If the merchant is not able to ship the order to the end users shipping address, use an empty array.   If there is only one option, a free delivery, the order still has to contain one option with a _&#x60;price.amount&#x60;_ of 0.  (required).</param>
        /// <param name="customerTypes">Limit the lind of customers that can be submitted via the address form in the express checkout. .</param>
        public SessionExpressExpress(SessionExpressExpressDiscountCodes discountCodes = default(SessionExpressExpressDiscountCodes), string shippingAddressCallbackUrl = default(string), List<ShippingOption> shippingOptions = default(List<ShippingOption>), List<CustomerTypesEnum> customerTypes = default(List<CustomerTypesEnum>))
        {
            // to ensure "shippingOptions" is required (not null)
            this.ShippingOptions = shippingOptions ?? throw new ArgumentNullException("shippingOptions is a required property for SessionExpressExpress and cannot be null");
            this.DiscountCodes = discountCodes;
            this.ShippingAddressCallbackUrl = shippingAddressCallbackUrl;
        ...
        public SessionExpressExpressDiscountCodes DiscountCodes { get; set; }

        /// <summary>
        /// URL that Checkout will POST to when the end user has submitted/changed a shipping address for an express-session.  Dintero will not attempt a retry after a failed delivery attempt. Following situations is considered as failed delivery  - HTTP status codes that are not 200. - A request timeout (60 seconds) - Any connection error such as connection timeout, bad certificate, etc  The response from the callback will be used to update the shipping options.  See [POST example/shipping_address_callback_url](#operation/example_shipping_address_callback_url) for details about the request and response. 
        /// </summary>
        /// <value>URL that Checkout will POST to when the end user has submitted/changed a shipping address for an express-session.  Dintero will not attempt a retry after a failed delivery attempt. Following situations is considered as failed delivery  - HTTP status codes that are not 200. - A request timeout (60 seconds) - Any connection error such as connection timeout, bad certificate, etc  The response from the callback will be used to update the shipping options.  See [POST example/shipping_address_callback_url](#operation/example_shipping_address_callback_url) for details about the request and response. </value>
        [DataMember(Name = "shipping_address_callback_url", EmitDefaultValue = false)]
        public string ShippingAddressCallbackUrl { get; set; }

        /// <summary>
        /// Shipping options that will be presented to the end user after the end user has submitted a shipping address.  To dynamically update the shipping_options when the _&#x60;order.shipping_address&#x60;_ is changed by the end user in the checkout, use the _&#x60;url.shipping_address_callback_url&#x60;_.   If the merchant is not able to ship the order to the end users shipping address, use an empty array.   If there is only one option, a free delivery, the order still has to contain one option with a _&#x60;price.amount&#x60;_ of 0. 
        /// </summary>
        /// <value>Shipping options that will be presented to the end user after the end user has submitted a shipping address.  To dynamically update the shipping_options when the _&#x60;order.shipping_address&#x60;_ is changed by the end user in the checkout, use the _&#x60;url.shipping_address_callback_url&#x60;_.   If the merchant is not able to ship the order to the end users shipping address, use an empty array.   If there is only one option, a free delivery, the order still has to contain one option with a _&#x60;price.amount&#x60;_ of 0. </value>
        [DataMember(Name = "shipping_options", IsRequired = true, EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SessionExpressExpress {\n");
            sb.Append("  DiscountCodes: ").Append(DiscountCodes).Append("\n");
            sb.Append("  ShippingAddressCallbackUrl: ").Append(ShippingAddressCallbackUrl).Append("\n");
        ...
        {
            return this.Equals(input as SessionExpressExpress);
        }

        /// <summary>
        /// Returns true if SessionExpressExpress instances are equal
        /// </summary>
        /// <param name="input">Instance of SessionExpressExpress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SessionExpressExpress input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    ...
                    this.DiscountCodes.Equals(input.DiscountCodes))
                ) && 
                (
                    this.ShippingAddressCallbackUrl == input.ShippingAddressCallbackUrl ||
                    (this.ShippingAddressCallbackUrl != null &&
                    this.ShippingAddressCallbackUrl.Equals(input.ShippingAddressCallbackUrl))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ShippingAddressCallbackUrl != null)
                    hashCode = hashCode * 59 + this.ShippingAddressCallbackUrl.GetHashCode();
        ...
        {
            // ShippingAddressCallbackUrl (string) pattern
            Regex regexShippingAddressCallbackUrl = new Regex(@"https?:\/\/_*", RegexOptions.CultureInvariant);
            if (false == regexShippingAddressCallbackUrl.Match(this.ShippingAddressCallbackUrl).Success)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ShippingAddressCallbackUrl, must match a pattern of " + regexShippingAddressCallbackUrl, new [] { "ShippingAddressCallbackUrl" });
            }
