...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NetaxeptConfiguration_creditcard_terminal")]
    public partial class NetaxeptConfigurationCreditcardTerminal : IEquatable<NetaxeptConfigurationCreditcardTerminal>, IValidatableObject
    {
        /// <summary>
        /// Defines Terminal
        /// </summary>
        ...
        {
            /// <summary>
            /// Enum TerminalDefaultAspx for value: /Terminal/default.aspx
            /// </summary>
            [EnumMember(Value = "/Terminal/default.aspx")]
            TerminalDefaultAspx = 1,

            /// <summary>
            /// Enum TerminalMobileDefaultAspx for value: /terminal/mobile/default.aspx
            /// </summary>
            [EnumMember(Value = "/terminal/mobile/default.aspx")]
            TerminalMobileDefaultAspx = 2
        ...
        /// </summary>
        [DataMember(Name = "terminal", IsRequired = true, EmitDefaultValue = false)]
        public TerminalEnum Terminal { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="NetaxeptConfigurationCreditcardTerminal" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NetaxeptConfigurationCreditcardTerminal() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NetaxeptConfigurationCreditcardTerminal" /> class.
        /// </summary>
        /// <param name="terminal">terminal (required).</param>
        /// <param name="terminalDesign">Name of the terminal template to use, created in Netaxept Admin .</param>
        /// <param name="terminalSinglePage">Set hosted payment window to single page (required).</param>
        /// <param name="terminalLayout">terminalLayout.</param>
        public NetaxeptConfigurationCreditcardTerminal(TerminalEnum terminal = default(TerminalEnum), string terminalDesign = default(string), bool terminalSinglePage = default(bool), string terminalLayout = default(string))
        {
            this.Terminal = terminal;
            this.TerminalSinglePage = terminalSinglePage;
            this.TerminalDesign = terminalDesign;
        ...
        /// </summary>
        /// <value>Name of the terminal template to use, created in Netaxept Admin </value>
        [DataMember(Name = "terminal_design", EmitDefaultValue = false)]
        public string TerminalDesign { get; set; }

        /// <summary>
        /// Set hosted payment window to single page
        /// </summary>
        /// <value>Set hosted payment window to single page</value>
        [DataMember(Name = "terminal_single_page", IsRequired = true, EmitDefaultValue = true)]
        public bool TerminalSinglePage { get; set; }

        /// <summary>
        /// Gets or Sets TerminalLayout
        /// </summary>
        [DataMember(Name = "terminal_layout", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NetaxeptConfigurationCreditcardTerminal {\n");
            sb.Append("  Terminal: ").Append(Terminal).Append("\n");
            sb.Append("  TerminalDesign: ").Append(TerminalDesign).Append("\n");
            sb.Append("  TerminalSinglePage: ").Append(TerminalSinglePage).Append("\n");
            sb.Append("  TerminalLayout: ").Append(TerminalLayout).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as NetaxeptConfigurationCreditcardTerminal);
        }

        /// <summary>
        /// Returns true if NetaxeptConfigurationCreditcardTerminal instances are equal
        /// </summary>
        /// <param name="input">Instance of NetaxeptConfigurationCreditcardTerminal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NetaxeptConfigurationCreditcardTerminal input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.TerminalDesign == input.TerminalDesign ||
                    (this.TerminalDesign != null &&
                    this.TerminalDesign.Equals(input.TerminalDesign))
                ) && 
                (
                    this.TerminalSinglePage == input.TerminalSinglePage ||
                    this.TerminalSinglePage.Equals(input.TerminalSinglePage)
                ) && 
                (
                    this.TerminalLayout == input.TerminalLayout ||
                    (this.TerminalLayout != null &&
                    this.TerminalLayout.Equals(input.TerminalLayout))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TerminalDesign != null)
                    hashCode = hashCode * 59 + this.TerminalDesign.GetHashCode();
                hashCode = hashCode * 59 + this.TerminalSinglePage.GetHashCode();
                if (this.TerminalLayout != null)
                    hashCode = hashCode * 59 + this.TerminalLayout.GetHashCode();
                return hashCode;
            }
        }
