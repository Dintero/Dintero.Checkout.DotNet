...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class InlineObject21 : IEquatable<InlineObject21>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="InlineObject21" /> class.
        /// </summary>
        /// <param name="amount">The amount to be refunded (required).</param>
        /// <param name="reason">The reason of the refund.</param>
        /// <param name="refundReference">A reference specified by the merchant to identify the transaction .</param>
        /// <param name="items">Info about the refunded order items  #### Instabank &#x60;required&#x60; if the transaction &#x60;payment_product&#x60; is *instabank*. The refund will then be applied to the items included. .</param>
        public InlineObject21(int amount = default(int), string reason = default(string), string refundReference = default(string), List<OrderItem> items = default(List<OrderItem>))
        {
            this.Amount = amount;
            this.Reason = reason;
        ...
        /// </summary>
        /// <value>The reason of the refund</value>
        ...
        [DataMember(Name = "refund_reference", EmitDefaultValue = false)]
        public string RefundReference { get; set; }

        /// <summary>
        /// Info about the refunded order items  #### Instabank &#x60;required&#x60; if the transaction &#x60;payment_product&#x60; is *instabank*. The refund will then be applied to the items included. 
        /// </summary>
        /// <value>Info about the refunded order items  #### Instabank &#x60;required&#x60; if the transaction &#x60;payment_product&#x60; is *instabank*. The refund will then be applied to the items included. </value>
        ...
        public bool Equals(InlineObject21 input)
        {
            ...
            return 
                ...
                (
                    this.RefundReference == input.RefundReference ||
                    (this.RefundReference != null &&
                    this.RefundReference.Equals(input.RefundReference))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RefundReference != null)
                    hashCode = hashCode * 59 + this.RefundReference.GetHashCode();
                if (this.Items != null)
