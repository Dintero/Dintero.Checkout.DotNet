...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccountUser")]
    public partial class AccountUser : IEquatable<AccountUser>, IValidatableObject
    {
        /// <summary>
        ...
        public AccountUser(string email = default(string), string name = default(string), List<string> scope = default(List<string>))
        {
            // to ensure "email" is required (not null)
            this.Email = email ?? throw new ArgumentNullException("email is a required property for AccountUser and cannot be null");
            this.Name = name;
            this.Scope = scope;
        }
        ...
        {
            return this.Equals(input as AccountUser);
        }

        /// <summary>
        /// Returns true if AccountUser instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountUser input)
        {
            if (input == null)
                return false;
