...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CollectorInvoiceB2BPreapprovedPayment")]
    [JsonConverter(typeof(JsonSubtypes), "PaymentProductType")]
    public partial class CollectorInvoiceB2BPreapprovedPayment : Payment, IEquatable<CollectorInvoiceB2BPreapprovedPayment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorInvoiceB2BPreapprovedPayment" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorInvoiceB2BPreapprovedPayment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorInvoiceB2BPreapprovedPayment" /> class.
        /// </summary>
        /// <param name="paymentProductType">The payment product type corresponding to this transaction  (required) (default to &quot;CollectorInvoiceB2BPreapprovedPayment&quot;).</param>
        ...
        public CollectorInvoiceB2BPreapprovedPayment(string paymentProductType = "CollectorInvoiceB2BPreapprovedPayment", CollectorB2BAddress shippingAddress = default(CollectorB2BAddress), string scc = default(string), string companyId = default(string), bool rememberMe = default(bool)) : base()
        {
            // to ensure "paymentProductType" is required (not null)
            this.PaymentProductType = paymentProductType ?? throw new ArgumentNullException("paymentProductType is a required property for CollectorInvoiceB2BPreapprovedPayment and cannot be null");
            // to ensure "shippingAddress" is required (not null)
            this.ShippingAddress = shippingAddress ?? throw new ArgumentNullException("shippingAddress is a required property for CollectorInvoiceB2BPreapprovedPayment and cannot be null");
            // to ensure "companyId" is required (not null)
            this.CompanyId = companyId ?? throw new ArgumentNullException("companyId is a required property for CollectorInvoiceB2BPreapprovedPayment and cannot be null");
            this.Scc = scc;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorInvoiceB2BPreapprovedPayment {\n");
        ...
        {
            return this.Equals(input as CollectorInvoiceB2BPreapprovedPayment);
        }

        /// <summary>
        /// Returns true if CollectorInvoiceB2BPreapprovedPayment instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorInvoiceB2BPreapprovedPayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorInvoiceB2BPreapprovedPayment input)
        {
            if (input == null)
                return false;
