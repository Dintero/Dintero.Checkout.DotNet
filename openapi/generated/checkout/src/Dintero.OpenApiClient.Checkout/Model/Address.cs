...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class Address : IEquatable<Address>, IValidatableObject
    {
        ...
        /// <param name="postalPlace">postalPlace (required).</param>
        /// <param name="country">ISO 3166-1 country code  (required).</param>
        public Address(string addressLine = default(string), string addressLine2 = default(string), string postalCode = default(string), string postalPlace = default(string), string country = default(string))
        {
            // to ensure "addressLine" is required (not null)
            this.AddressLine = addressLine ?? throw new ArgumentNullException("addressLine is a required property for Address and cannot be null");
            // to ensure "postalPlace" is required (not null)
            this.PostalPlace = postalPlace ?? throw new ArgumentNullException("postalPlace is a required property for Address and cannot be null");
