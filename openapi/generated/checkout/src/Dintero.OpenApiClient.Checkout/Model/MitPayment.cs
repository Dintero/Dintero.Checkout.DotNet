...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// MitPayment
    /// </summary>
    [DataContract(Name = "MitPayment")]
    [JsonConverter(typeof(JsonSubtypes), "PaymentProductType")]
    [JsonSubtypes.KnownSubType(typeof(PayExMitPayment), "PayExMitPayment")]
    [JsonSubtypes.KnownSubType(typeof(PayExMitPayment), "payex.creditcard")]
    public partial class MitPayment : IEquatable<MitPayment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MitPayment" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MitPayment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MitPayment" /> class.
        /// </summary>
        /// <param name="paymentProductType">The payment product type corresponding to this transaction  (required).</param>
        public MitPayment(string paymentProductType = default(string))
        {
            // to ensure "paymentProductType" is required (not null)
            this.PaymentProductType = paymentProductType ?? throw new ArgumentNullException("paymentProductType is a required property for MitPayment and cannot be null");
        }
        ...
        {
            return this.Equals(input as MitPayment);
        }

        /// <summary>
        /// Returns true if MitPayment instances are equal
        /// </summary>
        /// <param name="input">Instance of MitPayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MitPayment input)
        {
            if (input == null)
                return false;
