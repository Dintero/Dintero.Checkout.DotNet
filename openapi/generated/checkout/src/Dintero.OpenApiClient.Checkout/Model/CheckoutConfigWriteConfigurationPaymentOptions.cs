...
{
    /// <summary>
    /// CheckoutConfigWriteConfigurationPaymentOptions
    /// </summary>
    [DataContract(Name = "CheckoutConfigWrite_configuration_payment_options")]
    public partial class CheckoutConfigWriteConfigurationPaymentOptions : IEquatable<CheckoutConfigWriteConfigurationPaymentOptions>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        public enum TypeEnum
        {
            ...
            /// <summary>
            /// Enum BamboraMobilepay for value: bambora.mobilepay
            /// </summary>
            [EnumMember(Value = "bambora.mobilepay")]
            BamboraMobilepay = 2,
            ...
            CollectorInvoiceB2bPreapproved = 8,
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckoutConfigWriteConfigurationPaymentOptions" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CheckoutConfigWriteConfigurationPaymentOptions() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckoutConfigWriteConfigurationPaymentOptions" /> class.
        /// </summary>
        /// <param name="type">type (required).</param>
        /// <param name="details">details.</param>
        /// <param name="currencies">Accepted currencies for payment option (required).</param>
        public CheckoutConfigWriteConfigurationPaymentOptions(TypeEnum type = default(TypeEnum), CheckoutConfigWriteConfigurationDetails details = default(CheckoutConfigWriteConfigurationDetails), List<string> currencies = default(List<string>))
        {
            this.Type = type;
            // to ensure "currencies" is required (not null)
            this.Currencies = currencies ?? throw new ArgumentNullException("currencies is a required property for CheckoutConfigWriteConfigurationPaymentOptions and cannot be null");
        ...
        public CheckoutConfigWriteConfigurationDetails Details { get; set; }

        /// <summary>
        /// Accepted currencies for payment option
        /// </summary>
        /// <value>Accepted currencies for payment option</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CheckoutConfigWriteConfigurationPaymentOptions {\n");
        ...
        {
            return this.Equals(input as CheckoutConfigWriteConfigurationPaymentOptions);
        }

        /// <summary>
        /// Returns true if CheckoutConfigWriteConfigurationPaymentOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of CheckoutConfigWriteConfigurationPaymentOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CheckoutConfigWriteConfigurationPaymentOptions input)
        {
            if (input == null)
                return false;
