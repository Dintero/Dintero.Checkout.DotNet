...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// SessionCancelled
    /// </summary>
    [DataContract(Name = "SessionCancelled")]
    public partial class SessionCancelled : IEquatable<SessionCancelled>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionCancelled" /> class.
        /// </summary>
        /// <param name="cancelledBy">cancelledBy.</param>
        /// <param name="cancelledAt">The date-time when the resource was cancelled .</param>
        public SessionCancelled(string cancelledBy = default(string), DateTime cancelledAt = default(DateTime))
        {
        ...
        /// </summary>
        /// <value>The date-time when the resource was cancelled </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SessionCancelled {\n");
        ...
        {
            return this.Equals(input as SessionCancelled);
        }

        /// <summary>
        /// Returns true if SessionCancelled instances are equal
        /// </summary>
        /// <param name="input">Instance of SessionCancelled to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SessionCancelled input)
        {
            if (input == null)
                return false;
