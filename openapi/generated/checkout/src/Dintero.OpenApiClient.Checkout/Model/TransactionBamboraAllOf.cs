...
{
    /// <summary>
    /// TransactionBamboraAllOf
    /// </summary>
    [DataContract(Name = "TransactionBambora_allOf")]
    public partial class TransactionBamboraAllOf : IEquatable<TransactionBamboraAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionBamboraAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionBamboraAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionBamboraAllOf" /> class.
        /// </summary>
        ...
        public TransactionBamboraAllOf(PaymentProductTypeEnum paymentProductType = default(PaymentProductTypeEnum), TransactionBamboraAllOfCard card = default(TransactionBamboraAllOfCard), StatusEnum? status = default(StatusEnum?), List<TransactionBamboraAllOfEvents> events = default(List<TransactionBamboraAllOfEvents>), TransactionBamboraAllOfMetadata1 metadata = default(TransactionBamboraAllOfMetadata1))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionBamboraAllOf {\n");
        ...
        {
            return this.Equals(input as TransactionBamboraAllOf);
        }

        /// <summary>
        /// Returns true if TransactionBamboraAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionBamboraAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionBamboraAllOf input)
        {
            if (input == null)
                return false;
