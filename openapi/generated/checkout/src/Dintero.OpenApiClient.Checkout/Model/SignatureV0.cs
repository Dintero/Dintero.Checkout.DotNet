...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// SignatureV0
    /// </summary>
    [DataContract(Name = "SignatureV0")]
    public partial class SignatureV0 : IEquatable<SignatureV0>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SignatureV0" /> class.
        /// </summary>
        ...
        public SignatureV0(string id = default(string), DateTime createdAt = default(DateTime), string createdBy = default(string), SignatureV0AllOfSignature signature = default(SignatureV0AllOfSignature))
        {
            this.Id = id;
        ...
        public SignatureV0AllOfSignature Signature { get; set; }
        ...
        {
            return this.Equals(input as SignatureV0);
        }

        /// <summary>
        /// Returns true if SignatureV0 instances are equal
        /// </summary>
        /// <param name="input">Instance of SignatureV0 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SignatureV0 input)
        {
            if (input == null)
                return false;
