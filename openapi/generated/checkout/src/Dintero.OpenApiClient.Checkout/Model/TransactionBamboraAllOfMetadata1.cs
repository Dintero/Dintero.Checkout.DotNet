...
{
    /// <summary>
    /// TransactionBamboraAllOfMetadata1
    /// </summary>
    [DataContract(Name = "TransactionBambora_allOf_metadata_1")]
    public partial class TransactionBamboraAllOfMetadata1 : IEquatable<TransactionBamboraAllOfMetadata1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionBamboraAllOfMetadata1" /> class.
        /// </summary>
        /// <param name="gatewayid">gatewayid.</param>
        /// <param name="bamboramerchantNumber">bamboramerchantNumber.</param>
        /// <param name="bamboratransactionId">bamboratransactionId.</param>
        /// <param name="bamborareference">bamborareference.</param>
        /// <param name="bamboraacquirer">bamboraacquirer.</param>
        /// <param name="bamborawallet">bamborawallet.</param>
        public TransactionBamboraAllOfMetadata1(string gatewayid = default(string), string bamboramerchantNumber = default(string), string bamboratransactionId = default(string), string bamborareference = default(string), string bamboraacquirer = default(string), string bamborawallet = default(string))
        {
            this.Gatewayid = gatewayid;
            this.BamboramerchantNumber = bamboramerchantNumber;
            this.BamboratransactionId = bamboratransactionId;
            this.Bamborareference = bamborareference;
            this.Bamboraacquirer = bamboraacquirer;
            this.Bamborawallet = bamborawallet;
        }

        /// <summary>
        /// Gets or Sets Gatewayid
        /// </summary>
        [DataMember(Name = "gateway:id", EmitDefaultValue = false)]
        public string Gatewayid { get; set; }

        /// <summary>
        /// Gets or Sets BamboramerchantNumber
        /// </summary>
        [DataMember(Name = "bambora:merchant_number", EmitDefaultValue = false)]
        public string BamboramerchantNumber { get; set; }

        /// <summary>
        /// Gets or Sets BamboratransactionId
        /// </summary>
        [DataMember(Name = "bambora:transaction_id", EmitDefaultValue = false)]
        public string BamboratransactionId { get; set; }

        /// <summary>
        /// Gets or Sets Bamborareference
        /// </summary>
        [DataMember(Name = "bambora:reference", EmitDefaultValue = false)]
        public string Bamborareference { get; set; }

        /// <summary>
        /// Gets or Sets Bamboraacquirer
        /// </summary>
        [DataMember(Name = "bambora:acquirer", EmitDefaultValue = false)]
        public string Bamboraacquirer { get; set; }

        /// <summary>
        /// Gets or Sets Bamborawallet
        /// </summary>
        [DataMember(Name = "bambora:wallet", EmitDefaultValue = false)]
        public string Bamborawallet { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionBamboraAllOfMetadata1 {\n");
            sb.Append("  Gatewayid: ").Append(Gatewayid).Append("\n");
            sb.Append("  BamboramerchantNumber: ").Append(BamboramerchantNumber).Append("\n");
            sb.Append("  BamboratransactionId: ").Append(BamboratransactionId).Append("\n");
            sb.Append("  Bamborareference: ").Append(Bamborareference).Append("\n");
            sb.Append("  Bamboraacquirer: ").Append(Bamboraacquirer).Append("\n");
            sb.Append("  Bamborawallet: ").Append(Bamborawallet).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TransactionBamboraAllOfMetadata1);
        }

        /// <summary>
        /// Returns true if TransactionBamboraAllOfMetadata1 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionBamboraAllOfMetadata1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionBamboraAllOfMetadata1 input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.BamboramerchantNumber == input.BamboramerchantNumber ||
                    (this.BamboramerchantNumber != null &&
                    this.BamboramerchantNumber.Equals(input.BamboramerchantNumber))
                ) && 
                (
                    this.BamboratransactionId == input.BamboratransactionId ||
                    (this.BamboratransactionId != null &&
                    this.BamboratransactionId.Equals(input.BamboratransactionId))
                ) && 
                (
                    this.Bamborareference == input.Bamborareference ||
                    (this.Bamborareference != null &&
                    this.Bamborareference.Equals(input.Bamborareference))
                ) && 
                (
                    this.Bamboraacquirer == input.Bamboraacquirer ||
                    (this.Bamboraacquirer != null &&
                    this.Bamboraacquirer.Equals(input.Bamboraacquirer))
                ) && 
                (
                    this.Bamborawallet == input.Bamborawallet ||
                    (this.Bamborawallet != null &&
                    this.Bamborawallet.Equals(input.Bamborawallet))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BamboramerchantNumber != null)
                    hashCode = hashCode * 59 + this.BamboramerchantNumber.GetHashCode();
                if (this.BamboratransactionId != null)
                    hashCode = hashCode * 59 + this.BamboratransactionId.GetHashCode();
                if (this.Bamborareference != null)
                    hashCode = hashCode * 59 + this.Bamborareference.GetHashCode();
                if (this.Bamboraacquirer != null)
                    hashCode = hashCode * 59 + this.Bamboraacquirer.GetHashCode();
                if (this.Bamborawallet != null)
                    hashCode = hashCode * 59 + this.Bamborawallet.GetHashCode();
                return hashCode;
            }
        }
