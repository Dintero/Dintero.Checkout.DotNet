...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// TransactionBambora
    /// </summary>
    [DataContract(Name = "TransactionBambora")]
    [JsonConverter(typeof(JsonSubtypes), "PaymentProduct")]
    public partial class TransactionBambora : Transaction, IEquatable<TransactionBambora>, IValidatableObject
    {
        /// <summary>
        ...
        {
            /// <summary>
            /// Enum Creditcard for value: bambora.creditcard
            /// </summary>
            [EnumMember(Value = "bambora.creditcard")]
            Creditcard = 1,

            /// <summary>
            /// Enum Vipps for value: bambora.vipps
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionBambora" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionBambora() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionBambora" /> class.
        /// </summary>
        ...
        /// <param name="paymentProduct">The payment product corresponding to this transaction  (required) (default to &quot;TransactionBambora&quot;).</param>
        ...
        public TransactionBambora(string id = default(string), DateTime createdAt = default(DateTime), PaymentProductTypeEnum paymentProductType = default(PaymentProductTypeEnum), TransactionBamboraAllOfCard card = default(TransactionBamboraAllOfCard), StatusEnum? status = default(StatusEnum?), List<TransactionBamboraAllOfEvents> events = default(List<TransactionBamboraAllOfEvents>), TransactionBamboraAllOfMetadata1 metadata = default(TransactionBamboraAllOfMetadata1), string paymentProduct = "TransactionBambora", int amount = default(int), string currency = default(string), string merchantReference = default(string), string merchantReference2 = default(string), string dynamicDescriptor = default(string), SettlementStatus? settlementStatus = default(SettlementStatus?), TransactionCustomer customer = default(TransactionCustomer), string customerIp = default(string), string userAgent = default(string), OrderAddress shippingAddress = default(OrderAddress), ShippingOption shippingOption = default(ShippingOption), OrderAddress billingAddress = default(OrderAddress), Store store = default(Store), List<OrderItem> items = default(List<OrderItem>), TransactionUrl url = default(TransactionUrl), string sessionId = default(string), Session session = default(Session), DateTime updatedAt = default(DateTime)) : base(paymentProduct, amount, currency, merchantReference, merchantReference2, dynamicDescriptor, settlementStatus, customer, customerIp, userAgent, shippingAddress, shippingOption, billingAddress, store, items, url, sessionId, session, updatedAt)
        {
        ...
        public TransactionBamboraAllOfCard Card { get; set; }

        /// <summary>
        /// Gets or Sets Events
        /// </summary>
        [DataMember(Name = "events", EmitDefaultValue = false)]
        public List<TransactionBamboraAllOfEvents> Events { get; set; }

        /// <summary>
        /// Gets or Sets Metadata
        /// </summary>
        [DataMember(Name = "metadata", EmitDefaultValue = false)]
        public TransactionBamboraAllOfMetadata1 Metadata { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionBambora {\n");
        ...
        {
            return this.Equals(input as TransactionBambora);
        }

        /// <summary>
        /// Returns true if TransactionBambora instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionBambora to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionBambora input)
        {
            if (input == null)
                return false;
