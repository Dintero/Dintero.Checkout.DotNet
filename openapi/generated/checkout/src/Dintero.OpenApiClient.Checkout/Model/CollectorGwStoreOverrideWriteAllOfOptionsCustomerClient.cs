...
{
    /// <summary>
    /// CollectorGwStoreOverrideWriteAllOfOptionsCustomerClient
    /// </summary>
    [DataContract(Name = "CollectorGwStoreOverrideWrite_allOf_options_customer_client")]
    public partial class CollectorGwStoreOverrideWriteAllOfOptionsCustomerClient : IEquatable<CollectorGwStoreOverrideWriteAllOfOptionsCustomerClient>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorGwStoreOverrideWriteAllOfOptionsCustomerClient" /> class.
        /// </summary>
        /// <param name="customersClientId">customersClientId.</param>
        /// <param name="customersClientSecret">customersClientSecret.</param>
        /// <param name="customersClientAudience">customersClientAudience.</param>
        public CollectorGwStoreOverrideWriteAllOfOptionsCustomerClient(string customersClientId = default(string), string customersClientSecret = default(string), string customersClientAudience = default(string))
        {
            this.CustomersClientId = customersClientId;
            this.CustomersClientSecret = customersClientSecret;
            this.CustomersClientAudience = customersClientAudience;
        }

        /// <summary>
        /// Gets or Sets CustomersClientId
        /// </summary>
        [DataMember(Name = "customers_client_id", EmitDefaultValue = false)]
        public string CustomersClientId { get; set; }

        /// <summary>
        /// Gets or Sets CustomersClientSecret
        /// </summary>
        [DataMember(Name = "customers_client_secret", EmitDefaultValue = false)]
        public string CustomersClientSecret { get; set; }

        /// <summary>
        /// Gets or Sets CustomersClientAudience
        /// </summary>
        [DataMember(Name = "customers_client_audience", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorGwStoreOverrideWriteAllOfOptionsCustomerClient {\n");
        ...
        {
            return this.Equals(input as CollectorGwStoreOverrideWriteAllOfOptionsCustomerClient);
        }

        /// <summary>
        /// Returns true if CollectorGwStoreOverrideWriteAllOfOptionsCustomerClient instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorGwStoreOverrideWriteAllOfOptionsCustomerClient to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorGwStoreOverrideWriteAllOfOptionsCustomerClient input)
        {
            if (input == null)
                return false;
