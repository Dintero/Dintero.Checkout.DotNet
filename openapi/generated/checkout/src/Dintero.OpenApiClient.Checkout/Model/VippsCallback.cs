...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// VippsCallback
    /// </summary>
    [DataContract(Name = "VippsCallback")]
    public partial class VippsCallback : IEquatable<VippsCallback>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VippsCallback" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VippsCallback() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VippsCallback" /> class.
        /// </summary>
        /// <param name="orderId">orderId (required).</param>
        /// <param name="transactionInfo">transactionInfo (required).</param>
        public VippsCallback(string orderId = default(string), VippsCallbackTransactionInfo transactionInfo = default(VippsCallbackTransactionInfo))
        {
            // to ensure "orderId" is required (not null)
            this.OrderId = orderId ?? throw new ArgumentNullException("orderId is a required property for VippsCallback and cannot be null");
            // to ensure "transactionInfo" is required (not null)
            this.TransactionInfo = transactionInfo ?? throw new ArgumentNullException("transactionInfo is a required property for VippsCallback and cannot be null");
        }
        ...
        /// </summary>
        [DataMember(Name = "transactionInfo", IsRequired = true, EmitDefaultValue = false)]
        public VippsCallbackTransactionInfo TransactionInfo { get; set; }
        ...
        {
            return this.Equals(input as VippsCallback);
        }

        /// <summary>
        /// Returns true if VippsCallback instances are equal
        /// </summary>
        /// <param name="input">Instance of VippsCallback to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VippsCallback input)
        {
            if (input == null)
                return false;
