...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CollectorInstallmentPayment")]
    [JsonConverter(typeof(JsonSubtypes), "PaymentProductType")]
    public partial class CollectorInstallmentPayment : Payment, IEquatable<CollectorInstallmentPayment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorInstallmentPayment" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorInstallmentPayment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorInstallmentPayment" /> class.
        /// </summary>
        /// <param name="socialSecurityNumber">The social security number of the customer. For Norway, the length is 11. For Sweden, it&#39;s either 10 or 12 digits.  (required).</param>
        /// <param name="paymentProductType">The payment product type corresponding to this transaction  (required) (default to &quot;CollectorInstallmentPayment&quot;).</param>
        ...
        public CollectorInstallmentPayment(string socialSecurityNumber = default(string), string paymentProductType = "CollectorInstallmentPayment", CollectorInstallmentB2BPreapprovedPaymentAllOfProduct product = default(CollectorInstallmentB2BPreapprovedPaymentAllOfProduct), CollectorAddress shippingAddress = default(CollectorAddress), CollectorAddress billingAddress = default(CollectorAddress), bool rememberMe = default(bool)) : base()
        {
            // to ensure "socialSecurityNumber" is required (not null)
            this.SocialSecurityNumber = socialSecurityNumber ?? throw new ArgumentNullException("socialSecurityNumber is a required property for CollectorInstallmentPayment and cannot be null");
            // to ensure "paymentProductType" is required (not null)
            this.PaymentProductType = paymentProductType ?? throw new ArgumentNullException("paymentProductType is a required property for CollectorInstallmentPayment and cannot be null");
            // to ensure "product" is required (not null)
            this.Product = product ?? throw new ArgumentNullException("product is a required property for CollectorInstallmentPayment and cannot be null");
            // to ensure "shippingAddress" is required (not null)
            this.ShippingAddress = shippingAddress ?? throw new ArgumentNullException("shippingAddress is a required property for CollectorInstallmentPayment and cannot be null");
            // to ensure "billingAddress" is required (not null)
            this.BillingAddress = billingAddress ?? throw new ArgumentNullException("billingAddress is a required property for CollectorInstallmentPayment and cannot be null");
        ...
        /// </summary>
        /// <value>The social security number of the customer. For Norway, the length is 11. For Sweden, it&#39;s either 10 or 12 digits. </value>
        ...
        public CollectorInstallmentB2BPreapprovedPaymentAllOfProduct Product { get; set; }

        /// <summary>
        /// Gets or Sets ShippingAddress
        /// </summary>
        [DataMember(Name = "shipping_address", IsRequired = true, EmitDefaultValue = false)]
        public CollectorAddress ShippingAddress { get; set; }

        /// <summary>
        /// Gets or Sets BillingAddress
        /// </summary>
        [DataMember(Name = "billing_address", IsRequired = true, EmitDefaultValue = false)]
        public CollectorAddress BillingAddress { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorInstallmentPayment {\n");
        ...
        {
            return this.Equals(input as CollectorInstallmentPayment);
        }

        /// <summary>
        /// Returns true if CollectorInstallmentPayment instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorInstallmentPayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorInstallmentPayment input)
        {
            if (input == null)
                return false;
        ...
        protected IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> BaseValidate(ValidationContext validationContext)
        {
            ...
            if(this.SocialSecurityNumber != null && this.SocialSecurityNumber.Length > 12)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SocialSecurityNumber, length must be less than 12.", new [] { "SocialSecurityNumber" });
            }

            // SocialSecurityNumber (string) minLength
            if(this.SocialSecurityNumber != null && this.SocialSecurityNumber.Length < 10)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SocialSecurityNumber, length must be greater than 10.", new [] { "SocialSecurityNumber" });
            }
