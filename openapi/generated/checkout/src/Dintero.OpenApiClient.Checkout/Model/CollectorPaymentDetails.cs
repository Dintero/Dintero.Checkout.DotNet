...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CollectorPaymentDetails")]
    ...
    public partial class CollectorPaymentDetails : IEquatable<CollectorPaymentDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorPaymentDetails" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorPaymentDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorPaymentDetails" /> class.
        /// </summary>
        /// <param name="paymentProductType">The payment product type corresponding to this transaction  (required).</param>
        public CollectorPaymentDetails(string paymentProductType = default(string))
        {
            // to ensure "paymentProductType" is required (not null)
            this.PaymentProductType = paymentProductType ?? throw new ArgumentNullException("paymentProductType is a required property for CollectorPaymentDetails and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorPaymentDetails {\n");
        ...
        {
            return this.Equals(input as CollectorPaymentDetails);
        }

        /// <summary>
        /// Returns true if CollectorPaymentDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorPaymentDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorPaymentDetails input)
        {
            if (input == null)
                return false;
