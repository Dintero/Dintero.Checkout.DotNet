...
{
    /// <summary>
    /// InlineResponse20011Merchant
    /// </summary>
    [DataContract(Name = "inline_response_200_11_merchant")]
    public partial class InlineResponse20011Merchant : IEquatable<InlineResponse20011Merchant>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20011Merchant" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="logoUrl">logoUrl.</param>
        /// <param name="name">name.</param>
        public InlineResponse20011Merchant(string id = default(string), string logoUrl = default(string), string name = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20011Merchant {\n");
        ...
        {
            return this.Equals(input as InlineResponse20011Merchant);
        }

        /// <summary>
        /// Returns true if InlineResponse20011Merchant instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20011Merchant to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20011Merchant input)
        {
            if (input == null)
                return false;
