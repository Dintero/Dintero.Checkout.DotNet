...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// SessionMetaEvents
    /// </summary>
    [DataContract(Name = "SessionMeta_events")]
    public partial class SessionMetaEvents : IEquatable<SessionMetaEvents>, IValidatableObject
    {
        /// <summary>
        /// Defines Name
        /// </summary>
        ...
        public enum NameEnum
        {
            ...
            /// <summary>
            /// Enum PAYLOCKSTART for value: PAY_LOCK_START
            /// </summary>
            [EnumMember(Value = "PAY_LOCK_START")]
            PAYLOCKSTART = 6,

            /// <summary>
            /// Enum PAYLOCKMETA for value: PAY_LOCK_META
            /// </summary>
            [EnumMember(Value = "PAY_LOCK_META")]
            PAYLOCKMETA = 7,

            /// <summary>
            /// Enum PAYLOCKEND for value: PAY_LOCK_END
            /// </summary>
            [EnumMember(Value = "PAY_LOCK_END")]
            PAYLOCKEND = 8,

            /// <summary>
            /// Enum PAYFAILED for value: PAY_FAILED
            /// </summary>
            [EnumMember(Value = "PAY_FAILED")]
            PAYFAILED = 9,

            /// <summary>
            /// Enum ONHOLDCALLBACKSENT for value: ON_HOLD_CALLBACK_SENT
            /// </summary>
            [EnumMember(Value = "ON_HOLD_CALLBACK_SENT")]
            ONHOLDCALLBACKSENT = 10,

            /// <summary>
            /// Enum AUTHCALLBACKSENT for value: AUTH_CALLBACK_SENT
            /// </summary>
            [EnumMember(Value = "AUTH_CALLBACK_SENT")]
            AUTHCALLBACKSENT = 11,
            ...
            /// <summary>
            /// Enum PAYMENTTOKENFLOWSTART for value: PAYMENT_TOKEN_FLOW_START
            /// </summary>
            [EnumMember(Value = "PAYMENT_TOKEN_FLOW_START")]
            PAYMENTTOKENFLOWSTART = 14,

            /// <summary>
            /// Enum UPDATESESSION for value: UPDATE_SESSION
            /// </summary>
            ...
            /// <summary>
            /// Enum SETBILLINGADDRESS for value: SET_BILLING_ADDRESS
            /// </summary>
            [EnumMember(Value = "SET_BILLING_ADDRESS")]
            SETBILLINGADDRESS = 17,

            /// <summary>
            /// Enum SETDISCOUNTCODES for value: SET_DISCOUNT_CODES
            /// </summary>
            [EnumMember(Value = "SET_DISCOUNT_CODES")]
            SETDISCOUNTCODES = 18,

            /// <summary>
            /// Enum SETSHIPPINGADDRESS for value: SET_SHIPPING_ADDRESS
            /// </summary>
            [EnumMember(Value = "SET_SHIPPING_ADDRESS")]
            SETSHIPPINGADDRESS = 19,

            /// <summary>
            /// Enum SETSHIPPINGOPTION for value: SET_SHIPPING_OPTION
            /// </summary>
            [EnumMember(Value = "SET_SHIPPING_OPTION")]
            SETSHIPPINGOPTION = 20,

            /// <summary>
            /// Enum PUSHNOTIFICATIONSENT for value: PUSH_NOTIFICATION_SENT
            /// </summary>
            [EnumMember(Value = "PUSH_NOTIFICATION_SENT")]
            PUSHNOTIFICATIONSENT = 21,

            /// <summary>
            /// Enum SECRETCONFIRMATIONCODESENT for value: SECRET_CONFIRMATION_CODE_SENT
            /// </summary>
            [EnumMember(Value = "SECRET_CONFIRMATION_CODE_SENT")]
            SECRETCONFIRMATIONCODESENT = 22,

            /// <summary>
            /// Enum SETMYDINTERO for value: SET_MY_DINTERO
            /// </summary>
            [EnumMember(Value = "SET_MY_DINTERO")]
            SETMYDINTERO = 23
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionMetaEvents" /> class.
        /// </summary>
        /// <param name="createdAt">createdAt.</param>
        /// <param name="id">id.</param>
        /// <param name="name">name.</param>
        /// <param name="details">details.</param>
        public SessionMetaEvents(DateTime createdAt = default(DateTime), string id = default(string), NameEnum? name = default(NameEnum?), SessionMetaDetails details = default(SessionMetaDetails))
        {
        ...
        public SessionMetaDetails Details { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SessionMetaEvents {\n");
        ...
        {
            return this.Equals(input as SessionMetaEvents);
        }

        /// <summary>
        /// Returns true if SessionMetaEvents instances are equal
        /// </summary>
        /// <param name="input">Instance of SessionMetaEvents to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SessionMetaEvents input)
        {
            if (input == null)
                return false;
