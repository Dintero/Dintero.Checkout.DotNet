...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// SessionBase
    /// </summary>
    [DataContract(Name = "SessionBase")]
    public partial class SessionBase : IEquatable<SessionBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionBase" /> class.
        /// </summary>
        ...
        public SessionBase(SessionUrls url = default(SessionUrls), SessionCustomer customer = default(SessionCustomer), SessionOrder order = default(SessionOrder), DateTime expiresAt = default(DateTime))
        {
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url is a required property for SessionBase and cannot be null");
            // to ensure "order" is required (not null)
            this.Order = order ?? throw new ArgumentNullException("order is a required property for SessionBase and cannot be null");
        ...
        {
            return this.Equals(input as SessionBase);
        }

        /// <summary>
        /// Returns true if SessionBase instances are equal
        /// </summary>
        /// <param name="input">Instance of SessionBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SessionBase input)
        {
            if (input == null)
                return false;
