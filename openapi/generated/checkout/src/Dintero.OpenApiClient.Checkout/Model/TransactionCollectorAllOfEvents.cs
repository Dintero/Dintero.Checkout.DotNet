...
{
    /// <summary>
    /// TransactionCollectorAllOfEvents
    /// </summary>
    [DataContract(Name = "TransactionCollector_allOf_events")]
    public partial class TransactionCollectorAllOfEvents : IEquatable<TransactionCollectorAllOfEvents>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionCollectorAllOfEvents" /> class.
        /// </summary>
        /// <param name="metadata">metadata.</param>
        public TransactionCollectorAllOfEvents(TransactionCollectorAllOfMetadata metadata = default(TransactionCollectorAllOfMetadata))
        {
        ...
        public TransactionCollectorAllOfMetadata Metadata { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionCollectorAllOfEvents {\n");
        ...
        {
            return this.Equals(input as TransactionCollectorAllOfEvents);
        }

        /// <summary>
        /// Returns true if TransactionCollectorAllOfEvents instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionCollectorAllOfEvents to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionCollectorAllOfEvents input)
        {
            if (input == null)
                return false;
