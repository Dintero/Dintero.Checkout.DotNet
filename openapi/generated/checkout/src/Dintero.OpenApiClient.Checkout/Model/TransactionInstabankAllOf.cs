...
{
    /// <summary>
    /// TransactionInstabankAllOf
    /// </summary>
    [DataContract(Name = "TransactionInstabank_allOf")]
    public partial class TransactionInstabankAllOf : IEquatable<TransactionInstabankAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionInstabankAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionInstabankAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionInstabankAllOf" /> class.
        /// </summary>
        ...
        public TransactionInstabankAllOf(PaymentProductTypeEnum paymentProductType = default(PaymentProductTypeEnum), List<TransactionInstabankAllOfEvents> events = default(List<TransactionInstabankAllOfEvents>), TransactionInstabankAllOfMetadata1 metadata = default(TransactionInstabankAllOfMetadata1))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionInstabankAllOf {\n");
        ...
        {
            return this.Equals(input as TransactionInstabankAllOf);
        }

        /// <summary>
        /// Returns true if TransactionInstabankAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionInstabankAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionInstabankAllOf input)
        {
            if (input == null)
                return false;
