...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// VippsGwWrite
    /// </summary>
    [DataContract(Name = "VippsGwWrite")]
    public partial class VippsGwWrite : IEquatable<VippsGwWrite>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VippsGwWrite" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VippsGwWrite() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VippsGwWrite" /> class.
        /// </summary>
        ...
        public VippsGwWrite(string url = default(string), string clientId = default(string), string merchantSerialNumber = default(string), string clientSecret = default(string), string ocpApimSubscriptionKeyAccessToken = default(string), string ocpApimSubscriptionKeyEcom = default(string))
        {
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url is a required property for VippsGwWrite and cannot be null");
            // to ensure "clientId" is required (not null)
            this.ClientId = clientId ?? throw new ArgumentNullException("clientId is a required property for VippsGwWrite and cannot be null");
            // to ensure "merchantSerialNumber" is required (not null)
            this.MerchantSerialNumber = merchantSerialNumber ?? throw new ArgumentNullException("merchantSerialNumber is a required property for VippsGwWrite and cannot be null");
            // to ensure "clientSecret" is required (not null)
            this.ClientSecret = clientSecret ?? throw new ArgumentNullException("clientSecret is a required property for VippsGwWrite and cannot be null");
            // to ensure "ocpApimSubscriptionKeyAccessToken" is required (not null)
            this.OcpApimSubscriptionKeyAccessToken = ocpApimSubscriptionKeyAccessToken ?? throw new ArgumentNullException("ocpApimSubscriptionKeyAccessToken is a required property for VippsGwWrite and cannot be null");
            // to ensure "ocpApimSubscriptionKeyEcom" is required (not null)
            this.OcpApimSubscriptionKeyEcom = ocpApimSubscriptionKeyEcom ?? throw new ArgumentNullException("ocpApimSubscriptionKeyEcom is a required property for VippsGwWrite and cannot be null");
        }
        ...
        {
            return this.Equals(input as VippsGwWrite);
        }

        /// <summary>
        /// Returns true if VippsGwWrite instances are equal
        /// </summary>
        /// <param name="input">Instance of VippsGwWrite to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VippsGwWrite input)
        {
            if (input == null)
                return false;
