...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// InstabankGwWrite
    /// </summary>
    [DataContract(Name = "InstabankGwWrite")]
    public partial class InstabankGwWrite : IEquatable<InstabankGwWrite>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankGwWrite" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstabankGwWrite() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankGwWrite" /> class.
        /// </summary>
        /// <param name="organizationNumber">Company identification number (required).</param>
        /// <param name="paymentProductCodes">paymentProductCodes (required).</param>
        public InstabankGwWrite(string organizationNumber = default(string), InstabankGwReadPaymentProductCodes paymentProductCodes = default(InstabankGwReadPaymentProductCodes))
        {
            // to ensure "organizationNumber" is required (not null)
            this.OrganizationNumber = organizationNumber ?? throw new ArgumentNullException("organizationNumber is a required property for InstabankGwWrite and cannot be null");
            // to ensure "paymentProductCodes" is required (not null)
            this.PaymentProductCodes = paymentProductCodes ?? throw new ArgumentNullException("paymentProductCodes is a required property for InstabankGwWrite and cannot be null");
        }
        ...
        /// </summary>
        /// <value>Company identification number</value>
        [DataMember(Name = "organization_number", IsRequired = true, EmitDefaultValue = false)]
        public string OrganizationNumber { get; set; }

        /// <summary>
        /// Gets or Sets PaymentProductCodes
        /// </summary>
        [DataMember(Name = "payment_product_codes", IsRequired = true, EmitDefaultValue = false)]
        public InstabankGwReadPaymentProductCodes PaymentProductCodes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstabankGwWrite {\n");
            sb.Append("  CreatedAt: ").Append(CreatedAt).Append("\n");
            sb.Append("  CreatedBy: ").Append(CreatedBy).Append("\n");
            sb.Append("  Url: ").Append(Url).Append("\n");
            sb.Append("  OrganizationNumber: ").Append(OrganizationNumber).Append("\n");
            sb.Append("  PaymentProductCodes: ").Append(PaymentProductCodes).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as InstabankGwWrite);
        }

        /// <summary>
        /// Returns true if InstabankGwWrite instances are equal
        /// </summary>
        /// <param name="input">Instance of InstabankGwWrite to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstabankGwWrite input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PaymentProductCodes == input.PaymentProductCodes ||
                    (this.PaymentProductCodes != null &&
                    this.PaymentProductCodes.Equals(input.PaymentProductCodes))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PaymentProductCodes != null)
                    hashCode = hashCode * 59 + this.PaymentProductCodes.GetHashCode();
                return hashCode;
            }
        }
