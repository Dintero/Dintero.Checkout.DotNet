...
{
    /// <summary>
    /// BamboraConfigurationMobilepay
    /// </summary>
    [DataContract(Name = "BamboraConfiguration_mobilepay")]
    public partial class BamboraConfigurationMobilepay : IEquatable<BamboraConfigurationMobilepay>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraConfigurationMobilepay" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BamboraConfigurationMobilepay() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraConfigurationMobilepay" /> class.
        /// </summary>
        /// <param name="type">Denotes what kind of config parameter this is.</param>
        /// <param name="enabled">enable MobilePay Payment (required).</param>
        /// <param name="payability">payability.</param>
        public BamboraConfigurationMobilepay(TypeEnum? type = default(TypeEnum?), bool enabled = default(bool), SessionPayability? payability = default(SessionPayability?))
        {
        ...
        /// </summary>
        /// <value>enable MobilePay Payment</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BamboraConfigurationMobilepay {\n");
        ...
        {
            return this.Equals(input as BamboraConfigurationMobilepay);
        }

        /// <summary>
        /// Returns true if BamboraConfigurationMobilepay instances are equal
        /// </summary>
        /// <param name="input">Instance of BamboraConfigurationMobilepay to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BamboraConfigurationMobilepay input)
        {
            if (input == null)
                return false;
