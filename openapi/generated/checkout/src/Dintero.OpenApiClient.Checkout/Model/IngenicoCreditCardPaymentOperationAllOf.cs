...
{
    /// <summary>
    /// IngenicoCreditCardPaymentOperationAllOf
    /// </summary>
    [DataContract(Name = "IngenicoCreditCardPaymentOperation_allOf")]
    public partial class IngenicoCreditCardPaymentOperationAllOf : IEquatable<IngenicoCreditCardPaymentOperationAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoCreditCardPaymentOperationAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IngenicoCreditCardPaymentOperationAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoCreditCardPaymentOperationAllOf" /> class.
        /// </summary>
        /// <param name="href">Contains the URI to initiate a payment. .</param>
        /// <param name="session">session (required).</param>
        public IngenicoCreditCardPaymentOperationAllOf(string href = default(string), IngenicoCreditCardPaymentOperationAllOfSession session = default(IngenicoCreditCardPaymentOperationAllOfSession))
        {
            // to ensure "session" is required (not null)
            this.Session = session ?? throw new ArgumentNullException("session is a required property for IngenicoCreditCardPaymentOperationAllOf and cannot be null");
            this.Href = href;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IngenicoCreditCardPaymentOperationAllOf {\n");
        ...
        {
            return this.Equals(input as IngenicoCreditCardPaymentOperationAllOf);
        }

        /// <summary>
        /// Returns true if IngenicoCreditCardPaymentOperationAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of IngenicoCreditCardPaymentOperationAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IngenicoCreditCardPaymentOperationAllOf input)
        {
            if (input == null)
                return false;
