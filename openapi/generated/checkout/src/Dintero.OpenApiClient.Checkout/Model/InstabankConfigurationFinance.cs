...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// finance payment
    /// </summary>
    [DataContract(Name = "InstabankConfiguration_finance")]
    public partial class InstabankConfigurationFinance : IEquatable<InstabankConfigurationFinance>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankConfigurationFinance" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstabankConfigurationFinance() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankConfigurationFinance" /> class.
        /// </summary>
        /// <param name="enabled">enable finance payment (required).</param>
        /// <param name="payability">payability.</param>
        /// <param name="product">product.</param>
        public InstabankConfigurationFinance(bool enabled = default(bool), SessionPayability? payability = default(SessionPayability?), Object product = default(Object))
        {
        ...
        /// </summary>
        /// <value>enable finance payment</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstabankConfigurationFinance {\n");
        ...
        {
            return this.Equals(input as InstabankConfigurationFinance);
        }

        /// <summary>
        /// Returns true if InstabankConfigurationFinance instances are equal
        /// </summary>
        /// <param name="input">Instance of InstabankConfigurationFinance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstabankConfigurationFinance input)
        {
            if (input == null)
                return false;
