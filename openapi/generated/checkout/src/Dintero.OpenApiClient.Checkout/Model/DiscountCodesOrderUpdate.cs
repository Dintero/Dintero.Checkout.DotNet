...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DiscountCodesOrderUpdate")]
    public partial class DiscountCodesOrderUpdate : IEquatable<DiscountCodesOrderUpdate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DiscountCodesOrderUpdate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DiscountCodesOrderUpdate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DiscountCodesOrderUpdate" /> class.
        /// </summary>
        ...
        /// <param name="items">Items with discount lines.   - The list must include all items in the session order  - **Required** if the session order has any items. .</param>
        public DiscountCodesOrderUpdate(List<string> discountCodes = default(List<string>), decimal amount = default(decimal), List<OrderItem> items = default(List<OrderItem>))
        {
            this.Amount = amount;
        ...
        /// <summary>
        /// Items with discount lines.   - The list must include all items in the session order  - **Required** if the session order has any items. 
        /// </summary>
        /// <value>Items with discount lines.   - The list must include all items in the session order  - **Required** if the session order has any items. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DiscountCodesOrderUpdate {\n");
        ...
        {
            return this.Equals(input as DiscountCodesOrderUpdate);
        }

        /// <summary>
        /// Returns true if DiscountCodesOrderUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of DiscountCodesOrderUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DiscountCodesOrderUpdate input)
        {
            if (input == null)
                return false;
