...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// SessionMetaDetails
    /// </summary>
    [DataContract(Name = "SessionMeta_details")]
    public partial class SessionMetaDetails : IEquatable<SessionMetaDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionMetaDetails" /> class.
        /// </summary>
        /// <param name="error">error.</param>
        /// <param name="paymentProductType">paymentProductType.</param>
        ...
        /// <param name="collectorinstallmentproducts">collectorinstallmentproducts.</param>
        /// <param name="myDintero">myDintero.</param>
        public SessionMetaDetails(string error = default(string), string paymentProductType = default(string), int amount = default(int), ShippingOption shippingOption = default(ShippingOption), OrderAddress shippingAddress = default(OrderAddress), SessionMetaDetailsIngenico ingenico = default(SessionMetaDetailsIngenico), SessionMetaDetailsBambora bambora = default(SessionMetaDetailsBambora), string payexpaymentid = default(string), List<CollectorProduct> collectorinstallmentproducts = default(List<CollectorProduct>), MyDinteroUserCreation myDintero = default(MyDinteroUserCreation))
        {
            this.Error = error;
            ...
            this.Collectorinstallmentproducts = collectorinstallmentproducts;
            this.MyDintero = myDintero;
        }
        ...
        /// <summary>
        /// Gets or Sets PaymentProductType
        /// </summary>
        [DataMember(Name = "payment_product_type", EmitDefaultValue = false)]
        ...
        public SessionMetaDetailsIngenico Ingenico { get; set; }

        /// <summary>
        /// Gets or Sets Bambora
        /// </summary>
        [DataMember(Name = "bambora", EmitDefaultValue = false)]
        public SessionMetaDetailsBambora Bambora { get; set; }
        ...
        /// <summary>
        /// Gets or Sets Collectorinstallmentproducts
        /// </summary>
        [DataMember(Name = "collector:installment:products", EmitDefaultValue = false)]
        public List<CollectorProduct> Collectorinstallmentproducts { get; set; }

        /// <summary>
        /// Gets or Sets MyDintero
        /// </summary>
        [DataMember(Name = "my_dintero", EmitDefaultValue = false)]
        public MyDinteroUserCreation MyDintero { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SessionMetaDetails {\n");
            ...
            sb.Append("  Collectorinstallmentproducts: ").Append(Collectorinstallmentproducts).Append("\n");
            sb.Append("  MyDintero: ").Append(MyDintero).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as SessionMetaDetails);
        }

        /// <summary>
        /// Returns true if SessionMetaDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of SessionMetaDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SessionMetaDetails input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.Collectorinstallmentproducts == input.Collectorinstallmentproducts ||
                    this.Collectorinstallmentproducts != null &&
                    input.Collectorinstallmentproducts != null &&
                    this.Collectorinstallmentproducts.SequenceEqual(input.Collectorinstallmentproducts)
                ) && 
                (
                    this.MyDintero == input.MyDintero ||
                    (this.MyDintero != null &&
                    this.MyDintero.Equals(input.MyDintero))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Collectorinstallmentproducts != null)
                    hashCode = hashCode * 59 + this.Collectorinstallmentproducts.GetHashCode();
                if (this.MyDintero != null)
                    hashCode = hashCode * 59 + this.MyDintero.GetHashCode();
                return hashCode;
            }
        }
