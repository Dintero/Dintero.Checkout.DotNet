...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// MitSessionBase
    /// </summary>
    [DataContract(Name = "MitSessionBase")]
    public partial class MitSessionBase : IEquatable<MitSessionBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MitSessionBase" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MitSessionBase() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MitSessionBase" /> class.
        /// </summary>
        ...
        public MitSessionBase(MitSessionBaseUrl url = default(MitSessionBaseUrl), SessionCustomer customer = default(SessionCustomer), SessionOrder order = default(SessionOrder), DateTime expiresAt = default(DateTime))
        {
            // to ensure "order" is required (not null)
            this.Order = order ?? throw new ArgumentNullException("order is a required property for MitSessionBase and cannot be null");
            this.Url = url;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MitSessionBase {\n");
        ...
        {
            return this.Equals(input as MitSessionBase);
        }

        /// <summary>
        /// Returns true if MitSessionBase instances are equal
        /// </summary>
        /// <param name="input">Instance of MitSessionBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MitSessionBase input)
        {
            if (input == null)
                return false;
