...
{
    /// <summary>
    /// CollectorInvoiceB2BPaymentAllOf
    /// </summary>
    [DataContract(Name = "CollectorInvoiceB2BPayment_allOf")]
    public partial class CollectorInvoiceB2BPaymentAllOf : IEquatable<CollectorInvoiceB2BPaymentAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorInvoiceB2BPaymentAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorInvoiceB2BPaymentAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorInvoiceB2BPaymentAllOf" /> class.
        /// </summary>
        ...
        public CollectorInvoiceB2BPaymentAllOf(CollectorB2BAddress shippingAddress = default(CollectorB2BAddress), CollectorB2BAddress billingAddress = default(CollectorB2BAddress), bool rememberMe = default(bool))
        {
            // to ensure "shippingAddress" is required (not null)
            this.ShippingAddress = shippingAddress ?? throw new ArgumentNullException("shippingAddress is a required property for CollectorInvoiceB2BPaymentAllOf and cannot be null");
            // to ensure "billingAddress" is required (not null)
            this.BillingAddress = billingAddress ?? throw new ArgumentNullException("billingAddress is a required property for CollectorInvoiceB2BPaymentAllOf and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorInvoiceB2BPaymentAllOf {\n");
        ...
        {
            return this.Equals(input as CollectorInvoiceB2BPaymentAllOf);
        }

        /// <summary>
        /// Returns true if CollectorInvoiceB2BPaymentAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorInvoiceB2BPaymentAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorInvoiceB2BPaymentAllOf input)
        {
            if (input == null)
                return false;
