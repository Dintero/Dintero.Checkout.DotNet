...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProfileConfiguration")]
    public partial class ProfileConfiguration : IEquatable<ProfileConfiguration>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="profileId">The profile  you have defined for the profile. (must not have trailing or leading spaces) An auto-generated profile_id will be created if no profile_id is provided. .</param>
        ...
        public ProfileConfiguration(ProfileConfigurationUrl url = default(ProfileConfigurationUrl), string profileId = default(string), CheckoutConfigWriteConfigurationMerchant merchant = default(CheckoutConfigWriteConfigurationMerchant), PaymentConfiguration configuration = default(PaymentConfiguration), string description = default(string))
        {
            // to ensure "configuration" is required (not null)
            this.Configuration = configuration ?? throw new ArgumentNullException("configuration is a required property for ProfileConfiguration and cannot be null");
            this.Url = url;
        ...
        public ProfileConfigurationUrl Url { get; set; }

        /// <summary>
        /// The profile  you have defined for the profile. (must not have trailing or leading spaces) An auto-generated profile_id will be created if no profile_id is provided. 
        /// </summary>
        /// <value>The profile  you have defined for the profile. (must not have trailing or leading spaces) An auto-generated profile_id will be created if no profile_id is provided. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProfileConfiguration {\n");
        ...
        {
            return this.Equals(input as ProfileConfiguration);
        }

        /// <summary>
        /// Returns true if ProfileConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of ProfileConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProfileConfiguration input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if(this.ProfileId != null && this.ProfileId.Length > 255)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ProfileId, length must be less than 255.", new [] { "ProfileId" });
            }
