...
{
    /// <summary>
    /// TransactionInstabankAllOfEvents
    /// </summary>
    [DataContract(Name = "TransactionInstabank_allOf_events")]
    public partial class TransactionInstabankAllOfEvents : IEquatable<TransactionInstabankAllOfEvents>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Returns false as TransactionStatus should not be serialized given that it's read-only.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionInstabankAllOfEvents" /> class.
        /// </summary>
        /// <param name="metadata">metadata.</param>
        public TransactionInstabankAllOfEvents(TransactionInstabankAllOfMetadata metadata = default(TransactionInstabankAllOfMetadata))
        {
        ...
        public TransactionInstabankAllOfMetadata Metadata { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionInstabankAllOfEvents {\n");
        ...
        {
            return this.Equals(input as TransactionInstabankAllOfEvents);
        }

        /// <summary>
        /// Returns true if TransactionInstabankAllOfEvents instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionInstabankAllOfEvents to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionInstabankAllOfEvents input)
        {
            if (input == null)
                return false;
