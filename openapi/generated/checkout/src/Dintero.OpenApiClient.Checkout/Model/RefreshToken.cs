...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "refresh_token")]
    [JsonConverter(typeof(JsonSubtypes), "GrantType")]
    public partial class RefreshToken : AuthToken, IEquatable<RefreshToken>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="grantType">grantType (required) (default to &quot;refresh_token&quot;).</param>
        public RefreshToken(string refreshToken = default(string), string grantType = "refresh_token") : base(grantType)
        {
            // to ensure "refreshToken" is required (not null)
            this._RefreshToken = refreshToken ?? throw new ArgumentNullException("refreshToken is a required property for RefreshToken and cannot be null");
        }
