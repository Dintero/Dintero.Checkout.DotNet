...
{
    /// <summary>
    /// IngenicoWebhookEventTokenCardCustomerBillingAddress
    /// </summary>
    [DataContract(Name = "IngenicoWebhookEvent_token_card_customer_billingAddress")]
    public partial class IngenicoWebhookEventTokenCardCustomerBillingAddress : IEquatable<IngenicoWebhookEventTokenCardCustomerBillingAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoWebhookEventTokenCardCustomerBillingAddress" /> class.
        /// </summary>
        ...
        public IngenicoWebhookEventTokenCardCustomerBillingAddress(string additionalInfo = default(string), string city = default(string), string countryCode = default(string), string houseNumber = default(string), string state = default(string), string stateCode = default(string), string street = default(string), string zip = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IngenicoWebhookEventTokenCardCustomerBillingAddress {\n");
        ...
        {
            return this.Equals(input as IngenicoWebhookEventTokenCardCustomerBillingAddress);
        }

        /// <summary>
        /// Returns true if IngenicoWebhookEventTokenCardCustomerBillingAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of IngenicoWebhookEventTokenCardCustomerBillingAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IngenicoWebhookEventTokenCardCustomerBillingAddress input)
        {
            if (input == null)
                return false;
