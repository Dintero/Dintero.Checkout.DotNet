...
{
    /// <summary>
    /// TransactionBamboraAllOfMetadata
    /// </summary>
    [DataContract(Name = "TransactionBambora_allOf_metadata")]
    public partial class TransactionBamboraAllOfMetadata : IEquatable<TransactionBamboraAllOfMetadata>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionBamboraAllOfMetadata" /> class.
        /// </summary>
        /// <param name="bamboratransactionstatus">bamboratransactionstatus.</param>
        /// <param name="bamboratransactionoperationid">bamboratransactionoperationid.</param>
        /// <param name="bamborametaactionsource">bamborametaactionsource.</param>
        /// <param name="bamborametaactioncode">bamborametaactioncode.</param>
        /// <param name="bamborametaactiontype">bamborametaactiontype.</param>
        public TransactionBamboraAllOfMetadata(string bamboratransactionstatus = default(string), string bamboratransactionoperationid = default(string), string bamborametaactionsource = default(string), string bamborametaactioncode = default(string), string bamborametaactiontype = default(string))
        {
            this.Bamboratransactionstatus = bamboratransactionstatus;
            this.Bamboratransactionoperationid = bamboratransactionoperationid;
            this.Bamborametaactionsource = bamborametaactionsource;
            this.Bamborametaactioncode = bamborametaactioncode;
            this.Bamborametaactiontype = bamborametaactiontype;
        }

        /// <summary>
        /// Gets or Sets Bamboratransactionstatus
        /// </summary>
        [DataMember(Name = "bambora:transaction:status", EmitDefaultValue = false)]
        public string Bamboratransactionstatus { get; set; }

        /// <summary>
        /// Gets or Sets Bamboratransactionoperationid
        /// </summary>
        [DataMember(Name = "bambora:transactionoperation:id", EmitDefaultValue = false)]
        public string Bamboratransactionoperationid { get; set; }

        /// <summary>
        /// Gets or Sets Bamborametaactionsource
        /// </summary>
        [DataMember(Name = "bambora:meta:action:source", EmitDefaultValue = false)]
        public string Bamborametaactionsource { get; set; }

        /// <summary>
        /// Gets or Sets Bamborametaactioncode
        /// </summary>
        [DataMember(Name = "bambora:meta:action:code", EmitDefaultValue = false)]
        public string Bamborametaactioncode { get; set; }

        /// <summary>
        /// Gets or Sets Bamborametaactiontype
        /// </summary>
        [DataMember(Name = "bambora:meta:action:type", EmitDefaultValue = false)]
        public string Bamborametaactiontype { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionBamboraAllOfMetadata {\n");
            sb.Append("  Bamboratransactionstatus: ").Append(Bamboratransactionstatus).Append("\n");
            sb.Append("  Bamboratransactionoperationid: ").Append(Bamboratransactionoperationid).Append("\n");
            sb.Append("  Bamborametaactionsource: ").Append(Bamborametaactionsource).Append("\n");
            sb.Append("  Bamborametaactioncode: ").Append(Bamborametaactioncode).Append("\n");
            sb.Append("  Bamborametaactiontype: ").Append(Bamborametaactiontype).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TransactionBamboraAllOfMetadata);
        }

        /// <summary>
        /// Returns true if TransactionBamboraAllOfMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionBamboraAllOfMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionBamboraAllOfMetadata input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.Bamboratransactionstatus == input.Bamboratransactionstatus ||
                    (this.Bamboratransactionstatus != null &&
                    this.Bamboratransactionstatus.Equals(input.Bamboratransactionstatus))
                ) && 
                (
                    this.Bamboratransactionoperationid == input.Bamboratransactionoperationid ||
                    (this.Bamboratransactionoperationid != null &&
                    this.Bamboratransactionoperationid.Equals(input.Bamboratransactionoperationid))
                ) && 
                (
                    this.Bamborametaactionsource == input.Bamborametaactionsource ||
                    (this.Bamborametaactionsource != null &&
                    this.Bamborametaactionsource.Equals(input.Bamborametaactionsource))
                ) && 
                (
                    this.Bamborametaactioncode == input.Bamborametaactioncode ||
                    (this.Bamborametaactioncode != null &&
                    this.Bamborametaactioncode.Equals(input.Bamborametaactioncode))
                ) && 
                (
                    this.Bamborametaactiontype == input.Bamborametaactiontype ||
                    (this.Bamborametaactiontype != null &&
                    this.Bamborametaactiontype.Equals(input.Bamborametaactiontype))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.Bamboratransactionstatus != null)
                    hashCode = hashCode * 59 + this.Bamboratransactionstatus.GetHashCode();
                if (this.Bamboratransactionoperationid != null)
                    hashCode = hashCode * 59 + this.Bamboratransactionoperationid.GetHashCode();
                if (this.Bamborametaactionsource != null)
                    hashCode = hashCode * 59 + this.Bamborametaactionsource.GetHashCode();
                if (this.Bamborametaactioncode != null)
                    hashCode = hashCode * 59 + this.Bamborametaactioncode.GetHashCode();
                if (this.Bamborametaactiontype != null)
                    hashCode = hashCode * 59 + this.Bamborametaactiontype.GetHashCode();
                return hashCode;
            }
        }
