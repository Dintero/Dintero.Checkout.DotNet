...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class OrderAddress : IEquatable<OrderAddress>, IValidatableObject
    {
        ...
        /// <param name="addressLine">Gaustadalleen 21.</param>
        /// <param name="addressLine2">PB 123.</param>
        /// <param name="coAddress">coAddress.</param>
        /// <param name="businessName">Name of the company.</param>
        /// <param name="postalCode">The zip code / postal code of the address..</param>
        /// <param name="postalPlace">The name of the postal code.</param>
        ...
        /// <param name="email">The email address of a person or an organization .</param>
        /// <param name="latitude">latitude.</param>
        /// <param name="longitude">longitude.</param>
        /// <param name="comment">Comment about the address .</param>
        /// <param name="organizationNumber">The organization number of the customer. .</param>
        ...
        public OrderAddress(string firstName = default(string), string lastName = default(string), string addressLine = default(string), string addressLine2 = default(string), string coAddress = default(string), string businessName = default(string), string postalCode = default(string), string postalPlace = default(string), string country = default(string), string phoneNumber = default(string), string email = default(string), decimal latitude = default(decimal), decimal longitude = default(decimal), string comment = default(string), string organizationNumber = default(string), string customerReference = default(string), string costCenter = default(string))
        {
        ...
        [DataMember(Name = "postal_place", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>The email address of a person or an organization </value>
        ...
        /// </summary>
        /// <value>Comment about the address </value>
        ...
        /// </summary>
        /// <value>The organization number of the customer. </value>
