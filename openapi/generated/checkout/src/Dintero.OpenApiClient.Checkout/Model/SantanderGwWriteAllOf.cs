...
{
    /// <summary>
    /// SantanderGwWriteAllOf
    /// </summary>
    [DataContract(Name = "SantanderGwWrite_allOf")]
    public partial class SantanderGwWriteAllOf : IEquatable<SantanderGwWriteAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SantanderGwWriteAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SantanderGwWriteAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SantanderGwWriteAllOf" /> class.
        /// </summary>
        ...
        public SantanderGwWriteAllOf(string storeToken = default(string), string cert = default(string), string certPassword = default(string), string customersClientId = default(string), string customersClientSecret = default(string), string customersClientAudience = default(string))
        {
            // to ensure "storeToken" is required (not null)
            this.StoreToken = storeToken ?? throw new ArgumentNullException("storeToken is a required property for SantanderGwWriteAllOf and cannot be null");
            // to ensure "customersClientId" is required (not null)
            this.CustomersClientId = customersClientId ?? throw new ArgumentNullException("customersClientId is a required property for SantanderGwWriteAllOf and cannot be null");
            // to ensure "customersClientSecret" is required (not null)
            this.CustomersClientSecret = customersClientSecret ?? throw new ArgumentNullException("customersClientSecret is a required property for SantanderGwWriteAllOf and cannot be null");
            // to ensure "customersClientAudience" is required (not null)
            this.CustomersClientAudience = customersClientAudience ?? throw new ArgumentNullException("customersClientAudience is a required property for SantanderGwWriteAllOf and cannot be null");
            this.Cert = cert;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SantanderGwWriteAllOf {\n");
        ...
        {
            return this.Equals(input as SantanderGwWriteAllOf);
        }

        /// <summary>
        /// Returns true if SantanderGwWriteAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SantanderGwWriteAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SantanderGwWriteAllOf input)
        {
            if (input == null)
                return false;
