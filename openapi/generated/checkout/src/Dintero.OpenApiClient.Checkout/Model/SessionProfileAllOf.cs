...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// SessionProfileAllOf
    /// </summary>
    [DataContract(Name = "SessionProfile_allOf")]
    public partial class SessionProfileAllOf : IEquatable<SessionProfileAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionProfileAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SessionProfileAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionProfileAllOf" /> class.
        /// </summary>
        ...
        public SessionProfileAllOf(PaymentConfiguration configuration = default(PaymentConfiguration), string profileId = default(string))
        {
            // to ensure "profileId" is required (not null)
            this.ProfileId = profileId ?? throw new ArgumentNullException("profileId is a required property for SessionProfileAllOf and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SessionProfileAllOf {\n");
        ...
        {
            return this.Equals(input as SessionProfileAllOf);
        }

        /// <summary>
        /// Returns true if SessionProfileAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SessionProfileAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SessionProfileAllOf input)
        {
            if (input == null)
                return false;
