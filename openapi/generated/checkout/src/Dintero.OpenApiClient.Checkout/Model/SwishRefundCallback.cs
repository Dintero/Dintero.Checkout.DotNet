...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SwishRefundCallback")]
    public partial class SwishRefundCallback : IEquatable<SwishRefundCallback>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SwishRefundCallback" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SwishRefundCallback() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SwishRefundCallback" /> class.
        /// </summary>
        /// <param name="id">Refund id  (required).</param>
        /// <param name="originalPaymentReference">Used to identify the payment (required).</param>
        /// <param name="status">status (required).</param>
        public SwishRefundCallback(string id = default(string), string originalPaymentReference = default(string), StatusEnum status = default(StatusEnum))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for SwishRefundCallback and cannot be null");
            // to ensure "originalPaymentReference" is required (not null)
            this.OriginalPaymentReference = originalPaymentReference ?? throw new ArgumentNullException("originalPaymentReference is a required property for SwishRefundCallback and cannot be null");
            this.Status = status;
        }
        ...
        /// </summary>
        /// <value>Used to identify the payment</value>
        [DataMember(Name = "originalPaymentReference", IsRequired = true, EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SwishRefundCallback {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  OriginalPaymentReference: ").Append(OriginalPaymentReference).Append("\n");
        ...
        {
            return this.Equals(input as SwishRefundCallback);
        }

        /// <summary>
        /// Returns true if SwishRefundCallback instances are equal
        /// </summary>
        /// <param name="input">Instance of SwishRefundCallback to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SwishRefundCallback input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.OriginalPaymentReference == input.OriginalPaymentReference ||
                    (this.OriginalPaymentReference != null &&
                    this.OriginalPaymentReference.Equals(input.OriginalPaymentReference))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OriginalPaymentReference != null)
                    hashCode = hashCode * 59 + this.OriginalPaymentReference.GetHashCode();
