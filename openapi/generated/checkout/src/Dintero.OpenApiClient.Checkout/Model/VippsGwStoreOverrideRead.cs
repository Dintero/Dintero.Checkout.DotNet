...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VippsGwStoreOverrideRead")]
    public partial class VippsGwStoreOverrideRead : IEquatable<VippsGwStoreOverrideRead>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VippsGwStoreOverrideRead" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VippsGwStoreOverrideRead() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VippsGwStoreOverrideRead" /> class.
        /// </summary>
        ...
        public VippsGwStoreOverrideRead(string clientId = default(string), string merchantSerialNumber = default(string), string ocpApimSubscriptionKeyAccessToken = default(string), string ocpApimSubscriptionKeyEcom = default(string))
        {
            // to ensure "clientId" is required (not null)
            this.ClientId = clientId ?? throw new ArgumentNullException("clientId is a required property for VippsGwStoreOverrideRead and cannot be null");
            // to ensure "merchantSerialNumber" is required (not null)
            this.MerchantSerialNumber = merchantSerialNumber ?? throw new ArgumentNullException("merchantSerialNumber is a required property for VippsGwStoreOverrideRead and cannot be null");
            // to ensure "ocpApimSubscriptionKeyAccessToken" is required (not null)
            this.OcpApimSubscriptionKeyAccessToken = ocpApimSubscriptionKeyAccessToken ?? throw new ArgumentNullException("ocpApimSubscriptionKeyAccessToken is a required property for VippsGwStoreOverrideRead and cannot be null");
            // to ensure "ocpApimSubscriptionKeyEcom" is required (not null)
            this.OcpApimSubscriptionKeyEcom = ocpApimSubscriptionKeyEcom ?? throw new ArgumentNullException("ocpApimSubscriptionKeyEcom is a required property for VippsGwStoreOverrideRead and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VippsGwStoreOverrideRead {\n");
        ...
        {
            return this.Equals(input as VippsGwStoreOverrideRead);
        }

        /// <summary>
        /// Returns true if VippsGwStoreOverrideRead instances are equal
        /// </summary>
        /// <param name="input">Instance of VippsGwStoreOverrideRead to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VippsGwStoreOverrideRead input)
        {
            if (input == null)
                return false;
