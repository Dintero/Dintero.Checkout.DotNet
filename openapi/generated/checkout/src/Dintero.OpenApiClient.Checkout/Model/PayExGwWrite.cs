...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// PayExGwWrite
    /// </summary>
    [DataContract(Name = "PayExGwWrite")]
    public partial class PayExGwWrite : IEquatable<PayExGwWrite>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExGwWrite" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayExGwWrite() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExGwWrite" /> class.
        /// </summary>
        ...
        public PayExGwWrite(string url = default(string), string payeeId = default(string), string subsite = default(string), string token = default(string))
        {
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url is a required property for PayExGwWrite and cannot be null");
            // to ensure "payeeId" is required (not null)
            this.PayeeId = payeeId ?? throw new ArgumentNullException("payeeId is a required property for PayExGwWrite and cannot be null");
            // to ensure "token" is required (not null)
            this.Token = token ?? throw new ArgumentNullException("token is a required property for PayExGwWrite and cannot be null");
        ...
        {
            return this.Equals(input as PayExGwWrite);
        }

        /// <summary>
        /// Returns true if PayExGwWrite instances are equal
        /// </summary>
        /// <param name="input">Instance of PayExGwWrite to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayExGwWrite input)
        {
            if (input == null)
                return false;
