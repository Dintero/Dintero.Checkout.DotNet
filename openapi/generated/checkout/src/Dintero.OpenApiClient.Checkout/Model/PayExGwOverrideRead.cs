...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PayExGwOverrideRead")]
    public partial class PayExGwOverrideRead : IEquatable<PayExGwOverrideRead>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExGwOverrideRead" /> class.
        /// </summary>
        /// <param name="url">The base URIs of the eCommerce APIs:  - **test**: https://api.externalintegration.payex.com - **prod**: https://api.payex.com .</param>
        /// <param name="payeeId">Unique id that identifies the payee for the account (like merchant) set by PayEx. .</param>
        ...
        public PayExGwOverrideRead(string url = default(string), string payeeId = default(string), string subsite = default(string))
        {
            this.Url = url;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PayExGwOverrideRead {\n");
        ...
        {
            return this.Equals(input as PayExGwOverrideRead);
        }

        /// <summary>
        /// Returns true if PayExGwOverrideRead instances are equal
        /// </summary>
        /// <param name="input">Instance of PayExGwOverrideRead to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayExGwOverrideRead input)
        {
            if (input == null)
                return false;
