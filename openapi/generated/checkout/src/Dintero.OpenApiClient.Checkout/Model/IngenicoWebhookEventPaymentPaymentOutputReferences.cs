...
{
    /// <summary>
    /// IngenicoWebhookEventPaymentPaymentOutputReferences
    /// </summary>
    [DataContract(Name = "IngenicoWebhookEvent_payment_paymentOutput_references")]
    public partial class IngenicoWebhookEventPaymentPaymentOutputReferences : IEquatable<IngenicoWebhookEventPaymentPaymentOutputReferences>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoWebhookEventPaymentPaymentOutputReferences" /> class.
        /// </summary>
        ...
        /// <param name="providerReference">providerReference.</param>
        /// <param name="referenceOrigiPayment">referenceOrigiPayment.</param>
        public IngenicoWebhookEventPaymentPaymentOutputReferences(string merchantReference = default(string), string paymentReference = default(string), string merchantOrderId = default(string), string providerId = default(string), string providerReference = default(string), string referenceOrigiPayment = default(string))
        {
            ...
            this.ReferenceOrigiPayment = referenceOrigiPayment;
        }
        ...
        /// </summary>
        [DataMember(Name = "providerReference", EmitDefaultValue = false)]
        public string ProviderReference { get; set; }

        /// <summary>
        /// Gets or Sets ReferenceOrigiPayment
        /// </summary>
        [DataMember(Name = "referenceOrigiPayment", EmitDefaultValue = false)]
        public string ReferenceOrigiPayment { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IngenicoWebhookEventPaymentPaymentOutputReferences {\n");
            ...
            sb.Append("  ReferenceOrigiPayment: ").Append(ReferenceOrigiPayment).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as IngenicoWebhookEventPaymentPaymentOutputReferences);
        }

        /// <summary>
        /// Returns true if IngenicoWebhookEventPaymentPaymentOutputReferences instances are equal
        /// </summary>
        /// <param name="input">Instance of IngenicoWebhookEventPaymentPaymentOutputReferences to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IngenicoWebhookEventPaymentPaymentOutputReferences input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ReferenceOrigiPayment == input.ReferenceOrigiPayment ||
                    (this.ReferenceOrigiPayment != null &&
                    this.ReferenceOrigiPayment.Equals(input.ReferenceOrigiPayment))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ReferenceOrigiPayment != null)
                    hashCode = hashCode * 59 + this.ReferenceOrigiPayment.GetHashCode();
                return hashCode;
            }
        }
