...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class InlineObject14 : IEquatable<InlineObject14>, IValidatableObject
    {
        ...
        public InlineObject14(string storeId = default(string), VippsGwStoreOverrideWrite _override = default(VippsGwStoreOverrideWrite))
        {
            // to ensure "storeId" is required (not null)
            this.StoreId = storeId ?? throw new ArgumentNullException("storeId is a required property for InlineObject14 and cannot be null");
        ...
        public VippsGwStoreOverrideWrite Override { get; set; }
