...
{
    /// <summary>
    /// CollectorGwReadStores
    /// </summary>
    [DataContract(Name = "CollectorGwRead_stores")]
    public partial class CollectorGwReadStores : IEquatable<CollectorGwReadStores>, IValidatableObject
    {
        /// <summary>
        /// The type of customers this store id is used for
        /// </summary>
        /// <value>The type of customers this store id is used for</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorGwReadStores" /> class.
        /// </summary>
        /// <param name="storeId">storeId.</param>
        /// <param name="country">country.</param>
        /// <param name="currency">The three-character ISO-4217 currency. https://en.wikipedia.org/wiki/ISO_4217 .</param>
        /// <param name="segment">The type of customers this store id is used for.</param>
        public CollectorGwReadStores(decimal storeId = default(decimal), string country = default(string), string currency = default(string), SegmentEnum? segment = default(SegmentEnum?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorGwReadStores {\n");
        ...
        {
            return this.Equals(input as CollectorGwReadStores);
        }

        /// <summary>
        /// Returns true if CollectorGwReadStores instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorGwReadStores to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorGwReadStores input)
        {
            if (input == null)
                return false;
