...
{
    /// <summary>
    /// TransactionVippsAllOfMetadata1
    /// </summary>
    [DataContract(Name = "TransactionVipps_allOf_metadata_1")]
    public partial class TransactionVippsAllOfMetadata1 : IEquatable<TransactionVippsAllOfMetadata1>, IValidatableObject
    {
        /// <summary>
        /// Defines VippsmerchantInfoPaymentType
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum VippsmerchantInfoPaymentTypeEnum
        {
            /// <summary>
            /// Enum ECommRegularPayment for value: eComm Regular Payment
            /// </summary>
            [EnumMember(Value = "eComm Regular Payment")]
            ECommRegularPayment = 1

        }


        /// <summary>
        /// Gets or Sets VippsmerchantInfoPaymentType
        /// </summary>
        [DataMember(Name = "vipps:merchantInfo.paymentType", EmitDefaultValue = false)]
        public VippsmerchantInfoPaymentTypeEnum? VippsmerchantInfoPaymentType { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionVippsAllOfMetadata1" /> class.
        /// </summary>
        /// <param name="vippstransactionOrderId">vippstransactionOrderId.</param>
        /// <param name="vippstransactionTransactionText">vippstransactionTransactionText.</param>
        /// <param name="vippsmerchantInfoMerchantSerialNumber">Unique id for this merchant&#39;s sales channel: website, mobile app etc. Short name: MSN. .</param>
        /// <param name="vippsmerchantInfoPaymentType">vippsmerchantInfoPaymentType.</param>
        public TransactionVippsAllOfMetadata1(string vippstransactionOrderId = default(string), string vippstransactionTransactionText = default(string), string vippsmerchantInfoMerchantSerialNumber = default(string), VippsmerchantInfoPaymentTypeEnum? vippsmerchantInfoPaymentType = default(VippsmerchantInfoPaymentTypeEnum?))
        {
            this.VippstransactionOrderId = vippstransactionOrderId;
            this.VippstransactionTransactionText = vippstransactionTransactionText;
            this.VippsmerchantInfoMerchantSerialNumber = vippsmerchantInfoMerchantSerialNumber;
            this.VippsmerchantInfoPaymentType = vippsmerchantInfoPaymentType;
        }

        /// <summary>
        /// Gets or Sets VippstransactionOrderId
        /// </summary>
        [DataMember(Name = "vipps:transaction.orderId", EmitDefaultValue = false)]
        public string VippstransactionOrderId { get; set; }

        /// <summary>
        /// Gets or Sets VippstransactionTransactionText
        /// </summary>
        [DataMember(Name = "vipps:transaction.transactionText", EmitDefaultValue = false)]
        public string VippstransactionTransactionText { get; set; }
        ...
        [DataMember(Name = "vipps:merchantInfo.merchantSerialNumber", EmitDefaultValue = false)]
        public string VippsmerchantInfoMerchantSerialNumber { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionVippsAllOfMetadata1 {\n");
            sb.Append("  VippstransactionOrderId: ").Append(VippstransactionOrderId).Append("\n");
            sb.Append("  VippstransactionTransactionText: ").Append(VippstransactionTransactionText).Append("\n");
            sb.Append("  VippsmerchantInfoMerchantSerialNumber: ").Append(VippsmerchantInfoMerchantSerialNumber).Append("\n");
            sb.Append("  VippsmerchantInfoPaymentType: ").Append(VippsmerchantInfoPaymentType).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TransactionVippsAllOfMetadata1);
        }

        /// <summary>
        /// Returns true if TransactionVippsAllOfMetadata1 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionVippsAllOfMetadata1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionVippsAllOfMetadata1 input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.VippstransactionOrderId == input.VippstransactionOrderId ||
                    (this.VippstransactionOrderId != null &&
                    this.VippstransactionOrderId.Equals(input.VippstransactionOrderId))
                ) && 
                (
                    this.VippstransactionTransactionText == input.VippstransactionTransactionText ||
                    (this.VippstransactionTransactionText != null &&
                    this.VippstransactionTransactionText.Equals(input.VippstransactionTransactionText))
                ) && 
                (
                    this.VippsmerchantInfoMerchantSerialNumber == input.VippsmerchantInfoMerchantSerialNumber ||
                    (this.VippsmerchantInfoMerchantSerialNumber != null &&
                    this.VippsmerchantInfoMerchantSerialNumber.Equals(input.VippsmerchantInfoMerchantSerialNumber))
                ) && 
                (
                    this.VippsmerchantInfoPaymentType == input.VippsmerchantInfoPaymentType ||
                    this.VippsmerchantInfoPaymentType.Equals(input.VippsmerchantInfoPaymentType)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.VippstransactionOrderId != null)
                    hashCode = hashCode * 59 + this.VippstransactionOrderId.GetHashCode();
                if (this.VippstransactionTransactionText != null)
                    hashCode = hashCode * 59 + this.VippstransactionTransactionText.GetHashCode();
                if (this.VippsmerchantInfoMerchantSerialNumber != null)
                    hashCode = hashCode * 59 + this.VippsmerchantInfoMerchantSerialNumber.GetHashCode();
                hashCode = hashCode * 59 + this.VippsmerchantInfoPaymentType.GetHashCode();
                return hashCode;
            }
        }
        ...
        {
            // VippsmerchantInfoMerchantSerialNumber (string) maxLength
            if(this.VippsmerchantInfoMerchantSerialNumber != null && this.VippsmerchantInfoMerchantSerialNumber.Length > 9)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for VippsmerchantInfoMerchantSerialNumber, length must be less than 9.", new [] { "VippsmerchantInfoMerchantSerialNumber" });
            }
