...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IngenicoCreditCardPaymentOperation")]
    [JsonConverter(typeof(JsonSubtypes), "Rel")]
    public partial class IngenicoCreditCardPaymentOperation : PaymentOperation, IEquatable<IngenicoCreditCardPaymentOperation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoCreditCardPaymentOperation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IngenicoCreditCardPaymentOperation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoCreditCardPaymentOperation" /> class.
        /// </summary>
        /// <param name="href">Contains the URI to initiate a payment. .</param>
        ...
        /// <param name="rel">rel (required) (default to &quot;IngenicoCreditCardPaymentOperation&quot;).</param>
        public IngenicoCreditCardPaymentOperation(string href = default(string), IngenicoCreditCardPaymentOperationAllOfSession session = default(IngenicoCreditCardPaymentOperationAllOfSession), ContentTypeEnum? contentType = default(ContentTypeEnum?), MethodEnum? method = default(MethodEnum?), string rel = "IngenicoCreditCardPaymentOperation") : base(contentType, method, rel)
        {
            // to ensure "session" is required (not null)
            this.Session = session ?? throw new ArgumentNullException("session is a required property for IngenicoCreditCardPaymentOperation and cannot be null");
            this.Href = href;
        }
        ...
        /// </summary>
        /// <value>Contains the URI to initiate a payment. </value>
        ...
        public IngenicoCreditCardPaymentOperationAllOfSession Session { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IngenicoCreditCardPaymentOperation {\n");
        ...
        {
            return this.Equals(input as IngenicoCreditCardPaymentOperation);
        }

        /// <summary>
        /// Returns true if IngenicoCreditCardPaymentOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of IngenicoCreditCardPaymentOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IngenicoCreditCardPaymentOperation input)
        {
            if (input == null)
                return false;
