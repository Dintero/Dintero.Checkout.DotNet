...
{
    /// <summary>
    /// IngenicoWebhookEventPaymentStatusOutput
    /// </summary>
    [DataContract(Name = "IngenicoWebhookEvent_payment_statusOutput")]
    public partial class IngenicoWebhookEventPaymentStatusOutput : IEquatable<IngenicoWebhookEventPaymentStatusOutput>, IValidatableObject
    {
        /// <summary>
        /// Defines ThreeDSecureStatus
        /// </summary>
        ...
        public enum ThreeDSecureStatusEnum
        {
            ...
            /// <summary>
            /// Enum INVALIDPARESORNOTCOMPLETED for value: INVALID_PARES_OR_NOT_COMPLETED
            /// </summary>
            [EnumMember(Value = "INVALID_PARES_OR_NOT_COMPLETED")]
            INVALIDPARESORNOTCOMPLETED = 3,
        ...
        /// </summary>
        [DataMember(Name = "threeDSecureStatus", EmitDefaultValue = false)]
        public ThreeDSecureStatusEnum? ThreeDSecureStatus { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoWebhookEventPaymentStatusOutput" /> class.
        /// </summary>
        ...
        /// <param name="statusCodeChangeDateTime">statusCodeChangeDateTime.</param>
        /// <param name="threeDSecureStatus">threeDSecureStatus.</param>
        /// <param name="errors">errors.</param>
        public IngenicoWebhookEventPaymentStatusOutput(bool isAuthorized = default(bool), bool isCancellable = default(bool), bool isRefundable = default(bool), string statusCategory = default(string), int statusCode = default(int), string statusCodeChangeDateTime = default(string), ThreeDSecureStatusEnum? threeDSecureStatus = default(ThreeDSecureStatusEnum?), List<IngenicoWebhookEventPaymentStatusOutputErrors> errors = default(List<IngenicoWebhookEventPaymentStatusOutputErrors>))
        {
        ...
        /// </summary>
        [DataMember(Name = "isCancellable", EmitDefaultValue = true)]
        public bool IsCancellable { get; set; }

        /// <summary>
        /// Gets or Sets IsRefundable
        /// </summary>
        [DataMember(Name = "isRefundable", EmitDefaultValue = true)]
        ...
        /// <summary>
        /// Gets or Sets StatusCodeChangeDateTime
        /// </summary>
        [DataMember(Name = "statusCodeChangeDateTime", EmitDefaultValue = false)]
        ...
        public List<IngenicoWebhookEventPaymentStatusOutputErrors> Errors { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IngenicoWebhookEventPaymentStatusOutput {\n");
            ...
            sb.Append("  StatusCodeChangeDateTime: ").Append(StatusCodeChangeDateTime).Append("\n");
        ...
        {
            return this.Equals(input as IngenicoWebhookEventPaymentStatusOutput);
        }

        /// <summary>
        /// Returns true if IngenicoWebhookEventPaymentStatusOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of IngenicoWebhookEventPaymentStatusOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IngenicoWebhookEventPaymentStatusOutput input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.IsCancellable == input.IsCancellable ||
                    this.IsCancellable.Equals(input.IsCancellable)
                ) && 
                (
                ...
                (
                    this.StatusCategory == input.StatusCategory ||
                    (this.StatusCategory != null &&
                    this.StatusCategory.Equals(input.StatusCategory))
                ) && 
                (
                ...
                (
                    this.StatusCodeChangeDateTime == input.StatusCodeChangeDateTime ||
                    (this.StatusCodeChangeDateTime != null &&
                    this.StatusCodeChangeDateTime.Equals(input.StatusCodeChangeDateTime))
                ) && 
                (
                    this.ThreeDSecureStatus == input.ThreeDSecureStatus ||
                    this.ThreeDSecureStatus.Equals(input.ThreeDSecureStatus)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.IsCancellable.GetHashCode();
                hashCode = hashCode * 59 + this.IsRefundable.GetHashCode();
                if (this.StatusCategory != null)
                    hashCode = hashCode * 59 + this.StatusCategory.GetHashCode();
                hashCode = hashCode * 59 + this.StatusCode.GetHashCode();
                if (this.StatusCodeChangeDateTime != null)
                    hashCode = hashCode * 59 + this.StatusCodeChangeDateTime.GetHashCode();
                hashCode = hashCode * 59 + this.ThreeDSecureStatus.GetHashCode();
                if (this.Errors != null)
