...
{
    /// <summary>
    /// PayExConfigurationCreditcard
    /// </summary>
    [DataContract(Name = "PayExConfiguration_creditcard")]
    public partial class PayExConfigurationCreditcard : IEquatable<PayExConfigurationCreditcard>, IValidatableObject
    {

        /// <summary>
        /// Gets or Sets Payability
        /// </summary>
        [DataMember(Name = "payability", EmitDefaultValue = false)]
        public SessionPayability? Payability { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExConfigurationCreditcard" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayExConfigurationCreditcard() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExConfigurationCreditcard" /> class.
        /// </summary>
        /// <param name="enabled">enable Credit Card Payment (required).</param>
        /// <param name="payability">payability.</param>
        /// <param name="generatePaymentToken">generate payment token to use for future payments  The generated payment token will be made available from the transaction details.  (default to false).</param>
        /// <param name="noCvc">Disable the CVC field for payments where payment token is used. &gt; To use this feature it has to be enabled on the contract with Swedbank Pay. .</param>
        public PayExConfigurationCreditcard(bool enabled = default(bool), SessionPayability? payability = default(SessionPayability?), bool generatePaymentToken = false, bool noCvc = default(bool))
        {
        ...
        /// </summary>
        /// <value>enable Credit Card Payment</value>
        [DataMember(Name = "enabled", IsRequired = true, EmitDefaultValue = true)]
        public bool Enabled { get; set; }

        /// <summary>
        /// generate payment token to use for future payments  The generated payment token will be made available from the transaction details. 
        /// </summary>
        /// <value>generate payment token to use for future payments  The generated payment token will be made available from the transaction details. </value>
        [DataMember(Name = "generate_payment_token", EmitDefaultValue = true)]
        public bool GeneratePaymentToken { get; set; }

        /// <summary>
        /// Disable the CVC field for payments where payment token is used. &gt; To use this feature it has to be enabled on the contract with Swedbank Pay. 
        /// </summary>
        /// <value>Disable the CVC field for payments where payment token is used. &gt; To use this feature it has to be enabled on the contract with Swedbank Pay. </value>
        [DataMember(Name = "no_cvc", EmitDefaultValue = true)]
        public bool NoCvc { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PayExConfigurationCreditcard {\n");
            sb.Append("  Enabled: ").Append(Enabled).Append("\n");
            sb.Append("  Payability: ").Append(Payability).Append("\n");
            sb.Append("  GeneratePaymentToken: ").Append(GeneratePaymentToken).Append("\n");
            sb.Append("  NoCvc: ").Append(NoCvc).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as PayExConfigurationCreditcard);
        }

        /// <summary>
        /// Returns true if PayExConfigurationCreditcard instances are equal
        /// </summary>
        /// <param name="input">Instance of PayExConfigurationCreditcard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayExConfigurationCreditcard input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.Payability == input.Payability ||
                    this.Payability.Equals(input.Payability)
                ) && 
                (
                    this.GeneratePaymentToken == input.GeneratePaymentToken ||
                    this.GeneratePaymentToken.Equals(input.GeneratePaymentToken)
                ) && 
                (
                    this.NoCvc == input.NoCvc ||
                    this.NoCvc.Equals(input.NoCvc)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.Payability.GetHashCode();
                hashCode = hashCode * 59 + this.GeneratePaymentToken.GetHashCode();
                hashCode = hashCode * 59 + this.NoCvc.GetHashCode();
                return hashCode;
            }
        }
