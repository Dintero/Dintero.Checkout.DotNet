...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// SwishGwWrite
    /// </summary>
    [DataContract(Name = "SwishGwWrite")]
    public partial class SwishGwWrite : IEquatable<SwishGwWrite>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SwishGwWrite" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SwishGwWrite() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SwishGwWrite" /> class.
        /// </summary>
        /// <param name="url">url (required).</param>
        /// <param name="swishNumber">The merchant&#39;s Swish number (required).</param>
        /// <param name="cert">Base 64 encoded string of the certificate. Can be in PEM or P12 format. If PEM, key and ca are required.  (required).</param>
        /// <param name="key">Base 64 encoded string of the public key.</param>
        /// <param name="passphrase">The passphrase for the certificate (required).</param>
        /// <param name="ca">Base 64 encoded string of the CA of the certificate.</param>
        public SwishGwWrite(string url = default(string), string swishNumber = default(string), string cert = default(string), string key = default(string), string passphrase = default(string), string ca = default(string))
        {
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url is a required property for SwishGwWrite and cannot be null");
            // to ensure "swishNumber" is required (not null)
            this.SwishNumber = swishNumber ?? throw new ArgumentNullException("swishNumber is a required property for SwishGwWrite and cannot be null");
            // to ensure "cert" is required (not null)
            this.Cert = cert ?? throw new ArgumentNullException("cert is a required property for SwishGwWrite and cannot be null");
            // to ensure "passphrase" is required (not null)
            this.Passphrase = passphrase ?? throw new ArgumentNullException("passphrase is a required property for SwishGwWrite and cannot be null");
            this.Key = key;
            this.Ca = ca;
        }
        ...
        [DataMember(Name = "cert", IsRequired = true, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as SwishGwWrite);
        }

        /// <summary>
        /// Returns true if SwishGwWrite instances are equal
        /// </summary>
        /// <param name="input">Instance of SwishGwWrite to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SwishGwWrite input)
        {
            if (input == null)
                return false;
