...
{
    /// <summary>
    /// TransactionSwishAllOf
    /// </summary>
    [DataContract(Name = "TransactionSwish_allOf")]
    public partial class TransactionSwishAllOf : IEquatable<TransactionSwishAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionSwishAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionSwishAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionSwishAllOf" /> class.
        /// </summary>
        ...
        public TransactionSwishAllOf(PaymentProductTypeEnum paymentProductType = default(PaymentProductTypeEnum), List<TransactionSwishAllOfEvents> events = default(List<TransactionSwishAllOfEvents>), TransactionSwishAllOfMetadata1 metadata = default(TransactionSwishAllOfMetadata1))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionSwishAllOf {\n");
        ...
        {
            return this.Equals(input as TransactionSwishAllOf);
        }

        /// <summary>
        /// Returns true if TransactionSwishAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionSwishAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionSwishAllOf input)
        {
            if (input == null)
                return false;
