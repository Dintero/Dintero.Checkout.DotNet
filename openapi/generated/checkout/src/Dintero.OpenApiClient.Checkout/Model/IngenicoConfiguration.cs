...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IngenicoConfiguration")]
    public partial class IngenicoConfiguration : IEquatable<IngenicoConfiguration>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoConfiguration" /> class.
        /// </summary>
        /// <param name="type">Denotes what kind of config parameter this is.</param>
        /// <param name="creditcard">creditcard.</param>
        public IngenicoConfiguration(TypeEnum? type = default(TypeEnum?), BamboraConfigurationCreditcard creditcard = default(BamboraConfigurationCreditcard))
        {
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IngenicoConfiguration {\n");
        ...
        {
            return this.Equals(input as IngenicoConfiguration);
        }

        /// <summary>
        /// Returns true if IngenicoConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of IngenicoConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IngenicoConfiguration input)
        {
            if (input == null)
                return false;
