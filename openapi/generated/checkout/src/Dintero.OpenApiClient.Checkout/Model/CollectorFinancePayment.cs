...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CollectorFinancePayment")]
    [JsonConverter(typeof(JsonSubtypes), "PaymentProductType")]
    public partial class CollectorFinancePayment : Payment, IEquatable<CollectorFinancePayment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorFinancePayment" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorFinancePayment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorFinancePayment" /> class.
        /// </summary>
        ...
        /// <param name="paymentProductType">The payment product type corresponding to this transaction  (required) (default to &quot;CollectorFinancePayment&quot;).</param>
        ...
        public CollectorFinancePayment(string socialSecurityNumber = default(string), string paymentProductType = "CollectorFinancePayment", CollectorAddress shippingAddress = default(CollectorAddress), CollectorAddress billingAddress = default(CollectorAddress), bool rememberMe = default(bool)) : base()
        {
            // to ensure "socialSecurityNumber" is required (not null)
            this.SocialSecurityNumber = socialSecurityNumber ?? throw new ArgumentNullException("socialSecurityNumber is a required property for CollectorFinancePayment and cannot be null");
            // to ensure "paymentProductType" is required (not null)
            this.PaymentProductType = paymentProductType ?? throw new ArgumentNullException("paymentProductType is a required property for CollectorFinancePayment and cannot be null");
            // to ensure "shippingAddress" is required (not null)
            this.ShippingAddress = shippingAddress ?? throw new ArgumentNullException("shippingAddress is a required property for CollectorFinancePayment and cannot be null");
            // to ensure "billingAddress" is required (not null)
            this.BillingAddress = billingAddress ?? throw new ArgumentNullException("billingAddress is a required property for CollectorFinancePayment and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorFinancePayment {\n");
        ...
        {
            return this.Equals(input as CollectorFinancePayment);
        }

        /// <summary>
        /// Returns true if CollectorFinancePayment instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorFinancePayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorFinancePayment input)
        {
            if (input == null)
                return false;
