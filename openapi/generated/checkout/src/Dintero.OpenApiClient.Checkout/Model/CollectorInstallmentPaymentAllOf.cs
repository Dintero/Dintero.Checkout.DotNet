...
{
    /// <summary>
    /// CollectorInstallmentPaymentAllOf
    /// </summary>
    [DataContract(Name = "CollectorInstallmentPayment_allOf")]
    public partial class CollectorInstallmentPaymentAllOf : IEquatable<CollectorInstallmentPaymentAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorInstallmentPaymentAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorInstallmentPaymentAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorInstallmentPaymentAllOf" /> class.
        /// </summary>
        ...
        public CollectorInstallmentPaymentAllOf(CollectorInstallmentB2BPreapprovedPaymentAllOfProduct product = default(CollectorInstallmentB2BPreapprovedPaymentAllOfProduct), CollectorAddress shippingAddress = default(CollectorAddress), CollectorAddress billingAddress = default(CollectorAddress), bool rememberMe = default(bool))
        {
            // to ensure "product" is required (not null)
            this.Product = product ?? throw new ArgumentNullException("product is a required property for CollectorInstallmentPaymentAllOf and cannot be null");
            // to ensure "shippingAddress" is required (not null)
            this.ShippingAddress = shippingAddress ?? throw new ArgumentNullException("shippingAddress is a required property for CollectorInstallmentPaymentAllOf and cannot be null");
            // to ensure "billingAddress" is required (not null)
            this.BillingAddress = billingAddress ?? throw new ArgumentNullException("billingAddress is a required property for CollectorInstallmentPaymentAllOf and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorInstallmentPaymentAllOf {\n");
        ...
        {
            return this.Equals(input as CollectorInstallmentPaymentAllOf);
        }

        /// <summary>
        /// Returns true if CollectorInstallmentPaymentAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorInstallmentPaymentAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorInstallmentPaymentAllOf input)
        {
            if (input == null)
                return false;
