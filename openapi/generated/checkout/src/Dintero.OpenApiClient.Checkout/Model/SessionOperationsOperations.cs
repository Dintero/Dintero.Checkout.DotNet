...
{
    /// <summary>
    /// SessionOperationsOperations
    /// </summary>
    [DataContract(Name = "SessionOperations_operations")]
    public partial class SessionOperationsOperations : IEquatable<SessionOperationsOperations>, IValidatableObject
    {
        /// <summary>
        /// The HTTP method to use when performing the operation 
        /// </summary>
        /// <value>The HTTP method to use when performing the operation </value>
        ...
        /// <summary>
        /// The name of the relation the operation has to the current resource  - &#x60;view-payex-creditcard&#x60;: Contains the href that is used to   get the URL for the JavaScript that is used to embed the   credit card UI directly on the Checkout site. - &#x60;view-payex-swish&#x60;: Contains the href that is used to   get the URL for the JavaScript that is used to embed the   Swish UI directly on the Checkout site. - &#x60;view-collector-installment&#x60;: Contains the href that is used   to get the producsts available for the collector installment - &#x60;view-ingenico-installment&#x60;: Contains the href that is used   to get the URL that is used to embed the UI directly on the   Checkout site. 
        /// </summary>
        /// <value>The name of the relation the operation has to the current resource  - &#x60;view-payex-creditcard&#x60;: Contains the href that is used to   get the URL for the JavaScript that is used to embed the   credit card UI directly on the Checkout site. - &#x60;view-payex-swish&#x60;: Contains the href that is used to   get the URL for the JavaScript that is used to embed the   Swish UI directly on the Checkout site. - &#x60;view-collector-installment&#x60;: Contains the href that is used   to get the producsts available for the collector installment - &#x60;view-ingenico-installment&#x60;: Contains the href that is used   to get the URL that is used to embed the UI directly on the   Checkout site. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum RelEnum
        {
            /// <summary>
            /// Enum PayexCreditcard for value: view-payex-creditcard
            /// </summary>
            [EnumMember(Value = "view-payex-creditcard")]
            PayexCreditcard = 1,

            /// <summary>
            /// Enum PayexSwish for value: view-payex-swish
            /// </summary>
            [EnumMember(Value = "view-payex-swish")]
            PayexSwish = 2,

            /// <summary>
            /// Enum CollectorInstallment for value: view-collector-installment
            /// </summary>
            [EnumMember(Value = "view-collector-installment")]
            CollectorInstallment = 3,

            /// <summary>
            /// Enum IngenicoCreditcard for value: view-ingenico-creditcard
            /// </summary>
            [EnumMember(Value = "view-ingenico-creditcard")]
            IngenicoCreditcard = 4
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionOperationsOperations" /> class.
        /// </summary>
        /// <param name="method">The HTTP method to use when performing the operation .</param>
        /// <param name="href">The target URI to perform the operation against. .</param>
        /// <param name="rel">The name of the relation the operation has to the current resource  - &#x60;view-payex-creditcard&#x60;: Contains the href that is used to   get the URL for the JavaScript that is used to embed the   credit card UI directly on the Checkout site. - &#x60;view-payex-swish&#x60;: Contains the href that is used to   get the URL for the JavaScript that is used to embed the   Swish UI directly on the Checkout site. - &#x60;view-collector-installment&#x60;: Contains the href that is used   to get the producsts available for the collector installment - &#x60;view-ingenico-installment&#x60;: Contains the href that is used   to get the URL that is used to embed the UI directly on the   Checkout site. .</param>
        /// <param name="contentType">The Content-Type to used when performing the operation. .</param>
        public SessionOperationsOperations(MethodEnum? method = default(MethodEnum?), string href = default(string), RelEnum? rel = default(RelEnum?), string contentType = default(string))
        {
            this.Method = method;
            this.Href = href;
            this.Rel = rel;
        ...
        /// </summary>
        /// <value>The target URI to perform the operation against. </value>
        ...
        /// </summary>
        /// <value>The Content-Type to used when performing the operation. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SessionOperationsOperations {\n");
        ...
        {
            return this.Equals(input as SessionOperationsOperations);
        }

        /// <summary>
        /// Returns true if SessionOperationsOperations instances are equal
        /// </summary>
        /// <param name="input">Instance of SessionOperationsOperations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SessionOperationsOperations input)
        {
            if (input == null)
                return false;
