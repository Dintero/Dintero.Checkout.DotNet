...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CollectorGwRead_options")]
    public partial class CollectorGwReadOptions : IEquatable<CollectorGwReadOptions>, IValidatableObject
    {
        /// <summary>
        /// The field(s) used to populate the settlement reference. The &#x60;store_id&#x60; in this context is &#x60;order.store.id&#x60; from session, not to be confused with a store_id from Collector stores. 
        /// </summary>
        /// <value>The field(s) used to populate the settlement reference. The &#x60;store_id&#x60; in this context is &#x60;order.store.id&#x60; from session, not to be confused with a store_id from Collector stores. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum SettlementReferenceFieldsEnum
        {
            /// <summary>
            /// Enum Id for value: account_id
            /// </summary>
            [EnumMember(Value = "account_id")]
            Id = 1,

            /// <summary>
            /// Enum IdStoreId for value: account_id.store_id
            /// </summary>
            [EnumMember(Value = "account_id.store_id")]
            IdStoreId = 2
        ...
        /// </summary>
        /// <value>The field(s) used to populate the settlement reference. The &#x60;store_id&#x60; in this context is &#x60;order.store.id&#x60; from session, not to be confused with a store_id from Collector stores. </value>
        [DataMember(Name = "settlement_reference_fields", EmitDefaultValue = false)]
        public SettlementReferenceFieldsEnum? SettlementReferenceFields { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorGwReadOptions" /> class.
        /// </summary>
        /// <param name="enableOnHold">Create the collector transaction with status &#x60;ON_HOLD&#x60; and let the Collector callback update the transaction state from &#x60;ON_HOLD&#x60; to &#x60;AUTHORIZED&#x60; or &#x60;FAILED&#x60;.  A callback will be sent to the &#x60;callback_url&#x60; when the transaction changes state from &#x60;ON_HOLD&#x60; to any new state.  (default to false).</param>
        /// <param name="settlementReferenceFields">The field(s) used to populate the settlement reference. The &#x60;store_id&#x60; in this context is &#x60;order.store.id&#x60; from session, not to be confused with a store_id from Collector stores.  (default to SettlementReferenceFieldsEnum.Id).</param>
        public CollectorGwReadOptions(bool enableOnHold = false, SettlementReferenceFieldsEnum? settlementReferenceFields = SettlementReferenceFieldsEnum.Id)
        {
            this.EnableOnHold = enableOnHold;
            this.SettlementReferenceFields = settlementReferenceFields;
        }

        /// <summary>
        /// Create the collector transaction with status &#x60;ON_HOLD&#x60; and let the Collector callback update the transaction state from &#x60;ON_HOLD&#x60; to &#x60;AUTHORIZED&#x60; or &#x60;FAILED&#x60;.  A callback will be sent to the &#x60;callback_url&#x60; when the transaction changes state from &#x60;ON_HOLD&#x60; to any new state. 
        /// </summary>
        /// <value>Create the collector transaction with status &#x60;ON_HOLD&#x60; and let the Collector callback update the transaction state from &#x60;ON_HOLD&#x60; to &#x60;AUTHORIZED&#x60; or &#x60;FAILED&#x60;.  A callback will be sent to the &#x60;callback_url&#x60; when the transaction changes state from &#x60;ON_HOLD&#x60; to any new state. </value>
        [DataMember(Name = "enable_on_hold", EmitDefaultValue = true)]
        public bool EnableOnHold { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorGwReadOptions {\n");
            sb.Append("  EnableOnHold: ").Append(EnableOnHold).Append("\n");
            sb.Append("  SettlementReferenceFields: ").Append(SettlementReferenceFields).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as CollectorGwReadOptions);
        }

        /// <summary>
        /// Returns true if CollectorGwReadOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorGwReadOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorGwReadOptions input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.EnableOnHold == input.EnableOnHold ||
                    this.EnableOnHold.Equals(input.EnableOnHold)
                ) && 
                (
                    this.SettlementReferenceFields == input.SettlementReferenceFields ||
                    this.SettlementReferenceFields.Equals(input.SettlementReferenceFields)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = hashCode * 59 + this.EnableOnHold.GetHashCode();
                hashCode = hashCode * 59 + this.SettlementReferenceFields.GetHashCode();
                return hashCode;
            }
        }
