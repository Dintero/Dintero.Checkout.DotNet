...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IngenicoGwRead")]
    public partial class IngenicoGwRead : IEquatable<IngenicoGwRead>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoGwRead" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IngenicoGwRead() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoGwRead" /> class.
        /// </summary>
        ...
        public IngenicoGwRead(string url = default(string), string merchantId = default(string), string apiKeyId = default(string), IngenicoGwReadOptions options = default(IngenicoGwReadOptions))
        {
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url is a required property for IngenicoGwRead and cannot be null");
            // to ensure "merchantId" is required (not null)
            this.MerchantId = merchantId ?? throw new ArgumentNullException("merchantId is a required property for IngenicoGwRead and cannot be null");
            // to ensure "apiKeyId" is required (not null)
            this.ApiKeyId = apiKeyId ?? throw new ArgumentNullException("apiKeyId is a required property for IngenicoGwRead and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IngenicoGwRead {\n");
        ...
        {
            return this.Equals(input as IngenicoGwRead);
        }

        /// <summary>
        /// Returns true if IngenicoGwRead instances are equal
        /// </summary>
        /// <param name="input">Instance of IngenicoGwRead to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IngenicoGwRead input)
        {
            if (input == null)
                return false;
