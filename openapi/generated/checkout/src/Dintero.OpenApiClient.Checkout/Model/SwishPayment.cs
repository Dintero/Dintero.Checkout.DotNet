...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// SwishPayment
    /// </summary>
    [DataContract(Name = "SwishPayment")]
    [JsonConverter(typeof(JsonSubtypes), "PaymentProductType")]
    public partial class SwishPayment : Payment, IEquatable<SwishPayment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SwishPayment" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SwishPayment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SwishPayment" /> class.
        /// </summary>
        ...
        /// <param name="paymentProductType">The payment product type corresponding to this transaction  (required) (default to &quot;SwishPayment&quot;).</param>
        public SwishPayment(string phoneNumber = default(string), bool rememberMe = default(bool), string paymentProductType = "SwishPayment") : base(paymentProductType)
        {
            // to ensure "phoneNumber" is required (not null)
            this.PhoneNumber = phoneNumber ?? throw new ArgumentNullException("phoneNumber is a required property for SwishPayment and cannot be null");
        ...
        {
            return this.Equals(input as SwishPayment);
        }

        /// <summary>
        /// Returns true if SwishPayment instances are equal
        /// </summary>
        /// <param name="input">Instance of SwishPayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SwishPayment input)
        {
            if (input == null)
                return false;
