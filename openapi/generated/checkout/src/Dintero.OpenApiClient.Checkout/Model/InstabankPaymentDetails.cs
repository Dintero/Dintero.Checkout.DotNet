...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InstabankPaymentDetails")]
    ...
    public partial class InstabankPaymentDetails : IEquatable<InstabankPaymentDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankPaymentDetails" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstabankPaymentDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankPaymentDetails" /> class.
        /// </summary>
        /// <param name="paymentProductType">The payment product type corresponding to this transaction  (required).</param>
        public InstabankPaymentDetails(string paymentProductType = default(string))
        {
            // to ensure "paymentProductType" is required (not null)
            this.PaymentProductType = paymentProductType ?? throw new ArgumentNullException("paymentProductType is a required property for InstabankPaymentDetails and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstabankPaymentDetails {\n");
        ...
        {
            return this.Equals(input as InstabankPaymentDetails);
        }

        /// <summary>
        /// Returns true if InstabankPaymentDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of InstabankPaymentDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstabankPaymentDetails input)
        {
            if (input == null)
                return false;
