...
{
    /// <summary>
    /// TransactionSantanderAllOfEvents
    /// </summary>
    [DataContract(Name = "TransactionSantander_allOf_events")]
    public partial class TransactionSantanderAllOfEvents : IEquatable<TransactionSantanderAllOfEvents>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionSantanderAllOfEvents" /> class.
        /// </summary>
        /// <param name="metadata">metadata.</param>
        public TransactionSantanderAllOfEvents(TransactionSantanderAllOfMetadata metadata = default(TransactionSantanderAllOfMetadata))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionSantanderAllOfEvents {\n");
        ...
        {
            return this.Equals(input as TransactionSantanderAllOfEvents);
        }

        /// <summary>
        /// Returns true if TransactionSantanderAllOfEvents instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionSantanderAllOfEvents to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionSantanderAllOfEvents input)
        {
            if (input == null)
                return false;
