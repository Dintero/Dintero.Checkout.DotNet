...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IngenicoWebhookEvent_payment")]
    public partial class IngenicoWebhookEventPayment : IEquatable<IngenicoWebhookEventPayment>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        {
            /// <summary>
            /// Enum ACCOUNTVERIFIED for value: ACCOUNT_VERIFIED
            /// </summary>
            [EnumMember(Value = "ACCOUNT_VERIFIED")]
            ACCOUNTVERIFIED = 1,
            ...
            /// <summary>
            /// Enum REDIRECTED for value: REDIRECTED
            /// </summary>
            ...
            /// <summary>
            /// Enum PENDINGFRAUDAPPROVAL for value: PENDING_FRAUD_APPROVAL
            /// </summary>
            [EnumMember(Value = "PENDING_FRAUD_APPROVAL")]
            PENDINGFRAUDAPPROVAL = 5,
            ...
            /// <summary>
            /// Enum PENDINGCOMPLETION for value: PENDING_COMPLETION
            /// </summary>
            ...
            /// <summary>
            /// Enum AUTHORIZATIONREQUESTED for value: AUTHORIZATION_REQUESTED
            /// </summary>
            [EnumMember(Value = "AUTHORIZATION_REQUESTED")]
            AUTHORIZATIONREQUESTED = 10,

            /// <summary>
            /// Enum CAPTUREREQUESTED for value: CAPTURE_REQUESTED
            /// </summary>
            ...
            /// <summary>
            /// Enum REJECTEDCAPTURE for value: REJECTED_CAPTURE
            /// </summary>
            ...
            /// <summary>
            /// Enum CHARGEBACKNOTIFICATION for value: CHARGEBACK_NOTIFICATION
            /// </summary>
            [EnumMember(Value = "CHARGEBACK_NOTIFICATION")]
            CHARGEBACKNOTIFICATION = 17,

            /// <summary>
            /// Enum CHARGEBACKED for value: CHARGEBACKED
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoWebhookEventPayment" /> class.
        /// </summary>
        /// <param name="id">Unique payment transaction identifier..</param>
        /// <param name="status">status.</param>
        /// <param name="statusOutput">statusOutput.</param>
        /// <param name="paymentOutput">paymentOutput.</param>
        /// <param name="hostedCheckoutSpecificOutput">hostedCheckoutSpecificOutput.</param>
        public IngenicoWebhookEventPayment(string id = default(string), StatusEnum? status = default(StatusEnum?), IngenicoWebhookEventPaymentStatusOutput statusOutput = default(IngenicoWebhookEventPaymentStatusOutput), IngenicoWebhookEventPaymentPaymentOutput paymentOutput = default(IngenicoWebhookEventPaymentPaymentOutput), IngenicoWebhookEventPaymentHostedCheckoutSpecificOutput hostedCheckoutSpecificOutput = default(IngenicoWebhookEventPaymentHostedCheckoutSpecificOutput))
        {
            this.Id = id;
            this.Status = status;
        ...
        /// </summary>
        /// <value>Unique payment transaction identifier.</value>
        ...
        public IngenicoWebhookEventPaymentStatusOutput StatusOutput { get; set; }

        /// <summary>
        /// Gets or Sets PaymentOutput
        /// </summary>
        [DataMember(Name = "paymentOutput", EmitDefaultValue = false)]
        public IngenicoWebhookEventPaymentPaymentOutput PaymentOutput { get; set; }

        /// <summary>
        /// Gets or Sets HostedCheckoutSpecificOutput
        /// </summary>
        [DataMember(Name = "hostedCheckoutSpecificOutput", EmitDefaultValue = false)]
        public IngenicoWebhookEventPaymentHostedCheckoutSpecificOutput HostedCheckoutSpecificOutput { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IngenicoWebhookEventPayment {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  Status: ").Append(Status).Append("\n");
            sb.Append("  StatusOutput: ").Append(StatusOutput).Append("\n");
            sb.Append("  PaymentOutput: ").Append(PaymentOutput).Append("\n");
            sb.Append("  HostedCheckoutSpecificOutput: ").Append(HostedCheckoutSpecificOutput).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as IngenicoWebhookEventPayment);
        }

        /// <summary>
        /// Returns true if IngenicoWebhookEventPayment instances are equal
        /// </summary>
        /// <param name="input">Instance of IngenicoWebhookEventPayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IngenicoWebhookEventPayment input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.StatusOutput == input.StatusOutput ||
                    (this.StatusOutput != null &&
                    this.StatusOutput.Equals(input.StatusOutput))
                ) && 
                (
                    this.PaymentOutput == input.PaymentOutput ||
                    (this.PaymentOutput != null &&
                    this.PaymentOutput.Equals(input.PaymentOutput))
                ) && 
                (
                    this.HostedCheckoutSpecificOutput == input.HostedCheckoutSpecificOutput ||
                    (this.HostedCheckoutSpecificOutput != null &&
                    this.HostedCheckoutSpecificOutput.Equals(input.HostedCheckoutSpecificOutput))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.StatusOutput != null)
                    hashCode = hashCode * 59 + this.StatusOutput.GetHashCode();
                if (this.PaymentOutput != null)
                    hashCode = hashCode * 59 + this.PaymentOutput.GetHashCode();
                if (this.HostedCheckoutSpecificOutput != null)
                    hashCode = hashCode * 59 + this.HostedCheckoutSpecificOutput.GetHashCode();
                return hashCode;
            }
        }
