...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IngenicoWebhookEvent_payout")]
    public partial class IngenicoWebhookEventPayout : IEquatable<IngenicoWebhookEventPayout>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        public enum StatusEnum
        {
            ...
            /// <summary>
            /// Enum PAYOUTREQUESTED for value: PAYOUT_REQUESTED
            /// </summary>
            [EnumMember(Value = "PAYOUT_REQUESTED")]
            PAYOUTREQUESTED = 4,

            /// <summary>
            /// Enum ACCOUNTCREDITED for value: ACCOUNT_CREDITED
            /// </summary>
            [EnumMember(Value = "ACCOUNT_CREDITED")]
            ACCOUNTCREDITED = 5,

            /// <summary>
            /// Enum REJECTEDCREDIT for value: REJECTED_CREDIT
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoWebhookEventPayout" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="status">status.</param>
        /// <param name="statusOutput">statusOutput.</param>
        /// <param name="payoutOutput">payoutOutput.</param>
        public IngenicoWebhookEventPayout(string id = default(string), StatusEnum? status = default(StatusEnum?), IngenicoWebhookEventRefundStatusOutput statusOutput = default(IngenicoWebhookEventRefundStatusOutput), IngenicoWebhookEventPayoutPayoutOutput payoutOutput = default(IngenicoWebhookEventPayoutPayoutOutput))
        {
            this.Id = id;
            this.Status = status;
        ...
        public IngenicoWebhookEventRefundStatusOutput StatusOutput { get; set; }

        /// <summary>
        /// Gets or Sets PayoutOutput
        /// </summary>
        [DataMember(Name = "payoutOutput", EmitDefaultValue = false)]
        public IngenicoWebhookEventPayoutPayoutOutput PayoutOutput { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IngenicoWebhookEventPayout {\n");
        ...
        {
            return this.Equals(input as IngenicoWebhookEventPayout);
        }

        /// <summary>
        /// Returns true if IngenicoWebhookEventPayout instances are equal
        /// </summary>
        /// <param name="input">Instance of IngenicoWebhookEventPayout to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IngenicoWebhookEventPayout input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PayoutOutput == input.PayoutOutput ||
                    (this.PayoutOutput != null &&
                    this.PayoutOutput.Equals(input.PayoutOutput))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PayoutOutput != null)
                    hashCode = hashCode * 59 + this.PayoutOutput.GetHashCode();
                return hashCode;
            }
        }
