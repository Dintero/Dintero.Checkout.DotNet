...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InstabankApplication")]
    public partial class InstabankApplication : IEquatable<InstabankApplication>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankApplication" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstabankApplication() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankApplication" /> class.
        /// </summary>
        ...
        /// <param name="totalIncome">**Deprecated** in favour of the top-level &#x60;total_income&#x60;.  income received by person from all source in smallest unit for the currency. e.g. $1.5 &#x3D; 150. .</param>
        ...
        public InstabankApplication(bool ownsHouse = default(bool), int monthlyHouseRental = default(int), MaritalStatusEnum maritalStatus = default(MaritalStatusEnum), int totalIncome = default(int), int mortgageDebt = default(int), int consumerDebt = default(int), int studentDebt = default(int), int otherSecuredDebt = default(int), int numberOfChildren = default(int), List<InstabankApplicationDebt> debt = default(List<InstabankApplicationDebt>))
        {
            this.OwnsHouse = ownsHouse;
            this.MaritalStatus = maritalStatus;
            this.NumberOfChildren = numberOfChildren;
            // to ensure "debt" is required (not null)
            this.Debt = debt ?? throw new ArgumentNullException("debt is a required property for InstabankApplication and cannot be null");
        ...
        [DataMember(Name = "total_income", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstabankApplication {\n");
        ...
        {
            return this.Equals(input as InstabankApplication);
        }

        /// <summary>
        /// Returns true if InstabankApplication instances are equal
        /// </summary>
        /// <param name="input">Instance of InstabankApplication to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstabankApplication input)
        {
            if (input == null)
                return false;
