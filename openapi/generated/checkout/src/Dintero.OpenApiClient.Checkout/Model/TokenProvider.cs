...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// TokenProvider
    /// </summary>
    [DataContract(Name = "TokenProvider")]
    [JsonConverter(typeof(JsonSubtypes), "PaymentProductType")]
    [JsonSubtypes.KnownSubType(typeof(PayExTokenProvider), "PayExTokenProvider")]
    [JsonSubtypes.KnownSubType(typeof(PayExTokenProvider), "payex.creditcard")]
    public partial class TokenProvider : IEquatable<TokenProvider>, IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="TokenProvider" /> class.
        /// </summary>
        /// <param name="paymentProductType">The payment product type corresponding to create token for  (required).</param>
        public TokenProvider(string paymentProductType = default(string))
        {
            // to ensure "paymentProductType" is required (not null)
            this.PaymentProductType = paymentProductType ?? throw new ArgumentNullException("paymentProductType is a required property for TokenProvider and cannot be null");
        }

        /// <summary>
        /// The payment product type corresponding to create token for 
        /// </summary>
        /// <value>The payment product type corresponding to create token for </value>
        ...
        {
            return this.Equals(input as TokenProvider);
        }

        /// <summary>
        /// Returns true if TokenProvider instances are equal
        /// </summary>
        /// <param name="input">Instance of TokenProvider to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokenProvider input)
        {
            if (input == null)
                return false;
