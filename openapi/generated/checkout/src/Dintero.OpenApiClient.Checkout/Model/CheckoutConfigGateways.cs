...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CheckoutConfig_gateways")]
    public partial class CheckoutConfigGateways : IEquatable<CheckoutConfigGateways>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckoutConfigGateways" /> class.
        /// </summary>
        ...
        public CheckoutConfigGateways(BamboraGwRead bambora = default(BamboraGwRead), InstabankGwRead instabank = default(InstabankGwRead), PayExGwRead payex = default(PayExGwRead), VippsGwRead vipps = default(VippsGwRead), CollectorGwRead collector = default(CollectorGwRead), SantanderGwRead santander = default(SantanderGwRead), IngenicoGwRead ingenico = default(IngenicoGwRead), NetaxeptGwRead netaxept = default(NetaxeptGwRead), SwishGwRead swish = default(SwishGwRead))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CheckoutConfigGateways {\n");
        ...
        {
            return this.Equals(input as CheckoutConfigGateways);
        }

        /// <summary>
        /// Returns true if CheckoutConfigGateways instances are equal
        /// </summary>
        /// <param name="input">Instance of CheckoutConfigGateways to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CheckoutConfigGateways input)
        {
            if (input == null)
                return false;
