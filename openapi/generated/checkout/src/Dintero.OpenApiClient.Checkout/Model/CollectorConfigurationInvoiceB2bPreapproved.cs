...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CollectorConfiguration_invoice_b2b_preapproved")]
    public partial class CollectorConfigurationInvoiceB2bPreapproved : IEquatable<CollectorConfigurationInvoiceB2bPreapproved>, IValidatableObject
    {
        /// <summary>
        ...
        {
            /// <summary>
            /// Enum PaymentProductType for value: payment_product_type
            /// </summary>
            [EnumMember(Value = "payment_product_type")]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorConfigurationInvoiceB2bPreapproved" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorConfigurationInvoiceB2bPreapproved() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorConfigurationInvoiceB2bPreapproved" /> class.
        /// </summary>
        /// <param name="type">Denotes what kind of config parameter this is (default to TypeEnum.PaymentProductType).</param>
        /// <param name="payability">payability.</param>
        /// <param name="enabled">enable Collector Bank Invoice Payment B2B (required).</param>
        /// <param name="countries">countries.</param>
        /// <param name="accounts">All Collector B2B accounts configured for the customer&#39;s phone number at the merchant. .</param>
        public CollectorConfigurationInvoiceB2bPreapproved(TypeEnum? type = TypeEnum.PaymentProductType, SessionPayability? payability = default(SessionPayability?), bool enabled = default(bool), List<string> countries = default(List<string>), List<CollectorConfigurationInvoiceB2bPreapprovedAccounts> accounts = default(List<CollectorConfigurationInvoiceB2bPreapprovedAccounts>))
        {
        ...
        /// </summary>
        /// <value>enable Collector Bank Invoice Payment B2B</value>
        ...
        /// </summary>
        /// <value>All Collector B2B accounts configured for the customer&#39;s phone number at the merchant. </value>
        [DataMember(Name = "accounts", EmitDefaultValue = false)]
        public List<CollectorConfigurationInvoiceB2bPreapprovedAccounts> Accounts { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorConfigurationInvoiceB2bPreapproved {\n");
        ...
        {
            return this.Equals(input as CollectorConfigurationInvoiceB2bPreapproved);
        }

        /// <summary>
        /// Returns true if CollectorConfigurationInvoiceB2bPreapproved instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorConfigurationInvoiceB2bPreapproved to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorConfigurationInvoiceB2bPreapproved input)
        {
            if (input == null)
                return false;
