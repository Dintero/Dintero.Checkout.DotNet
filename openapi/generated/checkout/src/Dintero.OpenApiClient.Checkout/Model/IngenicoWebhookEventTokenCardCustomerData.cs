...
{
    /// <summary>
    /// IngenicoWebhookEventTokenCardCustomerData
    /// </summary>
    [DataContract(Name = "IngenicoWebhookEvent_token_card_customer_data")]
    public partial class IngenicoWebhookEventTokenCardCustomerData : IEquatable<IngenicoWebhookEventTokenCardCustomerData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoWebhookEventTokenCardCustomerData" /> class.
        /// </summary>
        /// <param name="cardWithoutCvv">cardWithoutCvv.</param>
        /// <param name="firstTransactionDate">firstTransactionDate.</param>
        /// <param name="providerReference">providerReference.</param>
        public IngenicoWebhookEventTokenCardCustomerData(IngenicoWebhookEventTokenCardCustomerDataCardWithoutCvv cardWithoutCvv = default(IngenicoWebhookEventTokenCardCustomerDataCardWithoutCvv), string firstTransactionDate = default(string), string providerReference = default(string))
        {
        ...
        /// </summary>
        [DataMember(Name = "cardWithoutCvv", EmitDefaultValue = false)]
        public IngenicoWebhookEventTokenCardCustomerDataCardWithoutCvv CardWithoutCvv { get; set; }

        /// <summary>
        /// Gets or Sets FirstTransactionDate
        /// </summary>
        [DataMember(Name = "firstTransactionDate", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IngenicoWebhookEventTokenCardCustomerData {\n");
        ...
        {
            return this.Equals(input as IngenicoWebhookEventTokenCardCustomerData);
        }

        /// <summary>
        /// Returns true if IngenicoWebhookEventTokenCardCustomerData instances are equal
        /// </summary>
        /// <param name="input">Instance of IngenicoWebhookEventTokenCardCustomerData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IngenicoWebhookEventTokenCardCustomerData input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.CardWithoutCvv == input.CardWithoutCvv ||
                    (this.CardWithoutCvv != null &&
                    this.CardWithoutCvv.Equals(input.CardWithoutCvv))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CardWithoutCvv != null)
                    hashCode = hashCode * 59 + this.CardWithoutCvv.GetHashCode();
