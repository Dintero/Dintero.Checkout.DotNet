...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class InlineResponse2009 : IEquatable<InlineResponse2009>, IValidatableObject
    {
        ...
        /// <param name="sessionCancelled">sessionCancelled.</param>
        /// <param name="sessionRead">sessionRead.</param>
        public InlineResponse2009(Id id = default(Id), Session session = default(Session), SessionCancelled sessionCancelled = default(SessionCancelled), SessionRead sessionRead = default(SessionRead))
        {
            this.Id = id;
        ...
        /// <summary>
        /// Gets or Sets SessionCancelled
        /// </summary>
        [DataMember(Name = "SessionCancelled", EmitDefaultValue = false)]
        public SessionCancelled SessionCancelled { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SessionCancelled: ").Append(SessionCancelled).Append("\n");
        ...
        public bool Equals(InlineResponse2009 input)
        {
            ...
            return 
                ...
                (
                    this.SessionCancelled == input.SessionCancelled ||
                    (this.SessionCancelled != null &&
                    this.SessionCancelled.Equals(input.SessionCancelled))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SessionCancelled != null)
                    hashCode = hashCode * 59 + this.SessionCancelled.GetHashCode();
