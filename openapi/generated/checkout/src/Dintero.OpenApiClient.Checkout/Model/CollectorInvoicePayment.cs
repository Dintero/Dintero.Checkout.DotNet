...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CollectorInvoicePayment")]
    [JsonConverter(typeof(JsonSubtypes), "PaymentProductType")]
    public partial class CollectorInvoicePayment : Payment, IEquatable<CollectorInvoicePayment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorInvoicePayment" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorInvoicePayment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorInvoicePayment" /> class.
        /// </summary>
        ...
        /// <param name="paymentProductType">The payment product type corresponding to this transaction  (required) (default to &quot;CollectorInvoicePayment&quot;).</param>
        ...
        public CollectorInvoicePayment(string socialSecurityNumber = default(string), string paymentProductType = "CollectorInvoicePayment", CollectorAddress shippingAddress = default(CollectorAddress), CollectorAddress billingAddress = default(CollectorAddress), bool rememberMe = default(bool)) : base()
        {
            // to ensure "socialSecurityNumber" is required (not null)
            this.SocialSecurityNumber = socialSecurityNumber ?? throw new ArgumentNullException("socialSecurityNumber is a required property for CollectorInvoicePayment and cannot be null");
            // to ensure "paymentProductType" is required (not null)
            this.PaymentProductType = paymentProductType ?? throw new ArgumentNullException("paymentProductType is a required property for CollectorInvoicePayment and cannot be null");
            // to ensure "shippingAddress" is required (not null)
            this.ShippingAddress = shippingAddress ?? throw new ArgumentNullException("shippingAddress is a required property for CollectorInvoicePayment and cannot be null");
            // to ensure "billingAddress" is required (not null)
            this.BillingAddress = billingAddress ?? throw new ArgumentNullException("billingAddress is a required property for CollectorInvoicePayment and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorInvoicePayment {\n");
        ...
        {
            return this.Equals(input as CollectorInvoicePayment);
        }

        /// <summary>
        /// Returns true if CollectorInvoicePayment instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorInvoicePayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorInvoicePayment input)
        {
            if (input == null)
                return false;
