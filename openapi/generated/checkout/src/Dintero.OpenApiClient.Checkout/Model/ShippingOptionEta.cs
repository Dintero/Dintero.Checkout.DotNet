...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ShippingOption_eta")]
    public partial class ShippingOptionEta : IEquatable<ShippingOptionEta>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShippingOptionEta" /> class.
        /// </summary>
        /// <param name="startsAt">startsAt.</param>
        /// <param name="endsAt">endsAt.</param>
        public ShippingOptionEta(DateTime startsAt = default(DateTime), DateTime endsAt = default(DateTime))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShippingOptionEta {\n");
        ...
        {
            return this.Equals(input as ShippingOptionEta);
        }

        /// <summary>
        /// Returns true if ShippingOptionEta instances are equal
        /// </summary>
        /// <param name="input">Instance of ShippingOptionEta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShippingOptionEta input)
        {
            if (input == null)
                return false;
