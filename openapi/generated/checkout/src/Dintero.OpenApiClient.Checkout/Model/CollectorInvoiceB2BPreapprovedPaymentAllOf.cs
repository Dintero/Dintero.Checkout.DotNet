...
{
    /// <summary>
    /// CollectorInvoiceB2BPreapprovedPaymentAllOf
    /// </summary>
    [DataContract(Name = "CollectorInvoiceB2BPreapprovedPayment_allOf")]
    public partial class CollectorInvoiceB2BPreapprovedPaymentAllOf : IEquatable<CollectorInvoiceB2BPreapprovedPaymentAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorInvoiceB2BPreapprovedPaymentAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorInvoiceB2BPreapprovedPaymentAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorInvoiceB2BPreapprovedPaymentAllOf" /> class.
        /// </summary>
        ...
        public CollectorInvoiceB2BPreapprovedPaymentAllOf(CollectorB2BAddress shippingAddress = default(CollectorB2BAddress), string scc = default(string), string companyId = default(string), bool rememberMe = default(bool))
        {
            // to ensure "shippingAddress" is required (not null)
            this.ShippingAddress = shippingAddress ?? throw new ArgumentNullException("shippingAddress is a required property for CollectorInvoiceB2BPreapprovedPaymentAllOf and cannot be null");
            // to ensure "companyId" is required (not null)
            this.CompanyId = companyId ?? throw new ArgumentNullException("companyId is a required property for CollectorInvoiceB2BPreapprovedPaymentAllOf and cannot be null");
            this.Scc = scc;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorInvoiceB2BPreapprovedPaymentAllOf {\n");
        ...
        {
            return this.Equals(input as CollectorInvoiceB2BPreapprovedPaymentAllOf);
        }

        /// <summary>
        /// Returns true if CollectorInvoiceB2BPreapprovedPaymentAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorInvoiceB2BPreapprovedPaymentAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorInvoiceB2BPreapprovedPaymentAllOf input)
        {
            if (input == null)
                return false;
