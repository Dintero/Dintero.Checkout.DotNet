...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InstabankInstallmentProduct")]
    public partial class InstabankInstallmentProduct : IEquatable<InstabankInstallmentProduct>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankInstallmentProduct" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstabankInstallmentProduct() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankInstallmentProduct" /> class.
        /// </summary>
        /// <param name="minimumAmount">Minimum order amount for this product. The product option will be excluded in payments where the order amount is less than the minimum amount. .</param>
        /// <param name="productCode">productCode (required).</param>
        /// <param name="creditTime">Number of months  (required).</param>
        /// <param name="originationFee">The startup fee for the payment product  (required).</param>
        /// <param name="notificationFee">The notification fee for the payment product  (required).</param>
        /// <param name="annualInterestRate">The interest rate for the payment product.  (required).</param>
        /// <param name="requireApplicantAmount">The limit for when instabank will require a full applicant during payment. .</param>
        /// <param name="loanExample">loanExample.</param>
        /// <param name="brandingImageUrl">Url for a custom branding image.</param>
        public InstabankInstallmentProduct(int minimumAmount = default(int), string productCode = default(string), int creditTime = default(int), int originationFee = default(int), int notificationFee = default(int), string annualInterestRate = default(string), int requireApplicantAmount = default(int), InstabankFinanceProductLoanExample loanExample = default(InstabankFinanceProductLoanExample), string brandingImageUrl = default(string))
        {
            // to ensure "productCode" is required (not null)
            this.ProductCode = productCode ?? throw new ArgumentNullException("productCode is a required property for InstabankInstallmentProduct and cannot be null");
            this.CreditTime = creditTime;
            this.OriginationFee = originationFee;
            this.NotificationFee = notificationFee;
            // to ensure "annualInterestRate" is required (not null)
            this.AnnualInterestRate = annualInterestRate ?? throw new ArgumentNullException("annualInterestRate is a required property for InstabankInstallmentProduct and cannot be null");
            this.MinimumAmount = minimumAmount;
            this.RequireApplicantAmount = requireApplicantAmount;
            this.LoanExample = loanExample;
            this.BrandingImageUrl = brandingImageUrl;
        }

        /// <summary>
        /// Minimum order amount for this product. The product option will be excluded in payments where the order amount is less than the minimum amount. 
        /// </summary>
        /// <value>Minimum order amount for this product. The product option will be excluded in payments where the order amount is less than the minimum amount. </value>
        [DataMember(Name = "minimum_amount", EmitDefaultValue = false)]
        public int MinimumAmount { get; set; }

        /// <summary>
        /// Gets or Sets ProductCode
        /// </summary>
        [DataMember(Name = "product_code", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "credit_time", IsRequired = true, EmitDefaultValue = false)]
        public int CreditTime { get; set; }

        /// <summary>
        /// The startup fee for the payment product 
        /// </summary>
        /// <value>The startup fee for the payment product </value>
        [DataMember(Name = "origination_fee", IsRequired = true, EmitDefaultValue = false)]
        public int OriginationFee { get; set; }

        /// <summary>
        /// The notification fee for the payment product 
        /// </summary>
        /// <value>The notification fee for the payment product </value>
        [DataMember(Name = "notification_fee", IsRequired = true, EmitDefaultValue = false)]
        public int NotificationFee { get; set; }

        /// <summary>
        /// The interest rate for the payment product. 
        /// </summary>
        /// <value>The interest rate for the payment product. </value>
        [DataMember(Name = "annual_interest_rate", IsRequired = true, EmitDefaultValue = false)]
        public string AnnualInterestRate { get; set; }

        /// <summary>
        /// The effective annual interest rate for the payment product 
        /// </summary>
        /// <value>The effective annual interest rate for the payment product </value>
        [DataMember(Name = "effective_annual_interest_rate", EmitDefaultValue = false)]
        public string EffectiveAnnualInterestRate { get; private set; }

        /// <summary>
        /// Returns false as EffectiveAnnualInterestRate should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeEffectiveAnnualInterestRate()
        {
            return false;
        }
        ...
        /// </summary>
        /// <value>The total amount to pay</value>
        ...
        /// </summary>
        /// <value>The amount to pay pr month</value>
        [DataMember(Name = "monthly_amount", EmitDefaultValue = false)]
        public int MonthlyAmount { get; private set; }

        /// <summary>
        /// Returns false as MonthlyAmount should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeMonthlyAmount()
        {
            return false;
        }

        /// <summary>
        /// The amount to pay in the first invoice. Origantion fee is added to the first invoice. 
        /// </summary>
        /// <value>The amount to pay in the first invoice. Origantion fee is added to the first invoice. </value>
        [DataMember(Name = "first_monthly_amount", EmitDefaultValue = false)]
        public int FirstMonthlyAmount { get; private set; }

        /// <summary>
        /// Returns false as FirstMonthlyAmount should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeFirstMonthlyAmount()
        {
            return false;
        }
        ...
        /// </summary>
        /// <value>The limit for when instabank will require a full applicant during payment. </value>
        [DataMember(Name = "require_applicant_amount", EmitDefaultValue = false)]
        public int RequireApplicantAmount { get; set; }

        /// <summary>
        /// Gets or Sets LoanExample
        /// </summary>
        [DataMember(Name = "loan_example", EmitDefaultValue = false)]
        public InstabankFinanceProductLoanExample LoanExample { get; set; }

        /// <summary>
        /// Url for a custom branding image
        /// </summary>
        /// <value>Url for a custom branding image</value>
        [DataMember(Name = "branding_image_url", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstabankInstallmentProduct {\n");
            sb.Append("  MinimumAmount: ").Append(MinimumAmount).Append("\n");
            sb.Append("  ProductCode: ").Append(ProductCode).Append("\n");
            sb.Append("  CreditTime: ").Append(CreditTime).Append("\n");
            sb.Append("  OriginationFee: ").Append(OriginationFee).Append("\n");
            sb.Append("  NotificationFee: ").Append(NotificationFee).Append("\n");
            sb.Append("  AnnualInterestRate: ").Append(AnnualInterestRate).Append("\n");
            sb.Append("  EffectiveAnnualInterestRate: ").Append(EffectiveAnnualInterestRate).Append("\n");
            sb.Append("  TotalAmount: ").Append(TotalAmount).Append("\n");
            sb.Append("  MonthlyAmount: ").Append(MonthlyAmount).Append("\n");
            sb.Append("  FirstMonthlyAmount: ").Append(FirstMonthlyAmount).Append("\n");
            sb.Append("  RequireApplicantAmount: ").Append(RequireApplicantAmount).Append("\n");
            sb.Append("  LoanExample: ").Append(LoanExample).Append("\n");
            sb.Append("  BrandingImageUrl: ").Append(BrandingImageUrl).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as InstabankInstallmentProduct);
        }

        /// <summary>
        /// Returns true if InstabankInstallmentProduct instances are equal
        /// </summary>
        /// <param name="input">Instance of InstabankInstallmentProduct to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstabankInstallmentProduct input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CreditTime == input.CreditTime ||
                    this.CreditTime.Equals(input.CreditTime)
                ) && 
                (
                ...
                (
                    this.NotificationFee == input.NotificationFee ||
                    this.NotificationFee.Equals(input.NotificationFee)
                ) && 
                (
                ...
                (
                    this.EffectiveAnnualInterestRate == input.EffectiveAnnualInterestRate ||
                    (this.EffectiveAnnualInterestRate != null &&
                    this.EffectiveAnnualInterestRate.Equals(input.EffectiveAnnualInterestRate))
                ) && 
                (
                ...
                (
                    ...
                    this.MonthlyAmount.Equals(input.MonthlyAmount)
                ) && 
                (
                    this.FirstMonthlyAmount == input.FirstMonthlyAmount ||
                    this.FirstMonthlyAmount.Equals(input.FirstMonthlyAmount)
                ) && 
                (
                    this.RequireApplicantAmount == input.RequireApplicantAmount ||
                    this.RequireApplicantAmount.Equals(input.RequireApplicantAmount)
                ) && 
                (
                    this.LoanExample == input.LoanExample ||
                    (this.LoanExample != null &&
                    this.LoanExample.Equals(input.LoanExample))
                ) && 
                (
                    this.BrandingImageUrl == input.BrandingImageUrl ||
                    (this.BrandingImageUrl != null &&
                    this.BrandingImageUrl.Equals(input.BrandingImageUrl))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.CreditTime.GetHashCode();
                hashCode = hashCode * 59 + this.OriginationFee.GetHashCode();
                hashCode = hashCode * 59 + this.NotificationFee.GetHashCode();
                if (this.AnnualInterestRate != null)
                    hashCode = hashCode * 59 + this.AnnualInterestRate.GetHashCode();
                if (this.EffectiveAnnualInterestRate != null)
                    hashCode = hashCode * 59 + this.EffectiveAnnualInterestRate.GetHashCode();
                hashCode = hashCode * 59 + this.TotalAmount.GetHashCode();
                hashCode = hashCode * 59 + this.MonthlyAmount.GetHashCode();
                hashCode = hashCode * 59 + this.FirstMonthlyAmount.GetHashCode();
                hashCode = hashCode * 59 + this.RequireApplicantAmount.GetHashCode();
                if (this.LoanExample != null)
                    hashCode = hashCode * 59 + this.LoanExample.GetHashCode();
                if (this.BrandingImageUrl != null)
                    hashCode = hashCode * 59 + this.BrandingImageUrl.GetHashCode();
                return hashCode;
            }
        }
        ...
        {
            // MinimumAmount (int) minimum
            if(this.MinimumAmount < (int)1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for MinimumAmount, must be a value greater than or equal to 1.", new [] { "MinimumAmount" });
            }

            // CreditTime (int) minimum
            if(this.CreditTime < (int)1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CreditTime, must be a value greater than or equal to 1.", new [] { "CreditTime" });
            }

            // OriginationFee (int) minimum
            if(this.OriginationFee < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for OriginationFee, must be a value greater than or equal to 0.", new [] { "OriginationFee" });
            }

            // NotificationFee (int) minimum
            if(this.NotificationFee < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NotificationFee, must be a value greater than or equal to 0.", new [] { "NotificationFee" });
            }

            // RequireApplicantAmount (int) minimum
            if(this.RequireApplicantAmount < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for RequireApplicantAmount, must be a value greater than or equal to 0.", new [] { "RequireApplicantAmount" });
            }
