...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class CheckoutConfig : IEquatable<CheckoutConfig>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckoutConfig" /> class.
        /// </summary>
        /// <param name="gateways">gateways.</param>
        public CheckoutConfig(CheckoutConfigGateways gateways = default(CheckoutConfigGateways))
        {
        ...
        public CheckoutConfigGateways Gateways { get; set; }
        ...
        {
            return this.Equals(input as CheckoutConfig);
        }

        /// <summary>
        /// Returns true if CheckoutConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of CheckoutConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CheckoutConfig input)
        {
            if (input == null)
                return false;
