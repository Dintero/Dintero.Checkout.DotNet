...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransactionEvent_correction")]
    public partial class TransactionEventCorrection : IEquatable<TransactionEventCorrection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionEventCorrection" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionEventCorrection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionEventCorrection" /> class.
        /// </summary>
        /// <param name="status">status the transaction was corrected to  (required).</param>
        /// <param name="remainingCaptureAmount">Monetary amount in smallest unit for the currency  (required).</param>
        /// <param name="remainingRefundAmount">Monetary amount in smallest unit for the currency  (required).</param>
        /// <param name="remainingVoidAmount">Monetary amount in smallest unit for the currency  (required).</param>
        public TransactionEventCorrection(string status = default(string), int remainingCaptureAmount = default(int), int remainingRefundAmount = default(int), int remainingVoidAmount = default(int))
        {
            // to ensure "status" is required (not null)
            this.Status = status ?? throw new ArgumentNullException("status is a required property for TransactionEventCorrection and cannot be null");
            this.RemainingCaptureAmount = remainingCaptureAmount;
            this.RemainingRefundAmount = remainingRefundAmount;
            this.RemainingVoidAmount = remainingVoidAmount;
        }

        /// <summary>
        /// status the transaction was corrected to 
        /// </summary>
        /// <value>status the transaction was corrected to </value>
        ...
        /// </summary>
        /// <value>Monetary amount in smallest unit for the currency </value>
        [DataMember(Name = "remaining_capture_amount", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Monetary amount in smallest unit for the currency </value>
        [DataMember(Name = "remaining_refund_amount", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Monetary amount in smallest unit for the currency </value>
        [DataMember(Name = "remaining_void_amount", IsRequired = true, EmitDefaultValue = false)]
        public int RemainingVoidAmount { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionEventCorrection {\n");
            sb.Append("  Status: ").Append(Status).Append("\n");
            sb.Append("  RemainingCaptureAmount: ").Append(RemainingCaptureAmount).Append("\n");
            sb.Append("  RemainingRefundAmount: ").Append(RemainingRefundAmount).Append("\n");
            sb.Append("  RemainingVoidAmount: ").Append(RemainingVoidAmount).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TransactionEventCorrection);
        }

        /// <summary>
        /// Returns true if TransactionEventCorrection instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionEventCorrection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionEventCorrection input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.RemainingCaptureAmount == input.RemainingCaptureAmount ||
                    this.RemainingCaptureAmount.Equals(input.RemainingCaptureAmount)
                ) && 
                (
                    this.RemainingRefundAmount == input.RemainingRefundAmount ||
                    this.RemainingRefundAmount.Equals(input.RemainingRefundAmount)
                ) && 
                (
                    this.RemainingVoidAmount == input.RemainingVoidAmount ||
                    this.RemainingVoidAmount.Equals(input.RemainingVoidAmount)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.RemainingCaptureAmount.GetHashCode();
                hashCode = hashCode * 59 + this.RemainingRefundAmount.GetHashCode();
                hashCode = hashCode * 59 + this.RemainingVoidAmount.GetHashCode();
                return hashCode;
            }
        }
        ...
        {
            // RemainingCaptureAmount (int) minimum
            if(this.RemainingCaptureAmount < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for RemainingCaptureAmount, must be a value greater than or equal to 0.", new [] { "RemainingCaptureAmount" });
            }

            // RemainingRefundAmount (int) minimum
            if(this.RemainingRefundAmount < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for RemainingRefundAmount, must be a value greater than or equal to 0.", new [] { "RemainingRefundAmount" });
            }

            // RemainingVoidAmount (int) minimum
            if(this.RemainingVoidAmount < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for RemainingVoidAmount, must be a value greater than or equal to 0.", new [] { "RemainingVoidAmount" });
            }
