...
{
    /// <summary>
    /// TransactionSwishAllOfEvents
    /// </summary>
    [DataContract(Name = "TransactionSwish_allOf_events")]
    public partial class TransactionSwishAllOfEvents : IEquatable<TransactionSwishAllOfEvents>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionSwishAllOfEvents" /> class.
        /// </summary>
        /// <param name="metadata">metadata.</param>
        public TransactionSwishAllOfEvents(TransactionSwishAllOfMetadata metadata = default(TransactionSwishAllOfMetadata))
        {
        ...
        public TransactionSwishAllOfMetadata Metadata { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionSwishAllOfEvents {\n");
        ...
        {
            return this.Equals(input as TransactionSwishAllOfEvents);
        }

        /// <summary>
        /// Returns true if TransactionSwishAllOfEvents instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionSwishAllOfEvents to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionSwishAllOfEvents input)
        {
            if (input == null)
                return false;
