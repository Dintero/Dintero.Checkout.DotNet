...
{
    /// <summary>
    /// IngenicoPaymentDetails
    /// </summary>
    [DataContract(Name = "IngenicoPaymentDetails")]
    ...
    public partial class IngenicoPaymentDetails : IEquatable<IngenicoPaymentDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoPaymentDetails" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IngenicoPaymentDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoPaymentDetails" /> class.
        /// </summary>
        /// <param name="paymentProductType">The payment product type corresponding to this transaction  (required).</param>
        public IngenicoPaymentDetails(string paymentProductType = default(string))
        {
            // to ensure "paymentProductType" is required (not null)
            this.PaymentProductType = paymentProductType ?? throw new ArgumentNullException("paymentProductType is a required property for IngenicoPaymentDetails and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IngenicoPaymentDetails {\n");
        ...
        {
            return this.Equals(input as IngenicoPaymentDetails);
        }

        /// <summary>
        /// Returns true if IngenicoPaymentDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of IngenicoPaymentDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IngenicoPaymentDetails input)
        {
            if (input == null)
                return false;
