...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// QROptions
    /// </summary>
    [DataContract(Name = "QROptions")]
    public partial class QROptions : IEquatable<QROptions>, IValidatableObject
    {
        /// <summary>
        /// Defines Format
        /// </summary>
        ...
        /// <param name="size">Size of the QR code. The code is a square, so width and height are the same .</param>
        public QROptions(FormatEnum? format = default(FormatEnum?), int size = default(int))
        {
            this.Format = format;
            this.Size = size;
        }
        ...
        /// </summary>
        /// <value>Size of the QR code. The code is a square, so width and height are the same </value>
        ...
        {
            return this.Equals(input as QROptions);
        }

        /// <summary>
        /// Returns true if QROptions instances are equal
        /// </summary>
        /// <param name="input">Instance of QROptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QROptions input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Size (int) minimum
            if(this.Size < (int)300)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Size, must be a value greater than or equal to 300.", new [] { "Size" });
            }
