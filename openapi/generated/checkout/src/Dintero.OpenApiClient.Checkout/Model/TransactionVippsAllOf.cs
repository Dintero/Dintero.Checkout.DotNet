...
{
    /// <summary>
    /// TransactionVippsAllOf
    /// </summary>
    [DataContract(Name = "TransactionVipps_allOf")]
    public partial class TransactionVippsAllOf : IEquatable<TransactionVippsAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionVippsAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionVippsAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionVippsAllOf" /> class.
        /// </summary>
        ...
        public TransactionVippsAllOf(PaymentProductTypeEnum paymentProductType = default(PaymentProductTypeEnum), List<TransactionVippsAllOfEvents> events = default(List<TransactionVippsAllOfEvents>), TransactionVippsAllOfMetadata1 metadata = default(TransactionVippsAllOfMetadata1))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionVippsAllOf {\n");
        ...
        {
            return this.Equals(input as TransactionVippsAllOf);
        }

        /// <summary>
        /// Returns true if TransactionVippsAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionVippsAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionVippsAllOf input)
        {
            if (input == null)
                return false;
