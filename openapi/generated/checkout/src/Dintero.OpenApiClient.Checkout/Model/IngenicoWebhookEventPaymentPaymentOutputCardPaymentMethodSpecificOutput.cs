...
{
    /// <summary>
    /// IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutput
    /// </summary>
    [DataContract(Name = "IngenicoWebhookEvent_payment_paymentOutput_cardPaymentMethodSpecificOutput")]
    public partial class IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutput : IEquatable<IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutput" /> class.
        /// </summary>
        /// <param name="paymentProductId">paymentProductId.</param>
        /// <param name="authorisationCode">authorisationCode.</param>
        /// <param name="card">card.</param>
        /// <param name="fraudResults">fraudResults.</param>
        /// <param name="threeDSecureResults">threeDSecureResults.</param>
        public IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutput(decimal paymentProductId = default(decimal), string authorisationCode = default(string), IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutputCard card = default(IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutputCard), IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutputFraudResults fraudResults = default(IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutputFraudResults), IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutputThreeDSecureResults threeDSecureResults = default(IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutputThreeDSecureResults))
        {
        ...
        /// <summary>
        /// Gets or Sets PaymentProductId
        /// </summary>
        [DataMember(Name = "paymentProductId", EmitDefaultValue = false)]
        public decimal PaymentProductId { get; set; }

        /// <summary>
        /// Gets or Sets AuthorisationCode
        /// </summary>
        ...
        public IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutputCard Card { get; set; }

        /// <summary>
        /// Gets or Sets FraudResults
        /// </summary>
        [DataMember(Name = "fraudResults", EmitDefaultValue = false)]
        public IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutputFraudResults FraudResults { get; set; }

        /// <summary>
        /// Gets or Sets ThreeDSecureResults
        /// </summary>
        [DataMember(Name = "threeDSecureResults", EmitDefaultValue = false)]
        public IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutputThreeDSecureResults ThreeDSecureResults { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutput {\n");
        ...
        {
            return this.Equals(input as IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutput);
        }

        /// <summary>
        /// Returns true if IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutput input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.PaymentProductId == input.PaymentProductId ||
                    this.PaymentProductId.Equals(input.PaymentProductId)
                ) && 
                (
                ...
                (
                    this.ThreeDSecureResults == input.ThreeDSecureResults ||
                    (this.ThreeDSecureResults != null &&
                    this.ThreeDSecureResults.Equals(input.ThreeDSecureResults))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = hashCode * 59 + this.PaymentProductId.GetHashCode();
                ...
                if (this.ThreeDSecureResults != null)
                    hashCode = hashCode * 59 + this.ThreeDSecureResults.GetHashCode();
                return hashCode;
            }
        }
