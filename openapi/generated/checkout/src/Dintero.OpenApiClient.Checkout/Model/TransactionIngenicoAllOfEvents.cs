...
{
    /// <summary>
    /// TransactionIngenicoAllOfEvents
    /// </summary>
    [DataContract(Name = "TransactionIngenico_allOf_events")]
    public partial class TransactionIngenicoAllOfEvents : IEquatable<TransactionIngenicoAllOfEvents>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionIngenicoAllOfEvents" /> class.
        /// </summary>
        /// <param name="metadata">metadata.</param>
        public TransactionIngenicoAllOfEvents(TransactionIngenicoAllOfMetadata metadata = default(TransactionIngenicoAllOfMetadata))
        {
        ...
        public TransactionIngenicoAllOfMetadata Metadata { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionIngenicoAllOfEvents {\n");
        ...
        {
            return this.Equals(input as TransactionIngenicoAllOfEvents);
        }

        /// <summary>
        /// Returns true if TransactionIngenicoAllOfEvents instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionIngenicoAllOfEvents to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionIngenicoAllOfEvents input)
        {
            if (input == null)
                return false;
