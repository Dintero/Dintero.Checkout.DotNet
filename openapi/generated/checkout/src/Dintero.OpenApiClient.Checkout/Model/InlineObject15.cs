...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class InlineObject15 : IEquatable<InlineObject15>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>* synchronous - (default) the answer will come directly in the response </value>
        ...
        /// <summary>
        /// Defines CreditProviders
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum CreditProvidersEnum
        {
            /// <summary>
            /// Enum Collector for value: collector
            /// </summary>
        ...
        /// <summary>
        /// Gets or Sets CreditProviders
        /// </summary>
        [DataMember(Name = "credit_providers", IsRequired = true, EmitDefaultValue = false)]
        public List<CreditProvidersEnum> CreditProviders { get; set; }
        /// <summary>
        ...
        /// <param name="checkType">* synchronous - (default) the answer will come directly in the response .</param>
        /// <param name="creditProviders">creditProviders (required).</param>
        /// <param name="amount">reward amount for the the ref used, monetary amount in smallest unit for the currency  (required).</param>
        ...
        public InlineObject15(CreditchecksStore store = default(CreditchecksStore), CheckTypeEnum? checkType = default(CheckTypeEnum?), List<CreditProvidersEnum> creditProviders = default(List<CreditProvidersEnum>), int amount = default(int), string currency = default(string), CreditchecksApplicant applicant = default(CreditchecksApplicant))
        {
            // to ensure "creditProviders" is required (not null)
            this.CreditProviders = creditProviders ?? throw new ArgumentNullException("creditProviders is a required property for InlineObject15 and cannot be null");
            this.Amount = amount;
            // to ensure "currency" is required (not null)
            this.Currency = currency ?? throw new ArgumentNullException("currency is a required property for InlineObject15 and cannot be null");
            // to ensure "applicant" is required (not null)
            this.Applicant = applicant ?? throw new ArgumentNullException("applicant is a required property for InlineObject15 and cannot be null");
            this.Store = store;
        ...
        public CreditchecksStore Store { get; set; }

        /// <summary>
        /// reward amount for the the ref used, monetary amount in smallest unit for the currency 
        /// </summary>
        /// <value>reward amount for the the ref used, monetary amount in smallest unit for the currency </value>
        ...
        public CreditchecksApplicant Applicant { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CreditProviders: ").Append(CreditProviders).Append("\n");
        ...
        public bool Equals(InlineObject15 input)
        {
            ...
            return 
                ...
                (
                    this.CreditProviders == input.CreditProviders ||
                    this.CreditProviders.SequenceEqual(input.CreditProviders)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.CreditProviders.GetHashCode();
