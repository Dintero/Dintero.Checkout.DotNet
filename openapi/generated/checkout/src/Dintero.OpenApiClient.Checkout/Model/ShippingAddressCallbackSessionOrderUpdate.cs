...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ShippingAddressCallbackSessionOrderUpdate")]
    public partial class ShippingAddressCallbackSessionOrderUpdate : IEquatable<ShippingAddressCallbackSessionOrderUpdate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShippingAddressCallbackSessionOrderUpdate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ShippingAddressCallbackSessionOrderUpdate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ShippingAddressCallbackSessionOrderUpdate" /> class.
        /// </summary>
        /// <param name="amount">The amount to authorize/capture including VAT and discounts. In smallest unit for the currency, e.g. cents  (required).</param>
        ...
        public ShippingAddressCallbackSessionOrderUpdate(int amount = default(int), string currency = default(string), int vatAmount = default(int), List<OrderItem> items = default(List<OrderItem>), List<string> discountCodes = default(List<string>))
        {
            this.Amount = amount;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShippingAddressCallbackSessionOrderUpdate {\n");
        ...
        {
            return this.Equals(input as ShippingAddressCallbackSessionOrderUpdate);
        }

        /// <summary>
        /// Returns true if ShippingAddressCallbackSessionOrderUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of ShippingAddressCallbackSessionOrderUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShippingAddressCallbackSessionOrderUpdate input)
        {
            if (input == null)
                return false;
