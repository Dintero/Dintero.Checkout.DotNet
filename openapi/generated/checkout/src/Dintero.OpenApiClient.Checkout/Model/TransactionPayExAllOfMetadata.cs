...
{
    /// <summary>
    /// TransactionPayExAllOfMetadata
    /// </summary>
    [DataContract(Name = "TransactionPayEx_allOf_metadata")]
    public partial class TransactionPayExAllOfMetadata : IEquatable<TransactionPayExAllOfMetadata>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionPayExAllOfMetadata" /> class.
        /// </summary>
        /// <param name="payextransactionid">payextransactionid.</param>
        /// <param name="payextransactionnumber">payextransactionnumber.</param>
        /// <param name="payextransactiontype">payextransactiontype.</param>
        /// <param name="payextransactionstate">payextransactionstate.</param>
        /// <param name="payextransactioncreated">payextransactioncreated.</param>
        /// <param name="payextransactionpayeeReference">payextransactionpayeeReference.</param>
        public TransactionPayExAllOfMetadata(string payextransactionid = default(string), decimal payextransactionnumber = default(decimal), string payextransactiontype = default(string), string payextransactionstate = default(string), DateTime payextransactioncreated = default(DateTime), string payextransactionpayeeReference = default(string))
        {
            this.Payextransactionid = payextransactionid;
            this.Payextransactionnumber = payextransactionnumber;
            this.Payextransactiontype = payextransactiontype;
            this.Payextransactionstate = payextransactionstate;
            this.Payextransactioncreated = payextransactioncreated;
            this.PayextransactionpayeeReference = payextransactionpayeeReference;
        }

        /// <summary>
        /// Gets or Sets Payextransactionid
        /// </summary>
        [DataMember(Name = "payex:transaction:id", EmitDefaultValue = false)]
        public string Payextransactionid { get; set; }

        /// <summary>
        /// Gets or Sets Payextransactionnumber
        /// </summary>
        [DataMember(Name = "payex:transaction:number", EmitDefaultValue = false)]
        public decimal Payextransactionnumber { get; set; }

        /// <summary>
        /// Gets or Sets Payextransactiontype
        /// </summary>
        [DataMember(Name = "payex:transaction:type", EmitDefaultValue = false)]
        public string Payextransactiontype { get; set; }

        /// <summary>
        /// Gets or Sets Payextransactionstate
        /// </summary>
        [DataMember(Name = "payex:transaction:state", EmitDefaultValue = false)]
        public string Payextransactionstate { get; set; }

        /// <summary>
        /// Gets or Sets Payextransactioncreated
        /// </summary>
        [DataMember(Name = "payex:transaction:created", EmitDefaultValue = false)]
        public DateTime Payextransactioncreated { get; set; }

        /// <summary>
        /// Gets or Sets PayextransactionpayeeReference
        /// </summary>
        [DataMember(Name = "payex:transaction:payee_reference", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionPayExAllOfMetadata {\n");
            sb.Append("  Payextransactionid: ").Append(Payextransactionid).Append("\n");
            sb.Append("  Payextransactionnumber: ").Append(Payextransactionnumber).Append("\n");
            sb.Append("  Payextransactiontype: ").Append(Payextransactiontype).Append("\n");
            sb.Append("  Payextransactionstate: ").Append(Payextransactionstate).Append("\n");
            sb.Append("  Payextransactioncreated: ").Append(Payextransactioncreated).Append("\n");
            sb.Append("  PayextransactionpayeeReference: ").Append(PayextransactionpayeeReference).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TransactionPayExAllOfMetadata);
        }

        /// <summary>
        /// Returns true if TransactionPayExAllOfMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionPayExAllOfMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionPayExAllOfMetadata input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.Payextransactionid == input.Payextransactionid ||
                    (this.Payextransactionid != null &&
                    this.Payextransactionid.Equals(input.Payextransactionid))
                ) && 
                (
                    this.Payextransactionnumber == input.Payextransactionnumber ||
                    this.Payextransactionnumber.Equals(input.Payextransactionnumber)
                ) && 
                (
                    this.Payextransactiontype == input.Payextransactiontype ||
                    (this.Payextransactiontype != null &&
                    this.Payextransactiontype.Equals(input.Payextransactiontype))
                ) && 
                (
                    this.Payextransactionstate == input.Payextransactionstate ||
                    (this.Payextransactionstate != null &&
                    this.Payextransactionstate.Equals(input.Payextransactionstate))
                ) && 
                (
                    this.Payextransactioncreated == input.Payextransactioncreated ||
                    (this.Payextransactioncreated != null &&
                    this.Payextransactioncreated.Equals(input.Payextransactioncreated))
                ) && 
                (
                    this.PayextransactionpayeeReference == input.PayextransactionpayeeReference ||
                    (this.PayextransactionpayeeReference != null &&
                    this.PayextransactionpayeeReference.Equals(input.PayextransactionpayeeReference))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.Payextransactionid != null)
                    hashCode = hashCode * 59 + this.Payextransactionid.GetHashCode();
                hashCode = hashCode * 59 + this.Payextransactionnumber.GetHashCode();
                if (this.Payextransactiontype != null)
                    hashCode = hashCode * 59 + this.Payextransactiontype.GetHashCode();
                if (this.Payextransactionstate != null)
                    hashCode = hashCode * 59 + this.Payextransactionstate.GetHashCode();
                if (this.Payextransactioncreated != null)
                    hashCode = hashCode * 59 + this.Payextransactioncreated.GetHashCode();
                if (this.PayextransactionpayeeReference != null)
                    hashCode = hashCode * 59 + this.PayextransactionpayeeReference.GetHashCode();
                return hashCode;
            }
        }
