...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// SignatureV0AllOf
    /// </summary>
    [DataContract(Name = "SignatureV0_allOf")]
    public partial class SignatureV0AllOf : IEquatable<SignatureV0AllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SignatureV0AllOf" /> class.
        /// </summary>
        /// <param name="createdBy">createdBy.</param>
        /// <param name="signature">signature.</param>
        public SignatureV0AllOf(string createdBy = default(string), SignatureV0AllOfSignature signature = default(SignatureV0AllOfSignature))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SignatureV0AllOf {\n");
        ...
        {
            return this.Equals(input as SignatureV0AllOf);
        }

        /// <summary>
        /// Returns true if SignatureV0AllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SignatureV0AllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SignatureV0AllOf input)
        {
            if (input == null)
                return false;
