...
{
    /// <summary>
    /// TransactionIngenicoAllOfCard
    /// </summary>
    [DataContract(Name = "TransactionIngenico_allOf_card")]
    public partial class TransactionIngenicoAllOfCard : IEquatable<TransactionIngenicoAllOfCard>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionIngenicoAllOfCard" /> class.
        /// </summary>
        ...
        public TransactionIngenicoAllOfCard(string brand = default(string), string maskedPan = default(string), string expiryDate = default(string), AuthenticationStatusEnum? authenticationStatus = default(AuthenticationStatusEnum?))
        {
            this.Brand = brand;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionIngenicoAllOfCard {\n");
        ...
        {
            return this.Equals(input as TransactionIngenicoAllOfCard);
        }

        /// <summary>
        /// Returns true if TransactionIngenicoAllOfCard instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionIngenicoAllOfCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionIngenicoAllOfCard input)
        {
            if (input == null)
                return false;
