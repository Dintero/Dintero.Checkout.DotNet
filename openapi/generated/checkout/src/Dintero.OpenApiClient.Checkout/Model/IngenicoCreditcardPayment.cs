...
{
    /// <summary>
    /// IngenicoCreditcardPayment
    /// </summary>
    [DataContract(Name = "IngenicoCreditcardPayment")]
    [JsonConverter(typeof(JsonSubtypes), "PaymentProductType")]
    public partial class IngenicoCreditcardPayment : Payment, IEquatable<IngenicoCreditcardPayment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoCreditcardPayment" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IngenicoCreditcardPayment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoCreditcardPayment" /> class.
        /// </summary>
        /// <param name="paymentProductType">The payment product type corresponding to this transaction  (required) (default to &quot;IngenicoCreditcardPayment&quot;).</param>
        /// <param name="clientSessionId">Id of the session we&#39;re paying .</param>
        /// <param name="encryptedCustomerInput">Data that was encrypted client side containing all customer entered data elements like card data. Note: Because this data can only be submitted once to our system and contains encrypted card data you should not store it. As the data was captured within the context of a client session you also need to submit it to us before the session has expired.  (required).</param>
        public IngenicoCreditcardPayment(string paymentProductType = "IngenicoCreditcardPayment", string clientSessionId = default(string), string encryptedCustomerInput = default(string)) : base()
        {
            // to ensure "paymentProductType" is required (not null)
            this.PaymentProductType = paymentProductType ?? throw new ArgumentNullException("paymentProductType is a required property for IngenicoCreditcardPayment and cannot be null");
            // to ensure "encryptedCustomerInput" is required (not null)
            this.EncryptedCustomerInput = encryptedCustomerInput ?? throw new ArgumentNullException("encryptedCustomerInput is a required property for IngenicoCreditcardPayment and cannot be null");
        ...
        /// <summary>
        /// Id of the session we&#39;re paying 
        /// </summary>
        /// <value>Id of the session we&#39;re paying </value>
        [DataMember(Name = "client_session_id", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Data that was encrypted client side containing all customer entered data elements like card data. Note: Because this data can only be submitted once to our system and contains encrypted card data you should not store it. As the data was captured within the context of a client session you also need to submit it to us before the session has expired. </value>
        [DataMember(Name = "encrypted_customer_input", IsRequired = true, EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IngenicoCreditcardPayment {\n");
            ...
            sb.Append("  EncryptedCustomerInput: ").Append(EncryptedCustomerInput).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as IngenicoCreditcardPayment);
        }

        /// <summary>
        /// Returns true if IngenicoCreditcardPayment instances are equal
        /// </summary>
        /// <param name="input">Instance of IngenicoCreditcardPayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IngenicoCreditcardPayment input)
        {
            if (input == null)
                return false;
            ...
            return base.Equals(input) && 
                ...
                (
                    this.EncryptedCustomerInput == input.EncryptedCustomerInput ||
                    (this.EncryptedCustomerInput != null &&
                    this.EncryptedCustomerInput.Equals(input.EncryptedCustomerInput))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EncryptedCustomerInput != null)
                    hashCode = hashCode * 59 + this.EncryptedCustomerInput.GetHashCode();
                return hashCode;
            }
        }
