...
{
    /// <summary>
    /// BamboraPaymentOperationAllOf
    /// </summary>
    [DataContract(Name = "BamboraPaymentOperation_allOf")]
    public partial class BamboraPaymentOperationAllOf : IEquatable<BamboraPaymentOperationAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraPaymentOperationAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BamboraPaymentOperationAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraPaymentOperationAllOf" /> class.
        /// </summary>
        /// <param name="session">session (required).</param>
        /// <param name="href">Contains the URI to initiate a payment.  (required).</param>
        public BamboraPaymentOperationAllOf(BamboraPaymentOperationAllOfSession session = default(BamboraPaymentOperationAllOfSession), string href = default(string))
        {
            // to ensure "session" is required (not null)
            this.Session = session ?? throw new ArgumentNullException("session is a required property for BamboraPaymentOperationAllOf and cannot be null");
            // to ensure "href" is required (not null)
            this.Href = href ?? throw new ArgumentNullException("href is a required property for BamboraPaymentOperationAllOf and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BamboraPaymentOperationAllOf {\n");
        ...
        {
            return this.Equals(input as BamboraPaymentOperationAllOf);
        }

        /// <summary>
        /// Returns true if BamboraPaymentOperationAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of BamboraPaymentOperationAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BamboraPaymentOperationAllOf input)
        {
            if (input == null)
                return false;
