...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// SessionProfile
    /// </summary>
    [DataContract(Name = "SessionProfile")]
    public partial class SessionProfile : IEquatable<SessionProfile>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="configuration">Override configuration for the profile. .</param>
        /// <param name="profileId">configuration profile  (required).</param>
        /// <param name="express">express.</param>
        public SessionProfile(SessionUrls url = default(SessionUrls), SessionCustomerTokensCustomer customer = default(SessionCustomerTokensCustomer), SessionOrder order = default(SessionOrder), DateTime expiresAt = default(DateTime), PaymentConfiguration configuration = default(PaymentConfiguration), string profileId = default(string), SessionExpressExpress express = default(SessionExpressExpress))
        {
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url is a required property for SessionProfile and cannot be null");
            // to ensure "order" is required (not null)
            this.Order = order ?? throw new ArgumentNullException("order is a required property for SessionProfile and cannot be null");
            // to ensure "profileId" is required (not null)
            this.ProfileId = profileId ?? throw new ArgumentNullException("profileId is a required property for SessionProfile and cannot be null");
        ...
        public SessionCustomerTokensCustomer Customer { get; set; }
        ...
        /// </summary>
        /// <value>Override configuration for the profile. </value>
        ...
        /// </summary>
        /// <value>configuration profile </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SessionProfile {\n");
        ...
        {
            return this.Equals(input as SessionProfile);
        }

        /// <summary>
        /// Returns true if SessionProfile instances are equal
        /// </summary>
        /// <param name="input">Instance of SessionProfile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SessionProfile input)
        {
            if (input == null)
                return false;
