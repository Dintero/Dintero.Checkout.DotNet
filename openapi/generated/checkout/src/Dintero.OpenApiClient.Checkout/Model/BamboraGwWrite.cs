...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// BamboraGwWrite
    /// </summary>
    [DataContract(Name = "BamboraGwWrite")]
    public partial class BamboraGwWrite : IEquatable<BamboraGwWrite>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraGwWrite" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BamboraGwWrite() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraGwWrite" /> class.
        /// </summary>
        /// <param name="checkoutApiUrl">checkoutApiUrl (required).</param>
        /// <param name="merchantApiUrl">merchantApiUrl (required).</param>
        /// <param name="transactionApiUrl">transactionApiUrl (required).</param>
        /// <param name="walletApiUrl">walletApiUrl (required).</param>
        /// <param name="merchantNumber">merchantNumber (required).</param>
        /// <param name="accessToken">accessToken (required).</param>
        /// <param name="secretToken">secretToken (required).</param>
        /// <param name="md5Key">md5Key (required).</param>
        public BamboraGwWrite(string checkoutApiUrl = default(string), string merchantApiUrl = default(string), string transactionApiUrl = default(string), string walletApiUrl = default(string), string merchantNumber = default(string), string accessToken = default(string), string secretToken = default(string), string md5Key = default(string))
        {
            // to ensure "checkoutApiUrl" is required (not null)
            this.CheckoutApiUrl = checkoutApiUrl ?? throw new ArgumentNullException("checkoutApiUrl is a required property for BamboraGwWrite and cannot be null");
            // to ensure "merchantApiUrl" is required (not null)
            this.MerchantApiUrl = merchantApiUrl ?? throw new ArgumentNullException("merchantApiUrl is a required property for BamboraGwWrite and cannot be null");
            // to ensure "transactionApiUrl" is required (not null)
            this.TransactionApiUrl = transactionApiUrl ?? throw new ArgumentNullException("transactionApiUrl is a required property for BamboraGwWrite and cannot be null");
            // to ensure "walletApiUrl" is required (not null)
            this.WalletApiUrl = walletApiUrl ?? throw new ArgumentNullException("walletApiUrl is a required property for BamboraGwWrite and cannot be null");
            // to ensure "merchantNumber" is required (not null)
            this.MerchantNumber = merchantNumber ?? throw new ArgumentNullException("merchantNumber is a required property for BamboraGwWrite and cannot be null");
            // to ensure "accessToken" is required (not null)
            this.AccessToken = accessToken ?? throw new ArgumentNullException("accessToken is a required property for BamboraGwWrite and cannot be null");
            // to ensure "secretToken" is required (not null)
            this.SecretToken = secretToken ?? throw new ArgumentNullException("secretToken is a required property for BamboraGwWrite and cannot be null");
            // to ensure "md5Key" is required (not null)
            this.Md5Key = md5Key ?? throw new ArgumentNullException("md5Key is a required property for BamboraGwWrite and cannot be null");
        }
        ...
        /// <summary>
        /// Gets or Sets CheckoutApiUrl
        /// </summary>
        [DataMember(Name = "checkout_api_url", IsRequired = true, EmitDefaultValue = false)]
        public string CheckoutApiUrl { get; set; }

        /// <summary>
        /// Gets or Sets MerchantApiUrl
        /// </summary>
        [DataMember(Name = "merchant_api_url", IsRequired = true, EmitDefaultValue = false)]
        public string MerchantApiUrl { get; set; }

        /// <summary>
        /// Gets or Sets TransactionApiUrl
        /// </summary>
        [DataMember(Name = "transaction_api_url", IsRequired = true, EmitDefaultValue = false)]
        public string TransactionApiUrl { get; set; }

        /// <summary>
        /// Gets or Sets WalletApiUrl
        /// </summary>
        [DataMember(Name = "wallet_api_url", IsRequired = true, EmitDefaultValue = false)]
        public string WalletApiUrl { get; set; }

        /// <summary>
        /// Gets or Sets MerchantNumber
        /// </summary>
        [DataMember(Name = "merchant_number", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "secret_token", IsRequired = true, EmitDefaultValue = false)]
        public string SecretToken { get; set; }

        /// <summary>
        /// Gets or Sets Md5Key
        /// </summary>
        [DataMember(Name = "md5_key", IsRequired = true, EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BamboraGwWrite {\n");
            sb.Append("  CreatedAt: ").Append(CreatedAt).Append("\n");
            sb.Append("  CreatedBy: ").Append(CreatedBy).Append("\n");
            sb.Append("  CheckoutApiUrl: ").Append(CheckoutApiUrl).Append("\n");
            sb.Append("  MerchantApiUrl: ").Append(MerchantApiUrl).Append("\n");
            sb.Append("  TransactionApiUrl: ").Append(TransactionApiUrl).Append("\n");
            sb.Append("  WalletApiUrl: ").Append(WalletApiUrl).Append("\n");
        ...
        {
            return this.Equals(input as BamboraGwWrite);
        }

        /// <summary>
        /// Returns true if BamboraGwWrite instances are equal
        /// </summary>
        /// <param name="input">Instance of BamboraGwWrite to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BamboraGwWrite input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CheckoutApiUrl == input.CheckoutApiUrl ||
                    (this.CheckoutApiUrl != null &&
                    this.CheckoutApiUrl.Equals(input.CheckoutApiUrl))
                ) && 
                (
                    this.MerchantApiUrl == input.MerchantApiUrl ||
                    (this.MerchantApiUrl != null &&
                    this.MerchantApiUrl.Equals(input.MerchantApiUrl))
                ) && 
                (
                    this.TransactionApiUrl == input.TransactionApiUrl ||
                    (this.TransactionApiUrl != null &&
                    this.TransactionApiUrl.Equals(input.TransactionApiUrl))
                ) && 
                (
                    this.WalletApiUrl == input.WalletApiUrl ||
                    (this.WalletApiUrl != null &&
                    this.WalletApiUrl.Equals(input.WalletApiUrl))
                ) && 
                (
                ...
                (
                    this.Md5Key == input.Md5Key ||
                    (this.Md5Key != null &&
                    this.Md5Key.Equals(input.Md5Key))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CheckoutApiUrl != null)
                    hashCode = hashCode * 59 + this.CheckoutApiUrl.GetHashCode();
                if (this.MerchantApiUrl != null)
                    hashCode = hashCode * 59 + this.MerchantApiUrl.GetHashCode();
                if (this.TransactionApiUrl != null)
                    hashCode = hashCode * 59 + this.TransactionApiUrl.GetHashCode();
                if (this.WalletApiUrl != null)
                    hashCode = hashCode * 59 + this.WalletApiUrl.GetHashCode();
                ...
                if (this.Md5Key != null)
                    hashCode = hashCode * 59 + this.Md5Key.GetHashCode();
                return hashCode;
            }
        }
