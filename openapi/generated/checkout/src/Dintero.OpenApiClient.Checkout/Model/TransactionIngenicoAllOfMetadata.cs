...
{
    /// <summary>
    /// TransactionIngenicoAllOfMetadata
    /// </summary>
    [DataContract(Name = "TransactionIngenico_allOf_metadata")]
    public partial class TransactionIngenicoAllOfMetadata : IEquatable<TransactionIngenicoAllOfMetadata>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionIngenicoAllOfMetadata" /> class.
        /// </summary>
        /// <param name="ingenicooperationid">ingenicooperationid.</param>
        /// <param name="ingenicooperationtype">ingenicooperationtype.</param>
        /// <param name="ingenicopaymentstatus">Current high-level status of the payment in a human-readable form. .</param>
        /// <param name="ingenicopaymentstatusCode">ingenicopaymentstatusCode.</param>
        public TransactionIngenicoAllOfMetadata(string ingenicooperationid = default(string), string ingenicooperationtype = default(string), string ingenicopaymentstatus = default(string), string ingenicopaymentstatusCode = default(string))
        {
            this.Ingenicooperationid = ingenicooperationid;
            this.Ingenicooperationtype = ingenicooperationtype;
            this.Ingenicopaymentstatus = ingenicopaymentstatus;
            this.IngenicopaymentstatusCode = ingenicopaymentstatusCode;
        }

        /// <summary>
        /// Gets or Sets Ingenicooperationid
        /// </summary>
        [DataMember(Name = "ingenico:operation:id", EmitDefaultValue = false)]
        public string Ingenicooperationid { get; set; }

        /// <summary>
        /// Gets or Sets Ingenicooperationtype
        /// </summary>
        [DataMember(Name = "ingenico:operation:type", EmitDefaultValue = false)]
        public string Ingenicooperationtype { get; set; }

        /// <summary>
        /// Current high-level status of the payment in a human-readable form. 
        /// </summary>
        /// <value>Current high-level status of the payment in a human-readable form. </value>
        [DataMember(Name = "ingenico:payment:status", EmitDefaultValue = false)]
        public string Ingenicopaymentstatus { get; set; }

        /// <summary>
        /// Gets or Sets IngenicopaymentstatusCode
        /// </summary>
        [DataMember(Name = "ingenico:payment:status_code", EmitDefaultValue = false)]
        public string IngenicopaymentstatusCode { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionIngenicoAllOfMetadata {\n");
            sb.Append("  Ingenicooperationid: ").Append(Ingenicooperationid).Append("\n");
            sb.Append("  Ingenicooperationtype: ").Append(Ingenicooperationtype).Append("\n");
            sb.Append("  Ingenicopaymentstatus: ").Append(Ingenicopaymentstatus).Append("\n");
            sb.Append("  IngenicopaymentstatusCode: ").Append(IngenicopaymentstatusCode).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TransactionIngenicoAllOfMetadata);
        }

        /// <summary>
        /// Returns true if TransactionIngenicoAllOfMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionIngenicoAllOfMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionIngenicoAllOfMetadata input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.Ingenicooperationid == input.Ingenicooperationid ||
                    (this.Ingenicooperationid != null &&
                    this.Ingenicooperationid.Equals(input.Ingenicooperationid))
                ) && 
                (
                    this.Ingenicooperationtype == input.Ingenicooperationtype ||
                    (this.Ingenicooperationtype != null &&
                    this.Ingenicooperationtype.Equals(input.Ingenicooperationtype))
                ) && 
                (
                    this.Ingenicopaymentstatus == input.Ingenicopaymentstatus ||
                    (this.Ingenicopaymentstatus != null &&
                    this.Ingenicopaymentstatus.Equals(input.Ingenicopaymentstatus))
                ) && 
                (
                    this.IngenicopaymentstatusCode == input.IngenicopaymentstatusCode ||
                    (this.IngenicopaymentstatusCode != null &&
                    this.IngenicopaymentstatusCode.Equals(input.IngenicopaymentstatusCode))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.Ingenicooperationid != null)
                    hashCode = hashCode * 59 + this.Ingenicooperationid.GetHashCode();
                if (this.Ingenicooperationtype != null)
                    hashCode = hashCode * 59 + this.Ingenicooperationtype.GetHashCode();
                if (this.Ingenicopaymentstatus != null)
                    hashCode = hashCode * 59 + this.Ingenicopaymentstatus.GetHashCode();
                if (this.IngenicopaymentstatusCode != null)
                    hashCode = hashCode * 59 + this.IngenicopaymentstatusCode.GetHashCode();
                return hashCode;
            }
        }
