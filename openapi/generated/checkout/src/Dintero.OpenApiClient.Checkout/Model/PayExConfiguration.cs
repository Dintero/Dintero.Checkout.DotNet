...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// PayExConfiguration
    /// </summary>
    [DataContract(Name = "PayExConfiguration")]
    public partial class PayExConfiguration : IEquatable<PayExConfiguration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExConfiguration" /> class.
        /// </summary>
        ...
        public PayExConfiguration(string dynamicDescriptor = default(string), PayExConfigurationSwish swish = default(PayExConfigurationSwish), PayExConfigurationCreditcard creditcard = default(PayExConfigurationCreditcard))
        {
        ...
        public PayExConfigurationSwish Swish { get; set; }

        /// <summary>
        /// Gets or Sets Creditcard
        /// </summary>
        [DataMember(Name = "creditcard", EmitDefaultValue = false)]
        public PayExConfigurationCreditcard Creditcard { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PayExConfiguration {\n");
        ...
        {
            return this.Equals(input as PayExConfiguration);
        }

        /// <summary>
        /// Returns true if PayExConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of PayExConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayExConfiguration input)
        {
            if (input == null)
                return false;
