...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SwishPaymentCallback")]
    public partial class SwishPaymentCallback : IEquatable<SwishPaymentCallback>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SwishPaymentCallback" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SwishPaymentCallback() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SwishPaymentCallback" /> class.
        /// </summary>
        /// <param name="id">Payment request id  (required).</param>
        /// <param name="payeePaymentReference">payeePaymentReference.</param>
        /// <param name="status">status (required).</param>
        public SwishPaymentCallback(string id = default(string), string payeePaymentReference = default(string), StatusEnum status = default(StatusEnum))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for SwishPaymentCallback and cannot be null");
            this.Status = status;
        ...
        /// <summary>
        /// Gets or Sets PayeePaymentReference
        /// </summary>
        [DataMember(Name = "payeePaymentReference", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SwishPaymentCallback {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  PayeePaymentReference: ").Append(PayeePaymentReference).Append("\n");
        ...
        {
            return this.Equals(input as SwishPaymentCallback);
        }

        /// <summary>
        /// Returns true if SwishPaymentCallback instances are equal
        /// </summary>
        /// <param name="input">Instance of SwishPaymentCallback to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SwishPaymentCallback input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PayeePaymentReference == input.PayeePaymentReference ||
                    (this.PayeePaymentReference != null &&
                    this.PayeePaymentReference.Equals(input.PayeePaymentReference))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PayeePaymentReference != null)
                    hashCode = hashCode * 59 + this.PayeePaymentReference.GetHashCode();
