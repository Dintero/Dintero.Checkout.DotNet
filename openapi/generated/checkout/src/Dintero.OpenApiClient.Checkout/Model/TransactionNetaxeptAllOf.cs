...
{
    /// <summary>
    /// TransactionNetaxeptAllOf
    /// </summary>
    [DataContract(Name = "TransactionNetaxept_allOf")]
    public partial class TransactionNetaxeptAllOf : IEquatable<TransactionNetaxeptAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionNetaxeptAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionNetaxeptAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionNetaxeptAllOf" /> class.
        /// </summary>
        ...
        public TransactionNetaxeptAllOf(PaymentProductTypeEnum paymentProductType = default(PaymentProductTypeEnum), TransactionNetaxeptAllOfCard card = default(TransactionNetaxeptAllOfCard), List<TransactionNetaxeptAllOfEvents> events = default(List<TransactionNetaxeptAllOfEvents>), TransactionNetaxeptAllOfMetadata1 metadata = default(TransactionNetaxeptAllOfMetadata1))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionNetaxeptAllOf {\n");
        ...
        {
            return this.Equals(input as TransactionNetaxeptAllOf);
        }

        /// <summary>
        /// Returns true if TransactionNetaxeptAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionNetaxeptAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionNetaxeptAllOf input)
        {
            if (input == null)
                return false;
