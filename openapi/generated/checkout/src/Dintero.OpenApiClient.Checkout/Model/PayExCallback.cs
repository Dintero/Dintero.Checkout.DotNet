...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// PayExCallback
    /// </summary>
    [DataContract(Name = "PayExCallback")]
    public partial class PayExCallback : IEquatable<PayExCallback>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExCallback" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayExCallback() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExCallback" /> class.
        /// </summary>
        ...
        public PayExCallback(PayExCallbackPaymentOrder paymentOrder = default(PayExCallbackPaymentOrder), PayExCallbackPayment payment = default(PayExCallbackPayment), PayExCallbackTransaction transaction = default(PayExCallbackTransaction))
        {
            // to ensure "payment" is required (not null)
            this.Payment = payment ?? throw new ArgumentNullException("payment is a required property for PayExCallback and cannot be null");
        ...
        public PayExCallbackPaymentOrder PaymentOrder { get; set; }

        /// <summary>
        /// Gets or Sets Payment
        /// </summary>
        [DataMember(Name = "payment", IsRequired = true, EmitDefaultValue = false)]
        public PayExCallbackPayment Payment { get; set; }

        /// <summary>
        /// Gets or Sets Transaction
        /// </summary>
        [DataMember(Name = "transaction", EmitDefaultValue = false)]
        public PayExCallbackTransaction Transaction { get; set; }
        ...
        {
            return this.Equals(input as PayExCallback);
        }

        /// <summary>
        /// Returns true if PayExCallback instances are equal
        /// </summary>
        /// <param name="input">Instance of PayExCallback to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayExCallback input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.PaymentOrder == input.PaymentOrder ||
                    (this.PaymentOrder != null &&
                    this.PaymentOrder.Equals(input.PaymentOrder))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PaymentOrder != null)
                    hashCode = hashCode * 59 + this.PaymentOrder.GetHashCode();
