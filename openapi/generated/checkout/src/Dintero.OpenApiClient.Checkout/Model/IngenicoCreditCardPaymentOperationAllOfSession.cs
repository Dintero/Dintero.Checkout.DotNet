...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IngenicoCreditCardPaymentOperation_allOf_session")]
    public partial class IngenicoCreditCardPaymentOperationAllOfSession : IEquatable<IngenicoCreditCardPaymentOperationAllOfSession>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoCreditCardPaymentOperationAllOfSession" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IngenicoCreditCardPaymentOperationAllOfSession() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoCreditCardPaymentOperationAllOfSession" /> class.
        /// </summary>
        /// <param name="assetUrl">The datacenter-specific base url for assets. This value needs to be passed to the Client SDK to make sure that the client software connects to the right datacenter.  (required).</param>
        /// <param name="clientApiUrl">The datacenter-specific base url for client requests. This value needs to be passed to the Client SDK to make sure that the client software connects to the right datacenter.  (required).</param>
        /// <param name="clientSessionId">The identifier of the session that has been created. (required).</param>
        /// <param name="customerId">The session is built up around the customer in the form of the customerId. All client APIs use this customerId in the URI to identify the customer.  (required).</param>
        public IngenicoCreditCardPaymentOperationAllOfSession(string assetUrl = default(string), string clientApiUrl = default(string), string clientSessionId = default(string), string customerId = default(string))
        {
            // to ensure "assetUrl" is required (not null)
            this.AssetUrl = assetUrl ?? throw new ArgumentNullException("assetUrl is a required property for IngenicoCreditCardPaymentOperationAllOfSession and cannot be null");
            // to ensure "clientApiUrl" is required (not null)
            this.ClientApiUrl = clientApiUrl ?? throw new ArgumentNullException("clientApiUrl is a required property for IngenicoCreditCardPaymentOperationAllOfSession and cannot be null");
            // to ensure "clientSessionId" is required (not null)
            this.ClientSessionId = clientSessionId ?? throw new ArgumentNullException("clientSessionId is a required property for IngenicoCreditCardPaymentOperationAllOfSession and cannot be null");
            // to ensure "customerId" is required (not null)
            this.CustomerId = customerId ?? throw new ArgumentNullException("customerId is a required property for IngenicoCreditCardPaymentOperationAllOfSession and cannot be null");
        }
        ...
        /// </summary>
        /// <value>The datacenter-specific base url for assets. This value needs to be passed to the Client SDK to make sure that the client software connects to the right datacenter. </value>
        [DataMember(Name = "asset_url", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>The datacenter-specific base url for client requests. This value needs to be passed to the Client SDK to make sure that the client software connects to the right datacenter. </value>
        [DataMember(Name = "client_api_url", IsRequired = true, EmitDefaultValue = false)]
        public string ClientApiUrl { get; set; }

        /// <summary>
        /// The identifier of the session that has been created.
        /// </summary>
        /// <value>The identifier of the session that has been created.</value>
        ...
        /// </summary>
        /// <value>The session is built up around the customer in the form of the customerId. All client APIs use this customerId in the URI to identify the customer. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IngenicoCreditCardPaymentOperationAllOfSession {\n");
            sb.Append("  AssetUrl: ").Append(AssetUrl).Append("\n");
            sb.Append("  ClientApiUrl: ").Append(ClientApiUrl).Append("\n");
        ...
        {
            return this.Equals(input as IngenicoCreditCardPaymentOperationAllOfSession);
        }

        /// <summary>
        /// Returns true if IngenicoCreditCardPaymentOperationAllOfSession instances are equal
        /// </summary>
        /// <param name="input">Instance of IngenicoCreditCardPaymentOperationAllOfSession to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IngenicoCreditCardPaymentOperationAllOfSession input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ClientApiUrl == input.ClientApiUrl ||
                    (this.ClientApiUrl != null &&
                    this.ClientApiUrl.Equals(input.ClientApiUrl))
                ) && 
                (
                    this.ClientSessionId == input.ClientSessionId ||
                    (this.ClientSessionId != null &&
                    this.ClientSessionId.Equals(input.ClientSessionId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ClientApiUrl != null)
                    hashCode = hashCode * 59 + this.ClientApiUrl.GetHashCode();
                if (this.ClientSessionId != null)
                    hashCode = hashCode * 59 + this.ClientSessionId.GetHashCode();
