...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// IngenicoGwWrite
    /// </summary>
    [DataContract(Name = "IngenicoGwWrite")]
    public partial class IngenicoGwWrite : IEquatable<IngenicoGwWrite>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoGwWrite" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IngenicoGwWrite() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoGwWrite" /> class.
        /// </summary>
        /// <param name="url">The base URIs of the Ingenico Direct APIs:  - **test**: https://payment.preprod.direct.ingenico.com - **prod**: https://payment.direct.ingenico.com  (required).</param>
        /// <param name="merchantId">merchantId (required).</param>
        /// <param name="apiKeyId">apiKeyId (required).</param>
        /// <param name="options">options.</param>
        /// <param name="apiKeySecret">apiKeySecret (required).</param>
        public IngenicoGwWrite(string url = default(string), string merchantId = default(string), string apiKeyId = default(string), IngenicoGwReadOptions options = default(IngenicoGwReadOptions), string apiKeySecret = default(string))
        {
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url is a required property for IngenicoGwWrite and cannot be null");
            // to ensure "merchantId" is required (not null)
            this.MerchantId = merchantId ?? throw new ArgumentNullException("merchantId is a required property for IngenicoGwWrite and cannot be null");
            // to ensure "apiKeyId" is required (not null)
            this.ApiKeyId = apiKeyId ?? throw new ArgumentNullException("apiKeyId is a required property for IngenicoGwWrite and cannot be null");
            // to ensure "apiKeySecret" is required (not null)
            this.ApiKeySecret = apiKeySecret ?? throw new ArgumentNullException("apiKeySecret is a required property for IngenicoGwWrite and cannot be null");
        ...
        /// <summary>
        /// The base URIs of the Ingenico Direct APIs:  - **test**: https://payment.preprod.direct.ingenico.com - **prod**: https://payment.direct.ingenico.com 
        /// </summary>
        /// <value>The base URIs of the Ingenico Direct APIs:  - **test**: https://payment.preprod.direct.ingenico.com - **prod**: https://payment.direct.ingenico.com </value>
        ...
        /// </summary>
        [DataMember(Name = "api_key_id", IsRequired = true, EmitDefaultValue = false)]
        ...
        public IngenicoGwReadOptions Options { get; set; }

        /// <summary>
        /// Gets or Sets ApiKeySecret
        /// </summary>
        [DataMember(Name = "api_key_secret", IsRequired = true, EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IngenicoGwWrite {\n");
        ...
        {
            return this.Equals(input as IngenicoGwWrite);
        }

        /// <summary>
        /// Returns true if IngenicoGwWrite instances are equal
        /// </summary>
        /// <param name="input">Instance of IngenicoGwWrite to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IngenicoGwWrite input)
        {
            if (input == null)
                return false;
