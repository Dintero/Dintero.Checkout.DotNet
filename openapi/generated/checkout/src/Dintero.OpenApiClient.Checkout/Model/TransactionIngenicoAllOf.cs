...
{
    /// <summary>
    /// TransactionIngenicoAllOf
    /// </summary>
    [DataContract(Name = "TransactionIngenico_allOf")]
    public partial class TransactionIngenicoAllOf : IEquatable<TransactionIngenicoAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionIngenicoAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionIngenicoAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionIngenicoAllOf" /> class.
        /// </summary>
        ...
        public TransactionIngenicoAllOf(PaymentProductTypeEnum paymentProductType = default(PaymentProductTypeEnum), TransactionIngenicoAllOfCard card = default(TransactionIngenicoAllOfCard), List<TransactionIngenicoAllOfEvents> events = default(List<TransactionIngenicoAllOfEvents>), TransactionIngenicoAllOfMetadata1 metadata = default(TransactionIngenicoAllOfMetadata1))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionIngenicoAllOf {\n");
        ...
        {
            return this.Equals(input as TransactionIngenicoAllOf);
        }

        /// <summary>
        /// Returns true if TransactionIngenicoAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionIngenicoAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionIngenicoAllOf input)
        {
            if (input == null)
                return false;
