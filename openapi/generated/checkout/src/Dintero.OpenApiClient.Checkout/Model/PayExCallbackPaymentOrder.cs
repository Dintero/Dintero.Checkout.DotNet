...
{
    /// <summary>
    /// PayExCallbackPaymentOrder
    /// </summary>
    [DataContract(Name = "PayExCallback_paymentOrder")]
    public partial class PayExCallbackPaymentOrder : IEquatable<PayExCallbackPaymentOrder>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExCallbackPaymentOrder" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayExCallbackPaymentOrder() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExCallbackPaymentOrder" /> class.
        /// </summary>
        /// <param name="id">id (required).</param>
        /// <param name="instrument">CreditCard, Swish.</param>
        public PayExCallbackPaymentOrder(string id = default(string), string instrument = default(string))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for PayExCallbackPaymentOrder and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PayExCallbackPaymentOrder {\n");
        ...
        {
            return this.Equals(input as PayExCallbackPaymentOrder);
        }

        /// <summary>
        /// Returns true if PayExCallbackPaymentOrder instances are equal
        /// </summary>
        /// <param name="input">Instance of PayExCallbackPaymentOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayExCallbackPaymentOrder input)
        {
            if (input == null)
                return false;
