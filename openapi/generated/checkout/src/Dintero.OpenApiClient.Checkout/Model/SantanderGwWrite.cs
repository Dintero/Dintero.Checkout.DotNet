...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// SantanderGwWrite
    /// </summary>
    [DataContract(Name = "SantanderGwWrite")]
    public partial class SantanderGwWrite : IEquatable<SantanderGwWrite>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SantanderGwWrite" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SantanderGwWrite() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SantanderGwWrite" /> class.
        /// </summary>
        /// <param name="url">URL for the SOAP service (required).</param>
        /// <param name="storeEmail">Email-address to the store. Must correspond with email stored in Santander&#39;s system. (required).</param>
        /// <param name="brandingName">The name to brand debit_accounts with.</param>
        /// <param name="storeToken">storeToken (required).</param>
        /// <param name="cert">Certificate stored as base64-encoded string.</param>
        /// <param name="certPassword">Certificate password.</param>
        /// <param name="customersClientId">customersClientId (required).</param>
        /// <param name="customersClientSecret">customersClientSecret (required).</param>
        /// <param name="customersClientAudience">customersClientAudience (required).</param>
        public SantanderGwWrite(string url = default(string), string storeEmail = default(string), string brandingName = default(string), string storeToken = default(string), string cert = default(string), string certPassword = default(string), string customersClientId = default(string), string customersClientSecret = default(string), string customersClientAudience = default(string))
        {
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url is a required property for SantanderGwWrite and cannot be null");
            // to ensure "storeEmail" is required (not null)
            this.StoreEmail = storeEmail ?? throw new ArgumentNullException("storeEmail is a required property for SantanderGwWrite and cannot be null");
            // to ensure "storeToken" is required (not null)
            this.StoreToken = storeToken ?? throw new ArgumentNullException("storeToken is a required property for SantanderGwWrite and cannot be null");
            // to ensure "customersClientId" is required (not null)
            this.CustomersClientId = customersClientId ?? throw new ArgumentNullException("customersClientId is a required property for SantanderGwWrite and cannot be null");
            // to ensure "customersClientSecret" is required (not null)
            this.CustomersClientSecret = customersClientSecret ?? throw new ArgumentNullException("customersClientSecret is a required property for SantanderGwWrite and cannot be null");
            // to ensure "customersClientAudience" is required (not null)
            this.CustomersClientAudience = customersClientAudience ?? throw new ArgumentNullException("customersClientAudience is a required property for SantanderGwWrite and cannot be null");
        ...
        /// </summary>
        /// <value>URL for the SOAP service</value>
        [DataMember(Name = "url", IsRequired = true, EmitDefaultValue = false)]
        public string Url { get; set; }

        /// <summary>
        /// Email-address to the store. Must correspond with email stored in Santander&#39;s system.
        /// </summary>
        /// <value>Email-address to the store. Must correspond with email stored in Santander&#39;s system.</value>
        [DataMember(Name = "store_email", IsRequired = true, EmitDefaultValue = false)]
        public string StoreEmail { get; set; }

        /// <summary>
        /// The name to brand debit_accounts with
        /// </summary>
        /// <value>The name to brand debit_accounts with</value>
        [DataMember(Name = "branding_name", EmitDefaultValue = false)]
        public string BrandingName { get; set; }

        /// <summary>
        /// Gets or Sets StoreToken
        /// </summary>
        [DataMember(Name = "store_token", IsRequired = true, EmitDefaultValue = false)]
        public string StoreToken { get; set; }

        /// <summary>
        /// Certificate stored as base64-encoded string
        /// </summary>
        /// <value>Certificate stored as base64-encoded string</value>
        ...
        [DataMember(Name = "cert_password", EmitDefaultValue = false)]
        public string CertPassword { get; set; }

        /// <summary>
        /// Gets or Sets CustomersClientId
        /// </summary>
        [DataMember(Name = "customers_client_id", IsRequired = true, EmitDefaultValue = false)]
        public string CustomersClientId { get; set; }

        /// <summary>
        /// Gets or Sets CustomersClientSecret
        /// </summary>
        [DataMember(Name = "customers_client_secret", IsRequired = true, EmitDefaultValue = false)]
        public string CustomersClientSecret { get; set; }

        /// <summary>
        /// Gets or Sets CustomersClientAudience
        /// </summary>
        [DataMember(Name = "customers_client_audience", IsRequired = true, EmitDefaultValue = false)]
        public string CustomersClientAudience { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SantanderGwWrite {\n");
            ...
            sb.Append("  CertPassword: ").Append(CertPassword).Append("\n");
            sb.Append("  CustomersClientId: ").Append(CustomersClientId).Append("\n");
            sb.Append("  CustomersClientSecret: ").Append(CustomersClientSecret).Append("\n");
            sb.Append("  CustomersClientAudience: ").Append(CustomersClientAudience).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as SantanderGwWrite);
        }

        /// <summary>
        /// Returns true if SantanderGwWrite instances are equal
        /// </summary>
        /// <param name="input">Instance of SantanderGwWrite to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SantanderGwWrite input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.StoreEmail == input.StoreEmail ||
                    (this.StoreEmail != null &&
                    this.StoreEmail.Equals(input.StoreEmail))
                ) && 
                (
                    this.BrandingName == input.BrandingName ||
                    (this.BrandingName != null &&
                    this.BrandingName.Equals(input.BrandingName))
                ) && 
                (
                ...
                (
                    this.CertPassword == input.CertPassword ||
                    (this.CertPassword != null &&
                    this.CertPassword.Equals(input.CertPassword))
                ) && 
                (
                    this.CustomersClientId == input.CustomersClientId ||
                    (this.CustomersClientId != null &&
                    this.CustomersClientId.Equals(input.CustomersClientId))
                ) && 
                (
                    this.CustomersClientSecret == input.CustomersClientSecret ||
                    (this.CustomersClientSecret != null &&
                    this.CustomersClientSecret.Equals(input.CustomersClientSecret))
                ) && 
                (
                    this.CustomersClientAudience == input.CustomersClientAudience ||
                    (this.CustomersClientAudience != null &&
                    this.CustomersClientAudience.Equals(input.CustomersClientAudience))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.StoreEmail != null)
                    hashCode = hashCode * 59 + this.StoreEmail.GetHashCode();
                if (this.BrandingName != null)
                    hashCode = hashCode * 59 + this.BrandingName.GetHashCode();
                ...
                if (this.CertPassword != null)
                    hashCode = hashCode * 59 + this.CertPassword.GetHashCode();
                if (this.CustomersClientId != null)
                    hashCode = hashCode * 59 + this.CustomersClientId.GetHashCode();
                if (this.CustomersClientSecret != null)
                    hashCode = hashCode * 59 + this.CustomersClientSecret.GetHashCode();
                if (this.CustomersClientAudience != null)
                    hashCode = hashCode * 59 + this.CustomersClientAudience.GetHashCode();
                return hashCode;
            }
        }
