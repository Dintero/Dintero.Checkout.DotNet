...
{
    /// <summary>
    /// PayExMitPaymentAllOf
    /// </summary>
    [DataContract(Name = "PayExMitPayment_allOf")]
    public partial class PayExMitPaymentAllOf : IEquatable<PayExMitPaymentAllOf>, IValidatableObject
    {
        /// <summary>
        /// Defines Operation
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExMitPaymentAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayExMitPaymentAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExMitPaymentAllOf" /> class.
        /// </summary>
        /// <param name="operation">operation (required).</param>
        public PayExMitPaymentAllOf(OperationEnum operation = default(OperationEnum))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PayExMitPaymentAllOf {\n");
        ...
        {
            return this.Equals(input as PayExMitPaymentAllOf);
        }

        /// <summary>
        /// Returns true if PayExMitPaymentAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PayExMitPaymentAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayExMitPaymentAllOf input)
        {
            if (input == null)
                return false;
