...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class InlineResponse2005 : IEquatable<InlineResponse2005>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="id">Unique identifier of credit check.</param>
        /// <param name="createdAt">createdAt.</param>
        /// <param name="amount">The amount applied for.</param>
        /// <param name="results">results.</param>
        public InlineResponse2005(Guid id = default(Guid), DateTime createdAt = default(DateTime), int amount = default(int), List<InlineResponse2005Results> results = default(List<InlineResponse2005Results>))
        {
            this.Id = id;
        ...
        /// </summary>
        /// <value>Unique identifier of credit check</value>
        ...
        /// </summary>
        /// <value>The amount applied for</value>
        ...
        public List<InlineResponse2005Results> Results { get; set; }
