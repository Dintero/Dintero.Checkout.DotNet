...
{
    /// <summary>
    /// PaymentConfigurationAllOf
    /// </summary>
    [DataContract(Name = "PaymentConfiguration_allOf")]
    public partial class PaymentConfigurationAllOf : IEquatable<PaymentConfigurationAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentConfigurationAllOf" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentConfigurationAllOf {\n");
        ...
        {
            return this.Equals(input as PaymentConfigurationAllOf);
        }

        /// <summary>
        /// Returns true if PaymentConfigurationAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentConfigurationAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentConfigurationAllOf input)
        {
            if (input == null)
                return false;
