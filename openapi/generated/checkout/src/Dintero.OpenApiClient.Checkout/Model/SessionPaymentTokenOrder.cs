...
{
    /// <summary>
    /// SessionPaymentTokenOrder
    /// </summary>
    [DataContract(Name = "SessionPaymentToken_order")]
    public partial class SessionPaymentTokenOrder : IEquatable<SessionPaymentTokenOrder>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionPaymentTokenOrder" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SessionPaymentTokenOrder() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionPaymentTokenOrder" /> class.
        /// </summary>
        /// <param name="currency">The three-character ISO-4217 currency. https://en.wikipedia.org/wiki/ISO_4217 (required).</param>
        ...
        public SessionPaymentTokenOrder(string currency = default(string), string merchantReference = default(string), string merchantReference2 = default(string), Store store = default(Store))
        {
            // to ensure "currency" is required (not null)
            this.Currency = currency ?? throw new ArgumentNullException("currency is a required property for SessionPaymentTokenOrder and cannot be null");
            // to ensure "merchantReference" is required (not null)
            this.MerchantReference = merchantReference ?? throw new ArgumentNullException("merchantReference is a required property for SessionPaymentTokenOrder and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SessionPaymentTokenOrder {\n");
        ...
        {
            return this.Equals(input as SessionPaymentTokenOrder);
        }

        /// <summary>
        /// Returns true if SessionPaymentTokenOrder instances are equal
        /// </summary>
        /// <param name="input">Instance of SessionPaymentTokenOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SessionPaymentTokenOrder input)
        {
            if (input == null)
                return false;
