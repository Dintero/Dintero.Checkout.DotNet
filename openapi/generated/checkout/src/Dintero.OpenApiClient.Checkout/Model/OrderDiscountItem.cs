...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrderDiscountItem")]
    public partial class OrderDiscountItem : IEquatable<OrderDiscountItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderDiscountItem" /> class.
        /// </summary>
        /// <param name="eligibleForDiscount">The item is eligible for discount  (default to false).</param>
        /// <param name="isChanged">Discount applied to amount .</param>
        /// <param name="discountLines">discountLines.</param>
        public OrderDiscountItem(bool eligibleForDiscount = false, bool isChanged = default(bool), List<DiscountItem> discountLines = default(List<DiscountItem>))
        {
        ...
        /// </summary>
        /// <value>The item is eligible for discount </value>
        [DataMember(Name = "eligible_for_discount", EmitDefaultValue = true)]
        public bool EligibleForDiscount { get; set; }

        /// <summary>
        /// Discount applied to amount 
        /// </summary>
        /// <value>Discount applied to amount </value>
        ...
        /// </summary>
        /// <value>The origin item amount before any discount </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrderDiscountItem {\n");
            sb.Append("  EligibleForDiscount: ").Append(EligibleForDiscount).Append("\n");
        ...
        {
            return this.Equals(input as OrderDiscountItem);
        }

        /// <summary>
        /// Returns true if OrderDiscountItem instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderDiscountItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderDiscountItem input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.EligibleForDiscount == input.EligibleForDiscount ||
                    this.EligibleForDiscount.Equals(input.EligibleForDiscount)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = hashCode * 59 + this.EligibleForDiscount.GetHashCode();
