...
{
    /// <summary>
    /// TransactionPayExAllOf
    /// </summary>
    [DataContract(Name = "TransactionPayEx_allOf")]
    public partial class TransactionPayExAllOf : IEquatable<TransactionPayExAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionPayExAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionPayExAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionPayExAllOf" /> class.
        /// </summary>
        ...
        public TransactionPayExAllOf(PaymentProductTypeEnum paymentProductType = default(PaymentProductTypeEnum), TransactionPayExAllOfCard card = default(TransactionPayExAllOfCard), List<TransactionPayExAllOfEvents> events = default(List<TransactionPayExAllOfEvents>), TransactionPayExAllOfMetadata1 metadata = default(TransactionPayExAllOfMetadata1))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionPayExAllOf {\n");
        ...
        {
            return this.Equals(input as TransactionPayExAllOf);
        }

        /// <summary>
        /// Returns true if TransactionPayExAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionPayExAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionPayExAllOf input)
        {
            if (input == null)
                return false;
