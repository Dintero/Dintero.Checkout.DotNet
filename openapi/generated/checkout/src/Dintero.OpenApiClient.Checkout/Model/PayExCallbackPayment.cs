...
{
    /// <summary>
    /// PayExCallbackPayment
    /// </summary>
    [DataContract(Name = "PayExCallback_payment")]
    public partial class PayExCallbackPayment : IEquatable<PayExCallbackPayment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExCallbackPayment" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayExCallbackPayment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExCallbackPayment" /> class.
        /// </summary>
        /// <param name="id">- Payment Instrument: CreditCard, Swish  (required).</param>
        /// <param name="number">number.</param>
        public PayExCallbackPayment(string id = default(string), int number = default(int))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for PayExCallbackPayment and cannot be null");
            this.Number = number;
        }

        /// <summary>
        /// - Payment Instrument: CreditCard, Swish 
        /// </summary>
        /// <value>- Payment Instrument: CreditCard, Swish </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PayExCallbackPayment {\n");
        ...
        {
            return this.Equals(input as PayExCallbackPayment);
        }

        /// <summary>
        /// Returns true if PayExCallbackPayment instances are equal
        /// </summary>
        /// <param name="input">Instance of PayExCallbackPayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayExCallbackPayment input)
        {
            if (input == null)
                return false;
