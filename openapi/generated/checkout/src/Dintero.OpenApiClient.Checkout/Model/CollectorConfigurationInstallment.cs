...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// Fixed Part Payment
    /// </summary>
    [DataContract(Name = "CollectorConfiguration_installment")]
    public partial class CollectorConfigurationInstallment : IEquatable<CollectorConfigurationInstallment>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorConfigurationInstallment" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorConfigurationInstallment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorConfigurationInstallment" /> class.
        /// </summary>
        /// <param name="type">Denotes what kind of config parameter this is (default to TypeEnum.PaymentProductType).</param>
        /// <param name="enabled">enable Collector Bank Installment Payment (required).</param>
        /// <param name="countries">countries.</param>
        /// <param name="options">options.</param>
        /// <param name="payability">payability.</param>
        public CollectorConfigurationInstallment(TypeEnum? type = TypeEnum.PaymentProductType, bool enabled = default(bool), List<string> countries = default(List<string>), CollectorConfigurationInvoiceB2bOptions options = default(CollectorConfigurationInvoiceB2bOptions), SessionPayability? payability = default(SessionPayability?))
        {
        ...
        /// </summary>
        /// <value>enable Collector Bank Installment Payment</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorConfigurationInstallment {\n");
        ...
        {
            return this.Equals(input as CollectorConfigurationInstallment);
        }

        /// <summary>
        /// Returns true if CollectorConfigurationInstallment instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorConfigurationInstallment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorConfigurationInstallment input)
        {
            if (input == null)
                return false;
