...
{
    /// <summary>
    /// TransactionPayExAllOfCard
    /// </summary>
    [DataContract(Name = "TransactionPayEx_allOf_card")]
    public partial class TransactionPayExAllOfCard : IEquatable<TransactionPayExAllOfCard>, IValidatableObject
    {
        /// <summary>
        /// Credit or Debit. Indicates the type of card used 
        /// </summary>
        /// <value>Credit or Debit. Indicates the type of card used </value>
        ...
        /// </summary>
        /// <value>3DSECURE or SSL. Indicates the transaction type of the acquirer. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum AcquirerTransactionTypeEnum
        {
            /// <summary>
            /// Enum _3DSECURE for value: 3DSECURE
            /// </summary>
        ...
        /// </summary>
        /// <value>3DSECURE or SSL. Indicates the transaction type of the acquirer. </value>
        [DataMember(Name = "acquirer_transaction_type", EmitDefaultValue = false)]
        public AcquirerTransactionTypeEnum? AcquirerTransactionType { get; set; }
        /// <summary>
        /// Y, A, U or N. Indicates the status of the authentication. 
        /// </summary>
        /// <value>Y, A, U or N. Indicates the status of the authentication. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// </summary>
        /// <value>Y, A, U or N. Indicates the status of the authentication. </value>
        [DataMember(Name = "authentication_status", EmitDefaultValue = false)]
        public AuthenticationStatusEnum? AuthenticationStatus { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionPayExAllOfCard" /> class.
        /// </summary>
        /// <param name="brand">Visa, MasterCard, etc. The brand of the card..</param>
        /// <param name="maskedPan">maskedPan.</param>
        /// <param name="expiryDate">expiryDate.</param>
        /// <param name="type">Credit or Debit. Indicates the type of card used .</param>
        /// <param name="issuingBank">The name of the bank that issued the card used .</param>
        /// <param name="country">The country the card is issued in.</param>
        /// <param name="acquirerTransactionType">3DSECURE or SSL. Indicates the transaction type of the acquirer. .</param>
        /// <param name="acquirerStan">The System Trace Audit Number assigned by the acquirer to uniquely identify the transaction. .</param>
        /// <param name="acquirerTerminalId">The ID of the acquirer terminal..</param>
        /// <param name="acquirerTransactionTime">The ISO-8601 date and time of the acquirer transaction..</param>
        /// <param name="authenticationStatus">Y, A, U or N. Indicates the status of the authentication. .</param>
        /// <param name="paymentToken">The payment token generated by the authorization. Only available for transactions created from session where the generate_payment_token option is enabled in the payex session configuration or from payment token sessions created with payex configured  - [POST /v1/sessions-payment-token](#operation/checkout_payment_token_session_post) .</param>
        /// <param name="paymentTokenId">The id of the payment_token, only included in transaction where a payment_token was generated. .</param>
        public TransactionPayExAllOfCard(string brand = default(string), string maskedPan = default(string), string expiryDate = default(string), TypeEnum? type = default(TypeEnum?), string issuingBank = default(string), string country = default(string), AcquirerTransactionTypeEnum? acquirerTransactionType = default(AcquirerTransactionTypeEnum?), string acquirerStan = default(string), string acquirerTerminalId = default(string), DateTime acquirerTransactionTime = default(DateTime), AuthenticationStatusEnum? authenticationStatus = default(AuthenticationStatusEnum?), string paymentToken = default(string), string paymentTokenId = default(string))
        {
            this.Brand = brand;
            ...
            this.AcquirerTransactionType = acquirerTransactionType;
            this.AcquirerStan = acquirerStan;
            this.AcquirerTerminalId = acquirerTerminalId;
            this.AcquirerTransactionTime = acquirerTransactionTime;
        ...
        /// </summary>
        /// <value>Visa, MasterCard, etc. The brand of the card.</value>
        ...
        /// </summary>
        [DataMember(Name = "masked_pan", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>The name of the bank that issued the card used </value>
        ...
        /// </summary>
        /// <value>The country the card is issued in</value>
        ...
        /// </summary>
        /// <value>The System Trace Audit Number assigned by the acquirer to uniquely identify the transaction. </value>
        [DataMember(Name = "acquirer_stan", EmitDefaultValue = false)]
        public string AcquirerStan { get; set; }

        /// <summary>
        /// The ID of the acquirer terminal.
        /// </summary>
        /// <value>The ID of the acquirer terminal.</value>
        [DataMember(Name = "acquirer_terminal_id", EmitDefaultValue = false)]
        public string AcquirerTerminalId { get; set; }

        /// <summary>
        /// The ISO-8601 date and time of the acquirer transaction.
        /// </summary>
        /// <value>The ISO-8601 date and time of the acquirer transaction.</value>
        [DataMember(Name = "acquirer_transaction_time", EmitDefaultValue = false)]
        public DateTime AcquirerTransactionTime { get; set; }

        /// <summary>
        /// The payment token generated by the authorization. Only available for transactions created from session where the generate_payment_token option is enabled in the payex session configuration or from payment token sessions created with payex configured  - [POST /v1/sessions-payment-token](#operation/checkout_payment_token_session_post) 
        /// </summary>
        /// <value>The payment token generated by the authorization. Only available for transactions created from session where the generate_payment_token option is enabled in the payex session configuration or from payment token sessions created with payex configured  - [POST /v1/sessions-payment-token](#operation/checkout_payment_token_session_post) </value>
        ...
        /// </summary>
        /// <value>The id of the payment_token, only included in transaction where a payment_token was generated. </value>
        [DataMember(Name = "payment_token_id", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionPayExAllOfCard {\n");
            ...
            sb.Append("  AcquirerTransactionType: ").Append(AcquirerTransactionType).Append("\n");
            sb.Append("  AcquirerStan: ").Append(AcquirerStan).Append("\n");
            sb.Append("  AcquirerTerminalId: ").Append(AcquirerTerminalId).Append("\n");
            sb.Append("  AcquirerTransactionTime: ").Append(AcquirerTransactionTime).Append("\n");
            sb.Append("  AuthenticationStatus: ").Append(AuthenticationStatus).Append("\n");
            sb.Append("  PaymentToken: ").Append(PaymentToken).Append("\n");
            sb.Append("  PaymentTokenId: ").Append(PaymentTokenId).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TransactionPayExAllOfCard);
        }

        /// <summary>
        /// Returns true if TransactionPayExAllOfCard instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionPayExAllOfCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionPayExAllOfCard input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.AcquirerTransactionType == input.AcquirerTransactionType ||
                    this.AcquirerTransactionType.Equals(input.AcquirerTransactionType)
                ) && 
                (
                    this.AcquirerStan == input.AcquirerStan ||
                    (this.AcquirerStan != null &&
                    this.AcquirerStan.Equals(input.AcquirerStan))
                ) && 
                (
                    this.AcquirerTerminalId == input.AcquirerTerminalId ||
                    (this.AcquirerTerminalId != null &&
                    this.AcquirerTerminalId.Equals(input.AcquirerTerminalId))
                ) && 
                (
                    this.AcquirerTransactionTime == input.AcquirerTransactionTime ||
                    (this.AcquirerTransactionTime != null &&
                    this.AcquirerTransactionTime.Equals(input.AcquirerTransactionTime))
                ) && 
                (
                ...
                (
                    this.PaymentTokenId == input.PaymentTokenId ||
                    (this.PaymentTokenId != null &&
                    this.PaymentTokenId.Equals(input.PaymentTokenId))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.AcquirerTransactionType.GetHashCode();
                if (this.AcquirerStan != null)
                    hashCode = hashCode * 59 + this.AcquirerStan.GetHashCode();
                if (this.AcquirerTerminalId != null)
                    hashCode = hashCode * 59 + this.AcquirerTerminalId.GetHashCode();
                if (this.AcquirerTransactionTime != null)
                    hashCode = hashCode * 59 + this.AcquirerTransactionTime.GetHashCode();
                ...
                if (this.PaymentTokenId != null)
                    hashCode = hashCode * 59 + this.PaymentTokenId.GetHashCode();
                return hashCode;
            }
        }
