...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// ApiKeyReadAllOf
    /// </summary>
    [DataContract(Name = "ApiKeyRead_allOf")]
    public partial class ApiKeyReadAllOf : IEquatable<ApiKeyReadAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiKeyReadAllOf" /> class.
        /// </summary>
        /// <param name="updatedAt">updatedAt.</param>
        /// <param name="expiresAt">expiresAt.</param>
        /// <param name="deletedBy">deletedBy.</param>
        /// <param name="deletedAt">deletedAt.</param>
        public ApiKeyReadAllOf(DateTime updatedAt = default(DateTime), DateTime expiresAt = default(DateTime), string deletedBy = default(string), DateTime deletedAt = default(DateTime))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiKeyReadAllOf {\n");
        ...
        {
            return this.Equals(input as ApiKeyReadAllOf);
        }

        /// <summary>
        /// Returns true if ApiKeyReadAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiKeyReadAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiKeyReadAllOf input)
        {
            if (input == null)
                return false;
