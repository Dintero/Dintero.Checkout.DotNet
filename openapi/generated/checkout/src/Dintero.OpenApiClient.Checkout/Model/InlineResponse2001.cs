...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class InlineResponse2001 : IEquatable<InlineResponse2001>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="checkoutConfig">checkoutConfig.</param>
        /// <param name="checkoutConfigWrite">checkoutConfigWrite.</param>
        /// <param name="id">id.</param>
        public InlineResponse2001(CheckoutConfig checkoutConfig = default(CheckoutConfig), CheckoutConfigWrite checkoutConfigWrite = default(CheckoutConfigWrite), Id id = default(Id))
        {
            this.CheckoutConfig = checkoutConfig;
            this.CheckoutConfigWrite = checkoutConfigWrite;
            this.Id = id;
        }

        /// <summary>
        /// Gets or Sets CheckoutConfig
        /// </summary>
        [DataMember(Name = "CheckoutConfig", EmitDefaultValue = false)]
        public CheckoutConfig CheckoutConfig { get; set; }

        /// <summary>
        /// Gets or Sets CheckoutConfigWrite
        /// </summary>
        [DataMember(Name = "CheckoutConfigWrite", EmitDefaultValue = false)]
        public CheckoutConfigWrite CheckoutConfigWrite { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CheckoutConfig: ").Append(CheckoutConfig).Append("\n");
            sb.Append("  CheckoutConfigWrite: ").Append(CheckoutConfigWrite).Append("\n");
        ...
        public bool Equals(InlineResponse2001 input)
        {
            ...
            return 
                (
                    this.CheckoutConfig == input.CheckoutConfig ||
                    (this.CheckoutConfig != null &&
                    this.CheckoutConfig.Equals(input.CheckoutConfig))
                ) && 
                (
                    this.CheckoutConfigWrite == input.CheckoutConfigWrite ||
                    (this.CheckoutConfigWrite != null &&
                    this.CheckoutConfigWrite.Equals(input.CheckoutConfigWrite))
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CheckoutConfig != null)
                    hashCode = hashCode * 59 + this.CheckoutConfig.GetHashCode();
                if (this.CheckoutConfigWrite != null)
                    hashCode = hashCode * 59 + this.CheckoutConfigWrite.GetHashCode();
                if (this.Id != null)
