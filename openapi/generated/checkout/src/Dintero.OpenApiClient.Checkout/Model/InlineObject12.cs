...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class InlineObject12 : IEquatable<InlineObject12>, IValidatableObject
    {
        ...
        public InlineObject12(string storeId = default(string), SwishGwStoreOverrideWrite _override = default(SwishGwStoreOverrideWrite))
        {
            // to ensure "storeId" is required (not null)
            this.StoreId = storeId ?? throw new ArgumentNullException("storeId is a required property for InlineObject12 and cannot be null");
        ...
        public SwishGwStoreOverrideWrite Override { get; set; }
