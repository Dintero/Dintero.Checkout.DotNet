...
{
    /// <summary>
    /// IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutputFraudResults
    /// </summary>
    [DataContract(Name = "IngenicoWebhookEvent_payment_paymentOutput_cardPaymentMethodSpecificOutput_fraudResults")]
    public partial class IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutputFraudResults : IEquatable<IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutputFraudResults>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutputFraudResults" /> class.
        /// </summary>
        /// <param name="avsResult">avsResult.</param>
        /// <param name="cvvResult">cvvResult.</param>
        /// <param name="fraudServiceResult">fraudServiceResult.</param>
        public IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutputFraudResults(string avsResult = default(string), string cvvResult = default(string), string fraudServiceResult = default(string))
        {
        ...
        /// </summary>
        [DataMember(Name = "cvvResult", EmitDefaultValue = false)]
        public string CvvResult { get; set; }

        /// <summary>
        /// Gets or Sets FraudServiceResult
        /// </summary>
        [DataMember(Name = "fraudServiceResult", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutputFraudResults {\n");
        ...
        {
            return this.Equals(input as IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutputFraudResults);
        }

        /// <summary>
        /// Returns true if IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutputFraudResults instances are equal
        /// </summary>
        /// <param name="input">Instance of IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutputFraudResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IngenicoWebhookEventPaymentPaymentOutputCardPaymentMethodSpecificOutputFraudResults input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.FraudServiceResult == input.FraudServiceResult ||
                    (this.FraudServiceResult != null &&
                    this.FraudServiceResult.Equals(input.FraudServiceResult))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.FraudServiceResult != null)
                    hashCode = hashCode * 59 + this.FraudServiceResult.GetHashCode();
                return hashCode;
            }
        }
