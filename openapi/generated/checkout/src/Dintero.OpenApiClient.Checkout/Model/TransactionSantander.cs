...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransactionSantander")]
    [JsonConverter(typeof(JsonSubtypes), "PaymentProduct")]
    public partial class TransactionSantander : Transaction, IEquatable<TransactionSantander>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionSantander" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionSantander() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionSantander" /> class.
        /// </summary>
        ...
        /// <param name="paymentProduct">The payment product corresponding to this transaction  (required) (default to &quot;TransactionSantander&quot;).</param>
        ...
        public TransactionSantander(string id = default(string), DateTime createdAt = default(DateTime), PaymentProductTypeEnum paymentProductType = default(PaymentProductTypeEnum), List<TransactionSantanderAllOfEvents> events = default(List<TransactionSantanderAllOfEvents>), TransactionSantanderAllOfMetadata metadata = default(TransactionSantanderAllOfMetadata), string paymentProduct = "TransactionSantander", int amount = default(int), string currency = default(string), string merchantReference = default(string), string merchantReference2 = default(string), string dynamicDescriptor = default(string), SettlementStatus? settlementStatus = default(SettlementStatus?), TransactionCustomer customer = default(TransactionCustomer), string customerIp = default(string), string userAgent = default(string), OrderAddress shippingAddress = default(OrderAddress), ShippingOption shippingOption = default(ShippingOption), OrderAddress billingAddress = default(OrderAddress), Store store = default(Store), List<OrderItem> items = default(List<OrderItem>), TransactionUrl url = default(TransactionUrl), string sessionId = default(string), Session session = default(Session), DateTime updatedAt = default(DateTime)) : base(paymentProduct, amount, currency, merchantReference, merchantReference2, dynamicDescriptor, settlementStatus, customer, customerIp, userAgent, shippingAddress, shippingOption, billingAddress, store, items, url, sessionId, session, updatedAt)
        {
        ...
        public List<TransactionSantanderAllOfEvents> Events { get; set; }

        /// <summary>
        /// Gets or Sets Metadata
        /// </summary>
        [DataMember(Name = "metadata", EmitDefaultValue = false)]
        public TransactionSantanderAllOfMetadata Metadata { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionSantander {\n");
        ...
        {
            return this.Equals(input as TransactionSantander);
        }

        /// <summary>
        /// Returns true if TransactionSantander instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionSantander to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionSantander input)
        {
            if (input == null)
                return false;
