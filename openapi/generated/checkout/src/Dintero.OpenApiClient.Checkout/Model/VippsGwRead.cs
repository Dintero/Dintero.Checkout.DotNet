...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VippsGwRead")]
    public partial class VippsGwRead : IEquatable<VippsGwRead>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VippsGwRead" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VippsGwRead() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VippsGwRead" /> class.
        /// </summary>
        ...
        public VippsGwRead(string url = default(string), string clientId = default(string), string merchantSerialNumber = default(string))
        {
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url is a required property for VippsGwRead and cannot be null");
            // to ensure "clientId" is required (not null)
            this.ClientId = clientId ?? throw new ArgumentNullException("clientId is a required property for VippsGwRead and cannot be null");
            // to ensure "merchantSerialNumber" is required (not null)
            this.MerchantSerialNumber = merchantSerialNumber ?? throw new ArgumentNullException("merchantSerialNumber is a required property for VippsGwRead and cannot be null");
        }
        ...
        {
            return this.Equals(input as VippsGwRead);
        }

        /// <summary>
        /// Returns true if VippsGwRead instances are equal
        /// </summary>
        /// <param name="input">Instance of VippsGwRead to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VippsGwRead input)
        {
            if (input == null)
                return false;
