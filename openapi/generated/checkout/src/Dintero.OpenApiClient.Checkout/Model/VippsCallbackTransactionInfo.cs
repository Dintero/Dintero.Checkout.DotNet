...
{
    /// <summary>
    /// VippsCallbackTransactionInfo
    /// </summary>
    [DataContract(Name = "VippsCallback_transactionInfo")]
    public partial class VippsCallbackTransactionInfo : IEquatable<VippsCallbackTransactionInfo>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        public enum StatusEnum
        {
            ...
            /// <summary>
            /// Enum RESERVEFAILED for value: RESERVE_FAILED
            /// </summary>
            [EnumMember(Value = "RESERVE_FAILED")]
            RESERVEFAILED = 3,

            /// <summary>
            /// Enum SALEFAILED for value: SALE_FAILED
            /// </summary>
            [EnumMember(Value = "SALE_FAILED")]
            SALEFAILED = 4,
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VippsCallbackTransactionInfo" /> class.
        /// </summary>
        /// <param name="amount">amount.</param>
        /// <param name="status">status.</param>
        /// <param name="timeStamp">timeStamp.</param>
        /// <param name="transactionId">transactionId.</param>
        public VippsCallbackTransactionInfo(decimal amount = default(decimal), StatusEnum? status = default(StatusEnum?), DateTime timeStamp = default(DateTime), string transactionId = default(string))
        {
            this.Amount = amount;
            this.Status = status;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VippsCallbackTransactionInfo {\n");
        ...
        {
            return this.Equals(input as VippsCallbackTransactionInfo);
        }

        /// <summary>
        /// Returns true if VippsCallbackTransactionInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of VippsCallbackTransactionInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VippsCallbackTransactionInfo input)
        {
            if (input == null)
                return false;
