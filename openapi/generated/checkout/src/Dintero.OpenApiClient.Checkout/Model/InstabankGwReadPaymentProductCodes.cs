...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InstabankGwRead_payment_product_codes")]
    public partial class InstabankGwReadPaymentProductCodes : IEquatable<InstabankGwReadPaymentProductCodes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankGwReadPaymentProductCodes" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstabankGwReadPaymentProductCodes() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankGwReadPaymentProductCodes" /> class.
        /// </summary>
        /// <param name="instabankFinance">instabankFinance (required).</param>
        /// <param name="instabankInvoice">instabankInvoice (required).</param>
        /// <param name="instabankInstallment">instabankInstallment.</param>
        /// <param name="instabankPostponement">instabankPostponement.</param>
        public InstabankGwReadPaymentProductCodes(InstabankFinanceProduct instabankFinance = default(InstabankFinanceProduct), InstabankInvoiceProduct instabankInvoice = default(InstabankInvoiceProduct), List<InstabankInstallmentProduct> instabankInstallment = default(List<InstabankInstallmentProduct>), List<InstabankPostponementProduct> instabankPostponement = default(List<InstabankPostponementProduct>))
        {
            // to ensure "instabankFinance" is required (not null)
            this.InstabankFinance = instabankFinance ?? throw new ArgumentNullException("instabankFinance is a required property for InstabankGwReadPaymentProductCodes and cannot be null");
            // to ensure "instabankInvoice" is required (not null)
            this.InstabankInvoice = instabankInvoice ?? throw new ArgumentNullException("instabankInvoice is a required property for InstabankGwReadPaymentProductCodes and cannot be null");
            this.InstabankInstallment = instabankInstallment;
            this.InstabankPostponement = instabankPostponement;
        }

        /// <summary>
        /// Gets or Sets InstabankFinance
        /// </summary>
        [DataMember(Name = "instabank.finance", IsRequired = true, EmitDefaultValue = false)]
        public InstabankFinanceProduct InstabankFinance { get; set; }

        /// <summary>
        /// Gets or Sets InstabankInvoice
        /// </summary>
        [DataMember(Name = "instabank.invoice", IsRequired = true, EmitDefaultValue = false)]
        public InstabankInvoiceProduct InstabankInvoice { get; set; }

        /// <summary>
        /// Gets or Sets InstabankInstallment
        /// </summary>
        [DataMember(Name = "instabank.installment", EmitDefaultValue = false)]
        public List<InstabankInstallmentProduct> InstabankInstallment { get; set; }

        /// <summary>
        /// Gets or Sets InstabankPostponement
        /// </summary>
        [DataMember(Name = "instabank.postponement", EmitDefaultValue = false)]
        public List<InstabankPostponementProduct> InstabankPostponement { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstabankGwReadPaymentProductCodes {\n");
            sb.Append("  InstabankFinance: ").Append(InstabankFinance).Append("\n");
            sb.Append("  InstabankInvoice: ").Append(InstabankInvoice).Append("\n");
            sb.Append("  InstabankInstallment: ").Append(InstabankInstallment).Append("\n");
            sb.Append("  InstabankPostponement: ").Append(InstabankPostponement).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as InstabankGwReadPaymentProductCodes);
        }

        /// <summary>
        /// Returns true if InstabankGwReadPaymentProductCodes instances are equal
        /// </summary>
        /// <param name="input">Instance of InstabankGwReadPaymentProductCodes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstabankGwReadPaymentProductCodes input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.InstabankFinance == input.InstabankFinance ||
                    (this.InstabankFinance != null &&
                    this.InstabankFinance.Equals(input.InstabankFinance))
                ) && 
                (
                    this.InstabankInvoice == input.InstabankInvoice ||
                    (this.InstabankInvoice != null &&
                    this.InstabankInvoice.Equals(input.InstabankInvoice))
                ) && 
                (
                    this.InstabankInstallment == input.InstabankInstallment ||
                    this.InstabankInstallment != null &&
                    input.InstabankInstallment != null &&
                    this.InstabankInstallment.SequenceEqual(input.InstabankInstallment)
                ) && 
                (
                    this.InstabankPostponement == input.InstabankPostponement ||
                    this.InstabankPostponement != null &&
                    input.InstabankPostponement != null &&
                    this.InstabankPostponement.SequenceEqual(input.InstabankPostponement)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.InstabankFinance != null)
                    hashCode = hashCode * 59 + this.InstabankFinance.GetHashCode();
                if (this.InstabankInvoice != null)
                    hashCode = hashCode * 59 + this.InstabankInvoice.GetHashCode();
                if (this.InstabankInstallment != null)
                    hashCode = hashCode * 59 + this.InstabankInstallment.GetHashCode();
                if (this.InstabankPostponement != null)
                    hashCode = hashCode * 59 + this.InstabankPostponement.GetHashCode();
                return hashCode;
            }
        }
