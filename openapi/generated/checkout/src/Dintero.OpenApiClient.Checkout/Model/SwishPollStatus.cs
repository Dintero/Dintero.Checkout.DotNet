...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// SwishPollStatus
    /// </summary>
    [DataContract(Name = "SwishPollStatus")]
    public partial class SwishPollStatus : IEquatable<SwishPollStatus>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SwishPollStatus" /> class.
        /// </summary>
        /// <param name="keepPolling">keepPolling.</param>
        /// <param name="redirectUrl">redirect url to complete payment, will not be included if the payment failed with &#x60;Rejected&#x60; error as payment can be completed by choosing alternative payment option. .</param>
        /// <param name="pollUrl">poll_url to check the status of the payment. Will be included if the payment is dependent on 3rd party apps, such as Swish. .</param>
        public SwishPollStatus(bool keepPolling = default(bool), string redirectUrl = default(string), string pollUrl = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets KeepPolling
        /// </summary>
        [DataMember(Name = "keep_polling", EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>redirect url to complete payment, will not be included if the payment failed with &#x60;Rejected&#x60; error as payment can be completed by choosing alternative payment option. </value>
        ...
        /// </summary>
        /// <value>poll_url to check the status of the payment. Will be included if the payment is dependent on 3rd party apps, such as Swish. </value>
        [DataMember(Name = "poll_url", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SwishPollStatus {\n");
            sb.Append("  KeepPolling: ").Append(KeepPolling).Append("\n");
        ...
        {
            return this.Equals(input as SwishPollStatus);
        }

        /// <summary>
        /// Returns true if SwishPollStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of SwishPollStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SwishPollStatus input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.KeepPolling == input.KeepPolling ||
                    this.KeepPolling.Equals(input.KeepPolling)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = hashCode * 59 + this.KeepPolling.GetHashCode();
