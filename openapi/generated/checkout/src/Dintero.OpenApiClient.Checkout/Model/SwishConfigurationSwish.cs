...
{
    /// <summary>
    /// SwishConfigurationSwish
    /// </summary>
    [DataContract(Name = "SwishConfiguration_swish")]
    public partial class SwishConfigurationSwish : IEquatable<SwishConfigurationSwish>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SwishConfigurationSwish" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SwishConfigurationSwish() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SwishConfigurationSwish" /> class.
        /// </summary>
        /// <param name="type">Denotes what kind of config parameter this is.</param>
        /// <param name="enabled">enable Swish Payment (required).</param>
        /// <param name="payability">payability.</param>
        public SwishConfigurationSwish(TypeEnum? type = default(TypeEnum?), bool enabled = default(bool), SessionPayability? payability = default(SessionPayability?))
        {
        ...
        /// </summary>
        /// <value>enable Swish Payment</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SwishConfigurationSwish {\n");
        ...
        {
            return this.Equals(input as SwishConfigurationSwish);
        }

        /// <summary>
        /// Returns true if SwishConfigurationSwish instances are equal
        /// </summary>
        /// <param name="input">Instance of SwishConfigurationSwish to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SwishConfigurationSwish input)
        {
            if (input == null)
                return false;
