...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CollectorGwRead")]
    public partial class CollectorGwRead : IEquatable<CollectorGwRead>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorGwRead" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorGwRead() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorGwRead" /> class.
        /// </summary>
        ...
        public CollectorGwRead(string url = default(string), string username = default(string), decimal storeId = default(decimal), string country = default(string), CollectorGwReadOptions options = default(CollectorGwReadOptions), List<CollectorGwReadStores> stores = default(List<CollectorGwReadStores>))
        {
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url is a required property for CollectorGwRead and cannot be null");
            // to ensure "username" is required (not null)
            this.Username = username ?? throw new ArgumentNullException("username is a required property for CollectorGwRead and cannot be null");
            this.StoreId = storeId;
            // to ensure "country" is required (not null)
            this.Country = country ?? throw new ArgumentNullException("country is a required property for CollectorGwRead and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorGwRead {\n");
        ...
        {
            return this.Equals(input as CollectorGwRead);
        }

        /// <summary>
        /// Returns true if CollectorGwRead instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorGwRead to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorGwRead input)
        {
            if (input == null)
                return false;
