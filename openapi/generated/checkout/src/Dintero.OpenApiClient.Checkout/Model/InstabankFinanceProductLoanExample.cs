...
{
    /// <summary>
    /// InstabankFinanceProductLoanExample
    /// </summary>
    [DataContract(Name = "InstabankFinanceProduct_loan_example")]
    public partial class InstabankFinanceProductLoanExample : IEquatable<InstabankFinanceProductLoanExample>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankFinanceProductLoanExample" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstabankFinanceProductLoanExample() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankFinanceProductLoanExample" /> class.
        /// </summary>
        /// <param name="amount">The amount loaned in the example.  (required).</param>
        /// <param name="years">Years of payment in the example.  (required).</param>
        /// <param name="totalAmount">The total amount paid back in the example.  (required).</param>
        /// <param name="cost">The cost of the loan in the example.  (required).</param>
        public InstabankFinanceProductLoanExample(int amount = default(int), int years = default(int), int totalAmount = default(int), int cost = default(int))
        {
            this.Amount = amount;
            this.Years = years;
        ...
        /// </summary>
        /// <value>The amount loaned in the example. </value>
        ...
        /// </summary>
        /// <value>Years of payment in the example. </value>
        [DataMember(Name = "years", IsRequired = true, EmitDefaultValue = false)]
        public int Years { get; set; }

        /// <summary>
        /// The total amount paid back in the example. 
        /// </summary>
        /// <value>The total amount paid back in the example. </value>
        ...
        /// </summary>
        /// <value>The cost of the loan in the example. </value>
        ...
        /// </summary>
        /// <value>The effective annual interest rate in the example </value>
        [DataMember(Name = "effective_annual_interest_rate", IsRequired = true, EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstabankFinanceProductLoanExample {\n");
        ...
        {
            return this.Equals(input as InstabankFinanceProductLoanExample);
        }

        /// <summary>
        /// Returns true if InstabankFinanceProductLoanExample instances are equal
        /// </summary>
        /// <param name="input">Instance of InstabankFinanceProductLoanExample to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstabankFinanceProductLoanExample input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // TotalAmount (int) minimum
            if(this.TotalAmount < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TotalAmount, must be a value greater than or equal to 0.", new [] { "TotalAmount" });
            }
