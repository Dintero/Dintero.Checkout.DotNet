...
{
    /// <summary>
    /// TransactionCollectorAllOfMetadata
    /// </summary>
    [DataContract(Name = "TransactionCollector_allOf_metadata")]
    public partial class TransactionCollectorAllOfMetadata : IEquatable<TransactionCollectorAllOfMetadata>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionCollectorAllOfMetadata" /> class.
        /// </summary>
        /// <param name="collectorInvoiceInvoiceStatus">External status reported after adding invoice and activating invoice.</param>
        /// <param name="collectorCorrelationId">External request id .</param>
        /// <param name="collectorInvoicePaymentReference">The payment identification number. This is the id the customer must use when they do a payment of an invoice. .</param>
        /// <param name="collectorInvoiceLowestAmountToPay">The lowest amount to pay on the invoice..</param>
        /// <param name="collectorInvoiceTotalAmount">The total amount to pay for the invoice..</param>
        /// <param name="collectorInvoiceDueDate">The due date of the invoice..</param>
        /// <param name="collectorInvoiceInvoiceUrl">The url to invoice in pdf format..</param>
        /// <param name="collectorInvoiceCurrentInvoiceNumber">The invoice number of the invoice that this event belongs to..</param>
        /// <param name="collectorInvoiceNewInvoiceNumber">The invoice number for the next capture..</param>
        public TransactionCollectorAllOfMetadata(decimal collectorInvoiceInvoiceStatus = default(decimal), string collectorCorrelationId = default(string), string collectorInvoicePaymentReference = default(string), decimal collectorInvoiceLowestAmountToPay = default(decimal), decimal collectorInvoiceTotalAmount = default(decimal), string collectorInvoiceDueDate = default(string), string collectorInvoiceInvoiceUrl = default(string), string collectorInvoiceCurrentInvoiceNumber = default(string), string collectorInvoiceNewInvoiceNumber = default(string))
        {
            this.CollectorInvoiceInvoiceStatus = collectorInvoiceInvoiceStatus;
            this.CollectorCorrelationId = collectorCorrelationId;
            this.CollectorInvoicePaymentReference = collectorInvoicePaymentReference;
            this.CollectorInvoiceLowestAmountToPay = collectorInvoiceLowestAmountToPay;
            this.CollectorInvoiceTotalAmount = collectorInvoiceTotalAmount;
            this.CollectorInvoiceDueDate = collectorInvoiceDueDate;
            this.CollectorInvoiceInvoiceUrl = collectorInvoiceInvoiceUrl;
            this.CollectorInvoiceCurrentInvoiceNumber = collectorInvoiceCurrentInvoiceNumber;
            this.CollectorInvoiceNewInvoiceNumber = collectorInvoiceNewInvoiceNumber;
        }

        /// <summary>
        /// External status reported after adding invoice and activating invoice
        /// </summary>
        /// <value>External status reported after adding invoice and activating invoice</value>
        [DataMember(Name = "collector:Invoice.InvoiceStatus", EmitDefaultValue = false)]
        public decimal CollectorInvoiceInvoiceStatus { get; set; }

        /// <summary>
        /// External request id 
        /// </summary>
        /// <value>External request id </value>
        [DataMember(Name = "collector:CorrelationId", EmitDefaultValue = false)]
        public string CollectorCorrelationId { get; set; }

        /// <summary>
        /// The payment identification number. This is the id the customer must use when they do a payment of an invoice. 
        /// </summary>
        /// <value>The payment identification number. This is the id the customer must use when they do a payment of an invoice. </value>
        [DataMember(Name = "collector:Invoice.PaymentReference", EmitDefaultValue = false)]
        public string CollectorInvoicePaymentReference { get; set; }

        /// <summary>
        /// The lowest amount to pay on the invoice.
        /// </summary>
        /// <value>The lowest amount to pay on the invoice.</value>
        [DataMember(Name = "collector:Invoice.LowestAmountToPay", EmitDefaultValue = false)]
        public decimal CollectorInvoiceLowestAmountToPay { get; set; }

        /// <summary>
        /// The total amount to pay for the invoice.
        /// </summary>
        /// <value>The total amount to pay for the invoice.</value>
        [DataMember(Name = "collector:Invoice.TotalAmount", EmitDefaultValue = false)]
        public decimal CollectorInvoiceTotalAmount { get; set; }

        /// <summary>
        /// The due date of the invoice.
        /// </summary>
        /// <value>The due date of the invoice.</value>
        [DataMember(Name = "collector:Invoice.DueDate", EmitDefaultValue = false)]
        public string CollectorInvoiceDueDate { get; set; }

        /// <summary>
        /// The url to invoice in pdf format.
        /// </summary>
        /// <value>The url to invoice in pdf format.</value>
        [DataMember(Name = "collector:Invoice.InvoiceUrl", EmitDefaultValue = false)]
        public string CollectorInvoiceInvoiceUrl { get; set; }

        /// <summary>
        /// The invoice number of the invoice that this event belongs to.
        /// </summary>
        /// <value>The invoice number of the invoice that this event belongs to.</value>
        [DataMember(Name = "collector:Invoice.CurrentInvoiceNumber", EmitDefaultValue = false)]
        public string CollectorInvoiceCurrentInvoiceNumber { get; set; }

        /// <summary>
        /// The invoice number for the next capture.
        /// </summary>
        /// <value>The invoice number for the next capture.</value>
        [DataMember(Name = "collector:Invoice.NewInvoiceNumber", EmitDefaultValue = false)]
        public string CollectorInvoiceNewInvoiceNumber { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionCollectorAllOfMetadata {\n");
            sb.Append("  CollectorInvoiceInvoiceStatus: ").Append(CollectorInvoiceInvoiceStatus).Append("\n");
            sb.Append("  CollectorCorrelationId: ").Append(CollectorCorrelationId).Append("\n");
            sb.Append("  CollectorInvoicePaymentReference: ").Append(CollectorInvoicePaymentReference).Append("\n");
            sb.Append("  CollectorInvoiceLowestAmountToPay: ").Append(CollectorInvoiceLowestAmountToPay).Append("\n");
            sb.Append("  CollectorInvoiceTotalAmount: ").Append(CollectorInvoiceTotalAmount).Append("\n");
            sb.Append("  CollectorInvoiceDueDate: ").Append(CollectorInvoiceDueDate).Append("\n");
            sb.Append("  CollectorInvoiceInvoiceUrl: ").Append(CollectorInvoiceInvoiceUrl).Append("\n");
            sb.Append("  CollectorInvoiceCurrentInvoiceNumber: ").Append(CollectorInvoiceCurrentInvoiceNumber).Append("\n");
            sb.Append("  CollectorInvoiceNewInvoiceNumber: ").Append(CollectorInvoiceNewInvoiceNumber).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TransactionCollectorAllOfMetadata);
        }

        /// <summary>
        /// Returns true if TransactionCollectorAllOfMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionCollectorAllOfMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionCollectorAllOfMetadata input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.CollectorInvoiceInvoiceStatus == input.CollectorInvoiceInvoiceStatus ||
                    this.CollectorInvoiceInvoiceStatus.Equals(input.CollectorInvoiceInvoiceStatus)
                ) && 
                (
                    this.CollectorCorrelationId == input.CollectorCorrelationId ||
                    (this.CollectorCorrelationId != null &&
                    this.CollectorCorrelationId.Equals(input.CollectorCorrelationId))
                ) && 
                (
                    this.CollectorInvoicePaymentReference == input.CollectorInvoicePaymentReference ||
                    (this.CollectorInvoicePaymentReference != null &&
                    this.CollectorInvoicePaymentReference.Equals(input.CollectorInvoicePaymentReference))
                ) && 
                (
                    this.CollectorInvoiceLowestAmountToPay == input.CollectorInvoiceLowestAmountToPay ||
                    this.CollectorInvoiceLowestAmountToPay.Equals(input.CollectorInvoiceLowestAmountToPay)
                ) && 
                (
                    this.CollectorInvoiceTotalAmount == input.CollectorInvoiceTotalAmount ||
                    this.CollectorInvoiceTotalAmount.Equals(input.CollectorInvoiceTotalAmount)
                ) && 
                (
                    this.CollectorInvoiceDueDate == input.CollectorInvoiceDueDate ||
                    (this.CollectorInvoiceDueDate != null &&
                    this.CollectorInvoiceDueDate.Equals(input.CollectorInvoiceDueDate))
                ) && 
                (
                    this.CollectorInvoiceInvoiceUrl == input.CollectorInvoiceInvoiceUrl ||
                    (this.CollectorInvoiceInvoiceUrl != null &&
                    this.CollectorInvoiceInvoiceUrl.Equals(input.CollectorInvoiceInvoiceUrl))
                ) && 
                (
                    this.CollectorInvoiceCurrentInvoiceNumber == input.CollectorInvoiceCurrentInvoiceNumber ||
                    (this.CollectorInvoiceCurrentInvoiceNumber != null &&
                    this.CollectorInvoiceCurrentInvoiceNumber.Equals(input.CollectorInvoiceCurrentInvoiceNumber))
                ) && 
                (
                    this.CollectorInvoiceNewInvoiceNumber == input.CollectorInvoiceNewInvoiceNumber ||
                    (this.CollectorInvoiceNewInvoiceNumber != null &&
                    this.CollectorInvoiceNewInvoiceNumber.Equals(input.CollectorInvoiceNewInvoiceNumber))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = hashCode * 59 + this.CollectorInvoiceInvoiceStatus.GetHashCode();
                if (this.CollectorCorrelationId != null)
                    hashCode = hashCode * 59 + this.CollectorCorrelationId.GetHashCode();
                if (this.CollectorInvoicePaymentReference != null)
                    hashCode = hashCode * 59 + this.CollectorInvoicePaymentReference.GetHashCode();
                hashCode = hashCode * 59 + this.CollectorInvoiceLowestAmountToPay.GetHashCode();
                hashCode = hashCode * 59 + this.CollectorInvoiceTotalAmount.GetHashCode();
                if (this.CollectorInvoiceDueDate != null)
                    hashCode = hashCode * 59 + this.CollectorInvoiceDueDate.GetHashCode();
                if (this.CollectorInvoiceInvoiceUrl != null)
                    hashCode = hashCode * 59 + this.CollectorInvoiceInvoiceUrl.GetHashCode();
                if (this.CollectorInvoiceCurrentInvoiceNumber != null)
                    hashCode = hashCode * 59 + this.CollectorInvoiceCurrentInvoiceNumber.GetHashCode();
                if (this.CollectorInvoiceNewInvoiceNumber != null)
                    hashCode = hashCode * 59 + this.CollectorInvoiceNewInvoiceNumber.GetHashCode();
                return hashCode;
            }
        }
