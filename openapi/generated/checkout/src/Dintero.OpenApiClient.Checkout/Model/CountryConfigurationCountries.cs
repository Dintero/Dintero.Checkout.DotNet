...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// Country preferences 
    /// </summary>
    [DataContract(Name = "CountryConfiguration_countries")]
    public partial class CountryConfigurationCountries : IEquatable<CountryConfigurationCountries>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CountryConfigurationCountries" /> class.
        /// </summary>
        /// <param name="preferredCountry">Country to use as default in address and phone country code .</param>
        /// <param name="allowCountries">List of countries where the customer is allowed to set their address. If empty, all countries are allowed, except for the ones in &#x60;deny_countries&#x60;.  A country can not be in both &#x60;allow_countries&#x60; and &#x60;deny_countries&#x60;. .</param>
        /// <param name="denyCountries">List of countries where the customer is not allowed to set their address.  A country can not be in both &#x60;allow_countries&#x60; and &#x60;deny_countries&#x60;. .</param>
        public CountryConfigurationCountries(string preferredCountry = default(string), List<string> allowCountries = default(List<string>), List<string> denyCountries = default(List<string>))
        {
        ...
        /// </summary>
        /// <value>Country to use as default in address and phone country code </value>
        [DataMember(Name = "preferred_country", EmitDefaultValue = false)]
        public string PreferredCountry { get; set; }

        /// <summary>
        /// List of countries where the customer is allowed to set their address. If empty, all countries are allowed, except for the ones in &#x60;deny_countries&#x60;.  A country can not be in both &#x60;allow_countries&#x60; and &#x60;deny_countries&#x60;. 
        /// </summary>
        /// <value>List of countries where the customer is allowed to set their address. If empty, all countries are allowed, except for the ones in &#x60;deny_countries&#x60;.  A country can not be in both &#x60;allow_countries&#x60; and &#x60;deny_countries&#x60;. </value>
        [DataMember(Name = "allow_countries", EmitDefaultValue = false)]
        public List<string> AllowCountries { get; set; }

        /// <summary>
        /// List of countries where the customer is not allowed to set their address.  A country can not be in both &#x60;allow_countries&#x60; and &#x60;deny_countries&#x60;. 
        /// </summary>
        /// <value>List of countries where the customer is not allowed to set their address.  A country can not be in both &#x60;allow_countries&#x60; and &#x60;deny_countries&#x60;. </value>
        [DataMember(Name = "deny_countries", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CountryConfigurationCountries {\n");
            sb.Append("  PreferredCountry: ").Append(PreferredCountry).Append("\n");
            sb.Append("  AllowCountries: ").Append(AllowCountries).Append("\n");
            sb.Append("  DenyCountries: ").Append(DenyCountries).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as CountryConfigurationCountries);
        }

        /// <summary>
        /// Returns true if CountryConfigurationCountries instances are equal
        /// </summary>
        /// <param name="input">Instance of CountryConfigurationCountries to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CountryConfigurationCountries input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    ...
                    this.PreferredCountry.Equals(input.PreferredCountry))
                ) && 
                (
                    this.AllowCountries == input.AllowCountries ||
                    this.AllowCountries != null &&
                    input.AllowCountries != null &&
                    this.AllowCountries.SequenceEqual(input.AllowCountries)
                ) && 
                (
                    this.DenyCountries == input.DenyCountries ||
                    this.DenyCountries != null &&
                    input.DenyCountries != null &&
                    this.DenyCountries.SequenceEqual(input.DenyCountries)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PreferredCountry != null)
                    hashCode = hashCode * 59 + this.PreferredCountry.GetHashCode();
                if (this.AllowCountries != null)
                    hashCode = hashCode * 59 + this.AllowCountries.GetHashCode();
                if (this.DenyCountries != null)
                    hashCode = hashCode * 59 + this.DenyCountries.GetHashCode();
                return hashCode;
            }
        }
