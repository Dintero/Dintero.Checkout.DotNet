...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SantanderGwStoreOverrideWrite")]
    public partial class SantanderGwStoreOverrideWrite : IEquatable<SantanderGwStoreOverrideWrite>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SantanderGwStoreOverrideWrite" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SantanderGwStoreOverrideWrite() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SantanderGwStoreOverrideWrite" /> class.
        /// </summary>
        ...
        public SantanderGwStoreOverrideWrite(string storeEmail = default(string), string storeToken = default(string))
        {
            // to ensure "storeEmail" is required (not null)
            this.StoreEmail = storeEmail ?? throw new ArgumentNullException("storeEmail is a required property for SantanderGwStoreOverrideWrite and cannot be null");
            // to ensure "storeToken" is required (not null)
            this.StoreToken = storeToken ?? throw new ArgumentNullException("storeToken is a required property for SantanderGwStoreOverrideWrite and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SantanderGwStoreOverrideWrite {\n");
        ...
        {
            return this.Equals(input as SantanderGwStoreOverrideWrite);
        }

        /// <summary>
        /// Returns true if SantanderGwStoreOverrideWrite instances are equal
        /// </summary>
        /// <param name="input">Instance of SantanderGwStoreOverrideWrite to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SantanderGwStoreOverrideWrite input)
        {
            if (input == null)
                return false;
