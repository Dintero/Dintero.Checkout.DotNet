...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateSessionOptions")]
    public partial class UpdateSessionOptions : IEquatable<UpdateSessionOptions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateSessionOptions" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateSessionOptions() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateSessionOptions" /> class.
        /// </summary>
        /// <param name="order">order (required).</param>
        /// <param name="removeLock">Remove lock after updating (default to true).</param>
        public UpdateSessionOptions(SessionOrderUpdate order = default(SessionOrderUpdate), bool removeLock = true)
        {
            // to ensure "order" is required (not null)
            this.Order = order ?? throw new ArgumentNullException("order is a required property for UpdateSessionOptions and cannot be null");
        ...
        public SessionOrderUpdate Order { get; set; }

        /// <summary>
        /// Remove lock after updating
        /// </summary>
        /// <value>Remove lock after updating</value>
        [DataMember(Name = "remove_lock", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateSessionOptions {\n");
            sb.Append("  Order: ").Append(Order).Append("\n");
            sb.Append("  RemoveLock: ").Append(RemoveLock).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as UpdateSessionOptions);
        }

        /// <summary>
        /// Returns true if UpdateSessionOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateSessionOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateSessionOptions input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.RemoveLock == input.RemoveLock ||
                    this.RemoveLock.Equals(input.RemoveLock)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.RemoveLock.GetHashCode();
                return hashCode;
            }
        }
