...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// SessionRead
    /// </summary>
    [DataContract(Name = "SessionRead")]
    public partial class SessionRead : IEquatable<SessionRead>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionRead" /> class.
        /// </summary>
        /// <param name="customer">customer.</param>
        /// <param name="configuration">configuration.</param>
        public SessionRead(SessionReadCustomer customer = default(SessionReadCustomer), SessionReadConfiguration configuration = default(SessionReadConfiguration))
        {
        ...
        public SessionReadCustomer Customer { get; set; }

        /// <summary>
        /// Gets or Sets Configuration
        /// </summary>
        [DataMember(Name = "configuration", EmitDefaultValue = false)]
        public SessionReadConfiguration Configuration { get; set; }
        ...
        {
            return this.Equals(input as SessionRead);
        }

        /// <summary>
        /// Returns true if SessionRead instances are equal
        /// </summary>
        /// <param name="input">Instance of SessionRead to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SessionRead input)
        {
            if (input == null)
                return false;
