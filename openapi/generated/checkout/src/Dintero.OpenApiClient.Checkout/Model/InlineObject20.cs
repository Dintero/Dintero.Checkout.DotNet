...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class InlineObject20 : IEquatable<InlineObject20>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="InlineObject20" /> class.
        /// </summary>
        /// <param name="amount">The amount to be captured (required).</param>
        /// <param name="captureReference">A reference specified by the merchant to identify the transaction .</param>
        /// <param name="items">Info about the captured order items  #### Instabank &#x60;required&#x60; if the transaction &#x60;payment_product&#x60; is *instabank*. The capture will then be applied to the items included. .</param>
        public InlineObject20(int amount = default(int), string captureReference = default(string), List<OrderItem> items = default(List<OrderItem>))
        {
            this.Amount = amount;
        ...
        /// </summary>
        /// <value>The amount to be captured</value>
        ...
        [DataMember(Name = "capture_reference", EmitDefaultValue = false)]
        public string CaptureReference { get; set; }

        /// <summary>
        /// Info about the captured order items  #### Instabank &#x60;required&#x60; if the transaction &#x60;payment_product&#x60; is *instabank*. The capture will then be applied to the items included. 
        /// </summary>
        /// <value>Info about the captured order items  #### Instabank &#x60;required&#x60; if the transaction &#x60;payment_product&#x60; is *instabank*. The capture will then be applied to the items included. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CaptureReference: ").Append(CaptureReference).Append("\n");
        ...
        public bool Equals(InlineObject20 input)
        {
            ...
            return 
                ...
                (
                    this.CaptureReference == input.CaptureReference ||
                    (this.CaptureReference != null &&
                    this.CaptureReference.Equals(input.CaptureReference))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CaptureReference != null)
                    hashCode = hashCode * 59 + this.CaptureReference.GetHashCode();
                if (this.Items != null)
