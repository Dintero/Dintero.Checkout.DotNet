...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class InlineResponse2006 : IEquatable<InlineResponse2006>, IValidatableObject
    {
        ...
        public InlineResponse2006(DiscountCodesOrderUpdate order = default(DiscountCodesOrderUpdate), List<ShippingOption> shippingOptions = default(List<ShippingOption>))
        {
            // to ensure "shippingOptions" is required (not null)
            this.ShippingOptions = shippingOptions ?? throw new ArgumentNullException("shippingOptions is a required property for InlineResponse2006 and cannot be null");
            this.Order = order;
        }
        ...
        public DiscountCodesOrderUpdate Order { get; set; }
