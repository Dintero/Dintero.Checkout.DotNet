...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// MitSessionOptions
    /// </summary>
    [DataContract(Name = "MitSessionOptions")]
    public partial class MitSessionOptions : IEquatable<MitSessionOptions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MitSessionOptions" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MitSessionOptions() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MitSessionOptions" /> class.
        /// </summary>
        ...
        public MitSessionOptions(MitSessionBaseUrl url = default(MitSessionBaseUrl), SessionCustomer customer = default(SessionCustomer), SessionOrder order = default(SessionOrder), DateTime expiresAt = default(DateTime), AutoCaptureConfiguration configuration = default(AutoCaptureConfiguration))
        {
            // to ensure "order" is required (not null)
            this.Order = order ?? throw new ArgumentNullException("order is a required property for MitSessionOptions and cannot be null");
            this.Url = url;
        ...
        public MitSessionBaseUrl Url { get; set; }
        ...
        public AutoCaptureConfiguration Configuration { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MitSessionOptions {\n");
        ...
        {
            return this.Equals(input as MitSessionOptions);
        }

        /// <summary>
        /// Returns true if MitSessionOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of MitSessionOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MitSessionOptions input)
        {
            if (input == null)
                return false;
