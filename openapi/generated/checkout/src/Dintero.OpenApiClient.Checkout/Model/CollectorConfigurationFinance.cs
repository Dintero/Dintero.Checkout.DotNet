...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CollectorConfiguration_finance")]
    public partial class CollectorConfigurationFinance : IEquatable<CollectorConfigurationFinance>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorConfigurationFinance" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorConfigurationFinance() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorConfigurationFinance" /> class.
        /// </summary>
        /// <param name="type">Denotes what kind of config parameter this is (default to TypeEnum.PaymentProductType).</param>
        /// <param name="enabled">enable Collector Bank Finance Payment (required).</param>
        /// <param name="countries">countries.</param>
        /// <param name="payability">payability.</param>
        public CollectorConfigurationFinance(TypeEnum? type = TypeEnum.PaymentProductType, bool enabled = default(bool), List<string> countries = default(List<string>), SessionPayability? payability = default(SessionPayability?))
        {
        ...
        /// </summary>
        /// <value>enable Collector Bank Finance Payment</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorConfigurationFinance {\n");
        ...
        {
            return this.Equals(input as CollectorConfigurationFinance);
        }

        /// <summary>
        /// Returns true if CollectorConfigurationFinance instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorConfigurationFinance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorConfigurationFinance input)
        {
            if (input == null)
                return false;
