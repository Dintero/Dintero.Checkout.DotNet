...
{
    /// <summary>
    /// TransactionNetaxeptAllOfCard
    /// </summary>
    [DataContract(Name = "TransactionNetaxept_allOf_card")]
    public partial class TransactionNetaxeptAllOfCard : IEquatable<TransactionNetaxeptAllOfCard>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionNetaxeptAllOfCard" /> class.
        /// </summary>
        ...
        public TransactionNetaxeptAllOfCard(string brand = default(string), string maskedPan = default(string), string expiryDate = default(string), TypeEnum? type = default(TypeEnum?), string issuingBank = default(string), string country = default(string))
        {
            this.Brand = brand;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionNetaxeptAllOfCard {\n");
        ...
        {
            return this.Equals(input as TransactionNetaxeptAllOfCard);
        }

        /// <summary>
        /// Returns true if TransactionNetaxeptAllOfCard instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionNetaxeptAllOfCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionNetaxeptAllOfCard input)
        {
            if (input == null)
                return false;
