...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class InlineObject6 : IEquatable<InlineObject6>, IValidatableObject
    {
        ...
        public InlineObject6(string storeId = default(string), NetaxeptGwStoreOverride _override = default(NetaxeptGwStoreOverride))
        {
            // to ensure "storeId" is required (not null)
            this.StoreId = storeId ?? throw new ArgumentNullException("storeId is a required property for InlineObject6 and cannot be null");
        ...
        public NetaxeptGwStoreOverride Override { get; set; }
