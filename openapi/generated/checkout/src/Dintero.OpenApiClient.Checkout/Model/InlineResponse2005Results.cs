...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_5_results")]
    public partial class InlineResponse2005Results : IEquatable<InlineResponse2005Results>, IValidatableObject
    {
        /// <summary>
        /// Defines CreditProvider
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum CreditProviderEnum
        {
            /// <summary>
        ...
        /// <summary>
        /// Gets or Sets CreditProvider
        /// </summary>
        [DataMember(Name = "credit_provider", EmitDefaultValue = false)]
        public CreditProviderEnum? CreditProvider { get; set; }
        /// <summary>
        /// Defines Status
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2005Results" /> class.
        /// </summary>
        /// <param name="creditProvider">creditProvider.</param>
        /// <param name="status">status.</param>
        public InlineResponse2005Results(CreditProviderEnum? creditProvider = default(CreditProviderEnum?), StatusEnum? status = default(StatusEnum?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CreditProvider: ").Append(CreditProvider).Append("\n");
        ...
        {
            return this.Equals(input as InlineResponse2005Results);
        }

        /// <summary>
        /// Returns true if InlineResponse2005Results instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2005Results to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2005Results input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.CreditProvider == input.CreditProvider ||
                    this.CreditProvider.Equals(input.CreditProvider)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = hashCode * 59 + this.CreditProvider.GetHashCode();
