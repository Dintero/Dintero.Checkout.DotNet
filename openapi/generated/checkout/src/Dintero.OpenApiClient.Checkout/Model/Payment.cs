...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(BamboraVippsPayment), "BamboraVippsPayment")]
    [JsonSubtypes.KnownSubType(typeof(CollectorFinancePayment), "CollectorFinancePayment")]
    [JsonSubtypes.KnownSubType(typeof(CollectorInstallmentB2BPreapprovedPayment), "CollectorInstallmentB2BPreapprovedPayment")]
    [JsonSubtypes.KnownSubType(typeof(CollectorInstallmentPayment), "CollectorInstallmentPayment")]
    [JsonSubtypes.KnownSubType(typeof(CollectorInvoiceB2BPayment), "CollectorInvoiceB2BPayment")]
    [JsonSubtypes.KnownSubType(typeof(CollectorInvoiceB2BPreapprovedPayment), "CollectorInvoiceB2BPreapprovedPayment")]
    [JsonSubtypes.KnownSubType(typeof(CollectorInvoicePayment), "CollectorInvoicePayment")]
    [JsonSubtypes.KnownSubType(typeof(IngenicoCreditcardPayment), "IngenicoCreditcardPayment")]
    [JsonSubtypes.KnownSubType(typeof(InstabankFinancePayment), "InstabankFinancePayment")]
    [JsonSubtypes.KnownSubType(typeof(InstabankInstallmentPayment), "InstabankInstallmentPayment")]
    [JsonSubtypes.KnownSubType(typeof(InstabankInvoicePayment), "InstabankInvoicePayment")]
    [JsonSubtypes.KnownSubType(typeof(InstabankPostponementPayment), "InstabankPostponementPayment")]
    [JsonSubtypes.KnownSubType(typeof(SantanderPayment), "SantanderPayment")]
    [JsonSubtypes.KnownSubType(typeof(SwishPayment), "SwishPayment")]
    [JsonSubtypes.KnownSubType(typeof(VippsPayment), "VippsPayment")]
    [JsonSubtypes.KnownSubType(typeof(BamboraVippsPayment), "bambora.vipps")]
    [JsonSubtypes.KnownSubType(typeof(CollectorFinancePayment), "collector.finance")]
    [JsonSubtypes.KnownSubType(typeof(CollectorInstallmentPayment), "collector.installment")]
    [JsonSubtypes.KnownSubType(typeof(CollectorInstallmentB2BPreapprovedPayment), "collector.installment_b2b_preapproved")]
    [JsonSubtypes.KnownSubType(typeof(CollectorInvoicePayment), "collector.invoice")]
    [JsonSubtypes.KnownSubType(typeof(CollectorInvoiceB2BPayment), "collector.invoice_b2b")]
    [JsonSubtypes.KnownSubType(typeof(CollectorInvoiceB2BPreapprovedPayment), "collector.invoice_b2b_preapproved")]
    [JsonSubtypes.KnownSubType(typeof(IngenicoCreditcardPayment), "ingenico.creditcard")]
    [JsonSubtypes.KnownSubType(typeof(InstabankFinancePayment), "instabank.finance")]
    [JsonSubtypes.KnownSubType(typeof(InstabankInstallmentPayment), "instabank.installment")]
    [JsonSubtypes.KnownSubType(typeof(InstabankInvoicePayment), "instabank.invoice")]
    [JsonSubtypes.KnownSubType(typeof(InstabankPostponementPayment), "instabank.postponement")]
    [JsonSubtypes.KnownSubType(typeof(SantanderPayment), "santander.debit_account")]
    [JsonSubtypes.KnownSubType(typeof(SwishPayment), "swish.swish")]
    [JsonSubtypes.KnownSubType(typeof(VippsPayment), "vipps")]
    public partial class Payment : IEquatable<Payment>, IValidatableObject
    {
        ...
        public Payment(string paymentProductType = default(string))
        {
            // to ensure "paymentProductType" is required (not null)
            this.PaymentProductType = paymentProductType ?? throw new ArgumentNullException("paymentProductType is a required property for Payment and cannot be null");
        }
