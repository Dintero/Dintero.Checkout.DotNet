...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NetaxeptConfiguration")]
    public partial class NetaxeptConfiguration : IEquatable<NetaxeptConfiguration>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NetaxeptConfiguration" /> class.
        /// </summary>
        /// <param name="type">Denotes what kind of config parameter this is.</param>
        /// <param name="creditcard">creditcard.</param>
        public NetaxeptConfiguration(TypeEnum? type = default(TypeEnum?), NetaxeptConfigurationCreditcard creditcard = default(NetaxeptConfigurationCreditcard))
        {
            this.Type = type;
        ...
        public NetaxeptConfigurationCreditcard Creditcard { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NetaxeptConfiguration {\n");
        ...
        {
            return this.Equals(input as NetaxeptConfiguration);
        }

        /// <summary>
        /// Returns true if NetaxeptConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of NetaxeptConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NetaxeptConfiguration input)
        {
            if (input == null)
                return false;
