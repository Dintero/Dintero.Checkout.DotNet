...
{
    /// <summary>
    /// CollectorGwStoreOverrideWriteAllOf
    /// </summary>
    [DataContract(Name = "CollectorGwStoreOverrideWrite_allOf")]
    public partial class CollectorGwStoreOverrideWriteAllOf : IEquatable<CollectorGwStoreOverrideWriteAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorGwStoreOverrideWriteAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorGwStoreOverrideWriteAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorGwStoreOverrideWriteAllOf" /> class.
        /// </summary>
        /// <param name="password">password (required).</param>
        /// <param name="options">options.</param>
        public CollectorGwStoreOverrideWriteAllOf(string password = default(string), CollectorGwStoreOverrideWriteAllOfOptions options = default(CollectorGwStoreOverrideWriteAllOfOptions))
        {
            // to ensure "password" is required (not null)
            this.Password = password ?? throw new ArgumentNullException("password is a required property for CollectorGwStoreOverrideWriteAllOf and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorGwStoreOverrideWriteAllOf {\n");
        ...
        {
            return this.Equals(input as CollectorGwStoreOverrideWriteAllOf);
        }

        /// <summary>
        /// Returns true if CollectorGwStoreOverrideWriteAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorGwStoreOverrideWriteAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorGwStoreOverrideWriteAllOf input)
        {
            if (input == null)
                return false;
