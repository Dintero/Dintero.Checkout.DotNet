...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class Session : IEquatable<Session>, IValidatableObject
    {
        ...
        /// <param name="expiresAt">The session expiration time after which the Checkout page wouldn&#39;t be available .</param>
        ...
        /// <param name="createdAt">Time when the Checkout was created.</param>
        /// <param name="updatedAt">Last time when the Checkout was updated.</param>
        /// <param name="customerIp">The IP of the customer upon visiting the page. If the page is visited multiple times, the field is always updated with the last known value. .</param>
        /// <param name="userAgent">The full user agent of the device the customer used when visiting the checkout page .</param>
        /// <param name="events">Checkout process events .</param>
        /// <param name="transactionId">Transaction which has been created using the checkout. .</param>
        public Session(SessionUrls url = default(SessionUrls), SessionCustomer customer = default(SessionCustomer), SessionOrder order = default(SessionOrder), DateTime expiresAt = default(DateTime), SessionExpressExpress express = default(SessionExpressExpress), PaymentConfiguration configuration = default(PaymentConfiguration), string id = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), string customerIp = default(string), string userAgent = default(string), List<SessionMetaEvents> events = default(List<SessionMetaEvents>), string transactionId = default(string))
        {
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url is a required property for Session and cannot be null");
            // to ensure "order" is required (not null)
            this.Order = order ?? throw new ArgumentNullException("order is a required property for Session and cannot be null");
            // to ensure "configuration" is required (not null)
            this.Configuration = configuration ?? throw new ArgumentNullException("configuration is a required property for Session and cannot be null");
        ...
        public SessionUrls Url { get; set; }

        /// <summary>
        /// Gets or Sets Customer
        /// </summary>
        [DataMember(Name = "customer", EmitDefaultValue = false)]
        public SessionCustomer Customer { get; set; }
        ...
        /// </summary>
        /// <value>The session expiration time after which the Checkout page wouldn&#39;t be available </value>
        ...
        public SessionExpressExpress Express { get; set; }

        /// <summary>
        /// Gets or Sets Configuration
        /// </summary>
        [DataMember(Name = "configuration", IsRequired = true, EmitDefaultValue = false)]
        public PaymentConfiguration Configuration { get; set; }

        /// <summary>
        /// The ID of the Checkout
        /// </summary>
        /// <value>The ID of the Checkout</value>
        ...
        /// </summary>
        /// <value>Time when the Checkout was created</value>
        ...
        /// </summary>
        /// <value>Last time when the Checkout was updated</value>
        ...
        /// </summary>
        /// <value>The IP of the customer upon visiting the page. If the page is visited multiple times, the field is always updated with the last known value. </value>
        ...
        /// </summary>
        /// <value>The full user agent of the device the customer used when visiting the checkout page </value>
        ...
        /// </summary>
        /// <value>Checkout process events </value>
        [DataMember(Name = "events", EmitDefaultValue = false)]
        public List<SessionMetaEvents> Events { get; set; }

        /// <summary>
        /// Transaction which has been created using the checkout. 
        /// </summary>
        /// <value>Transaction which has been created using the checkout. </value>
        ...
        public bool Equals(Session input)
        {
            ...
            return 
                ...
                (
                    ...
                    (this.Express != null &&
                    this.Express.Equals(input.Express))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Express != null)
                    hashCode = hashCode * 59 + this.Express.GetHashCode();
