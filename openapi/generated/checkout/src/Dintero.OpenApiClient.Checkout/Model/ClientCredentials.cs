...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "client_credentials")]
    [JsonConverter(typeof(JsonSubtypes), "GrantType")]
    public partial class ClientCredentials : AuthToken, IEquatable<ClientCredentials>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="grantType">grantType (required) (default to &quot;client_credentials&quot;).</param>
        public ClientCredentials(string audience = default(string), string grantType = "client_credentials") : base(grantType)
        {
            // to ensure "audience" is required (not null)
            this.Audience = audience ?? throw new ArgumentNullException("audience is a required property for ClientCredentials and cannot be null");
        }
