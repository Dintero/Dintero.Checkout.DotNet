...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IngenicoWebhookEvent_token")]
    public partial class IngenicoWebhookEventToken : IEquatable<IngenicoWebhookEventToken>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoWebhookEventToken" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="originalPaymentId">originalPaymentId.</param>
        /// <param name="paymentProductId">paymentProductId.</param>
        /// <param name="card">card.</param>
        public IngenicoWebhookEventToken(string id = default(string), string originalPaymentId = default(string), string paymentProductId = default(string), IngenicoWebhookEventTokenCard card = default(IngenicoWebhookEventTokenCard))
        {
            this.Id = id;
        ...
        public IngenicoWebhookEventTokenCard Card { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IngenicoWebhookEventToken {\n");
        ...
        {
            return this.Equals(input as IngenicoWebhookEventToken);
        }

        /// <summary>
        /// Returns true if IngenicoWebhookEventToken instances are equal
        /// </summary>
        /// <param name="input">Instance of IngenicoWebhookEventToken to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IngenicoWebhookEventToken input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.OriginalPaymentId == input.OriginalPaymentId ||
                    (this.OriginalPaymentId != null &&
                    this.OriginalPaymentId.Equals(input.OriginalPaymentId))
                ) && 
                (
                    this.PaymentProductId == input.PaymentProductId ||
                    (this.PaymentProductId != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OriginalPaymentId != null)
                    hashCode = hashCode * 59 + this.OriginalPaymentId.GetHashCode();
