...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// NetaxeptGwWrite
    /// </summary>
    [DataContract(Name = "NetaxeptGwWrite")]
    public partial class NetaxeptGwWrite : IEquatable<NetaxeptGwWrite>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NetaxeptGwWrite" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NetaxeptGwWrite() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NetaxeptGwWrite" /> class.
        /// </summary>
        ...
        public NetaxeptGwWrite(string url = default(string), string merchantId = default(string), string token = default(string))
        {
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url is a required property for NetaxeptGwWrite and cannot be null");
            // to ensure "merchantId" is required (not null)
            this.MerchantId = merchantId ?? throw new ArgumentNullException("merchantId is a required property for NetaxeptGwWrite and cannot be null");
            // to ensure "token" is required (not null)
            this.Token = token ?? throw new ArgumentNullException("token is a required property for NetaxeptGwWrite and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NetaxeptGwWrite {\n");
        ...
        {
            return this.Equals(input as NetaxeptGwWrite);
        }

        /// <summary>
        /// Returns true if NetaxeptGwWrite instances are equal
        /// </summary>
        /// <param name="input">Instance of NetaxeptGwWrite to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NetaxeptGwWrite input)
        {
            if (input == null)
                return false;
