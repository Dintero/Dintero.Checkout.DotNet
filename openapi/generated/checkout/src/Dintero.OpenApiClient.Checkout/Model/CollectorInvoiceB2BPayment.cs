...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CollectorInvoiceB2BPayment")]
    [JsonConverter(typeof(JsonSubtypes), "PaymentProductType")]
    public partial class CollectorInvoiceB2BPayment : Payment, IEquatable<CollectorInvoiceB2BPayment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorInvoiceB2BPayment" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorInvoiceB2BPayment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorInvoiceB2BPayment" /> class.
        /// </summary>
        /// <param name="paymentProductType">The payment product type corresponding to this transaction  (required) (default to &quot;CollectorInvoiceB2BPayment&quot;).</param>
        ...
        public CollectorInvoiceB2BPayment(string paymentProductType = "CollectorInvoiceB2BPayment", CollectorB2BAddress shippingAddress = default(CollectorB2BAddress), CollectorB2BAddress billingAddress = default(CollectorB2BAddress), bool rememberMe = default(bool)) : base()
        {
            // to ensure "paymentProductType" is required (not null)
            this.PaymentProductType = paymentProductType ?? throw new ArgumentNullException("paymentProductType is a required property for CollectorInvoiceB2BPayment and cannot be null");
            // to ensure "shippingAddress" is required (not null)
            this.ShippingAddress = shippingAddress ?? throw new ArgumentNullException("shippingAddress is a required property for CollectorInvoiceB2BPayment and cannot be null");
            // to ensure "billingAddress" is required (not null)
            this.BillingAddress = billingAddress ?? throw new ArgumentNullException("billingAddress is a required property for CollectorInvoiceB2BPayment and cannot be null");
        ...
        public CollectorB2BAddress BillingAddress { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorInvoiceB2BPayment {\n");
        ...
        {
            return this.Equals(input as CollectorInvoiceB2BPayment);
        }

        /// <summary>
        /// Returns true if CollectorInvoiceB2BPayment instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorInvoiceB2BPayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorInvoiceB2BPayment input)
        {
            if (input == null)
                return false;
