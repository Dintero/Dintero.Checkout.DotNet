...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// InstabankDetails
    /// </summary>
    [DataContract(Name = "InstabankDetails")]
    public partial class InstabankDetails : IEquatable<InstabankDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankDetails" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstabankDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankDetails" /> class.
        /// </summary>
        ...
        public InstabankDetails(string email = default(string), string socialSecurityNumber = default(string), string phoneNumber = default(string), int totalIncome = default(int))
        {
            // to ensure "email" is required (not null)
            this.Email = email ?? throw new ArgumentNullException("email is a required property for InstabankDetails and cannot be null");
            // to ensure "socialSecurityNumber" is required (not null)
            this.SocialSecurityNumber = socialSecurityNumber ?? throw new ArgumentNullException("socialSecurityNumber is a required property for InstabankDetails and cannot be null");
            // to ensure "phoneNumber" is required (not null)
            this.PhoneNumber = phoneNumber ?? throw new ArgumentNullException("phoneNumber is a required property for InstabankDetails and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstabankDetails {\n");
        ...
        {
            return this.Equals(input as InstabankDetails);
        }

        /// <summary>
        /// Returns true if InstabankDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of InstabankDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstabankDetails input)
        {
            if (input == null)
                return false;
