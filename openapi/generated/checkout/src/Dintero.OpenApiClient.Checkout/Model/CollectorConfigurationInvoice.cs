...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CollectorConfiguration_invoice")]
    public partial class CollectorConfigurationInvoice : IEquatable<CollectorConfigurationInvoice>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorConfigurationInvoice" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorConfigurationInvoice() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorConfigurationInvoice" /> class.
        /// </summary>
        /// <param name="type">Denotes what kind of config parameter this is (default to TypeEnum.PaymentProductType).</param>
        /// <param name="enabled">enable Collector Bank Invoice Payment (required).</param>
        /// <param name="countries">countries.</param>
        /// <param name="options">options.</param>
        /// <param name="payability">payability.</param>
        public CollectorConfigurationInvoice(TypeEnum? type = TypeEnum.PaymentProductType, bool enabled = default(bool), List<string> countries = default(List<string>), CollectorConfigurationInvoiceOptions options = default(CollectorConfigurationInvoiceOptions), SessionPayability? payability = default(SessionPayability?))
        {
        ...
        /// </summary>
        /// <value>enable Collector Bank Invoice Payment</value>
        ...
        public CollectorConfigurationInvoiceOptions Options { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorConfigurationInvoice {\n");
        ...
        {
            return this.Equals(input as CollectorConfigurationInvoice);
        }

        /// <summary>
        /// Returns true if CollectorConfigurationInvoice instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorConfigurationInvoice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorConfigurationInvoice input)
        {
            if (input == null)
                return false;
