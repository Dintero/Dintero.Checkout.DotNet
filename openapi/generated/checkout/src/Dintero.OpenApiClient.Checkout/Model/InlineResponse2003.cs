...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class InlineResponse2003 : IEquatable<InlineResponse2003>, IValidatableObject
    {
        ...
        /// <param name="profileConfiguration">profileConfiguration.</param>
        /// <param name="profileConfigurationResponse">profileConfigurationResponse.</param>
        public InlineResponse2003(Id id = default(Id), ProfileConfiguration profileConfiguration = default(ProfileConfiguration), ProfileConfigurationResponse profileConfigurationResponse = default(ProfileConfigurationResponse))
        {
            this.Id = id;
            this.ProfileConfiguration = profileConfiguration;
            this.ProfileConfigurationResponse = profileConfigurationResponse;
        }
        ...
        /// <summary>
        /// Gets or Sets ProfileConfiguration
        /// </summary>
        [DataMember(Name = "ProfileConfiguration", EmitDefaultValue = false)]
        public ProfileConfiguration ProfileConfiguration { get; set; }

        /// <summary>
        /// Gets or Sets ProfileConfigurationResponse
        /// </summary>
        [DataMember(Name = "ProfileConfigurationResponse", EmitDefaultValue = false)]
        public ProfileConfigurationResponse ProfileConfigurationResponse { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ProfileConfiguration: ").Append(ProfileConfiguration).Append("\n");
            sb.Append("  ProfileConfigurationResponse: ").Append(ProfileConfigurationResponse).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(InlineResponse2003 input)
        {
            ...
            return 
                ...
                (
                    this.ProfileConfiguration == input.ProfileConfiguration ||
                    (this.ProfileConfiguration != null &&
                    this.ProfileConfiguration.Equals(input.ProfileConfiguration))
                ) && 
                (
                    this.ProfileConfigurationResponse == input.ProfileConfigurationResponse ||
                    (this.ProfileConfigurationResponse != null &&
                    this.ProfileConfigurationResponse.Equals(input.ProfileConfigurationResponse))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ProfileConfiguration != null)
                    hashCode = hashCode * 59 + this.ProfileConfiguration.GetHashCode();
                if (this.ProfileConfigurationResponse != null)
                    hashCode = hashCode * 59 + this.ProfileConfigurationResponse.GetHashCode();
                return hashCode;
            }
        }
