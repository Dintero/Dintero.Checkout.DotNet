...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// TransactionPayEx
    /// </summary>
    [DataContract(Name = "TransactionPayEx")]
    [JsonConverter(typeof(JsonSubtypes), "PaymentProduct")]
    public partial class TransactionPayEx : Transaction, IEquatable<TransactionPayEx>, IValidatableObject
    {
        /// <summary>
        ...
        {
            /// <summary>
            /// Enum Creditcard for value: payex.creditcard
            /// </summary>
            [EnumMember(Value = "payex.creditcard")]
            Creditcard = 1,

            /// <summary>
            /// Enum Swish for value: payex.swish
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionPayEx" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionPayEx() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionPayEx" /> class.
        /// </summary>
        ...
        /// <param name="paymentProduct">The payment product corresponding to this transaction  (required) (default to &quot;TransactionPayEx&quot;).</param>
        ...
        public TransactionPayExAllOfCard Card { get; set; }

        /// <summary>
        /// Gets or Sets Events
        /// </summary>
        [DataMember(Name = "events", EmitDefaultValue = false)]
        public List<TransactionPayExAllOfEvents> Events { get; set; }

        /// <summary>
        /// Gets or Sets Metadata
        /// </summary>
        [DataMember(Name = "metadata", EmitDefaultValue = false)]
        public TransactionPayExAllOfMetadata1 Metadata { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionPayEx {\n");
        ...
        {
            return this.Equals(input as TransactionPayEx);
        }

        /// <summary>
        /// Returns true if TransactionPayEx instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionPayEx to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionPayEx input)
        {
            if (input == null)
                return false;
