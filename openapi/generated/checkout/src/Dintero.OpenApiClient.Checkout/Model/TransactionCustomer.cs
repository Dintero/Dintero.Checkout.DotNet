...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// TransactionCustomer
    /// </summary>
    [DataContract(Name = "Transaction_customer")]
    public partial class TransactionCustomer : IEquatable<TransactionCustomer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionCustomer" /> class.
        /// </summary>
        /// <param name="customerId">Customer id .</param>
        /// <param name="email">Customer email address .</param>
        /// <param name="phoneNumber">Customer phone number, ITU/E.123 format with international prefix (+PPNNNNNNNNN...) .</param>
        /// <param name="myDintero">myDintero.</param>
        public TransactionCustomer(string customerId = default(string), string email = default(string), string phoneNumber = default(string), MyDinteroUserCreation myDintero = default(MyDinteroUserCreation))
        {
        ...
        /// <summary>
        /// Customer phone number, ITU/E.123 format with international prefix (+PPNNNNNNNNN...) 
        /// </summary>
        /// <value>Customer phone number, ITU/E.123 format with international prefix (+PPNNNNNNNNN...) </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionCustomer {\n");
        ...
        {
            return this.Equals(input as TransactionCustomer);
        }

        /// <summary>
        /// Returns true if TransactionCustomer instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionCustomer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionCustomer input)
        {
            if (input == null)
                return false;
