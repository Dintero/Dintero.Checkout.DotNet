...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ViewPaymentOperation")]
    [JsonConverter(typeof(JsonSubtypes), "Rel")]
    public partial class ViewPaymentOperation : PaymentOperation, IEquatable<ViewPaymentOperation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewPaymentOperation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ViewPaymentOperation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewPaymentOperation" /> class.
        /// </summary>
        /// <param name="href">Contains the URI of the JavaScript used to create a Hosted View iframe directly without redirecting the consumer to separate payment page. .</param>
        /// <param name="contentType">contentType.</param>
        /// <param name="method">The HTTP method to use when performing the operation .</param>
        /// <param name="rel">rel (required) (default to &quot;ViewPaymentOperation&quot;).</param>
        public ViewPaymentOperation(string href = default(string), ContentTypeEnum? contentType = default(ContentTypeEnum?), MethodEnum? method = default(MethodEnum?), string rel = "ViewPaymentOperation") : base(contentType, method, rel)
        {
            this.Href = href;
        }

        /// <summary>
        /// Contains the URI of the JavaScript used to create a Hosted View iframe directly without redirecting the consumer to separate payment page. 
        /// </summary>
        /// <value>Contains the URI of the JavaScript used to create a Hosted View iframe directly without redirecting the consumer to separate payment page. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ViewPaymentOperation {\n");
        ...
        {
            return this.Equals(input as ViewPaymentOperation);
        }

        /// <summary>
        /// Returns true if ViewPaymentOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of ViewPaymentOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ViewPaymentOperation input)
        {
            if (input == null)
                return false;
