...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SantanderConfiguration")]
    public partial class SantanderConfiguration : IEquatable<SantanderConfiguration>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SantanderConfiguration" /> class.
        /// </summary>
        /// <param name="type">Denotes what kind of config parameter this is.</param>
        /// <param name="debitAccount">debitAccount.</param>
        public SantanderConfiguration(TypeEnum? type = default(TypeEnum?), SantanderConfigurationDebitAccount debitAccount = default(SantanderConfigurationDebitAccount))
        {
            this.Type = type;
        ...
        public SantanderConfigurationDebitAccount DebitAccount { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SantanderConfiguration {\n");
        ...
        {
            return this.Equals(input as SantanderConfiguration);
        }

        /// <summary>
        /// Returns true if SantanderConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of SantanderConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SantanderConfiguration input)
        {
            if (input == null)
                return false;
