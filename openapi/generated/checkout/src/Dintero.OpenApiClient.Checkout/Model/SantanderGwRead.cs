...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SantanderGwRead")]
    public partial class SantanderGwRead : IEquatable<SantanderGwRead>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SantanderGwRead" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SantanderGwRead() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SantanderGwRead" /> class.
        /// </summary>
        ...
        public SantanderGwRead(string url = default(string), string storeEmail = default(string), string brandingName = default(string))
        {
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url is a required property for SantanderGwRead and cannot be null");
            // to ensure "storeEmail" is required (not null)
            this.StoreEmail = storeEmail ?? throw new ArgumentNullException("storeEmail is a required property for SantanderGwRead and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SantanderGwRead {\n");
        ...
        {
            return this.Equals(input as SantanderGwRead);
        }

        /// <summary>
        /// Returns true if SantanderGwRead instances are equal
        /// </summary>
        /// <param name="input">Instance of SantanderGwRead to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SantanderGwRead input)
        {
            if (input == null)
                return false;
