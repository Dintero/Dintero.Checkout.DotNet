...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// SessionOrder
    /// </summary>
    [DataContract(Name = "SessionOrder")]
    public partial class SessionOrder : IEquatable<SessionOrder>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionOrder" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="SessionOrder" /> class.
        /// </summary>
        /// <param name="amount">The amount to authorize/capture including VAT and discounts. In smallest unit for the currency, e.g. cents .</param>
        /// <param name="currency">The three-character ISO-4217 currency. https://en.wikipedia.org/wiki/ISO_4217.</param>
        /// <param name="vatAmount">The VAT of the &#x60;amount&#x60; parameter. Only used for display purposes.  In smallest unit for the currency, e.g. cents .</param>
        /// <param name="merchantReference2">A reference by the merchant to identify the corresponding order for the Checkout Session .</param>
        /// <param name="shippingAddress">shippingAddress.</param>
        /// <param name="billingAddress">billingAddress.</param>
        /// <param name="partialPayment">This is a partial payment where the &#x60;order.amount&#x60; can be lower or equal to the sum of &#x60;order.items.amount&#x60;  (default to false).</param>
        /// <param name="items">Details about the order items.  #### Instabank &#x60;required&#x60; if Instabank payment is configured in and partial_payment is false. All items must include a unique &#x60;line_id&#x60;, quantity and amount  #### Collector Bank &#x60;required&#x60; if Collector Bank payment is configured in and partial_payment is false. All items must include a unique &#x60;line_id&#x60;, quantity and amount .</param>
        /// <param name="shippingOption">shippingOption.</param>
        /// <param name="store">store.</param>
        /// <param name="discountLines">Discounts given, additions to any items discount_lines. .</param>
        /// <param name="discountCodes">discountCodes.</param>
        /// <param name="merchantReference">A reference by the merchant to identify the corresponding order for the Checkout Session  (required).</param>
        public SessionOrder(int amount = default(int), string currency = default(string), int vatAmount = default(int), string merchantReference2 = default(string), OrderAddress shippingAddress = default(OrderAddress), OrderAddress billingAddress = default(OrderAddress), bool partialPayment = false, List<OrderItem> items = default(List<OrderItem>), ShippingOption shippingOption = default(ShippingOption), Store store = default(Store), List<DiscountItem> discountLines = default(List<DiscountItem>), List<string> discountCodes = default(List<string>), string merchantReference = default(string))
        {
            // to ensure "merchantReference" is required (not null)
            this.MerchantReference = merchantReference ?? throw new ArgumentNullException("merchantReference is a required property for SessionOrder and cannot be null");
            this.Amount = amount;
        ...
        /// <summary>
        /// The amount to authorize/capture including VAT and discounts. In smallest unit for the currency, e.g. cents 
        /// </summary>
        /// <value>The amount to authorize/capture including VAT and discounts. In smallest unit for the currency, e.g. cents </value>
        ...
        /// </summary>
        /// <value>The three-character ISO-4217 currency. https://en.wikipedia.org/wiki/ISO_4217</value>
        [DataMember(Name = "currency", EmitDefaultValue = false)]
        public string Currency { get; set; }

        /// <summary>
        /// The VAT of the &#x60;amount&#x60; parameter. Only used for display purposes.  In smallest unit for the currency, e.g. cents 
        /// </summary>
        /// <value>The VAT of the &#x60;amount&#x60; parameter. Only used for display purposes.  In smallest unit for the currency, e.g. cents </value>
        [DataMember(Name = "vat_amount", EmitDefaultValue = false)]
        public int VatAmount { get; set; }

        /// <summary>
        /// A reference by the merchant to identify the corresponding order for the Checkout Session 
        /// </summary>
        /// <value>A reference by the merchant to identify the corresponding order for the Checkout Session </value>
        [DataMember(Name = "merchant_reference_2", EmitDefaultValue = false)]
        ...
        /// <summary>
        /// This is a partial payment where the &#x60;order.amount&#x60; can be lower or equal to the sum of &#x60;order.items.amount&#x60; 
        /// </summary>
        /// <value>This is a partial payment where the &#x60;order.amount&#x60; can be lower or equal to the sum of &#x60;order.items.amount&#x60; </value>
        [DataMember(Name = "partial_payment", EmitDefaultValue = true)]
        public bool PartialPayment { get; set; }

        /// <summary>
        /// Details about the order items.  #### Instabank &#x60;required&#x60; if Instabank payment is configured in and partial_payment is false. All items must include a unique &#x60;line_id&#x60;, quantity and amount  #### Collector Bank &#x60;required&#x60; if Collector Bank payment is configured in and partial_payment is false. All items must include a unique &#x60;line_id&#x60;, quantity and amount 
        /// </summary>
        /// <value>Details about the order items.  #### Instabank &#x60;required&#x60; if Instabank payment is configured in and partial_payment is false. All items must include a unique &#x60;line_id&#x60;, quantity and amount  #### Collector Bank &#x60;required&#x60; if Collector Bank payment is configured in and partial_payment is false. All items must include a unique &#x60;line_id&#x60;, quantity and amount </value>
        [DataMember(Name = "items", EmitDefaultValue = false)]
        public List<OrderItem> Items { get; set; }

        /// <summary>
        /// The origin amount to authorize/capture including VAT before any discount, only set if the session was updated when calculating discounts.  In smallest unit for the currency, e.g. cents 
        /// </summary>
        /// <value>The origin amount to authorize/capture including VAT before any discount, only set if the session was updated when calculating discounts.  In smallest unit for the currency, e.g. cents </value>
        ...
        /// <summary>
        /// The original order amount was changed by discount given. 
        /// </summary>
        /// <value>The original order amount was changed by discount given. </value>
        [DataMember(Name = "is_changed", EmitDefaultValue = true)]
        public bool IsChanged { get; private set; }

        /// <summary>
        /// Returns false as IsChanged should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeIsChanged()
        {
            return false;
        }
        ...
        /// </summary>
        [DataMember(Name = "shipping_option", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Discounts given, additions to any items discount_lines. </value>
        [DataMember(Name = "discount_lines", EmitDefaultValue = false)]
        public List<DiscountItem> DiscountLines { get; set; }

        /// <summary>
        /// Gets or Sets DiscountCodes
        /// </summary>
        [DataMember(Name = "discount_codes", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>A reference by the merchant to identify the corresponding order for the Checkout Session </value>
        [DataMember(Name = "merchant_reference", IsRequired = true, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as SessionOrder);
        }

        /// <summary>
        /// Returns true if SessionOrder instances are equal
        /// </summary>
        /// <param name="input">Instance of SessionOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SessionOrder input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.MerchantReference2 == input.MerchantReference2 ||
                    (this.MerchantReference2 != null &&
                    this.MerchantReference2.Equals(input.MerchantReference2))
                ) && 
                (
                ...
                (
                    this.ShippingOption == input.ShippingOption ||
                    (this.ShippingOption != null &&
                    this.ShippingOption.Equals(input.ShippingOption))
                ) && 
                (
                ...
                (
                    this.DiscountCodes == input.DiscountCodes ||
                    this.DiscountCodes != null &&
                    input.DiscountCodes != null &&
                    this.DiscountCodes.SequenceEqual(input.DiscountCodes)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MerchantReference2 != null)
                    hashCode = hashCode * 59 + this.MerchantReference2.GetHashCode();
                ...
                if (this.ShippingOption != null)
                    hashCode = hashCode * 59 + this.ShippingOption.GetHashCode();
                if (this.Store != null)
                    hashCode = hashCode * 59 + this.Store.GetHashCode();
                if (this.DiscountLines != null)
                    hashCode = hashCode * 59 + this.DiscountLines.GetHashCode();
                if (this.DiscountCodes != null)
                    hashCode = hashCode * 59 + this.DiscountCodes.GetHashCode();
