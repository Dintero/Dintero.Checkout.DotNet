...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// SantanderDetails
    /// </summary>
    [DataContract(Name = "SantanderDetails")]
    public partial class SantanderDetails : IEquatable<SantanderDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SantanderDetails" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SantanderDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SantanderDetails" /> class.
        /// </summary>
        ...
        public SantanderDetails(decimal accountNumberToken = default(decimal), string scc = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SantanderDetails {\n");
        ...
        {
            return this.Equals(input as SantanderDetails);
        }

        /// <summary>
        /// Returns true if SantanderDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of SantanderDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SantanderDetails input)
        {
            if (input == null)
                return false;
