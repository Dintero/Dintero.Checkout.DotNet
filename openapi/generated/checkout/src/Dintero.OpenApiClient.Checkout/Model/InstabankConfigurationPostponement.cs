...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// Postpone payment
    /// </summary>
    [DataContract(Name = "InstabankConfiguration_postponement")]
    public partial class InstabankConfigurationPostponement : IEquatable<InstabankConfigurationPostponement>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankConfigurationPostponement" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstabankConfigurationPostponement() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankConfigurationPostponement" /> class.
        /// </summary>
        /// <param name="type">Denotes what kind of config parameter this is (default to TypeEnum.PaymentProductType).</param>
        /// <param name="enabled">enable Instabank Postponement Payment (required).</param>
        /// <param name="payability">payability.</param>
        public InstabankConfigurationPostponement(TypeEnum? type = TypeEnum.PaymentProductType, bool enabled = default(bool), SessionPayability? payability = default(SessionPayability?))
        {
        ...
        /// </summary>
        /// <value>enable Instabank Postponement Payment</value>
        ...
        public List<InstabankPostponementProduct> Products { get; private set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstabankConfigurationPostponement {\n");
        ...
        {
            return this.Equals(input as InstabankConfigurationPostponement);
        }

        /// <summary>
        /// Returns true if InstabankConfigurationPostponement instances are equal
        /// </summary>
        /// <param name="input">Instance of InstabankConfigurationPostponement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstabankConfigurationPostponement input)
        {
            if (input == null)
                return false;
