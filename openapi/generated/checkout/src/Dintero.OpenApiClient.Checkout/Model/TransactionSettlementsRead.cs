...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransactionSettlementsRead")]
    public partial class TransactionSettlementsRead : IEquatable<TransactionSettlementsRead>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionSettlementsRead" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionSettlementsRead() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionSettlementsRead" /> class.
        /// </summary>
        /// <param name="settlementStatus">settlementStatus.</param>
        /// <param name="events">One item per payout to the merchants bank account  (required).</param>
        public TransactionSettlementsRead(SettlementStatus? settlementStatus = default(SettlementStatus?), List<TransactionSettlementsEvent> events = default(List<TransactionSettlementsEvent>))
        {
            // to ensure "events" is required (not null)
            this.Events = events ?? throw new ArgumentNullException("events is a required property for TransactionSettlementsRead and cannot be null");
        ...
        /// </summary>
        /// <value>One item per payout to the merchants bank account </value>
        [DataMember(Name = "events", IsRequired = true, EmitDefaultValue = false)]
        public List<TransactionSettlementsEvent> Events { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionSettlementsRead {\n");
        ...
        {
            return this.Equals(input as TransactionSettlementsRead);
        }

        /// <summary>
        /// Returns true if TransactionSettlementsRead instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionSettlementsRead to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionSettlementsRead input)
        {
            if (input == null)
                return false;
