...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class InlineObject10 : IEquatable<InlineObject10>, IValidatableObject
    {
        ...
        /// <param name="_override">Override properties for given store. Will delete override if null..</param>
        public InlineObject10(string storeId = default(string), SantanderGwStoreOverrideWrite _override = default(SantanderGwStoreOverrideWrite))
        {
            // to ensure "storeId" is required (not null)
            this.StoreId = storeId ?? throw new ArgumentNullException("storeId is a required property for InlineObject10 and cannot be null");
        ...
        /// </summary>
        /// <value>Override properties for given store. Will delete override if null.</value>
        [DataMember(Name = "override", EmitDefaultValue = true)]
        public SantanderGwStoreOverrideWrite Override { get; set; }
