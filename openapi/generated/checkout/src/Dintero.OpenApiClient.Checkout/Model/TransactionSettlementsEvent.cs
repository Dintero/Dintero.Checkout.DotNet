...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransactionSettlementsEvent")]
    public partial class TransactionSettlementsEvent : IEquatable<TransactionSettlementsEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionSettlementsEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionSettlementsEvent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionSettlementsEvent" /> class.
        /// </summary>
        /// <param name="settlementId">Id of the settlement this was paid in  (required).</param>
        /// <param name="providerReference">The providers reference for the settlement  (required).</param>
        /// <param name="eventCorrelationId">Id for matching to transaction event .</param>
        /// <param name="amount">The amount paid out in this settlement  (required).</param>
        /// <param name="capture">Amount captured in this settlement .</param>
        /// <param name="refund">Amount refunded in this settlement .</param>
        /// <param name="fee">Fee of the capture in this settlement .</param>
        public TransactionSettlementsEvent(string settlementId = default(string), string providerReference = default(string), string eventCorrelationId = default(string), decimal amount = default(decimal), decimal capture = default(decimal), decimal refund = default(decimal), decimal fee = default(decimal))
        {
            // to ensure "settlementId" is required (not null)
            this.SettlementId = settlementId ?? throw new ArgumentNullException("settlementId is a required property for TransactionSettlementsEvent and cannot be null");
            // to ensure "providerReference" is required (not null)
            this.ProviderReference = providerReference ?? throw new ArgumentNullException("providerReference is a required property for TransactionSettlementsEvent and cannot be null");
            this.Amount = amount;
        ...
        /// </summary>
        /// <value>Id of the settlement this was paid in </value>
        [DataMember(Name = "settlement_id", IsRequired = true, EmitDefaultValue = false)]
        public string SettlementId { get; set; }

        /// <summary>
        /// The providers reference for the settlement 
        /// </summary>
        /// <value>The providers reference for the settlement </value>
        [DataMember(Name = "provider_reference", IsRequired = true, EmitDefaultValue = false)]
        public string ProviderReference { get; set; }

        /// <summary>
        /// Id for matching to transaction event 
        /// </summary>
        /// <value>Id for matching to transaction event </value>
        [DataMember(Name = "event_correlation_id", EmitDefaultValue = false)]
        public string EventCorrelationId { get; set; }

        /// <summary>
        /// The amount paid out in this settlement 
        /// </summary>
        /// <value>The amount paid out in this settlement </value>
        ...
        /// </summary>
        /// <value>Amount captured in this settlement </value>
        ...
        /// </summary>
        /// <value>Amount refunded in this settlement </value>
        ...
        /// </summary>
        /// <value>Fee of the capture in this settlement </value>
        ...
        {
            return this.Equals(input as TransactionSettlementsEvent);
        }

        /// <summary>
        /// Returns true if TransactionSettlementsEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionSettlementsEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionSettlementsEvent input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.EventCorrelationId == input.EventCorrelationId ||
                    (this.EventCorrelationId != null &&
                    this.EventCorrelationId.Equals(input.EventCorrelationId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EventCorrelationId != null)
                    hashCode = hashCode * 59 + this.EventCorrelationId.GetHashCode();
