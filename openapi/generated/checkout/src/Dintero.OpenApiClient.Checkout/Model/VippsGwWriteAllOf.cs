...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// VippsGwWriteAllOf
    /// </summary>
    [DataContract(Name = "VippsGwWrite_allOf")]
    public partial class VippsGwWriteAllOf : IEquatable<VippsGwWriteAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VippsGwWriteAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VippsGwWriteAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VippsGwWriteAllOf" /> class.
        /// </summary>
        ...
        public VippsGwWriteAllOf(string clientSecret = default(string), string ocpApimSubscriptionKeyAccessToken = default(string), string ocpApimSubscriptionKeyEcom = default(string))
        {
            // to ensure "clientSecret" is required (not null)
            this.ClientSecret = clientSecret ?? throw new ArgumentNullException("clientSecret is a required property for VippsGwWriteAllOf and cannot be null");
            // to ensure "ocpApimSubscriptionKeyAccessToken" is required (not null)
            this.OcpApimSubscriptionKeyAccessToken = ocpApimSubscriptionKeyAccessToken ?? throw new ArgumentNullException("ocpApimSubscriptionKeyAccessToken is a required property for VippsGwWriteAllOf and cannot be null");
            // to ensure "ocpApimSubscriptionKeyEcom" is required (not null)
            this.OcpApimSubscriptionKeyEcom = ocpApimSubscriptionKeyEcom ?? throw new ArgumentNullException("ocpApimSubscriptionKeyEcom is a required property for VippsGwWriteAllOf and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VippsGwWriteAllOf {\n");
        ...
        {
            return this.Equals(input as VippsGwWriteAllOf);
        }

        /// <summary>
        /// Returns true if VippsGwWriteAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of VippsGwWriteAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VippsGwWriteAllOf input)
        {
            if (input == null)
                return false;
