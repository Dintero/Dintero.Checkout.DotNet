...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// PayExGwWriteAllOf
    /// </summary>
    [DataContract(Name = "PayExGwWrite_allOf")]
    public partial class PayExGwWriteAllOf : IEquatable<PayExGwWriteAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExGwWriteAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayExGwWriteAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExGwWriteAllOf" /> class.
        /// </summary>
        /// <param name="payeeId">payeeId (required).</param>
        /// <param name="token">token (required).</param>
        public PayExGwWriteAllOf(string payeeId = default(string), string token = default(string))
        {
            // to ensure "payeeId" is required (not null)
            this.PayeeId = payeeId ?? throw new ArgumentNullException("payeeId is a required property for PayExGwWriteAllOf and cannot be null");
            // to ensure "token" is required (not null)
            this.Token = token ?? throw new ArgumentNullException("token is a required property for PayExGwWriteAllOf and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PayExGwWriteAllOf {\n");
        ...
        {
            return this.Equals(input as PayExGwWriteAllOf);
        }

        /// <summary>
        /// Returns true if PayExGwWriteAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PayExGwWriteAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayExGwWriteAllOf input)
        {
            if (input == null)
                return false;
