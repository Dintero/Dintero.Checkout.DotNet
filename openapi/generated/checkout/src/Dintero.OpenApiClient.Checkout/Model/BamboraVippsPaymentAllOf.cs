...
{
    /// <summary>
    /// BamboraVippsPaymentAllOf
    /// </summary>
    [DataContract(Name = "BamboraVippsPayment_allOf")]
    public partial class BamboraVippsPaymentAllOf : IEquatable<BamboraVippsPaymentAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraVippsPaymentAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BamboraVippsPaymentAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraVippsPaymentAllOf" /> class.
        /// </summary>
        ...
        public BamboraVippsPaymentAllOf(string phoneNumber = default(string), bool rememberMe = default(bool))
        {
            // to ensure "phoneNumber" is required (not null)
            this.PhoneNumber = phoneNumber ?? throw new ArgumentNullException("phoneNumber is a required property for BamboraVippsPaymentAllOf and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BamboraVippsPaymentAllOf {\n");
        ...
        {
            return this.Equals(input as BamboraVippsPaymentAllOf);
        }

        /// <summary>
        /// Returns true if BamboraVippsPaymentAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of BamboraVippsPaymentAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BamboraVippsPaymentAllOf input)
        {
            if (input == null)
                return false;
