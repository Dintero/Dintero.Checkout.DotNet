...
{
    /// <summary>
    /// TransactionCollectorAllOf
    /// </summary>
    [DataContract(Name = "TransactionCollector_allOf")]
    public partial class TransactionCollectorAllOf : IEquatable<TransactionCollectorAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionCollectorAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionCollectorAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionCollectorAllOf" /> class.
        /// </summary>
        ...
        public TransactionCollectorAllOf(PaymentProductTypeEnum paymentProductType = default(PaymentProductTypeEnum), List<TransactionCollectorAllOfEvents> events = default(List<TransactionCollectorAllOfEvents>), TransactionCollectorAllOfMetadata1 metadata = default(TransactionCollectorAllOfMetadata1))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionCollectorAllOf {\n");
        ...
        {
            return this.Equals(input as TransactionCollectorAllOf);
        }

        /// <summary>
        /// Returns true if TransactionCollectorAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionCollectorAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionCollectorAllOf input)
        {
            if (input == null)
                return false;
