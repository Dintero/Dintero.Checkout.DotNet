...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// SessionReadCustomer
    /// </summary>
    [DataContract(Name = "SessionRead_customer")]
    public partial class SessionReadCustomer : IEquatable<SessionReadCustomer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionReadCustomer" /> class.
        /// </summary>
        /// <param name="myDintero">myDintero.</param>
        /// <param name="tokens">tokens.</param>
        public SessionReadCustomer(MyDinteroUserCreation myDintero = default(MyDinteroUserCreation), SessionReadCustomerTokens tokens = default(SessionReadCustomerTokens))
        {
        ...
        public SessionReadCustomerTokens Tokens { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SessionReadCustomer {\n");
        ...
        {
            return this.Equals(input as SessionReadCustomer);
        }

        /// <summary>
        /// Returns true if SessionReadCustomer instances are equal
        /// </summary>
        /// <param name="input">Instance of SessionReadCustomer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SessionReadCustomer input)
        {
            if (input == null)
                return false;
