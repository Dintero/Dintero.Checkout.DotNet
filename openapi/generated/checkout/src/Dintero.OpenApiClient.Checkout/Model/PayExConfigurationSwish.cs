...
{
    /// <summary>
    /// PayExConfigurationSwish
    /// </summary>
    [DataContract(Name = "PayExConfiguration_swish")]
    public partial class PayExConfigurationSwish : IEquatable<PayExConfigurationSwish>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExConfigurationSwish" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayExConfigurationSwish() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExConfigurationSwish" /> class.
        /// </summary>
        /// <param name="enabled">enable Payex Swish Payment (required).</param>
        /// <param name="payability">payability.</param>
        public PayExConfigurationSwish(bool enabled = default(bool), SessionPayability? payability = default(SessionPayability?))
        {
        ...
        /// </summary>
        /// <value>enable Payex Swish Payment</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PayExConfigurationSwish {\n");
        ...
        {
            return this.Equals(input as PayExConfigurationSwish);
        }

        /// <summary>
        /// Returns true if PayExConfigurationSwish instances are equal
        /// </summary>
        /// <param name="input">Instance of PayExConfigurationSwish to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayExConfigurationSwish input)
        {
            if (input == null)
                return false;
