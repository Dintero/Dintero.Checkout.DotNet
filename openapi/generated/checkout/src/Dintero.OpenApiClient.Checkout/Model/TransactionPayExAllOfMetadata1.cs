...
{
    /// <summary>
    /// TransactionPayExAllOfMetadata1
    /// </summary>
    [DataContract(Name = "TransactionPayEx_allOf_metadata_1")]
    public partial class TransactionPayExAllOfMetadata1 : IEquatable<TransactionPayExAllOfMetadata1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionPayExAllOfMetadata1" /> class.
        /// </summary>
        /// <param name="payexpaymentpayeeInfopayeeId">payexpaymentpayeeInfopayeeId.</param>
        /// <param name="payexpaymentpayeeInfopayeeName">payexpaymentpayeeInfopayeeName.</param>
        /// <param name="payexpaymentpayeeInfosubsite">payexpaymentpayeeInfosubsite.</param>
        /// <param name="payexpaymentid">payexpaymentid.</param>
        /// <param name="payexpaymentnumber">payexpaymentnumber.</param>
        /// <param name="payexpaymentoperation">payexpaymentoperation.</param>
        /// <param name="payexpaymentcreated">payexpaymentcreated.</param>
        public TransactionPayExAllOfMetadata1(string payexpaymentpayeeInfopayeeId = default(string), string payexpaymentpayeeInfopayeeName = default(string), string payexpaymentpayeeInfosubsite = default(string), string payexpaymentid = default(string), decimal payexpaymentnumber = default(decimal), string payexpaymentoperation = default(string), DateTime payexpaymentcreated = default(DateTime))
        {
            this.PayexpaymentpayeeInfopayeeId = payexpaymentpayeeInfopayeeId;
            this.PayexpaymentpayeeInfopayeeName = payexpaymentpayeeInfopayeeName;
            this.PayexpaymentpayeeInfosubsite = payexpaymentpayeeInfosubsite;
            this.Payexpaymentid = payexpaymentid;
            this.Payexpaymentnumber = payexpaymentnumber;
            this.Payexpaymentoperation = payexpaymentoperation;
            this.Payexpaymentcreated = payexpaymentcreated;
        }

        /// <summary>
        /// Gets or Sets PayexpaymentpayeeInfopayeeId
        /// </summary>
        [DataMember(Name = "payex:payment:payee_info:payee_id", EmitDefaultValue = false)]
        public string PayexpaymentpayeeInfopayeeId { get; set; }

        /// <summary>
        /// Gets or Sets PayexpaymentpayeeInfopayeeName
        /// </summary>
        [DataMember(Name = "payex:payment:payee_info:payee_name", EmitDefaultValue = false)]
        public string PayexpaymentpayeeInfopayeeName { get; set; }

        /// <summary>
        /// Gets or Sets PayexpaymentpayeeInfosubsite
        /// </summary>
        [DataMember(Name = "payex:payment:payee_info:subsite", EmitDefaultValue = false)]
        public string PayexpaymentpayeeInfosubsite { get; set; }

        /// <summary>
        /// Gets or Sets Payexpaymentid
        /// </summary>
        [DataMember(Name = "payex:payment:id", EmitDefaultValue = false)]
        public string Payexpaymentid { get; set; }

        /// <summary>
        /// Gets or Sets Payexpaymentnumber
        /// </summary>
        [DataMember(Name = "payex:payment:number", EmitDefaultValue = false)]
        public decimal Payexpaymentnumber { get; set; }

        /// <summary>
        /// Gets or Sets Payexpaymentoperation
        /// </summary>
        [DataMember(Name = "payex:payment:operation", EmitDefaultValue = false)]
        public string Payexpaymentoperation { get; set; }

        /// <summary>
        /// Gets or Sets Payexpaymentcreated
        /// </summary>
        [DataMember(Name = "payex:payment:created", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionPayExAllOfMetadata1 {\n");
            sb.Append("  PayexpaymentpayeeInfopayeeId: ").Append(PayexpaymentpayeeInfopayeeId).Append("\n");
            sb.Append("  PayexpaymentpayeeInfopayeeName: ").Append(PayexpaymentpayeeInfopayeeName).Append("\n");
            sb.Append("  PayexpaymentpayeeInfosubsite: ").Append(PayexpaymentpayeeInfosubsite).Append("\n");
            sb.Append("  Payexpaymentid: ").Append(Payexpaymentid).Append("\n");
            sb.Append("  Payexpaymentnumber: ").Append(Payexpaymentnumber).Append("\n");
            sb.Append("  Payexpaymentoperation: ").Append(Payexpaymentoperation).Append("\n");
            sb.Append("  Payexpaymentcreated: ").Append(Payexpaymentcreated).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TransactionPayExAllOfMetadata1);
        }

        /// <summary>
        /// Returns true if TransactionPayExAllOfMetadata1 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionPayExAllOfMetadata1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionPayExAllOfMetadata1 input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.PayexpaymentpayeeInfopayeeId == input.PayexpaymentpayeeInfopayeeId ||
                    (this.PayexpaymentpayeeInfopayeeId != null &&
                    this.PayexpaymentpayeeInfopayeeId.Equals(input.PayexpaymentpayeeInfopayeeId))
                ) && 
                (
                    this.PayexpaymentpayeeInfopayeeName == input.PayexpaymentpayeeInfopayeeName ||
                    (this.PayexpaymentpayeeInfopayeeName != null &&
                    this.PayexpaymentpayeeInfopayeeName.Equals(input.PayexpaymentpayeeInfopayeeName))
                ) && 
                (
                    this.PayexpaymentpayeeInfosubsite == input.PayexpaymentpayeeInfosubsite ||
                    (this.PayexpaymentpayeeInfosubsite != null &&
                    this.PayexpaymentpayeeInfosubsite.Equals(input.PayexpaymentpayeeInfosubsite))
                ) && 
                (
                    this.Payexpaymentid == input.Payexpaymentid ||
                    (this.Payexpaymentid != null &&
                    this.Payexpaymentid.Equals(input.Payexpaymentid))
                ) && 
                (
                    this.Payexpaymentnumber == input.Payexpaymentnumber ||
                    this.Payexpaymentnumber.Equals(input.Payexpaymentnumber)
                ) && 
                (
                    this.Payexpaymentoperation == input.Payexpaymentoperation ||
                    (this.Payexpaymentoperation != null &&
                    this.Payexpaymentoperation.Equals(input.Payexpaymentoperation))
                ) && 
                (
                    this.Payexpaymentcreated == input.Payexpaymentcreated ||
                    (this.Payexpaymentcreated != null &&
                    this.Payexpaymentcreated.Equals(input.Payexpaymentcreated))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.PayexpaymentpayeeInfopayeeId != null)
                    hashCode = hashCode * 59 + this.PayexpaymentpayeeInfopayeeId.GetHashCode();
                if (this.PayexpaymentpayeeInfopayeeName != null)
                    hashCode = hashCode * 59 + this.PayexpaymentpayeeInfopayeeName.GetHashCode();
                if (this.PayexpaymentpayeeInfosubsite != null)
                    hashCode = hashCode * 59 + this.PayexpaymentpayeeInfosubsite.GetHashCode();
                if (this.Payexpaymentid != null)
                    hashCode = hashCode * 59 + this.Payexpaymentid.GetHashCode();
                hashCode = hashCode * 59 + this.Payexpaymentnumber.GetHashCode();
                if (this.Payexpaymentoperation != null)
                    hashCode = hashCode * 59 + this.Payexpaymentoperation.GetHashCode();
                if (this.Payexpaymentcreated != null)
                    hashCode = hashCode * 59 + this.Payexpaymentcreated.GetHashCode();
                return hashCode;
            }
        }
