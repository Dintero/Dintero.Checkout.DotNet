...
{
    /// <summary>
    /// BamboraConfigurationVipps
    /// </summary>
    [DataContract(Name = "BamboraConfiguration_vipps")]
    public partial class BamboraConfigurationVipps : IEquatable<BamboraConfigurationVipps>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraConfigurationVipps" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BamboraConfigurationVipps() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraConfigurationVipps" /> class.
        /// </summary>
        ...
        public BamboraConfigurationVipps(TypeEnum? type = default(TypeEnum?), bool enabled = default(bool), SessionPayability? payability = default(SessionPayability?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BamboraConfigurationVipps {\n");
        ...
        {
            return this.Equals(input as BamboraConfigurationVipps);
        }

        /// <summary>
        /// Returns true if BamboraConfigurationVipps instances are equal
        /// </summary>
        /// <param name="input">Instance of BamboraConfigurationVipps to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BamboraConfigurationVipps input)
        {
            if (input == null)
                return false;
