...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// SessionCustomer
    /// </summary>
    [DataContract(Name = "SessionCustomer")]
    public partial class SessionCustomer : IEquatable<SessionCustomer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionCustomer" /> class.
        /// </summary>
        ...
        public SessionCustomer(string customerId = default(string), string email = default(string), string phoneNumber = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SessionCustomer {\n");
        ...
        {
            return this.Equals(input as SessionCustomer);
        }

        /// <summary>
        /// Returns true if SessionCustomer instances are equal
        /// </summary>
        /// <param name="input">Instance of SessionCustomer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SessionCustomer input)
        {
            if (input == null)
                return false;
