...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CollectorGwStoreOverrideRead")]
    public partial class CollectorGwStoreOverrideRead : IEquatable<CollectorGwStoreOverrideRead>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorGwStoreOverrideRead" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorGwStoreOverrideRead() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorGwStoreOverrideRead" /> class.
        /// </summary>
        ...
        public CollectorGwStoreOverrideRead(string url = default(string), string username = default(string), decimal storeId = default(decimal), string country = default(string), CollectorGwReadOptions options = default(CollectorGwReadOptions), List<CollectorGwReadStores> stores = default(List<CollectorGwReadStores>))
        {
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url is a required property for CollectorGwStoreOverrideRead and cannot be null");
            // to ensure "username" is required (not null)
            this.Username = username ?? throw new ArgumentNullException("username is a required property for CollectorGwStoreOverrideRead and cannot be null");
            this.StoreId = storeId;
            // to ensure "country" is required (not null)
            this.Country = country ?? throw new ArgumentNullException("country is a required property for CollectorGwStoreOverrideRead and cannot be null");
        ...
        public CollectorGwReadOptions Options { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorGwStoreOverrideRead {\n");
        ...
        {
            return this.Equals(input as CollectorGwStoreOverrideRead);
        }

        /// <summary>
        /// Returns true if CollectorGwStoreOverrideRead instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorGwStoreOverrideRead to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorGwStoreOverrideRead input)
        {
            if (input == null)
                return false;
