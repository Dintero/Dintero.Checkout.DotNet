...
{
    /// <summary>
    /// PaymentResponseActions
    /// </summary>
    [DataContract(Name = "PaymentResponse_actions")]
    public partial class PaymentResponseActions : IEquatable<PaymentResponseActions>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentResponseActions" /> class.
        /// </summary>
        /// <param name="source">action source.</param>
        /// <param name="code">status.</param>
        /// <param name="type">type.</param>
        public PaymentResponseActions(string source = default(string), string code = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Source = source;
            this.Code = code;
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentResponseActions {\n");
        ...
        {
            return this.Equals(input as PaymentResponseActions);
        }

        /// <summary>
        /// Returns true if PaymentResponseActions instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentResponseActions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentResponseActions input)
        {
            if (input == null)
                return false;
