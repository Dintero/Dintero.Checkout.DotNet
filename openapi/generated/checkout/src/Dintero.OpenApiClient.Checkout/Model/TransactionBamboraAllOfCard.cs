...
{
    /// <summary>
    /// TransactionBamboraAllOfCard
    /// </summary>
    [DataContract(Name = "TransactionBambora_allOf_card")]
    public partial class TransactionBamboraAllOfCard : IEquatable<TransactionBamboraAllOfCard>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionBamboraAllOfCard" /> class.
        /// </summary>
        ...
        public TransactionBamboraAllOfCard(string brand = default(string), string maskedPan = default(string), string expiryDate = default(string), TypeEnum? type = default(TypeEnum?), string eci = default(string), string country = default(string))
        {
            this.Brand = brand;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionBamboraAllOfCard {\n");
        ...
        {
            return this.Equals(input as TransactionBamboraAllOfCard);
        }

        /// <summary>
        /// Returns true if TransactionBamboraAllOfCard instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionBamboraAllOfCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionBamboraAllOfCard input)
        {
            if (input == null)
                return false;
