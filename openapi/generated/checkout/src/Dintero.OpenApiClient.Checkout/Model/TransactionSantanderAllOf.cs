...
{
    /// <summary>
    /// TransactionSantanderAllOf
    /// </summary>
    [DataContract(Name = "TransactionSantander_allOf")]
    public partial class TransactionSantanderAllOf : IEquatable<TransactionSantanderAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionSantanderAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionSantanderAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionSantanderAllOf" /> class.
        /// </summary>
        ...
        public TransactionSantanderAllOf(PaymentProductTypeEnum paymentProductType = default(PaymentProductTypeEnum), List<TransactionSantanderAllOfEvents> events = default(List<TransactionSantanderAllOfEvents>), TransactionSantanderAllOfMetadata metadata = default(TransactionSantanderAllOfMetadata))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionSantanderAllOf {\n");
        ...
        {
            return this.Equals(input as TransactionSantanderAllOf);
        }

        /// <summary>
        /// Returns true if TransactionSantanderAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionSantanderAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionSantanderAllOf input)
        {
            if (input == null)
                return false;
