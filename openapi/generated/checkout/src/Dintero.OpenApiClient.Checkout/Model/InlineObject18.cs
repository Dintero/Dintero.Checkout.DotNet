...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class InlineObject18 : IEquatable<InlineObject18>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="InlineObject18" /> class.
        /// </summary>
        /// <param name="session">The session to create the payment token from  (required).</param>
        /// <param name="tokenProvider">tokenProvider (required).</param>
        public InlineObject18(SessionPaymentToken session = default(SessionPaymentToken), TokenProvider tokenProvider = default(TokenProvider))
        {
            // to ensure "session" is required (not null)
            this.Session = session ?? throw new ArgumentNullException("session is a required property for InlineObject18 and cannot be null");
            // to ensure "tokenProvider" is required (not null)
            this.TokenProvider = tokenProvider ?? throw new ArgumentNullException("tokenProvider is a required property for InlineObject18 and cannot be null");
        }

        /// <summary>
        /// The session to create the payment token from 
        /// </summary>
        /// <value>The session to create the payment token from </value>
        [DataMember(Name = "session", IsRequired = true, EmitDefaultValue = false)]
        public SessionPaymentToken Session { get; set; }

        /// <summary>
        /// Gets or Sets TokenProvider
        /// </summary>
        [DataMember(Name = "token_provider", IsRequired = true, EmitDefaultValue = false)]
        ...
        public bool Equals(InlineObject18 input)
        {
            ...
            return 
                ...
                (
                    ...
                    this.TokenProvider.Equals(input.TokenProvider))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TokenProvider != null)
                    hashCode = hashCode * 59 + this.TokenProvider.GetHashCode();
                return hashCode;
            }
        }
