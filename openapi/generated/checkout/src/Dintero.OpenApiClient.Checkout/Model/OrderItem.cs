...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class OrderItem : IEquatable<OrderItem>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="id">The ID or SKU of the product on the line .</param>
        /// <param name="groups">The groups the product on the line belongs to .</param>
        /// <param name="lineId">the number of the line (or id), must be &#x60;unique&#x60; between all items. &#x60;required&#x60; when Instabank payment is configured. .</param>
        /// <param name="description">A short, localized description of the line item .</param>
        /// <param name="quantity">The quantity of the product in the item line. .</param>
        /// <param name="amount">The total monetary amount of the line item  In smallest unit for the currency, e.g. cents .</param>
        ...
        /// <param name="unitVolume">The volume of one item in m³ (cubic meters) .</param>
        /// <param name="unitWeight">The volume of one item in kg (kilo grams) .</param>
        /// <param name="unitDimensionalWeight">The dimensional weight (also known as volumetric) value unit of one item. [Dimensional weight at Wikipedia](https://en.wikipedia.org/wiki/Dimensional_weight) .</param>
        public OrderItem(string id = default(string), List<OrderItemGroups> groups = default(List<OrderItemGroups>), string lineId = default(string), string description = default(string), decimal quantity = default(decimal), int amount = default(int), int vatAmount = default(int), decimal vat = default(decimal), decimal unitVolume = default(decimal), decimal unitWeight = default(decimal), decimal unitDimensionalWeight = default(decimal))
        {
            this.Id = id;
            this.Groups = groups;
            this.LineId = lineId;
            ...
            this.UnitDimensionalWeight = unitDimensionalWeight;
        }

        /// <summary>
        /// The ID or SKU of the product on the line 
        /// </summary>
        /// <value>The ID or SKU of the product on the line </value>
        ...
        /// </summary>
        /// <value>The groups the product on the line belongs to </value>
        [DataMember(Name = "groups", EmitDefaultValue = false)]
        public List<OrderItemGroups> Groups { get; set; }

        /// <summary>
        /// the number of the line (or id), must be &#x60;unique&#x60; between all items. &#x60;required&#x60; when Instabank payment is configured. 
        /// </summary>
        /// <value>the number of the line (or id), must be &#x60;unique&#x60; between all items. &#x60;required&#x60; when Instabank payment is configured. </value>
        [DataMember(Name = "line_id", EmitDefaultValue = false)]
        public string LineId { get; set; }

        /// <summary>
        /// The version where the item was added or last updated, see the events for the source. 
        /// </summary>
        /// <value>The version where the item was added or last updated, see the events for the source. </value>
        ...
        /// </summary>
        /// <value>A short, localized description of the line item </value>
        ...
        /// </summary>
        /// <value>The quantity of the product in the item line. </value>
        [DataMember(Name = "quantity", EmitDefaultValue = false)]
        public decimal Quantity { get; set; }

        /// <summary>
        /// The total monetary amount of the line item  In smallest unit for the currency, e.g. cents 
        /// </summary>
        /// <value>The total monetary amount of the line item  In smallest unit for the currency, e.g. cents </value>
        ...
        /// </summary>
        /// <value>The volume of one item in m³ (cubic meters) </value>
        [DataMember(Name = "unit_volume", EmitDefaultValue = false)]
        public decimal UnitVolume { get; set; }

        /// <summary>
        /// The volume of one item in kg (kilo grams) 
        /// </summary>
        /// <value>The volume of one item in kg (kilo grams) </value>
        ...
        /// </summary>
        /// <value>The dimensional weight (also known as volumetric) value unit of one item. [Dimensional weight at Wikipedia](https://en.wikipedia.org/wiki/Dimensional_weight) </value>
        [DataMember(Name = "unit_dimensional_weight", EmitDefaultValue = false)]
        public decimal UnitDimensionalWeight { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  UnitVolume: ").Append(UnitVolume).Append("\n");
            sb.Append("  UnitWeight: ").Append(UnitWeight).Append("\n");
            sb.Append("  UnitDimensionalWeight: ").Append(UnitDimensionalWeight).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(OrderItem input)
        {
            ...
            return 
                ...
                (
                    this.UnitVolume == input.UnitVolume ||
                    this.UnitVolume.Equals(input.UnitVolume)
                ) && 
                (
                ...
                (
                    this.UnitDimensionalWeight == input.UnitDimensionalWeight ||
                    this.UnitDimensionalWeight.Equals(input.UnitDimensionalWeight)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.UnitVolume.GetHashCode();
                hashCode = hashCode * 59 + this.UnitWeight.GetHashCode();
                hashCode = hashCode * 59 + this.UnitDimensionalWeight.GetHashCode();
                return hashCode;
            }
        }
