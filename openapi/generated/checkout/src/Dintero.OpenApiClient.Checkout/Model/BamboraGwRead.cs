...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BamboraGwRead")]
    public partial class BamboraGwRead : IEquatable<BamboraGwRead>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraGwRead" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BamboraGwRead() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraGwRead" /> class.
        /// </summary>
        ...
        public BamboraGwRead(string checkoutApiUrl = default(string), string merchantApiUrl = default(string), string transactionApiUrl = default(string), string walletApiUrl = default(string), string merchantNumber = default(string))
        {
            // to ensure "checkoutApiUrl" is required (not null)
            this.CheckoutApiUrl = checkoutApiUrl ?? throw new ArgumentNullException("checkoutApiUrl is a required property for BamboraGwRead and cannot be null");
            // to ensure "merchantApiUrl" is required (not null)
            this.MerchantApiUrl = merchantApiUrl ?? throw new ArgumentNullException("merchantApiUrl is a required property for BamboraGwRead and cannot be null");
            // to ensure "transactionApiUrl" is required (not null)
            this.TransactionApiUrl = transactionApiUrl ?? throw new ArgumentNullException("transactionApiUrl is a required property for BamboraGwRead and cannot be null");
            // to ensure "walletApiUrl" is required (not null)
            this.WalletApiUrl = walletApiUrl ?? throw new ArgumentNullException("walletApiUrl is a required property for BamboraGwRead and cannot be null");
            // to ensure "merchantNumber" is required (not null)
            this.MerchantNumber = merchantNumber ?? throw new ArgumentNullException("merchantNumber is a required property for BamboraGwRead and cannot be null");
        }
        ...
        {
            return this.Equals(input as BamboraGwRead);
        }

        /// <summary>
        /// Returns true if BamboraGwRead instances are equal
        /// </summary>
        /// <param name="input">Instance of BamboraGwRead to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BamboraGwRead input)
        {
            if (input == null)
                return false;
