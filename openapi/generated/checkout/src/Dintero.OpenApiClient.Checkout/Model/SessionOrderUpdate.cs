...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// SessionOrderUpdate
    /// </summary>
    [DataContract(Name = "SessionOrderUpdate")]
    public partial class SessionOrderUpdate : IEquatable<SessionOrderUpdate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionOrderUpdate" /> class.
        /// </summary>
        ...
        public SessionOrderUpdate(int amount = default(int), string currency = default(string), int vatAmount = default(int), string merchantReference2 = default(string), OrderAddress shippingAddress = default(OrderAddress), OrderAddress billingAddress = default(OrderAddress), bool partialPayment = false, List<OrderItem> items = default(List<OrderItem>), ShippingOption shippingOption = default(ShippingOption), Store store = default(Store), List<DiscountItem> discountLines = default(List<DiscountItem>), List<string> discountCodes = default(List<string>))
        {
            this.Amount = amount;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SessionOrderUpdate {\n");
        ...
        {
            return this.Equals(input as SessionOrderUpdate);
        }

        /// <summary>
        /// Returns true if SessionOrderUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of SessionOrderUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SessionOrderUpdate input)
        {
            if (input == null)
                return false;
