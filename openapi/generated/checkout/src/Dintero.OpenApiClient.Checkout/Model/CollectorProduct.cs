...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CollectorProduct")]
    public partial class CollectorProduct : IEquatable<CollectorProduct>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        public enum TypeEnum
        {
            ...
            /// <summary>
            /// Enum Annuity for value: annuity
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorProduct" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorProduct() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorProduct" /> class.
        /// </summary>
        /// <param name="id">Id for the payment product  (required).</param>
        /// <param name="type">type (required).</param>
        /// <param name="creditTime">Number of months  (required).</param>
        /// <param name="campaignFee">The fee for a \&quot;Buy now – pay later\&quot; Payment product  (required).</param>
        ...
        /// <param name="effectiveAnnualInterestRate">The effective annual interest rate for the payment product .</param>
        /// <param name="totalAmount">The total amount to pay (required).</param>
        /// <param name="monthlyAmount">The amount to pay pr month (required).</param>
        /// <param name="firstMonthlyAmount">The amount to pay in the first invoice. Origantion fee is added to the first invoice.  (required).</param>
        public CollectorProduct(string id = default(string), TypeEnum type = default(TypeEnum), int creditTime = default(int), int campaignFee = default(int), int originationFee = default(int), int notificationFee = default(int), string annualInterestRate = default(string), string effectiveAnnualInterestRate = default(string), int totalAmount = default(int), int monthlyAmount = default(int), int firstMonthlyAmount = default(int))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for CollectorProduct and cannot be null");
            this.Type = type;
            ...
            this.EffectiveAnnualInterestRate = effectiveAnnualInterestRate;
        }

        /// <summary>
        /// Id for the payment product 
        /// </summary>
        /// <value>Id for the payment product </value>
        ...
        /// </summary>
        /// <value>The fee for a \&quot;Buy now – pay later\&quot; Payment product </value>
        [DataMember(Name = "campaign_fee", IsRequired = true, EmitDefaultValue = false)]
        ...
        public string EffectiveAnnualInterestRate { get; set; }
        ...
        [DataMember(Name = "monthly_amount", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "first_monthly_amount", IsRequired = true, EmitDefaultValue = false)]
        public int FirstMonthlyAmount { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorProduct {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  Type: ").Append(Type).Append("\n");
            sb.Append("  CreditTime: ").Append(CreditTime).Append("\n");
            sb.Append("  CampaignFee: ").Append(CampaignFee).Append("\n");
        ...
        {
            return this.Equals(input as CollectorProduct);
        }

        /// <summary>
        /// Returns true if CollectorProduct instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorProduct to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorProduct input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CampaignFee == input.CampaignFee ||
                    this.CampaignFee.Equals(input.CampaignFee)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.CampaignFee.GetHashCode();
