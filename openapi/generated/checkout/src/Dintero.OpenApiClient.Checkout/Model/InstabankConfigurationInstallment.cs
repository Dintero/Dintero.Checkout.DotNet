...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// Fixed Part Payment
    /// </summary>
    [DataContract(Name = "InstabankConfiguration_installment")]
    public partial class InstabankConfigurationInstallment : IEquatable<InstabankConfigurationInstallment>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankConfigurationInstallment" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstabankConfigurationInstallment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankConfigurationInstallment" /> class.
        /// </summary>
        /// <param name="type">Denotes what kind of config parameter this is (default to TypeEnum.PaymentProductType).</param>
        /// <param name="enabled">enable Instabank Installment Payment (required).</param>
        /// <param name="payability">payability.</param>
        public InstabankConfigurationInstallment(TypeEnum? type = TypeEnum.PaymentProductType, bool enabled = default(bool), SessionPayability? payability = default(SessionPayability?))
        {
        ...
        /// </summary>
        /// <value>enable Instabank Installment Payment</value>
        ...
        public List<InstabankInstallmentProduct> Products { get; private set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstabankConfigurationInstallment {\n");
        ...
        {
            return this.Equals(input as InstabankConfigurationInstallment);
        }

        /// <summary>
        /// Returns true if InstabankConfigurationInstallment instances are equal
        /// </summary>
        /// <param name="input">Instance of InstabankConfigurationInstallment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstabankConfigurationInstallment input)
        {
            if (input == null)
                return false;
