...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class TransactionEvent : IEquatable<TransactionEvent>, IValidatableObject
    {
        ...
        public enum EventEnum
        {
            ...
            /// <summary>
            /// Enum INITIATEREFUND for value: INITIATE_REFUND
            /// </summary>
            [EnumMember(Value = "INITIATE_REFUND")]
            INITIATEREFUND = 6,

            /// <summary>
            /// Enum INITIATECAPTURE for value: INITIATE_CAPTURE
            /// </summary>
            [EnumMember(Value = "INITIATE_CAPTURE")]
            INITIATECAPTURE = 7,
        ...
        /// </summary>
        /// <param name="transactionStatus">The transaction state after this event .</param>
        /// <param name="_event">the event type.</param>
        /// <param name="success">The event operation completed with success .</param>
        /// <param name="correction">correction.</param>
        /// <param name="error">error.</param>
        /// <param name="amount">Amount captured or refunded .</param>
        /// <param name="calculatedVatAmount">Best-effort calculation of the VAT amount in this transaction .</param>
        /// <param name="items">The applicable event items.</param>
        /// <param name="createdAt">createdAt.</param>
        /// <param name="createdBy">createdBy.</param>
        /// <param name="requestId">requestId.</param>
        /// <param name="metadata">Additional details about the event .</param>
        /// <param name="correlationRequestId">The event correlation to existing event. The property will be set if the event is an CAPTURE or REFUND of correlated INITIATE_CAPTURE or INITIATE_REFUND event. .</param>
        /// <param name="eventReference">Reference for the transaction event provided by the merchant.  - For captures, this is &#x60;capture_reference&#x60; - For refunds, this is &#x60;refund_reference&#x60;  When relevant, it will be visible on the Dintero settlement report. .</param>
        /// <param name="settlements">settlements.</param>
        public TransactionEvent(string transactionStatus = default(string), EventEnum? _event = default(EventEnum?), bool success = default(bool), TransactionEventCorrection correction = default(TransactionEventCorrection), TransactionEventError error = default(TransactionEventError), decimal amount = default(decimal), decimal calculatedVatAmount = default(decimal), List<OrderItem> items = default(List<OrderItem>), DateTime createdAt = default(DateTime), string createdBy = default(string), Guid requestId = default(Guid), Object metadata = default(Object), Guid correlationRequestId = default(Guid), string eventReference = default(string), TransactionSettlementsRead settlements = default(TransactionSettlementsRead))
        {
        ...
        /// </summary>
        /// <value>The transaction state after this event </value>
        ...
        /// </summary>
        /// <value>The event operation completed with success </value>
        ...
        public TransactionEventCorrection Correction { get; set; }

        /// <summary>
        /// Gets or Sets Error
        /// </summary>
        [DataMember(Name = "error", EmitDefaultValue = false)]
        public TransactionEventError Error { get; set; }

        /// <summary>
        /// Amount captured or refunded 
        /// </summary>
        /// <value>Amount captured or refunded </value>
        ...
        /// </summary>
        /// <value>Best-effort calculation of the VAT amount in this transaction </value>
        [DataMember(Name = "calculated_vat_amount", EmitDefaultValue = false)]
        public decimal CalculatedVatAmount { get; set; }

        /// <summary>
        /// The applicable event items
        /// </summary>
        /// <value>The applicable event items</value>
        ...
        /// </summary>
        /// <value>Additional details about the event </value>
        [DataMember(Name = "metadata", EmitDefaultValue = false)]
        public Object Metadata { get; set; }

        /// <summary>
        /// The event correlation to existing event. The property will be set if the event is an CAPTURE or REFUND of correlated INITIATE_CAPTURE or INITIATE_REFUND event. 
        /// </summary>
        /// <value>The event correlation to existing event. The property will be set if the event is an CAPTURE or REFUND of correlated INITIATE_CAPTURE or INITIATE_REFUND event. </value>
        [DataMember(Name = "correlation_request_id", EmitDefaultValue = false)]
        public Guid CorrelationRequestId { get; set; }

        /// <summary>
        /// Reference for the transaction event provided by the merchant.  - For captures, this is &#x60;capture_reference&#x60; - For refunds, this is &#x60;refund_reference&#x60;  When relevant, it will be visible on the Dintero settlement report. 
        /// </summary>
        /// <value>Reference for the transaction event provided by the merchant.  - For captures, this is &#x60;capture_reference&#x60; - For refunds, this is &#x60;refund_reference&#x60;  When relevant, it will be visible on the Dintero settlement report. </value>
        [DataMember(Name = "event_reference", EmitDefaultValue = false)]
        ...
        public TransactionSettlementsRead Settlements { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CalculatedVatAmount: ").Append(CalculatedVatAmount).Append("\n");
            sb.Append("  Items: ").Append(Items).Append("\n");
            sb.Append("  CreatedAt: ").Append(CreatedAt).Append("\n");
            sb.Append("  CreatedBy: ").Append(CreatedBy).Append("\n");
            sb.Append("  RequestId: ").Append(RequestId).Append("\n");
            sb.Append("  Metadata: ").Append(Metadata).Append("\n");
            sb.Append("  CorrelationRequestId: ").Append(CorrelationRequestId).Append("\n");
            sb.Append("  EventReference: ").Append(EventReference).Append("\n");
        ...
        public bool Equals(TransactionEvent input)
        {
            ...
            return 
                ...
                (
                    this.Correction == input.Correction ||
                    (this.Correction != null &&
                    this.Correction.Equals(input.Correction))
                ) && 
                (
                ...
                (
                    this.CalculatedVatAmount == input.CalculatedVatAmount ||
                    this.CalculatedVatAmount.Equals(input.CalculatedVatAmount)
                ) && 
                (
                ...
                (
                    this.CorrelationRequestId == input.CorrelationRequestId ||
                    (this.CorrelationRequestId != null &&
                    this.CorrelationRequestId.Equals(input.CorrelationRequestId))
                ) && 
                (
                    this.EventReference == input.EventReference ||
                    (this.EventReference != null &&
                    this.EventReference.Equals(input.EventReference))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Correction != null)
                    hashCode = hashCode * 59 + this.Correction.GetHashCode();
                if (this.Error != null)
                    hashCode = hashCode * 59 + this.Error.GetHashCode();
                hashCode = hashCode * 59 + this.Amount.GetHashCode();
                hashCode = hashCode * 59 + this.CalculatedVatAmount.GetHashCode();
                if (this.Items != null)
                ...
                if (this.CorrelationRequestId != null)
                    hashCode = hashCode * 59 + this.CorrelationRequestId.GetHashCode();
                if (this.EventReference != null)
                    hashCode = hashCode * 59 + this.EventReference.GetHashCode();
