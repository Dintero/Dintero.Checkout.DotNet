...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransactionCollector_allOf_metadata_1")]
    public partial class TransactionCollectorAllOfMetadata1 : IEquatable<TransactionCollectorAllOfMetadata1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionCollectorAllOfMetadata1" /> class.
        /// </summary>
        /// <param name="collectorStoreId">The Collector Store ID of the payment.</param>
        /// <param name="collectorInvoiceInvoiceNumber">The invoice number of the invoice..</param>
        /// <param name="collectorInvoiceOrderNumber">Corresponds to the Dintero session ID.</param>
        /// <param name="collectorInvoiceCountryCode">The country of the payment.</param>
        /// <param name="collectorInvoiceProductCode">collectorInvoiceProductCode.</param>
        /// <param name="collectorInvoiceInvoiceType">collectorInvoiceInvoiceType.</param>
        /// <param name="collectorInvoiceSettlementReference">The SettlementReference used for the payment..</param>
        public TransactionCollectorAllOfMetadata1(string collectorStoreId = default(string), string collectorInvoiceInvoiceNumber = default(string), string collectorInvoiceOrderNumber = default(string), string collectorInvoiceCountryCode = default(string), string collectorInvoiceProductCode = default(string), string collectorInvoiceInvoiceType = default(string), string collectorInvoiceSettlementReference = default(string))
        {
            this.CollectorStoreId = collectorStoreId;
            this.CollectorInvoiceInvoiceNumber = collectorInvoiceInvoiceNumber;
            this.CollectorInvoiceOrderNumber = collectorInvoiceOrderNumber;
            this.CollectorInvoiceCountryCode = collectorInvoiceCountryCode;
            this.CollectorInvoiceProductCode = collectorInvoiceProductCode;
            this.CollectorInvoiceInvoiceType = collectorInvoiceInvoiceType;
            this.CollectorInvoiceSettlementReference = collectorInvoiceSettlementReference;
        }

        /// <summary>
        /// The Collector Store ID of the payment
        /// </summary>
        /// <value>The Collector Store ID of the payment</value>
        [DataMember(Name = "collector:StoreId", EmitDefaultValue = false)]
        public string CollectorStoreId { get; set; }

        /// <summary>
        /// The invoice number of the invoice.
        /// </summary>
        /// <value>The invoice number of the invoice.</value>
        [DataMember(Name = "collector:Invoice.InvoiceNumber", EmitDefaultValue = false)]
        public string CollectorInvoiceInvoiceNumber { get; set; }

        /// <summary>
        /// Corresponds to the Dintero session ID
        /// </summary>
        /// <value>Corresponds to the Dintero session ID</value>
        [DataMember(Name = "collector:Invoice.OrderNumber", EmitDefaultValue = false)]
        public string CollectorInvoiceOrderNumber { get; set; }

        /// <summary>
        /// The country of the payment
        /// </summary>
        /// <value>The country of the payment</value>
        [DataMember(Name = "collector:Invoice.CountryCode", EmitDefaultValue = false)]
        public string CollectorInvoiceCountryCode { get; set; }

        /// <summary>
        /// Gets or Sets CollectorInvoiceProductCode
        /// </summary>
        [DataMember(Name = "collector:Invoice.ProductCode", EmitDefaultValue = false)]
        public string CollectorInvoiceProductCode { get; set; }

        /// <summary>
        /// Gets or Sets CollectorInvoiceInvoiceType
        /// </summary>
        [DataMember(Name = "collector:Invoice.InvoiceType", EmitDefaultValue = false)]
        public string CollectorInvoiceInvoiceType { get; set; }

        /// <summary>
        /// The SettlementReference used for the payment.
        /// </summary>
        /// <value>The SettlementReference used for the payment.</value>
        [DataMember(Name = "collector:Invoice.SettlementReference", EmitDefaultValue = false)]
        public string CollectorInvoiceSettlementReference { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionCollectorAllOfMetadata1 {\n");
            sb.Append("  CollectorStoreId: ").Append(CollectorStoreId).Append("\n");
            sb.Append("  CollectorInvoiceInvoiceNumber: ").Append(CollectorInvoiceInvoiceNumber).Append("\n");
            sb.Append("  CollectorInvoiceOrderNumber: ").Append(CollectorInvoiceOrderNumber).Append("\n");
            sb.Append("  CollectorInvoiceCountryCode: ").Append(CollectorInvoiceCountryCode).Append("\n");
            sb.Append("  CollectorInvoiceProductCode: ").Append(CollectorInvoiceProductCode).Append("\n");
            sb.Append("  CollectorInvoiceInvoiceType: ").Append(CollectorInvoiceInvoiceType).Append("\n");
            sb.Append("  CollectorInvoiceSettlementReference: ").Append(CollectorInvoiceSettlementReference).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TransactionCollectorAllOfMetadata1);
        }

        /// <summary>
        /// Returns true if TransactionCollectorAllOfMetadata1 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionCollectorAllOfMetadata1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionCollectorAllOfMetadata1 input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.CollectorStoreId == input.CollectorStoreId ||
                    (this.CollectorStoreId != null &&
                    this.CollectorStoreId.Equals(input.CollectorStoreId))
                ) && 
                (
                    this.CollectorInvoiceInvoiceNumber == input.CollectorInvoiceInvoiceNumber ||
                    (this.CollectorInvoiceInvoiceNumber != null &&
                    this.CollectorInvoiceInvoiceNumber.Equals(input.CollectorInvoiceInvoiceNumber))
                ) && 
                (
                    this.CollectorInvoiceOrderNumber == input.CollectorInvoiceOrderNumber ||
                    (this.CollectorInvoiceOrderNumber != null &&
                    this.CollectorInvoiceOrderNumber.Equals(input.CollectorInvoiceOrderNumber))
                ) && 
                (
                    this.CollectorInvoiceCountryCode == input.CollectorInvoiceCountryCode ||
                    (this.CollectorInvoiceCountryCode != null &&
                    this.CollectorInvoiceCountryCode.Equals(input.CollectorInvoiceCountryCode))
                ) && 
                (
                    this.CollectorInvoiceProductCode == input.CollectorInvoiceProductCode ||
                    (this.CollectorInvoiceProductCode != null &&
                    this.CollectorInvoiceProductCode.Equals(input.CollectorInvoiceProductCode))
                ) && 
                (
                    this.CollectorInvoiceInvoiceType == input.CollectorInvoiceInvoiceType ||
                    (this.CollectorInvoiceInvoiceType != null &&
                    this.CollectorInvoiceInvoiceType.Equals(input.CollectorInvoiceInvoiceType))
                ) && 
                (
                    this.CollectorInvoiceSettlementReference == input.CollectorInvoiceSettlementReference ||
                    (this.CollectorInvoiceSettlementReference != null &&
                    this.CollectorInvoiceSettlementReference.Equals(input.CollectorInvoiceSettlementReference))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.CollectorStoreId != null)
                    hashCode = hashCode * 59 + this.CollectorStoreId.GetHashCode();
                if (this.CollectorInvoiceInvoiceNumber != null)
                    hashCode = hashCode * 59 + this.CollectorInvoiceInvoiceNumber.GetHashCode();
                if (this.CollectorInvoiceOrderNumber != null)
                    hashCode = hashCode * 59 + this.CollectorInvoiceOrderNumber.GetHashCode();
                if (this.CollectorInvoiceCountryCode != null)
                    hashCode = hashCode * 59 + this.CollectorInvoiceCountryCode.GetHashCode();
                if (this.CollectorInvoiceProductCode != null)
                    hashCode = hashCode * 59 + this.CollectorInvoiceProductCode.GetHashCode();
                if (this.CollectorInvoiceInvoiceType != null)
                    hashCode = hashCode * 59 + this.CollectorInvoiceInvoiceType.GetHashCode();
                if (this.CollectorInvoiceSettlementReference != null)
                    hashCode = hashCode * 59 + this.CollectorInvoiceSettlementReference.GetHashCode();
                return hashCode;
            }
        }
