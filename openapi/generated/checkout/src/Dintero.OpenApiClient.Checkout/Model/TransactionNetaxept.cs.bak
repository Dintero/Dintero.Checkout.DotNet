...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// TransactionNetaxept
    /// </summary>
    [DataContract(Name = "TransactionNetaxept")]
    [JsonConverter(typeof(JsonSubtypes), "PaymentProduct")]
    public partial class TransactionNetaxept : Transaction, IEquatable<TransactionNetaxept>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionNetaxept" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionNetaxept() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionNetaxept" /> class.
        /// </summary>
        ...
        /// <param name="paymentProduct">The payment product corresponding to this transaction  (required) (default to &quot;TransactionNetaxept&quot;).</param>
        ...
        public TransactionNetaxept(string id = default(string), DateTime createdAt = default(DateTime), PaymentProductTypeEnum paymentProductType = default(PaymentProductTypeEnum), TransactionNetaxeptAllOfCard card = default(TransactionNetaxeptAllOfCard), List<TransactionNetaxeptAllOfEvents> events = default(List<TransactionNetaxeptAllOfEvents>), TransactionNetaxeptAllOfMetadata1 metadata = default(TransactionNetaxeptAllOfMetadata1), string paymentProduct = "TransactionNetaxept", int amount = default(int), string currency = default(string), string merchantReference = default(string), string merchantReference2 = default(string), string dynamicDescriptor = default(string), SettlementStatus? settlementStatus = default(SettlementStatus?), TransactionCustomer customer = default(TransactionCustomer), string customerIp = default(string), string userAgent = default(string), OrderAddress shippingAddress = default(OrderAddress), ShippingOption shippingOption = default(ShippingOption), OrderAddress billingAddress = default(OrderAddress), Store store = default(Store), List<OrderItem> items = default(List<OrderItem>), TransactionUrl url = default(TransactionUrl), string sessionId = default(string), Session session = default(Session), DateTime updatedAt = default(DateTime)) : base(paymentProduct, amount, currency, merchantReference, merchantReference2, dynamicDescriptor, settlementStatus, customer, customerIp, userAgent, shippingAddress, shippingOption, billingAddress, store, items, url, sessionId, session, updatedAt)
        {
        ...
        public TransactionNetaxeptAllOfCard Card { get; set; }

        /// <summary>
        /// Gets or Sets Events
        /// </summary>
        [DataMember(Name = "events", EmitDefaultValue = false)]
        public List<TransactionNetaxeptAllOfEvents> Events { get; set; }

        /// <summary>
        /// Gets or Sets Metadata
        /// </summary>
        [DataMember(Name = "metadata", EmitDefaultValue = false)]
        public TransactionNetaxeptAllOfMetadata1 Metadata { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionNetaxept {\n");
        ...
        {
            return this.Equals(input as TransactionNetaxept);
        }

        /// <summary>
        /// Returns true if TransactionNetaxept instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionNetaxept to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionNetaxept input)
        {
            if (input == null)
                return false;
