...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NetaxeptGwStoreOverride")]
    public partial class NetaxeptGwStoreOverride : IEquatable<NetaxeptGwStoreOverride>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NetaxeptGwStoreOverride" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NetaxeptGwStoreOverride() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NetaxeptGwStoreOverride" /> class.
        /// </summary>
        /// <param name="url">The base URIs of the eCommerce APIs:  - **test**: https://test.epayment.nets.eu - **prod**: https://epayment.nets.eu  (required).</param>
        /// <param name="merchantId">Unique id that identifies the merchant  (required).</param>
        /// <param name="token">token (required).</param>
        public NetaxeptGwStoreOverride(string url = default(string), string merchantId = default(string), string token = default(string))
        {
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url is a required property for NetaxeptGwStoreOverride and cannot be null");
            // to ensure "merchantId" is required (not null)
            this.MerchantId = merchantId ?? throw new ArgumentNullException("merchantId is a required property for NetaxeptGwStoreOverride and cannot be null");
            // to ensure "token" is required (not null)
            this.Token = token ?? throw new ArgumentNullException("token is a required property for NetaxeptGwStoreOverride and cannot be null");
        }
        ...
        /// <summary>
        /// The base URIs of the eCommerce APIs:  - **test**: https://test.epayment.nets.eu - **prod**: https://epayment.nets.eu 
        /// </summary>
        /// <value>The base URIs of the eCommerce APIs:  - **test**: https://test.epayment.nets.eu - **prod**: https://epayment.nets.eu </value>
        ...
        /// </summary>
        /// <value>Unique id that identifies the merchant </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NetaxeptGwStoreOverride {\n");
        ...
        {
            return this.Equals(input as NetaxeptGwStoreOverride);
        }

        /// <summary>
        /// Returns true if NetaxeptGwStoreOverride instances are equal
        /// </summary>
        /// <param name="input">Instance of NetaxeptGwStoreOverride to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NetaxeptGwStoreOverride input)
        {
            if (input == null)
                return false;
