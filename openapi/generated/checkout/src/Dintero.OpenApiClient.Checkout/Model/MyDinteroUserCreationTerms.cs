...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MyDinteroUserCreation_terms")]
    public partial class MyDinteroUserCreationTerms : IEquatable<MyDinteroUserCreationTerms>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MyDinteroUserCreationTerms" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MyDinteroUserCreationTerms() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MyDinteroUserCreationTerms" /> class.
        /// </summary>
        /// <param name="id">id of the myDintero terms and conditions  (required).</param>
        /// <param name="url">Url to the terms and conditions accepted by the customer  (required).</param>
        public MyDinteroUserCreationTerms(Guid id = default(Guid), string url = default(string))
        {
            this.Id = id;
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url is a required property for MyDinteroUserCreationTerms and cannot be null");
        }

        /// <summary>
        /// id of the myDintero terms and conditions 
        /// </summary>
        /// <value>id of the myDintero terms and conditions </value>
        ...
        /// </summary>
        /// <value>Url to the terms and conditions accepted by the customer </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MyDinteroUserCreationTerms {\n");
        ...
        {
            return this.Equals(input as MyDinteroUserCreationTerms);
        }

        /// <summary>
        /// Returns true if MyDinteroUserCreationTerms instances are equal
        /// </summary>
        /// <param name="input">Instance of MyDinteroUserCreationTerms to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MyDinteroUserCreationTerms input)
        {
            if (input == null)
                return false;
        ...
        {
            // Url (string) pattern
            Regex regexUrl = new Regex(@"https?:\/\/_*", RegexOptions.CultureInvariant);
