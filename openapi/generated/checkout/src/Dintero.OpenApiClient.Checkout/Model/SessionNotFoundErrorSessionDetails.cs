...
{
    /// <summary>
    /// SessionNotFoundErrorSessionDetails
    /// </summary>
    [DataContract(Name = "SessionNotFound_error_session_details")]
    public partial class SessionNotFoundErrorSessionDetails : IEquatable<SessionNotFoundErrorSessionDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionNotFoundErrorSessionDetails" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SessionNotFoundErrorSessionDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionNotFoundErrorSessionDetails" /> class.
        /// </summary>
        ...
        /// <param name="returnUrl">URL to page where Checkout will redirect the customer to after the Checkout process has ended. (required).</param>
        /// <param name="merchant">merchant.</param>
        public SessionNotFoundErrorSessionDetails(string merchantReference = default(string), string transactionId = default(string), string returnUrl = default(string), SessionNotFoundErrorSessionDetailsMerchant merchant = default(SessionNotFoundErrorSessionDetailsMerchant))
        {
            // to ensure "merchantReference" is required (not null)
            this.MerchantReference = merchantReference ?? throw new ArgumentNullException("merchantReference is a required property for SessionNotFoundErrorSessionDetails and cannot be null");
            // to ensure "returnUrl" is required (not null)
            this.ReturnUrl = returnUrl ?? throw new ArgumentNullException("returnUrl is a required property for SessionNotFoundErrorSessionDetails and cannot be null");
        ...
        /// <summary>
        /// URL to page where Checkout will redirect the customer to after the Checkout process has ended.
        /// </summary>
        /// <value>URL to page where Checkout will redirect the customer to after the Checkout process has ended.</value>
        ...
        public SessionNotFoundErrorSessionDetailsMerchant Merchant { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SessionNotFoundErrorSessionDetails {\n");
        ...
        {
            return this.Equals(input as SessionNotFoundErrorSessionDetails);
        }

        /// <summary>
        /// Returns true if SessionNotFoundErrorSessionDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of SessionNotFoundErrorSessionDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SessionNotFoundErrorSessionDetails input)
        {
            if (input == null)
                return false;
