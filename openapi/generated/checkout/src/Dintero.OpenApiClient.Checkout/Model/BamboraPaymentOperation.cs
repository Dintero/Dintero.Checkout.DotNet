...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BamboraPaymentOperation")]
    [JsonConverter(typeof(JsonSubtypes), "Rel")]
    public partial class BamboraPaymentOperation : PaymentOperation, IEquatable<BamboraPaymentOperation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraPaymentOperation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BamboraPaymentOperation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraPaymentOperation" /> class.
        /// </summary>
        /// <param name="session">session (required).</param>
        /// <param name="href">Contains the URI to initiate a payment.  (required).</param>
        /// <param name="contentType">contentType.</param>
        /// <param name="method">The HTTP method to use when performing the operation .</param>
        /// <param name="rel">rel (required) (default to &quot;BamboraPaymentOperation&quot;).</param>
        public BamboraPaymentOperation(BamboraPaymentOperationAllOfSession session = default(BamboraPaymentOperationAllOfSession), string href = default(string), ContentTypeEnum? contentType = default(ContentTypeEnum?), MethodEnum? method = default(MethodEnum?), string rel = "BamboraPaymentOperation") : base(contentType, method, rel)
        {
            // to ensure "session" is required (not null)
            this.Session = session ?? throw new ArgumentNullException("session is a required property for BamboraPaymentOperation and cannot be null");
            // to ensure "href" is required (not null)
            this.Href = href ?? throw new ArgumentNullException("href is a required property for BamboraPaymentOperation and cannot be null");
        }
        ...
        public BamboraPaymentOperationAllOfSession Session { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BamboraPaymentOperation {\n");
        ...
        {
            return this.Equals(input as BamboraPaymentOperation);
        }

        /// <summary>
        /// Returns true if BamboraPaymentOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of BamboraPaymentOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BamboraPaymentOperation input)
        {
            if (input == null)
                return false;
