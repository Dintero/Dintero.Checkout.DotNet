...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class PaymentConfiguration : IEquatable<PaymentConfiguration>, IValidatableObject
    {
        ...
        /// <summary>
        /// Configure the default payment type, the selected payment when loading the checkout window. The value must be an enabled payment type. 
        /// </summary>
        /// <value>Configure the default payment type, the selected payment when loading the checkout window. The value must be an enabled payment type. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum DefaultPaymentTypeEnum
        {
            /// <summary>
            /// Enum BamboraCreditcard for value: bambora.creditcard
            /// </summary>
            [EnumMember(Value = "bambora.creditcard")]
            BamboraCreditcard = 1,

            /// <summary>
            /// Enum BamboraVipps for value: bambora.vipps
            /// </summary>
            [EnumMember(Value = "bambora.vipps")]
            BamboraVipps = 2,

            /// <summary>
            /// Enum InstabankFinance for value: instabank.finance
            /// </summary>
            [EnumMember(Value = "instabank.finance")]
            InstabankFinance = 3,

            /// <summary>
            /// Enum InstabankInvoice for value: instabank.invoice
            /// </summary>
            [EnumMember(Value = "instabank.invoice")]
            InstabankInvoice = 4,

            /// <summary>
            /// Enum InstabankInstallment for value: instabank.installment
            /// </summary>
            [EnumMember(Value = "instabank.installment")]
            InstabankInstallment = 5,

            /// <summary>
            /// Enum InstabankPostponement for value: instabank.postponement
            /// </summary>
            [EnumMember(Value = "instabank.postponement")]
            InstabankPostponement = 6,
            ...
            /// <summary>
            /// Enum PayexCreditcard for value: payex.creditcard
            /// </summary>
            [EnumMember(Value = "payex.creditcard")]
            PayexCreditcard = 8,

            /// <summary>
            /// Enum PayexSwish for value: payex.swish
            /// </summary>
            [EnumMember(Value = "payex.swish")]
            PayexSwish = 9,

            /// <summary>
            /// Enum CollectorFinance for value: collector.finance
            /// </summary>
            [EnumMember(Value = "collector.finance")]
            CollectorFinance = 10,

            /// <summary>
            /// Enum CollectorInvoice for value: collector.invoice
            /// </summary>
            [EnumMember(Value = "collector.invoice")]
            CollectorInvoice = 11,

            /// <summary>
            /// Enum CollectorInvoiceB2b for value: collector.invoice_b2b
            /// </summary>
            [EnumMember(Value = "collector.invoice_b2b")]
            CollectorInvoiceB2b = 12,

            /// <summary>
            /// Enum CollectorInvoiceB2bPreapproved for value: collector.invoice_b2b_preapproved
            /// </summary>
            [EnumMember(Value = "collector.invoice_b2b_preapproved")]
            CollectorInvoiceB2bPreapproved = 13,

            /// <summary>
            /// Enum CollectorInstallmentB2bPreapproved for value: collector.installment_b2b_preapproved
            /// </summary>
            [EnumMember(Value = "collector.installment_b2b_preapproved")]
            CollectorInstallmentB2bPreapproved = 14,

            /// <summary>
            /// Enum CollectorInstallment for value: collector.installment
            /// </summary>
            [EnumMember(Value = "collector.installment")]
            CollectorInstallment = 15,

            /// <summary>
            /// Enum SantanderDebitAccount for value: santander.debit_account
            /// </summary>
            [EnumMember(Value = "santander.debit_account")]
            SantanderDebitAccount = 16,

            /// <summary>
            /// Enum IngenicoCreditcard for value: ingenico.creditcard
            /// </summary>
            [EnumMember(Value = "ingenico.creditcard")]
            IngenicoCreditcard = 17,

            /// <summary>
            /// Enum SwishSwish for value: swish.swish
            /// </summary>
            [EnumMember(Value = "swish.swish")]
            SwishSwish = 18,

            /// <summary>
            /// Enum NetaxeptCreditcard for value: netaxept.creditcard
            /// </summary>
            [EnumMember(Value = "netaxept.creditcard")]
            NetaxeptCreditcard = 19
        ...
        /// </summary>
        /// <value>Configure the default payment type, the selected payment when loading the checkout window. The value must be an enabled payment type. </value>
        [DataMember(Name = "default_payment_type", EmitDefaultValue = false)]
        public DefaultPaymentTypeEnum? DefaultPaymentType { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentConfiguration" /> class.
        /// </summary>
        /// <param name="autoCapture">If &#x60;true&#x60; the transaction from the payment session will be captured automatically after the transaction has been &#x60;AUTHORIZED&#x60;. The checkout sessions &#x60;callback_url&#x60; will not be called until after the transaction has been &#x60;CAPTURED&#x60;.  If &#x60;auto_capture&#x60; is not specified it defaults to &#x60;false&#x60;.  A successful auto-capture of a transaction sometimes requires more than one capture attempt. This can be the case if the payment gateway is down or is experiencing heavy traffic.  Dintero will attempts capture retries for 48 hours, the &#x60;callback_url&#x60; will be invoked when capture succeeds.  Manual capture of a transaction that is pending auto-capture will stop the auto-capture process from completing the capture. .</param>
        /// <param name="channel">### in_app  The &#x60;in_app&#x60; channel is intended for payments done from mobile devices where &#x60;url.return_url&#x60; can be set to the application&#39;s appswitch URL.  #### Session deeplink URL  The session URL will be an appswitch deeplink URL to the payment application if the session enables a single payment option that supports appswitch deeplink payments (Vipps)  &gt; &#x60;in_app&#x60; is currently not supported when express is enabled  &gt; &#x60;in_app&#x60; with deeplink URL is not supported if &#x60;publish&#x60; is enabled  ### in_store  The &#x60;in_store&#x60; channel is intended for payments done in physical stores.  Depending on the payment_type, choosing &#x60;in_store&#x60; will change the behaviour of the payment. .</param>
        /// <param name="publish">Publish checkout message to the customer. .</param>
        /// <param name="defaultPaymentType">Configure the default payment type, the selected payment when loading the checkout window. The value must be an enabled payment type. .</param>
        /// <param name="bambora">bambora.</param>
        /// <param name="ingenico">ingenico.</param>
        /// <param name="instabank">instabank.</param>
        /// <param name="netaxept">netaxept.</param>
        /// <param name="payex">payex.</param>
        /// <param name="vipps">vipps.</param>
        /// <param name="collector">collector.</param>
        /// <param name="santander">santander.</param>
        /// <param name="swish">swish.</param>
        public PaymentConfiguration(bool autoCapture = default(bool), ChannelEnum? channel = default(ChannelEnum?), List<Object> publish = default(List<Object>), DefaultPaymentTypeEnum? defaultPaymentType = default(DefaultPaymentTypeEnum?), BamboraConfiguration bambora = default(BamboraConfiguration), IngenicoConfiguration ingenico = default(IngenicoConfiguration), InstabankConfiguration instabank = default(InstabankConfiguration), NetaxeptConfiguration netaxept = default(NetaxeptConfiguration), PayExConfiguration payex = default(PayExConfiguration), VippsConfiguration vipps = default(VippsConfiguration), CollectorConfiguration collector = default(CollectorConfiguration), SantanderConfiguration santander = default(SantanderConfiguration), SwishConfiguration swish = default(SwishConfiguration))
        {
            ...
            this.Instabank = instabank;
            this.Netaxept = netaxept;
            this.Payex = payex;
            this.Vipps = vipps;
        ...
        /// </summary>
        /// <value>If &#x60;true&#x60; the transaction from the payment session will be captured automatically after the transaction has been &#x60;AUTHORIZED&#x60;. The checkout sessions &#x60;callback_url&#x60; will not be called until after the transaction has been &#x60;CAPTURED&#x60;.  If &#x60;auto_capture&#x60; is not specified it defaults to &#x60;false&#x60;.  A successful auto-capture of a transaction sometimes requires more than one capture attempt. This can be the case if the payment gateway is down or is experiencing heavy traffic.  Dintero will attempts capture retries for 48 hours, the &#x60;callback_url&#x60; will be invoked when capture succeeds.  Manual capture of a transaction that is pending auto-capture will stop the auto-capture process from completing the capture. </value>
        [DataMember(Name = "auto_capture", EmitDefaultValue = true)]
        public bool AutoCapture { get; set; }

        /// <summary>
        /// Publish checkout message to the customer. 
        /// </summary>
        /// <value>Publish checkout message to the customer. </value>
        [DataMember(Name = "publish", EmitDefaultValue = false)]
        public List<Object> Publish { get; set; }

        /// <summary>
        /// Gets or Sets Bambora
        /// </summary>
        [DataMember(Name = "bambora", EmitDefaultValue = false)]
        public BamboraConfiguration Bambora { get; set; }

        /// <summary>
        /// Gets or Sets Ingenico
        /// </summary>
        [DataMember(Name = "ingenico", EmitDefaultValue = false)]
        public IngenicoConfiguration Ingenico { get; set; }

        /// <summary>
        /// Gets or Sets Instabank
        /// </summary>
        [DataMember(Name = "instabank", EmitDefaultValue = false)]
        public InstabankConfiguration Instabank { get; set; }

        /// <summary>
        /// Gets or Sets Netaxept
        /// </summary>
        [DataMember(Name = "netaxept", EmitDefaultValue = false)]
        public NetaxeptConfiguration Netaxept { get; set; }

        /// <summary>
        /// Gets or Sets Payex
        /// </summary>
        [DataMember(Name = "payex", EmitDefaultValue = false)]
        public PayExConfiguration Payex { get; set; }

        /// <summary>
        /// Gets or Sets Vipps
        /// </summary>
        [DataMember(Name = "vipps", EmitDefaultValue = false)]
        public VippsConfiguration Vipps { get; set; }
        ...
        /// <summary>
        /// Gets or Sets Santander
        /// </summary>
        [DataMember(Name = "santander", EmitDefaultValue = false)]
        public SantanderConfiguration Santander { get; set; }

        /// <summary>
        /// Gets or Sets Swish
        /// </summary>
        [DataMember(Name = "swish", EmitDefaultValue = false)]
        public SwishConfiguration Swish { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Ingenico: ").Append(Ingenico).Append("\n");
            sb.Append("  Instabank: ").Append(Instabank).Append("\n");
            sb.Append("  Netaxept: ").Append(Netaxept).Append("\n");
            sb.Append("  Payex: ").Append(Payex).Append("\n");
            sb.Append("  Vipps: ").Append(Vipps).Append("\n");
            sb.Append("  Collector: ").Append(Collector).Append("\n");
            sb.Append("  Santander: ").Append(Santander).Append("\n");
        ...
        {
            return this.Equals(input as PaymentConfiguration);
        }

        /// <summary>
        /// Returns true if PaymentConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentConfiguration input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.Publish != null &&
                    input.Publish != null &&
                    this.Publish.SequenceEqual(input.Publish)
                ) && 
                (
                ...
                (
                    this.Ingenico == input.Ingenico ||
                    (this.Ingenico != null &&
                    this.Ingenico.Equals(input.Ingenico))
                ) && 
                (
                    this.Instabank == input.Instabank ||
                    (this.Instabank != null &&
                    this.Instabank.Equals(input.Instabank))
                ) && 
                (
                    this.Netaxept == input.Netaxept ||
                    (this.Netaxept != null &&
                    this.Netaxept.Equals(input.Netaxept))
                ) && 
                (
                    this.Payex == input.Payex ||
                    (this.Payex != null &&
                    this.Payex.Equals(input.Payex))
                ) && 
                (
                ...
                (
                    this.Santander == input.Santander ||
                    (this.Santander != null &&
                    this.Santander.Equals(input.Santander))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Ingenico != null)
                    hashCode = hashCode * 59 + this.Ingenico.GetHashCode();
                if (this.Instabank != null)
                    hashCode = hashCode * 59 + this.Instabank.GetHashCode();
                if (this.Netaxept != null)
                    hashCode = hashCode * 59 + this.Netaxept.GetHashCode();
                if (this.Payex != null)
                    hashCode = hashCode * 59 + this.Payex.GetHashCode();
                if (this.Vipps != null)
                    hashCode = hashCode * 59 + this.Vipps.GetHashCode();
                if (this.Collector != null)
                    hashCode = hashCode * 59 + this.Collector.GetHashCode();
                if (this.Santander != null)
                    hashCode = hashCode * 59 + this.Santander.GetHashCode();
                if (this.Swish != null)
