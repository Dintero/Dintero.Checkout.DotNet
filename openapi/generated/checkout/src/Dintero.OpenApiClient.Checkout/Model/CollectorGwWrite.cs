...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// CollectorGwWrite
    /// </summary>
    [DataContract(Name = "CollectorGwWrite")]
    public partial class CollectorGwWrite : IEquatable<CollectorGwWrite>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorGwWrite" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorGwWrite() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorGwWrite" /> class.
        /// </summary>
        ...
        public CollectorGwWrite(string url = default(string), string username = default(string), decimal storeId = default(decimal), string country = default(string), CollectorGwStoreOverrideWriteAllOfOptions options = default(CollectorGwStoreOverrideWriteAllOfOptions), List<CollectorGwReadStores> stores = default(List<CollectorGwReadStores>), string password = default(string))
        {
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url is a required property for CollectorGwWrite and cannot be null");
            // to ensure "username" is required (not null)
            this.Username = username ?? throw new ArgumentNullException("username is a required property for CollectorGwWrite and cannot be null");
            this.StoreId = storeId;
            // to ensure "country" is required (not null)
            this.Country = country ?? throw new ArgumentNullException("country is a required property for CollectorGwWrite and cannot be null");
            // to ensure "password" is required (not null)
            this.Password = password ?? throw new ArgumentNullException("password is a required property for CollectorGwWrite and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorGwWrite {\n");
        ...
        {
            return this.Equals(input as CollectorGwWrite);
        }

        /// <summary>
        /// Returns true if CollectorGwWrite instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorGwWrite to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorGwWrite input)
        {
            if (input == null)
                return false;
