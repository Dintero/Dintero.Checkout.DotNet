...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CheckoutConfigWrite_configuration")]
    public partial class CheckoutConfigWriteConfiguration : IEquatable<CheckoutConfigWriteConfiguration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckoutConfigWriteConfiguration" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CheckoutConfigWriteConfiguration() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckoutConfigWriteConfiguration" /> class.
        /// </summary>
        /// <param name="paymentOptions">Payment options enabled for the account, the payment option currencies set must be unique given the &#x60;type&#x60;  (required).</param>
        /// <param name="merchant">merchant (required).</param>
        public CheckoutConfigWriteConfiguration(List<CheckoutConfigWriteConfigurationPaymentOptions> paymentOptions = default(List<CheckoutConfigWriteConfigurationPaymentOptions>), CheckoutConfigWriteConfigurationMerchant merchant = default(CheckoutConfigWriteConfigurationMerchant))
        {
            // to ensure "paymentOptions" is required (not null)
            this.PaymentOptions = paymentOptions ?? throw new ArgumentNullException("paymentOptions is a required property for CheckoutConfigWriteConfiguration and cannot be null");
            // to ensure "merchant" is required (not null)
            this.Merchant = merchant ?? throw new ArgumentNullException("merchant is a required property for CheckoutConfigWriteConfiguration and cannot be null");
        }

        /// <summary>
        /// Payment options enabled for the account, the payment option currencies set must be unique given the &#x60;type&#x60; 
        /// </summary>
        /// <value>Payment options enabled for the account, the payment option currencies set must be unique given the &#x60;type&#x60; </value>
        [DataMember(Name = "payment_options", IsRequired = true, EmitDefaultValue = false)]
        public List<CheckoutConfigWriteConfigurationPaymentOptions> PaymentOptions { get; set; }

        /// <summary>
        /// Gets or Sets Merchant
        /// </summary>
        [DataMember(Name = "merchant", IsRequired = true, EmitDefaultValue = false)]
        public CheckoutConfigWriteConfigurationMerchant Merchant { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CheckoutConfigWriteConfiguration {\n");
        ...
        {
            return this.Equals(input as CheckoutConfigWriteConfiguration);
        }

        /// <summary>
        /// Returns true if CheckoutConfigWriteConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of CheckoutConfigWriteConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CheckoutConfigWriteConfiguration input)
        {
            if (input == null)
                return false;
