...
{
    /// <summary>
    /// SessionMetaDetailsIngenico
    /// </summary>
    [DataContract(Name = "SessionMeta_details_ingenico")]
    public partial class SessionMetaDetailsIngenico : IEquatable<SessionMetaDetailsIngenico>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionMetaDetailsIngenico" /> class.
        /// </summary>
        /// <param name="hostedCheckoutId">hostedCheckoutId.</param>
        /// <param name="returnMac">returnMac.</param>
        /// <param name="partialRedirectUrl">partialRedirectUrl.</param>
        public SessionMetaDetailsIngenico(string hostedCheckoutId = default(string), string returnMac = default(string), string partialRedirectUrl = default(string))
        {
        ...
        /// </summary>
        [DataMember(Name = "hosted_checkout_id", EmitDefaultValue = false)]
        public string HostedCheckoutId { get; set; }

        /// <summary>
        /// Gets or Sets ReturnMac
        /// </summary>
        [DataMember(Name = "return_mac", EmitDefaultValue = false)]
        public string ReturnMac { get; set; }

        /// <summary>
        /// Gets or Sets PartialRedirectUrl
        /// </summary>
        [DataMember(Name = "partial_redirect_url", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SessionMetaDetailsIngenico {\n");
        ...
        {
            return this.Equals(input as SessionMetaDetailsIngenico);
        }

        /// <summary>
        /// Returns true if SessionMetaDetailsIngenico instances are equal
        /// </summary>
        /// <param name="input">Instance of SessionMetaDetailsIngenico to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SessionMetaDetailsIngenico input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.HostedCheckoutId == input.HostedCheckoutId ||
                    (this.HostedCheckoutId != null &&
                    this.HostedCheckoutId.Equals(input.HostedCheckoutId))
                ) && 
                (
                    this.ReturnMac == input.ReturnMac ||
                    (this.ReturnMac != null &&
                    this.ReturnMac.Equals(input.ReturnMac))
                ) && 
                (
                    this.PartialRedirectUrl == input.PartialRedirectUrl ||
                    (this.PartialRedirectUrl != null &&
                    this.PartialRedirectUrl.Equals(input.PartialRedirectUrl))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HostedCheckoutId != null)
                    hashCode = hashCode * 59 + this.HostedCheckoutId.GetHashCode();
                if (this.ReturnMac != null)
                    hashCode = hashCode * 59 + this.ReturnMac.GetHashCode();
                if (this.PartialRedirectUrl != null)
                    hashCode = hashCode * 59 + this.PartialRedirectUrl.GetHashCode();
                return hashCode;
            }
        }
