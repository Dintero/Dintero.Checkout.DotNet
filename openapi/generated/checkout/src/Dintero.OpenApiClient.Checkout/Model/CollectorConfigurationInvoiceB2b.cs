...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CollectorConfiguration_invoice_b2b")]
    public partial class CollectorConfigurationInvoiceB2b : IEquatable<CollectorConfigurationInvoiceB2b>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorConfigurationInvoiceB2b" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorConfigurationInvoiceB2b() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorConfigurationInvoiceB2b" /> class.
        /// </summary>
        ...
        public CollectorConfigurationInvoiceB2b(TypeEnum? type = TypeEnum.PaymentProductType, SessionPayability? payability = default(SessionPayability?), bool enabled = default(bool), List<string> countries = default(List<string>), CollectorConfigurationInvoiceB2bOptions options = default(CollectorConfigurationInvoiceB2bOptions))
        {
        ...
        public CollectorConfigurationInvoiceB2bOptions Options { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorConfigurationInvoiceB2b {\n");
        ...
        {
            return this.Equals(input as CollectorConfigurationInvoiceB2b);
        }

        /// <summary>
        /// Returns true if CollectorConfigurationInvoiceB2b instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorConfigurationInvoiceB2b to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorConfigurationInvoiceB2b input)
        {
            if (input == null)
                return false;
