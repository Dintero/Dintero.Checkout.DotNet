...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InstabankFinanceProduct")]
    public partial class InstabankFinanceProduct : IEquatable<InstabankFinanceProduct>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankFinanceProduct" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstabankFinanceProduct() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankFinanceProduct" /> class.
        /// </summary>
        /// <param name="productCode">productCode (required).</param>
        /// <param name="minimumMonthlyBalanceRate">The minimum monthly installment basis as a percentage of the account balance.  (required).</param>
        /// <param name="annualInterestRate">The interest rate for the payment product. .</param>
        ...
        /// <param name="loanExample">loanExample (required).</param>
        /// <param name="brandingImageUrl">Url for a custom branding image.</param>
        public InstabankFinanceProduct(string productCode = default(string), string minimumMonthlyBalanceRate = default(string), string annualInterestRate = default(string), int originationFee = default(int), int notificationFee = default(int), int minimumAmount = default(int), InstabankFinanceProductLoanExample loanExample = default(InstabankFinanceProductLoanExample), string brandingImageUrl = default(string))
        {
            // to ensure "productCode" is required (not null)
            this.ProductCode = productCode ?? throw new ArgumentNullException("productCode is a required property for InstabankFinanceProduct and cannot be null");
            // to ensure "minimumMonthlyBalanceRate" is required (not null)
            this.MinimumMonthlyBalanceRate = minimumMonthlyBalanceRate ?? throw new ArgumentNullException("minimumMonthlyBalanceRate is a required property for InstabankFinanceProduct and cannot be null");
            this.OriginationFee = originationFee;
            this.NotificationFee = notificationFee;
            // to ensure "loanExample" is required (not null)
            this.LoanExample = loanExample ?? throw new ArgumentNullException("loanExample is a required property for InstabankFinanceProduct and cannot be null");
        ...
        /// </summary>
        /// <value>The minimum monthly installment basis as a percentage of the account balance. </value>
        [DataMember(Name = "minimum_monthly_balance_rate", IsRequired = true, EmitDefaultValue = false)]
        public string MinimumMonthlyBalanceRate { get; set; }

        /// <summary>
        /// The interest rate for the payment product. 
        /// </summary>
        /// <value>The interest rate for the payment product. </value>
        [DataMember(Name = "annual_interest_rate", EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "loan_example", IsRequired = true, EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstabankFinanceProduct {\n");
            sb.Append("  ProductCode: ").Append(ProductCode).Append("\n");
            sb.Append("  MinimumMonthlyBalanceRate: ").Append(MinimumMonthlyBalanceRate).Append("\n");
        ...
        {
            return this.Equals(input as InstabankFinanceProduct);
        }

        /// <summary>
        /// Returns true if InstabankFinanceProduct instances are equal
        /// </summary>
        /// <param name="input">Instance of InstabankFinanceProduct to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstabankFinanceProduct input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.MinimumMonthlyBalanceRate == input.MinimumMonthlyBalanceRate ||
                    (this.MinimumMonthlyBalanceRate != null &&
                    this.MinimumMonthlyBalanceRate.Equals(input.MinimumMonthlyBalanceRate))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MinimumMonthlyBalanceRate != null)
                    hashCode = hashCode * 59 + this.MinimumMonthlyBalanceRate.GetHashCode();
