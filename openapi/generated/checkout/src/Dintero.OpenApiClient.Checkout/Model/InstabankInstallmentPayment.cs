...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InstabankInstallmentPayment")]
    [JsonConverter(typeof(JsonSubtypes), "PaymentProductType")]
    public partial class InstabankInstallmentPayment : Payment, IEquatable<InstabankInstallmentPayment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankInstallmentPayment" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstabankInstallmentPayment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankInstallmentPayment" /> class.
        /// </summary>
        ...
        /// <param name="paymentProductType">The payment product type corresponding to this transaction  (required) (default to &quot;InstabankInstallmentPayment&quot;).</param>
        ...
        public InstabankInstallmentPayment(string email = default(string), string socialSecurityNumber = default(string), string phoneNumber = default(string), int totalIncome = default(int), string paymentProductType = "InstabankInstallmentPayment", string productCode = default(string), InstabankApplication applicant = default(InstabankApplication), bool rememberMe = default(bool)) : base()
        {
            // to ensure "email" is required (not null)
            this.Email = email ?? throw new ArgumentNullException("email is a required property for InstabankInstallmentPayment and cannot be null");
            // to ensure "socialSecurityNumber" is required (not null)
            this.SocialSecurityNumber = socialSecurityNumber ?? throw new ArgumentNullException("socialSecurityNumber is a required property for InstabankInstallmentPayment and cannot be null");
            // to ensure "phoneNumber" is required (not null)
            this.PhoneNumber = phoneNumber ?? throw new ArgumentNullException("phoneNumber is a required property for InstabankInstallmentPayment and cannot be null");
            this.TotalIncome = totalIncome;
            // to ensure "paymentProductType" is required (not null)
            this.PaymentProductType = paymentProductType ?? throw new ArgumentNullException("paymentProductType is a required property for InstabankInstallmentPayment and cannot be null");
            // to ensure "productCode" is required (not null)
            this.ProductCode = productCode ?? throw new ArgumentNullException("productCode is a required property for InstabankInstallmentPayment and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstabankInstallmentPayment {\n");
        ...
        {
            return this.Equals(input as InstabankInstallmentPayment);
        }

        /// <summary>
        /// Returns true if InstabankInstallmentPayment instances are equal
        /// </summary>
        /// <param name="input">Instance of InstabankInstallmentPayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstabankInstallmentPayment input)
        {
            if (input == null)
                return false;
