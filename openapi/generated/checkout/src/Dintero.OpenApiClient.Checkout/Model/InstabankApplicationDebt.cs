...
{
    /// <summary>
    /// InstabankApplicationDebt
    /// </summary>
    [DataContract(Name = "InstabankApplication_debt")]
    public partial class InstabankApplicationDebt : IEquatable<InstabankApplicationDebt>, IValidatableObject
    {
        /// <summary>
        /// Defines DebtType
        /// </summary>
        ...
        {
            /// <summary>
            /// Enum MortgageDebt for value: mortgage_debt
            /// </summary>
            [EnumMember(Value = "mortgage_debt")]
            MortgageDebt = 1,

            /// <summary>
            /// Enum StudentDebt for value: student_debt
            /// </summary>
            [EnumMember(Value = "student_debt")]
            StudentDebt = 2,

            /// <summary>
            /// Enum OtherSecuredDebt for value: other_secured_debt
            /// </summary>
            [EnumMember(Value = "other_secured_debt")]
            OtherSecuredDebt = 3
        ...
        /// </summary>
        [DataMember(Name = "debt_type", EmitDefaultValue = false)]
        public DebtTypeEnum? DebtType { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankApplicationDebt" /> class.
        /// </summary>
        /// <param name="debtType">debtType.</param>
        /// <param name="amount">amount of money in smallest unit for the currency. .</param>
        /// <param name="interest">interest rate .</param>
        /// <param name="remainingDurationMonths">remaining duration of loan in months .</param>
        public InstabankApplicationDebt(DebtTypeEnum? debtType = default(DebtTypeEnum?), int amount = default(int), decimal interest = default(decimal), int remainingDurationMonths = default(int))
        {
            this.DebtType = debtType;
            this.Amount = amount;
            this.Interest = interest;
            this.RemainingDurationMonths = remainingDurationMonths;
        }
        ...
        /// </summary>
        /// <value>remaining duration of loan in months </value>
        [DataMember(Name = "remaining_duration_months", EmitDefaultValue = false)]
        public int RemainingDurationMonths { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstabankApplicationDebt {\n");
            sb.Append("  DebtType: ").Append(DebtType).Append("\n");
            sb.Append("  Amount: ").Append(Amount).Append("\n");
            sb.Append("  Interest: ").Append(Interest).Append("\n");
            sb.Append("  RemainingDurationMonths: ").Append(RemainingDurationMonths).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as InstabankApplicationDebt);
        }

        /// <summary>
        /// Returns true if InstabankApplicationDebt instances are equal
        /// </summary>
        /// <param name="input">Instance of InstabankApplicationDebt to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstabankApplicationDebt input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.DebtType == input.DebtType ||
                    this.DebtType.Equals(input.DebtType)
                ) && 
                (
                ...
                (
                    this.RemainingDurationMonths == input.RemainingDurationMonths ||
                    this.RemainingDurationMonths.Equals(input.RemainingDurationMonths)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = hashCode * 59 + this.DebtType.GetHashCode();
                hashCode = hashCode * 59 + this.Amount.GetHashCode();
                hashCode = hashCode * 59 + this.Interest.GetHashCode();
                hashCode = hashCode * 59 + this.RemainingDurationMonths.GetHashCode();
                return hashCode;
            }
        }
