...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// TransactionSwish
    /// </summary>
    [DataContract(Name = "TransactionSwish")]
    [JsonConverter(typeof(JsonSubtypes), "PaymentProduct")]
    public partial class TransactionSwish : Transaction, IEquatable<TransactionSwish>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionSwish" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionSwish() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionSwish" /> class.
        /// </summary>
        ...
        /// <param name="paymentProduct">The payment product corresponding to this transaction  (required) (default to &quot;TransactionSwish&quot;).</param>
        ...
        public TransactionSwish(string id = default(string), DateTime createdAt = default(DateTime), PaymentProductTypeEnum paymentProductType = default(PaymentProductTypeEnum), List<TransactionSwishAllOfEvents> events = default(List<TransactionSwishAllOfEvents>), TransactionSwishAllOfMetadata1 metadata = default(TransactionSwishAllOfMetadata1), string paymentProduct = "TransactionSwish", int amount = default(int), string currency = default(string), string merchantReference = default(string), string merchantReference2 = default(string), string dynamicDescriptor = default(string), SettlementStatus? settlementStatus = default(SettlementStatus?), TransactionCustomer customer = default(TransactionCustomer), string customerIp = default(string), string userAgent = default(string), OrderAddress shippingAddress = default(OrderAddress), ShippingOption shippingOption = default(ShippingOption), OrderAddress billingAddress = default(OrderAddress), Store store = default(Store), List<OrderItem> items = default(List<OrderItem>), TransactionUrl url = default(TransactionUrl), string sessionId = default(string), Session session = default(Session), DateTime updatedAt = default(DateTime)) : base(paymentProduct, amount, currency, merchantReference, merchantReference2, dynamicDescriptor, settlementStatus, customer, customerIp, userAgent, shippingAddress, shippingOption, billingAddress, store, status, items, url, sessionId, session, updatedAt)
        {
        ...
        public List<TransactionSwishAllOfEvents> Events { get; set; }

        /// <summary>
        /// Gets or Sets Metadata
        /// </summary>
        [DataMember(Name = "metadata", EmitDefaultValue = false)]
        public TransactionSwishAllOfMetadata1 Metadata { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionSwish {\n");
        ...
        {
            return this.Equals(input as TransactionSwish);
        }

        /// <summary>
        /// Returns true if TransactionSwish instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionSwish to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionSwish input)
        {
            if (input == null)
                return false;
