...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// TransactionUrl
    /// </summary>
    [DataContract(Name = "Transaction_url")]
    public partial class TransactionUrl : IEquatable<TransactionUrl>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionUrl" /> class.
        /// </summary>
        /// <param name="callbackUrl">URL that Checkout will call when the session payment is complete and the transaction has been authorized .</param>
        public TransactionUrl(string callbackUrl = default(string))
        {
        ...
        /// </summary>
        /// <value>URL the customer is redirected after checkout completes (successfully or failed) </value>
        [DataMember(Name = "redirect_url", EmitDefaultValue = false)]
        public string RedirectUrl { get; private set; }

        /// <summary>
        /// Returns false as RedirectUrl should not be serialized given that it's read-only.
        /// </summary>
        ...
        /// </summary>
        /// <value>URL the customer is redirected to for authentication. </value>
        [DataMember(Name = "approval_url", EmitDefaultValue = false)]
        public string ApprovalUrl { get; private set; }

        /// <summary>
        /// Returns false as ApprovalUrl should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeApprovalUrl()
        {
            return false;
        }

        /// <summary>
        /// URL that Checkout will call when the session payment is complete and the transaction has been authorized 
        /// </summary>
        /// <value>URL that Checkout will call when the session payment is complete and the transaction has been authorized </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionUrl {\n");
        ...
        {
            return this.Equals(input as TransactionUrl);
        }

        /// <summary>
        /// Returns true if TransactionUrl instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionUrl to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionUrl input)
        {
            if (input == null)
                return false;
