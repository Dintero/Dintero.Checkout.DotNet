...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(TransactionBambora), "TransactionBambora")]
    [JsonSubtypes.KnownSubType(typeof(TransactionCollector), "TransactionCollector")]
    [JsonSubtypes.KnownSubType(typeof(TransactionIngenico), "TransactionIngenico")]
    [JsonSubtypes.KnownSubType(typeof(TransactionInstabank), "TransactionInstabank")]
    [JsonSubtypes.KnownSubType(typeof(TransactionNetaxept), "TransactionNetaxept")]
    [JsonSubtypes.KnownSubType(typeof(TransactionPayEx), "TransactionPayEx")]
    [JsonSubtypes.KnownSubType(typeof(TransactionSantander), "TransactionSantander")]
    [JsonSubtypes.KnownSubType(typeof(TransactionSwish), "TransactionSwish")]
    [JsonSubtypes.KnownSubType(typeof(TransactionVipps), "TransactionVipps")]
    [JsonSubtypes.KnownSubType(typeof(TransactionBambora), "bambora")]
    [JsonSubtypes.KnownSubType(typeof(TransactionCollector), "collector")]
    [JsonSubtypes.KnownSubType(typeof(TransactionIngenico), "ingenico")]
    [JsonSubtypes.KnownSubType(typeof(TransactionInstabank), "instabank")]
    [JsonSubtypes.KnownSubType(typeof(TransactionNetaxept), "netaxept")]
    [JsonSubtypes.KnownSubType(typeof(TransactionPayEx), "payex")]
    [JsonSubtypes.KnownSubType(typeof(TransactionSantander), "santander")]
    [JsonSubtypes.KnownSubType(typeof(TransactionSwish), "swish")]
    [JsonSubtypes.KnownSubType(typeof(TransactionVipps), "vipps")]
    public partial class Transaction : IEquatable<Transaction>, IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name = "settlement_status", EmitDefaultValue = false)]
        ...
        /// <param name="paymentProduct">The payment product corresponding to this transaction  (required).</param>
        ...
        /// <param name="events">All events recorded on the transaction .</param>
        ...
        /// <param name="createdAt">When the transaction was created.</param>
        /// <param name="metadata">metadata.</param>
        public Transaction(string id = default(string), string paymentProduct = default(string), int amount = default(int), string currency = default(string), string merchantReference = default(string), string merchantReference2 = default(string), string dynamicDescriptor = default(string), SettlementStatus? settlementStatus = default(SettlementStatus?), TransactionCustomer customer = default(TransactionCustomer), string customerIp = default(string), string userAgent = default(string), OrderAddress shippingAddress = default(OrderAddress), ShippingOption shippingOption = default(ShippingOption), OrderAddress billingAddress = default(OrderAddress), Store store = default(Store), List<OrderItem> items = default(List<OrderItem>), TransactionUrl url = default(TransactionUrl), List<TransactionEvent> events = default(List<TransactionEvent>), string sessionId = default(string), Session session = default(Session), DateTime updatedAt = default(DateTime), DateTime createdAt = default(DateTime), TransactionMetadata metadata = default(TransactionMetadata))
        {
            // to ensure "paymentProduct" is required (not null)
            this.PaymentProduct = paymentProduct ?? throw new ArgumentNullException("paymentProduct is a required property for Transaction and cannot be null");
            this.Amount = amount;
            // to ensure "currency" is required (not null)
            this.Currency = currency ?? throw new ArgumentNullException("currency is a required property for Transaction and cannot be null");
            this.Id = id;
        ...
        /// </summary>
        /// <value>The payment product corresponding to this transaction </value>
        [DataMember(Name = "payment_product", IsRequired = true, EmitDefaultValue = false)]
        public string PaymentProduct { get; set; }

        /// <summary>
        /// Non-negative, minor units. Total amount of the transaction 
        /// </summary>
        /// <value>Non-negative, minor units. Total amount of the transaction </value>
        ...
        /// </summary>
        /// <value>ISO 4217 transaction currency</value>
        ...
        /// </summary>
        /// <value>A reference specified by the merchant to identify the transaction </value>
        ...
        /// </summary>
        /// <value>A reference specified by the merchant to identify the transaction, can be updated after the transaction has been created </value>
        ...
        /// </summary>
        /// <value>A short reference / descriptor that will show up on the customers bank statement </value>
        ...
        /// </summary>
        /// <value>The full user agent string of the device the customer used to submit the transaction </value>
        ...
        /// </summary>
        /// <value>The applicable transaction items </value>
        ...
        /// </summary>
        /// <value>All events recorded on the transaction </value>
        ...
        /// </summary>
        /// <value>The session id for the transaction</value>
        ...
        /// </summary>
        /// <value>When the transaction was last modified.</value>
        ...
        /// </summary>
        /// <value>When the transaction was created</value>
        ...
        public bool Equals(Transaction input)
        {
            ...
            return 
                ...
                (
                    this.SettlementStatus == input.SettlementStatus ||
                    this.SettlementStatus.Equals(input.SettlementStatus)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.SettlementStatus.GetHashCode();
