...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CollectorInstallmentB2BPreapprovedPayment")]
    [JsonConverter(typeof(JsonSubtypes), "PaymentProductType")]
    public partial class CollectorInstallmentB2BPreapprovedPayment : Payment, IEquatable<CollectorInstallmentB2BPreapprovedPayment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorInstallmentB2BPreapprovedPayment" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectorInstallmentB2BPreapprovedPayment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorInstallmentB2BPreapprovedPayment" /> class.
        /// </summary>
        /// <param name="paymentProductType">The payment product type corresponding to this transaction  (required) (default to &quot;CollectorInstallmentB2BPreapprovedPayment&quot;).</param>
        /// <param name="product">product (required).</param>
        /// <param name="shippingAddress">shippingAddress (required).</param>
        /// <param name="scc">Optional query parameter. SMS-confirm-code. To verify the identity of the payee..</param>
        /// <param name="companyId">Id to represent the company being paid from (required).</param>
        ...
        public CollectorInstallmentB2BPreapprovedPayment(string paymentProductType = "CollectorInstallmentB2BPreapprovedPayment", CollectorInstallmentB2BPreapprovedPaymentAllOfProduct product = default(CollectorInstallmentB2BPreapprovedPaymentAllOfProduct), CollectorB2BAddress shippingAddress = default(CollectorB2BAddress), string scc = default(string), string companyId = default(string), bool rememberMe = default(bool)) : base()
        {
            // to ensure "paymentProductType" is required (not null)
            this.PaymentProductType = paymentProductType ?? throw new ArgumentNullException("paymentProductType is a required property for CollectorInstallmentB2BPreapprovedPayment and cannot be null");
            // to ensure "product" is required (not null)
            this.Product = product ?? throw new ArgumentNullException("product is a required property for CollectorInstallmentB2BPreapprovedPayment and cannot be null");
            // to ensure "shippingAddress" is required (not null)
            this.ShippingAddress = shippingAddress ?? throw new ArgumentNullException("shippingAddress is a required property for CollectorInstallmentB2BPreapprovedPayment and cannot be null");
            // to ensure "companyId" is required (not null)
            this.CompanyId = companyId ?? throw new ArgumentNullException("companyId is a required property for CollectorInstallmentB2BPreapprovedPayment and cannot be null");
            this.Scc = scc;
        ...
        public CollectorB2BAddress ShippingAddress { get; set; }

        /// <summary>
        /// Optional query parameter. SMS-confirm-code. To verify the identity of the payee.
        /// </summary>
        /// <value>Optional query parameter. SMS-confirm-code. To verify the identity of the payee.</value>
        [DataMember(Name = "scc", EmitDefaultValue = false)]
        public string Scc { get; set; }

        /// <summary>
        /// Id to represent the company being paid from
        /// </summary>
        /// <value>Id to represent the company being paid from</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectorInstallmentB2BPreapprovedPayment {\n");
        ...
        {
            return this.Equals(input as CollectorInstallmentB2BPreapprovedPayment);
        }

        /// <summary>
        /// Returns true if CollectorInstallmentB2BPreapprovedPayment instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectorInstallmentB2BPreapprovedPayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectorInstallmentB2BPreapprovedPayment input)
        {
            if (input == null)
                return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Scc != null)
                    hashCode = hashCode * 59 + this.Scc.GetHashCode();
