...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NetaxeptGwRead")]
    public partial class NetaxeptGwRead : IEquatable<NetaxeptGwRead>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NetaxeptGwRead" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NetaxeptGwRead() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NetaxeptGwRead" /> class.
        /// </summary>
        ...
        public NetaxeptGwRead(string url = default(string), string merchantId = default(string))
        {
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url is a required property for NetaxeptGwRead and cannot be null");
            // to ensure "merchantId" is required (not null)
            this.MerchantId = merchantId ?? throw new ArgumentNullException("merchantId is a required property for NetaxeptGwRead and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NetaxeptGwRead {\n");
        ...
        {
            return this.Equals(input as NetaxeptGwRead);
        }

        /// <summary>
        /// Returns true if NetaxeptGwRead instances are equal
        /// </summary>
        /// <param name="input">Instance of NetaxeptGwRead to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NetaxeptGwRead input)
        {
            if (input == null)
                return false;
