...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CheckoutConfigWrite_configuration_merchant")]
    public partial class CheckoutConfigWriteConfigurationMerchant : IEquatable<CheckoutConfigWriteConfigurationMerchant>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckoutConfigWriteConfigurationMerchant" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CheckoutConfigWriteConfigurationMerchant() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckoutConfigWriteConfigurationMerchant" /> class.
        /// </summary>
        /// <param name="name">name (required).</param>
        /// <param name="logoUrl">logoUrl (required).</param>
        public CheckoutConfigWriteConfigurationMerchant(string name = default(string), string logoUrl = default(string))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CheckoutConfigWriteConfigurationMerchant and cannot be null");
            // to ensure "logoUrl" is required (not null)
            this.LogoUrl = logoUrl ?? throw new ArgumentNullException("logoUrl is a required property for CheckoutConfigWriteConfigurationMerchant and cannot be null");
        }
        ...
        /// </summary>
        [DataMember(Name = "logo_url", IsRequired = true, EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CheckoutConfigWriteConfigurationMerchant {\n");
        ...
        {
            return this.Equals(input as CheckoutConfigWriteConfigurationMerchant);
        }

        /// <summary>
        /// Returns true if CheckoutConfigWriteConfigurationMerchant instances are equal
        /// </summary>
        /// <param name="input">Instance of CheckoutConfigWriteConfigurationMerchant to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CheckoutConfigWriteConfigurationMerchant input)
        {
            if (input == null)
                return false;
        ...
        {
            // LogoUrl (string) pattern
            Regex regexLogoUrl = new Regex(@"https?:\/\/_*", RegexOptions.CultureInvariant);
            if (false == regexLogoUrl.Match(this.LogoUrl).Success)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for LogoUrl, must match a pattern of " + regexLogoUrl, new [] { "LogoUrl" });
            }
