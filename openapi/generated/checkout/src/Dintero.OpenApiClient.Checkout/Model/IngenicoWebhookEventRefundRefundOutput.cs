...
{
    /// <summary>
    /// IngenicoWebhookEventRefundRefundOutput
    /// </summary>
    [DataContract(Name = "IngenicoWebhookEvent_refund_refundOutput")]
    public partial class IngenicoWebhookEventRefundRefundOutput : IEquatable<IngenicoWebhookEventRefundRefundOutput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoWebhookEventRefundRefundOutput" /> class.
        /// </summary>
        ...
        /// <param name="cardRefundMethodSpecificOutput">cardRefundMethodSpecificOutput.</param>
        public IngenicoWebhookEventRefundRefundOutput(string id = default(string), IngenicoWebhookEventPaymentPaymentOutputAmountOfMoney amountOfMoney = default(IngenicoWebhookEventPaymentPaymentOutputAmountOfMoney), decimal amountPaid = default(decimal), string paymentMethod = default(string), IngenicoWebhookEventPaymentPaymentOutputReferences references = default(IngenicoWebhookEventPaymentPaymentOutputReferences), IngenicoWebhookEventRefundRefundOutputCardRefundMethodSpecificOutput cardRefundMethodSpecificOutput = default(IngenicoWebhookEventRefundRefundOutputCardRefundMethodSpecificOutput))
        {
            this.Id = id;
            ...
            this.CardRefundMethodSpecificOutput = cardRefundMethodSpecificOutput;
        }
        ...
        /// </summary>
        [DataMember(Name = "cardRefundMethodSpecificOutput", EmitDefaultValue = false)]
        public IngenicoWebhookEventRefundRefundOutputCardRefundMethodSpecificOutput CardRefundMethodSpecificOutput { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IngenicoWebhookEventRefundRefundOutput {\n");
        ...
        {
            return this.Equals(input as IngenicoWebhookEventRefundRefundOutput);
        }

        /// <summary>
        /// Returns true if IngenicoWebhookEventRefundRefundOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of IngenicoWebhookEventRefundRefundOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IngenicoWebhookEventRefundRefundOutput input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CardRefundMethodSpecificOutput == input.CardRefundMethodSpecificOutput ||
                    (this.CardRefundMethodSpecificOutput != null &&
                    this.CardRefundMethodSpecificOutput.Equals(input.CardRefundMethodSpecificOutput))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CardRefundMethodSpecificOutput != null)
                    hashCode = hashCode * 59 + this.CardRefundMethodSpecificOutput.GetHashCode();
                return hashCode;
            }
        }
