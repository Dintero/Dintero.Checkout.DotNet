...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// PayExMitPayment
    /// </summary>
    [DataContract(Name = "PayExMitPayment")]
    [JsonConverter(typeof(JsonSubtypes), "PaymentProductType")]
    public partial class PayExMitPayment : MitPayment, IEquatable<PayExMitPayment>, IValidatableObject
    {
        /// <summary>
        /// Defines Operation
        /// </summary>
        ...
        {
            /// <summary>
            /// Enum UnscheduledPurchase for value: unscheduled_purchase
            /// </summary>
            [EnumMember(Value = "unscheduled_purchase")]
            UnscheduledPurchase = 1
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExMitPayment" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayExMitPayment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayExMitPayment" /> class.
        /// </summary>
        /// <param name="operation">operation (required).</param>
        /// <param name="paymentProductType">The payment product type corresponding to this transaction  (required) (default to &quot;PayExMitPayment&quot;).</param>
        public PayExMitPayment(OperationEnum operation = default(OperationEnum), string paymentProductType = "PayExMitPayment") : base(paymentProductType)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PayExMitPayment {\n");
        ...
        {
            return this.Equals(input as PayExMitPayment);
        }

        /// <summary>
        /// Returns true if PayExMitPayment instances are equal
        /// </summary>
        /// <param name="input">Instance of PayExMitPayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayExMitPayment input)
        {
            if (input == null)
                return false;
