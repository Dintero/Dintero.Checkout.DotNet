...
{
    /// <summary>
    /// TransactionVippsAllOfEvents
    /// </summary>
    [DataContract(Name = "TransactionVipps_allOf_events")]
    public partial class TransactionVippsAllOfEvents : IEquatable<TransactionVippsAllOfEvents>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionVippsAllOfEvents" /> class.
        /// </summary>
        /// <param name="metadata">metadata.</param>
        public TransactionVippsAllOfEvents(TransactionVippsAllOfMetadata metadata = default(TransactionVippsAllOfMetadata))
        {
        ...
        public TransactionVippsAllOfMetadata Metadata { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionVippsAllOfEvents {\n");
        ...
        {
            return this.Equals(input as TransactionVippsAllOfEvents);
        }

        /// <summary>
        /// Returns true if TransactionVippsAllOfEvents instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionVippsAllOfEvents to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionVippsAllOfEvents input)
        {
            if (input == null)
                return false;
