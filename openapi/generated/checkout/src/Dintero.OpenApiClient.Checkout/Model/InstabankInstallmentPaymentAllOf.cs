...
{
    /// <summary>
    /// InstabankInstallmentPaymentAllOf
    /// </summary>
    [DataContract(Name = "InstabankInstallmentPayment_allOf")]
    public partial class InstabankInstallmentPaymentAllOf : IEquatable<InstabankInstallmentPaymentAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankInstallmentPaymentAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstabankInstallmentPaymentAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankInstallmentPaymentAllOf" /> class.
        /// </summary>
        ...
        public InstabankInstallmentPaymentAllOf(string productCode = default(string), InstabankApplication applicant = default(InstabankApplication), bool rememberMe = default(bool))
        {
            // to ensure "productCode" is required (not null)
            this.ProductCode = productCode ?? throw new ArgumentNullException("productCode is a required property for InstabankInstallmentPaymentAllOf and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstabankInstallmentPaymentAllOf {\n");
        ...
        {
            return this.Equals(input as InstabankInstallmentPaymentAllOf);
        }

        /// <summary>
        /// Returns true if InstabankInstallmentPaymentAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of InstabankInstallmentPaymentAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstabankInstallmentPaymentAllOf input)
        {
            if (input == null)
                return false;
