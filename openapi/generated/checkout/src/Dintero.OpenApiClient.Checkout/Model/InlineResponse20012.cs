...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    public partial class InlineResponse20012 : IEquatable<InlineResponse20012>, IValidatableObject
    {
        ...
        /// <param name="sessionLock">sessionLock.</param>
        /// <param name="sessionOperations">sessionOperations.</param>
        /// <param name="sessionOptions">sessionOptions.</param>
        /// <param name="sessionRead">sessionRead.</param>
        public InlineResponse20012(Id id = default(Id), SessionLock sessionLock = default(SessionLock), SessionOperations sessionOperations = default(SessionOperations), SessionOptions sessionOptions = default(SessionOptions), SessionRead sessionRead = default(SessionRead))
        {
            this.Id = id;
        ...
        /// <summary>
        /// Gets or Sets SessionLock
        /// </summary>
        [DataMember(Name = "SessionLock", EmitDefaultValue = false)]
        public SessionLock SessionLock { get; set; }

        /// <summary>
        /// Gets or Sets SessionOperations
        /// </summary>
        [DataMember(Name = "SessionOperations", EmitDefaultValue = false)]
        public SessionOperations SessionOperations { get; set; }

        /// <summary>
        /// Gets or Sets SessionOptions
        /// </summary>
        [DataMember(Name = "SessionOptions", EmitDefaultValue = false)]
        public SessionOptions SessionOptions { get; set; }

        /// <summary>
        /// Gets or Sets SessionRead
        /// </summary>
        [DataMember(Name = "SessionRead", EmitDefaultValue = false)]
        public SessionRead SessionRead { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SessionLock: ").Append(SessionLock).Append("\n");
            sb.Append("  SessionOperations: ").Append(SessionOperations).Append("\n");
            sb.Append("  SessionOptions: ").Append(SessionOptions).Append("\n");
            sb.Append("  SessionRead: ").Append(SessionRead).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(InlineResponse20012 input)
        {
            ...
            return 
                ...
                (
                    this.SessionLock == input.SessionLock ||
                    (this.SessionLock != null &&
                    this.SessionLock.Equals(input.SessionLock))
                ) && 
                (
                    this.SessionOperations == input.SessionOperations ||
                    (this.SessionOperations != null &&
                    this.SessionOperations.Equals(input.SessionOperations))
                ) && 
                (
                    this.SessionOptions == input.SessionOptions ||
                    (this.SessionOptions != null &&
                    this.SessionOptions.Equals(input.SessionOptions))
                ) && 
                (
                    this.SessionRead == input.SessionRead ||
                    (this.SessionRead != null &&
                    this.SessionRead.Equals(input.SessionRead))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SessionLock != null)
                    hashCode = hashCode * 59 + this.SessionLock.GetHashCode();
                if (this.SessionOperations != null)
                    hashCode = hashCode * 59 + this.SessionOperations.GetHashCode();
                if (this.SessionOptions != null)
                    hashCode = hashCode * 59 + this.SessionOptions.GetHashCode();
                if (this.SessionRead != null)
                    hashCode = hashCode * 59 + this.SessionRead.GetHashCode();
                return hashCode;
            }
        }
