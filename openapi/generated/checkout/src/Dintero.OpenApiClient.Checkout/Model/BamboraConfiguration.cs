...
namespace Dintero.OpenApiClient.Checkout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BamboraConfiguration")]
    public partial class BamboraConfiguration : IEquatable<BamboraConfiguration>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraConfiguration" /> class.
        /// </summary>
        /// <param name="type">Denotes what kind of config parameter this is.</param>
        /// <param name="creditcard">creditcard.</param>
        /// <param name="mobilepay">mobilepay.</param>
        /// <param name="vipps">vipps.</param>
        public BamboraConfiguration(TypeEnum? type = default(TypeEnum?), BamboraConfigurationCreditcard creditcard = default(BamboraConfigurationCreditcard), BamboraConfigurationMobilepay mobilepay = default(BamboraConfigurationMobilepay), BamboraConfigurationVipps vipps = default(BamboraConfigurationVipps))
        {
            this.Type = type;
        ...
        public BamboraConfigurationCreditcard Creditcard { get; set; }

        /// <summary>
        /// Gets or Sets Mobilepay
        /// </summary>
        [DataMember(Name = "mobilepay", EmitDefaultValue = false)]
        public BamboraConfigurationMobilepay Mobilepay { get; set; }

        /// <summary>
        /// Gets or Sets Vipps
        /// </summary>
        [DataMember(Name = "vipps", EmitDefaultValue = false)]
        public BamboraConfigurationVipps Vipps { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BamboraConfiguration {\n");
        ...
        {
            return this.Equals(input as BamboraConfiguration);
        }

        /// <summary>
        /// Returns true if BamboraConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of BamboraConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BamboraConfiguration input)
        {
            if (input == null)
                return false;
