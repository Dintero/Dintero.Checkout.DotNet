...
namespace Dintero.OpenApiClient.Checkout.Api
{
    ...
    /// </summary>
    public interface INetaxeptGatewayApiSync : IApiAccessor
    {
        ...
        ApiResponse<Object> AdminCheckoutIdGwNetaxeptPutWithHttpInfo(InlineObject5 configuration);
        /// <summary>
        ...
        /// <returns></returns>
        void AdminCheckoutIdGwOverrideNetaxeptPut(InlineObject6 configuration = default(InlineObject6));
        ...
        /// <param name="configuration"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> AdminCheckoutIdGwOverrideNetaxeptPutWithHttpInfo(InlineObject6 configuration = default(InlineObject6));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface INetaxeptGatewayApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task AdminCheckoutIdGwNetaxeptPutAsync(InlineObject5 configuration, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> AdminCheckoutIdGwNetaxeptPutWithHttpInfoAsync(InlineObject5 configuration, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Update overrides for Netaxept Gateway
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task AdminCheckoutIdGwOverrideNetaxeptPutAsync(InlineObject6 configuration = default(InlineObject6), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> AdminCheckoutIdGwOverrideNetaxeptPutWithHttpInfoAsync(InlineObject6 configuration = default(InlineObject6), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface INetaxeptGatewayApi : INetaxeptGatewayApiSync, INetaxeptGatewayApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class NetaxeptGatewayApi : INetaxeptGatewayApi
    {
        private Dintero.OpenApiClient.Checkout.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="NetaxeptGatewayApi"/> class.
        /// </summary>
        /// <returns></returns>
        public NetaxeptGatewayApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public NetaxeptGatewayApi(String basePath)
        {
        ...
        /// <returns></returns>
        public NetaxeptGatewayApi(Dintero.OpenApiClient.Checkout.Client.Configuration configuration)
        {
        ...
        public NetaxeptGatewayApi(Dintero.OpenApiClient.Checkout.Client.ISynchronousClient client, Dintero.OpenApiClient.Checkout.Client.IAsynchronousClient asyncClient, Dintero.OpenApiClient.Checkout.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Update Netaxept gateway scopes: - admin:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="configuration"></param>
        /// <returns></returns>
        public void AdminCheckoutIdGwNetaxeptPut(InlineObject5 configuration)
        {
            AdminCheckoutIdGwNetaxeptPutWithHttpInfo(configuration);
        }
        ...
        /// <param name="configuration"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object> AdminCheckoutIdGwNetaxeptPutWithHttpInfo(InlineObject5 configuration)
        {
            // verify the required parameter 'configuration' is set
            if (configuration == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'configuration' when calling NetaxeptGatewayApi->AdminCheckoutIdGwNetaxeptPut");
            ...
            var localVarResponse = this.Client.Put<Object>("/admin/gateways/netaxept", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("AdminCheckoutIdGwNetaxeptPut", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task AdminCheckoutIdGwNetaxeptPutAsync(InlineObject5 configuration, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await AdminCheckoutIdGwNetaxeptPutWithHttpInfoAsync(configuration, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object>> AdminCheckoutIdGwNetaxeptPutWithHttpInfoAsync(InlineObject5 configuration, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'configuration' is set
            if (configuration == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'configuration' when calling NetaxeptGatewayApi->AdminCheckoutIdGwNetaxeptPut");
            ...
            var localVarResponse = await this.AsynchronousClient.PutAsync<Object>("/admin/gateways/netaxept", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Update overrides for Netaxept Gateway scopes: - admin:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="configuration"> (optional)</param>
        /// <returns></returns>
        public void AdminCheckoutIdGwOverrideNetaxeptPut(InlineObject6 configuration = default(InlineObject6))
        {
            AdminCheckoutIdGwOverrideNetaxeptPutWithHttpInfo(configuration);
        }
        ...
        /// <param name="configuration"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object> AdminCheckoutIdGwOverrideNetaxeptPutWithHttpInfo(InlineObject6 configuration = default(InlineObject6))
        {
            Dintero.OpenApiClient.Checkout.Client.RequestOptions localVarRequestOptions = new Dintero.OpenApiClient.Checkout.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Put<Object>("/admin/gateways/netaxept/override", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("AdminCheckoutIdGwOverrideNetaxeptPut", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task AdminCheckoutIdGwOverrideNetaxeptPutAsync(InlineObject6 configuration = default(InlineObject6), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await AdminCheckoutIdGwOverrideNetaxeptPutWithHttpInfoAsync(configuration, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object>> AdminCheckoutIdGwOverrideNetaxeptPutWithHttpInfoAsync(InlineObject6 configuration = default(InlineObject6), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PutAsync<Object>("/admin/gateways/netaxept/override", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
