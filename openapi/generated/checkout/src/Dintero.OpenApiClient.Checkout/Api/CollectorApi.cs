...
namespace Dintero.OpenApiClient.Checkout.Api
{
    ...
    /// </summary>
    public interface ICollectorApiSync : IApiAccessor
    {
        ...
        ApiResponse<Object> CheckoutSidCollectorCallbackPostWithHttpInfo(string invoiceNo, string orderNo, int invoiceStatus);
        /// <summary>
        ...
        /// <param name="sessionId">The session ID</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> CheckoutSidCollectorRedirectGetWithHttpInfo(string sessionId);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ICollectorApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task CheckoutSidCollectorCallbackPostAsync(string invoiceNo, string orderNo, int invoiceStatus, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> CheckoutSidCollectorCallbackPostWithHttpInfoAsync(string invoiceNo, string orderNo, int invoiceStatus, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Handle redirect from payment
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task CheckoutSidCollectorRedirectGetAsync(string sessionId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> CheckoutSidCollectorRedirectGetWithHttpInfoAsync(string sessionId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ICollectorApi : ICollectorApiSync, ICollectorApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class CollectorApi : ICollectorApi
    {
        private Dintero.OpenApiClient.Checkout.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorApi"/> class.
        /// </summary>
        /// <returns></returns>
        public CollectorApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public CollectorApi(String basePath)
        {
        ...
        /// <returns></returns>
        public CollectorApi(Dintero.OpenApiClient.Checkout.Client.Configuration configuration)
        {
        ...
        public CollectorApi(Dintero.OpenApiClient.Checkout.Client.ISynchronousClient client, Dintero.OpenApiClient.Checkout.Client.IAsynchronousClient asyncClient, Dintero.OpenApiClient.Checkout.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="invoiceStatus"></param>
        /// <returns></returns>
        public void CheckoutSidCollectorCallbackPost(string invoiceNo, string orderNo, int invoiceStatus)
        {
            CheckoutSidCollectorCallbackPostWithHttpInfo(invoiceNo, orderNo, invoiceStatus);
        }
        ...
        /// <param name="invoiceStatus"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object> CheckoutSidCollectorCallbackPostWithHttpInfo(string invoiceNo, string orderNo, int invoiceStatus)
        {
            // verify the required parameter 'invoiceNo' is set
            if (invoiceNo == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'invoiceNo' when calling CollectorApi->CheckoutSidCollectorCallbackPost");

            // verify the required parameter 'orderNo' is set
            if (orderNo == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'orderNo' when calling CollectorApi->CheckoutSidCollectorCallbackPost");
            ...
            localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("", "InvoiceNo", invoiceNo));
            localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("", "OrderNo", orderNo));
            localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("", "InvoiceStatus", invoiceStatus));
            ...
            var localVarResponse = this.Client.Get<Object>("/callbacks/collector/antifraud", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CheckoutSidCollectorCallbackPost", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task CheckoutSidCollectorCallbackPostAsync(string invoiceNo, string orderNo, int invoiceStatus, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await CheckoutSidCollectorCallbackPostWithHttpInfoAsync(invoiceNo, orderNo, invoiceStatus, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object>> CheckoutSidCollectorCallbackPostWithHttpInfoAsync(string invoiceNo, string orderNo, int invoiceStatus, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'invoiceNo' is set
            if (invoiceNo == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'invoiceNo' when calling CollectorApi->CheckoutSidCollectorCallbackPost");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/callbacks/collector/antifraud", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="sessionId">The session ID</param>
        /// <returns></returns>
        public void CheckoutSidCollectorRedirectGet(string sessionId)
        {
            CheckoutSidCollectorRedirectGetWithHttpInfo(sessionId);
        }
        ...
        /// <param name="sessionId">The session ID</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object> CheckoutSidCollectorRedirectGetWithHttpInfo(string sessionId)
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling CollectorApi->CheckoutSidCollectorRedirectGet");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<Object>("/sessions/{session_id}/collector/redirect", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CheckoutSidCollectorRedirectGet", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task CheckoutSidCollectorRedirectGetAsync(string sessionId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await CheckoutSidCollectorRedirectGetWithHttpInfoAsync(sessionId, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object>> CheckoutSidCollectorRedirectGetWithHttpInfoAsync(string sessionId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling CollectorApi->CheckoutSidCollectorRedirectGet");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/sessions/{session_id}/collector/redirect", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
