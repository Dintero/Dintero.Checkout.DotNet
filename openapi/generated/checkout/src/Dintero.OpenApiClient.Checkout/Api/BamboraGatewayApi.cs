...
namespace Dintero.OpenApiClient.Checkout.Api
{
    ...
    /// </summary>
    public interface IBamboraGatewayApiSync : IApiAccessor
    {
        ...
        ApiResponse<Object> AdminCheckoutIdGwBamboraPutWithHttpInfo(InlineObject configuration);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IBamboraGatewayApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task AdminCheckoutIdGwBamboraPutAsync(InlineObject configuration, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> AdminCheckoutIdGwBamboraPutWithHttpInfoAsync(InlineObject configuration, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IBamboraGatewayApi : IBamboraGatewayApiSync, IBamboraGatewayApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class BamboraGatewayApi : IBamboraGatewayApi
    {
        private Dintero.OpenApiClient.Checkout.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="BamboraGatewayApi"/> class.
        /// </summary>
        /// <returns></returns>
        public BamboraGatewayApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public BamboraGatewayApi(String basePath)
        {
        ...
        /// <returns></returns>
        public BamboraGatewayApi(Dintero.OpenApiClient.Checkout.Client.Configuration configuration)
        {
        ...
        public BamboraGatewayApi(Dintero.OpenApiClient.Checkout.Client.ISynchronousClient client, Dintero.OpenApiClient.Checkout.Client.IAsynchronousClient asyncClient, Dintero.OpenApiClient.Checkout.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Update Bambora gateway scopes: - admin:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="configuration"></param>
        /// <returns></returns>
        public void AdminCheckoutIdGwBamboraPut(InlineObject configuration)
        {
            AdminCheckoutIdGwBamboraPutWithHttpInfo(configuration);
        }
        ...
        /// <param name="configuration"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object> AdminCheckoutIdGwBamboraPutWithHttpInfo(InlineObject configuration)
        {
            // verify the required parameter 'configuration' is set
            if (configuration == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'configuration' when calling BamboraGatewayApi->AdminCheckoutIdGwBamboraPut");
            ...
            var localVarResponse = this.Client.Put<Object>("/admin/gateways/bambora", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("AdminCheckoutIdGwBamboraPut", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task AdminCheckoutIdGwBamboraPutAsync(InlineObject configuration, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await AdminCheckoutIdGwBamboraPutWithHttpInfoAsync(configuration, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object>> AdminCheckoutIdGwBamboraPutWithHttpInfoAsync(InlineObject configuration, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'configuration' is set
            if (configuration == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'configuration' when calling BamboraGatewayApi->AdminCheckoutIdGwBamboraPut");
            ...
            var localVarResponse = await this.AsynchronousClient.PutAsync<Object>("/admin/gateways/bambora", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
