...
namespace Dintero.OpenApiClient.Checkout.Api
{
    ...
    /// </summary>
    public interface IExampleSessionCallbacksApiSync : IApiAccessor
    {
        ...
        ApiResponse<InlineResponse2006> ExampleDiscountCodesCallbackUrlWithHttpInfo(UNKNOWN_BASE_TYPE options);
        /// <summary>
        /// Address Update
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<InlineResponse2007> ExampleShippingAddressCallbackUrlWithHttpInfo(UNKNOWN_BASE_TYPE options);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IExampleSessionCallbacksApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<InlineResponse2006> ExampleDiscountCodesCallbackUrlAsync(UNKNOWN_BASE_TYPE options, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse2006>> ExampleDiscountCodesCallbackUrlWithHttpInfoAsync(UNKNOWN_BASE_TYPE options, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Address Update
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<InlineResponse2007> ExampleShippingAddressCallbackUrlAsync(UNKNOWN_BASE_TYPE options, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse2007>> ExampleShippingAddressCallbackUrlWithHttpInfoAsync(UNKNOWN_BASE_TYPE options, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IExampleSessionCallbacksApi : IExampleSessionCallbacksApiSync, IExampleSessionCallbacksApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ExampleSessionCallbacksApi : IExampleSessionCallbacksApi
    {
        private Dintero.OpenApiClient.Checkout.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="ExampleSessionCallbacksApi"/> class.
        /// </summary>
        /// <returns></returns>
        public ExampleSessionCallbacksApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public ExampleSessionCallbacksApi(String basePath)
        {
        ...
        /// <returns></returns>
        public ExampleSessionCallbacksApi(Dintero.OpenApiClient.Checkout.Client.Configuration configuration)
        {
        ...
        public ExampleSessionCallbacksApi(Dintero.OpenApiClient.Checkout.Client.ISynchronousClient client, Dintero.OpenApiClient.Checkout.Client.IAsynchronousClient asyncClient, Dintero.OpenApiClient.Checkout.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Discount codes Update This API endpoint on the merchant side allows Dintero to get shipping_options and order with discounts based on the provided session that had its &#x60;order.discount_codes&#x60; updated. 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="options"></param>
        /// <returns>InlineResponse2006</returns>
        public InlineResponse2006 ExampleDiscountCodesCallbackUrl(UNKNOWN_BASE_TYPE options)
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2006> localVarResponse = ExampleDiscountCodesCallbackUrlWithHttpInfo(options);
        ...
        /// <param name="options"></param>
        /// <returns>ApiResponse of InlineResponse2006</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2006> ExampleDiscountCodesCallbackUrlWithHttpInfo(UNKNOWN_BASE_TYPE options)
        {
            // verify the required parameter 'options' is set
            if (options == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'options' when calling ExampleSessionCallbacksApi->ExampleDiscountCodesCallbackUrl");
            ...
            var localVarResponse = this.Client.Post<InlineResponse2006>("/examples/discount_code_callback_url", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ExampleDiscountCodesCallbackUrl", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse2006</returns>
        public async System.Threading.Tasks.Task<InlineResponse2006> ExampleDiscountCodesCallbackUrlAsync(UNKNOWN_BASE_TYPE options, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2006> localVarResponse = await ExampleDiscountCodesCallbackUrlWithHttpInfoAsync(options, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse2006)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2006>> ExampleDiscountCodesCallbackUrlWithHttpInfoAsync(UNKNOWN_BASE_TYPE options, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'options' is set
            if (options == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'options' when calling ExampleSessionCallbacksApi->ExampleDiscountCodesCallbackUrl");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<InlineResponse2006>("/examples/discount_code_callback_url", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Address Update This API endpoint on the merchant side allows Dintero to get shipping options based on the provided session after an address update 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="options"></param>
        /// <returns>InlineResponse2007</returns>
        public InlineResponse2007 ExampleShippingAddressCallbackUrl(UNKNOWN_BASE_TYPE options)
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2007> localVarResponse = ExampleShippingAddressCallbackUrlWithHttpInfo(options);
            return localVarResponse.Data;
        }
        ...
        /// <param name="options"></param>
        /// <returns>ApiResponse of InlineResponse2007</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2007> ExampleShippingAddressCallbackUrlWithHttpInfo(UNKNOWN_BASE_TYPE options)
        {
            // verify the required parameter 'options' is set
            if (options == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'options' when calling ExampleSessionCallbacksApi->ExampleShippingAddressCallbackUrl");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<InlineResponse2007>("/examples/shipping_address_callback_url", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ExampleShippingAddressCallbackUrl", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse2007</returns>
        public async System.Threading.Tasks.Task<InlineResponse2007> ExampleShippingAddressCallbackUrlAsync(UNKNOWN_BASE_TYPE options, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2007> localVarResponse = await ExampleShippingAddressCallbackUrlWithHttpInfoAsync(options, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse2007)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2007>> ExampleShippingAddressCallbackUrlWithHttpInfoAsync(UNKNOWN_BASE_TYPE options, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'options' is set
            if (options == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'options' when calling ExampleSessionCallbacksApi->ExampleShippingAddressCallbackUrl");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<InlineResponse2007>("/examples/shipping_address_callback_url", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
