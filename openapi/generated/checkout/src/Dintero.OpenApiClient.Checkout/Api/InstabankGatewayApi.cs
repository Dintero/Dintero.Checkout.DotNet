...
namespace Dintero.OpenApiClient.Checkout.Api
{
    ...
    /// </summary>
    public interface IInstabankGatewayApiSync : IApiAccessor
    {
        ...
        ApiResponse<Object> AdminCheckoutIdGwInstabankPutWithHttpInfo(InlineObject4 configuration);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IInstabankGatewayApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task AdminCheckoutIdGwInstabankPutAsync(InlineObject4 configuration, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> AdminCheckoutIdGwInstabankPutWithHttpInfoAsync(InlineObject4 configuration, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IInstabankGatewayApi : IInstabankGatewayApiSync, IInstabankGatewayApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class InstabankGatewayApi : IInstabankGatewayApi
    {
        private Dintero.OpenApiClient.Checkout.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="InstabankGatewayApi"/> class.
        /// </summary>
        /// <returns></returns>
        public InstabankGatewayApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public InstabankGatewayApi(String basePath)
        {
        ...
        /// <returns></returns>
        public InstabankGatewayApi(Dintero.OpenApiClient.Checkout.Client.Configuration configuration)
        {
        ...
        public InstabankGatewayApi(Dintero.OpenApiClient.Checkout.Client.ISynchronousClient client, Dintero.OpenApiClient.Checkout.Client.IAsynchronousClient asyncClient, Dintero.OpenApiClient.Checkout.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Update Instabank gateway scopes: - admin:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="configuration"></param>
        /// <returns></returns>
        public void AdminCheckoutIdGwInstabankPut(InlineObject4 configuration)
        {
            AdminCheckoutIdGwInstabankPutWithHttpInfo(configuration);
        }
        ...
        /// <param name="configuration"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object> AdminCheckoutIdGwInstabankPutWithHttpInfo(InlineObject4 configuration)
        {
            // verify the required parameter 'configuration' is set
            if (configuration == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'configuration' when calling InstabankGatewayApi->AdminCheckoutIdGwInstabankPut");
            ...
            var localVarResponse = this.Client.Put<Object>("/admin/gateways/instabank", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("AdminCheckoutIdGwInstabankPut", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task AdminCheckoutIdGwInstabankPutAsync(InlineObject4 configuration, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await AdminCheckoutIdGwInstabankPutWithHttpInfoAsync(configuration, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object>> AdminCheckoutIdGwInstabankPutWithHttpInfoAsync(InlineObject4 configuration, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'configuration' is set
            if (configuration == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'configuration' when calling InstabankGatewayApi->AdminCheckoutIdGwInstabankPut");
            ...
            var localVarResponse = await this.AsynchronousClient.PutAsync<Object>("/admin/gateways/instabank", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
