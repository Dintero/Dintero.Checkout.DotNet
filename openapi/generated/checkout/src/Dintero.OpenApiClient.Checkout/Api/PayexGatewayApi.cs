...
namespace Dintero.OpenApiClient.Checkout.Api
{
    ...
    /// </summary>
    public interface IPayexGatewayApiSync : IApiAccessor
    {
        ...
        /// <param name="keepVersions">keep existing override versions when updating the overridej  (optional, default to true)</param>
        /// <param name="configuration"> (optional)</param>
        /// <returns></returns>
        void AdminCheckoutIdGwOverridePayexPut(bool? keepVersions = default(bool?), InlineObject8 configuration = default(InlineObject8));
        ...
        ApiResponse<Object> AdminCheckoutIdGwOverridePayexPutWithHttpInfo(bool? keepVersions = default(bool?), InlineObject8 configuration = default(InlineObject8));
        /// <summary>
        ...
        /// <param name="keepOverrides">keep existing overrides when updating the gateway  (optional, default to true)</param>
        /// <param name="keepVersions">keep existing overrides when updating the gateway  (optional, default to true)</param>
        /// <returns></returns>
        void AdminCheckoutIdGwPayexPut(InlineObject7 configuration, bool? keepOverrides = default(bool?), bool? keepVersions = default(bool?));
        ...
        /// <param name="keepVersions">keep existing overrides when updating the gateway  (optional, default to true)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> AdminCheckoutIdGwPayexPutWithHttpInfo(InlineObject7 configuration, bool? keepOverrides = default(bool?), bool? keepVersions = default(bool?));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IPayexGatewayApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task AdminCheckoutIdGwOverridePayexPutAsync(bool? keepVersions = default(bool?), InlineObject8 configuration = default(InlineObject8), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> AdminCheckoutIdGwOverridePayexPutWithHttpInfoAsync(bool? keepVersions = default(bool?), InlineObject8 configuration = default(InlineObject8), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Update PayEx gateway
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task AdminCheckoutIdGwPayexPutAsync(InlineObject7 configuration, bool? keepOverrides = default(bool?), bool? keepVersions = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> AdminCheckoutIdGwPayexPutWithHttpInfoAsync(InlineObject7 configuration, bool? keepOverrides = default(bool?), bool? keepVersions = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IPayexGatewayApi : IPayexGatewayApiSync, IPayexGatewayApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class PayexGatewayApi : IPayexGatewayApi
    {
        private Dintero.OpenApiClient.Checkout.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="PayexGatewayApi"/> class.
        /// </summary>
        /// <returns></returns>
        public PayexGatewayApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public PayexGatewayApi(String basePath)
        {
        ...
        /// <returns></returns>
        public PayexGatewayApi(Dintero.OpenApiClient.Checkout.Client.Configuration configuration)
        {
        ...
        public PayexGatewayApi(Dintero.OpenApiClient.Checkout.Client.ISynchronousClient client, Dintero.OpenApiClient.Checkout.Client.IAsynchronousClient asyncClient, Dintero.OpenApiClient.Checkout.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Update overrides for PayEx Gateway scopes: - admin:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="keepVersions">keep existing override versions when updating the overridej  (optional, default to true)</param>
        /// <param name="configuration"> (optional)</param>
        /// <returns></returns>
        public void AdminCheckoutIdGwOverridePayexPut(bool? keepVersions = default(bool?), InlineObject8 configuration = default(InlineObject8))
        {
            AdminCheckoutIdGwOverridePayexPutWithHttpInfo(keepVersions, configuration);
        }
        ...
        /// <param name="configuration"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object> AdminCheckoutIdGwOverridePayexPutWithHttpInfo(bool? keepVersions = default(bool?), InlineObject8 configuration = default(InlineObject8))
        {
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("", "keep_versions", keepVersions));
            }
            ...
            var localVarResponse = this.Client.Put<Object>("/admin/gateways/payex/override", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("AdminCheckoutIdGwOverridePayexPut", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task AdminCheckoutIdGwOverridePayexPutAsync(bool? keepVersions = default(bool?), InlineObject8 configuration = default(InlineObject8), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await AdminCheckoutIdGwOverridePayexPutWithHttpInfoAsync(keepVersions, configuration, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object>> AdminCheckoutIdGwOverridePayexPutWithHttpInfoAsync(bool? keepVersions = default(bool?), InlineObject8 configuration = default(InlineObject8), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PutAsync<Object>("/admin/gateways/payex/override", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Update PayEx gateway scopes: - admin:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="configuration"></param>
        /// <param name="keepOverrides">keep existing overrides when updating the gateway  (optional, default to true)</param>
        /// <param name="keepVersions">keep existing overrides when updating the gateway  (optional, default to true)</param>
        /// <returns></returns>
        public void AdminCheckoutIdGwPayexPut(InlineObject7 configuration, bool? keepOverrides = default(bool?), bool? keepVersions = default(bool?))
        {
            AdminCheckoutIdGwPayexPutWithHttpInfo(configuration, keepOverrides, keepVersions);
        }
        ...
        /// <param name="keepVersions">keep existing overrides when updating the gateway  (optional, default to true)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object> AdminCheckoutIdGwPayexPutWithHttpInfo(InlineObject7 configuration, bool? keepOverrides = default(bool?), bool? keepVersions = default(bool?))
        {
            // verify the required parameter 'configuration' is set
            if (configuration == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'configuration' when calling PayexGatewayApi->AdminCheckoutIdGwPayexPut");
            ...
            if (keepOverrides != null)
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("", "keep_overrides", keepOverrides));
            }
            if (keepVersions != null)
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("", "keep_versions", keepVersions));
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Put<Object>("/admin/gateways/payex", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("AdminCheckoutIdGwPayexPut", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task AdminCheckoutIdGwPayexPutAsync(InlineObject7 configuration, bool? keepOverrides = default(bool?), bool? keepVersions = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await AdminCheckoutIdGwPayexPutWithHttpInfoAsync(configuration, keepOverrides, keepVersions, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object>> AdminCheckoutIdGwPayexPutWithHttpInfoAsync(InlineObject7 configuration, bool? keepOverrides = default(bool?), bool? keepVersions = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'configuration' is set
            if (configuration == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'configuration' when calling PayexGatewayApi->AdminCheckoutIdGwPayexPut");
            ...
            var localVarResponse = await this.AsynchronousClient.PutAsync<Object>("/admin/gateways/payex", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
