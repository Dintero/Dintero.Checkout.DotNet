...
namespace Dintero.OpenApiClient.Checkout.Api
{
    ...
    public interface ISessionApiSync : IApiAccessor
    {
        ...
        InlineResponse2008 CheckoutPaymentTokenSessionPost(InlineObject18 options, bool? includeSession = default(bool?));
        ...
        ApiResponse<InlineResponse2008> CheckoutPaymentTokenSessionPostWithHttpInfo(InlineObject18 options, bool? includeSession = default(bool?));
        /// <summary>
        /// Cancel session
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<InlineResponse2009> CheckoutSessionCancelPostWithHttpInfo(string sessionId);
        /// <summary>
        ...
        /// <param name="sessionId">The session ID</param>
        /// <returns>ApiResponse of InlineResponse2009</returns>
        ApiResponse<InlineResponse2009> CheckoutSessionGetWithHttpInfo(string sessionId);
        /// <summary>
        ...
        /// <param name="search">Will try to match the search to either merchant_reference, merchant_reference_2, or the customer name using the format &#x60;{first_name} {last_name}&#x60;.  (optional)</param>
        /// <param name="transactionId">The id(s) of the transaction(s) that should be included in the result (optional)</param>
        /// <param name="createdAtGte">Session created after (ISO 8601. We recommend using a localised ISO 8601 datetime like &#x60;2017-07-21T17:32:28Z&#x60;. If a timezone is not specified we assume UTC) (optional)</param>
        /// <param name="createdAtLte">Session created before a date (ISO 8601. We recommend using a localised ISO 8601 datetime like &#x60;2017-07-21T17:32:28Z&#x60;. If a timezone is not specified we assume UTC) (optional)</param>
        /// <param name="storeId">The store_id that the session relates to. ?store_id&#x3D;A&amp;store_id&#x3D;B&amp;store_id&#x3D;X.  (optional)</param>
        /// <returns>List&lt;Id&gt;</returns>
        List<Id> CheckoutSessionsGet(int? limit = default(int?), string startingAfter = default(string), List<string> id = default(List<string>), string search = default(string), List<string> transactionId = default(List<string>), string createdAtGte = default(string), string createdAtLte = default(string), List<string> storeId = default(List<string>));
        ...
        /// <param name="createdAtLte">Session created before a date (ISO 8601. We recommend using a localised ISO 8601 datetime like &#x60;2017-07-21T17:32:28Z&#x60;. If a timezone is not specified we assume UTC) (optional)</param>
        /// <param name="storeId">The store_id that the session relates to. ?store_id&#x3D;A&amp;store_id&#x3D;B&amp;store_id&#x3D;X.  (optional)</param>
        /// <returns>ApiResponse of List&lt;Id&gt;</returns>
        ApiResponse<List<Id>> CheckoutSessionsGetWithHttpInfo(int? limit = default(int?), string startingAfter = default(string), List<string> id = default(List<string>), string search = default(string), List<string> transactionId = default(List<string>), string createdAtGte = default(string), string createdAtLte = default(string), List<string> storeId = default(List<string>));
    ...
    public interface ISessionApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<InlineResponse2008> CheckoutPaymentTokenSessionPostAsync(InlineObject18 options, bool? includeSession = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse2008>> CheckoutPaymentTokenSessionPostWithHttpInfoAsync(InlineObject18 options, bool? includeSession = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Cancel session
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<InlineResponse2009> CheckoutSessionCancelPostAsync(string sessionId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse2009>> CheckoutSessionCancelPostWithHttpInfoAsync(string sessionId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get checkout session details
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse2009</returns>
        System.Threading.Tasks.Task<InlineResponse2009> CheckoutSessionGetAsync(string sessionId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse2009)</returns>
        System.Threading.Tasks.Task<ApiResponse<InlineResponse2009>> CheckoutSessionGetWithHttpInfoAsync(string sessionId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Create a checkout session
        /// </summary>
        /// <remarks>
        ...
        /// <param name="storeId">The store_id that the session relates to. ?store_id&#x3D;A&amp;store_id&#x3D;B&amp;store_id&#x3D;X.  (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;Id&gt;</returns>
        System.Threading.Tasks.Task<List<Id>> CheckoutSessionsGetAsync(int? limit = default(int?), string startingAfter = default(string), List<string> id = default(List<string>), string search = default(string), List<string> transactionId = default(List<string>), string createdAtGte = default(string), string createdAtLte = default(string), List<string> storeId = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="storeId">The store_id that the session relates to. ?store_id&#x3D;A&amp;store_id&#x3D;B&amp;store_id&#x3D;X.  (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;Id&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<Id>>> CheckoutSessionsGetWithHttpInfoAsync(int? limit = default(int?), string startingAfter = default(string), List<string> id = default(List<string>), string search = default(string), List<string> transactionId = default(List<string>), string createdAtGte = default(string), string createdAtLte = default(string), List<string> storeId = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class SessionApi : ISessionApi
    {
        ...
        /// <returns></returns>
        public SessionApi(Dintero.OpenApiClient.Checkout.Client.Configuration configuration)
        {
        ...
        public SessionApi(Dintero.OpenApiClient.Checkout.Client.ISynchronousClient client, Dintero.OpenApiClient.Checkout.Client.IAsynchronousClient asyncClient, Dintero.OpenApiClient.Checkout.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Payment token session  This endpoint lets you create payment tokens without reserving or charging any amount.  The URL returned by this endpoint opens a web site where the customer can enter their payment details, e.g. card information.  The payment details will be validated and a transaction with a payment token will be created on success containing the payment token created from the customer payment details.  - [GET /v1/transactions/{id}?includes&#x3D;card.payment_token](#operation/transactions_id_get)  scopes: - admin:checkout - write:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="options"></param>
        /// <param name="includeSession">Include all details about the session created  (optional)</param>
        /// <returns>InlineResponse2008</returns>
        public InlineResponse2008 CheckoutPaymentTokenSessionPost(InlineObject18 options, bool? includeSession = default(bool?))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2008> localVarResponse = CheckoutPaymentTokenSessionPostWithHttpInfo(options, includeSession);
        ...
        /// <param name="includeSession">Include all details about the session created  (optional)</param>
        /// <returns>ApiResponse of InlineResponse2008</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2008> CheckoutPaymentTokenSessionPostWithHttpInfo(InlineObject18 options, bool? includeSession = default(bool?))
        {
            // verify the required parameter 'options' is set
            if (options == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'options' when calling SessionApi->CheckoutPaymentTokenSessionPost");
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("", "include_session", includeSession));
            }
            ...
            var localVarResponse = this.Client.Post<InlineResponse2008>("/sessions/payment-token", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CheckoutPaymentTokenSessionPost", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse2008</returns>
        public async System.Threading.Tasks.Task<InlineResponse2008> CheckoutPaymentTokenSessionPostAsync(InlineObject18 options, bool? includeSession = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2008> localVarResponse = await CheckoutPaymentTokenSessionPostWithHttpInfoAsync(options, includeSession, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse2008)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2008>> CheckoutPaymentTokenSessionPostWithHttpInfoAsync(InlineObject18 options, bool? includeSession = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'options' is set
            if (options == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'options' when calling SessionApi->CheckoutPaymentTokenSessionPost");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<InlineResponse2008>("/sessions/payment-token", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Cancel session  Cancel a session  The session transaction will be voided in case where it is initialized or authorized.  Cancel is not allowed in case where the current transaction state is not initialized or authorized.  scopes: - admin:checkout - write:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="sessionId">The session ID</param>
        /// <returns>InlineResponse2009</returns>
        public InlineResponse2009 CheckoutSessionCancelPost(string sessionId)
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2009> localVarResponse = CheckoutSessionCancelPostWithHttpInfo(sessionId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="sessionId">The session ID</param>
        /// <returns>ApiResponse of InlineResponse2009</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2009> CheckoutSessionCancelPostWithHttpInfo(string sessionId)
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling SessionApi->CheckoutSessionCancelPost");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<InlineResponse2009>("/sessions/{session_id}/cancel", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CheckoutSessionCancelPost", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse2009</returns>
        public async System.Threading.Tasks.Task<InlineResponse2009> CheckoutSessionCancelPostAsync(string sessionId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2009> localVarResponse = await CheckoutSessionCancelPostWithHttpInfoAsync(sessionId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse2009)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2009>> CheckoutSessionCancelPostWithHttpInfoAsync(string sessionId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling SessionApi->CheckoutSessionCancelPost");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<InlineResponse2009>("/sessions/{session_id}/cancel", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Get checkout session details scopes: - admin:checkout - read:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="sessionId">The session ID</param>
        /// <returns>InlineResponse2009</returns>
        public InlineResponse2009 CheckoutSessionGet(string sessionId)
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2009> localVarResponse = CheckoutSessionGetWithHttpInfo(sessionId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="sessionId">The session ID</param>
        /// <returns>ApiResponse of InlineResponse2009</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2009> CheckoutSessionGetWithHttpInfo(string sessionId)
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling SessionApi->CheckoutSessionGet");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<InlineResponse2009>("/sessions/{session_id}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CheckoutSessionGet", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse2009</returns>
        public async System.Threading.Tasks.Task<InlineResponse2009> CheckoutSessionGetAsync(string sessionId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2009> localVarResponse = await CheckoutSessionGetWithHttpInfoAsync(sessionId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse2009)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2009>> CheckoutSessionGetWithHttpInfoAsync(string sessionId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling SessionApi->CheckoutSessionGet");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<InlineResponse2009>("/sessions/{session_id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Create a checkout session Create a corresponding Checkout Session for an order placed in your system  #### Session with Instabank  Note that &#x60;items&#x60; is a required property when creating a session with Instabank configured.  scopes: - admin:checkout - write:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="options"></param>
        /// <param name="includeSession">Include all details about the session created  (optional)</param>
        ...
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2008> CheckoutSessionPostWithHttpInfo(UNKNOWN_BASE_TYPE options, bool? includeSession = default(bool?))
        {
            // verify the required parameter 'options' is set
            if (options == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'options' when calling SessionApi->CheckoutSessionPost");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<InlineResponse2008>("/sessions", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CheckoutSessionPost", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2008>> CheckoutSessionPostWithHttpInfoAsync(UNKNOWN_BASE_TYPE options, bool? includeSession = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<InlineResponse2008>("/sessions", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Create checkout session from profile Create a corresponding Checkout Session for an order placed in your system using predefined session profile  #### Session with Instabank  Note that &#x60;items&#x60; is a required property when creating a session with Instabank configured.  scopes: - admin:checkout - write:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="options"></param>
        /// <param name="includeSession">Include all details about the session created  (optional)</param>
        ...
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2008> CheckoutSessionProfilePostWithHttpInfo(UNKNOWN_BASE_TYPE options, bool? includeSession = default(bool?))
        {
            // verify the required parameter 'options' is set
            if (options == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'options' when calling SessionApi->CheckoutSessionProfilePost");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<InlineResponse2008>("/sessions-profile", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CheckoutSessionProfilePost", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2008>> CheckoutSessionProfilePostWithHttpInfoAsync(UNKNOWN_BASE_TYPE options, bool? includeSession = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<InlineResponse2008>("/sessions-profile", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Update checkout session details Session must be locked for paying before updating.  scopes: - admin:checkout - read:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="sessionId">The session ID</param>
        /// <param name="options"></param>
        ...
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2009> CheckoutSessionPutWithHttpInfo(string sessionId, UNKNOWN_BASE_TYPE options)
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling SessionApi->CheckoutSessionPut");

            // verify the required parameter 'options' is set
            if (options == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'options' when calling SessionApi->CheckoutSessionPut");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Put<InlineResponse2009>("/sessions/{session_id}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CheckoutSessionPut", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2009>> CheckoutSessionPutWithHttpInfoAsync(string sessionId, UNKNOWN_BASE_TYPE options, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PutAsync<InlineResponse2009>("/sessions/{session_id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// List checkout sessions List all Checkout sessions scopes: - admin:checkout - read:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="limit">A limit on the number of objects to be returned. Limit can range between 1 and 100 items, and the default is 10 items.  (optional, default to 10)</param>
        /// <param name="startingAfter">cursor for use in pagination. starting_after is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with &#x60;obj_foo&#x60;, your subsequent call can include &#x60;starting_after&#x3D;obj_foo&#x60; in order to fetch the next page of the list.  (optional)</param>
        ...
        /// <param name="storeId">The store_id that the session relates to. ?store_id&#x3D;A&amp;store_id&#x3D;B&amp;store_id&#x3D;X.  (optional)</param>
        /// <returns>List&lt;Id&gt;</returns>
        public List<Id> CheckoutSessionsGet(int? limit = default(int?), string startingAfter = default(string), List<string> id = default(List<string>), string search = default(string), List<string> transactionId = default(List<string>), string createdAtGte = default(string), string createdAtLte = default(string), List<string> storeId = default(List<string>))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<List<Id>> localVarResponse = CheckoutSessionsGetWithHttpInfo(limit, startingAfter, id, search, transactionId, createdAtGte, createdAtLte, storeId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="storeId">The store_id that the session relates to. ?store_id&#x3D;A&amp;store_id&#x3D;B&amp;store_id&#x3D;X.  (optional)</param>
        /// <returns>ApiResponse of List&lt;Id&gt;</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<List<Id>> CheckoutSessionsGetWithHttpInfo(int? limit = default(int?), string startingAfter = default(string), List<string> id = default(List<string>), string search = default(string), List<string> transactionId = default(List<string>), string createdAtGte = default(string), string createdAtLte = default(string), List<string> storeId = default(List<string>))
        {
            Dintero.OpenApiClient.Checkout.Client.RequestOptions localVarRequestOptions = new Dintero.OpenApiClient.Checkout.Client.RequestOptions();
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("multi", "transaction_id", transactionId));
            }
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<List<Id>>("/sessions", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CheckoutSessionsGet", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<List<Id>> localVarResponse = await CheckoutSessionsGetWithHttpInfoAsync(limit, startingAfter, id, search, transactionId, createdAtGte, createdAtLte, storeId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;Id&gt;)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<List<Id>>> CheckoutSessionsGetWithHttpInfoAsync(int? limit = default(int?), string startingAfter = default(string), List<string> id = default(List<string>), string search = default(string), List<string> transactionId = default(List<string>), string createdAtGte = default(string), string createdAtLte = default(string), List<string> storeId = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<Id>>("/sessions", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
