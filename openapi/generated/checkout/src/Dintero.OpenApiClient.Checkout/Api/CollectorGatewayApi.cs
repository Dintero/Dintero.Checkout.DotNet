...
namespace Dintero.OpenApiClient.Checkout.Api
{
    ...
    /// </summary>
    public interface ICollectorGatewayApiSync : IApiAccessor
    {
        ...
        ApiResponse<Object> AdminCheckoutIdGwCollectorPutWithHttpInfo(InlineObject1 configuration);
        /// <summary>
        ...
        /// <returns></returns>
        void AdminCheckoutIdGwOverrideCollectorPut(InlineObject2 configuration = default(InlineObject2));
        ...
        /// <param name="configuration"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> AdminCheckoutIdGwOverrideCollectorPutWithHttpInfo(InlineObject2 configuration = default(InlineObject2));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ICollectorGatewayApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task AdminCheckoutIdGwCollectorPutAsync(InlineObject1 configuration, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> AdminCheckoutIdGwCollectorPutWithHttpInfoAsync(InlineObject1 configuration, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Update overrides for Collector Gateway
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task AdminCheckoutIdGwOverrideCollectorPutAsync(InlineObject2 configuration = default(InlineObject2), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> AdminCheckoutIdGwOverrideCollectorPutWithHttpInfoAsync(InlineObject2 configuration = default(InlineObject2), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ICollectorGatewayApi : ICollectorGatewayApiSync, ICollectorGatewayApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class CollectorGatewayApi : ICollectorGatewayApi
    {
        private Dintero.OpenApiClient.Checkout.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="CollectorGatewayApi"/> class.
        /// </summary>
        /// <returns></returns>
        public CollectorGatewayApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public CollectorGatewayApi(String basePath)
        {
        ...
        /// <returns></returns>
        public CollectorGatewayApi(Dintero.OpenApiClient.Checkout.Client.Configuration configuration)
        {
        ...
        public CollectorGatewayApi(Dintero.OpenApiClient.Checkout.Client.ISynchronousClient client, Dintero.OpenApiClient.Checkout.Client.IAsynchronousClient asyncClient, Dintero.OpenApiClient.Checkout.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Update Collector gateway scopes: - admin:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="configuration"></param>
        /// <returns></returns>
        public void AdminCheckoutIdGwCollectorPut(InlineObject1 configuration)
        {
            AdminCheckoutIdGwCollectorPutWithHttpInfo(configuration);
        }
        ...
        /// <param name="configuration"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object> AdminCheckoutIdGwCollectorPutWithHttpInfo(InlineObject1 configuration)
        {
            // verify the required parameter 'configuration' is set
            if (configuration == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'configuration' when calling CollectorGatewayApi->AdminCheckoutIdGwCollectorPut");
            ...
            var localVarResponse = this.Client.Put<Object>("/admin/gateways/collector", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("AdminCheckoutIdGwCollectorPut", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task AdminCheckoutIdGwCollectorPutAsync(InlineObject1 configuration, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await AdminCheckoutIdGwCollectorPutWithHttpInfoAsync(configuration, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object>> AdminCheckoutIdGwCollectorPutWithHttpInfoAsync(InlineObject1 configuration, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'configuration' is set
            if (configuration == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'configuration' when calling CollectorGatewayApi->AdminCheckoutIdGwCollectorPut");
            ...
            var localVarResponse = await this.AsynchronousClient.PutAsync<Object>("/admin/gateways/collector", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Update overrides for Collector Gateway scopes: - admin:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="configuration"> (optional)</param>
        /// <returns></returns>
        public void AdminCheckoutIdGwOverrideCollectorPut(InlineObject2 configuration = default(InlineObject2))
        {
            AdminCheckoutIdGwOverrideCollectorPutWithHttpInfo(configuration);
        }
        ...
        /// <param name="configuration"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object> AdminCheckoutIdGwOverrideCollectorPutWithHttpInfo(InlineObject2 configuration = default(InlineObject2))
        {
            Dintero.OpenApiClient.Checkout.Client.RequestOptions localVarRequestOptions = new Dintero.OpenApiClient.Checkout.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Put<Object>("/admin/gateways/collector/override", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("AdminCheckoutIdGwOverrideCollectorPut", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task AdminCheckoutIdGwOverrideCollectorPutAsync(InlineObject2 configuration = default(InlineObject2), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await AdminCheckoutIdGwOverrideCollectorPutWithHttpInfoAsync(configuration, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object>> AdminCheckoutIdGwOverrideCollectorPutWithHttpInfoAsync(InlineObject2 configuration = default(InlineObject2), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PutAsync<Object>("/admin/gateways/collector/override", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
