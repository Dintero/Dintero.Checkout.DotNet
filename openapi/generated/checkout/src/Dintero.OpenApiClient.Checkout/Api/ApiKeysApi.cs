...
namespace Dintero.OpenApiClient.Checkout.Api
{
    ...
    public interface IApiKeysApiSync : IApiAccessor
    {
        ...
        ApiResponse<InlineResponse200> AdminApiKeysApiKeyIdRotatePostWithHttpInfo(string apiKeyId);
        /// <summary>
        /// List api-keys
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="includeDeleted">include deleted api-keys in the response  (optional, default to false)</param>
        ...
        /// <returns>List&lt;ApiKeyRead&gt;</returns>
        List<ApiKeyRead> AdminApiKeysGet(bool? includeDeleted = default(bool?), int? limit = default(int?), string startingAfter = default(string));
        ...
        /// <param name="limit">A limit on the number of objects to be returned. Limit can range between 1 and 100 items, and the default is 10 items.  (optional, default to 10)</param>
        /// <param name="startingAfter">cursor for use in pagination. starting_after is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with &#x60;obj_foo&#x60;, your subsequent call can include &#x60;starting_after&#x3D;obj_foo&#x60; in order to fetch the next page of the list.  (optional)</param>
        /// <returns>ApiResponse of List&lt;ApiKeyRead&gt;</returns>
        ApiResponse<List<ApiKeyRead>> AdminApiKeysGetWithHttpInfo(bool? includeDeleted = default(bool?), int? limit = default(int?), string startingAfter = default(string));
        /// <summary>
        /// Create api-key
        /// </summary>
        /// <remarks>
        ...
        /// <param name="configuration"></param>
        /// <returns>ApiResponse of InlineResponse200</returns>
        ApiResponse<InlineResponse200> AdminApiKeysPostWithHttpInfo(UNKNOWN_BASE_TYPE configuration);
        /// <summary>
        /// Delete api-key
        /// </summary>
        /// <remarks>
        ...
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="apiKeyId"></param>
        /// <returns>ApiResponse of ApiKeyRead</returns>
        ApiResponse<ApiKeyRead> AdminParametersApiKeyDeleteWithHttpInfo(string apiKeyId);
    ...
    public interface IApiKeysApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<InlineResponse200> AdminApiKeysApiKeyIdRotatePostAsync(string apiKeyId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse200>> AdminApiKeysApiKeyIdRotatePostWithHttpInfoAsync(string apiKeyId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// List api-keys
        /// </summary>
        /// <remarks>
        ...
        /// <param name="startingAfter">cursor for use in pagination. starting_after is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with &#x60;obj_foo&#x60;, your subsequent call can include &#x60;starting_after&#x3D;obj_foo&#x60; in order to fetch the next page of the list.  (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;ApiKeyRead&gt;</returns>
        System.Threading.Tasks.Task<List<ApiKeyRead>> AdminApiKeysGetAsync(bool? includeDeleted = default(bool?), int? limit = default(int?), string startingAfter = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="startingAfter">cursor for use in pagination. starting_after is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with &#x60;obj_foo&#x60;, your subsequent call can include &#x60;starting_after&#x3D;obj_foo&#x60; in order to fetch the next page of the list.  (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;ApiKeyRead&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<ApiKeyRead>>> AdminApiKeysGetWithHttpInfoAsync(bool? includeDeleted = default(bool?), int? limit = default(int?), string startingAfter = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Create api-key
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse200</returns>
        System.Threading.Tasks.Task<InlineResponse200> AdminApiKeysPostAsync(UNKNOWN_BASE_TYPE configuration, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse200)</returns>
        System.Threading.Tasks.Task<ApiResponse<InlineResponse200>> AdminApiKeysPostWithHttpInfoAsync(UNKNOWN_BASE_TYPE configuration, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Delete api-key
        /// </summary>
        /// <remarks>
        ...
        /// <param name="apiKeyId"></param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiKeyRead</returns>
        System.Threading.Tasks.Task<ApiKeyRead> AdminParametersApiKeyDeleteAsync(string apiKeyId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="apiKeyId"></param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ApiKeyRead)</returns>
        System.Threading.Tasks.Task<ApiResponse<ApiKeyRead>> AdminParametersApiKeyDeleteWithHttpInfoAsync(string apiKeyId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class ApiKeysApi : IApiKeysApi
    {
        ...
        /// <returns></returns>
        public ApiKeysApi(Dintero.OpenApiClient.Checkout.Client.Configuration configuration)
        {
        ...
        public ApiKeysApi(Dintero.OpenApiClient.Checkout.Client.ISynchronousClient client, Dintero.OpenApiClient.Checkout.Client.IAsynchronousClient asyncClient, Dintero.OpenApiClient.Checkout.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Rotate api-key scopes: - admin:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="apiKeyId"></param>
        /// <returns>InlineResponse200</returns>
        public InlineResponse200 AdminApiKeysApiKeyIdRotatePost(string apiKeyId)
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse200> localVarResponse = AdminApiKeysApiKeyIdRotatePostWithHttpInfo(apiKeyId);
        ...
        /// <param name="apiKeyId"></param>
        /// <returns>ApiResponse of InlineResponse200</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse200> AdminApiKeysApiKeyIdRotatePostWithHttpInfo(string apiKeyId)
        {
            // verify the required parameter 'apiKeyId' is set
            if (apiKeyId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'apiKeyId' when calling ApiKeysApi->AdminApiKeysApiKeyIdRotatePost");
            ...
            localVarRequestOptions.PathParameters.Add("api_key_id", Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToString(apiKeyId)); // path parameter
            ...
            var localVarResponse = this.Client.Post<InlineResponse200>("/admin/api-keys/{api_key_id}/rotate-api-key", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("AdminApiKeysApiKeyIdRotatePost", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse200</returns>
        public async System.Threading.Tasks.Task<InlineResponse200> AdminApiKeysApiKeyIdRotatePostAsync(string apiKeyId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse200> localVarResponse = await AdminApiKeysApiKeyIdRotatePostWithHttpInfoAsync(apiKeyId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse200)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse200>> AdminApiKeysApiKeyIdRotatePostWithHttpInfoAsync(string apiKeyId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'apiKeyId' is set
            if (apiKeyId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'apiKeyId' when calling ApiKeysApi->AdminApiKeysApiKeyIdRotatePost");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<InlineResponse200>("/admin/api-keys/{api_key_id}/rotate-api-key", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// List api-keys scopes: - admin:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="includeDeleted">include deleted api-keys in the response  (optional, default to false)</param>
        /// <param name="limit">A limit on the number of objects to be returned. Limit can range between 1 and 100 items, and the default is 10 items.  (optional, default to 10)</param>
        /// <param name="startingAfter">cursor for use in pagination. starting_after is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with &#x60;obj_foo&#x60;, your subsequent call can include &#x60;starting_after&#x3D;obj_foo&#x60; in order to fetch the next page of the list.  (optional)</param>
        /// <returns>List&lt;ApiKeyRead&gt;</returns>
        public List<ApiKeyRead> AdminApiKeysGet(bool? includeDeleted = default(bool?), int? limit = default(int?), string startingAfter = default(string))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<List<ApiKeyRead>> localVarResponse = AdminApiKeysGetWithHttpInfo(includeDeleted, limit, startingAfter);
            return localVarResponse.Data;
        }
        ...
        /// <param name="startingAfter">cursor for use in pagination. starting_after is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with &#x60;obj_foo&#x60;, your subsequent call can include &#x60;starting_after&#x3D;obj_foo&#x60; in order to fetch the next page of the list.  (optional)</param>
        /// <returns>ApiResponse of List&lt;ApiKeyRead&gt;</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<List<ApiKeyRead>> AdminApiKeysGetWithHttpInfo(bool? includeDeleted = default(bool?), int? limit = default(int?), string startingAfter = default(string))
        {
            Dintero.OpenApiClient.Checkout.Client.RequestOptions localVarRequestOptions = new Dintero.OpenApiClient.Checkout.Client.RequestOptions();
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("", "include_deleted", includeDeleted));
            }
            if (limit != null)
            {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<List<ApiKeyRead>>("/admin/api-keys", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("AdminApiKeysGet", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;ApiKeyRead&gt;</returns>
        public async System.Threading.Tasks.Task<List<ApiKeyRead>> AdminApiKeysGetAsync(bool? includeDeleted = default(bool?), int? limit = default(int?), string startingAfter = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<List<ApiKeyRead>> localVarResponse = await AdminApiKeysGetWithHttpInfoAsync(includeDeleted, limit, startingAfter, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;ApiKeyRead&gt;)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<List<ApiKeyRead>>> AdminApiKeysGetWithHttpInfoAsync(bool? includeDeleted = default(bool?), int? limit = default(int?), string startingAfter = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<ApiKeyRead>>("/admin/api-keys", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Create api-key scopes: - admin:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="configuration"></param>
        /// <returns>InlineResponse200</returns>
        public InlineResponse200 AdminApiKeysPost(UNKNOWN_BASE_TYPE configuration)
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse200> localVarResponse = AdminApiKeysPostWithHttpInfo(configuration);
            return localVarResponse.Data;
        }
        ...
        /// <param name="configuration"></param>
        /// <returns>ApiResponse of InlineResponse200</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse200> AdminApiKeysPostWithHttpInfo(UNKNOWN_BASE_TYPE configuration)
        {
            // verify the required parameter 'configuration' is set
            if (configuration == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'configuration' when calling ApiKeysApi->AdminApiKeysPost");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<InlineResponse200>("/admin/api-keys", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("AdminApiKeysPost", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse200</returns>
        public async System.Threading.Tasks.Task<InlineResponse200> AdminApiKeysPostAsync(UNKNOWN_BASE_TYPE configuration, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse200> localVarResponse = await AdminApiKeysPostWithHttpInfoAsync(configuration, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse200)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse200>> AdminApiKeysPostWithHttpInfoAsync(UNKNOWN_BASE_TYPE configuration, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'configuration' is set
            if (configuration == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'configuration' when calling ApiKeysApi->AdminApiKeysPost");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<InlineResponse200>("/admin/api-keys", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Delete api-key scopes: - admin:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="apiKeyId"></param>
        /// <returns>ApiKeyRead</returns>
        public ApiKeyRead AdminParametersApiKeyDelete(string apiKeyId)
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<ApiKeyRead> localVarResponse = AdminParametersApiKeyDeleteWithHttpInfo(apiKeyId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="apiKeyId"></param>
        /// <returns>ApiResponse of ApiKeyRead</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<ApiKeyRead> AdminParametersApiKeyDeleteWithHttpInfo(string apiKeyId)
        {
            // verify the required parameter 'apiKeyId' is set
            if (apiKeyId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'apiKeyId' when calling ApiKeysApi->AdminParametersApiKeyDelete");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Delete<ApiKeyRead>("/admin/api-keys/{api_key_id}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("AdminParametersApiKeyDelete", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiKeyRead</returns>
        public async System.Threading.Tasks.Task<ApiKeyRead> AdminParametersApiKeyDeleteAsync(string apiKeyId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<ApiKeyRead> localVarResponse = await AdminParametersApiKeyDeleteWithHttpInfoAsync(apiKeyId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ApiKeyRead)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<ApiKeyRead>> AdminParametersApiKeyDeleteWithHttpInfoAsync(string apiKeyId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'apiKeyId' is set
            if (apiKeyId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'apiKeyId' when calling ApiKeysApi->AdminParametersApiKeyDelete");
            ...
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<ApiKeyRead>("/admin/api-keys/{api_key_id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
