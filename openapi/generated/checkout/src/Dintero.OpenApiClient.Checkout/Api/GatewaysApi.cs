...
namespace Dintero.OpenApiClient.Checkout.Api
{
    ...
    public interface IGatewaysApiSync : IApiAccessor
    {
        ...
        ApiResponse<InlineResponse2002> AdminCheckoutGwTypeStatusPostWithHttpInfo(string gateway);
        /// <summary>
        ...
        ApiResponse<Transaction> EventsTransactionPostWithHttpInfo(string intent, UNKNOWN_BASE_TYPE data);
    ...
    public interface IGatewaysApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<InlineResponse2002> AdminCheckoutGwTypeStatusPostAsync(string gateway, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse2002>> AdminCheckoutGwTypeStatusPostWithHttpInfoAsync(string gateway, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// process transaction event
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<Transaction> EventsTransactionPostAsync(string intent, UNKNOWN_BASE_TYPE data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Transaction>> EventsTransactionPostWithHttpInfoAsync(string intent, UNKNOWN_BASE_TYPE data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class GatewaysApi : IGatewaysApi
    {
        ...
        /// <returns></returns>
        public GatewaysApi(Dintero.OpenApiClient.Checkout.Client.Configuration configuration)
        {
        ...
        public GatewaysApi(Dintero.OpenApiClient.Checkout.Client.ISynchronousClient client, Dintero.OpenApiClient.Checkout.Client.IAsynchronousClient asyncClient, Dintero.OpenApiClient.Checkout.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Check gateway status verify the gateway configuration  scopes: - admin:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="gateway"></param>
        /// <returns>InlineResponse2002</returns>
        public InlineResponse2002 AdminCheckoutGwTypeStatusPost(string gateway)
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2002> localVarResponse = AdminCheckoutGwTypeStatusPostWithHttpInfo(gateway);
        ...
        /// <param name="gateway"></param>
        /// <returns>ApiResponse of InlineResponse2002</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2002> AdminCheckoutGwTypeStatusPostWithHttpInfo(string gateway)
        {
            // verify the required parameter 'gateway' is set
            if (gateway == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'gateway' when calling GatewaysApi->AdminCheckoutGwTypeStatusPost");
            ...
            localVarRequestOptions.PathParameters.Add("gateway", Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToString(gateway)); // path parameter
            ...
            var localVarResponse = this.Client.Post<InlineResponse2002>("/admin/gateways/{gateway}/status", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("AdminCheckoutGwTypeStatusPost", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse2002</returns>
        public async System.Threading.Tasks.Task<InlineResponse2002> AdminCheckoutGwTypeStatusPostAsync(string gateway, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2002> localVarResponse = await AdminCheckoutGwTypeStatusPostWithHttpInfoAsync(gateway, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse2002)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse2002>> AdminCheckoutGwTypeStatusPostWithHttpInfoAsync(string gateway, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'gateway' is set
            if (gateway == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'gateway' when calling GatewaysApi->AdminCheckoutGwTypeStatusPost");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<InlineResponse2002>("/admin/gateways/{gateway}/status", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// process transaction event Handle async update of transaction.  scopes: - admin:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="intent">**retry_auto_capture**  Retry the capture of a transaction that was created by a session with auto-capture enabled. A success is return if the transaction new state is captured.  **cancel_unknown**  Cancel a transaction that failed the athorization check done before the redirect to the merchant.  **sync_status**  Sync the status of a transaction that is not in sync with the status in the payment gateway  **poll_initiated**  Poll the status of a transaction with status &#x60;INITIATED&#x60; from the payment gateway. Trigger callback on transaction if the payment gateway status is no longer &#x60;INITIATED&#x60; &gt; Intended for cases where expected callback from payment gateway &gt; was never received </param>
        /// <param name="data"></param>
        /// <returns>Transaction</returns>
        public Transaction EventsTransactionPost(string intent, UNKNOWN_BASE_TYPE data)
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<Transaction> localVarResponse = EventsTransactionPostWithHttpInfo(intent, data);
            return localVarResponse.Data;
        }
        ...
        /// <param name="data"></param>
        /// <returns>ApiResponse of Transaction</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<Transaction> EventsTransactionPostWithHttpInfo(string intent, UNKNOWN_BASE_TYPE data)
        {
            // verify the required parameter 'intent' is set
            if (intent == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'intent' when calling GatewaysApi->EventsTransactionPost");

            // verify the required parameter 'data' is set
            if (data == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'data' when calling GatewaysApi->EventsTransactionPost");
            ...
            localVarRequestOptions.PathParameters.Add("intent", Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToString(intent)); // path parameter
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Transaction>("/events/transaction/{intent}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("EventsTransactionPost", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Transaction</returns>
        public async System.Threading.Tasks.Task<Transaction> EventsTransactionPostAsync(string intent, UNKNOWN_BASE_TYPE data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<Transaction> localVarResponse = await EventsTransactionPostWithHttpInfoAsync(intent, data, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Transaction)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<Transaction>> EventsTransactionPostWithHttpInfoAsync(string intent, UNKNOWN_BASE_TYPE data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'intent' is set
            if (intent == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'intent' when calling GatewaysApi->EventsTransactionPost");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<Transaction>("/events/transaction/{intent}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
