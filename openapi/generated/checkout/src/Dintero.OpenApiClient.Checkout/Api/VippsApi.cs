...
namespace Dintero.OpenApiClient.Checkout.Api
{
    ...
    /// </summary>
    public interface IVippsApiSync : IApiAccessor
    {
        ...
        ApiResponse<Object> CheckoutSidHtmlVippsGetWithHttpInfo(string sessionId);
        /// <summary>
        ...
        /// <param name="callback"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> CheckoutSidVippsPaymentsOrderidPostWithHttpInfo(string sessionId, string orderId, UNKNOWN_BASE_TYPE callback);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IVippsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task CheckoutSidHtmlVippsGetAsync(string sessionId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> CheckoutSidHtmlVippsGetWithHttpInfoAsync(string sessionId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Handle Vipps callback after the payment request
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task CheckoutSidVippsPaymentsOrderidPostAsync(string sessionId, string orderId, UNKNOWN_BASE_TYPE callback, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> CheckoutSidVippsPaymentsOrderidPostWithHttpInfoAsync(string sessionId, string orderId, UNKNOWN_BASE_TYPE callback, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IVippsApi : IVippsApiSync, IVippsApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class VippsApi : IVippsApi
    {
        private Dintero.OpenApiClient.Checkout.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="VippsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public VippsApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public VippsApi(String basePath)
        {
        ...
        /// <returns></returns>
        public VippsApi(Dintero.OpenApiClient.Checkout.Client.Configuration configuration)
        {
        ...
        public VippsApi(Dintero.OpenApiClient.Checkout.Client.ISynchronousClient client, Dintero.OpenApiClient.Checkout.Client.IAsynchronousClient asyncClient, Dintero.OpenApiClient.Checkout.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="sessionId">The session ID</param>
        /// <returns></returns>
        public void CheckoutSidHtmlVippsGet(string sessionId)
        {
            CheckoutSidHtmlVippsGetWithHttpInfo(sessionId);
        }
        ...
        /// <param name="sessionId">The session ID</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object> CheckoutSidHtmlVippsGetWithHttpInfo(string sessionId)
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling VippsApi->CheckoutSidHtmlVippsGet");
            ...
            var localVarResponse = this.Client.Get<Object>("/view/{session_id}/vipps", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CheckoutSidHtmlVippsGet", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task CheckoutSidHtmlVippsGetAsync(string sessionId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await CheckoutSidHtmlVippsGetWithHttpInfoAsync(sessionId, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object>> CheckoutSidHtmlVippsGetWithHttpInfoAsync(string sessionId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling VippsApi->CheckoutSidHtmlVippsGet");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/view/{session_id}/vipps", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="callback"></param>
        /// <returns></returns>
        public void CheckoutSidVippsPaymentsOrderidPost(string sessionId, string orderId, UNKNOWN_BASE_TYPE callback)
        {
            CheckoutSidVippsPaymentsOrderidPostWithHttpInfo(sessionId, orderId, callback);
        }
        ...
        /// <param name="callback"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object> CheckoutSidVippsPaymentsOrderidPostWithHttpInfo(string sessionId, string orderId, UNKNOWN_BASE_TYPE callback)
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling VippsApi->CheckoutSidVippsPaymentsOrderidPost");

            // verify the required parameter 'orderId' is set
            if (orderId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'orderId' when calling VippsApi->CheckoutSidVippsPaymentsOrderidPost");

            // verify the required parameter 'callback' is set
            if (callback == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'callback' when calling VippsApi->CheckoutSidVippsPaymentsOrderidPost");
            ...
            localVarRequestOptions.PathParameters.Add("session_id", Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToString(sessionId)); // path parameter
            localVarRequestOptions.PathParameters.Add("order_id", Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToString(orderId)); // path parameter
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Object>("/sessions/{session_id}/vipps/v2/payments/{order_id}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CheckoutSidVippsPaymentsOrderidPost", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task CheckoutSidVippsPaymentsOrderidPostAsync(string sessionId, string orderId, UNKNOWN_BASE_TYPE callback, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await CheckoutSidVippsPaymentsOrderidPostWithHttpInfoAsync(sessionId, orderId, callback, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object>> CheckoutSidVippsPaymentsOrderidPostWithHttpInfoAsync(string sessionId, string orderId, UNKNOWN_BASE_TYPE callback, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling VippsApi->CheckoutSidVippsPaymentsOrderidPost");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/sessions/{session_id}/vipps/v2/payments/{order_id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
