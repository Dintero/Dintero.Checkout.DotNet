...
namespace Dintero.OpenApiClient.Checkout.Api
{
    ...
    /// </summary>
    public interface IGenerateCheckoutImageApiSync : IApiAccessor
    {
        ...
        /// <param name="logos">logos for payment types separated by underscore eg. &#x60;visa_mastercard_vipps_swish_instabank&#x60; </param>
        /// <param name="variant">Image variant, multi-colors or mono-colored. </param>
        /// <param name="color">rgb hex color without the \\# character or an rbg() or rgba() color code. </param>
        /// <param name="width">width of image </param>
        /// <param name="template">Template for branding image </param>
        /// <returns></returns>
        ...
        ApiResponse<Object> BrandingLogoframeWithHttpInfo(string logos, string variant, string color, string width, string template);
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="profileId">Profile Id like &#x60;P00112233.abc123def321aAabBb9z9cccDdd&#x60; </param>
        /// <param name="variant">Image variant, multi-colors or mono-colored. </param>
        /// <param name="color">rgb hex color without the \\# character or an rbg() or rgba() color code </param>
        /// <param name="width">width of image </param>
        /// <param name="template">Template for branding image </param>
        ...
        /// <param name="template">Template for branding image </param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> BrandingProfileWithHttpInfo(string profileId, string variant, string color, string width, string template);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IGenerateCheckoutImageApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task BrandingLogoframeAsync(string logos, string variant, string color, string width, string template, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> BrandingLogoframeWithHttpInfoAsync(string logos, string variant, string color, string width, string template, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get checkout profile image
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task BrandingProfileAsync(string profileId, string variant, string color, string width, string template, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> BrandingProfileWithHttpInfoAsync(string profileId, string variant, string color, string width, string template, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IGenerateCheckoutImageApi : IGenerateCheckoutImageApiSync, IGenerateCheckoutImageApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class GenerateCheckoutImageApi : IGenerateCheckoutImageApi
    {
        private Dintero.OpenApiClient.Checkout.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateCheckoutImageApi"/> class.
        /// </summary>
        /// <returns></returns>
        public GenerateCheckoutImageApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public GenerateCheckoutImageApi(String basePath)
        {
        ...
        /// <returns></returns>
        public GenerateCheckoutImageApi(Dintero.OpenApiClient.Checkout.Client.Configuration configuration)
        {
        ...
        public GenerateCheckoutImageApi(Dintero.OpenApiClient.Checkout.Client.ISynchronousClient client, Dintero.OpenApiClient.Checkout.Client.IAsynchronousClient asyncClient, Dintero.OpenApiClient.Checkout.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Get payment logos image Endpoint that returns an svg that can be used to show the world your payment options. [Go to the documentation for the checkout branding endpoints.](/docs/checkout-branding)
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="logos">logos for payment types separated by underscore eg. &#x60;visa_mastercard_vipps_swish_instabank&#x60; </param>
        /// <param name="variant">Image variant, multi-colors or mono-colored. </param>
        ...
        /// <param name="template">Template for branding image </param>
        /// <returns></returns>
        public void BrandingLogoframe(string logos, string variant, string color, string width, string template)
        {
            BrandingLogoframeWithHttpInfo(logos, variant, color, width, template);
        }
        ...
        /// <param name="template">Template for branding image </param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object> BrandingLogoframeWithHttpInfo(string logos, string variant, string color, string width, string template)
        {
            // verify the required parameter 'logos' is set
            if (logos == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'logos' when calling GenerateCheckoutImageApi->BrandingLogoframe");

            // verify the required parameter 'variant' is set
            if (variant == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'variant' when calling GenerateCheckoutImageApi->BrandingLogoframe");

            // verify the required parameter 'color' is set
            if (color == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'color' when calling GenerateCheckoutImageApi->BrandingLogoframe");

            // verify the required parameter 'width' is set
            if (width == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'width' when calling GenerateCheckoutImageApi->BrandingLogoframe");

            // verify the required parameter 'template' is set
            if (template == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'template' when calling GenerateCheckoutImageApi->BrandingLogoframe");
            ...
            localVarRequestOptions.PathParameters.Add("logos", Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToString(logos)); // path parameter
            localVarRequestOptions.PathParameters.Add("variant", Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToString(variant)); // path parameter
            localVarRequestOptions.PathParameters.Add("color", Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToString(color)); // path parameter
            localVarRequestOptions.PathParameters.Add("width", Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToString(width)); // path parameter
            localVarRequestOptions.PathParameters.Add("template", Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToString(template)); // path parameter
            ...
            var localVarResponse = this.Client.Get<Object>("/branding/logos/{logos}/variant/{variant}/color/{color}/width/{width}/{template}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("BrandingLogoframe", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task BrandingLogoframeAsync(string logos, string variant, string color, string width, string template, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await BrandingLogoframeWithHttpInfoAsync(logos, variant, color, width, template, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object>> BrandingLogoframeWithHttpInfoAsync(string logos, string variant, string color, string width, string template, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'logos' is set
            if (logos == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'logos' when calling GenerateCheckoutImageApi->BrandingLogoframe");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/branding/logos/{logos}/variant/{variant}/color/{color}/width/{width}/{template}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Get checkout profile image Endpoint that returns an svg that can be used to show the world your payment options. [Go to the documentation for the checkout branding endpoints.](/docs/checkout-branding)
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="profileId">Profile Id like &#x60;P00112233.abc123def321aAabBb9z9cccDdd&#x60; </param>
        /// <param name="variant">Image variant, multi-colors or mono-colored. </param>
        ...
        /// <param name="template">Template for branding image </param>
        /// <returns></returns>
        public void BrandingProfile(string profileId, string variant, string color, string width, string template)
        {
            BrandingProfileWithHttpInfo(profileId, variant, color, width, template);
        }
        ...
        /// <param name="template">Template for branding image </param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object> BrandingProfileWithHttpInfo(string profileId, string variant, string color, string width, string template)
        {
            // verify the required parameter 'profileId' is set
            if (profileId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'profileId' when calling GenerateCheckoutImageApi->BrandingProfile");

            // verify the required parameter 'variant' is set
            if (variant == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'variant' when calling GenerateCheckoutImageApi->BrandingProfile");

            // verify the required parameter 'color' is set
            if (color == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'color' when calling GenerateCheckoutImageApi->BrandingProfile");

            // verify the required parameter 'width' is set
            if (width == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'width' when calling GenerateCheckoutImageApi->BrandingProfile");

            // verify the required parameter 'template' is set
            if (template == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'template' when calling GenerateCheckoutImageApi->BrandingProfile");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<Object>("/branding/profiles/{profile_id}/variant/{variant}/color/{color}/width/{width}/{template}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("BrandingProfile", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task BrandingProfileAsync(string profileId, string variant, string color, string width, string template, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await BrandingProfileWithHttpInfoAsync(profileId, variant, color, width, template, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object>> BrandingProfileWithHttpInfoAsync(string profileId, string variant, string color, string width, string template, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'profileId' is set
            if (profileId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'profileId' when calling GenerateCheckoutImageApi->BrandingProfile");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/branding/profiles/{profile_id}/variant/{variant}/color/{color}/width/{width}/{template}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
