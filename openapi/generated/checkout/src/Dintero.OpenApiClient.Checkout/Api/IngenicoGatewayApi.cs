...
namespace Dintero.OpenApiClient.Checkout.Api
{
    ...
    /// </summary>
    public interface IIngenicoGatewayApiSync : IApiAccessor
    {
        ...
        ApiResponse<Object> AdminCheckoutIdGwIngenicoPutWithHttpInfo(InlineObject3 configuration);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IIngenicoGatewayApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task AdminCheckoutIdGwIngenicoPutAsync(InlineObject3 configuration, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> AdminCheckoutIdGwIngenicoPutWithHttpInfoAsync(InlineObject3 configuration, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IIngenicoGatewayApi : IIngenicoGatewayApiSync, IIngenicoGatewayApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class IngenicoGatewayApi : IIngenicoGatewayApi
    {
        private Dintero.OpenApiClient.Checkout.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="IngenicoGatewayApi"/> class.
        /// </summary>
        /// <returns></returns>
        public IngenicoGatewayApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public IngenicoGatewayApi(String basePath)
        {
        ...
        /// <returns></returns>
        public IngenicoGatewayApi(Dintero.OpenApiClient.Checkout.Client.Configuration configuration)
        {
        ...
        public IngenicoGatewayApi(Dintero.OpenApiClient.Checkout.Client.ISynchronousClient client, Dintero.OpenApiClient.Checkout.Client.IAsynchronousClient asyncClient, Dintero.OpenApiClient.Checkout.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Update Ingenico gateway scopes: - admin:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="configuration"></param>
        /// <returns></returns>
        public void AdminCheckoutIdGwIngenicoPut(InlineObject3 configuration)
        {
            AdminCheckoutIdGwIngenicoPutWithHttpInfo(configuration);
        }
        ...
        /// <param name="configuration"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object> AdminCheckoutIdGwIngenicoPutWithHttpInfo(InlineObject3 configuration)
        {
            // verify the required parameter 'configuration' is set
            if (configuration == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'configuration' when calling IngenicoGatewayApi->AdminCheckoutIdGwIngenicoPut");
            ...
            var localVarResponse = this.Client.Put<Object>("/admin/gateways/ingenico", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("AdminCheckoutIdGwIngenicoPut", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task AdminCheckoutIdGwIngenicoPutAsync(InlineObject3 configuration, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await AdminCheckoutIdGwIngenicoPutWithHttpInfoAsync(configuration, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object>> AdminCheckoutIdGwIngenicoPutWithHttpInfoAsync(InlineObject3 configuration, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'configuration' is set
            if (configuration == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'configuration' when calling IngenicoGatewayApi->AdminCheckoutIdGwIngenicoPut");
            ...
            var localVarResponse = await this.AsynchronousClient.PutAsync<Object>("/admin/gateways/ingenico", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
