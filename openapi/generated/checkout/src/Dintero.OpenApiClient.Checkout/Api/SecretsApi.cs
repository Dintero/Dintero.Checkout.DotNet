...
namespace Dintero.OpenApiClient.Checkout.Api
{
    ...
    public interface ISecretsApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of SignatureV0</returns>
        ApiResponse<SignatureV0> AdminSignatureGetWithHttpInfo();
        /// <summary>
        ...
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of SignatureV0</returns>
        ApiResponse<SignatureV0> AdminSignaturePostWithHttpInfo();
    ...
    public interface ISecretsApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of SignatureV0</returns>
        System.Threading.Tasks.Task<SignatureV0> AdminSignatureGetAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SignatureV0)</returns>
        System.Threading.Tasks.Task<ApiResponse<SignatureV0>> AdminSignatureGetWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Create signature secret
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SignatureV0</returns>
        System.Threading.Tasks.Task<SignatureV0> AdminSignaturePostAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SignatureV0)</returns>
        System.Threading.Tasks.Task<ApiResponse<SignatureV0>> AdminSignaturePostWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class SecretsApi : ISecretsApi
    {
        ...
        /// <returns></returns>
        public SecretsApi(Dintero.OpenApiClient.Checkout.Client.Configuration configuration)
        {
        ...
        public SecretsApi(Dintero.OpenApiClient.Checkout.Client.ISynchronousClient client, Dintero.OpenApiClient.Checkout.Client.IAsynchronousClient asyncClient, Dintero.OpenApiClient.Checkout.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Get signature secret Get the current signature secret Dintero uses when create the &#x60;Dintero-Signature&#x60; header included in requests it sends to your endpoints.  scopes: - admin:checkout - read:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>SignatureV0</returns>
        public SignatureV0 AdminSignatureGet()
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<SignatureV0> localVarResponse = AdminSignatureGetWithHttpInfo();
        ...
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of SignatureV0</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<SignatureV0> AdminSignatureGetWithHttpInfo()
        {
            ...
            var localVarResponse = this.Client.Get<SignatureV0>("/admin/signature", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("AdminSignatureGet", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SignatureV0</returns>
        public async System.Threading.Tasks.Task<SignatureV0> AdminSignatureGetAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<SignatureV0> localVarResponse = await AdminSignatureGetWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SignatureV0)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<SignatureV0>> AdminSignatureGetWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<SignatureV0>("/admin/signature", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Create signature secret Dintero can optionally sign all request it sends to your endpoints.  We do so by including a signature in the request &#x60;Dintero-Signature&#x60; header. This allows you to verify that the request was done by Dintero, not by a third party.  *&#x60;v0-hmac-sha256&#x60;*  &#x60;&#x60;&#x60; &lt;timestamp&gt;\\n&lt;account_id&gt;\\n&lt;method&gt;\\n&lt;hostname&gt;\\n&lt;pathname&gt;\\n&lt;query&gt; &#x60;&#x60;&#x60;  &#x60;&#x60;&#x60; secret: 123 timestamp: 1582236537 account_id: P00000000 method: GET url: https://example.com/callback?B&#x3D;123&amp;A&#x3D;992  Dintero-Signature: t&#x3D;1582236537,     v0-hmac-sha256&#x3D;6bed2ab1b919d460ef7465a20dc6c97260dca73fab6647106ca525f0908df64a &#x60;&#x60;&#x60;  &gt; The timestamp (&#x60;t&#x60;) in the Dintero-Signature, is included in the signature payload to &gt; mitigate &#x60;replay attach&#x60;. If your signature is valid but the timestamp is too old, you &gt; can have your application reject the request. We recommend that your application have &gt; a tolerance of five minutes between the timestamp and the current time.  &gt; *NOTE:* The query parameters must be sorted.  scopes: - admin:checkout - write:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>SignatureV0</returns>
        public SignatureV0 AdminSignaturePost()
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<SignatureV0> localVarResponse = AdminSignaturePostWithHttpInfo();
            return localVarResponse.Data;
        }
        ...
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of SignatureV0</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<SignatureV0> AdminSignaturePostWithHttpInfo()
        {
            Dintero.OpenApiClient.Checkout.Client.RequestOptions localVarRequestOptions = new Dintero.OpenApiClient.Checkout.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<SignatureV0>("/admin/signature", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("AdminSignaturePost", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SignatureV0</returns>
        public async System.Threading.Tasks.Task<SignatureV0> AdminSignaturePostAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<SignatureV0> localVarResponse = await AdminSignaturePostWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SignatureV0)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<SignatureV0>> AdminSignaturePostWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<SignatureV0>("/admin/signature", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
