...
namespace Dintero.OpenApiClient.Checkout.Api
{
    ...
    /// </summary>
    public interface IGenerateQRCodeApiSync : IApiAccessor
    {
        ...
        ApiResponse<QRCode> QrLocationsLidPostWithHttpInfo(string locationId, QROptions options);
        /// <summary>
        ...
        /// <param name="options"></param>
        /// <returns>ApiResponse of QRCode</returns>
        ApiResponse<QRCode> QrSessionsSidPostWithHttpInfo(string sessionId, QROptions options);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IGenerateQRCodeApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<QRCode> QrLocationsLidPostAsync(string locationId, QROptions options, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<QRCode>> QrLocationsLidPostWithHttpInfoAsync(string locationId, QROptions options, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// QR Code for a Session
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of QRCode</returns>
        System.Threading.Tasks.Task<QRCode> QrSessionsSidPostAsync(string sessionId, QROptions options, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (QRCode)</returns>
        System.Threading.Tasks.Task<ApiResponse<QRCode>> QrSessionsSidPostWithHttpInfoAsync(string sessionId, QROptions options, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IGenerateQRCodeApi : IGenerateQRCodeApiSync, IGenerateQRCodeApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class GenerateQRCodeApi : IGenerateQRCodeApi
    {
        private Dintero.OpenApiClient.Checkout.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateQRCodeApi"/> class.
        /// </summary>
        /// <returns></returns>
        public GenerateQRCodeApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public GenerateQRCodeApi(String basePath)
        {
        ...
        /// <returns></returns>
        public GenerateQRCodeApi(Dintero.OpenApiClient.Checkout.Client.Configuration configuration)
        {
        ...
        public GenerateQRCodeApi(Dintero.OpenApiClient.Checkout.Client.ISynchronousClient client, Dintero.OpenApiClient.Checkout.Client.IAsynchronousClient asyncClient, Dintero.OpenApiClient.Checkout.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// QR Code for a Location. Generate a QR Code that can be used statically, to enable payment on a location. The customer can scan the QR Code to retrive a checkout payment window. Payment is possible after a [Checkout](#operation/qr_locations_lid_checkout_sid_post) is requested on the location.  scopes: - admin:checkout - write:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="locationId">The ID of the sale location, point of sale.</param>
        /// <param name="options"></param>
        /// <returns>QRCode</returns>
        public QRCode QrLocationsLidPost(string locationId, QROptions options)
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<QRCode> localVarResponse = QrLocationsLidPostWithHttpInfo(locationId, options);
        ...
        /// <param name="options"></param>
        /// <returns>ApiResponse of QRCode</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<QRCode> QrLocationsLidPostWithHttpInfo(string locationId, QROptions options)
        {
            // verify the required parameter 'locationId' is set
            if (locationId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'locationId' when calling GenerateQRCodeApi->QrLocationsLidPost");

            // verify the required parameter 'options' is set
            if (options == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'options' when calling GenerateQRCodeApi->QrLocationsLidPost");
            ...
            var localVarResponse = this.Client.Post<QRCode>("/locations/{location_id}/qr", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("QrLocationsLidPost", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of QRCode</returns>
        public async System.Threading.Tasks.Task<QRCode> QrLocationsLidPostAsync(string locationId, QROptions options, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<QRCode> localVarResponse = await QrLocationsLidPostWithHttpInfoAsync(locationId, options, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (QRCode)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<QRCode>> QrLocationsLidPostWithHttpInfoAsync(string locationId, QROptions options, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'locationId' is set
            if (locationId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'locationId' when calling GenerateQRCodeApi->QrLocationsLidPost");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<QRCode>("/locations/{location_id}/qr", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// QR Code for a Session Generate a QR Code containing the URL for the Checkout Session. The QR Code can be displayed in POS to enable Checkout payment.  scopes: - admin:checkout - write:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="sessionId">The session ID</param>
        /// <param name="options"></param>
        /// <returns>QRCode</returns>
        public QRCode QrSessionsSidPost(string sessionId, QROptions options)
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<QRCode> localVarResponse = QrSessionsSidPostWithHttpInfo(sessionId, options);
            return localVarResponse.Data;
        }
        ...
        /// <param name="options"></param>
        /// <returns>ApiResponse of QRCode</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<QRCode> QrSessionsSidPostWithHttpInfo(string sessionId, QROptions options)
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling GenerateQRCodeApi->QrSessionsSidPost");

            // verify the required parameter 'options' is set
            if (options == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'options' when calling GenerateQRCodeApi->QrSessionsSidPost");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<QRCode>("/sessions/{session_id}/qr", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("QrSessionsSidPost", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of QRCode</returns>
        public async System.Threading.Tasks.Task<QRCode> QrSessionsSidPostAsync(string sessionId, QROptions options, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<QRCode> localVarResponse = await QrSessionsSidPostWithHttpInfoAsync(sessionId, options, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (QRCode)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<QRCode>> QrSessionsSidPostWithHttpInfoAsync(string sessionId, QROptions options, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling GenerateQRCodeApi->QrSessionsSidPost");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<QRCode>("/sessions/{session_id}/qr", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
