...
namespace Dintero.OpenApiClient.Checkout.Api
{
    ...
    /// </summary>
    public interface ISwishApiSync : IApiAccessor
    {
        ...
        /// <returns>SwishPollStatus</returns>
        ...
        /// <param name="sessionId">The session ID</param>
        /// <param name="paymentRequestId"></param>
        /// <returns>ApiResponse of SwishPollStatus</returns>
        ApiResponse<SwishPollStatus> CheckoutSidSwishGetWithHttpInfo(string sessionId, string paymentRequestId);
        /// <summary>
        ...
        ApiResponse<Object> CheckoutSidSwishRedirectGetWithHttpInfo(string sessionId, string redirectRef);
        /// <summary>
        ...
        /// <param name="data">Content of payment callback</param>
        /// <returns></returns>
        ...
        /// <param name="data">Content of payment callback</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> CheckoutSwishPaymentCallbackPostWithHttpInfo(string sessionId, string callbackRef, SwishPaymentCallback data);
        /// <summary>
        ...
        /// <param name="callbackRef"></param>
        /// <param name="data">Content of refund callback</param>
        /// <returns></returns>
        ...
        /// <param name="data">Content of refund callback</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> CheckoutSwishRefundCallbackPostWithHttpInfo(string id, string callbackRef, SwishRefundCallback data);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ISwishApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of SwishPollStatus</returns>
        System.Threading.Tasks.Task<SwishPollStatus> CheckoutSidSwishGetAsync(string sessionId, string paymentRequestId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="paymentRequestId"></param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SwishPollStatus)</returns>
        System.Threading.Tasks.Task<ApiResponse<SwishPollStatus>> CheckoutSidSwishGetWithHttpInfoAsync(string sessionId, string paymentRequestId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Handle redirect from payment
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task CheckoutSidSwishRedirectGetAsync(string sessionId, string redirectRef, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> CheckoutSidSwishRedirectGetWithHttpInfoAsync(string sessionId, string redirectRef, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Handle Swish payment callback
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task CheckoutSwishPaymentCallbackPostAsync(string sessionId, string callbackRef, SwishPaymentCallback data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> CheckoutSwishPaymentCallbackPostWithHttpInfoAsync(string sessionId, string callbackRef, SwishPaymentCallback data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Handle Swish refund callback
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task CheckoutSwishRefundCallbackPostAsync(string id, string callbackRef, SwishRefundCallback data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> CheckoutSwishRefundCallbackPostWithHttpInfoAsync(string id, string callbackRef, SwishRefundCallback data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ISwishApi : ISwishApiSync, ISwishApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class SwishApi : ISwishApi
    {
        private Dintero.OpenApiClient.Checkout.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="SwishApi"/> class.
        /// </summary>
        /// <returns></returns>
        public SwishApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public SwishApi(String basePath)
        {
        ...
        /// <returns></returns>
        public SwishApi(Dintero.OpenApiClient.Checkout.Client.Configuration configuration)
        {
        ...
        public SwishApi(Dintero.OpenApiClient.Checkout.Client.ISynchronousClient client, Dintero.OpenApiClient.Checkout.Client.IAsynchronousClient asyncClient, Dintero.OpenApiClient.Checkout.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Get status about the Swish session.  Get status about the Swish session. Will check if the session contains a transaction_id, and if the transaction is paid with the given Swish payment_request_id. 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="sessionId">The session ID</param>
        /// <param name="paymentRequestId"></param>
        /// <returns>SwishPollStatus</returns>
        public SwishPollStatus CheckoutSidSwishGet(string sessionId, string paymentRequestId)
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<SwishPollStatus> localVarResponse = CheckoutSidSwishGetWithHttpInfo(sessionId, paymentRequestId);
        ...
        /// <param name="paymentRequestId"></param>
        /// <returns>ApiResponse of SwishPollStatus</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<SwishPollStatus> CheckoutSidSwishGetWithHttpInfo(string sessionId, string paymentRequestId)
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling SwishApi->CheckoutSidSwishGet");

            // verify the required parameter 'paymentRequestId' is set
            if (paymentRequestId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'paymentRequestId' when calling SwishApi->CheckoutSidSwishGet");
            ...
            localVarRequestOptions.PathParameters.Add("payment_request_id", Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToString(paymentRequestId)); // path parameter
            ...
            var localVarResponse = this.Client.Get<SwishPollStatus>("/view/{session_id}/swish/{payment_request_id}/status", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CheckoutSidSwishGet", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SwishPollStatus</returns>
        public async System.Threading.Tasks.Task<SwishPollStatus> CheckoutSidSwishGetAsync(string sessionId, string paymentRequestId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<SwishPollStatus> localVarResponse = await CheckoutSidSwishGetWithHttpInfoAsync(sessionId, paymentRequestId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SwishPollStatus)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<SwishPollStatus>> CheckoutSidSwishGetWithHttpInfoAsync(string sessionId, string paymentRequestId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling SwishApi->CheckoutSidSwishGet");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<SwishPollStatus>("/view/{session_id}/swish/{payment_request_id}/status", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="redirectRef"></param>
        /// <returns></returns>
        public void CheckoutSidSwishRedirectGet(string sessionId, string redirectRef)
        {
            CheckoutSidSwishRedirectGetWithHttpInfo(sessionId, redirectRef);
        }
        ...
        /// <param name="redirectRef"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object> CheckoutSidSwishRedirectGetWithHttpInfo(string sessionId, string redirectRef)
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling SwishApi->CheckoutSidSwishRedirectGet");

            // verify the required parameter 'redirectRef' is set
            if (redirectRef == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'redirectRef' when calling SwishApi->CheckoutSidSwishRedirectGet");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<Object>("/sessions/{session_id}/swish/redirect/{redirect_ref}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CheckoutSidSwishRedirectGet", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task CheckoutSidSwishRedirectGetAsync(string sessionId, string redirectRef, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await CheckoutSidSwishRedirectGetWithHttpInfoAsync(sessionId, redirectRef, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object>> CheckoutSidSwishRedirectGetWithHttpInfoAsync(string sessionId, string redirectRef, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling SwishApi->CheckoutSidSwishRedirectGet");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/sessions/{session_id}/swish/redirect/{redirect_ref}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="data">Content of payment callback</param>
        /// <returns></returns>
        public void CheckoutSwishPaymentCallbackPost(string sessionId, string callbackRef, SwishPaymentCallback data)
        {
            CheckoutSwishPaymentCallbackPostWithHttpInfo(sessionId, callbackRef, data);
        }
        ...
        /// <param name="data">Content of payment callback</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object> CheckoutSwishPaymentCallbackPostWithHttpInfo(string sessionId, string callbackRef, SwishPaymentCallback data)
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling SwishApi->CheckoutSwishPaymentCallbackPost");

            // verify the required parameter 'callbackRef' is set
            if (callbackRef == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'callbackRef' when calling SwishApi->CheckoutSwishPaymentCallbackPost");

            // verify the required parameter 'data' is set
            if (data == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'data' when calling SwishApi->CheckoutSwishPaymentCallbackPost");
            ...
            localVarRequestOptions.PathParameters.Add("session_id", Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToString(sessionId)); // path parameter
            localVarRequestOptions.PathParameters.Add("callback_ref", Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToString(callbackRef)); // path parameter
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Object>("/events/gateways/swish/transaction/payment/{session_id}/{callback_ref}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CheckoutSwishPaymentCallbackPost", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task CheckoutSwishPaymentCallbackPostAsync(string sessionId, string callbackRef, SwishPaymentCallback data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await CheckoutSwishPaymentCallbackPostWithHttpInfoAsync(sessionId, callbackRef, data, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object>> CheckoutSwishPaymentCallbackPostWithHttpInfoAsync(string sessionId, string callbackRef, SwishPaymentCallback data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling SwishApi->CheckoutSwishPaymentCallbackPost");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/events/gateways/swish/transaction/payment/{session_id}/{callback_ref}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="data">Content of refund callback</param>
        /// <returns></returns>
        public void CheckoutSwishRefundCallbackPost(string id, string callbackRef, SwishRefundCallback data)
        {
            CheckoutSwishRefundCallbackPostWithHttpInfo(id, callbackRef, data);
        }
        ...
        /// <param name="data">Content of refund callback</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object> CheckoutSwishRefundCallbackPostWithHttpInfo(string id, string callbackRef, SwishRefundCallback data)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'id' when calling SwishApi->CheckoutSwishRefundCallbackPost");

            // verify the required parameter 'callbackRef' is set
            if (callbackRef == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'callbackRef' when calling SwishApi->CheckoutSwishRefundCallbackPost");

            // verify the required parameter 'data' is set
            if (data == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'data' when calling SwishApi->CheckoutSwishRefundCallbackPost");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Object>("/events/gateways/swish/transaction/refund/{id}/{callback_ref}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CheckoutSwishRefundCallbackPost", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task CheckoutSwishRefundCallbackPostAsync(string id, string callbackRef, SwishRefundCallback data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await CheckoutSwishRefundCallbackPostWithHttpInfoAsync(id, callbackRef, data, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object>> CheckoutSwishRefundCallbackPostWithHttpInfoAsync(string id, string callbackRef, SwishRefundCallback data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'id' when calling SwishApi->CheckoutSwishRefundCallbackPost");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/events/gateways/swish/transaction/refund/{id}/{callback_ref}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
