...
namespace Dintero.OpenApiClient.Checkout.Api
{
    ...
    /// </summary>
    public interface IPayexApiSync : IApiAccessor
    {
        ...
        /// <returns></returns>
        void CheckoutSidCallbackPost(string sessionId, string paymentProductType, UNKNOWN_BASE_TYPE callback, string token = default(string));
        ...
        ApiResponse<Object> CheckoutSidCallbackPostWithHttpInfo(string sessionId, string paymentProductType, UNKNOWN_BASE_TYPE callback, string token = default(string));
        /// <summary>
        ...
        /// <param name="paymentProductType"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> CheckoutSidPayexRedirectGetWithHttpInfo(string sessionId, string action, string paymentProductType);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IPayexApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task CheckoutSidCallbackPostAsync(string sessionId, string paymentProductType, UNKNOWN_BASE_TYPE callback, string token = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> CheckoutSidCallbackPostWithHttpInfoAsync(string sessionId, string paymentProductType, UNKNOWN_BASE_TYPE callback, string token = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Handle redirect from payment
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task CheckoutSidPayexRedirectGetAsync(string sessionId, string action, string paymentProductType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> CheckoutSidPayexRedirectGetWithHttpInfoAsync(string sessionId, string action, string paymentProductType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IPayexApi : IPayexApiSync, IPayexApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class PayexApi : IPayexApi
    {
        private Dintero.OpenApiClient.Checkout.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="PayexApi"/> class.
        /// </summary>
        /// <returns></returns>
        public PayexApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public PayexApi(String basePath)
        {
        ...
        /// <returns></returns>
        public PayexApi(Dintero.OpenApiClient.Checkout.Client.Configuration configuration)
        {
        ...
        public PayexApi(Dintero.OpenApiClient.Checkout.Client.ISynchronousClient client, Dintero.OpenApiClient.Checkout.Client.IAsynchronousClient asyncClient, Dintero.OpenApiClient.Checkout.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Handle Payex callback after a change or update  Creates a transaction from the session with status determined by the payment status provided by Payex. 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="sessionId">The session ID</param>
        /// <param name="paymentProductType"></param>
        ...
        /// <param name="token"> (optional)</param>
        /// <returns></returns>
        public void CheckoutSidCallbackPost(string sessionId, string paymentProductType, UNKNOWN_BASE_TYPE callback, string token = default(string))
        {
            CheckoutSidCallbackPostWithHttpInfo(sessionId, paymentProductType, callback, token);
        }
        ...
        /// <param name="token"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object> CheckoutSidCallbackPostWithHttpInfo(string sessionId, string paymentProductType, UNKNOWN_BASE_TYPE callback, string token = default(string))
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling PayexApi->CheckoutSidCallbackPost");

            // verify the required parameter 'paymentProductType' is set
            if (paymentProductType == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'paymentProductType' when calling PayexApi->CheckoutSidCallbackPost");

            // verify the required parameter 'callback' is set
            if (callback == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'callback' when calling PayexApi->CheckoutSidCallbackPost");
            ...
            if (token != null)
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("", "token", token));
            }
            ...
            var localVarResponse = this.Client.Post<Object>("/sessions/{session_id}/payex/callback/{payment_product_type}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CheckoutSidCallbackPost", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task CheckoutSidCallbackPostAsync(string sessionId, string paymentProductType, UNKNOWN_BASE_TYPE callback, string token = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await CheckoutSidCallbackPostWithHttpInfoAsync(sessionId, paymentProductType, callback, token, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object>> CheckoutSidCallbackPostWithHttpInfoAsync(string sessionId, string paymentProductType, UNKNOWN_BASE_TYPE callback, string token = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling PayexApi->CheckoutSidCallbackPost");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/sessions/{session_id}/payex/callback/{payment_product_type}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="paymentProductType"></param>
        /// <returns></returns>
        public void CheckoutSidPayexRedirectGet(string sessionId, string action, string paymentProductType)
        {
            CheckoutSidPayexRedirectGetWithHttpInfo(sessionId, action, paymentProductType);
        }
        ...
        /// <param name="paymentProductType"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object> CheckoutSidPayexRedirectGetWithHttpInfo(string sessionId, string action, string paymentProductType)
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling PayexApi->CheckoutSidPayexRedirectGet");

            // verify the required parameter 'action' is set
            if (action == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'action' when calling PayexApi->CheckoutSidPayexRedirectGet");

            // verify the required parameter 'paymentProductType' is set
            if (paymentProductType == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'paymentProductType' when calling PayexApi->CheckoutSidPayexRedirectGet");
            ...
            localVarRequestOptions.PathParameters.Add("session_id", Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToString(sessionId)); // path parameter
            localVarRequestOptions.PathParameters.Add("action", Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToString(action)); // path parameter
            localVarRequestOptions.PathParameters.Add("payment_product_type", Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToString(paymentProductType)); // path parameter
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<Object>("/sessions/{session_id}/payex/redirect/{action}/{payment_product_type}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CheckoutSidPayexRedirectGet", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task CheckoutSidPayexRedirectGetAsync(string sessionId, string action, string paymentProductType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await CheckoutSidPayexRedirectGetWithHttpInfoAsync(sessionId, action, paymentProductType, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object>> CheckoutSidPayexRedirectGetWithHttpInfoAsync(string sessionId, string action, string paymentProductType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling PayexApi->CheckoutSidPayexRedirectGet");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/sessions/{session_id}/payex/redirect/{action}/{payment_product_type}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
