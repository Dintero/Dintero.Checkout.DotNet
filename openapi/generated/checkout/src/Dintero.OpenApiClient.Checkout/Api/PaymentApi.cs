...
namespace Dintero.OpenApiClient.Checkout.Api
{
    ...
    public interface IPaymentApiSync : IApiAccessor
    {
        ...
        ApiResponse<Transaction> CheckoutSessionPayPostWithHttpInfo(InlineObject17 options);
        /// <summary>
        ...
        PaymentResponse CheckoutSidPayPost(string sessionId, Payment payment, string ifUnmodifiedSince = default(string));
        ...
        ApiResponse<PaymentResponse> CheckoutSidPayPostWithHttpInfo(string sessionId, Payment payment, string ifUnmodifiedSince = default(string));
        /// <summary>
        ...
        ApiResponse<Object> CheckoutSidRedirectGetWithHttpInfo(string sessionId, string redirectRef);
        /// <summary>
        /// Handle redirect from payment
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        ...
        /// <param name="sessionId">The session ID</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> CheckoutSidSantanderRedirectGetWithHttpInfo(string sessionId);
    ...
    public interface IPaymentApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Transaction> CheckoutSessionPayPostAsync(InlineObject17 options, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Transaction>> CheckoutSessionPayPostWithHttpInfoAsync(InlineObject17 options, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Initiate a checkout payment
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<PaymentResponse> CheckoutSidPayPostAsync(string sessionId, Payment payment, string ifUnmodifiedSince = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<PaymentResponse>> CheckoutSidPayPostWithHttpInfoAsync(string sessionId, Payment payment, string ifUnmodifiedSince = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Handle redirect from payment
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task CheckoutSidRedirectGetAsync(string sessionId, string redirectRef, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> CheckoutSidRedirectGetWithHttpInfoAsync(string sessionId, string redirectRef, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Handle redirect from payment
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task CheckoutSidSantanderRedirectGetAsync(string sessionId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> CheckoutSidSantanderRedirectGetWithHttpInfoAsync(string sessionId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class PaymentApi : IPaymentApi
    {
        ...
        /// <returns></returns>
        public PaymentApi(Dintero.OpenApiClient.Checkout.Client.Configuration configuration)
        {
        ...
        public PaymentApi(Dintero.OpenApiClient.Checkout.Client.ISynchronousClient client, Dintero.OpenApiClient.Checkout.Client.IAsynchronousClient asyncClient, Dintero.OpenApiClient.Checkout.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Create and pay merchant initiated session For merchant initiated payments, where the customer is not involved.  Receives a session and pays it with the given card token.  scopes: - admin:checkout - write:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="options"></param>
        /// <returns>Transaction</returns>
        public Transaction CheckoutSessionPayPost(InlineObject17 options)
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<Transaction> localVarResponse = CheckoutSessionPayPostWithHttpInfo(options);
        ...
        /// <param name="options"></param>
        /// <returns>ApiResponse of Transaction</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<Transaction> CheckoutSessionPayPostWithHttpInfo(InlineObject17 options)
        {
            // verify the required parameter 'options' is set
            if (options == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'options' when calling PaymentApi->CheckoutSessionPayPost");
            ...
            var localVarResponse = this.Client.Post<Transaction>("/sessions/pay", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CheckoutSessionPayPost", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Transaction</returns>
        public async System.Threading.Tasks.Task<Transaction> CheckoutSessionPayPostAsync(InlineObject17 options, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<Transaction> localVarResponse = await CheckoutSessionPayPostWithHttpInfoAsync(options, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Transaction)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<Transaction>> CheckoutSessionPayPostWithHttpInfoAsync(InlineObject17 options, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'options' is set
            if (options == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'options' when calling PaymentApi->CheckoutSessionPayPost");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<Transaction>("/sessions/pay", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Initiate a checkout payment For Express Checkout sessions, the _&#x60;order.shipping_address&#x60;_ must be set on the session, and a _&#x60;order.items.shipping_option&#x60; item is required if the session has either an _&#x60;express.shipping_address_callback_url&#x60;_ or the session has at least one option in _&#x60;express.shipping_options&#x60;_. 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="sessionId">The session ID</param>
        /// <param name="payment"></param>
        /// <param name="ifUnmodifiedSince">Optional header. The put request is discarded and a 412 is returned if the header does not match the &#x60;updated_at&#x60; property of the session. (optional)</param>
        /// <returns>PaymentResponse</returns>
        public PaymentResponse CheckoutSidPayPost(string sessionId, Payment payment, string ifUnmodifiedSince = default(string))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<PaymentResponse> localVarResponse = CheckoutSidPayPostWithHttpInfo(sessionId, payment, ifUnmodifiedSince);
            return localVarResponse.Data;
        }
        ...
        /// <param name="ifUnmodifiedSince">Optional header. The put request is discarded and a 412 is returned if the header does not match the &#x60;updated_at&#x60; property of the session. (optional)</param>
        /// <returns>ApiResponse of PaymentResponse</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<PaymentResponse> CheckoutSidPayPostWithHttpInfo(string sessionId, Payment payment, string ifUnmodifiedSince = default(string))
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling PaymentApi->CheckoutSidPayPost");

            // verify the required parameter 'payment' is set
            if (payment == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'payment' when calling PaymentApi->CheckoutSidPayPost");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<PaymentResponse>("/sessions/{session_id}/pay", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CheckoutSidPayPost", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PaymentResponse</returns>
        public async System.Threading.Tasks.Task<PaymentResponse> CheckoutSidPayPostAsync(string sessionId, Payment payment, string ifUnmodifiedSince = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<PaymentResponse> localVarResponse = await CheckoutSidPayPostWithHttpInfoAsync(sessionId, payment, ifUnmodifiedSince, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PaymentResponse)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<PaymentResponse>> CheckoutSidPayPostWithHttpInfoAsync(string sessionId, Payment payment, string ifUnmodifiedSince = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling PaymentApi->CheckoutSidPayPost");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<PaymentResponse>("/sessions/{session_id}/pay", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="redirectRef"></param>
        /// <returns></returns>
        public void CheckoutSidRedirectGet(string sessionId, string redirectRef)
        {
            CheckoutSidRedirectGetWithHttpInfo(sessionId, redirectRef);
        }
        ...
        /// <param name="redirectRef"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object> CheckoutSidRedirectGetWithHttpInfo(string sessionId, string redirectRef)
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling PaymentApi->CheckoutSidRedirectGet");

            // verify the required parameter 'redirectRef' is set
            if (redirectRef == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'redirectRef' when calling PaymentApi->CheckoutSidRedirectGet");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<Object>("/sessions/{session_id}/redirect/{redirect_ref}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CheckoutSidRedirectGet", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task CheckoutSidRedirectGetAsync(string sessionId, string redirectRef, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await CheckoutSidRedirectGetWithHttpInfoAsync(sessionId, redirectRef, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object>> CheckoutSidRedirectGetWithHttpInfoAsync(string sessionId, string redirectRef, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling PaymentApi->CheckoutSidRedirectGet");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/sessions/{session_id}/redirect/{redirect_ref}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="sessionId">The session ID</param>
        /// <returns></returns>
        public void CheckoutSidSantanderRedirectGet(string sessionId)
        {
            CheckoutSidSantanderRedirectGetWithHttpInfo(sessionId);
        }
        ...
        /// <param name="sessionId">The session ID</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object> CheckoutSidSantanderRedirectGetWithHttpInfo(string sessionId)
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling PaymentApi->CheckoutSidSantanderRedirectGet");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<Object>("/sessions/{session_id}/santander/redirect", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CheckoutSidSantanderRedirectGet", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task CheckoutSidSantanderRedirectGetAsync(string sessionId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await CheckoutSidSantanderRedirectGetWithHttpInfoAsync(sessionId, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object>> CheckoutSidSantanderRedirectGetWithHttpInfoAsync(string sessionId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling PaymentApi->CheckoutSidSantanderRedirectGet");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/sessions/{session_id}/santander/redirect", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
