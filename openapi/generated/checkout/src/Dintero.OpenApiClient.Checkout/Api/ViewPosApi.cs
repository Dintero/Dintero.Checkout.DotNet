...
namespace Dintero.OpenApiClient.Checkout.Api
{
    ...
    /// </summary>
    public interface IViewPosApiSync : IApiAccessor
    {
        ...
        /// <param name="authorization">Bearer authorization with &#x60;access_token&#x60; returned from [Location Page](#operation/view_location_lid_get)  Example: &#x60;Bearer {access_token}&#x60; </param>
        ...
        ApiResponse<InlineResponse20011> ViewLocationLidDetailsPostWithHttpInfo(string authorization, string locationId);
        /// <summary>
        ...
        /// <returns></returns>
        void ViewLocationLidGet(string locationId, string language = default(string), string ui = default(string));
        ...
        ApiResponse<Object> ViewLocationLidGetWithHttpInfo(string locationId, string language = default(string), string ui = default(string));
        /// <summary>
        /// Location redirect
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        ...
        /// <param name="redirectRef"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> ViewLocationLidSessionRedirectGetWithHttpInfo(string locationId, string redirectRef);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IViewPosApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<InlineResponse20011> ViewLocationLidDetailsPostAsync(string authorization, string locationId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse20011>> ViewLocationLidDetailsPostWithHttpInfoAsync(string authorization, string locationId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get the Location Checkout page
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task ViewLocationLidGetAsync(string locationId, string language = default(string), string ui = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> ViewLocationLidGetWithHttpInfoAsync(string locationId, string language = default(string), string ui = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Location redirect
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task ViewLocationLidSessionRedirectGetAsync(string locationId, string redirectRef, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> ViewLocationLidSessionRedirectGetWithHttpInfoAsync(string locationId, string redirectRef, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IViewPosApi : IViewPosApiSync, IViewPosApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ViewPosApi : IViewPosApi
    {
        private Dintero.OpenApiClient.Checkout.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="ViewPosApi"/> class.
        /// </summary>
        /// <returns></returns>
        public ViewPosApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public ViewPosApi(String basePath)
        {
        ...
        /// <returns></returns>
        public ViewPosApi(Dintero.OpenApiClient.Checkout.Client.Configuration configuration)
        {
        ...
        public ViewPosApi(Dintero.OpenApiClient.Checkout.Client.ISynchronousClient client, Dintero.OpenApiClient.Checkout.Client.IAsynchronousClient asyncClient, Dintero.OpenApiClient.Checkout.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="locationId">The ID of the sale location, point of sale.</param>
        /// <returns>InlineResponse20011</returns>
        public InlineResponse20011 ViewLocationLidDetailsPost(string authorization, string locationId)
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse20011> localVarResponse = ViewLocationLidDetailsPostWithHttpInfo(authorization, locationId);
        ...
        /// <param name="locationId">The ID of the sale location, point of sale.</param>
        /// <returns>ApiResponse of InlineResponse20011</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse20011> ViewLocationLidDetailsPostWithHttpInfo(string authorization, string locationId)
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'authorization' when calling ViewPosApi->ViewLocationLidDetailsPost");

            // verify the required parameter 'locationId' is set
            if (locationId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'locationId' when calling ViewPosApi->ViewLocationLidDetailsPost");
            ...
            localVarRequestOptions.HeaderParameters.Add("Authorization", Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToString(authorization)); // header parameter
            ...
            var localVarResponse = this.Client.Get<InlineResponse20011>("/view-location/{location_id}/details", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ViewLocationLidDetailsPost", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse20011</returns>
        public async System.Threading.Tasks.Task<InlineResponse20011> ViewLocationLidDetailsPostAsync(string authorization, string locationId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse20011> localVarResponse = await ViewLocationLidDetailsPostWithHttpInfoAsync(authorization, locationId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse20011)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse20011>> ViewLocationLidDetailsPostWithHttpInfoAsync(string authorization, string locationId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'authorization' when calling ViewPosApi->ViewLocationLidDetailsPost");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<InlineResponse20011>("/view-location/{location_id}/details", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="ui"> (optional)</param>
        /// <returns></returns>
        public void ViewLocationLidGet(string locationId, string language = default(string), string ui = default(string))
        {
            ViewLocationLidGetWithHttpInfo(locationId, language, ui);
        }
        ...
        /// <param name="ui"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object> ViewLocationLidGetWithHttpInfo(string locationId, string language = default(string), string ui = default(string))
        {
            // verify the required parameter 'locationId' is set
            if (locationId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'locationId' when calling ViewPosApi->ViewLocationLidGet");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<Object>("/view-location/{location_id}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ViewLocationLidGet", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task ViewLocationLidGetAsync(string locationId, string language = default(string), string ui = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await ViewLocationLidGetWithHttpInfoAsync(locationId, language, ui, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object>> ViewLocationLidGetWithHttpInfoAsync(string locationId, string language = default(string), string ui = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'locationId' is set
            if (locationId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'locationId' when calling ViewPosApi->ViewLocationLidGet");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/view-location/{location_id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="redirectRef"></param>
        /// <returns></returns>
        public void ViewLocationLidSessionRedirectGet(string locationId, string redirectRef)
        {
            ViewLocationLidSessionRedirectGetWithHttpInfo(locationId, redirectRef);
        }
        ...
        /// <param name="redirectRef"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object> ViewLocationLidSessionRedirectGetWithHttpInfo(string locationId, string redirectRef)
        {
            // verify the required parameter 'locationId' is set
            if (locationId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'locationId' when calling ViewPosApi->ViewLocationLidSessionRedirectGet");

            // verify the required parameter 'redirectRef' is set
            if (redirectRef == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'redirectRef' when calling ViewPosApi->ViewLocationLidSessionRedirectGet");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<Object>("/view-location/{location_id}/session/{redirect_ref}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ViewLocationLidSessionRedirectGet", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task ViewLocationLidSessionRedirectGetAsync(string locationId, string redirectRef, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await ViewLocationLidSessionRedirectGetWithHttpInfoAsync(locationId, redirectRef, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object>> ViewLocationLidSessionRedirectGetWithHttpInfoAsync(string locationId, string redirectRef, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'locationId' is set
            if (locationId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'locationId' when calling ViewPosApi->ViewLocationLidSessionRedirectGet");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/view-location/{location_id}/session/{redirect_ref}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
