...
namespace Dintero.OpenApiClient.Checkout.Api
{
    ...
    public interface ITransactionsApiSync : IApiAccessor
    {
        ...
        ApiResponse<List<Transaction>> TransactionsEventsSettlementsPostWithHttpInfo(UNKNOWN_BASE_TYPE data);
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">List of ids that should be included in the result. ?id&#x3D;A&amp;id&#x3D;B&amp;id&#x3D;X  (optional)</param>
        ...
        /// <param name="status">The status of the transaction.  (optional)</param>
        /// <param name="paymentProduct">The type of payment product used (optional)</param>
        /// <param name="paymentProductType">The payment product type (optional)</param>
        /// <param name="cardBrand">The card brand for the payment (optional)</param>
        /// <param name="merchantReference">The merchant reference used (optional)</param>
        /// <param name="merchantReference2">The second merchant reference on the transaction (optional)</param>
        /// <param name="sessionId">The session id(s) associated with the transactions. ?session_id&#x3D;A&amp;session_id&#x3D;B&amp;session_id&#x3D;X.  (optional)</param>
        /// <param name="storeId">The store_id that the transaction belongs to. ?store_id&#x3D;A&amp;store_id&#x3D;B&amp;store_id&#x3D;X.  (optional)</param>
        /// <param name="payoutCorrelationId">Filter by the &#x60;payout_correlation_id&#x60;. Different format between payment providers. ?payout_correlation_id&#x3D;A,B  (optional)</param>
        /// <param name="currency">The currency of the transaction. ?currency&#x3D;NOK&amp;currency&#x3D;SEK.  (optional)</param>
        /// <param name="amount">Exact transaction amount, amount authorized. (optional)</param>
        /// <param name="amountGte">Lower limit for filtering on transaction amount, amount authorized. (optional)</param>
        /// <param name="amountLte">Upper limit for filtering on transaction amount, amount authorized. (optional)</param>
        /// <param name="createdAtGte">Transaction created after (ISO 8601. We recommend using a localised ISO 8601 datetime like &#x60;2017-07-21T17:32:28Z&#x60;. If a timezone is not specified we assume UTC) (optional)</param>
        /// <param name="createdAtLte">Transaction created before a date (ISO 8601. We recommend using a localised ISO 8601 datetime like &#x60;2017-07-21T17:32:28Z&#x60;. If a timezone is not specified we assume UTC) (optional)</param>
        /// <param name="capturedAtGte">Transaction captured after date (This param is subject to change in the future) (ISO 8601. We recommend using a localised ISO 8601 datetime like &#x60;2017-07-21T17:32:28Z&#x60;. If a timezone is not specified we assume UTC) (optional)</param>
        /// <param name="capturedAtLte">Transaction captured before date (This param is subject to change in the future) (ISO 8601. We recommend using a localised ISO 8601 datetime like &#x60;2017-07-21T17:32:28Z&#x60;. If a timezone is not specified we assume UTC) (optional)</param>
        /// <param name="refundedAtGte">Transaction refunded after date (This param is subject to change in the future) (ISO 8601. We recommend using a localised ISO 8601 datetime like &#x60;2017-07-21T17:32:28Z&#x60;. If a timezone is not specified we assume UTC) (optional)</param>
        /// <param name="refundedAtLte">Transaction refunded before date (This param is subject to change in the future) (ISO 8601. We recommend using a localised ISO 8601 datetime like &#x60;2017-07-21T17:32:28Z&#x60;. If a timezone is not specified we assume UTC) (optional)</param>
        /// <param name="search">Will try to match the search to either transaction_id, session_id or merchant_reference, merchant_reference_2, phone_number, email or the customer name using the format &#x60;{first_name} {last_name}&#x60;.  (optional)</param>
        /// <returns>List&lt;Transaction&gt;</returns>
        List<Transaction> TransactionsGet(List<string> id = default(List<string>), int? limit = default(int?), string startingAfter = default(string), List<string> status = default(List<string>), List<string> paymentProduct = default(List<string>), List<string> paymentProductType = default(List<string>), List<string> cardBrand = default(List<string>), string merchantReference = default(string), string merchantReference2 = default(string), List<string> sessionId = default(List<string>), List<string> storeId = default(List<string>), List<string> payoutCorrelationId = default(List<string>), List<string> currency = default(List<string>), int? amount = default(int?), int? amountGte = default(int?), int? amountLte = default(int?), string createdAtGte = default(string), string createdAtLte = default(string), string capturedAtGte = default(string), string capturedAtLte = default(string), string refundedAtGte = default(string), string refundedAtLte = default(string), string search = default(string));
        ...
        /// <param name="search">Will try to match the search to either transaction_id, session_id or merchant_reference, merchant_reference_2, phone_number, email or the customer name using the format &#x60;{first_name} {last_name}&#x60;.  (optional)</param>
        /// <returns>ApiResponse of List&lt;Transaction&gt;</returns>
        ApiResponse<List<Transaction>> TransactionsGetWithHttpInfo(List<string> id = default(List<string>), int? limit = default(int?), string startingAfter = default(string), List<string> status = default(List<string>), List<string> paymentProduct = default(List<string>), List<string> paymentProductType = default(List<string>), List<string> cardBrand = default(List<string>), string merchantReference = default(string), string merchantReference2 = default(string), List<string> sessionId = default(List<string>), List<string> storeId = default(List<string>), List<string> payoutCorrelationId = default(List<string>), List<string> currency = default(List<string>), int? amount = default(int?), int? amountGte = default(int?), int? amountLte = default(int?), string createdAtGte = default(string), string createdAtLte = default(string), string capturedAtGte = default(string), string capturedAtLte = default(string), string refundedAtGte = default(string), string refundedAtLte = default(string), string search = default(string));
        /// <summary>
        ...
        InlineResponse20010 TransactionsIdCapturePost(string id, InlineObject20 data = default(InlineObject20));
        ...
        ApiResponse<InlineResponse20010> TransactionsIdCapturePostWithHttpInfo(string id, InlineObject20 data = default(InlineObject20));
        /// <summary>
        /// Get a transaction
        /// </summary>
        /// <remarks>
        ...
        /// <param name="includes">Include aditional data that are by default excluded from the transaction details.  - **&#x60;card.payment_token&#x60;**: Include the payment_token generated from the transaction.   Only available for transaction with a session that enabled generate_payment_token. - **&#x60;session&#x60;** Include the session that the transaction resulted from  (optional)</param>
        /// <returns>ApiResponse of InlineResponse20010</returns>
        ApiResponse<InlineResponse20010> TransactionsIdGetWithHttpInfo(string id, List<string> includes = default(List<string>));
        /// <summary>
        ...
        /// <param name="data"> (optional)</param>
        /// <returns>InlineResponse20010</returns>
        InlineResponse20010 TransactionsIdPut(string id, InlineObject19 data = default(InlineObject19));
        ...
        /// <param name="data"> (optional)</param>
        /// <returns>ApiResponse of InlineResponse20010</returns>
        ApiResponse<InlineResponse20010> TransactionsIdPutWithHttpInfo(string id, InlineObject19 data = default(InlineObject19));
        /// <summary>
        /// Refund transaction
        /// </summary>
        /// <remarks>
        ...
        /// <param name="refunds"></param>
        /// <returns>ApiResponse of InlineResponse20010</returns>
        ApiResponse<InlineResponse20010> TransactionsIdRefundPostWithHttpInfo(string id, InlineObject21 refunds);
        /// <summary>
        /// Void transaction
        /// </summary>
        /// <remarks>
        ...
        /// <param name="id">The ID of the transaction</param>
        /// <returns>ApiResponse of InlineResponse20010</returns>
        ApiResponse<InlineResponse20010> TransactionsIdVoidPostWithHttpInfo(string id);
    ...
    public interface ITransactionsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<Transaction>> TransactionsEventsSettlementsPostAsync(UNKNOWN_BASE_TYPE data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<Transaction>>> TransactionsEventsSettlementsPostWithHttpInfoAsync(UNKNOWN_BASE_TYPE data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// List all transactions
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;Transaction&gt;</returns>
        System.Threading.Tasks.Task<List<Transaction>> TransactionsGetAsync(List<string> id = default(List<string>), int? limit = default(int?), string startingAfter = default(string), List<string> status = default(List<string>), List<string> paymentProduct = default(List<string>), List<string> paymentProductType = default(List<string>), List<string> cardBrand = default(List<string>), string merchantReference = default(string), string merchantReference2 = default(string), List<string> sessionId = default(List<string>), List<string> storeId = default(List<string>), List<string> payoutCorrelationId = default(List<string>), List<string> currency = default(List<string>), int? amount = default(int?), int? amountGte = default(int?), int? amountLte = default(int?), string createdAtGte = default(string), string createdAtLte = default(string), string capturedAtGte = default(string), string capturedAtLte = default(string), string refundedAtGte = default(string), string refundedAtLte = default(string), string search = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;Transaction&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<Transaction>>> TransactionsGetWithHttpInfoAsync(List<string> id = default(List<string>), int? limit = default(int?), string startingAfter = default(string), List<string> status = default(List<string>), List<string> paymentProduct = default(List<string>), List<string> paymentProductType = default(List<string>), List<string> cardBrand = default(List<string>), string merchantReference = default(string), string merchantReference2 = default(string), List<string> sessionId = default(List<string>), List<string> storeId = default(List<string>), List<string> payoutCorrelationId = default(List<string>), List<string> currency = default(List<string>), int? amount = default(int?), int? amountGte = default(int?), int? amountLte = default(int?), string createdAtGte = default(string), string createdAtLte = default(string), string capturedAtGte = default(string), string capturedAtLte = default(string), string refundedAtGte = default(string), string refundedAtLte = default(string), string search = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Capture a transaction
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<InlineResponse20010> TransactionsIdCapturePostAsync(string id, InlineObject20 data = default(InlineObject20), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse20010>> TransactionsIdCapturePostWithHttpInfoAsync(string id, InlineObject20 data = default(InlineObject20), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get a transaction
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse20010</returns>
        System.Threading.Tasks.Task<InlineResponse20010> TransactionsIdGetAsync(string id, List<string> includes = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse20010)</returns>
        System.Threading.Tasks.Task<ApiResponse<InlineResponse20010>> TransactionsIdGetWithHttpInfoAsync(string id, List<string> includes = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Update a transaction
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse20010</returns>
        System.Threading.Tasks.Task<InlineResponse20010> TransactionsIdPutAsync(string id, InlineObject19 data = default(InlineObject19), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse20010)</returns>
        System.Threading.Tasks.Task<ApiResponse<InlineResponse20010>> TransactionsIdPutWithHttpInfoAsync(string id, InlineObject19 data = default(InlineObject19), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Refund transaction
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse20010</returns>
        System.Threading.Tasks.Task<InlineResponse20010> TransactionsIdRefundPostAsync(string id, InlineObject21 refunds, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse20010)</returns>
        System.Threading.Tasks.Task<ApiResponse<InlineResponse20010>> TransactionsIdRefundPostWithHttpInfoAsync(string id, InlineObject21 refunds, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Void transaction
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse20010</returns>
        System.Threading.Tasks.Task<InlineResponse20010> TransactionsIdVoidPostAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse20010)</returns>
        System.Threading.Tasks.Task<ApiResponse<InlineResponse20010>> TransactionsIdVoidPostWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class TransactionsApi : ITransactionsApi
    {
        ...
        /// <returns></returns>
        public TransactionsApi(Dintero.OpenApiClient.Checkout.Client.Configuration configuration)
        {
        ...
        public TransactionsApi(Dintero.OpenApiClient.Checkout.Client.ISynchronousClient client, Dintero.OpenApiClient.Checkout.Client.IAsynchronousClient asyncClient, Dintero.OpenApiClient.Checkout.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Update transactions with settlements Add settlement events to list of transactions  scopes: - admin:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="data"></param>
        /// <returns>List&lt;Transaction&gt;</returns>
        public List<Transaction> TransactionsEventsSettlementsPost(UNKNOWN_BASE_TYPE data)
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<List<Transaction>> localVarResponse = TransactionsEventsSettlementsPostWithHttpInfo(data);
        ...
        /// <param name="data"></param>
        /// <returns>ApiResponse of List&lt;Transaction&gt;</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<List<Transaction>> TransactionsEventsSettlementsPostWithHttpInfo(UNKNOWN_BASE_TYPE data)
        {
            // verify the required parameter 'data' is set
            if (data == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'data' when calling TransactionsApi->TransactionsEventsSettlementsPost");
            ...
            var localVarResponse = this.Client.Post<List<Transaction>>("/transactions/events/settlements", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("TransactionsEventsSettlementsPost", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;Transaction&gt;</returns>
        public async System.Threading.Tasks.Task<List<Transaction>> TransactionsEventsSettlementsPostAsync(UNKNOWN_BASE_TYPE data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<List<Transaction>> localVarResponse = await TransactionsEventsSettlementsPostWithHttpInfoAsync(data, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;Transaction&gt;)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<List<Transaction>>> TransactionsEventsSettlementsPostWithHttpInfoAsync(UNKNOWN_BASE_TYPE data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'data' is set
            if (data == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'data' when calling TransactionsApi->TransactionsEventsSettlementsPost");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<List<Transaction>>("/transactions/events/settlements", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// List all transactions scopes: - admin:checkout - read:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">List of ids that should be included in the result. ?id&#x3D;A&amp;id&#x3D;B&amp;id&#x3D;X  (optional)</param>
        /// <param name="limit">A limit on the number of objects to be returned. Limit can range between 1 and 100 items, and the default is 10 items.  (optional, default to 10)</param>
        ...
        /// <param name="search">Will try to match the search to either transaction_id, session_id or merchant_reference, merchant_reference_2, phone_number, email or the customer name using the format &#x60;{first_name} {last_name}&#x60;.  (optional)</param>
        /// <returns>List&lt;Transaction&gt;</returns>
        public List<Transaction> TransactionsGet(List<string> id = default(List<string>), int? limit = default(int?), string startingAfter = default(string), List<string> status = default(List<string>), List<string> paymentProduct = default(List<string>), List<string> paymentProductType = default(List<string>), List<string> cardBrand = default(List<string>), string merchantReference = default(string), string merchantReference2 = default(string), List<string> sessionId = default(List<string>), List<string> storeId = default(List<string>), List<string> payoutCorrelationId = default(List<string>), List<string> currency = default(List<string>), int? amount = default(int?), int? amountGte = default(int?), int? amountLte = default(int?), string createdAtGte = default(string), string createdAtLte = default(string), string capturedAtGte = default(string), string capturedAtLte = default(string), string refundedAtGte = default(string), string refundedAtLte = default(string), string search = default(string))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<List<Transaction>> localVarResponse = TransactionsGetWithHttpInfo(id, limit, startingAfter, status, paymentProduct, paymentProductType, cardBrand, merchantReference, merchantReference2, sessionId, storeId, payoutCorrelationId, currency, amount, amountGte, amountLte, createdAtGte, createdAtLte, capturedAtGte, capturedAtLte, refundedAtGte, refundedAtLte, search);
            return localVarResponse.Data;
        }
        ...
        /// <param name="search">Will try to match the search to either transaction_id, session_id or merchant_reference, merchant_reference_2, phone_number, email or the customer name using the format &#x60;{first_name} {last_name}&#x60;.  (optional)</param>
        /// <returns>ApiResponse of List&lt;Transaction&gt;</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<List<Transaction>> TransactionsGetWithHttpInfo(List<string> id = default(List<string>), int? limit = default(int?), string startingAfter = default(string), List<string> status = default(List<string>), List<string> paymentProduct = default(List<string>), List<string> paymentProductType = default(List<string>), List<string> cardBrand = default(List<string>), string merchantReference = default(string), string merchantReference2 = default(string), List<string> sessionId = default(List<string>), List<string> storeId = default(List<string>), List<string> payoutCorrelationId = default(List<string>), List<string> currency = default(List<string>), int? amount = default(int?), int? amountGte = default(int?), int? amountLte = default(int?), string createdAtGte = default(string), string createdAtLte = default(string), string capturedAtGte = default(string), string capturedAtLte = default(string), string refundedAtGte = default(string), string refundedAtLte = default(string), string search = default(string))
        {
            Dintero.OpenApiClient.Checkout.Client.RequestOptions localVarRequestOptions = new Dintero.OpenApiClient.Checkout.Client.RequestOptions();
            ...
            if (id != null)
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("multi", "id", id));
            }
            if (limit != null)
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("", "limit", limit));
            }
            if (startingAfter != null)
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("", "starting_after", startingAfter));
            }
            if (status != null)
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("multi", "status", status));
            }
            if (paymentProduct != null)
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("multi", "payment_product", paymentProduct));
            }
            if (paymentProductType != null)
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("multi", "payment_product_type", paymentProductType));
            }
            if (cardBrand != null)
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("multi", "card_brand", cardBrand));
            }
            if (merchantReference != null)
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("", "merchant_reference", merchantReference));
            }
            if (merchantReference2 != null)
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("", "merchant_reference_2", merchantReference2));
            }
            if (sessionId != null)
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("multi", "session_id", sessionId));
            }
            if (storeId != null)
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("multi", "store_id", storeId));
            }
            if (payoutCorrelationId != null)
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("csv", "payout_correlation_id", payoutCorrelationId));
            }
            if (currency != null)
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("multi", "currency", currency));
            }
            if (amount != null)
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("", "amount", amount));
            }
            if (amountGte != null)
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("", "amount.gte", amountGte));
            }
            if (amountLte != null)
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("", "amount.lte", amountLte));
            }
            if (createdAtGte != null)
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("", "created_at.gte", createdAtGte));
            }
            if (createdAtLte != null)
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("", "created_at.lte", createdAtLte));
            }
            if (capturedAtGte != null)
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("", "captured_at.gte", capturedAtGte));
            }
            if (capturedAtLte != null)
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("", "captured_at.lte", capturedAtLte));
            }
            if (refundedAtGte != null)
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("", "refunded_at.gte", refundedAtGte));
            }
            if (refundedAtLte != null)
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("", "refunded_at.lte", refundedAtLte));
            }
            if (search != null)
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("", "search", search));
            }
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<List<Transaction>>("/transactions", localVarRequestOptions, this.Configuration);
        ...
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<List<Transaction>> localVarResponse = await TransactionsGetWithHttpInfoAsync(id, limit, startingAfter, status, paymentProduct, paymentProductType, cardBrand, merchantReference, merchantReference2, sessionId, storeId, payoutCorrelationId, currency, amount, amountGte, amountLte, createdAtGte, createdAtLte, capturedAtGte, capturedAtLte, refundedAtGte, refundedAtLte, search, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;Transaction&gt;)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<List<Transaction>>> TransactionsGetWithHttpInfoAsync(List<string> id = default(List<string>), int? limit = default(int?), string startingAfter = default(string), List<string> status = default(List<string>), List<string> paymentProduct = default(List<string>), List<string> paymentProductType = default(List<string>), List<string> cardBrand = default(List<string>), string merchantReference = default(string), string merchantReference2 = default(string), List<string> sessionId = default(List<string>), List<string> storeId = default(List<string>), List<string> payoutCorrelationId = default(List<string>), List<string> currency = default(List<string>), int? amount = default(int?), int? amountGte = default(int?), int? amountLte = default(int?), string createdAtGte = default(string), string createdAtLte = default(string), string capturedAtGte = default(string), string capturedAtLte = default(string), string refundedAtGte = default(string), string refundedAtLte = default(string), string search = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<Transaction>>("/transactions", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Capture a transaction Captures a transaction that was created with the Checkout endpoint with a &#x60;capture_now&#x60; value of &#x60;false&#x60;.  #### Capture Instabank transaction  Note that &#x60;items&#x60; is required when capturing a transaction with &#x60;payment_product&#x3D;instabank&#x60;. The items must include the lines to Capture, with &#x60;line_id&#x60;, &#x60;quantity&#x60; and &#x60;amount&#x60;.  scopes: - admin:checkout - write:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The ID of the transaction</param>
        /// <param name="data"> (optional)</param>
        /// <returns>InlineResponse20010</returns>
        public InlineResponse20010 TransactionsIdCapturePost(string id, InlineObject20 data = default(InlineObject20))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse20010> localVarResponse = TransactionsIdCapturePostWithHttpInfo(id, data);
            return localVarResponse.Data;
        }
        ...
        /// <param name="data"> (optional)</param>
        /// <returns>ApiResponse of InlineResponse20010</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse20010> TransactionsIdCapturePostWithHttpInfo(string id, InlineObject20 data = default(InlineObject20))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'id' when calling TransactionsApi->TransactionsIdCapturePost");
            ...
            localVarRequestOptions.PathParameters.Add("id", Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToString(id)); // path parameter
            localVarRequestOptions.Data = data;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<InlineResponse20010>("/transactions/{id}/capture", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("TransactionsIdCapturePost", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse20010</returns>
        public async System.Threading.Tasks.Task<InlineResponse20010> TransactionsIdCapturePostAsync(string id, InlineObject20 data = default(InlineObject20), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse20010> localVarResponse = await TransactionsIdCapturePostWithHttpInfoAsync(id, data, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse20010)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse20010>> TransactionsIdCapturePostWithHttpInfoAsync(string id, InlineObject20 data = default(InlineObject20), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'id' when calling TransactionsApi->TransactionsIdCapturePost");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<InlineResponse20010>("/transactions/{id}/capture", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Get a transaction scopes: - admin:checkout - read:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The ID of the transaction</param>
        /// <param name="includes">Include aditional data that are by default excluded from the transaction details.  - **&#x60;card.payment_token&#x60;**: Include the payment_token generated from the transaction.   Only available for transaction with a session that enabled generate_payment_token. - **&#x60;session&#x60;** Include the session that the transaction resulted from  (optional)</param>
        /// <returns>InlineResponse20010</returns>
        public InlineResponse20010 TransactionsIdGet(string id, List<string> includes = default(List<string>))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse20010> localVarResponse = TransactionsIdGetWithHttpInfo(id, includes);
            return localVarResponse.Data;
        }
        ...
        /// <param name="includes">Include aditional data that are by default excluded from the transaction details.  - **&#x60;card.payment_token&#x60;**: Include the payment_token generated from the transaction.   Only available for transaction with a session that enabled generate_payment_token. - **&#x60;session&#x60;** Include the session that the transaction resulted from  (optional)</param>
        /// <returns>ApiResponse of InlineResponse20010</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse20010> TransactionsIdGetWithHttpInfo(string id, List<string> includes = default(List<string>))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'id' when calling TransactionsApi->TransactionsIdGet");
            ...
            if (includes != null)
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("multi", "includes", includes));
            }
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<InlineResponse20010>("/transactions/{id}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("TransactionsIdGet", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse20010</returns>
        public async System.Threading.Tasks.Task<InlineResponse20010> TransactionsIdGetAsync(string id, List<string> includes = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse20010> localVarResponse = await TransactionsIdGetWithHttpInfoAsync(id, includes, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse20010)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse20010>> TransactionsIdGetWithHttpInfoAsync(string id, List<string> includes = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'id' when calling TransactionsApi->TransactionsIdGet");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<InlineResponse20010>("/transactions/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Update a transaction scopes: - admin:checkout - write:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The ID of the transaction</param>
        /// <param name="data"> (optional)</param>
        /// <returns>InlineResponse20010</returns>
        public InlineResponse20010 TransactionsIdPut(string id, InlineObject19 data = default(InlineObject19))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse20010> localVarResponse = TransactionsIdPutWithHttpInfo(id, data);
            return localVarResponse.Data;
        }
        ...
        /// <param name="data"> (optional)</param>
        /// <returns>ApiResponse of InlineResponse20010</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse20010> TransactionsIdPutWithHttpInfo(string id, InlineObject19 data = default(InlineObject19))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'id' when calling TransactionsApi->TransactionsIdPut");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Put<InlineResponse20010>("/transactions/{id}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("TransactionsIdPut", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse20010</returns>
        public async System.Threading.Tasks.Task<InlineResponse20010> TransactionsIdPutAsync(string id, InlineObject19 data = default(InlineObject19), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse20010> localVarResponse = await TransactionsIdPutWithHttpInfoAsync(id, data, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse20010)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse20010>> TransactionsIdPutWithHttpInfoAsync(string id, InlineObject19 data = default(InlineObject19), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'id' when calling TransactionsApi->TransactionsIdPut");
            ...
            var localVarResponse = await this.AsynchronousClient.PutAsync<InlineResponse20010>("/transactions/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Refund transaction Once a transaction has been successfully captured, a refund operation is available. Like other operations, refund can be partial or total  #### Refund Instabank transaction  Note that &#x60;items&#x60; is required when refunding a transaction with &#x60;payment_product&#x3D;instabank&#x60;. The items must include the lines to Refund, with &#x60;line_id&#x60;, &#x60;quantity&#x60; and &#x60;amount&#x60;.  scopes: - admin:checkout - write:checkout 
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The ID of the transaction</param>
        /// <param name="refunds"></param>
        /// <returns>InlineResponse20010</returns>
        public InlineResponse20010 TransactionsIdRefundPost(string id, InlineObject21 refunds)
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse20010> localVarResponse = TransactionsIdRefundPostWithHttpInfo(id, refunds);
            return localVarResponse.Data;
        }
        ...
        /// <param name="refunds"></param>
        /// <returns>ApiResponse of InlineResponse20010</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse20010> TransactionsIdRefundPostWithHttpInfo(string id, InlineObject21 refunds)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'id' when calling TransactionsApi->TransactionsIdRefundPost");

            // verify the required parameter 'refunds' is set
            if (refunds == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'refunds' when calling TransactionsApi->TransactionsIdRefundPost");
            ...
            localVarRequestOptions.PathParameters.Add("id", Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToString(id)); // path parameter
            localVarRequestOptions.Data = refunds;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<InlineResponse20010>("/transactions/{id}/refund", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("TransactionsIdRefundPost", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse20010</returns>
        public async System.Threading.Tasks.Task<InlineResponse20010> TransactionsIdRefundPostAsync(string id, InlineObject21 refunds, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse20010> localVarResponse = await TransactionsIdRefundPostWithHttpInfoAsync(id, refunds, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse20010)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse20010>> TransactionsIdRefundPostWithHttpInfoAsync(string id, InlineObject21 refunds, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'id' when calling TransactionsApi->TransactionsIdRefundPost");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<InlineResponse20010>("/transactions/{id}/refund", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="id">The ID of the transaction</param>
        /// <returns>InlineResponse20010</returns>
        public InlineResponse20010 TransactionsIdVoidPost(string id)
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse20010> localVarResponse = TransactionsIdVoidPostWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">The ID of the transaction</param>
        /// <returns>ApiResponse of InlineResponse20010</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse20010> TransactionsIdVoidPostWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'id' when calling TransactionsApi->TransactionsIdVoidPost");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<InlineResponse20010>("/transactions/{id}/void", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("TransactionsIdVoidPost", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse20010</returns>
        public async System.Threading.Tasks.Task<InlineResponse20010> TransactionsIdVoidPostAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse20010> localVarResponse = await TransactionsIdVoidPostWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse20010)</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<InlineResponse20010>> TransactionsIdVoidPostWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'id' when calling TransactionsApi->TransactionsIdVoidPost");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<InlineResponse20010>("/transactions/{id}/void", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
