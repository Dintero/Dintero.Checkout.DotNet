...
namespace Dintero.OpenApiClient.Checkout.Api
{
    ...
    /// </summary>
    public interface INetaxeptApiSync : IApiAccessor
    {
        ...
        ApiResponse<Object> CheckoutNetaxeptWebhooksPostWithHttpInfo(InlineObject16 data);
        /// <summary>
        /// Redirect to Netaxept hosted payment window
        /// </summary>
        /// <exception cref="Dintero.OpenApiClient.Checkout.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="sessionId">The session ID</param>
        /// <param name="language">Indicates which language is used in the Netaxept hosted payment window  (optional, default to no_NO)</param>
        /// <returns></returns>
        void CheckoutSidNetaxeptHtmlGet(string sessionId, string language = default(string));
        ...
        /// <param name="language">Indicates which language is used in the Netaxept hosted payment window  (optional, default to no_NO)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> CheckoutSidNetaxeptHtmlGetWithHttpInfo(string sessionId, string language = default(string));
        /// <summary>
        ...
        /// <param name="responseCode"> (optional)</param>
        /// <returns></returns>
        void CheckoutSidNetaxeptRedirectGet(string sessionId, string redirectRef, string transactionId = default(string), string responseCode = default(string));
        ...
        /// <param name="responseCode"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> CheckoutSidNetaxeptRedirectGetWithHttpInfo(string sessionId, string redirectRef, string transactionId = default(string), string responseCode = default(string));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface INetaxeptApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task CheckoutNetaxeptWebhooksPostAsync(InlineObject16 data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> CheckoutNetaxeptWebhooksPostWithHttpInfoAsync(InlineObject16 data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Redirect to Netaxept hosted payment window
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task CheckoutSidNetaxeptHtmlGetAsync(string sessionId, string language = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> CheckoutSidNetaxeptHtmlGetWithHttpInfoAsync(string sessionId, string language = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Handle redirect from payment
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task CheckoutSidNetaxeptRedirectGetAsync(string sessionId, string redirectRef, string transactionId = default(string), string responseCode = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> CheckoutSidNetaxeptRedirectGetWithHttpInfoAsync(string sessionId, string redirectRef, string transactionId = default(string), string responseCode = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface INetaxeptApi : INetaxeptApiSync, INetaxeptApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class NetaxeptApi : INetaxeptApi
    {
        private Dintero.OpenApiClient.Checkout.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="NetaxeptApi"/> class.
        /// </summary>
        /// <returns></returns>
        public NetaxeptApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public NetaxeptApi(String basePath)
        {
        ...
        /// <returns></returns>
        public NetaxeptApi(Dintero.OpenApiClient.Checkout.Client.Configuration configuration)
        {
        ...
        public NetaxeptApi(Dintero.OpenApiClient.Checkout.Client.ISynchronousClient client, Dintero.OpenApiClient.Checkout.Client.IAsynchronousClient asyncClient, Dintero.OpenApiClient.Checkout.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public void CheckoutNetaxeptWebhooksPost(InlineObject16 data)
        {
            CheckoutNetaxeptWebhooksPostWithHttpInfo(data);
        }
        ...
        /// <param name="data"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object> CheckoutNetaxeptWebhooksPostWithHttpInfo(InlineObject16 data)
        {
            // verify the required parameter 'data' is set
            if (data == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'data' when calling NetaxeptApi->CheckoutNetaxeptWebhooksPost");
            ...
            var localVarResponse = this.Client.Post<Object>("/events/gateways/netaxept/transaction/hooks", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CheckoutNetaxeptWebhooksPost", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task CheckoutNetaxeptWebhooksPostAsync(InlineObject16 data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await CheckoutNetaxeptWebhooksPostWithHttpInfoAsync(data, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object>> CheckoutNetaxeptWebhooksPostWithHttpInfoAsync(InlineObject16 data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'data' is set
            if (data == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'data' when calling NetaxeptApi->CheckoutNetaxeptWebhooksPost");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/events/gateways/netaxept/transaction/hooks", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="language">Indicates which language is used in the Netaxept hosted payment window  (optional, default to no_NO)</param>
        /// <returns></returns>
        public void CheckoutSidNetaxeptHtmlGet(string sessionId, string language = default(string))
        {
            CheckoutSidNetaxeptHtmlGetWithHttpInfo(sessionId, language);
        }
        ...
        /// <param name="language">Indicates which language is used in the Netaxept hosted payment window  (optional, default to no_NO)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object> CheckoutSidNetaxeptHtmlGetWithHttpInfo(string sessionId, string language = default(string))
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling NetaxeptApi->CheckoutSidNetaxeptHtmlGet");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<Object>("/view/{session_id}/netaxept", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CheckoutSidNetaxeptHtmlGet", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task CheckoutSidNetaxeptHtmlGetAsync(string sessionId, string language = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await CheckoutSidNetaxeptHtmlGetWithHttpInfoAsync(sessionId, language, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object>> CheckoutSidNetaxeptHtmlGetWithHttpInfoAsync(string sessionId, string language = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling NetaxeptApi->CheckoutSidNetaxeptHtmlGet");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/view/{session_id}/netaxept", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="responseCode"> (optional)</param>
        /// <returns></returns>
        public void CheckoutSidNetaxeptRedirectGet(string sessionId, string redirectRef, string transactionId = default(string), string responseCode = default(string))
        {
            CheckoutSidNetaxeptRedirectGetWithHttpInfo(sessionId, redirectRef, transactionId, responseCode);
        }
        ...
        /// <param name="responseCode"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object> CheckoutSidNetaxeptRedirectGetWithHttpInfo(string sessionId, string redirectRef, string transactionId = default(string), string responseCode = default(string))
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling NetaxeptApi->CheckoutSidNetaxeptRedirectGet");

            // verify the required parameter 'redirectRef' is set
            if (redirectRef == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'redirectRef' when calling NetaxeptApi->CheckoutSidNetaxeptRedirectGet");
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("", "transactionId", transactionId));
            }
            if (responseCode != null)
            {
                localVarRequestOptions.QueryParameters.Add(Dintero.OpenApiClient.Checkout.Client.ClientUtils.ParameterToMultiMap("", "responseCode", responseCode));
            }
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<Object>("/sessions/{session_id}/netaxept/redirect/{redirect_ref}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CheckoutSidNetaxeptRedirectGet", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task CheckoutSidNetaxeptRedirectGetAsync(string sessionId, string redirectRef, string transactionId = default(string), string responseCode = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await CheckoutSidNetaxeptRedirectGetWithHttpInfoAsync(sessionId, redirectRef, transactionId, responseCode, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Dintero.OpenApiClient.Checkout.Client.ApiResponse<Object>> CheckoutSidNetaxeptRedirectGetWithHttpInfoAsync(string sessionId, string redirectRef, string transactionId = default(string), string responseCode = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
                throw new Dintero.OpenApiClient.Checkout.Client.ApiException(400, "Missing required parameter 'sessionId' when calling NetaxeptApi->CheckoutSidNetaxeptRedirectGet");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/sessions/{session_id}/netaxept/redirect/{redirect_ref}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
